...
`;function He(e,t,i="ts-hero-name"){return Z`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function je(e,t,i,s){return Z`
    <div class="${i}">
      ${He(e,t)}
...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ve=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ge=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,o]of Object.entries(t)){if(!o?.device_id)continue;if(o.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const n=(o.platform??"").toLowerCase();if("shelly"!==n)continue;const l=o.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===n,c=e.area_id??o.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:n,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==n||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:o.area_id,platform:n})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],o=s?.via_device_id;if(!o||!r.has(o)||a.has(o))continue;const n=i[o],l=s?.configuration_url??"",c=n?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(o).integration;if(!p&&!h)continue;const u=r.get(o);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]},et={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",badges:"Type & gen badges"};function tt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const it={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const st="—";function rt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:st}function at(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:st}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:st}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:st}function lt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:st}function ct(e){return!Number.isFinite(e)||e<0?st:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function dt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":st}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:st}function ht(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:st}function ut(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:st}function gt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:st}function vt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:st}function ft(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:st}function bt(e){return Number.isFinite(e)?`${Math.round(e)} %`:st}const mt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],xt=Object.fromEntries(mt.map(e=>[e.key,e.label.split(" ")[0]])),yt={co2:"carbon_dioxide",rssi:"signal_strength"};function wt(e){return yt[e]??e}function kt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(wt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=wt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const At=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Ct=["online","offline","power","alerts"];function St(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,u=110,g=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+g*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=u+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),o=u+e*Math.sin(m(i)),n=g*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return Z`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      `;default:return Z``}}const Mt=255;function Bt(e){return Z`
    ...
    </div>`}function Tt(e){if(!e.getGraphEntities(e.device).length)return Z``;const t=e.getDetailHistoryRange();return Z`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?Z`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:V}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),_=C.max??Math.max(...A),z=_-S||1,O=s[0].t,I=s[s.length-1].t,M=I-O||1,B=e=>(e.t-O)/M*a,T=e=>o-4-(e.v-S)/z*(o-8),E=s.map(e=>`${B(e).toFixed(1)},${T(e).toFixed(1)}`).join(" "),R=B(s[0]).toFixed(1),D=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,F=A[A.length-1],P=F%1==0?`${F}`:F.toFixed(1),L=Math.max(...A),N=Math.min(...A);let H=A.indexOf(L),j=A.indexOf(N);H<0&&(H=0),j<0&&(j=0);const U=B(s[H]).toFixed(1),W=T(s[H]).toFixed(1),q=B(s[j]).toFixed(1),X=T(s[j]).toFixed(1),G=m(s[0].t),Y=m((s[0].t+I)/2),K=v/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&_-S>0;return Z`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?V:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="none"
                ...
                `:V}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=B(e)-t/2,r=T(e),n=o-4-r;return Q`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):Q`
          ...
          ${p?Z`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${G}</span><span>${Y}</span><span>now</span>
              </div>
    ...
    `,g=Z`
      ...
      <div class="field">
        ...
        `:V}
      </div>`;this._getAreas();const v=t.accent_color??"#f4601e",f=t.card_bg??"#1c1c1e",b=t.tile_bg??"#1c1c1e",m=t.tile_border??"#2a2a30",x=t.tile_hover_bg??"rgba(255,255,255,0.07)",y=t.tile_sensor_bg??"rgba(255,255,255,0.04)",w=t.text_primary??"#e5e7eb",k=t.text_secondary??"#9ca3af",A=t.text_muted??"#6b7280",C=t.online_color??"#4ade80",S=t.offline_color??"#ef4444";t.power_color;const _=t.header_bg??"#1a1a2e",z=t.header_bg2??"#0f3460",O=t.header_text_color??"#ffffff",I=t.header_orb_color??"#3b82f6",M=t.header_title_size??1.1,B=t.header_padding??16,T=t.header_border_width??0,E=t.header_border_color??"#4ade80",R=t.header_stat_online??"#4ade80",D=t.header_stat_power??"#fb923c",F=t.font_family?`'${t.font_family}', sans-serif`:"inherit",P=t.text_size_scale??1,L=t.tile_radius??12,N=t.tile_border_width??1,H=t.header_radius??0,j=T>0?`${T}px solid ${E}`:"none",U=Z`
      <div class="style-preview" style="font-family:${F};background:${f}">
        <div class="sp-header"
          style="background:linear-gradient(135deg,${_},${z});color:${O};border-radius:${H}px;padding:${Math.round(.55*B)}px 12px;border-bottom:${j};position:relative;overflow:hidden">
      ...
      ${Wt.map(i=>{const s=i.items.map(e=>e.key),r=s.filter(e=>t.includes(e)).length,a=s.every(e=>t.includes(e)),o=this._badge(`${r||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),n=Z`
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...Lt[t]}}(this._config.style,e))}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=function(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of Nt){const i=Lt[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}(t);return Z`
          ...
          <div class="dp-group">
            ...
            <div class="theme-grid">
              ${Nt.map(e=>{const t=Lt[e];return Z`
                  <button class="theme-swatch ${s===e?"on":""}" title=${Ht[e]}
                    @click=${()=>this._applyTheme(e)}>
                    ...
                    <span class="ts-name">${Ht[e]}</span>
                  </button>`})}
            </div>
            ${"custom"===s?Z`<div class="hint">Custom — your colours don't match a preset. Pick one to reset the palette.</div>`:V}
          </div>
  ...
  `],e([ve({attribute:!1})],Vt.prototype,"hass",void 0),e([fe()],Vt.prototype,"_config",void 0),e([fe()],Vt.prototype,"_tab",void 0),e([fe()],Vt.prototype,"_advanced",void 0),e([fe()],Vt.prototype,"_defaultsOpen",void 0),e([fe()],Vt.prototype,"_expandedViewId",void 0),e([fe()],Vt.prototype,"_openSections",void 0),e([fe()],Vt.prototype,"_expandedRooms",void 0),e([fe()],Vt.prototype,"_expandedRoomStyle",void 0),e([fe()],Vt.prototype,"_selectedDeviceId",void 0),e([fe()],Vt.prototype,"_deviceSearch",void 0),e([fe()],Vt.prototype,"_hiddenBlocks",void 0),e([fe()],Vt.prototype,"_dragOrder",void 0),e([fe()],Vt.prototype,"_dragOver",void 0),e([fe()],Vt.prototype,"_styleClipFeedback",void 0),e([fe()],Vt.prototype,"_copyAreaOpen",void 0),e([fe()],Vt.prototype,"_copyJson",void 0),e([fe()],Vt.prototype,"_pasteOpen",void 0),e([fe()],Vt.prototype,"_pasteText",void 0),e([fe()],Vt.prototype,"_iconPickerState",void 0),Vt=e([he("ha-device-dashboard-editor")],Vt),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
