...
`;function Ve(e,t,i="ts-hero-name"){return q`
    ...
    <div class="input-row ${i.isButton?"btn-mode":i.isOn?"active":""}">
      ...
      ${function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputSelectChip(t,i);if(!s)return o?Xe(e,o):K;const a=e.inputHasHold(t,i),n=()=>e.endInputHold();return q`
    ...
    </select>`}const Ye=/^\s*[♪♫♬♩]\s*/,Ze=new Set(["pixels","pixelwave","juggles","matripix","gravimeter","plasmoid","puddles","midnoise","noisemeter","freqwave","freqmatrix","geq","waterfall","freqpixels","noisefire","puddlepeak","noisemove","ripple peak","freqmap","gravcenter","gravcentric","gravfreq","dj light","funky plank","blurz","waverly","swirl","rocktaves","akemi","ps spray","ps geq 2d","ps geq nova","ps blobs","ps geq 1d","ps sonic stream","ps sonic boom","ps springy"]),Je=e=>Ye.test(e)||Ze.has(e.replace(Ye,"").trim().toLowerCase());function et(e,t,i){if(e.length<=1)return K;const s=e.filter(Je),o=e.filter(e=>!Je(e)&&"Off"!==e),a=e.find(e=>"Off"===e)??e.find(e=>"Solid"===e),n=e=>q`
    ...
    <div class="tile-effects" @click=${e=>e.stopPropagation()}>
      <select class="effect-sel"
        ...
        ${s.length?q`
          <optgroup label="Sound reactive">${s.map(n)}</optgroup>`:K}
        <optgroup label="Effects">${o.filter(e=>e!==a).map(n)}</optgroup>
      </select>
    </div>`}const tt={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const it=[3,7,11,15,19,23,27];function st(e,t,i,s){if("none"===e)return q``;const o=t?"on":"off";return"flame"===e?q`${G`<svg class="${s} ent-icon-flame ${o}" style="${i}" viewBox="0 0 20 20">
...
`,nt=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function rt(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    <button
      ...
      ${r&&e.showEl("target_state")?q`<span class="ts-key-sub">${r}</span>`:K}
    ...
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,o=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),a="W"===e.label||"A"===e.label?"left":"right",n=(h+s*("left"===a?-1:1)).toFixed(1),r=(g+8).toFixed(1),l="left"===a?"start":"end";return G`
    ...
    ${o>s?G`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${u}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${u}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:K}`})():K;return q`
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ${l&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(l.entityId,i,t)}>${i?"ON":"OFF"}</button>`:K}
        ${Ve(t,o,"ts-spark-name")}
      </div>
      ...
      <div class="ts-spark-bottom">
        ...
        ${e.showEl("secondary")?q`<div class="ts-spark-meta">
          ${null!=r.voltage?q`<div class="ts-spark-mrow">${r.voltage.toFixed(1)} <b>V</b></div>`:K}
          ${null!=r.current?q`<div class="ts-spark-mrow">${r.current.toFixed(2)} <b>A</b></div>`:K}
          ${null!=r.energy?q`<div class="ts-spark-mrow">${r.energy.toFixed(2)} <b>kWh</b></div>`:K}
          ${null!=r.temp?q`<div class="ts-spark-mrow">${r.temp.toFixed(1)} <b>°C</b></div>`:K}
          ${null!=r.rssi?q`<div class="ts-spark-mrow">${r.rssi} <b>dBm</b></div>`:K}
        </div>`:K}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipPowerGraph:!0}):K}
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=n.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${qt(n.uptime)}</span>`:K}
        </div>
    ...
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:n}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${r})"/>
    <polyline points="${n}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():K,f=(e,t,i=!1)=>q`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=r.power?f("Power",Nt(r.power),!0):K}
      ${e.showEl("secondary")?q`
        ${null!=r.voltage?f("Voltage",`${r.voltage.toFixed(1)} V`):K}
        ${null!=r.current?f("Current",`${r.current.toFixed(3)} A`):K}
        ${null!=r.energy?f(r.energyLabel,jt(r.energy)):K}
        ${null!=r.temp?f("Temp",`${r.temp.toFixed(1)} °C`):K}
        ${null!=r.rssi?f("WiFi",`${r.rssi} dBm`):K}`:K}
      ${null!=r.uptime&&e.showEl("uptime")?f("Uptime",qt(r.uptime)):K}
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipGraphs:!0}):K}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:n}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${r})"/>
    <polyline points="${n}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():K;return q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ${e.showEl("secondary")?q`<div class="ts-chips">
          ${null!=r.voltage?q`<span class="ts-chip">${r.voltage.toFixed(1)} V</span>`:K}
          ${null!=r.current?q`<span class="ts-chip">${r.current.toFixed(2)} A</span>`:K}
          ${null!=r.energy?q`<span class="ts-chip">${r.energy.toFixed(2)} kWh</span>`:K}
          ${null!=r.temp?q`<span class="ts-chip">${r.temp.toFixed(1)} °C</span>`:K}
          ${null!=r.rssi?q`<span class="ts-chip">${r.rssi} dBm</span>`:K}
        </div>`:K}
        ${e.showEl("uptime")?q`<span class="ts-uptime">${r.uptime?qt(r.uptime):""}</span>`:K}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n):K}
    </div>`}(e)}}const Vi=140,Ki=70;function Qi(e){const{device:t,isOn:i,accent:s,online:o,hass:a,profile:n}=e,r=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!r)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(r.entityId.startsWith("switch.")||"dimmer"!==n.type&&"rgb"!==n.type)return q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Vi}" height="${Vi}" viewBox="0 0 ${Vi} ${Vi}"
            ...
            <circle cx="${Ki}" cy="${Ki}" r="${Ki}" fill="url(#${k})" opacity="${i?1:.3}"/>
            ${_?G`<circle cx="${_.x.toFixed(1)}" cy="${_.y.toFixed(1)}" r="7" fill="${h}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:K}
          </svg>
        </div>`:K}
      ...
      ${e.showEl("effects")?et(f,m,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e})):K}
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Nt(l.power)}</div>`:K}
    </div>`}function Xi(e,t){const{device:i,profile:s,config:o,hass:a,online:n}=e,r=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),g=e.getPower(i),u=e.getSensors(i),v=e.getInputChannels(i),f=r?.isOn??!1,m=void 0!==r?.brightness,b=r&&m&&f?Math.max(1,r.brightness??1):0,y=!!r?.colorModes?.length,x=r?.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",w=!!r?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),_="heat"===l?.hvacMode,k="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Bt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=st(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?st(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?st(i,!0,"--ent-spd:1","tile-icon"):q``}else a=q``;const p=r?e.renderEntityAnim(r.entityId,f,i.device_id):q``,g=r?q`
      ...
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=r?a.states[r.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,o=r?.whiteValue??0;return r&&m?q`
        ...
        `:K}
        ${et(i,s,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e}))}
      ...
      `:q``}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=ft(i);return e.length?q`
        ...
        <div class="tile-bot">
          ...
          <div class="tile-badges">
            ...
            ${k?q`<span class="gen-badge gen-${s.gen}">${k}</span>`:K}
      ...
      `;default:return q``}var S}const Yi=255;function Zi(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=n.rssi?q`<div class="ds-signal">Wi-Fi: ${Gt(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?q` · Up ${qt(n.uptime)}`:K}</div>`:K}
    ...
    ${es(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return q`
    ...
    ${es(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,o=Math.round(s/255*100);return q`
    <div class="ds-section">
    ...
    ${es(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Yi*100);return q`
    <div class="ds-section">
    ...
    ${es(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return q`
    <div class="ds-section">
    ...
    ${es(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return q`
    <div class="ds-section">
    ...
    ${es(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return q`
    <div class="ds-section">
    ...
    ${es(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return q`${es(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),o=e.getAlerts(t);return q`
    ...
    ${es(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t}=e,i=e.getInputChannels(t);return q`
    <div class="ds-section">
    ...
    ${es(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),o=t.entities.filter(e=>"switch"===e.domain);return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    ${es(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return q`
    ${t?q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${es(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    </div>`}function Ji(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function es(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:o=!1}=t;return q`
    ${o&&s?Ji(e):K}
    ...
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const a=(t,s)=>{const o=i.states[t.entity_id],a=o?.attributes?.friendly_name??t.entity_id,n=o?.state??"unknown",r=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===n,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      ...
      </div>`},n=o.filter(e=>"primary"===dt(e)),r=o.filter(e=>"config"===dt(e)),l=o.filter(e=>"diagnostic"===dt(e));return q`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${n.map(e=>a(e,!1))}
      ${r.length?q`<div class="ds-ent-subgroup">Configuration</div>${r.map(e=>a(e,!0))}`:K}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:K}
          ...
          </div>`;const A=s.map(e=>e.v),S=(this._config.graph_style?.sensor_ranges??{})[_]??{},C=S.min??Math.min(...A),E=S.max??Math.max(...A),T=E-C||1,I=s[0].t,z=s[s.length-1].t,$=z-I||1,O=e=>(e.t-I)/$*a,D=e=>n-4-(e.v-C)/T*(n-8),M=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),R=O(s[0]).toFixed(1),P=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,B=A[A.length-1],F=B%1==0?`${B}`:B.toFixed(1),L=Math.max(...A),N=Math.min(...A);let j=A.indexOf(L),H=A.indexOf(N);j<0&&(j=0),H<0&&(H=0);const W=O(s[j]).toFixed(1),U=D(s[j]).toFixed(1),V=O(s[H]).toFixed(1),Q=D(s[H]).toFixed(1),X=y(s[0].t),Y=y((s[0].t+z)/2),Z=f/$*a,J=`${Math.max(.3,.7*Z).toFixed(2)} ${Math.max(.3,.3*Z).toFixed(2)}`,ee=c&&E-C>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?K:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),n=I+o*$;let r=s[0];for(const e of s)Math.abs(e.t-n)<Math.abs(r.t-n)&&(r=e);const l=O(r),c=D(r),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const h=t.parentElement,g=h?.querySelector(".spark-tooltip");if(g){const e=g.querySelector(".spark-tooltip-val"),t=g.querySelector(".spark-tooltip-time");e&&(e.textContent=`${r.v%1==0?String(r.v):r.v.toFixed(1)} ${w}`),t&&(t.textContent=y(r.t)),g.style.left=`${(l/a*100).toFixed(1)}%`,g.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                `:K}
                ${"bar"!==h&&u?G`
                  <polygon points="${M} ${a},${n-4} ${R},${n-4}" fill="url(#${P})"/>
                `:K}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=O(e)-t/2,o=D(e),r=n-4-o;return G`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,r).toFixed(1)}" rx="${g}" fill="${k}" opacity="0.75"/>`}):G`
                ...
                ${ee?G`
                  <circle cx="${W}" cy="${U}" r="3"
                    fill="${k}" stroke="#1e1e2e" stroke-width="1.2"/>
                  <circle cx="${V}" cy="${Q}" r="2.5"
    ...
    `}_trvTempFromEvent(e,t,i,s,o){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const n=(e.clientX-a.left)*(160/a.width),r=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(r-70,n-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=o||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),o=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(o-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const n=(a-210+360)%360;return n>300?null:Math.round(n/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[o,a]=i(e,s),[n,r]=i(t,s);return`M ${o} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${n} ${r}`},o=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,n=(e=>210+e/100*300)(a),[r,l]=i(n,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=o?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},o=()=>{i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",n)},a=t=>{const s=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=s&&this._setValvePosition(e.entityId,s,e.numEntityId),o()},n=()=>{this._valveDragPos=null,o()};i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",n)}:void 0;return G`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${o?"valve-interactive":""}"
        ...
        ${t>0?G`<path d="${s(210,n,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:K}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return q``;const o=(t?s.on:s.off)??"none";return"none"===o?q``:st(o,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i,s){return Xi(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return q`
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        </div>`:K,g=void 0!==s?.brightness,u=!!s?.colorModes?.length,v=u&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=u&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=g&&r?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,x=y?.attributes?.effect_list??[],w=y?.attributes?.effect??null,_=g?q`
      <div class="ts-lower-section ts-lower-dimmer" @click=${e=>e.stopPropagation()}>
        ...
        `:K}
        ${et(x,w,e=>this.hass.callService("light","turn_on",{entity_id:s.entityId,effect:e}))}
      </div>
    `:K,k=o?q`
    ...
    `:K;return p.length||g||o||a||n||C.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${ke(p)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?Xi(a,e[0]):q`<div class="tile-row">${e.map(e=>Xi(a,e))}</div>`)}
        </div>`}const y=e.area??"",x=this._tileAccent(e,y);return q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${ke(p)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===f?Gi(this._buildTileCtx(e,s,x),b):"light-control"===f?Qi(this._buildTileCtx(e,s,x)):"climate-control"===f?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return Ke(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(o.states[r.entity_id]?.state??"")||null;return q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("presets")&&a.presetModes.length?q`<div class="trv-presets">${a.presetModes.map(t=>q`
        <button class="trv-preset-btn ${a.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(a.entityId,t)}>${(tt[t]??"")+t}</button>`)}
      </div>`:K}
    </div>`}(this._buildTileCtx(e,s,x)):"cover-control"===f?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=o.position??("open"===o.state?100:0),n="opening"===o.state||"closing"===o.state,r=Math.ceil(a/100*it.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${it.map((e,t)=>G`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<r?"0.85":"0.1"}"/>`)}
        </svg>
        ${n&&e.showEl("moving_label")?q`<span class="ts-cover-state">${"opening"===o.state?"▲ Opening…":"▼ Closing…"}</span>`:K}
      </div>`:K}
    ...
    </div>`}(this._buildTileCtx(e,s,x)):"sensor-card"===f?function(e){const{device:t,accent:i,online:s,hass:o,config:a}=e;let n;for(const e of Ui)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=o.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const r=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return t&&qi.includes(t.attributes?.device_class??"")});if(!n&&!r)return Ke(t,s,"ts-sensor","No sensor");if(n){const r=o.states[n.entity_id],l=parseFloat(r?.state??""),c=r?.attributes?.unit_of_measurement??"",d=r?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const h=e.getGraphPoints(n.entity_id,p);let g=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const u=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return q`
      ...
      </div>`}const l=o.states[r.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",h=c?"#f87171":"var(--sc-online-color)",g=l?.last_changed?e.timeAgo(l.last_changed):"";return q`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${Ve(t,s)}
        <span class="ts-sensor-dc">${d}</span>
    ...
    </div>`}(this._buildTileCtx(e,s,x)):"input-control"===f?rt(this._buildTileCtx(e,s,x)):"scene-button"===f?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),n=o.device_styles?.[t.device_id],r=st(n?.tile_icon??"pulse",!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      ${e.showEl("icon")?q`<div class="ts-scene-icon-wrap">${r}</div>`:K}
    ...
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(ts._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return q``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return q``;const o=s.reduce((e,t)=>e+(this._getPower(t)??0),0),a=s.filter(e=>this._isOnline(e)).length,n=zi(this._config,this._getActiveView()??void 0),r=this._config.area_styles?.Favourites?.tile_style;return q`
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._config.area_styles?.[t]?.header_chips:void 0,s=void 0!==i?new Set(i):void 0!==this._config.area_header_chips?new Set(this._config.area_header_chips):new Set(li),o=e=>s.has(e),a={},n=(e,t)=>{a[e]||(a[e]={sum:0,count:0}),a[e].sum+=t,a[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",a=ri.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));a&&o(a.key)&&n(a.key,i)}const r=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",l=[];for(const t of ri){if("energy"===t.key&&o("energy")&&"total"!==r){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,r);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){a.energy&&l.push({key:"energy",label:t.label,value:this._formatAreaChip("energy",a.energy.sum)});continue}if(s||a.energy){const e="today"===r?"Today":"week"===r?"Week":"Month";l.push({key:"energy",label:e,value:s?jt(i):"…"})}continue}const i=a[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;l.push({key:t.key,label:t.label,value:this._formatAreaChip(t.key,s)})}return l}_areaChipDeviceValues(e,t,i){const s=ri.find(e=>e.key===t);if(!s)return[];if("energy"===t){const t=(i?this._config.area_styles?.[i]?.energy_period:void 0)??this._config.energy_period??"total";if("total"!==t){const i=[];for(const s of e){let e=0,o=!1;for(const i of this._energyEntitiesFor(s)){const s=this._periodEnergyValue(i,t);null!=s.kwh&&(e+=s.kwh,o=!0)}o&&i.push({name:s.name,value:e})}if(i.length)return i.sort((e,t)=>t.value-e.value)}}const o=[];for(const t of e){let e=0,i=0;for(const o of t.entities){if("sensor"!==o.domain)continue;const t=this.hass.states[o.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const a=parseFloat(t.state);if(isNaN(a))continue;const n=t.attributes.device_class??"";(s.dc===n||"rssi"===s.key&&("signal_strength"===n||o.entity_id.includes("_rssi")))&&(e+=a,i++)}i&&o.push({name:t.name,value:"sum"===s.agg?e:e/i})}return o.sort((e,t)=>t.value-e.value)}_formatAreaChip(e,t){switch(e){case"power":return Nt(t);case"energy":return jt(t);case"voltage":return Ht(t);case"current":return Wt(t);case"temperature":return Ut(t);case"humidity":return Xt(t);case"co2":return Zt(t);case"illuminance":return Yt(t);case"battery":return Jt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_renderCollapseAll(e){const t=e.every(e=>this._closedAreas.has(e));return q`
      ...
      <div class="area-section ${s?"closed":""} ${a?.bg_image&&"ambient"===a.bg_image_mode?"area-bg-ambient":""}" style=${ke(r)}>
        ...
        ${(()=>{const s=this._areaChipOpen;if(!s||!s.startsWith(`${e}::`))return K;const o=s.slice(e.length+2),a=this._areaChipDeviceValues(t,o,i);if(!a.length)return K;const n=ri.find(e=>e.key===o);return q`
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${ke(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l&&n.size>0&&!1!==this._config.show_collapse_all?q`<div class="rooms-toolbar">${this._renderCollapseAll([...n.keys()])}</div>`:K}
    ...
    `;return m}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=function(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const a of e){const e=[],n=[];if(Di(a,t)){const o=Pi(a,t);o.length&&(e.push("alert"),n.push(...o));const r=Fi(a,t);null!==r&&r<=s&&(e.push("battery"),n.push(`battery ${Math.round(r)}%`));const l=Bi(a,t,i)?Ni(a,t,i):null;l&&(e.push("update"),n.push(`update → ${l.next}`))}else e.push("offline"),n.push("offline");e.length&&o.push({device:a,kinds:e,detail:n})}const a={offline:0,alert:1,battery:2,update:3},n=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>n(e)-n(t)||e.device.name.localeCompare(t.device.name))}(e,this.hass.states,{batteryBelow:this._config.attention_battery,includeBeta:this._config.include_beta_updates}),i=!1===this._config.show_firmware_summary?[]:Hi(e),s=i.length>1;if(!t.length&&!s)return q``;const o={offline:"○",alert:"▲",battery:"▮",update:"↑"},a=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t));return q`
      <div class="attention">
    ...
    `],e([ve({attribute:!1})],as.prototype,"hass",void 0),e([ve({type:Boolean})],as.prototype,"preview",void 0),e([fe()],as.prototype,"_config",void 0),e([fe()],as.prototype,"_closedAreas",void 0),e([fe()],as.prototype,"_areaChipOpen",void 0),e([fe()],as.prototype,"_graphData",void 0),e([fe()],as.prototype,"_periodEnergy",void 0),e([fe()],as.prototype,"_periodEnergyErrAt",void 0),e([fe()],as.prototype,"_valveDragPos",void 0),e([fe()],as.prototype,"_trvDragTemp",void 0),e([fe()],as.prototype,"_cloudDetailOpen",void 0),e([fe()],as.prototype,"_detailDevice",void 0),e([fe()],as.prototype,"_detailHistoryRange",void 0),e([fe()],as.prototype,"_activeViewId",void 0),e([fe()],as.prototype,"_delegateNoticeDismissed",void 0),e([fe()],as.prototype,"_attentionOpen",void 0),as=ts=e([he("ha-device-dashboard")],as);const ns=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),ns(e,t);return!0},rs=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},ls=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),ps(t)}};function cs(e){void 0!==this._$AN?(rs(this),this._$AM=e,ls(this)):this._$AM=e}function ds(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)ns(s[e],!1),rs(s[e]);else null!=s&&(ns(s,!1),rs(s));else ns(this,e)}const ps=e=>{e.type==be&&(e._$AP??=ds,e._$AQ??=cs)};class hs extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),ls(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ns(this,e),rs(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const gs=new WeakMap,us=ye(class extends hs{render(e){return K}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),K}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=gs.get(t);void 0===i&&(i=new WeakMap,gs.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?gs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),vs=ye(class extends xe{constructor(){super(...arguments),this.key=K}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(ze(e),this.key=t),i}}),fs={kind:"global"};function ms(e,t){switch(t){case"tile":return!0;case"container":return"global"===e.kind||"view"===e.kind||"room"===e.kind;case"chrome":return"global"===e.kind||"view"===e.kind}}function bs(e){switch(e.kind){case"global":return"global";case"view":return`view:${e.id}`;case"room":return`room:${e.name}`;case"type":return`type:${e.profile}`;case"device":return`device:${e.id}`}}function ys(e){let t=(e??"").trim();if(t&&(t=t.replace(/^[a-z]+:\/\//i,""),t=t.split("/")[0].split(":")[0],/^[a-z0-9][a-z0-9.-]+\.[a-z]{2,}$/i.test(t)))return`https://${t}`}function xs(e,t,i=!1){if(e){if(/^https?:\/\//i.test(e))return e;if(e.startsWith("images/")){return"https://control.shelly.cloud/"+(i?e.replace(/_m\.(jpe?g|png)$/i,"_l.$1"):e)}if(e.startsWith("assets/")){const s=i?e.replace(/thumb_(?=[^/]+$)/,""):e;return`${t.replace(/\/$/,"")}/shelly_files/${s}`}}}function ws(e){return!!e&&e.startsWith("images/room_def/")}function _s(e){const t=/^([0-9a-f]{12})(?:_\d+)?$/i.exec(e??"");return t?t[1].toLowerCase():void 0}const ks=e=>e.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\s+/g," ").trim();function As(e,t){const i=new Map;for(const e of t){const t=new Set;for(const[i,s]of e.connections??[])"mac"===i&&t.add(s.replace(/[:-]/g,"").toLowerCase());for(const[i,s]of e.identifiers??[])"shelly"===i&&/^[0-9a-f]{12}$/i.test(s)&&t.add(s.toLowerCase());for(const s of t){const t=i.get(s)??[];t.push(e.id),i.set(s,t)}}const s=new Map;for(const t of e){const e=_s(t.id);if(!e)continue;const o=i.get(e);o?.length&&s.set(e,o)}return s}const Ss=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"},{id:"lights",label:"What counts as a light"}]},{id:"design",label:"Design",icon:"◈",sections:[{id:"design-scope",label:"Scope"},{id:"design-panel",label:"Controls for the selected scope"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"theme",label:"Colour theme"},{id:"content",label:"Chips & metrics"},{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours"},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],Cs=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","For blocks there is one extra rung: a saved custom style's own layout sits above the room and card-wide values, since choosing a saved look is more deliberate than leaving the global default in place.","The editor flags the common cases for you — see Conflicts."]},{id:"content-defaults",title:"Global defaults vs. per-room overrides",body:["The **Chips & metrics** section at the top of Card & Theme sets three things card-wide: which chips each room header shows, which window the energy readout totals (Total / Today / Week / Month), and which sensor chips appear on tiles. Treat it as the first stop — decide what data is on show, then style it.","These are *defaults*. Every room and device inherits them, but any room or device can override any of them — in Per-room styling or Device styling — and the moment it does, it stops listening to the global. A global toggle only moves scopes that are still inheriting: turning a chip on globally will **not** turn it on in a room that has set its own chips, and turning it off will not turn it off there.",'Each picker tells you which state it is in. **Inheriting from …** means a global change still reaches it; **Custom selection** means it is pinned to its own value. Setting a room or device to an empty selection is itself a custom choice ("show none"), not the same as inheriting.',"To hand control back to the global default, use that scope's reset — `↺ Default` for room header chips, `↺ Inherit` for the chip pickers. Room header chips resolve room → global → built-in; energy and sensor chips also allow a per-device override (and, for sensor chips, a per-type one) in front of the room."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:["**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…). **Sensor chips** choose which measurements appear as little pills, in any style.","The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","The Device styling panel goes further and narrows to the device in front of you — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['A Shelly i3, i4 or UNI is a wall switch: it reports presses and controls nothing by itself. Nothing in Home Assistant can make it emit a press, so the card cannot "push" a channel for you.',"What it can do is run the same thing the physical button runs. Give a channel an action and its row becomes a key: tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.","A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to.","Channels you have not wired stay as read-only status rows showing the last event and when it fired, so a half-configured switch shows both."]},{id:"lights",title:"What counts as a light",body:["The **Lights** header chip counts `light` entities that are on. A relay or plug wired to a lamp is a `switch` as far as Home Assistant is concerned — it has no way to know what is on the other end of the wire, and neither does the card.","You do. Label those devices in Home Assistant (Settings → Areas & labels), then tick the label under **Header → What counts as a light**. Every `switch` on a labelled device is counted from then on. The picker only offers labels that exist on your devices, with how many carry each.","For the stragglers a label does not cover, name entities directly in the same panel. A device caught by both routes is still counted once."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","**Follow HA** is the exception: instead of a palette it points every colour at Home Assistant’s own theme variables, so the card matches whatever HA theme is active and follows it into light or dark. Available per card, per view and per room like any other theme.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is.","A **view** and a **room** can each take a theme of their own, resolved room → view → card. A view theme repaints the whole card, header included, while that view is showing, and outranks the colours in `style`. A room theme repaints what the room contains — its block background, tiles, text, accent and its own header — but not the card header, which no room encloses; the room's individual colour fields still override it key by key."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running.",'**Beta firmware does not count as an update.** A Shelly exposes a `beta_firmware` entity that is on nearly permanently — on one real fleet that was 21 of 25 "available updates". Turn on `include_beta_updates` if you actually run betas.']},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],Es=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"cloud-import",title:"Import your Shelly app setup",body:["Coming from the Shelly app? The card can pull each room's photo and the official product image for every device from your Shelly Cloud account. The auth key is used for the one fetch and never saved; imported images stay hosted on Shelly's cloud."],steps:["Get your key: control.shelly.cloud → user settings → Authorization cloud key. Note the server shown next to it.","Rooms & devices → Import from Shelly Cloud → paste both → Fetch my Shelly setup.","Pair any cloud rooms that did not auto-match with a room here (name matching ignores accents).","Pick what to import — room photos, product images on tiles, full-size vs thumbnails — and Apply.","A custom room photo's cloud URL is unlisted but not private. Swap in a /local/… photo later if that matters.","To invalidate a key you have shared or leaked, change your Shelly account password — the key only rotates with it."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Card & Theme → scroll to the room picker at the bottom.","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["This mirrors the physical button rather than driving it — both paths keep working independently."],steps:["Device styling → pick the switch → Input actions.",'For a channel, choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["Card & Theme → Colour theme (also under ◆ Defaults).","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Card & Theme → Tiles → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],Ts=e=>Math.random()<e;const Is=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},zs=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},$s=(e,t)=>{const[i,s]=[zs(e),zs(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function Os(e,t,i,s,o,a){let n=i;for(let i=0;i<40;i++){const i=Is(e,t,n);if($s(i,s)>=o)return i;if(n+=a?2:-2,n>98||n<2)break}return Is(e,t,a?98:2)}var Ds;const Ms=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Rs=!1;const Ps=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Bs=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Fs=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Ls=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Ns=Ds=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._viewDeleteArmed=null,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewIds=new Set,this._openSections={rooms:!0,theme:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._designScope=fs,this._designGroupBy="room",this._designOpenGroups=new Set,this._designScopeLoaded=!1,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._sciServer="",this._sciKey="",this._sciBusy=!1,this._sciError="",this._sciDone="",this._sciData=null,this._sciRoomMap={},this._sciOptRooms=!0,this._sciOptDevices=!0,this._sciOptStock=!1,this._sciOptFull=!0,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;t?.tab&&t.section&&t.flash&&this._gotoControl(t.tab,t.section,t.flash)},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=oi(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=Ss.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1,this._openSections={...this._openSections,[t]:!0},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(oi(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </div>`}_renderHelpPanel(){const e=this._helpFilter.trim().toLowerCase(),t=t=>!e||t.title.toLowerCase().includes(e)||t.body.some(t=>t.toLowerCase().includes(e))||(t.steps??[]).some(t=>t.toLowerCase().includes(e)),i=Cs.filter(t),s=Es.filter(t);return q`
      ...
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?nt.map(i=>{const s=(e.currentValue??"none")===i.value,o="none"!==i.value?ot[i.value]?.[e.isOn?"on":"off"]??t:t;return q`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?q`<span class="icon-grid-none">—</span>`:st(i.value,e.isOn,`--ent-spd:1;color:${o};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):K}
      </div>`}_iconPicker(e,t,i,s){const o="#f4601e",a=t?ot[t]?.[i?"on":"off"]??o:o,n=this._iconPickerState?.onSelect===s;return q`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          ${t?st(t,i,`--ent-spd:1;color:${a}`,"icon-preview-sm"):q`<span class="icon-cell-none">—</span>`}
        </button>
      ...
      </span>`}_chipPicker(e,t,i,s,o){const a=t??[],n=void 0!==e,r=t=>!o||o.has(t)||(e??[]).includes(t),l=Ps.map(e=>({...e,items:e.items.filter(e=>r(e.key))})).filter(e=>e.items.length),c=Ps.flatMap(e=>e.items.map(e=>e.key)).filter(r),d=new Set(n?e:a.length?a:c);return q`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${i?q`<button class="color-reset" @click=${n}>↺</button>`:K}
      ...
      ${e.favorites?.length?(()=>{const t=Ds.FAV_ROW_KEY,i=(e.favorites??[]).map(e=>a.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),o=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return q`
          ...
          ${s?q`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id,a=t.area?q`<span class="fav-dev-area">${t.area}</span>`:K;return q`
      ...
      ${this._xcDraft?q`
        ...
        </div>`:K}`,o=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):K;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",o,s)}_renderCheckDropdown(e,t,i,s,o,a){const n=this._openDiscDropdown===e,r=new Set(s),l=r.size;return q`
      <div class="field">
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const o=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${us(e=>e?.focus())}/>`:q`<span class="pill ${e===o?"on":""}" @click=${()=>s(o)}>
                ${i.label||t}
      ...
      ${l?q`
        ...
        </div>`:K}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,o=s?e.find(e=>e.device_id===s):null,a=o?Mt(o):null,n=this._styleScope,r=a?e.filter(e=>Mt(e).type===a.type).length:0,l=a?yt[a.type]||a.type:"",c=e=>q`
      ...
      <div class="dev-styling-tab">
        ...
        ${o&&a?q`
          ...
          ${"device"===n?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&o?wt(a.type,o):void 0)??"default";return q`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",xt[a.type],e=>this._setProfileStyle(a.type,{tile_style:e}),e=>this._setProfileStyle(a.type,{power_monitor_variant:e}),e.show_graphs,e=>this._setProfileStyle(a.type,{show_graphs:e}))}
          </div>
          ${"power-monitor"===i?K:q`
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>Bs.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>r(e,t,i))}
              ${e.length<Ds.ROW_MAX?q`<span class="lay-slot">drop here</span>`:K}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=_t[e];if(!s)return q``;return q`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._allDevices().find(t=>t.device_id===e),s=i?xi(i,this.hass?.states??{}):null,o=!!s&&!this._devPanelAll,a=Bs.map(e=>e.id),n=this._config.tile_layout??a,r=At(n),l=At(t.tile_layout)??null,c=t.entity_animations??{},d=i=>{const s=(l??r).includes(i),o=function(e,t,i,s){const o=kt(e).map(e=>[...e]);if(!i)return o.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(o.some(e=>e.includes(t)))return o;const a=e=>{const t=s.indexOf(e);return t<0?s.length:t},n=o.findIndex(e=>a(e[0])>a(t));return o.splice(n<0?o.length:n,0,[t]),o}(t.tile_layout??n,i,!s,a),c=JSON.stringify(o)===JSON.stringify(kt(n));this._setDeviceStyle(e,{tile_layout:c?void 0:o})},p=(t,i,s)=>{const o={...c[t]??{}};if("speed"===i){const e=Number(s);1===e?delete o.speed:o.speed=e}else"none"===s?delete o[i]:o[i]=s;const a={...c,[t]:o};o.on||o.off||o.speed||delete a[t],this._setDeviceStyle(e,{entity_animations:Object.keys(a).length?a:void 0})},h=this._allDevices().find(t=>t.device_id===e),g=h?Mt(h):null,u=g?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control",generic:"scene-button"}[g.type]:void 0,v=t.tile_style,f=t.power_monitor_variant??"big-number",m=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${u&&!v?q`<span class="dev-style-hint">Recommended: ${u}</span>`:K}
          ${v?q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:K}
        </div>
        ${this._renderTileStylePicker(v,f,u,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}),t.show_graphs,t=>this._setDeviceStyle(e,{show_graphs:t}))}
      ...
      <div class="dev-style-panel">
        ...
        <div class="field" style="margin-bottom:6px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
            Type
            ${h?.model?q`<span class="dev-style-hint">${h.model}</span>`:K}
            ${t.profile?q`<button class="color-reset"
              @click=${()=>this._setDeviceStyle(e,{profile:void 0})}>↺ auto</button>`:K}
          </div>
          <select class="inline-text" style="width:100%"
        ...
        <div class="color-row">
          ...
          ${t.color?q`<button class="color-reset"
            @click=${()=>this._setDeviceStyle(e,{color:void 0})}>↺</button>`:K}
        </div>
        ...
        ${(()=>{const i=h?Mt(h):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&h?wt(i.type,h):void 0)??this._config.tile_style;return"power-monitor"===this._baseStyleOf(a)||o&&!s.hasGraphs?K:q`
        ...
        ${(()=>{const i=h?Mt(h):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&h?wt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(a);return c&&"default"!==c?K:q`
            ...
            ${this._adv(q`
                ...
                <div class="block-toggles">
                  ${Bs.filter(e=>"graph"!==e.id).filter(e=>!o||s.blocks.has(e.id)||(l??r).includes(e.id)).map(e=>{const t=null===l?r.includes(e.id):l.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>d(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ${(()=>{const i=h?mi(h,this.hass.states):[];if(!i.length)return K;const s=t.input_actions??{},o=e=>Array.isArray(e)?e.join(", "):e??"",a=e=>{const t=e.split(",").map(e=>e.trim()).filter(Boolean);return t.length>1?t:t[0]||void 0},n=(t,i)=>{const o={...s};i?o[t]={...o[t]??{action:"none"},...i}:delete o[t],this._setDeviceStyle(e,{input_actions:Object.keys(o).length?o:void 0})};return q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    ${"dim"===t?.hold_action?.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=a(i.target.value);n(e.entityId,{hold_action:{...t?.hold_action??{action:"dim"},entity:s}})}}/>`:K}
                  </div>
                  ${"dim"===t?.hold_action?.action?q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=i.target.value,o="perform-action"===t.double_tap_action.action?{perform_action:s.trim()||void 0}:{entity:a(s)};n(e.entityId,{double_tap_action:{...t.double_tap_action,...o}})}}/>`:K}
                  </div>
                  ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                    <div class="hint" style="margin:-4px 0 8px 34%">
        ...
        ${(()=>{const i=h?.area?this._config.area_styles?.[h.area]?.sensors:void 0;return this._chipPicker(t.sensors,i?.length?i:this._config.sensors,i?.length?`area (${h?.area})`:"global",t=>this._setDeviceStyle(e,{sensors:t}),o?s.chips:void 0)})()}`:K}
      ...
      </div>`}_renderGlobalRoomHeaderChips(){const e=new Set;for(const t of this._allDevices())for(const i of t.entities){if("sensor"!==i.domain)continue;const t=i.attributes?.device_class??"",s=ri.find(e=>e.dc===t||"rssi"===e.key&&("signal_strength"===t||i.entity_id.includes("_rssi")));s&&e.add(s.key)}const t=ri.filter(t=>e.has(t.key));if(!t.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors discovered yet.</div>`;const i=this._config.area_header_chips??li;return q`
      <div class="field" style="margin-bottom:4px">
      ...
      </div>`}_designFamily(e,t,i){return ms(this._designScope,e)?q`
      <div class="dsn-family">
        ...
        <div class="dsn-family off">
          <div class="dsn-family-hdr">${t}</div>
          <div class="hint">${function(e,t){if(!ms(e,t))return"container"===t?"device"===e.kind?"Columns, tile size and gap belong to the grid a tile sits in, not to one device. Set them on the room, the view, or the card.":"A device type is a set of tiles scattered across rooms, so it has no grid of its own. Set these on the room, the view, or the card.":"The header and the card surface belong to the card. Only a view can restyle them, because a view replaces what the whole card shows."}(this._designScope,e)}</div>
        </div>`}_renderDesignScopePicker(){const e=this._config,t=bs(this._designScope),i=function(e,t,i){const s=new Map;for(const o of e){let e,a;if("room"===t)e=o.area||"No room",a={kind:"room",name:o.area??""};else if("type"===t){const t=i(o);e=t,a={kind:"type",profile:t}}else e=o.integration||"unknown",a=void 0;let n=s.get(e);n||(n={label:e,scope:a,devices:[]},s.set(e,n)),n.devices.push({id:o.device_id,name:o.name})}for(const e of s.values())e.devices.sort((e,t)=>e.name.localeCompare(t.name));return[...s.values()].sort((e,t)=>e.label.localeCompare(t.label))}(this._allDevices(),this._designGroupBy,e=>this._deviceProfile(e)),s=["theme","color","tile_style","power_monitor_variant","tile_layout","sensors","show_graphs","elements","energy_period","columns","tile_size","tileGap","tile_gap","style"],o=(i,o,a="")=>q`
      <button class="dsn-chip ${t===bs(i)?"on":""} ${a}"
        @click=${()=>this._setDesignScope(i)}>${o}${(t=>{const i=function(e,t,i){const s=function(e,t){switch(t.kind){case"global":return e;case"view":return(e.views??[]).find(e=>e.id===t.id);case"room":return e.area_styles?.[t.name];case"type":return e.profile_styles?.[t.profile];case"device":return e.device_styles?.[t.id]}}(e,t);return s?i.filter(e=>void 0!==s[e]).length:0}(e,t,s);return i?q`<span class="dsn-count">${i}</span>`:K})(i)}</button>`;return q`
      <div class="dsn-picker">
        <div class="dsn-pick-row">${o(fs,"Global")}</div>

        ${(e.views??[]).length?q`
          <div class="dsn-pick-lbl">Views</div>
          <div class="dsn-pick-row">
            ${(e.views??[]).map(e=>o({kind:"view",id:e.id},e.name||e.id))}
          </div>`:K}
          ...
          ${i.map(e=>{const t=this._designOpenGroups.has(e.label);return q`
              <div class="dsn-group">
                <div class="dsn-group-hdr">
                  ...
                  ${e.scope?o(e.scope,e.label,"grp"):q`<span class="dsn-chip grp browse"
                ...
                ${t?q`
                  <div class="dsn-group-body">
                    ${e.devices.map(e=>o({kind:"device",id:e.id},e.name,"dev"))}
                  </div>`:K}
              </div>`})}
        </div>
      </div>`}_renderDesignPanel(){const e=this._designScope,t=this._scopeValues(),i=this._allDevices(),s=function(e,t){switch(e.kind){case"global":return"Global";case"view":return`View · ${t.viewName(e.id)}`;case"room":return`Room · ${e.name||"No room"}`;case"type":return`Type · ${e.profile}`;case"device":return`Device · ${t.deviceName(e.id)}`}}(e,{viewName:e=>(this._config.views??[]).find(t=>t.id===e)?.name||e,deviceName:e=>i.find(t=>t.device_id===e)?.name??e}),o=["theme","color","tile_style","power_monitor_variant","tile_layout","sensors","show_graphs","elements","energy_period","columns","tile_size","tileGap","tile_gap"].filter(e=>void 0!==t[e]).length;return q`
      <div class="dsn-panel">
        ...
        ${this._designFamily("tile","Tile — device → type → room → view → card",()=>q`
      ${this._designRow("Colour theme","theme","global"===e.kind?q`<div class="hint">Global's palette is the theme picker in Card &amp; Theme — every layer below starts from it.</div>`:this._themeOverrideSelect(t.theme,e=>this._patchScope({theme:e}),"device"===e.kind||"type"===e.kind?"Repaints this tile only — 13 of the 19 palette keys. The card surface and header are not inside a tile.":"Repaints everything this layer contains."))}
      ...
      ${this._designRow("Blocks","tile_layout",this._renderLayoutCanvas(t.tile_layout,kt(this._inheritedFrom("tile_layout")?.value??St.generic),e=>this._patchScope({tile_layout:e})),"Drag to reorder or drop into a row. Blocks only apply to the adaptive tile style.")}

      ${(()=>{const e=t.tile_style??this._inheritedFrom("tile_style")?.value??"default";return _t[e]?this._designRow("Elements","elements",this._renderStyleElementToggles(e,t.elements??{},e=>this._patchScope({elements:e}))):K})()}
      ...
      ${this._designRow("Tile size","tile_size",q`
        ...
        ${this._designFamily("chrome","Card chrome — view → card",()=>{if("global"===e.kind){const e=this._globalSectionDescriptors();return q`
          <div class="hint" style="margin-bottom:6px">
            The card's own header, surface and type. Every layer below inherits these.
          </div>
          ${this._sec("design-chrome-header","◈","rgba(99,102,241,0.1)","#818cf8","Header",K,e.header.body)}
          ${this._sec("design-chrome-card","▢","rgba(129,140,248,0.1)","#818cf8","Card",K,e.card.body)}
          ${this._sec("design-chrome-type","T","rgba(251,191,36,0.1)","#fbbf24","Typography",K,e.typography.body)}`}const i=t.style??{},s=(e,t)=>{const s={...i};void 0===t?delete s[e]:s[e]=t,this._patchScope({style:Object.keys(s).length?s:void 0})},o=(e,t,o)=>q`
        <div class="color-row">
    ...
    `}_renderViewCard(e,t,i,s,o,a,n,r){const l=this._expandedViewIds.has(e.id),c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,n,r),g=n.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return q`
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${ai.map(t=>{const i=e.header_chips??ni,s=i.includes(t.key);return q`
    ...
    `,f=q`
      ...
      </div>`;return{theme:{icon:"🎨",bg:"rgba(244,96,30,0.1)",fg:"#f4601e",label:"Colour theme",badge:K,body:x},header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:K,body:r},lights:{icon:"💡",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"What counts as a light",badge:K,body:m},content:{icon:"◫",bg:"rgba(244,96,30,0.1)",fg:"#f4601e",label:"Chips & metrics",badge:K,body:y},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:K,body:v},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:K,body:f},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:K,body:d},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:K,body:h}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",o=t.tile_bg??"#1c1c1e",a=t.tile_border??"#2a2a30",n=t.tile_hover_bg??"rgba(255,255,255,0.07)",r=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",g=t.header_bg??"#1a1a2e",u=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",_=t.header_stat_power??"#fb923c",k=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,S=t.tile_radius??12,C=t.tile_border_width??1,E=t.header_radius??0,T=y>0?`${y}px solid ${x}`:"none",I=q`
      <div class="style-preview" style="font-family:${k};background:${s}">
        <div class="sp-header"
          ...
          <span class="sp-h-stat" style="color:${_};position:relative;z-index:1">42 W</span>
        </div>
        <div class="sp-tile"
        ...
        <div class="sp-tile"
          style="background:${n};border:${C}px solid ${a};border-radius:${S}px">
          <div class="sp-row" style="color:${l};font-size:${(13*A).toFixed(0)}px">
      ...
      </div>`)}`,a=e.graph_sensors??Tt,n=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],r=(e,t,i)=>{const o=s[e]??i,a=!!s[e];return q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${o}"></div>
      ...
      ${a.filter(e=>!n.find(t=>t.key===e)).length?q`
        ...
        ${a.filter(e=>!n.find(t=>t.key===e)).map(e=>{const t=ei.find(t=>t.key===e);return r(e,t?.label??e,(e=>s[e]??ei.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:K}
      <div class="field" style="margin-top:10px">
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=si(i.key),a=!!ei.find(e=>e.key===o),n=e.graph_sensors??Tt,r=n.some(e=>si(e)===o);return q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=Ss.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(Ss.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};Ss.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],a=()=>[Ds.FAV_ROW_KEY,...new Set(this._allDevices().map(e=>e.area??""))],n="views"===this._tab?{keys:(this._config.views??[]).map(e=>e.id),isOpen:e=>this._expandedViewIds.has(e),setAll:e=>{this._expandedViewIds=e?new Set((this._config.views??[]).map(e=>e.id)):new Set}}:"devices"===this._tab?{keys:a(),isOpen:e=>this._expandedRooms.has(e),setAll:e=>{this._expandedRooms=e?new Set(a()):new Set}}:{keys:o,isOpen:e=>!!this._openSections[e],setAll:e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t}},r=n.keys.length>0&&n.keys.every(n.isOpen),l=n.keys.length>1,c=e.findIndex(e=>e.id===this._tab);return q`
      <div class="shell">
        ...
        <div class="tab-body">
          ${(()=>(({devices:()=>this._renderDevicesTab(),"device-styling":()=>this._renderDeviceStylingTab(),views:()=>this._renderViewsTab(),design:()=>this._renderDesignTab(),"card-theme":()=>this._renderStyleTab(),graphs:()=>this._renderGraphsSensorsTab(),yaml:()=>this._renderYamlTab()}[this._tab]??(()=>this._renderCustomTab(this._tab)))()))()}
        </div>
        ${this._renderIconGridPopover()}
      </div>`}};Ns.FAV_ROW_KEY="★ Favourites",Ns.ROLL_SLOT="Before roll",Ns.ROW_MAX=3,Ns.DRAG_SLOP=6,Ns._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls","sensors","graph_sensors","energy_period","header_chips","area_header_chips"],Ns.styles=[at,r`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Ns.prototype,"hass",void 0),e([fe()],Ns.prototype,"_config",void 0),e([fe()],Ns.prototype,"_tab",void 0),e([fe()],Ns.prototype,"_styleScope",void 0),e([fe()],Ns.prototype,"_cardThemeRoom",void 0),e([fe()],Ns.prototype,"_newStyleName",void 0),e([fe()],Ns.prototype,"_renamingStyle",void 0),e([fe()],Ns.prototype,"_advanced",void 0),e([fe()],Ns.prototype,"_defaultsOpen",void 0),e([fe()],Ns.prototype,"_resetArmed",void 0),e([fe()],Ns.prototype,"_viewDeleteArmed",void 0),e([fe()],Ns.prototype,"_xcPlacement",void 0),e([fe()],Ns.prototype,"_xcRoom",void 0),e([fe()],Ns.prototype,"_xcAdding",void 0),e([fe()],Ns.prototype,"_xcEditIndex",void 0),e([fe()],Ns.prototype,"_xcDraft",void 0),e([fe()],Ns.prototype,"_xcDashboards",void 0),e([fe()],Ns.prototype,"_xcImportCards",void 0),e([fe()],Ns.prototype,"_xcImportLoading",void 0),e([fe()],Ns.prototype,"_palettes",void 0),e([fe()],Ns.prototype,"_paletteNaming",void 0),e([fe()],Ns.prototype,"_paletteName",void 0),e([fe()],Ns.prototype,"_expandedViewIds",void 0),e([fe()],Ns.prototype,"_openSections",void 0),e([fe()],Ns.prototype,"_expandedRooms",void 0),e([fe()],Ns.prototype,"_designScope",void 0),e([fe()],Ns.prototype,"_designGroupBy",void 0),e([fe()],Ns.prototype,"_designOpenGroups",void 0),e([fe()],Ns.prototype,"_expandedRoomStyle",void 0),e([fe()],Ns.prototype,"_selectedDeviceId",void 0),e([fe()],Ns.prototype,"_devPanelAll",void 0),e([fe()],Ns.prototype,"_conflictsOpen",void 0),e([fe()],Ns.prototype,"_flashControl",void 0),e([fe()],Ns.prototype,"_snapshots",void 0),e([fe()],Ns.prototype,"_snapMenu",void 0),e([fe()],Ns.prototype,"_snapName",void 0),e([fe()],Ns.prototype,"_snapMsg",void 0),e([fe()],Ns.prototype,"_helpOpen",void 0),e([fe()],Ns.prototype,"_helpFilter",void 0),e([fe()],Ns.prototype,"_helpTopic",void 0),e([fe()],Ns.prototype,"_rolled",void 0),e([fe()],Ns.prototype,"_deviceSearch",void 0),e([fe()],Ns.prototype,"_styleClipFeedback",void 0),e([fe()],Ns.prototype,"_openDiscDropdown",void 0),e([fe()],Ns.prototype,"_sciServer",void 0),e([fe()],Ns.prototype,"_sciKey",void 0),e([fe()],Ns.prototype,"_sciBusy",void 0),e([fe()],Ns.prototype,"_sciError",void 0),e([fe()],Ns.prototype,"_sciDone",void 0),e([fe()],Ns.prototype,"_sciData",void 0),e([fe()],Ns.prototype,"_sciRoomMap",void 0),e([fe()],Ns.prototype,"_sciOptRooms",void 0),e([fe()],Ns.prototype,"_sciOptDevices",void 0),e([fe()],Ns.prototype,"_sciOptStock",void 0),e([fe()],Ns.prototype,"_sciOptFull",void 0),e([fe()],Ns.prototype,"_iconPickerState",void 0),Ns=Ds=e([he("ha-device-dashboard-editor")],Ns);let js=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??K}};js.styles=r`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],js.prototype,"hass",void 0),e([ve()],js.prototype,"entity",void 0),e([ve({attribute:!1})],js.prototype,"features",void 0),e([fe()],js.prototype,"_el",void 0),js=e([he("hdd-delegated")],js);let Hs=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??K}};Hs.styles=r`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Hs.prototype,"hass",void 0),e([ve({attribute:!1})],Hs.prototype,"config",void 0),e([fe()],Hs.prototype,"_el",void 0),Hs=e([he("hdd-card")],Hs);console.info("%c ha-device-dashboard %c design-panel-2026-09-01e ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard-card"});
