    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Hi}" height="${Hi}" viewBox="0 0 ${Hi} ${Hi}"
            ...
            <foreignObject x="0" y="0" width="${Hi}" height="${Hi}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${Hi}px;height:${Hi}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
