...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ve=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ge=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,n]of Object.entries(t)){if(!n?.device_id)continue;if(n.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const o=(n.platform??"").toLowerCase();if("shelly"!==o)continue;const l=n.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??n.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:o,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:n.area_id,platform:o})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],n=s?.via_device_id;if(!n||!r.has(n)||a.has(n))continue;const o=i[n],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(n).integration;if(!p&&!h)continue;const u=r.get(n);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function et(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const tt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const it="—";function st(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:it}function rt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:it}function at(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:it}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:it}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:it}function lt(e){return!Number.isFinite(e)||e<0?it:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function ct(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":it}function dt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:it}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:it}function ht(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:it}function ut(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:it}function gt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:it}function vt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:it}function ft(e){return Number.isFinite(e)?`${Math.round(e)} %`:it}const bt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],mt=Object.fromEntries(bt.map(e=>[e.key,e.label.split(" ")[0]])),xt={co2:"carbon_dioxide",rssi:"signal_strength"};function yt(e){return xt[e]??e}function wt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(yt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=yt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const kt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],At=["online","offline","power","alerts"];function Ct(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:n}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,u=110,g=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+g*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=u+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),n=u+e*Math.sin(m(i)),o=g*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return Z`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=n.voltage?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${n.voltage.toFixed(0)}</div></div>`:V}
          ${null!=n.current?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${n.current.toFixed(2)}</div></div>`:V}
          ${null!=n.temp?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${n.temp.toFixed(1)}</div></div>`:V}
          ${null!=n.rssi?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${n.rssi}</div></div>`:V}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=n.energy?Z`<span class="ts-hbar-badge">${n.energy.toFixed(2)} kWh</span>`:V}
          ${null!=n.uptime?Z`<span class="ts-hbar-badge">${lt(n.uptime)}</span>`:V}
        </div>
    ...
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():V,f=(e,t,i=!1)=>Z`
    ...
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${o})"/>
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():V;return Z`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?Z`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${st(l.power)}</div>`:V}
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      `:Z``}case"power_bar":return e.renderPowerBar(i);case"badges":return Z`
        <div class="tile-bot">
          ${null!=u?Z`<span class="tile-power">${st(u)}</span>`:V}
      ...
      `;default:return Z``}}const Mt=255;function Ot(e){return Z`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=n.rssi?Z`<div class="ds-signal">Wi-Fi: ${ct(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?Z` · Up ${lt(n.uptime)}`:V}</div>`:V}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,n=r?.attributes?.friendly_name??s.entity_id,o=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(o)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Z`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?V:Z`<span class="ds-channel-power">${st(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?Z`<span class="ds-big-power">${st(s.power)}</span>`:V}
    </div>
    ...
    ${Tt(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/Mt*100);return Z`
    <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,n=s?.last_changed?e.timeAgo(s.last_changed):"";return Z`
              <div class="ds-channel-row">
                ...
                ${n?Z`<span class="ds-ent-age">${n}</span>`:V}
              </div>`})}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${st(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:V}
        ${null!=t.voltage?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:V}
        ...
        ${null!=t.energy?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:V}
        ${null!=t.temp?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${ot(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:V}
      </div>
    </div>`:Z``}(e):V}
    ${!r&&s?Bt(e):V}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?Z`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${ct(r.rssi)} (${r.rssi} dBm)</span></div>`:V}
        ${null!=r.uptime?Z`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${lt(r.uptime)}</span></div>`:V}
        ...
        ${i.length?Z`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:V}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,_=s[0].t,M=s[s.length-1].t,O=M-_||1,B=e=>(e.t-_)/O*a,T=e=>n-4-(e.v-S)/I*(n-8),E=s.map(e=>`${B(e).toFixed(1)},${T(e).toFixed(1)}`).join(" "),R=B(s[0]).toFixed(1),F=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,D=A[A.length-1],P=D%1==0?`${D}`:D.toFixed(1),L=Math.max(...A),N=Math.min(...A);let U=A.indexOf(L),j=A.indexOf(N);U<0&&(U=0),j<0&&(j=0);const H=B(s[U]).toFixed(1),W=T(s[U]).toFixed(1),q=B(s[j]).toFixed(1),X=T(s[j]).toFixed(1),G=m(s[0].t),Y=m((s[0].t+M)/2),K=v/O*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&z-S>0;return Z`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?V:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                `:V}
                ${"bar"!==h&&u?Q`
                  <polygon points="${E} ${a},${n-4} ${R},${n-4}" fill="url(#${F})"/>
                `:V}
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const n=(e.clientX-a.left)*(160/a.width),o=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(o-70,n-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const n=(a-210+360)%360;return n>300?null:Math.round(n/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[n,o]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${n} ${o}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,n=(e=>210+e/100*300)(a),[o,l]=i(n,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return Q`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${t>0?Q`<path d="${s(210,n,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:V}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:n,hasFan:o}=i,l=e.type;if("relay"===l||"plug"===l)return o?Q`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return Z``;const r=(t?s.on:s.off)??"none";return"none"===r?Z``:qe(r,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i,s){return _t(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return Z``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return Z`
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        </div>`:V,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),b=u&&o?Math.max(1,s.brightness??1):0,m=s?.whiteValue??0,x=s?this.hass.states[s.entityId]:null,y=x?.attributes?.effect_list??[],w=x?.attributes?.effect??null,k=u?Z`
    ...
    `:V,z=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),I=z.length>1?Z`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:V;return p.length||u||r||a||n||z.length>1?Z`
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        ...
        ${n?Z`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:V}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let n;for(const e of Ve)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const o=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&Ge.includes(t.attributes?.device_class??"")});if(!n&&!o)return je(t,s,"ts-sensor","No sensor");if(n){const o=r.states[n.entity_id],l=parseFloat(o?.state??""),c=o?.attributes?.unit_of_measurement??"",d=o?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const h=e.getGraphPoints(n.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Z`
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?Z`<span class="fav-chip fav-chip-power">${st(r)}</span>`:V}
          </div>
        </div>
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Z`<span class="area-power">${st(a)}</span>`:V}
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Z``;const t=this._getActiveView()?.id;return Z`
      ...
      </div>`}_set(e,t){if(!this._config)return;const i={...this._config,[e]:t};(""===t||void 0===t||Array.isArray(t)&&0===t.length&&"areas"!==e)&&delete i[e],this._emitConfig(i)}_emitConfig(e){this._config=e,this._pendingConfig=e,null!=this._emitTimer&&clearTimeout(this._emitTimer),this._emitTimer=window.setTimeout(()=>this._flushConfig(),300)}_flushConfig(){null!=this._emitTimer&&(clearTimeout(this._emitTimer),this._emitTimer=null);const e=this._pendingConfig;this._pendingConfig=null,e&&De(this,"config-changed",{config:e})}_emitNow(e){this._config=e,this._pendingConfig=e,this._flushConfig()}_toggleSec(e){this._openSections={...this._openSections,[e]:!this._openSections[e]}}_resetBtn(e,t){return e?Z`<button class="field-reset" title="Reset to default"
          ...
          ${s?Z`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?Z`<span class="fav-dev-area">${t.area}</span>`:V;return Z`
    ...
    `}_renderViewCard(e,t,i,s,r,a,n,o){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,n,o),u=n.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return Z`
      ...
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=Wt.find(t=>t.id===e);if(!t)return V;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Z`
      ...
      </div>`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},r=(e,r,a)=>{const n=t[r]??a;return Z`
        <div class="color-row">
      ...
      ${n("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=Z`
      ...
      ${n("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=Z`
      <div class="field">
    ...
    `,g=Z`
      ...
      <div class="field">
        ...
        `:V}
      </div>`;this._getAreas();const v=t.accent_color??"#f4601e",f=t.card_bg??"#1c1c1e",b=t.tile_bg??"#1c1c1e",m=t.tile_border??"#2a2a30",x=t.tile_hover_bg??"rgba(255,255,255,0.07)",y=t.tile_sensor_bg??"rgba(255,255,255,0.04)",w=t.text_primary??"#e5e7eb",k=t.text_secondary??"#9ca3af",A=t.text_muted??"#6b7280",C=t.online_color??"#4ade80",S=t.offline_color??"#ef4444";t.power_color;const z=t.header_bg??"#1a1a2e",I=t.header_bg2??"#0f3460",_=t.header_text_color??"#ffffff",M=t.header_orb_color??"#3b82f6",O=t.header_title_size??1.1,B=t.header_padding??16,T=t.header_border_width??0,E=t.header_border_color??"#4ade80",R=t.header_stat_online??"#4ade80",F=t.header_stat_power??"#fb923c",D=t.font_family?`'${t.font_family}', sans-serif`:"inherit",P=t.text_size_scale??1,L=t.tile_radius??12,N=t.tile_border_width??1,U=t.header_radius??0,j=T>0?`${T}px solid ${E}`:"none",H=Z`
      <div class="style-preview" style="font-family:${D};background:${f}">
        <div class="sp-header"
          style="background:linear-gradient(135deg,${z},${I});color:${_};border-radius:${U}px;padding:${Math.round(.55*B)}px 12px;border-bottom:${j};position:relative;overflow:hidden">
          <span class="sp-h-orb" style="background:radial-gradient(circle,${M} 0%,transparent 70%)"></span>
          <span class="sp-h-title" style="font-size:${(O*P).toFixed(2)}em;position:relative;z-index:1">${t.header_icon??"⚡"} ${e.title??"Shelly"}</span>
          <span class="sp-h-stat" style="color:${R};position:relative;z-index:1">● 12 on</span>
          <span class="sp-h-stat" style="color:${F};position:relative;z-index:1">42 W</span>
        </div>
        <div class="sp-tile"
      ...
      ${a.filter(e=>!n.find(t=>t.key===e)).length?Z`
        ...
        ${a.filter(e=>!n.find(t=>t.key===e)).map(e=>{const t=bt.find(t=>t.key===e);return o(e,t?.label??e,(e=>s[e]??bt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:V}
            ...
            ${i.items.map(i=>{const s=t.includes(i.key),r=yt(i.key),a=!!bt.find(e=>e.key===r),n=e.graph_sensors??[],o=n.some(e=>yt(e)===r);return Z`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${a?Z`<button class="sensor-graph-btn ${o?"on":""}"
                    ...
                    @click=${e=>{e.stopPropagation();const t=o?n.filter(e=>yt(e)!==r):[...n,r];this._set("graph_sensors",t)}}>∿</button>`:V}
                </div>`})}
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...Pt[t]}}(this._config.style,e))}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=function(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of Lt){const i=Pt[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}(t);return Z`
