...
`;function je(e,t,i="ts-hero-name"){return Z`
    ...
    </div>`}const Ue={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const We=[3,7,11,15,19,23,27];function qe(e,t,i,s){if("none"===e)return Z``;const r=t?"on":"off";return"flame"===e?Z`${Q`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake"===e?Z`${Q`<svg class="${s} ent-icon-snowflake" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?Z`${Q`<svg class="${s} ent-icon-fan ${r}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?Z`${Q`<svg class="${s} ent-icon-pulse ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"wave"===e?Z`${Q`<svg class="${s} ent-icon-wave" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?Z`${Q`<svg class="${s} ent-icon-sun ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?Z`${Q`<svg class="${s} ent-icon-lightning ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?Z`${Q`<svg class="${s} ent-icon-heart ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?Z`${Q`<svg class="${s} ent-icon-bulb ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?Z`${Q`<svg class="${s} ent-icon-leaf ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?Z`${Q`<svg class="${s} ent-icon-flame2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?Z`${Q`<svg class="${s} ent-icon-flame3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake2"===e?Z`${Q`<svg class="${s} ent-icon-snowflake2" style="${i}" viewBox="0 0 20 20">
    <g class="snow-arms" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"snowflake3"===e?Z`${Q`<svg class="${s} ent-icon-snowflake3" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?Z`${Q`<svg class="${s} ent-icon-fan2 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?Z`${Q`<svg class="${s} ent-icon-fan3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?Z`${Q`<svg class="${s} ent-icon-lightning2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?Z`${Q`<svg class="${s} ent-icon-lightning3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?Z`${Q`<svg class="${s} ent-icon-bulb2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?Z`${Q`<svg class="${s} ent-icon-bulb3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water2"===e?Z`${Q`<svg class="${s} ent-icon-water2" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?Z`${Q`<svg class="${s} ent-icon-water3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?Z`${Q`<svg class="${s} ent-icon-sun2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?Z`${Q`<svg class="${s} ent-icon-sun3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?Z`${Q`<svg class="${s} ent-icon-moon2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?Z`${Q`<svg class="${s} ent-icon-moon3 ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?Z`${Q`<svg class="${s} ent-icon-wind ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?Z`${Q`<svg class="${s} ent-icon-wind2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?Z`${Q`<svg class="${s} ent-icon-wind3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?Z`${Q`<svg class="${s} ent-icon-bell ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?Z`${Q`<svg class="${s} ent-icon-bell2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?Z`${Q`<svg class="${s} ent-icon-bell3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?Z`${Q`<svg class="${s} ent-icon-thermometer ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?Z`${Q`<svg class="${s} ent-icon-thermometer2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?Z`${Q`<svg class="${s} ent-icon-thermometer3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?Z`${Q`<svg class="${s} ent-icon-battery ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?Z`${Q`<svg class="${s} ent-icon-battery2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?Z`${Q`<svg class="${s} ent-icon-battery3 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?Z`${Q`<svg class="${s} ent-icon-star ${r}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?Z`${Q`<svg class="${s} ent-icon-star2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?Z`${Q`<svg class="${s} ent-icon-star3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?Z`${Q`<svg class="${s} ent-icon-pulse2 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?Z`${Q`<svg class="${s} ent-icon-pulse3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?Z`${Q`<svg class="${s} ent-icon-wave2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?Z`${Q`<svg class="${s} ent-icon-wave3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?Z`${Q`<svg class="${s} ent-icon-wave4 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?Z`${Q`<svg class="${s} ent-icon-heart2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?Z`${Q`<svg class="${s} ent-icon-leaf2 ${r}" style="${i}" viewBox="0 0 20 20">
...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ve=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ge=["motion","door","window","moisture","smoke","gas"];const Ke=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ye(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,o]of Object.entries(t)){if(!o?.device_id)continue;if(o.hidden_by)continue;const t=a.split(".")[0];if(!Ke.has(t))continue;const n=(o.platform??"").toLowerCase();if("shelly"!==n)continue;const l=o.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===n,c=e.area_id??o.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:n,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==n||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:o.area_id,platform:n})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],o=s?.via_device_id;if(!o||!r.has(o)||a.has(o))continue;const n=i[o],l=s?.configuration_url??"",c=n?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(o).integration;if(!p&&!h)continue;const u=r.get(o);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]},et={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",badges:"Type & gen badges"};function tt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const it={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const st="—";function rt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:st}function at(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:st}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:st}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:st}function lt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:st}function ct(e){return!Number.isFinite(e)||e<0?st:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function dt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":st}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:st}function ht(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:st}function ut(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:st}function gt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:st}function vt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:st}function ft(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:st}function bt(e){return Number.isFinite(e)?`${Math.round(e)} %`:st}const mt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],xt=Object.fromEntries(mt.map(e=>[e.key,e.label.split(" ")[0]])),yt={co2:"carbon_dioxide",rssi:"signal_strength"};function wt(e){return yt[e]??e}function kt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(wt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=wt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const At=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Ct=["online","offline","power","alerts"];function St(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,u=110,g=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+g*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=u+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),o=u+e*Math.sin(m(i)),n=g*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return Z`
    ...
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const b=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=i.max??Math.max(...e),o=r-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/o*(p-2*h),b=e.indexOf(r);v=n(null,b),f=l(r);const m=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),x=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return Q`<defs><linearGradient id="${x}" x1="0" y1="0" x2="0" y2="1">
    ...
    <polyline points="${m}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>
    ${r>s?Q`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${g}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${g}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:V}`})():V;return Z`
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      <div class="ts-spark-bottom">
        ...
        <div class="ts-spark-meta">
          ${null!=n.voltage?Z`<div class="ts-spark-mrow">${n.voltage.toFixed(1)} <b>V</b></div>`:V}
          ${null!=n.current?Z`<div class="ts-spark-mrow">${n.current.toFixed(2)} <b>A</b></div>`:V}
          ${null!=n.energy?Z`<div class="ts-spark-mrow">${n.energy.toFixed(2)} <b>kWh</b></div>`:V}
          ${null!=n.temp?Z`<div class="ts-spark-mrow">${n.temp.toFixed(1)} <b>°C</b></div>`:V}
          ${null!=n.rssi?Z`<div class="ts-spark-mrow">${n.rssi} <b>dBm</b></div>`:V}
        </div>
      </div>
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=o.voltage?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${o.voltage.toFixed(0)}</div></div>`:V}
          ${null!=o.current?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${o.current.toFixed(2)}</div></div>`:V}
          ${null!=o.temp?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${o.temp.toFixed(1)}</div></div>`:V}
          ${null!=o.rssi?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${o.rssi}</div></div>`:V}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=o.energy?Z`<span class="ts-hbar-badge">${o.energy.toFixed(2)} kWh</span>`:V}
          ${null!=o.uptime?Z`<span class="ts-hbar-badge">${ct(o.uptime)}</span>`:V}
        </div>
        ${n?Z`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(n.entityId,i,t)}>${i?"ON":"OFF"}</button>`:V}
      </div>
      ${e.renderTileLowerBody(t,a)}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return Q`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():V,f=(e,t,i=!1)=>Z`
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return Q`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():V;return Z`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        <div class="ts-chips">
          ${null!=n.voltage?Z`<span class="ts-chip">${n.voltage.toFixed(1)} V</span>`:V}
          ${null!=n.current?Z`<span class="ts-chip">${n.current.toFixed(2)} A</span>`:V}
          ${null!=n.energy?Z`<span class="ts-chip">${n.energy.toFixed(2)} kWh</span>`:V}
          ${null!=n.temp?Z`<span class="ts-chip">${n.temp.toFixed(1)} °C</span>`:V}
          ${null!=n.rssi?Z`<span class="ts-chip">${n.rssi} dBm</span>`:V}
        </div>
      ...
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?Z`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${rt(l.power)}</div>`:V}
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Z`
        <div class="ts-light-wheel-wrap">
          <svg width="${_t}" height="${_t}" viewBox="0 0 ${_t} ${_t}"
            class="ts-light-wheel" @click=${e=>{if(!d||!n)return;e.stopPropagation();const t=e.currentTarget,i=t.getBoundingClientRect(),s=i.left+i.width/2,r=i.top+i.height/2,o=e.clientX-s,l=e.clientY-r,c=Math.sqrt(o*o+l*l),p=i.width/2-8;if(c>p+8){const e=t.parentElement;return void(e&&(e.classList.remove("ts-wheel-pulse"),e.offsetWidth,e.classList.add("ts-wheel-pulse")))}const h=(180*Math.atan2(l,o)/Math.PI+90+360)%360,u=Math.min(1,c/p),g=e=>{const t=(e+h/60)%6;return 1-u*Math.max(0,Math.min(t,4-t,1))},v=Math.round(255*g(5)),f=Math.round(255*g(3)),b=Math.round(255*g(1));a.callService("light","turn_on",{entity_id:n.entityId,rgb_color:[v,f,b]})}} style="cursor:crosshair">
            <defs>
              <radialGradient id="${A}">
            ...
            ${k?Q`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${h}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:V}
          </svg>
        </div>`:V}
      ...
      ${null!=l.power?Z`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${rt(l.power)}</div>`:V}
        ...
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${h?Z`<span class="update-dot" title="Firmware update">●</span>`:V}
          </div>
          ${c?Z`
      ...
      `}case"sensors":{if(!g.length)return Z``;const e=g.filter(e=>"primary"===(e.tier??"primary")),t=g.filter(e=>"electrical"===e.tier),i=g.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const a=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return Z`
        ${e.length?Z`
          <div class="tile-stats">
            ${e.map(e=>Z`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?Z`<span class="stat-lbl">${e.ch}</span>`:V}
                ${!e.ch&&e.key&&s.has(e.key)?Z`<span class="stat-lbl">${e.label}</span>`:V}
                ${e.value}
              </span>`)}
          </div>`:V}
        ${t.length?Z`
          <div class="tile-elec-wrap">
            ${[...r.entries()].map(([e,t])=>Z`
              <div class="tile-elec">
                ${e?Z`<span class="stat-lbl">${e}</span>`:V}
                ${t.map((e,t)=>Z`${t>0?Z`<span class="sep">·</span>`:V}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:V}
        ${i.length?Z`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>Z`${t>0?Z`<span class="sep">·</span>`:V}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:V}
      ...
      `:Z``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?Z`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?Z`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:V}
            ${null!=s?Z`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:V}
          </div>
      ...
      `:Z``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Z`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return V;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return Z`
                <div class="virt-row">
      ...
      `:Z``}case"power_bar":return e.renderPowerBar(i);case"badges":return Z`
        <div class="tile-bot">
          ${null!=u?Z`<span class="tile-power">${rt(u)}</span>`:V}
          <div class="tile-badges">
            ${p.map(e=>Z`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?Z`<span class="type-badge type-${s.type}">${s.label}</span>`:V}
            ${A?Z`<span class="gen-badge gen-${s.gen}">${A}</span>`:V}
            ${C?Z`<span class="int-badge-tile">${C}</span>`:V}
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?Z`<span class="ds-chip ds-chip--room">${t.area}</span>`:V}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?Z`<span class="ds-chip">${t.model}</span>`:V}
        ${"other"!==i.gen?Z`<span class="ds-chip">Gen ${i.gen}</span>`:V}
        ${t.ip?Z`<span class="ds-chip">${t.ip}</span>`:V}
      </div>
      ${a?Z`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:V}
      ${null!=o.rssi?Z`<div class="ds-signal">Wi-Fi: ${dt(o.rssi)} (${o.rssi} dBm)${null!=o.uptime?Z` · Up ${ct(o.uptime)}`:V}</div>`:V}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,o=r?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Z`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?V:Z`<span class="ds-channel-power">${rt(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ${t?Z`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:V}
      ${null!=s.power?Z`<span class="ds-big-power">${rt(s.power)}</span>`:V}
    </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?Z`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:V}
      </div>
    </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?Z`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:V}
      </div>
      ${i?.rgbColor?Z`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:V}
    </div>
    ...
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?Z`<span class="ds-chip">${t.hvacAction}</span>`:V}
          ${t.presetMode?Z`<span class="ds-chip">${t.presetMode}</span>`:V}
        </div>
        ${null!=t.valvePosition?Z`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:V}
    ...
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        ${null!=t.position?Z`<div class="ds-cover-pos">Position: ${t.position}%</div>`:V}
    ...
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        ${null!=t.position?Z`<div class="ds-cover-pos">Position: ${t.position}%</div>`:V}
        ${null!=t.temperature?Z`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:V}
        <span class="ds-chip">${t.state}</span>
    ...
    ${r.length?Z`<div class="ds-section ds-alert-row">${r.map(e=>Z`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:V}
        ...
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,o=s?.last_changed?e.timeAgo(s.last_changed):"";return Z`
              <div class="ds-channel-row">
                ...
                ${o?Z`<span class="ds-ent-age">${o}</span>`:V}
              </div>`})}
    ...
    <details class="ds-customize">
      <summary class="ds-cz-summary">⚙ Customise tile${t.customized?Z`<span class="ds-cz-dot" title="This tile has custom visibility"></span>`:V}</summary>
      <div class="ds-cz-body">
        ...
        ${t.customized?Z`<button class="ds-cz-reset" @click=${()=>t.reset()}>↺ Reset to default</button>`:V}
      </div>
    </details>`}(e)}
        </div>
      </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:V}
        ${null!=t.voltage?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${ot(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:V}
        ${null!=t.current?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${nt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:V}
        ${null!=t.energy?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:V}
        ${null!=t.temp?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${lt(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:V}
      </div>
    </div>`:Z``}(e):V}
    ${!r&&s?Bt(e):V}
    ...
    <div class="ds-section">
      ...
      ${r.map(t=>{const s=i.states[t.entity_id],r=s?.attributes?.friendly_name??t.entity_id,a=s?.state??"unknown",o=s?.attributes?.unit_of_measurement??"",n="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===a,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Z`
          <div class="ds-entity-row" @click=${()=>e.fireMoreInfo(t.entity_id)}>
            ...
            ${c?Z`<span class="ds-ent-age">${c}</span>`:V}
            ${n?Z`<button class="tog ${l?"on":"off"}" @click=${i=>{i.stopPropagation(),e.toggle(t.entity_id,l,i)}}>${l?"ON":"OFF"}</button>`:V}
          </div>`})}
    </div>`}(e)}
    ...
    <div class="ds-section">
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?V:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="none"
                ...
                `:V}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=T(e)-t/2,r=B(e),n=o-4-r;return Q`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):Q`
          ...
          ${p?Z`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${G}</span><span>${K}</span><span>now</span>
              </div>
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const r=e=>{const r=this._trvTempFromEvent(e,s,t,i,a);null!=r&&(this._trvDragTemp=r)},n=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(o,l),s.removeEventListener("pointermove",r),s.removeEventListener("pointerup",n)};s.addEventListener("pointermove",r),s.addEventListener("pointerup",n)}}>
        ...
        ${g>210?Q`<path d="${h(210,g,54)}" fill="none" stroke="url(#${y})" stroke-width="8" stroke-linecap="round"/>`:V}
        ${m?Q`<circle cx="${m[0]}" cy="${m[1]}" r="5" fill="white" stroke="${x}" stroke-width="2"/>`:V}
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const o=(e.clientX-a.left)*(160/a.width),n=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(n-70,o-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const o=(a-210+360)%360;return o>300?null:Math.round(o/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[o,n]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${o} ${n}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,o=(e=>210+e/100*300)(a),[n,l]=i(o,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return Q`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${r?Q`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:V}
        <path d="${s(210,510,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${t>0?Q`<path d="${s(210,o,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:V}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:o,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?Q`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
          ...
          <circle cx="10" cy="10" r="2" fill="currentColor"/>
        </svg>`:Q`<svg class="tile-icon tile-icon-relay ${t?"on":""}" viewBox="0 0 20 20">
        <path d="M11 2L4 11h6l-1 7 7-9h-6l1-7z" fill="currentColor"/>
      </svg>`;if("dimmer"===l||"rgb"===l)return Q`<svg class="tile-icon tile-icon-sun ${t?"on":""}" viewBox="0 0 20 20">
        <circle cx="10" cy="10" r="3.5" fill="currentColor"/>
      ...
      </svg>`;if("cover"===l){const e=s??("open"===r?100:"closed"===r?0:50),t="opening"===r||"closing"===r,i=[2,5.5,9,12.5,16],a=Math.ceil(e/100*i.length);return Q`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
        ...
        ${i.map((e,t)=>Q`<rect x="3" y="${e}" width="14" height="1.8" rx="0.5"
          fill="currentColor" opacity="${t<a?"0.85":"0.2"}"/>`)}
      </svg>`}return"climate"===l||"wall_display"===l?Q`<svg class="tile-icon tile-icon-flame ${a?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?Q`<svg class="tile-icon tile-icon-valve ${o?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"energy"===l?Q`<svg class="tile-icon tile-icon-energy" viewBox="0 0 20 20">
        <polyline class="energy-wave" points="1,10 4,6 7,14 10,4 13,14 16,6 19,10"
          fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`:"sensor"===l?Q`<svg class="tile-icon tile-icon-sensor" viewBox="0 0 20 20">
      ...
      </svg>`:"input"===l||"uni"===l?Q`<svg class="tile-icon tile-icon-input ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:Q`<svg class="tile-icon tile-icon-generic" viewBox="0 0 20 20">
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        <div class="metric-list">
          ${r.map(e=>Z`
            <div class="metric-row">
              ...
              ${e.value?Z`<span class="metric-val">${e.value}</span>`:V}
            </div>`)}
        </div>
        ...
        </div>`:V,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),b=u&&n?Math.max(1,s.brightness??1):0,m=s?.whiteValue??0,x=s?this.hass.states[s.entityId]:null,y=x?.attributes?.effect_list??[],w=x?.attributes?.effect??null,k=u?Z`
    ...
    `:V,_=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),z=_.length>1?Z`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:V;return p.length||u||r||a||o||_.length>1?Z`
    ...
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?Z`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:V}
        ${null!=l?Z`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:V}
      </div>
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${We.map((e,t)=>Q`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<n?"0.85":"0.1"}"/>`)}
        </svg>
        ${o?Z`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:V}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let o;for(const e of Ve)if(o=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),o)break;const n=o?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&Ge.includes(t.attributes?.device_class??"")});if(!o&&!n)return He(t,s,"ts-sensor","No sensor");if(o){const n=r.states[o.entity_id],l=parseFloat(n?.state??""),c=n?.attributes?.unit_of_measurement??"",d=n?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(o.entity_id);const h=e.getGraphPoints(o.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===o.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Z`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${g.length?Z`<div class="ts-chips" style="margin-top:6px">
          ${g.map(e=>{const t=r.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return Z`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:V}
      </div>`}const l=r.states[n.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",h=c?"#f87171":"var(--sc-online-color)",u=l?.last_changed?e.timeAgo(l.last_changed):"";return Z`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${je(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      ...
      ${u?Z`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${u}</div>`:V}
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      ${c?Z`<div class="ts-scene-time">${c}</div>`:V}
      ...
      <div class="area-cog-pop" @click=${e=>e.stopPropagation()}>
        ...
        ${s?Z`<button class="acp-reset" @click=${()=>this._setAreaHeaderChips(e,null)}>↺ Reset</button>`:V}
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Z`<span class="area-power">${rt(a)}</span>`:V}
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${Ae(g)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        ${"on"===this._cloudDetailOpen?Z`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            ...
            <div class="cloud-grid">
              ${d.map(e=>Z`<div class="cloud-item">${u(e)}</div>`)}
            </div>
          </div>`:V}
        ${"off"===this._cloudDetailOpen?Z`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            ...
            <div class="cloud-grid">
              ${p.map(e=>Z`<div class="cloud-item">${u(e)}</div>`)}
            </div>
          </div>`:V}
        ${"unavailable"===this._cloudDetailOpen?Z`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            ...
            <div class="cloud-grid">
              ${h.map(e=>Z`<div class="cloud-item">${u(e)}</div>`)}
            </div>
          </div>`:V}
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Z``;const t=this._getActiveView()?.id;return Z`
            ...
            <div class="room-expanded">
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${n&&!c.length?Z`<span class="dev-style-dot"></span>`:V}
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?Z`<span class="fav-dev-area">${t.area}</span>`:V;return Z`
                    <div class="room-device-row ${r?"selected":""}">
                      ${a}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?Z`<span class="dev-style-dot"></span>`:V}
                      <label class="sw">
      ...
      ${l.map(t=>{const i=t||"No Room",a=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),h=e.area_styles?.[t]??{},u=[h.accentColor,h.tileBgColor,h.headerBgColor,h.bgColor].filter(Boolean);return Z`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${a.length?Z`<span class="room-count">${a.length}</span>`:V}
          ...
          ${c?Z`
            <div class="room-expanded">
              ...
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${u.length?Z`<div class="room-swatch-strip">
                    ${u.map(e=>Z`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:V}
                  ${p&&!u.length?Z`<span class="dev-style-dot"></span>`:V}
                  ${p?Z`<button class="color-reset" style="margin-left:auto" @click=${e=>{e.stopPropagation(),this._clearAreaStyle(t)}}>Clear</button>`:V}
            ...
            </div>`:V}`})}`,h=this._selectedDeviceId,u=h?a.find(e=>e.device_id===h):null,g=h&&u?Z`
      ...
      <div class="dev-panel" role="dialog" aria-label="Device style" @click=${e=>e.stopPropagation()}>
        <div class="dev-panel-hdr">
          <span class="dev-panel-title">${u.name}</span>
      ...
      ${g}`}_setDeviceStyle(e,t){const i={...this._config.device_styles?.[e]??{},...t};void 0===i.color&&delete i.color,void 0===i.tile_layout&&delete i.tile_layout,void 0===i.tile_style&&delete i.tile_style,void 0===i.power_monitor_variant&&delete i.power_monitor_variant,void 0===i.tile_icon&&delete i.tile_icon,void 0===i.tile_icon_off&&delete i.tile_icon_off,void 0===i.tile_icon_speed&&delete i.tile_icon_speed,void 0===i.entity_animations&&delete i.entity_animations,void 0===i.sensors&&delete i.sensors;const s={...this._config.device_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("device_styles",Object.keys(s).length?s:void 0)}_renderTileStylePicker(e,t,i,s,r){const a=e??"default",o="power-monitor"===a||!e&&"power-monitor"===i;return Z`
      ...
      ${o?Z`
        ...
        </div>`:V}`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._config.tile_layout??Qt.map(e=>e.id),s=t.tile_layout??null,r=t.entity_animations??{},a=t=>{const r=null===s?i.includes(t):s.includes(t),a=Qt.map(e=>e.id).filter(e=>e===t?!r:null===s?i.includes(e):s.includes(e)),o=a.length===i.length&&a.every(e=>i.includes(e));this._setDeviceStyle(e,{tile_layout:o?void 0:a})},o=(t,i,s)=>{const a={...r[t]??{}};if("speed"===i){const e=Number(s);1===e?delete a.speed:a.speed=e}else"none"===s?delete a[i]:a[i]=s;const o={...r,[t]:a};a.on||a.off||a.speed||delete o[t],this._setDeviceStyle(e,{entity_animations:Object.keys(o).length?o:void 0})},n=this._allDevices().find(t=>t.device_id===e),l=n?tt(n):null,c=l?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[l.type]:void 0,d=t.tile_style,p=t.power_monitor_variant??"big-number",h=Z`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${c&&!d?Z`<span class="dev-style-hint">Recommended: ${c}</span>`:V}
          ${d?Z`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:V}
        </div>
        ${this._renderTileStylePicker(d,p,c,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}))}
      </div>`,u=n?n.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return Z`
      <div class="dev-style-panel">
        ...
        <div class="block-toggles">
          ${Qt.map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Z`<span class="block-tog ${t?"on":""}" @click=${()=>a(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
        ...
        ${this._adv(u.length?Z`
          ...
          ${u.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,a=r[t.entity_id]?.on??"none",n=r[t.entity_id]?.off??"none",l=r[t.entity_id]?.speed??1;return Z`
        ...
        <div class="color-row">
          ...
          ${t[s]?Z`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:V}
      ...
      <div class="rsp-panel">
        ...
        ${r("Tile style")}
        ${this._renderTileStylePicker(t.tile_style,t.power_monitor_variant??"big-number",void 0,t=>this._setAreaStyle(e,"tile_style",t),t=>this._setAreaStyle(e,"power_monitor_variant",t))}

        ${r("Tile appearance")}
        ${i("Accent colour","accentColor","#f4601e")}
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",r=t.buttonSize??"md",a="square"===i||"circle"===i,o="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",n=a?"sm"===r?"3px 5px":"lg"===r?"6px 12px":"4px 8px":"sm"===r?"2px 8px":"lg"===r?"6px 16px":"4px 12px",l="sm"===r?"10px":"lg"===r?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${o};padding:${n};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,u=t.buttonShape||t.buttonVariant||t.buttonSize;return Z`
            <div class="btn-preview">
              ...
              ${u?Z`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:V}
            </div>
            <div class="field">
    ...
    `}_renderViewCard(e,t,i,s,r,a,o,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,o,n),u=o.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return Z`
        ...
        ${l?Z`
          <div class="view-card-body">
              ...
              <div class="view-dev-list">
                ${Ee(o,e=>e.device_id,t=>Z`
                  <label class="view-dev-row">
                    ...
                    ${t.area?Z`<span class="view-dev-area">${t.area}</span>`:V}
                  </label>`)}
              </div>
            </div>
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?Z`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:V}
            </div>`)}
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Z`<button class="color-reset" @click=${()=>g("columns",void 0)}>↺</button>`:V}
            </div>
      ...
      <div class="drag-list">
        ...
        <div class="color-row">
          ...
          ${t[r]?Z`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:V}
        </div>`},a=Z`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?Z`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?Z`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:V}
          </div>
          <div class="pill-grp">
      ...
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[i]?Z`<button class="color-reset" @click=${()=>{const e={...t};delete e[i],this._set("style",e)}}>↺</button>`:V}
        </div>`},n=Z`
      ...
      </div>`,p=e.card_opacity??100,h=e.tile_opacity??100,u=Z`
      ${this._gridBody()}
      <div class="field">
        <div class="field-lbl">Tile size</div>
        <div class="pill-grp">
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?Z`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:V}
        </div>
        ${t.tile_bg_image?Z`
    ...
    `,g=Z`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${e.card_bg_image?Z`<button class="color-reset" @click=${()=>{const e={...this._config};delete e.card_bg_image,delete e.card_bg_image_size,this._emitNow(e)}}>↺</button>`:V}
        </div>
        ${e.card_bg_image?Z`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
      ...
      <div class="style-toolbar">
        ...
        ${this._styleClipFeedback?Z`<span class="clip-feedback">${this._styleClipFeedback}</span>`:V}
      </div>
      ...
      ${this._sec("tiles","⊡","rgba(45,212,191,0.1)","#2dd4bf","Tiles",V,u)}
      ${this._adv(this._sec("card","▢","rgba(129,140,248,0.1)","#818cf8","Card",V,g))}
      ${this._adv(this._sec("colors","◐","rgba(244,96,30,0.12)","#f4601e","Colours",V,l))}
      ${this._adv(this._sec("typography","T","rgba(251,191,36,0.1)","#fbbf24","Typography",V,d))}`}_renderGraphsTab(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},r=Z`
      <div class="field">
      ...
      <div class="tog-row">
        ...
        <div class="color-row">
          ...
          ${a?Z`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:V}
        </div>`},l=Z`
      ...
      ${a.filter(e=>!o.find(t=>t.key===e)).length?Z`
        ...
        ${a.filter(e=>!o.find(t=>t.key===e)).map(e=>{const t=mt.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??mt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:V}
      ...
      ${this._sec("graphtype","∿","rgba(45,212,191,0.1)","#2dd4bf","Graph Type",V,r)}
      ${this._adv(this._sec("graphcolors","◐","rgba(244,96,30,0.12)","#f4601e","Per-sensor Colors",V,l))}
      ${this._adv(this._sec("graphranges","⇕","rgba(251,191,36,0.1)","#fbbf24","Sensor Min / Max",Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):V,p))}`}_renderSensorsTab(){const e=this._config,t=e.sensors??[];return Z`
            ...
            ${i.items.map(i=>{const s=t.includes(i.key),r=wt(i.key),a=!!mt.find(e=>e.key===r),o=e.graph_sensors??[],n=o.some(e=>wt(e)===r);return Z`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  <div class="sensor-item-body">
                    ...
                    ${i.unit?Z`<span class="sensor-unit">${i.unit}</span>`:V}
                  </div>
                  ${a?Z`<button class="sensor-graph-btn ${n?"on":""}"
                    title="${n?"Remove from graphs":"Add to graphs"}"
                    @click=${e=>{e.stopPropagation();const t=n?o.filter(e=>wt(e)!==r):[...o,r];this._set("graph_sensors",t)}}>∿</button>`:V}
                </div>`})}
        ...
        <div class="dp-grid">
          ...
          <div class="dp-group">
            ...
            ${this._pendingTheme?Z`
              ...
              </div>`:"custom"===s?Z`<div class="hint">Custom — your colours don't match a preset.${this._savedTheme?"":" Applying one will offer to save these first."}</div>`:V}
          </div>
