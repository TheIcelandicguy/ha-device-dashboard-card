...
`;function qe(e,t,i="ts-hero-name"){return q`
    ...
    </div>`}function Ve(e,t,i){const s=e.getInputActionLabel(t,i);if(!s)return Z;const r=e.inputHasHold(t,i),o=()=>e.endInputHold();return q`
    <button class="input-act ${r?"holdable":""}"
      ...
      @pointerup=${o} @pointerleave=${o} @pointercancel=${o}
      >${s}</button>`}const Ze={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const Xe=[3,7,11,15,19,23,27];function Qe(e,t,i,s){if("none"===e)return q``;const r=t?"on":"off";return"flame"===e?q`${G`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
...
`,Je=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const et=["temperature","humidity","carbon_dioxide","illuminance","battery"],tt=["motion","door","window","moisture","smoke","gas"];const it=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function st(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,r=i?new Set([...ot,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,o=i&&t.includeDomains?.length?new Set(t.includeDomains):null,a=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!it.has(n))continue;if(a?.has(n))continue;if(o&&!o.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(r?.has(h)&&!s?.has(h))continue;const g=p.device_id;if(!d.has(g)){const e=l[g];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const r=e.area_id??p.area_id,o=r?c[r]?.name:void 0;d.set(g,{device_id:g,name:e.name_by_user??e.name??g,area:o,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const u=d.get(g);"shelly"===h&&(u.isShelly=!0,u.integration="shelly");const v=e.states[t];u.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:g,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const r=l[s],o=i?.configuration_url??"",a=r?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=o&&a&&n(o)===n(a),h=!o&&a&&t.integration===d.get(s).integration;if(!c&&!h)continue;const g=d.get(s);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},g=new Map;for(const e of d.keys())for(const t of h(l[e]))g.has(t)||g.set(t,[]),g.get(t).push(e);const u=new Map,v=e=>{let t=e;for(let e=0;u.has(t)&&e<8;e++)t=u.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of g.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),u.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!pt(e)||"devices"===t&&ht(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function rt(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const ot=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),at=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),nt=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),lt=new Set(["switch","light","cover","climate","valve"]),ct={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function dt(e){return e.entities.filter(e=>"primary"===rt(e)&&!lt.has(e.domain)&&e.domain in ct)}const pt=e=>e.entities.some(e=>"primary"===rt(e)&&at.has(e.domain)),ht=e=>e.entities.some(e=>"primary"===rt(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&nt.has(e.attributes?.device_class??""));const gt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},ut={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function vt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:ut[e]}const ft={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function mt(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function bt(e){const t=mt(e);return t&&t.flat()}const yt={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},xt=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const wt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},kt=["power","temperature","humidity","battery"],_t={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function At(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),o=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||o?"sensor":"input"}else s="input";return s}const Ct=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),St={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=At(e);if(Ct.has(t)){const i=function(e){if(e)for(const t of xt)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:Tt(e.model??""),label:gt[t],integration:e.integration}}},Et={id:"generic",matches:()=>!0,detect:e=>{const t=At(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":gt[t],integration:e.integration}}},zt=[St,Et];function It(e){for(const t of zt)if(t.matches(e))return t.detect(e);return Et.detect(e)}function Tt(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Mt={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Ot(e){return Mt[e.toLowerCase()]??e.toUpperCase().slice(0,6)}const Dt="—";function Rt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Dt}function Bt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Dt}function Pt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Dt}function Ft(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Dt}function Lt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Dt}function Nt(e){return!Number.isFinite(e)||e<0?Dt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ht(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Dt}function jt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Dt}function Ut(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Dt}function Wt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Dt}function $t(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Dt}function qt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Dt}function Gt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Dt}function Vt(e){return Number.isFinite(e)?`${Math.round(e)} %`:Dt}const Zt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Xt=Object.fromEntries(Zt.map(e=>[e.key,e.label.split(" ")[0]])),Qt={co2:"carbon_dioxide",rssi:"signal_strength"};function Yt(e){return Qt[e]??e}function Kt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(Yt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=Yt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Jt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],ei=["online","offline","power","alerts"],ti=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Light",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],ii=["power","energy","voltage","current","temperature"],si=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:ei});function ri(){return{...si,header_chips:[...si.header_chips??[]]}}function oi(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function ai(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function ni(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function li(e,t,i,s){let r=e.trim();const o=t.trim();return o&&r.toLowerCase().startsWith(o.toLowerCase())&&(r=r.slice(o.length).trim()),r||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function ci(e,t){const i=e.entities.filter(oi),s=e.entities.filter(ai),r=new Set,o=[];return i.forEach((i,a)=>{const n=t[i.entity_id],l=ni(i.entity_id),c=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),o=s.find(e=>!r.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return o||(null!=t?s.find(e=>!r.has(e.entity_id)&&ni(e.entity_id)===t):void 0)})(i,l);c&&r.add(c.entity_id);const d=c?t[c.entity_id]:null,p=d?.attributes?.event_type;o.push({entityId:i.entity_id,label:li(n?.attributes?.friendly_name??"",e.name,l,i.entity_id),isOn:"on"===n?.state,isButton:!!c,channel:l??0,lastEvent:p??null,lastChanged:n?.last_changed??null,_sort:l??50+a})}),s.filter(e=>!r.has(e.entity_id)).forEach((i,s)=>{const r=t[i.entity_id],a=ni(i.entity_id),n=r?.state&&"unknown"!==r.state&&"unavailable"!==r.state?r.state:null;o.push({entityId:i.entity_id,label:li(r?.attributes?.friendly_name??"",e.name,a,i.entity_id),isOn:!1,isButton:!0,channel:a??0,lastEvent:r?.attributes?.event_type??null,lastChanged:r?.last_changed??n,_sort:a??50+s})}),o.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}const di=new Set(["power","voltage","current","energy","apparent_power","reactive_power","frequency","power_factor","temperature","humidity","illuminance","co2","battery","rssi"]),pi={select:/_enum_\d+$/i,number:/_number_\d+$/i,button:/_button_\d+$/i,text:/_text_\d+$/i,switch:/_boolean_\d+$/i};function hi(e,t){const i=function(e){const t=new Set;for(const i of e.entities){const e=i.attributes?.device_class??"",s=i.entity_id;if("sensor"===i.domain){if(!e&&(s.endsWith("_ip")||s.endsWith("_ip_address"))){t.add("ip");continue}if(!e&&s.endsWith("_ssid")){t.add("ssid");continue}if(!e&&(s.endsWith("_firmware")||s.endsWith("_fw"))){t.add("fw_version");continue}if(!e&&s.endsWith("_mac")){t.add("mac");continue}"carbon_dioxide"===e?t.add("co2"):"signal_strength"===e||s.includes("rssi")?t.add("rssi"):s.includes("uptime")?t.add("uptime"):["power","apparent_power","reactive_power","power_factor","frequency","energy","voltage","current","temperature","humidity","illuminance","gas","battery"].includes(e)&&t.add(e)}else"binary_sensor"===i.domain&&("door"===e||"window"===e||"opening"===e?t.add("door"):"moisture"===e?t.add("flood"):"heat"===e||s.includes("overtemp")?t.add("overtemp"):"safety"===e||s.includes("overpower")?t.add("overpower"):"connectivity"===e?s.includes("cloud")?t.add("cloud"):s.includes("mqtt")?t.add("mqtt"):s.includes("eth")&&t.add("eth"):["motion","smoke","gas","vibration"].includes(e)&&t.add(e))}return t}(e),s=t=>e.entities.some(e=>e.domain===t),r=t=>e.entities.filter(e=>e.domain===t).length,o=new Set(["name_row","badges"]);i.size&&o.add("sensors");const a=[...i].some(e=>di.has(e));return a&&o.add("graph"),s("light")&&o.add("dimmer"),s("cover")&&o.add("cover_controls"),s("climate")&&o.add("trv_control"),s("valve")&&o.add("valve_controls"),ci(e,t).length&&o.add("input_channels"),r("switch")+r("light")>1&&o.add("relay_channels"),i.has("power")&&o.add("power_bar"),e.entities.some(e=>pi[e.domain]?.test(e.entity_id))&&o.add("virtual_controls"),["lock","media_player","fan","vacuum"].some(s)&&o.add("delegated_controls"),{chips:i,blocks:o,hasEnergy:i.has("energy")||i.has("power"),hasGraphs:a,hasOnOff:["switch","light","cover","valve","fan","lock","climate","binary_sensor"].some(s)}}function gi(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:o,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=o.graph_style?.sensor_ranges??{},d=o.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),r=g+e*Math.sin(b(v)),o=h+e*Math.cos(b(i)),a=g+e*Math.sin(b(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${o.toFixed(2)} ${a.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return q`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=a.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${Nt(a.uptime)}</span>`:Z}
        </div>
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${e.showEl("secondary")?q`
        ...
        ${null!=n.energy?f(n.energyLabel,Bt(n.energy)):Z}
        ${null!=n.temp?f("Temp",`${n.temp.toFixed(1)} °C`):Z}
        ${null!=n.rssi?f("WiFi",`${n.rssi} dBm`):Z}`:Z}
      ${null!=n.uptime&&e.showEl("uptime")?f("Uptime",Nt(n.uptime)):Z}
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ...
        ${e.showEl("uptime")?q`<span class="ts-uptime">${n.uptime?Nt(n.uptime):""}</span>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Z}
    </div>`}(e)}}const ui=140,vi=70;function fi(e){const{device:t,isOn:i,accent:s,online:r,hass:o,profile:a}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==a.type&&"rgb"!==a.type)return q`
      ...
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",g=n.whiteValue??0,u=o.states[n.entityId],v=u?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),r=s-Math.min(e,t,i);let o=0;r>0&&(o=s===e?((t-i)/r+6)%6:s===t?(i-e)/r+2:(e-t)/r+4);const a=0===s?0:r/s,l=(e=>e*Math.PI/180)(60*o-90);return{x:vi+62*a*Math.cos(l),y:vi+62*a*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${ui}" height="${ui}" viewBox="0 0 ${ui} ${ui}"
            ...
            <foreignObject x="0" y="0" width="${ui}" height="${ui}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${ui}px;height:${ui}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${vi}" cy="${vi}" r="${vi}" fill="url(#${_})" opacity="${i?1:.3}"/>
    ...
    </div>`}function mi(e,t){const{device:i,profile:s,config:r,hass:o,online:a}=e,n=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),g=e.getPower(i),u=e.getSensors(i),v=e.getInputChannels(i),f=n?.isOn??!1,m=void 0!==n?.brightness,b=n&&m&&f?Math.max(1,n.brightness??1):0,y=!!n?.colorModes?.length,x=n?.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",w=!!n?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Ot(i.integration);switch(t){case"name_row":{const t=r.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let o;if(s)o=Qe(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;o=t?Qe(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;o=i?Qe(i,!0,"--ent-spd:1","tile-icon"):q``}else o=q``;const p=n?e.renderEntityAnim(n.entityId,f,i.device_id):q``;return q`
        <div class="tile-top">
      ...
      `:q``}case"delegated_controls":{if(!r.delegate_controls)return q``;const e=dt(i);return e.length?q`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>q`
            <hdd-delegated .hass=${o} .entity=${e.entity_id} .features=${ct[e.domain]}></hdd-delegated>
          `)}
      ...
      `;default:return q``}var C}const bi=255;function yi(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=a.rssi?q`<div class="ds-signal">Wi-Fi: ${Ht(a.rssi)} (${a.rssi} dBm)${null!=a.uptime?q` · Up ${Nt(a.uptime)}`:Z}</div>`:Z}
    ...
    ${wi(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return q`
    ...
    ${wi(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return q`
    <div class="ds-section">
    ...
    ${wi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,o=Math.round(r/bi*100);return q`
    <div class="ds-section">
    ...
    ${wi(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return q`
    <div class="ds-section">
    ...
    ${wi(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return q`
    <div class="ds-section">
    ...
    ${wi(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return q`
    <div class="ds-section">
    ...
    ${wi(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return q`${wi(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return q`
    ...
    ${wi(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return q`
    <div class="ds-section">
    ...
    ${wi(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    ${wi(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return q`
    ${t?q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${wi(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    </div>`}function xi(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function wi(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return q`
    ${r&&s?xi(e):Z}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ...
        ${null!=t.voltage?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Pt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:Z}
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ft(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Z}
        ${null!=t.energy?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Bt(t.energy)}</span><span class="ds-sensor-label">${t.energyLabel}</span></div>`:Z}
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Lt(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Z}
      </div>
    </div>`:q``}(e):Z}
    ${!r&&s?xi(e):Z}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),r=t.entities.filter(e=>!s.has(e.entity_id));if(!r.length)return q``;const o=(t,s)=>{const r=i.states[t.entity_id],o=r?.attributes?.friendly_name??t.entity_id,a=r?.state??"unknown",n=r?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===a,d=r?.last_changed?e.timeAgo(r.last_changed):"";return q`
      ...
      </div>`},a=r.filter(e=>"primary"===rt(e)),n=r.filter(e=>"config"===rt(e)),l=r.filter(e=>"diagnostic"===rt(e));return q`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${Ht(r.rssi)} (${r.rssi} dBm)</span></div>`:Z}
        ${null!=r.uptime?q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${Nt(r.uptime)}</span></div>`:Z}
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),E=C.max??Math.max(...A),z=E-S||1,I=s[0].t,T=s[s.length-1].t,M=T-I||1,O=e=>(e.t-I)/M*o,D=e=>a-4-(e.v-S)/z*(a-8),R=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=O(s[0]).toFixed(1),P=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,F=A[A.length-1],L=F%1==0?`${F}`:F.toFixed(1),N=Math.max(...A),H=Math.min(...A);let j=A.indexOf(N),U=A.indexOf(H);j<0&&(j=0),U<0&&(U=0);const W=O(s[j]).toFixed(1),$=D(s[j]).toFixed(1),V=O(s[U]).toFixed(1),X=D(s[U]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+T)/2),K=f/M*o,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&E-S>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Z:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${o} ${a}" preserveAspectRatio="none"
                ...
                `:Z}
                ${"bar"!==h&&u?G`
                  <polygon points="${R} ${o},${a-4} ${B},${a-4}" fill="url(#${P})"/>
                `:Z}
    ...
    `:Z,S=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),E=S.length>1?q`
    ...
    `:Z;return p.length||g||r||o||a||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${_e(l)}
          ...
          ${De(o,e=>e.join("+"),e=>1===e.length?mi(c,e[0]):q`<div class="tile-row">${e.map(e=>mi(c,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return q`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?gi(this._buildTileCtx(e,s,y),m):"light-control"===v?fi(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:r}=e,o=e.getTrv(t);if(!o)return Ge(t,s,"ts-climate","No climate entity");const a="heating"===o.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return q`
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${Xe.map((e,t)=>G`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<n?"0.85":"0.1"}"/>`)}
        </svg>
    ...
    </div>`}(this._buildTileCtx(e,s,y)):"scene-button"===v?function(e){const{device:t,accent:i,online:s,config:r}=e,o=e.getInputChannels(t),a=r.device_styles?.[t.device_id],n=Qe(a?.tile_icon??"pulse",!0,`--ent-spd:${a?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return o.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
    ...
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(ki._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return q``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return q``;const r=s.reduce((e,t)=>e+(this._getPower(t)??0),0),o=s.filter(e=>this._isOnline(e)).length,a=this._config.columns??3,n=this._config.area_styles?.Favourites?.tile_style;return q`
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,r=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(ii),o=e=>r.has(e),a={},n=(e,t)=>{a[e]||(a[e]={sum:0,count:0}),a[e].sum+=t,a[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",r=ti.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));r&&o(r.key)&&n(r.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ti){if("energy"===t.key&&o("energy")&&"total"!==l){let i=0,s=!1,r=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?r=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(r){a.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",a.energy.sum)});continue}if(s||a.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?Bt(i):"…"})}continue}const i=a[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return Rt(t);case"energy":return Bt(t);case"voltage":return Pt(t);case"current":return Ft(t);case"temperature":return Lt(t);case"humidity":return $t(t);case"co2":return Gt(t);case"illuminance":return qt(t);case"battery":return Vt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),r=this._config.area_styles?.[t]?.header_chips,o=void 0!==s?new Set(s):void 0!==r?new Set(r):new Set(ii),a=[];for(const e of ti)i.has(e.key)&&a.push({key:e.key,label:e.label,visible:o.has(e.key)});return a}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",r=ti.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));r&&t.add(r.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,r=(t,s)=>{const r=new Set(i.filter(e=>e.visible).map(e=>e.key));s?r.add(t):r.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>r.has(e)))};return q`
    ...
    `;return m}_renderExtraCards(e){return e?.length?q`
      ...
      </div>`:q``}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return q``;const t=e.filter(e=>dt(e).length>0).length;return t?q`
    ...
    `],e([ve({attribute:!1})],Ci.prototype,"hass",void 0),e([ve({type:Boolean})],Ci.prototype,"preview",void 0),e([fe()],Ci.prototype,"_config",void 0),e([fe()],Ci.prototype,"_closedAreas",void 0),e([fe()],Ci.prototype,"_entityListOpen",void 0),e([fe()],Ci.prototype,"_graphData",void 0),e([fe()],Ci.prototype,"_periodEnergy",void 0),e([fe()],Ci.prototype,"_periodEnergyErrAt",void 0),e([fe()],Ci.prototype,"_valveDragPos",void 0),e([fe()],Ci.prototype,"_trvDragTemp",void 0),e([fe()],Ci.prototype,"_cloudDetailOpen",void 0),e([fe()],Ci.prototype,"_detailDevice",void 0),e([fe()],Ci.prototype,"_detailHistoryRange",void 0),e([fe()],Ci.prototype,"_activeViewId",void 0),e([fe()],Ci.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Ci.prototype,"_tileBlockOverride",void 0),e([fe()],Ci.prototype,"_tileChipOverride",void 0),e([fe()],Ci.prototype,"_areaHeaderOverride",void 0),e([fe()],Ci.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Ci.prototype,"_areaCustomizeOpen",void 0),Ci=ki=e([he("ha-device-dashboard")],Ci);const Si=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Si(e,t);return!0},Ei=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},zi=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Mi(t)}};function Ii(e){void 0!==this._$AN?(Ei(this),this._$AM=e,zi(this)):this._$AM=e}function Ti(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Si(s[e],!1),Ei(s[e]);else null!=s&&(Si(s,!1),Ei(s));else Si(this,e)}const Mi=e=>{e.type==be&&(e._$AP??=Ti,e._$AQ??=Ii)};class Oi extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),zi(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Si(this,e),Ei(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Di=new WeakMap,Ri=ye(class extends Oi{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Di.get(t);void 0===i&&(i=new WeakMap,Di.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Di.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Bi=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Te(e),this.key=t),i}}),Pi=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Fi;const Li=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Ni=!1;const Hi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],ji=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Ui=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Wi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let $i=Fi=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=Kt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of He)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Z}connectedCallback(){super.connectedCallback(),function(){if(Ni||"undefined"==typeof document)return;const e=Li.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),Ni=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;try{if(window.matchMedia("(min-width: 1600px)").matches){const e=s;!1===e.large&&"function"==typeof e._enlarge&&e._enlarge()}}catch{}const o="ha-device-dashboard-editor-fix";if(!r.getElementById(o)){const e=document.createElement("style");e.id=o,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const a=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),o=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(o,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);a(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),a(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),a(o,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return q`
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?Je.map(i=>{const s=(e.currentValue??"none")===i.value,r="none"!==i.value?Ye[i.value]?.[e.isOn?"on":"off"]??t:t;return q`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?q`<span class="icon-grid-none">—</span>`:Qe(i.value,e.isOn,`--ent-spd:1;color:${r};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):Z}
      </div>`}_iconPicker(e,t,i,s){const r="#f4601e",o=t?Ye[t]?.[i?"on":"off"]??r:r,a=this._iconPickerState?.onSelect===s;return q`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          ${t?Qe(t,i,`--ent-spd:1;color:${o}`,"icon-preview-sm"):q`<span class="icon-cell-none">—</span>`}
        </button>
      ...
      </span>`}_chipPicker(e,t,i,s,r){const o=t??[],a=void 0!==e,n=t=>!r||r.has(t)||(e??[]).includes(t),l=Hi.map(e=>({...e,items:e.items.filter(e=>n(e.key))})).filter(e=>e.items.length),c=Hi.flatMap(e=>e.items.map(e=>e.key)).filter(n),d=new Set(a?e:o.length?o:c);return q`
      ...
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?function(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,r]of Object.entries(t)){if(!r?.device_id||r.hidden_by)continue;const t=e.split(".")[0];if(!it.has(t))continue;s.add(t);const o=(r.platform??"").toLowerCase();o&&i.add(o)}return{integrations:[...i].sort((e,t)=>Ot(e).localeCompare(Ot(t))),domains:[...s].sort()}}(this.hass):{integrations:[],domains:[]},r=q`
      <div class="field">
      ...
      ${t?q`
        ...
        ${this._renderCheckDropdown("disc-int","Hide integrations",s.integrations.map(e=>({value:e,label:Ot(e)})),e.exclude_integrations??[],e=>this._set("exclude_integrations",e),"Tick the integrations to drop. The built-in list (phones, browsers, routers…) is always hidden on top of these.")}
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const r=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${Ri(e=>e?.focus())}/>`:q`<span class="pill ${e===r?"on":""}" @click=${()=>s(r)}>
                ${i.label||t}
      ...
      ${a?q`
        ...
        </div>`:Z}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,r=s?e.find(e=>e.device_id===s):null,o=r?It(r):null,a=this._styleScope,n=o?e.filter(e=>It(e).type===o.type).length:0,l=o?gt[o.type]||o.type:"",c=e=>q`
      ...
      <div class="dev-styling-tab">
        ...
        ${r&&o?q`
          ...
          ${"device"===a?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&r?vt(o.type,r):void 0)??"default";return q`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[o.type]??{},t=e.tile_style??(this._config.smart_tile_styles?ut[o.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return q`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",ut[o.type],e=>this._setProfileStyle(o.type,{tile_style:e}),e=>this._setProfileStyle(o.type,{power_monitor_variant:e}))}
          </div>
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>ji.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${r.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>n(e,t,i))}
              ${e.length<Fi.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=ft[e];if(!s)return q``;return q`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._allDevices().find(t=>t.device_id===e),s=i?hi(i,this.hass?.states??{}):null,r=!!s&&!this._devPanelAll,o=ji.map(e=>e.id),a=this._config.tile_layout??o,n=bt(a),l=bt(t.tile_layout)??null,c=t.entity_animations??{},d=i=>{const s=(l??n).includes(i),r=function(e,t,i,s){const r=mt(e).map(e=>[...e]);if(!i)return r.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(r.some(e=>e.includes(t)))return r;const o=e=>{const t=s.indexOf(e);return t<0?s.length:t},a=r.findIndex(e=>o(e[0])>o(t));return r.splice(a<0?r.length:a,0,[t]),r}(t.tile_layout??a,i,!s,o),c=JSON.stringify(r)===JSON.stringify(mt(a));this._setDeviceStyle(e,{tile_layout:c?void 0:r})},p=(t,i,s)=>{const r={...c[t]??{}};if("speed"===i){const e=Number(s);1===e?delete r.speed:r.speed=e}else"none"===s?delete r[i]:r[i]=s;const o={...c,[t]:r};r.on||r.off||r.speed||delete o[t],this._setDeviceStyle(e,{entity_animations:Object.keys(o).length?o:void 0})},h=this._allDevices().find(t=>t.device_id===e),g=h?It(h):null,u=g?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[g.type]:void 0,v=t.tile_style,f=t.power_monitor_variant??"big-number",m=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
      ...
      <div class="dev-style-panel">
        ...
        <div class="field" style="margin-bottom:6px">
          ...
          <select class="inline-text" style="width:100%"
            ...
            <option value="" ?selected=${!t.profile}>Auto${g?` — detected: ${gt[g.type]||g.type||"generic"}`:""}</option>
            ${["relay","plug","dimmer","rgb","climate","cover","valve","energy","sensor","input","uni","wall_display","generic"].map(e=>q`
              <option value=${e} ?selected=${t.profile===e}>${gt[e]||e}</option>`)}
          </select>
        </div>
        ${m}
        <div class="color-row">
        ...
        ${(()=>{const i=h?It(h):null,o=t.tile_style??(this._config.smart_tile_styles&&i&&h?vt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(o);return c&&"default"!==c?Z:q`
            ...
            ${this._adv(q`
                ...
                <div class="block-toggles">
                  ${ji.filter(e=>"graph"!==e.id).filter(e=>!r||s.blocks.has(e.id)||(l??n).includes(e.id)).map(e=>{const t=null===l?n.includes(e.id):l.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>d(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ${(()=>{const i=h?ci(h,this.hass.states):[];if(!i.length)return Z;const s=t.input_actions??{},r=(t,i)=>{const r={...s};i?r[t]={...r[t]??{action:"none"},...i}:delete r[t],this._setDeviceStyle(e,{input_actions:Object.keys(r).length?r:void 0})};return q`
                ...
                ${"perform-action"===i?q`
                  <div style="display:flex;gap:6px;margin:0 0 6px 34%">
                    ...
                    <input type="text" class="inline-text" style="flex:1" placeholder="target entity — optional"
                      .value=${t?.entity??""}
                      @change=${t=>r(e.entityId,{entity:t.target.value.trim()||void 0})}/>
                  </div>`:Z}
                ${"toggle"===i?q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    ${"dim"===t?.hold_action?.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        placeholder=${t?.entity??"light.…"}
                        .value=${t?.hold_action?.entity??""}
                        @change=${i=>{const s=i.target.value.trim();r(e.entityId,{hold_action:{...t?.hold_action??{action:"dim"},entity:s||void 0}})}}/>`:Z}
                  </div>
                  ${"dim"===t?.hold_action?.action?q`
      ...
      </div>`}_renderRoomHeaderChips(e,t){const i=this._allDevices().filter(t=>(t.area??"")===e),s=new Set;for(const e of i)for(const t of e.entities){if("sensor"!==t.domain)continue;const e=t.attributes?.device_class??"",i=ti.find(i=>i.dc===e||"rssi"===i.key&&("signal_strength"===e||t.entity_id.includes("_rssi")));i&&s.add(i.key)}const r=ti.filter(e=>s.has(e.key));if(!r.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors in this room.</div>`;const o=t.header_chips??ii;return q`
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${r.map(t=>{const i=o.includes(t.key);return q`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?o.filter(e=>e!==t.key):[...o,t.key];var r;this._setAreaStyle(e,"header_chips",(r=s).length===ii.length&&ii.every(e=>r.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
    ...
    `}_renderViewCard(e,t,i,s,r,o,a,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,a,n),g=a.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return q`
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${Jt.map(t=>{const i=e.header_chips??ei,s=i.includes(t.key);return q`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],r=e.length===ei.length&&ei.every(t=>e.includes(t));this._set("header_chips",r?void 0:e)}}>${t.label}</span>`})}
          </div>
    ...
    `,u=q`
      ...
      <div class="field">
        ...
        `:Z}
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Z,body:o},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Z,body:g},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Z,body:u},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Z,body:l},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Z,body:d}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",r=t.tile_bg??"#1c1c1e",o=t.tile_border??"#2a2a30",a=t.tile_hover_bg??"rgba(255,255,255,0.07)",n=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",g=t.header_bg??"#1a1a2e",u=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",_=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,C=t.tile_radius??12,S=t.tile_border_width??1,E=t.header_radius??0,z=y>0?`${y}px solid ${x}`:"none",I=q`
      <div class="style-preview" style="font-family:${_};background:${s}">
        <div class="sp-header"
          style="background:linear-gradient(135deg,${g},${u});color:${v};border-radius:${E}px;padding:${Math.round(.55*b)}px 12px;border-bottom:${z};position:relative;overflow:hidden">
      ...
      </div>`)}`,o=e.graph_sensors??kt,a=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const r=s[e]??i,o=!!s[e];return q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
      ...
      ${o.filter(e=>!a.find(t=>t.key===e)).length?q`
        ...
        ${o.filter(e=>!a.find(t=>t.key===e)).map(e=>{const t=Zt.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??Zt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",Zt.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${Zt.map(e=>{const t=o.some(t=>Yt(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?o.filter(t=>Yt(t)!==e.key):[...o,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),r=Yt(i.key),o=!!Zt.find(e=>e.key===r),a=e.graph_sensors??kt,n=a.some(e=>Yt(e)===r);return q`
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...Fe[t]}}(this._config.style,e)),this._set("theme",e)}_onPickTheme(e){const t=this._config.style??{},i=He.some(e=>void 0!==t[e]);i&&"custom"===je(t)?this._pendingTheme=e:this._applyTheme(e)}_applySaved(){this._savedTheme&&(this._set("style",{...this._config.style??{},...this._savedTheme}),this._set("theme","custom"))}_resetLook(){const e=this._config,t={};for(const i of Fi._CONTENT_KEYS)void 0!==e[i]&&(t[i]=e[i]);this._emitNow({type:"custom:ha-device-dashboard",...ri(),...t})}_onResetEverything(){this._resetArmed?(this._resetArmed=!1,this._emitNow({type:"custom:ha-device-dashboard",...ri()})):this._resetArmed=!0}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=je(t),r=!!this._savedTheme&&Object.entries(this._savedTheme).every(([e,i])=>t[e]===i);return q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=Pi.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(Pi.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};Pi.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),r=s[this._tab]??[],o=e=>{if(!r.length)return;const t={...this._openSections};for(const i of r)t[i]=e;this._openSections=t},a=r.length>1;return q`
      <div class="shell">
        <div class="tab-nav">
          ${e.map(e=>q`
      ...
      </div>`}};$i.ROW_MAX=3,$i.DRAG_SLOP=6,$i._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],$i.styles=[Ke,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],$i.prototype,"hass",void 0),e([fe()],$i.prototype,"_config",void 0),e([fe()],$i.prototype,"_tab",void 0),e([fe()],$i.prototype,"_styleScope",void 0),e([fe()],$i.prototype,"_cardThemeRoom",void 0),e([fe()],$i.prototype,"_newStyleName",void 0),e([fe()],$i.prototype,"_renamingStyle",void 0),e([fe()],$i.prototype,"_advanced",void 0),e([fe()],$i.prototype,"_defaultsOpen",void 0),e([fe()],$i.prototype,"_resetArmed",void 0),e([fe()],$i.prototype,"_xcPlacement",void 0),e([fe()],$i.prototype,"_xcRoom",void 0),e([fe()],$i.prototype,"_xcAdding",void 0),e([fe()],$i.prototype,"_xcEditIndex",void 0),e([fe()],$i.prototype,"_xcDraft",void 0),e([fe()],$i.prototype,"_xcDashboards",void 0),e([fe()],$i.prototype,"_xcImportCards",void 0),e([fe()],$i.prototype,"_xcImportLoading",void 0),e([fe()],$i.prototype,"_pendingTheme",void 0),e([fe()],$i.prototype,"_savedTheme",void 0),e([fe()],$i.prototype,"_expandedViewId",void 0),e([fe()],$i.prototype,"_openSections",void 0),e([fe()],$i.prototype,"_expandedRooms",void 0),e([fe()],$i.prototype,"_expandedRoomStyle",void 0),e([fe()],$i.prototype,"_selectedDeviceId",void 0),e([fe()],$i.prototype,"_devPanelAll",void 0),e([fe()],$i.prototype,"_deviceSearch",void 0),e([fe()],$i.prototype,"_styleClipFeedback",void 0),e([fe()],$i.prototype,"_openDiscDropdown",void 0),e([fe()],$i.prototype,"_iconPickerState",void 0),$i=Fi=e([he("ha-device-dashboard-editor")],$i);let qi=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};qi.styles=n`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],qi.prototype,"hass",void 0),e([ve()],qi.prototype,"entity",void 0),e([ve({attribute:!1})],qi.prototype,"features",void 0),e([fe()],qi.prototype,"_el",void 0),qi=e([he("hdd-delegated")],qi);let Gi=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Gi.styles=n`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Gi.prototype,"hass",void 0),e([ve({attribute:!1})],Gi.prototype,"config",void 0),e([fe()],Gi.prototype,"_el",void 0),Gi=e([he("hdd-card")],Gi);console.info("%c ha-device-dashboard %c devpanel-2026-08-20b ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
