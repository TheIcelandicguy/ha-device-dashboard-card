...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Qe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[o,a]of Object.entries(t)){if(!a?.device_id)continue;if(a.hidden_by)continue;const t=o.split(".")[0];if(!Ye.has(t))continue;const n=(a.platform??"").toLowerCase();if("shelly"!==n&&"bthome"!==n)continue;const l=a.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),o=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===n;if("bthome"===n&&!o)continue;const c=e.area_id??a.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:o,integration:n,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==n||(c.isShelly=!0,c.integration="shelly");const d=e.states[o];c.entities.push({entity_id:o,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:a.area_id,platform:n})}const o=new Set;for(const[e,t]of r){if(o.has(e))continue;const s=i[e],a=s?.via_device_id;if(!a||!r.has(a)||o.has(a))continue;const n=i[a],l=s?.configuration_url??"",c=n?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(a).integration;if(!p&&!h)continue;const g=r.get(a);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),o.add(e)}for(const e of o)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function et(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:$e[e]}const tt={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function it(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function st(e){const t=it(e);return t&&t.flat()}const rt={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]},ot=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const at={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},nt=["power","temperature","humidity","battery"],lt={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",badges:"Type & gen badges"};function ct(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),o=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||o?"sensor":"input"}else s="input";const r=new Set(["relay","plug","energy","sensor","input","uni","generic"]);if(e.isShelly&&r.has(s)){const t=function(e){if(e)for(const t of ot)if(t.match.test(e))return t.profile}(e.model);t&&(s=t)}const o=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:o,label:Je[s],integration:e.integration}}const dt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const pt="—";function ht(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:pt}function gt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:pt}function ut(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:pt}function vt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:pt}function ft(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:pt}function bt(e){return!Number.isFinite(e)||e<0?pt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function mt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":pt}function yt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:pt}function xt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:pt}function wt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:pt}function kt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:pt}function At(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:pt}function Ct(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:pt}function St(e){return Number.isFinite(e)?`${Math.round(e)} %`:pt}const _t=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],zt=Object.fromEntries(_t.map(e=>[e.key,e.label.split(" ")[0]])),Ot={co2:"carbon_dioxide",rssi:"signal_strength"};function It(e){return Ot[e]??e}function Mt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(It).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=It(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Tt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Et=["online","offline","power","alerts"];function Bt(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:o,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=o.graph_style?.sensor_ranges??{},d=o.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),o=h+e*Math.cos(m(i)),a=g+e*Math.sin(m(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${o.toFixed(2)} ${a.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return G`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=b-t*f,r=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),o="W"===e.label||"A"===e.label?"left":"right",a=(h+s*("left"===o?-1:1)).toFixed(1),n=(g+8).toFixed(1),l="left"===o?"start":"end";return Z`
    ...
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:r,config:o,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,g=o.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const b=c.length>1?(()=>{const e=c.map(e=>e.v),i=o.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=i.max??Math.max(...e),a=r-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/a*(p-2*h),b=e.indexOf(r);v=n(null,b),f=l(r);const m=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return Z`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a,{skipPowerGraph:!0}):Q}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:r,profile:o}=e,a=e.tileSensors(t),n=e.getPrimarySwitch(t);return G`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        ${e.showEl("secondary")?G`<div class="ts-hbar-side">
          ${null!=a.voltage?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${a.voltage.toFixed(0)}</div></div>`:Q}
          ${null!=a.current?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${a.current.toFixed(2)}</div></div>`:Q}
          ${null!=a.temp?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${a.temp.toFixed(1)}</div></div>`:Q}
          ${null!=a.rssi?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${a.rssi}</div></div>`:Q}
        </div>`:Q}
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=a.energy?G`<span class="ts-hbar-badge">${a.energy.toFixed(2)} kWh</span>`:Q}
          ${null!=a.uptime&&e.showEl("uptime")?G`<span class="ts-hbar-badge">${bt(a.uptime)}</span>`:Q}
        </div>
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a,{skipGraphs:!0}):Q}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:r,config:o,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=o.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=o.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,a=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return Z`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${a} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${a}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():Q;return G`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Q}
    </div>`}(e)}}const Dt=140,Rt=70;function Pt(e){const{device:t,isOn:i,accent:s,online:r,hass:o,profile:a}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return G`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==a.type&&"rgb"!==a.type)return G`
      ...
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",g=n.whiteValue??0,u=o.states[n.entityId],v=u?.attributes??{},f=v.effect_list??[],b=v.effect??"",m=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),r=s-Math.min(e,t,i);let o=0;r>0&&(o=s===e?((t-i)/r+6)%6:s===t?(i-e)/r+2:(e-t)/r+4);const a=0===s?0:r/s,l=(e=>e*Math.PI/180)(60*o-90);return{x:Rt+62*a*Math.cos(l),y:Rt+62*a*Math.sin(l)}})():null,A=`wsat-${t.device_id.replace(/\W/g,"")}`;return G`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
        ...
        <div class="tile-effects">
          ${f.filter(e=>"Off"!==e).map(e=>G`
            <button class="effect-btn ${b===e?"active":""}"
              @click=${()=>o.callService("light","turn_on",{entity_id:n.entityId,effect:b===e?"Off":e})}>${e}</button>`)}
        </div>`:Q}
      ${null!=l.power&&e.showEl("power")?G`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${ht(l.power)}</div>`:Q}
    </div>`}function Ft(e,t){const{device:i,profile:s,config:r,hass:o,online:a}=e,n=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),g=e.getPower(i),u=e.getSensors(i),v=e.getInputChannels(i),f=n?.isOn??!1,b=void 0!==n?.brightness,m=n&&b&&f?Math.max(1,n.brightness??1):0,y=!!n?.colorModes?.length,x=n?.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",w=!!n?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,A="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,C=(S=i.integration,dt[S.toLowerCase()]??S.toUpperCase().slice(0,6));var S,_;switch(t){case"name_row":{const t=r.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let o;if(s)o=qe(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;o=t?qe(t,!0,"--ent-spd:1","tile-icon"):G``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;o=i?qe(i,!0,"--ent-spd:1","tile-icon"):G``}else o=G``;const p=n?e.renderEntityAnim(n.entityId,f,i.device_id):G``;return G`
        <div class="tile-top">
      ...
      `}case"sensors":{if(!u.length)return G``;const e=u.filter(e=>"primary"===(e.tier??"primary")),t=u.filter(e=>"electrical"===e.tier),i=u.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const o=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return G`
        ...
        ${i.length?G`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:Q}<span class="${e.warn?"warn":""}">${o(e)}</span>`)}
          </div>`:Q}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=n?o.states[n.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,r=n?.whiteValue??0;return n&&b?G`
      ...
      `:G``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(o.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?G`
      ...
      `:G``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?G`
        ...
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=o.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id;return G`
      ...
      `:G``}case"power_bar":return e.renderPowerBar(i);case"badges":return G`
        <div class="tile-bot">
          ...
          <div class="tile-badges">
            ...
            ${C?G`<span class="int-badge-tile">${C}</span>`:Q}
            ${i.isShelly&&i.ip&&(_=i.ip,/^10\./.test(_)||/^192\.168\./.test(_)||/^172\.(1[6-9]|2\d|3[01])\./.test(_)||/^169\.254\./.test(_))?G`
    ...
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:r}=e,o=e.getFirmware(t),a=e.tileSensors(t);return G`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${o?G`<div class="ds-fw-update"><span>FW update: ${o.current} → ${o.newVersion}</span></div>`:Q}
      ${null!=a.rssi?G`<div class="ds-signal">Wi-Fi: ${mt(a.rssi)} (${a.rssi} dBm)${null!=a.uptime?G` · Up ${bt(a.uptime)}`:Q}</div>`:Q}
    ...
    ${s.length>1?G`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],o="on"===r?.state,a=r?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return G`
    ...
    ${Ht(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,o=Math.round(r/Lt*100);return G`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      ${s.length?G`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,o=s?.attributes?.friendly_name??t.entity_id,a=s?.last_changed?e.timeAgo(s.last_changed):"";return G`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${o}</span>
                <span class="ds-chip ${r?"ds-chip--on":""}">${r?"ON":"OFF"}</span>
                ${a?G`<span class="ds-ent-age">${a}</span>`:Q}
              </div>`})}
    ...
    ${s.length?G`
      <div class="ds-section">
        ...
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",r=t?.attributes?.unit_of_measurement??"",o=t?.attributes?.friendly_name??e.entity_id;return G`<div class="ds-channel-row"><span class="ds-channel-name">${o}</span><span>${s} ${r}</span></div>`})}
      </div>`:Q}
    ${r.length?G`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${r.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,o=s?.attributes?.friendly_name??t.entity_id;return G`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${o}</span>
    ...
    <div class="ds-section">
      ...
      ${r.map(t=>{const s=i.states[t.entity_id],r=s?.attributes?.friendly_name??t.entity_id,o=s?.state??"unknown",a=s?.attributes?.unit_of_measurement??"",n="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===o,c=s?.last_changed?e.timeAgo(s.last_changed):"";return G`
          <div class="ds-entity-row" @click=${()=>e.fireMoreInfo(t.entity_id)}>
            ...
            <span class="ds-ent-state">${o}${a?` ${a}`:""}</span>
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?G`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Q}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),_=C.max??Math.max(...A),z=_-S||1,O=s[0].t,I=s[s.length-1].t,M=I-O||1,T=e=>(e.t-O)/M*o,E=e=>a-4-(e.v-S)/z*(a-8),B=s.map(e=>`${T(e).toFixed(1)},${E(e).toFixed(1)}`).join(" "),D=T(s[0]).toFixed(1),R=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],F=P%1==0?`${P}`:P.toFixed(1),L=Math.max(...A),N=Math.min(...A);let j=A.indexOf(L),H=A.indexOf(N);j<0&&(j=0),H<0&&(H=0);const U=T(s[j]).toFixed(1),W=E(s[j]).toFixed(1),q=T(s[H]).toFixed(1),X=E(s[H]).toFixed(1),V=m(s[0].t),Y=m((s[0].t+I)/2),K=v/M*o,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&_-S>0;return G`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Q:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${o} ${a}" preserveAspectRatio="none"
                ...
                `:Q}
                ${"bar"!==h&&g?Z`
                  <polygon points="${B} ${o},${a-4} ${D},${a-4}" fill="url(#${R})"/>
                `:Q}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,o/s.length-2),i=T(e)-t/2,r=E(e),n=a-4-r;return Z`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):Z`
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const o=t.getBoundingClientRect();if(!o.width||!o.height)return null;const a=(e.clientX-o.left)*(160/o.width),n=(e.clientY-o.top)*(132/o.height);let l=Math.atan2(n-70,a-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let o=Math.atan2(r-68,s-80)*(180/Math.PI)+90;o<0&&(o+=360);const a=(o-210+360)%360;return a>300?null:Math.round(a/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,o]=i(e,s),[a,n]=i(t,s);return`M ${r} ${o} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${a} ${n}`},r=e.supportsPosition||!!e.numEntityId,o=this._valveDragPos??t,a=(e=>210+e/100*300)(o),[n,l]=i(a,54),c=`hsl(${200+.2*o}, ${40+.55*o}%, ${38+.18*o}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const o=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=o&&this._setValvePosition(e.entityId,o,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return Z`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${t>0?Z`<path d="${s(210,a,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:Q}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:o,valveOpen:a,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?Z`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`;if("cover"===l){const e=s??("open"===r?100:"closed"===r?0:50),t="opening"===r||"closing"===r,i=[2,5.5,9,12.5,16],o=Math.ceil(e/100*i.length);return Z`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
      ...
      </svg>`}return"climate"===l||"wall_display"===l?Z`<svg class="tile-icon tile-icon-flame ${o?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?Z`<svg class="tile-icon tile-icon-valve ${a?"on":""}" viewBox="0 0 20 20">
    ...
    `:Q,_=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),z=_.length>1?G`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:Q;return p.length||g||r||o||a||_.length>1?G`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${Ae(l)}
          ...
          ${Be(o,e=>e.join("+"),e=>1===e.length?Ft(d,e[0]):G`<div class="tile-row">${e.map(e=>Ft(d,e))}</div>`)}
        </div>`}const b=e.area??"",m=this._tileAccent(e,b);return G`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${Ae(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===u?Bt(this._buildTileCtx(e,s,m),f):"light-control"===u?Pt(this._buildTileCtx(e,s,m)):"climate-control"===u?function(e){const{device:t,accent:i,online:s,hass:r}=e,o=e.getTrv(t);if(!o)return He(t,s,"ts-climate","No climate entity");const a="heating"===o.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return G`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ...
        ${e.showEl("heating_badge")?G`<div style="display:flex;align-items:center;gap:6px">
          ${a?G`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:G`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>`:Q}
      </div>
      ${e.showEl("dial")?e.renderTrvDial(o):Q}
      ...
      ${e.showEl("stats")?G`<div class="trv-stat-row">
        ...
        ${null!=o.valvePosition?G`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(o.valvePosition)}%</span></div>`:Q}
        ${null!=l?G`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:Q}
      </div>`:Q}
      ${e.showEl("presets")&&o.presetModes.length?G`<div class="trv-presets">${o.presetModes.map(t=>G`
        <button class="trv-preset-btn ${o.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(o.entityId,t)}>${(Ue[t]??"")+t}</button>`)}
      </div>`:Q}
    </div>`}(this._buildTileCtx(e,s,m)):"cover-control"===u?function(e){const{device:t,accent:i,online:s}=e,r=e.getCover(t);if(!r)return G`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const o=r.position??("open"===r.state?100:0),a="opening"===r.state||"closing"===r.state,n=Math.ceil(o/100*We.length);return G`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-cover-top">
        ${je(t,s)}
        ${e.showEl("position_pct")?G`<span class="ts-cover-pct" style="color:${i}">${Math.round(o)}%</span>`:Q}
      </div>
      ${e.showEl("shutter_graphic")?G`<div class="ts-cover-graphic">
        ...
        ${a&&e.showEl("moving_label")?G`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:Q}
      </div>`:Q}
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"sensor-card"===u?function(e){const{device:t,accent:i,online:s,hass:r,config:o}=e;let a;for(const e of Qe)if(a=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),a)break;const n=a?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&Ve.includes(t.attributes?.device_class??"")});if(!a&&!n)return He(t,s,"ts-sensor","No sensor");if(a){const n=r.states[a.entity_id],l=parseFloat(n?.state??""),c=n?.attributes?.unit_of_measurement??"",d=n?.attributes?.device_class??"",p=o.graph_hours??24;e.requestGraphData(a.entity_id);const h=e.getGraphPoints(a.entity_id,p);let g=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const u=t.entities.filter(e=>{if(e.entity_id===a.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return G`
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"scene-button"===u?function(e){const{device:t,accent:i,online:s,config:r}=e,o=e.getInputChannels(t),a=r.device_styles?.[t.device_id],n=qe(a?.tile_icon??"pulse",!0,`--ent-spd:${a?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return o.length>0?G`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0;let r;if(void 0!==i)r=new Set(i);else if(void 0!==s)r=new Set(s);else{const e=t?this._config.area_styles?.[t]?.sensors:void 0,i=e?.length?e:this._config.sensors;r=i?.length?new Set(i):null}const o=e=>!r||r.has(e),a={},n=(e,t)=>{a[e]||(a[e]={sum:0,count:0}),a[e].sum+=t,a[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"";"power"===s&&o("power")?n("power",i):"energy"===s&&o("energy")?n("energy",i):"temperature"===s&&o("temperature")?n("temperature",i):"humidity"===s&&o("humidity")?n("humidity",i):"carbon_dioxide"===s&&o("co2")?n("co2",i):"illuminance"===s&&o("illuminance")&&n("illuminance",i)}const l=[];return a.power&&l.push({label:"Power",value:ht(a.power.sum)}),a.energy&&l.push({label:"Energy",value:gt(a.energy.sum)}),a.temperature&&l.push({label:"Temp",value:ft(a.temperature.sum/a.temperature.count)}),a.humidity&&l.push({label:"Hum",value:kt(a.humidity.sum/a.humidity.count)}),a.co2&&l.push({label:"CO₂",value:Ct(a.co2.sum/a.co2.count)}),a.illuminance&&l.push({label:"Light",value:At(a.illuminance.sum/a.illuminance.count)}),l}_areaHeaderCandidates(e,t){const i=[["power","Power","power"],["energy","Energy","energy"],["temperature","Temp","temperature"],["humidity","Hum","humidity"],["co2","CO₂","carbon_dioxide"],["illuminance","Light","illuminance"]],s=new Set;for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];t&&s.add(t.attributes.device_class??"")}const r=this._areaHeaderOverride.get(t),o=this._config.area_styles?.[t]?.header_chips;let a;if(void 0!==r)a=new Set(r);else if(void 0!==o)a=new Set(o);else{const e=this._config.area_styles?.[t]?.sensors,i=e?.length?e:this._config.sensors;a=i?.length?new Set(i):null}const n=[];for(const[e,t,r]of i)s.has(r)&&n.push({key:e,label:t,visible:!a||a.has(e)});return n}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,r=(t,s)=>{const r=new Set(i.filter(e=>e.visible).map(e=>e.key));s?r.add(t):r.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>r.has(e)))};return G`
      ...
      </div>`}_renderAreaSection(e,t){if(!t.length)return G``;const i=e||"No Area",s=this._closedAreas.has(e),r=t.filter(e=>this._isOnline(e)).length,o=t.reduce((e,t)=>e+(this._getPower(t)??0),0),a=this._config.area_styles?.[i],n=a?.columns??this._config.columns??3,l={};if(a&&((a.borderColor||a.borderWidth)&&(l.border=`${a.borderWidth??1}px ${a.borderStyle??"solid"} ${a.borderColor??"var(--divider-color)"}`),a.borderRadius&&(l.borderRadius=`${a.borderRadius}px`,l.overflow="hidden"),a.headerBgColor&&(l["--area-header-bg"]=a.headerBgColor2?`linear-gradient(${a.headerBgDir??"to right"}, ${a.headerBgColor}, ${a.headerBgColor2})`:a.headerBgColor),a.textColor&&(l["--area-header-color"]=a.textColor),a.fontSize&&(l["--area-name-size"]=`${a.fontSize}px`),a.fontWeight&&(l["--area-name-weight"]=a.fontWeight),a.tileBgColor&&(l["--sc-tile-bg"]=a.tileBgColor),a.tileBorderColor&&(l["--sc-tile-border"]=a.tileBorderColor),null!=a.tileBorderRadius&&(l["--tile-radius"]=`${a.tileBorderRadius}px`),null!=a.tileGap&&(l["--tile-gap"]=`${a.tileGap}px`),a.tileTextColor&&(l["--sc-text-primary"]=a.tileTextColor),a.accentColor&&(l["--sc-accent"]=a.accentColor,l["--sc-graph-line"]=a.accentColor,l["--sc-accent-glow"]=`${a.accentColor}59`),a.buttonShape||a.buttonVariant||a.buttonSize)){const e=a.buttonShape??"pill",t=a.buttonVariant??"fill",i=a.buttonSize??"md",s="square"===e||"circle"===e,r={sm:"2px 8px",md:"4px 11px",lg:"6px 16px"},o={sm:"3px 5px",md:"4px 8px",lg:"6px 12px"};l["--tog-radius"]="pill"===e?"20px":"rect"===e||"square"===e?"6px":"50%",l["--tog-pad"]=s?o[i]??o.md:r[i]??r.md,l["--tog-fsize"]="sm"===i?".65em":"lg"===i?".8em":".72em",l["--tog-aspect"]=s?"1":"auto","outline"===t?(l["--tog-on-bg"]="transparent",l["--tog-on-border"]="1px solid var(--sc-accent)",l["--tog-on-color"]="var(--sc-accent)",l["--tog-on-shadow"]="none"):"ghost"===t&&(l["--tog-on-bg"]="transparent",l["--tog-on-border"]="none",l["--tog-on-color"]="var(--sc-accent)",l["--tog-on-shadow"]="none")}const c=a?.tile_style,d=this._getAreaChips(t,i);return G`
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${o>0?G`<span class="area-power">${ht(o)}</span>`:Q}
    ...
    `}render(){if(!this._config||!this.hass)return G``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return G`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${Ae(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?Be([...a.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):G`<div class="device-grid" style="--cols:${r?.columns??this._config.columns??3}">
                ${Be(o,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
      </ha-card>
    ...
    `],e([ve({attribute:!1})],Gt.prototype,"hass",void 0),e([ve({type:Boolean})],Gt.prototype,"preview",void 0),e([fe()],Gt.prototype,"_config",void 0),e([fe()],Gt.prototype,"_closedAreas",void 0),e([fe()],Gt.prototype,"_entityListOpen",void 0),e([fe()],Gt.prototype,"_graphData",void 0),e([fe()],Gt.prototype,"_valveDragPos",void 0),e([fe()],Gt.prototype,"_trvDragTemp",void 0),e([fe()],Gt.prototype,"_cloudDetailOpen",void 0),e([fe()],Gt.prototype,"_detailDevice",void 0),e([fe()],Gt.prototype,"_detailHistoryRange",void 0),e([fe()],Gt.prototype,"_activeViewId",void 0),e([fe()],Gt.prototype,"_tileBlockOverride",void 0),e([fe()],Gt.prototype,"_tileChipOverride",void 0),e([fe()],Gt.prototype,"_areaHeaderOverride",void 0),e([fe()],Gt.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Gt.prototype,"_areaCustomizeOpen",void 0),Gt=Ut=e([he("ha-device-dashboard")],Gt);const Zt=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Zt(e,t);return!0},Xt=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Qt=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Kt(t)}};function Vt(e){void 0!==this._$AN?(Xt(this),this._$AM=e,Qt(this)):this._$AM=e}function Yt(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Zt(s[e],!1),Xt(s[e]);else null!=s&&(Zt(s,!1),Xt(s));else Zt(this,e)}const Kt=e=>{e.type==me&&(e._$AP??=Yt,e._$AQ??=Vt)};class Jt extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Qt(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Zt(this,e),Xt(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const $t=new WeakMap,ei=ye(class extends Jt{render(e){return Q}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Q}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=$t.get(t);void 0===i&&(i=new WeakMap,$t.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?$t.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),ti={warm_dusk:{accent_color:"#c98a63",card_bg:"#1e1a17",tile_bg:"rgba(255,244,232,0.035)",tile_border:"rgba(255,244,232,0.08)",tile_hover_bg:"rgba(255,244,232,0.06)",tile_hover_shadow:"rgba(0,0,0,0.35)",tile_sensor_bg:"rgba(255,244,232,0.045)",tile_exp_bg:"rgba(255,244,232,0.05)",text_primary:"#ece5dc",text_secondary:"#b3a596",text_muted:"#7e7265",header_bg:"#241f1b",header_bg2:"#33291f",header_text_color:"#f3ece3",header_orb_color:"#c98a63",online_color:"#93b384",offline_color:"#d47f62",power_color:"#dba25c",area_header_color:"#c98a63"},dark_industrial:{accent_color:"#f4601e",card_bg:"#1c1c1e",tile_bg:"rgba(255,255,255,0.04)",tile_border:"rgba(255,255,255,0.07)",tile_hover_bg:"rgba(255,255,255,0.07)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(255,255,255,0.04)",tile_exp_bg:"rgba(255,255,255,0.06)",text_primary:"#e5e7eb",text_secondary:"#9ca3af",text_muted:"#6b7280",header_bg:"#1a1a2e",header_bg2:"#0f3460",header_text_color:"#ffffff",header_orb_color:"#3b82f6",online_color:"#4ade80",offline_color:"#ef4444",power_color:"#fb923c",area_header_color:"#f4601e"},teal_terminal:{accent_color:"#2dd4bf",card_bg:"#0b0f0e",tile_bg:"#0f1917",tile_border:"#1e2b28",tile_hover_bg:"rgba(45,212,191,0.08)",tile_hover_shadow:"rgba(0,0,0,0.40)",tile_sensor_bg:"rgba(45,212,191,0.05)",tile_exp_bg:"rgba(45,212,191,0.07)",text_primary:"#d1fae5",text_secondary:"#6ee7b7",text_muted:"#4b5563",header_bg:"#042f2e",header_bg2:"#0b6157",header_text_color:"#ccfbf1",header_orb_color:"#2dd4bf",online_color:"#34d399",offline_color:"#f87171",power_color:"#fbbf24",area_header_color:"#2dd4bf"},brutalist:{accent_color:"#facc15",card_bg:"#000000",tile_bg:"#0a0a0a",tile_border:"#ffffff",tile_hover_bg:"rgba(255,255,255,0.12)",tile_hover_shadow:"rgba(250,204,21,0.25)",tile_sensor_bg:"rgba(255,255,255,0.06)",tile_exp_bg:"rgba(255,255,255,0.09)",text_primary:"#ffffff",text_secondary:"#d4d4d4",text_muted:"#a3a3a3",header_bg:"#000000",header_bg2:"#171717",header_text_color:"#facc15",header_orb_color:"#facc15",online_color:"#22c55e",offline_color:"#ef4444",power_color:"#facc15",area_header_color:"#ffffff"},frosted_light:{accent_color:"#0071e3",card_bg:"#f2f2f7",tile_bg:"#ffffff",tile_border:"#d1d1d6",tile_hover_bg:"rgba(0,0,0,0.04)",tile_hover_shadow:"rgba(0,0,0,0.12)",tile_sensor_bg:"rgba(0,0,0,0.04)",tile_exp_bg:"rgba(0,0,0,0.05)",text_primary:"#1c1c1e",text_secondary:"#48484a",text_muted:"#8e8e93",header_bg:"#e8eef7",header_bg2:"#cfe0f5",header_text_color:"#1c1c1e",header_orb_color:"#0071e3",online_color:"#34c759",offline_color:"#ff3b30",power_color:"#ff9500",area_header_color:"#0071e3"},nordic_warm:{accent_color:"#d08770",card_bg:"#2e3440",tile_bg:"#3b4252",tile_border:"#434c5e",tile_hover_bg:"rgba(236,239,244,0.06)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(236,239,244,0.04)",tile_exp_bg:"rgba(236,239,244,0.06)",text_primary:"#eceff4",text_secondary:"#d8dee9",text_muted:"#9aa4b8",header_bg:"#3b4252",header_bg2:"#434c5e",header_text_color:"#eceff4",header_orb_color:"#ebcb8b",online_color:"#a3be8c",offline_color:"#bf616a",power_color:"#d08770",area_header_color:"#d08770"},midnight_purple:{accent_color:"#a78bfa",card_bg:"#0f0a1e",tile_bg:"#1a1030",tile_border:"#2e1f4d",tile_hover_bg:"rgba(167,139,250,0.10)",tile_hover_shadow:"rgba(0,0,0,0.45)",tile_sensor_bg:"rgba(167,139,250,0.06)",tile_exp_bg:"rgba(167,139,250,0.08)",text_primary:"#ede9fe",text_secondary:"#c4b5fd",text_muted:"#7c6ba8",header_bg:"#1e1b4b",header_bg2:"#4c1d95",header_text_color:"#ede9fe",header_orb_color:"#a78bfa",online_color:"#4ade80",offline_color:"#fb7185",power_color:"#c084fc",area_header_color:"#a78bfa"}},ii=["warm_dusk","dark_industrial","teal_terminal","brutalist","frosted_light","nordic_warm","midnight_purple"],si={warm_dusk:"Warm Dusk",dark_industrial:"Dark Industrial",teal_terminal:"Teal Terminal",brutalist:"Brutalist",frosted_light:"Frosted Light",nordic_warm:"Nordic Warm",midnight_purple:"Midnight Purple",custom:"Custom"},ri=Object.keys(ti.dark_industrial);function oi(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of ii){const i=ti[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}const ai=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"device-panel",label:"Per-device style panel"},{id:"room-panel",label:"Per-room style panel"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var ni;const li=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let ci=!1;const di=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"}]}],pi=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],hi=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],gi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}],ui=["style","tile_size","tile_opacity","card_opacity","card_bg_image","card_bg_image_size","tile_layout","graph_style","graph_sensors","graph_hours","graph_line_color","graph_sensor_colors","sensors","sort_by","columns","show_power_bar","power_bar_max","area_styles","device_styles","views","default_view"];let vi=ni=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._styleClipFeedback="",this._copyAreaOpen=!1,this._copyJson="",this._pasteOpen=!1,this._pasteText="",this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCache=[],this._layDrag=null,this._layMove=null}setConfig(e){this._config=Mt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of ri)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Q}connectedCallback(){super.connectedCallback(),function(){if(ci||"undefined"==typeof document)return;const e=li.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),ci=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;const o="ha-device-dashboard-editor-fix";if(!r.getElementById(o)){const e=document.createElement("style");e.id=o,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const a=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),o=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(o,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);a(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),a(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),a(o,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return G`
      ...
      </div>`}_iconPicker(e,t,i,s){const r="#f4601e",o=t?Ge[t]?.[i?"on":"off"]??r:r,a=this._iconPickerState?.onSelect===s;return G`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          ${t?qe(t,i,`--ent-spd:1;color:${o}`,"icon-preview-sm"):G`<span class="icon-cell-none">—</span>`}
        </button>
      ...
      </span>`}_chipPicker(e,t,i,s){const r=t??[],o=void 0!==e,a=di.flatMap(e=>e.items.map(e=>e.key)),n=new Set(o?e:r.length?r:a);return G`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          ...
          ${o?G`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:G`<button class="color-reset" @click=${()=>s([...n])}>Customize</button>`}
        </div>
        ${di.map(t=>G`
      ...
      </div>`}_clearDeviceStyle(e){const t={...this._config.device_styles??{}};delete t[e],this._set("device_styles",Object.keys(t).length?t:void 0)}async _prepareImageForEmbed(e,t={}){const i=t.maxDim??1920,s=t.targetBytes??409600,r=await createImageBitmap(e,{imageOrientation:"from-image"}),o=Math.min(1,i/Math.max(r.width,r.height)),a=Math.max(1,Math.round(r.width*o)),n=Math.max(1,Math.round(r.height*o)),l=document.createElement("canvas");l.width=a,l.height=n;const c=l.getContext("2d");if(!c)throw r.close(),new Error("canvas 2d context unavailable");c.drawImage(r,0,0,a,n),r.close();let d=.85,p=l.toDataURL("image/jpeg",d);for(;.75*p.length>s&&d>.4;)d-=.1,p=l.toDataURL("image/jpeg",d);return l.width=0,l.height=0,p}async _handleBgUpload(e,t,i){const s=e.target,r=s.files?.[0];if(r){try{t(await this._prepareImageForEmbed(r,i))}catch(e){console.warn("[editor] failed to process image",r.name,e),this._showStyleFeedback(`Couldn't process "${r.name}" — try a /local/… URL instead`)}s.value=""}}_handleCardBgUpload(e){return this._handleBgUpload(e,e=>this._set("card_bg_image",e))}_handleTileBgUpload(e){return this._handleBgUpload(e,e=>this._set("style",{...this._config.style??{},tile_bg_image:e}),{maxDim:720})}_sec(e,t,i,s,r,o,a){const n=this._openSections[e];return G`
      ...
      </div>`}_badge(e,t,i){return G`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,r=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const r=t.size===i.length?void 0:[...t];this._set("areas",r)},o=this._getDiscoveredDevices(),a=e.hidden_devices??[],n=new Map;for(const e of o){const t=e.area??"";n.has(t)||n.set(t,[]),n.get(t).push(e)}const l=[...t.map(e=>e.name)];n.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=n.get("")?.length??0,h=G`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>o.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),r=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return G`
          ...
          ${s?G`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=a.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,o=t.area?G`<span class="fav-dev-area">${t.area}</span>`:Q;return G`
      ...
      ${l.map(t=>{const i=t||"No Room",o=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return G`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${o.length?G`<span class="room-count">${o.length}</span>`:Q}
          ...
          ${c?G`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${o.length?o.map(t=>{const i=a.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id;return G`
                    <div class="room-device-row ${r?"selected":""}">
      ...
      ${g}`}_setDeviceStyle(e,t){const i={...this._config.device_styles?.[e]??{},...t};void 0===i.color&&delete i.color,void 0===i.tile_layout&&delete i.tile_layout,void 0===i.profile&&delete i.profile,void 0===i.tile_style&&delete i.tile_style,void 0===i.power_monitor_variant&&delete i.power_monitor_variant,void 0===i.tile_icon&&delete i.tile_icon,void 0===i.tile_icon_off&&delete i.tile_icon_off,void 0===i.tile_icon_speed&&delete i.tile_icon_speed,void 0===i.entity_animations&&delete i.entity_animations,void 0===i.sensors&&delete i.sensors,void 0===i.show_graphs&&delete i.show_graphs,void 0===i.elements&&delete i.elements;const s={...this._config.device_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("device_styles",Object.keys(s).length?s:void 0)}_setProfileStyle(e,t){const i={...this._config.profile_styles?.[e]??{},...t};for(const e of["color","tile_layout","tile_style","power_monitor_variant","sensors","show_graphs","elements"])void 0===i[e]&&delete i[e];const s={...this._config.profile_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("profile_styles",Object.keys(s).length?s:void 0)}_styleSlug(e){const t=e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"style",i=this._config.custom_styles??{};if(!i[t])return t;let s=2;for(;i[`${t}-${s}`];)s++;return`${t}-${s}`}_saveAsStyle(e,t,i){const s=this._newStyleName.trim();if(!s)return;const r=this._styleSlug(s),o=e.tile_style,a={label:s,base:"string"==typeof o&&o.startsWith("custom:")?this._config.custom_styles?.[o.slice(7)]?.base??t:o??t};e.power_monitor_variant&&(a.variant=e.power_monitor_variant),e.elements&&(a.elements={...e.elements}),e.sensors&&(a.sensors=[...e.sensors]),e.tile_layout&&(a.tile_layout=e.tile_layout.map(e=>Array.isArray(e)?[...e]:e)),this._set("custom_styles",{...this._config.custom_styles??{},[r]:a}),i(`custom:${r}`),this._newStyleName=""}_saveDeviceAsStyle(e){const t=this._allDevices().find(t=>t.device_id===e),i=t?ct(t):null,s=(this._config.smart_tile_styles&&i&&t?et(i.type,t):void 0)??"default";this._saveAsStyle(this._config.device_styles?.[e]??{},s,t=>this._setDeviceStyle(e,{tile_style:t}))}_saveProfileAsStyle(e){const t=$e[e]??"default";this._saveAsStyle(this._config.profile_styles?.[e]??{},t,t=>this._setProfileStyle(e,{tile_style:t}))}_renameCustomStyle(e,t){const i=t.trim(),s=this._config.custom_styles?.[e];this._renamingStyle=null,s&&i&&i!==s.label&&this._set("custom_styles",{...this._config.custom_styles??{},[e]:{...s,label:i}})}_deleteCustomStyle(e){const t=`custom:${e}`,i={...this._config.custom_styles??{}};delete i[e],this._set("custom_styles",Object.keys(i).length?i:void 0);const s=e=>{if(!e||!Object.values(e).some(e=>e.tile_style===t))return null;const i={};for(const[s,r]of Object.entries(e)){const e={...r};e.tile_style===t&&delete e.tile_style,Object.keys(e).length&&(i[s]=e)}return Object.keys(i).length?i:void 0},r=s(this._config.device_styles);null!==r&&this._set("device_styles",r);const o=s(this._config.profile_styles);null!==o&&this._set("profile_styles",o);const a=s(this._config.area_styles);null!==a&&this._set("area_styles",a),this._config.views?.some(e=>e.tile_style===t)&&this._set("views",this._config.views.map(e=>{if(e.tile_style!==t)return e;const i={...e};return delete i.tile_style,i})),this._config.tile_style===t&&this._set("tile_style",void 0),this._flushConfig()}_renderTileStylePicker(e,t,i,s,r){const o=e??"default",a="power-monitor"===o||!e&&"power-monitor"===i;return G`
      ...
      ${a?G`
        ...
        </div>`:Q}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,r=s?e.find(e=>e.device_id===s):null,o=r?ct(r):null,a=this._styleScope,n=o?e.filter(e=>ct(e).type===o.type).length:0,l=o?Je[o.type]||o.type:"",c=e=>G`
      ...
      <div class="dev-styling-tab">
        ...
        ${r&&o?G`
          ...
          ${"device"===a?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&r?et(o.type,r):void 0)??"default";return G`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[o.type]??{},t=e.tile_style??(this._config.smart_tile_styles?$e[o.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return G`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",$e[o.type],e=>this._setProfileStyle(o.type,{tile_style:e}),e=>this._setProfileStyle(o.type,{power_monitor_variant:e}))}
          </div>
      ...
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-palette">
          ${o.length?o.map((e,t)=>a(e,-1,t)):G`<span class="dev-style-hint">drag a block here to hide it</span>`}
        </div>
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=pi.map(e=>e.id),s=this._config.tile_layout??i,r=st(s),o=st(t.tile_layout)??null,a=t.entity_animations??{},n=a=>{const n=(o??r).includes(a),l=function(e,t,i,s){const r=it(e).map(e=>[...e]);if(!i)return r.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(r.some(e=>e.includes(t)))return r;const o=e=>{const t=s.indexOf(e);return t<0?s.length:t},a=r.findIndex(e=>o(e[0])>o(t));return r.splice(a<0?r.length:a,0,[t]),r}(t.tile_layout??s,a,!n,i),c=JSON.stringify(l)===JSON.stringify(it(s));this._setDeviceStyle(e,{tile_layout:c?void 0:l})},l=(t,i,s)=>{const r={...a[t]??{}};if("speed"===i){const e=Number(s);1===e?delete r.speed:r.speed=e}else"none"===s?delete r[i]:r[i]=s;const o={...a,[t]:r};r.on||r.off||r.speed||delete o[t],this._setDeviceStyle(e,{entity_animations:Object.keys(o).length?o:void 0})},c=this._allDevices().find(t=>t.device_id===e),d=c?ct(c):null,p=d?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[d.type]:void 0,h=t.tile_style,g=t.power_monitor_variant??"big-number",u=G`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
      ...
      <div class="dev-style-panel">
        ...
        ${(()=>{const i=c?ct(c):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&c?et(i.type,c):void 0)??this._config.tile_style,l=this._baseStyleOf(a);return l&&"default"!==l?Q:G`
            ...
            ${this._adv(G`
                ...
                <div class="block-toggles">
                  ${pi.filter(e=>"graph"!==e.id).map(e=>{const t=null===o?r.includes(e.id):o.includes(e.id);return G`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ...
        ${this._adv(v.length?G`
          ...
          ${v.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,r=a[t.entity_id]?.on??"none",o=a[t.entity_id]?.off??"none",n=a[t.entity_id]?.speed??1;return G`
      ...
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,r)=>{const o=t[s]??r;return G`
        <div class="color-row">
        ...
        </div>`},s=(i,s,r,o,a,n,l)=>{const c=t[s]??n;return G`
        <div class="sl-row">
          <span class="color-key">${i}</span>
    ...
    `}_renderViewCard(e,t,i,s,r,o,a,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,a,n),g=a.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return G`
      ...
      </div>`}_layoutSectionDescriptors(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},r=(e,r,o)=>{const a=t[r]??o;return G`
        <div class="color-row">
      ...
      </div>`)}`,a=(e,i,s)=>{const r=t[i]??s;return G`
        <div class="color-row">
      ...
      ${a("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=G`
      ...
      ${a("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=G`
      <div class="field">
    ...
    `,u=G`
      ...
      <div class="field">
        ...
        `:Q}
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Q,body:o},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Q,body:g},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Q,body:u},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Q,body:l},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Q,body:d}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",r=t.tile_bg??"#1c1c1e",o=t.tile_border??"#2a2a30",a=t.tile_hover_bg??"rgba(255,255,255,0.07)",n=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",g=t.header_bg??"#1a1a2e",u=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",b=t.header_title_size??1.1,m=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",A=t.font_family?`'${t.font_family}', sans-serif`:"inherit",C=t.text_size_scale??1,S=t.tile_radius??12,_=t.tile_border_width??1,z=t.header_radius??0,O=y>0?`${y}px solid ${x}`:"none",I=G`
      <div class="style-preview" style="font-family:${A};background:${s}">
        ...
        <div class="sp-tile"
          style="background:${r};border:${_}px solid ${o};border-radius:${S}px">
        ...
        <div class="sp-tile"
          style="background:${a};border:${_}px solid ${o};border-radius:${S}px">
          <div class="sp-row" style="color:${l};font-size:${(13*C).toFixed(0)}px">
      ...
      </div>`)}`,o=e.graph_sensors??nt,a=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const r=s[e]??i,o=!!s[e];return G`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${r}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${o?G`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:Q}
        </div>`},l=G`
      <div class="field-lbl" style="margin-bottom:6px">Gauge ring colours</div>
      ${a.map(e=>n(e.key,e.label,e.default))}
      ${o.filter(e=>!a.find(t=>t.key===e)).length?G`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${o.filter(e=>!a.find(t=>t.key===e)).map(e=>{const t=_t.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??_t.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Q}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",_t.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${_t.map(e=>{const t=o.some(t=>It(t)===e.key);return G`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?o.filter(t=>It(t)!==e.key):[...o,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const r=""===s.trim()?void 0:parseFloat(s),o={...c[e]??{}};void 0===r||isNaN(r)?delete o[i]:o[i]=r;const a={...c,[e]:o};o.min||0===o.min||o.max||0===o.max||delete a[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(a).length?a:void 0})},p=G`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return G`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),r=It(i.key),o=!!_t.find(e=>e.key===r),a=e.graph_sensors??nt,n=a.some(e=>It(e)===r);return G`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${o?G`<button class="sensor-graph-btn ${n?"on":""}"
                    title="${n?"Remove from graphs":"Add to graphs"}"
                    @click=${e=>{e.stopPropagation();const t=n?a.filter(e=>It(e)!==r):[...a,r];this._set("graph_sensors",t)}}>∿</button>`:Q}
                </div>`})}
          </div>`,c=s.group.toLowerCase().replace(" ","");i[c]={icon:s.icon,bg:s.iconBg,fg:s.iconColor,label:s.group,badge:n,body:l}}),i}_renderTabSections(e,t,i){const s=ai.find(t=>t.id===e);if(!s)return G``;const r=new Set;return G`${s.sections.map(e=>{const s=t[e.id];if(!s)return Q;const o=i?i(e.id,r):Q;r.add(e.id);const a=G`${o}${this._sec(e.id,s.icon,s.bg,s.fg,e.label??s.label,s.badge,s.body)}`;return e.advanced?this._adv(a):a})}`}_renderGraphsSensorsTab(){const e=this._globalSectionDescriptors(),t=new Set(["electrical","environmental","deviceinfo","alerts"]);return this._renderTabSections("graphs",e,(e,i)=>{const s=[...i].some(e=>t.has(e));return t.has(e)&&!s?G`<div class="hint" style="margin:4px 2px 8px">Global default — override per room (Layout & Style → room) or per device (Rooms & devices).</div>`:Q})}_renderYamlTab(){const e=this._config,t=(e,i=0)=>{const s="  ".repeat(i);return Object.entries(e).map(([e,r])=>null==r?"":"object"!=typeof r||Array.isArray(r)?Array.isArray(r)?`${s}${e}:\n${r.map(e=>"object"==typeof e?`${s}  -\n${t(e,i+2)}`:`${s}  - ${e}`).join("\n")}`:`${s}${e}: ${r}`:`${s}${e}:\n${t(r,i+1)}`).filter(Boolean).join("\n")},i=t(e);return G`
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...ti[t]}}(this._config.style,e))}_onPickTheme(e){const t=this._config.style??{},i=ri.some(e=>void 0!==t[e]);i&&"custom"===oi(t)?this._pendingTheme=e:this._applyTheme(e)}_applySaved(){this._savedTheme&&this._set("style",{...this._config.style??{},...this._savedTheme})}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=oi(t),r=!!this._savedTheme&&Object.entries(this._savedTheme).every(([e,i])=>t[e]===i);return G`
