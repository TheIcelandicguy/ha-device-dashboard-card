...
`;function qe(e,t,i="ts-hero-name"){return q`
    ...
    <div class="input-row ${i.isButton?"btn-mode":i.isOn?"active":""}">
      ...
      ${function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputSelectChip(t,i);if(!s)return o?Qe(e,o):Q;const a=e.inputHasHold(t,i),n=()=>e.endInputHold();return q`
    ...
    </select>`}const Ze=/^\s*[♪♫♬♩]\s*/,Xe=new Set(["pixels","pixelwave","juggles","matripix","gravimeter","plasmoid","puddles","midnoise","noisemeter","freqwave","freqmatrix","geq","waterfall","freqpixels","noisefire","puddlepeak","noisemove","ripple peak","freqmap","gravcenter","gravcentric","gravfreq","dj light","funky plank","blurz","waverly","swirl","rocktaves","akemi","ps spray","ps geq 2d","ps geq nova","ps blobs","ps geq 1d","ps sonic stream","ps sonic boom","ps springy"]),Ye=e=>Ze.test(e)||Xe.has(e.replace(Ze,"").trim().toLowerCase());function Ke(e,t,i){if(e.length<=1)return Q;const s=e.filter(Ye),o=e.filter(e=>!Ye(e)&&"Off"!==e),a=e.find(e=>"Off"===e)??e.find(e=>"Solid"===e),n=e=>q`
    ...
    <div class="tile-effects" @click=${e=>e.stopPropagation()}>
      <select class="effect-sel"
        ...
        ${a?q`
          <option value=${a} ?selected=${!t||t===a}>— no effect —</option>`:Q}
        ${s.length?q`
          <optgroup label="Sound reactive">${s.map(n)}</optgroup>`:Q}
...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function at(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    <div class="ts-inputs" style="--ts-accent:${i}">
      ${e.showEl("name")?q`
        <div class="ts-inputs-top">${qe(t,s)}</div>`:Q}
    ...
    <button
      ...
      ${r&&e.showEl("target_state")?q`<span class="ts-key-sub">${r}</span>`:Q}
      ${e.showEl("last_event")&&i.lastChanged?q`<span class="ts-key-age">${e.timeAgo(i.lastChanged)}</span>`:Q}
    </button>`}(e,t,i))}
        </div>`:Q}
      ...
      ${l.length&&e.showEl("keypad")?q`
        <div class="ts-key-chips" @click=${e=>e.stopPropagation()}>
          ${l.map(({ch:i,chip:s})=>q`
            ${l.length>1?q`<span class="ts-key-chip-lbl">${e.getInputActionLabel(t,i)}</span>`:Q}
            ${Qe(e,s)}`)}
        </div>`:Q}
    ...
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n):Q}
    ...
    ${o>s?G`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${g}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${g}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:Q}`})():Q;return q`
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ${qe(t,o,"ts-spark-name")}
        ${l&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(l.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Q}
      </div>
      ${e.showEl("graph")?q`<div class="ts-spark-graph"><svg viewBox="0 0 ${d} ${p}" preserveAspectRatio="none" style="width:100%;height:${p}px;display:block;overflow:visible">${m}</svg></div>`:Q}
      <div class="ts-spark-bottom">
        ...
        ${e.showEl("secondary")?q`<div class="ts-spark-meta">
          ${null!=r.voltage?q`<div class="ts-spark-mrow">${r.voltage.toFixed(1)} <b>V</b></div>`:Q}
          ${null!=r.current?q`<div class="ts-spark-mrow">${r.current.toFixed(2)} <b>A</b></div>`:Q}
          ${null!=r.energy?q`<div class="ts-spark-mrow">${r.energy.toFixed(2)} <b>kWh</b></div>`:Q}
          ${null!=r.temp?q`<div class="ts-spark-mrow">${r.temp.toFixed(1)} <b>°C</b></div>`:Q}
          ${null!=r.rssi?q`<div class="ts-spark-mrow">${r.rssi} <b>dBm</b></div>`:Q}
        </div>`:Q}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipPowerGraph:!0}):Q}
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        ${e.showEl("secondary")?q`<div class="ts-hbar-side">
          ${null!=n.voltage?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${n.voltage.toFixed(0)}</div></div>`:Q}
          ${null!=n.current?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${n.current.toFixed(2)}</div></div>`:Q}
          ${null!=n.temp?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${n.temp.toFixed(1)}</div></div>`:Q}
          ${null!=n.rssi?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${n.rssi}</div></div>`:Q}
        </div>`:Q}
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=n.energy?q`<span class="ts-hbar-badge">${n.energy.toFixed(2)} kWh</span>`:Q}
          ${null!=n.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${Wt(n.uptime)}</span>`:Q}
        </div>
        ${r&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Q}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Q}
    ...
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Q,f=(e,t,i=!1)=>q`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=r.power?f("Power",Ft(r.power),!0):Q}
      ${e.showEl("secondary")?q`
        ${null!=r.voltage?f("Voltage",`${r.voltage.toFixed(1)} V`):Q}
        ${null!=r.current?f("Current",`${r.current.toFixed(3)} A`):Q}
        ${null!=r.energy?f(r.energyLabel,Nt(r.energy)):Q}
        ${null!=r.temp?f("Temp",`${r.temp.toFixed(1)} °C`):Q}
        ${null!=r.rssi?f("WiFi",`${r.rssi} dBm`):Q}`:Q}
      ${null!=r.uptime&&e.showEl("uptime")?f("Uptime",Wt(r.uptime)):Q}
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipGraphs:!0}):Q}
    ...
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${r})"/>
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Q;return q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.showEl("graph")?q`<div class="ts-hero-spark"><svg viewBox="0 0 ${d} ${p}" preserveAspectRatio="none" style="width:100%;height:${p}px;display:block">${v}</svg></div>`:Q}
      <div class="ts-hero-foot">
        ${e.showEl("secondary")?q`<div class="ts-chips">
          ${null!=r.voltage?q`<span class="ts-chip">${r.voltage.toFixed(1)} V</span>`:Q}
          ${null!=r.current?q`<span class="ts-chip">${r.current.toFixed(2)} A</span>`:Q}
          ${null!=r.energy?q`<span class="ts-chip">${r.energy.toFixed(2)} kWh</span>`:Q}
          ${null!=r.temp?q`<span class="ts-chip">${r.temp.toFixed(1)} °C</span>`:Q}
          ${null!=r.rssi?q`<span class="ts-chip">${r.rssi} dBm</span>`:Q}
        </div>`:Q}
        ${e.showEl("uptime")?q`<span class="ts-uptime">${r.uptime?Wt(r.uptime):""}</span>`:Q}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n):Q}
      ...
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${Ft(l.power)}</div>`:Q}
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${qi}" height="${qi}" viewBox="0 0 ${qi} ${qi}"
            ...
            ${k?G`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${h}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:Q}
          </svg>
        </div>`:Q}
      ...
      ${e.showEl("effects")?Ke(f,m,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e})):Q}
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Ft(l.power)}</div>`:Q}
    </div>`}function Qi(e,t){const{device:i,profile:s,config:o,hass:a,online:n}=e,r=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),u=e.getPower(i),g=e.getSensors(i),v=e.getInputChannels(i),f=r?.isOn??!1,m=void 0!==r?.brightness,b=r&&m&&f?Math.max(1,r.brightness??1):0,y=!!r?.colorModes?.length,x=r?.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",w=!!r?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Bt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=tt(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?tt(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?tt(i,!0,"--ent-spd:1","tile-icon"):q``}else a=q``;const p=r?e.renderEntityAnim(r.entityId,f,i.device_id):q``;return q`
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${h?q`<span class="update-dot" title="Firmware update">●</span>`:Q}
          </div>
          ${c?q`
          ...
          <div class="tile-stats">
            ${e.map(e=>q`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?q`<span class="stat-lbl">${e.ch}</span>`:Q}
                ${!e.ch&&e.key&&s.has(e.key)?q`<span class="stat-lbl">${e.label}</span>`:Q}
                ${e.value}
              </span>`)}
          </div>`:Q}
        ${t.length?q`
          <div class="tile-elec-wrap">
            ${[...o.entries()].map(([e,t])=>q`
              <div class="tile-elec">
                ${e?q`<span class="stat-lbl">${e}</span>`:Q}
                ${t.map((e,t)=>q`${t>0?q`<span class="sep">·</span>`:Q}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:Q}
        ${i.length?q`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>q`${t>0?q`<span class="sep">·</span>`:Q}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:Q}
      ...
      `:q``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,o={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?q`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:Q}
            ${null!=s?q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:Q}
          </div>
      ...
      `:q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?q`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return Q;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return q`
                <div class="virt-row">
      ...
      `:q``}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=gt(i);return e.length?q`
        ...
        <div class="tile-bot">
          ${null!=u?q`<span class="tile-power">${Ft(u)}</span>`:Q}
          <div class="tile-badges">
            ${p.map(e=>q`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?q`<span class="type-badge type-${s.type}">${s.label}</span>`:Q}
            ${_?q`<span class="gen-badge gen-${s.gen}">${_}</span>`:Q}
            ${A?q`<span class="int-badge-tile">${A}</span>`:Q}
      ...
      `;default:return q``}var C}const Zi=255;function Xi(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?q`<span class="ds-chip ds-chip--room">${t.area}</span>`:Q}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?q`<span class="ds-chip">${t.model}</span>`:Q}
        ${"ble"===i.gen?q`<span class="ds-chip">BLE</span>`:"other"!==i.gen?q`<span class="ds-chip">Gen ${i.gen}</span>`:Q}
        ${t.ip?q`<span class="ds-chip">${t.ip}</span>`:Q}
      </div>
      ${a?q`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:Q}
      ${null!=n.rssi?q`<div class="ds-signal">Wi-Fi: ${qt(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?q` · Up ${Wt(n.uptime)}`:Q}</div>`:Q}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,n=o?.attributes?.friendly_name??s.entity_id,r=s.entity_id.match(/_(?:switch|relay|channel)_\d+/)?.[0]??"",l=r?t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(r)&&"power"===i.states[e.entity_id]?.attributes?.device_class):void 0,c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?Q:q`<span class="ds-channel-power">${Ft(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ${t?q`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:Q}
      ${null!=s.power?q`<span class="ds-big-power">${Ft(s.power)}</span>`:Q}
    </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?q`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:Q}
      </div>
    </div>
    ${Ki(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Zi*100);return q`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?q`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:Q}
      </div>
      ${i?.rgbColor?q`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:Q}
    </div>
    ...
    <div class="ds-section">
      ...
      ${t?q`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?q`<span class="ds-chip">${t.hvacAction}</span>`:Q}
          ${t.presetMode?q`<span class="ds-chip">${t.presetMode}</span>`:Q}
        </div>
        ${null!=t.valvePosition?q`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:Q}
    ...
    <div class="ds-section">
      ...
      ${t?q`
        ...
        ${null!=t.position?q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:Q}
    ...
    <div class="ds-section">
      ...
      ${t?q`
        ...
        ${null!=t.position?q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:Q}
        ${null!=t.temperature?q`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:Q}
        <span class="ds-chip">${t.state}</span>
    ...
    ${o.length?q`<div class="ds-section ds-alert-row">${o.map(e=>q`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:Q}
        ...
        <div class="ds-channel-list">
          ${i.map(i=>{const s=e.getInputActionLabel(t,i),o=e.getInputActionState(t,i),a=i.lastChanged?e.timeAgo(i.lastChanged):"";return q`
              <div class="ds-channel-row">
                ...
                ${a?q`<span class="ds-ent-age">${a}</span>`:Q}
              </div>`})}
    ...
    <details class="ds-customize">
      <summary class="ds-cz-summary">⚙ Customise tile${t.customized?q`<span class="ds-cz-dot" title="This tile has custom visibility"></span>`:Q}</summary>
      <div class="ds-cz-body">
        ...
        ${t.customized?q`<button class="ds-cz-reset" @click=${()=>t.reset()}>↺ Reset to default</button>`:Q}
      </div>
    </details>`}(e)}
        </div>
      </div>
    </div>`}function Yi(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ft(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Q}
        ${null!=t.voltage?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ht(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:Q}
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${jt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Q}
        ${null!=t.energy?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Nt(t.energy)}</span><span class="ds-sensor-label">${t.energyLabel}</span></div>`:Q}
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ut(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Q}
      </div>
    </div>`:q``}(e):Q}
    ${!o&&s?Yi(e):Q}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const a=(t,s)=>{const o=i.states[t.entity_id],a=o?.attributes?.friendly_name??t.entity_id,n=o?.state??"unknown",r=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===n,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      <div class="ds-entity-row ${s?"is-secondary":""}" @click=${()=>e.fireMoreInfo(t.entity_id)}>
        ...
        ${d?q`<span class="ds-ent-age">${d}</span>`:Q}
        ${l?q`<button class="tog ${c?"on":"off"}" @click=${i=>{i.stopPropagation(),e.toggle(t.entity_id,c,i)}}>${c?"ON":"OFF"}</button>`:Q}
    ...
    <div class="ds-section">
      ...
      ${n.map(e=>a(e,!1))}
      ${r.length?q`<div class="ds-ent-subgroup">Configuration</div>${r.map(e=>a(e,!0))}`:Q}
      ${l.length?q`<div class="ds-ent-subgroup">Diagnostic</div>${l.map(e=>a(e,!0))}`:Q}
    </div>`}(e)}
    ...
    <div class="ds-section">
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Q:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                `:Q}
                ${"bar"!==h&&g?G`
                  <polygon points="${R} ${a},${n-4} ${P},${n-4}" fill="url(#${B})"/>
                `:Q}
          ...
          ${p?q`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${X}</span><span>${Y}</span><span>now</span>
              </div>
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const o=e=>{const o=this._trvTempFromEvent(e,s,t,i,a);null!=o&&(this._trvDragTemp=o)},r=()=>{s.removeEventListener("pointermove",o),s.removeEventListener("pointerup",l),s.removeEventListener("pointercancel",c)},l=e=>{const o=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=o&&this._setTemp(n,o),r()},c=()=>{this._trvDragTemp=null,r()};s.addEventListener("pointermove",o),s.addEventListener("pointerup",l),s.addEventListener("pointercancel",c)}}>
        ...
        ${g>210?G`<path d="${h(210,g,54)}" fill="none" stroke="url(#${x})" stroke-width="8" stroke-linecap="round"/>`:Q}
        ${b?G`<circle cx="${b[0]}" cy="${b[1]}" r="5" fill="white" stroke="${y}" stroke-width="2"/>`:Q}
    ...
    `}_trvTempFromEvent(e,t,i,s,o){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const n=(e.clientX-a.left)*(160/a.width),r=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(r-70,n-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=o||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),o=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(o-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const n=(a-210+360)%360;return n>300?null:Math.round(n/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[o,a]=i(e,s),[n,r]=i(t,s);return`M ${o} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${n} ${r}`},o=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,n=(e=>210+e/100*300)(a),[r,l]=i(n,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=o?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},o=()=>{i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",n)},a=t=>{const s=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=s&&this._setValvePosition(e.entityId,s,e.numEntityId),o()},n=()=>{this._valveDragPos=null,o()};i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",n)}:void 0;return G`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${o?"valve-interactive":""}"
        ...
        ${o?G`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:Q}
        <path d="${s(210,510,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${t>0?G`<path d="${s(210,n,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:Q}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:o,isHeating:a,valveOpen:n,hasFan:r}=i,l=e.type;if("relay"===l||"plug"===l)return r?G`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        <div class="metric-list">
          ${o.map(e=>q`
            <div class="metric-row">
              ...
              ${e.value?q`<span class="metric-val">${e.value}</span>`:Q}
            </div>`)}
        </div>
        ...
        </div>`:Q,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=u&&r?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,x=y?.attributes?.effect_list??[],w=y?.attributes?.effect??null,k=u?q`
    ...
    `:Q,S=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),E=S.length>1?q`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:Q;return p.length||u||o||a||n||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${_e(l)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?Qi(a,e[0]):q`<div class="tile-row">${e.map(e=>Qi(a,e))}</div>`)}
    ...
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("dial")?e.renderTrvDial(a):Q}
      ...
      ${e.showEl("stats")?q`<div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:Q}
        ${null!=l?q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:Q}
      </div>`:Q}
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-cover-top">
        ${qe(t,s)}
        ${e.showEl("position_pct")?q`<span class="ts-cover-pct" style="color:${i}">${Math.round(a)}%</span>`:Q}
      </div>
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        ...
        ${n&&e.showEl("moving_label")?q`<span class="ts-cover-state">${"opening"===o.state?"▲ Opening…":"▼ Closing…"}</span>`:Q}
      </div>`:Q}
    ...
    <div class="ts-sensor" style="--ts-accent:${i}">
      ...
      ${u?q`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${u}</div>`:Q}
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(g)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-header">
          ...
          ${!1!==this._config.header_show_stats?this._renderHeaderChips(s):Q}
        ...
        <div class="dash-body">
          ...
          ${r?this._renderFavoritesSection(s):Q}
    ...
    `;return m}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=function(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const a of e){const e=[],n=[];if(Mi(a,t)){const o=Ri(a,t);o.length&&(e.push("alert"),n.push(...o));const r=Bi(a,t);null!==r&&r<=s&&(e.push("battery"),n.push(`battery ${Math.round(r)}%`));const l=Pi(a,t,i)?Li(a,t,i):null;l&&(e.push("update"),n.push(`update → ${l.next}`))}else e.push("offline"),n.push("offline");e.length&&o.push({device:a,kinds:e,detail:n})}const a={offline:0,alert:1,battery:2,update:3},n=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>n(e)-n(t)||e.device.name.localeCompare(t.device.name))}(e,this.hass.states,{batteryBelow:this._config.attention_battery,includeBeta:this._config.include_beta_updates}),i=!1===this._config.show_firmware_summary?[]:Ni(e),s=i.length>1;if(!t.length&&!s)return q``;const o={offline:"○",alert:"▲",battery:"▮",update:"↑"},a=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t));return q`
      <div class="attention">
        <div class="att-hdr" @click=${()=>{this._attentionOpen=!this._attentionOpen}}>
          ...
          ${t.length?q`<span class="att-count">${t.length}</span>`:Q}
          ${s?q`<span class="att-fw-chip">${i.length} firmware versions</span>`:Q}
        </div>
          ...
          <div class="att-body">
            ${t.map(e=>q`
              <button class="att-row att-${a(e)}" @click=${()=>{this._detailDevice=e.device.device_id}}>
                ...
                ${e.device.area?q`<span class="att-area">${e.device.area}</span>`:Q}
              </button>`)}
            ${s?q`
              <div class="att-fw">
                ...
                ${i.map(t=>q`
                  <div class="att-fw-row ${t.current?"current":""}">
                    ...
                    ${t.current?q`<span class="att-fw-tag">newest</span>`:Q}
                  </div>`)}
              </div>`:Q}
          </div>`:Q}
      ...
      <div class="view-tabs">
        ${e.map(e=>q`
          <button class="view-tab ${e.id===t?"active":""}"
            ...
            ${e.icon?q`<ha-icon class="view-tab-icon" .icon=${e.icon}></ha-icon>`:Q}
            <span>${e.name}</span>
          </button>`)}
    ...
    `],e([ve({attribute:!1})],ss.prototype,"hass",void 0),e([ve({type:Boolean})],ss.prototype,"preview",void 0),e([fe()],ss.prototype,"_config",void 0),e([fe()],ss.prototype,"_closedAreas",void 0),e([fe()],ss.prototype,"_entityListOpen",void 0),e([fe()],ss.prototype,"_graphData",void 0),e([fe()],ss.prototype,"_periodEnergy",void 0),e([fe()],ss.prototype,"_periodEnergyErrAt",void 0),e([fe()],ss.prototype,"_valveDragPos",void 0),e([fe()],ss.prototype,"_trvDragTemp",void 0),e([fe()],ss.prototype,"_cloudDetailOpen",void 0),e([fe()],ss.prototype,"_detailDevice",void 0),e([fe()],ss.prototype,"_detailHistoryRange",void 0),e([fe()],ss.prototype,"_activeViewId",void 0),e([fe()],ss.prototype,"_delegateNoticeDismissed",void 0),e([fe()],ss.prototype,"_tileBlockOverride",void 0),e([fe()],ss.prototype,"_tileChipOverride",void 0),e([fe()],ss.prototype,"_areaHeaderOverride",void 0),e([fe()],ss.prototype,"_attentionOpen",void 0),e([fe()],ss.prototype,"_tileShowGraphsOverride",void 0),e([fe()],ss.prototype,"_areaCustomizeOpen",void 0),ss=Ji=e([he("ha-device-dashboard")],ss);const os=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),os(e,t);return!0},as=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},ns=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),cs(t)}};function rs(e){void 0!==this._$AN?(as(this),this._$AM=e,ns(this)):this._$AM=e}function ls(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)os(s[e],!1),as(s[e]);else null!=s&&(os(s,!1),as(s));else os(this,e)}const cs=e=>{e.type==be&&(e._$AP??=ls,e._$AQ??=rs)};class ds extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),ns(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(os(this,e),as(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const ps=new WeakMap,hs=ye(class extends ds{render(e){return Q}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Q}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=ps.get(t);void 0===i&&(i=new WeakMap,ps.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?ps.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),us=ye(class extends xe{constructor(){super(...arguments),this.key=Q}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ie(e),this.key=t),i}}),gs=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"},{id:"lights",label:"What counts as a light"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],vs=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","Two things sit above all of it: your own Customize tweaks on a tile (stored in this browser, see Local tweaks) and, for blocks, whatever a saved custom style defines.","The editor flags the common cases for you — see Conflicts."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:["**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…). **Sensor chips** choose which measurements appear as little pills, in any style.","The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","The Device styling panel goes further and narrows to the device in front of you — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['A Shelly i3, i4 or UNI is a wall switch: it reports presses and controls nothing by itself. Nothing in Home Assistant can make it emit a press, so the card cannot "push" a channel for you.',"What it can do is run the same thing the physical button runs. Give a channel an action and its row becomes a key: tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.","A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to.","Channels you have not wired stay as read-only status rows showing the last event and when it fired, so a half-configured switch shows both."]},{id:"lights",title:"What counts as a light",body:["The **Lights** header chip counts `light` entities that are on. A relay or plug wired to a lamp is a `switch` as far as Home Assistant is concerned — it has no way to know what is on the other end of the wire, and neither does the card.","You do. Label those devices in Home Assistant (Settings → Areas & labels), then tick the label under **Header → What counts as a light**. Every `switch` on a labelled device is counted from then on. The picker only offers labels that exist on your devices, with how many carry each.","For the stragglers a label does not cover, name entities directly in the same panel. A device caught by both routes is still counted once."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is."]},{id:"local",title:"Local tweaks live in your browser",body:["The little Customize panel on a tile — which blocks, which chips, graphs on or off — is deliberately *not* saved to your dashboard. It is stored in the browser you did it in, so you can adjust a tile on your phone without changing what everyone else sees.","The catch: those tweaks sit above the config in every cascade. If a YAML edit seems to be ignored on one device only, that is usually why.","Each tile has a reset in its own Customize panel, and **◆ Defaults → Clear local tweaks** wipes all of them for this browser at once."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running.",'**Beta firmware does not count as an update.** A Shelly exposes a `beta_firmware` entity that is on nearly permanently — on one real fleet that was 21 of 25 "available updates". Turn on `include_beta_updates` if you actually run betas.']},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],fs=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Card & Theme → scroll to the room picker at the bottom.","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["This mirrors the physical button rather than driving it — both paths keep working independently."],steps:["Device styling → pick the switch → Input actions.",'For a channel, choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["◆ Defaults → Colour theme.","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Card & Theme → Tiles → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],ms=e=>Math.random()<e;const bs=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},ys=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},xs=(e,t)=>{const[i,s]=[ys(e),ys(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function ws(e,t,i,s,o,a){let n=i;for(let i=0;i<40;i++){const i=bs(e,t,n);if(xs(i,s)>=o)return i;if(n+=a?2:-2,n>98||n<2)break}return bs(e,t,a?98:2)}var ks;const _s=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let As=!1;const Cs=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Ss=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Es=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Ts=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let zs=ks=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._localTweaksCleared=null,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;t?.tab&&t.section&&t.flash&&this._gotoControl(t.tab,t.section,t.flash)},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=si(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=gs.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1,this._openSections={...this._openSections,[t]:!0},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(si(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      <div class="help-topic ${t?"open":""}">
        ...
        ${t?q`
          <div class="help-topic-body">
            ...
            ${e.steps?q`<ol>${e.steps.map(e=>q`<li>${this._helpText(e)}</li>`)}</ol>`:Q}
          </div>`:Q}
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${i?q`<button class="color-reset" @click=${n}>↺</button>`:Q}
          ${this._styleClipFeedback?q`<span class="clip-feedback">${this._styleClipFeedback}</span>`:Q}
        </div>
        ${i&&c?q`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>a.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),o=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return q`
          <div class="room-row fav-room-row">
            ...
            ${o?q`<button class="room-reset-btn" title="Set Favourites style to default"
              @click=${e=>{e.stopPropagation(),this._clearAreaStyle("Favourites")}}>↺</button>`:Q}
          ...
          ${s?q`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id,a=t.area?q`<span class="fav-dev-area">${t.area}</span>`:Q;return q`
                    <div class="room-device-row ${o?"selected":""}">
                      ${a}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?q`<span class="dev-style-dot"></span>`:Q}
                      <label class="sw">
                      ...
                      ${s?q`<button class="room-reset-btn" title="Set device style to default"
                        @click=${e=>{e.stopPropagation(),this._clearDeviceStyle(t.device_id)}}>↺</button>`:Q}
      ...
      ${this._xcAdding||null!==this._xcEditIndex?Q:q`
      ...
      ${this._xcAdding?q`
        <div class="field">
          ...
          ${this._xcImportLoading?q`<div class="dp-hint-inline">Loading cards…</div>`:Q}
          ${this._xcImportCards?this._xcImportCards.length?q`
            ...
            </div>`:q`<div class="dp-hint-inline">No cards found on that dashboard.</div>`:Q}
        </div>
        <div class="field">
      ...
      ${this._xcDraft?q`
        ...
        </div>`:Q}`,o=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):Q;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",o,s)}_renderCheckDropdown(e,t,i,s,o,a){const n=this._openDiscDropdown===e,r=new Set(s),l=r.size;return q`
      <div class="field">
      ...
      ${t?q`
        ...
        ${this._renderCheckDropdown("disc-int","Hide integrations",s.integrations.map(e=>({value:e,label:Bt(e)})),e.exclude_integrations??[],e=>this._set("exclude_integrations",e),"Tick the integrations to drop. The built-in list (phones, browsers, routers…) is always hidden on top of these.")}
      ...
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>r(e,t,i))}
              ${e.length<ks.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Q}
            </div>`)}
      ...
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${g&&!v?q`<span class="dev-style-hint">Recommended: ${g}</span>`:Q}
          ${v?q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:Q}
        </div>
      ...
      <div class="dev-style-panel">
        ...
        <div class="field" style="margin-bottom:6px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
            Type
            ${h?.model?q`<span class="dev-style-hint">${h.model}</span>`:Q}
            ${t.profile?q`<button class="color-reset"
              @click=${()=>this._setDeviceStyle(e,{profile:void 0})}>↺ auto</button>`:Q}
          </div>
          <select class="inline-text" style="width:100%"
        ...
        ${(()=>{const i=h?Dt(h):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&h?yt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(a);return c&&"default"!==c?Q:q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    ${"dim"===t?.hold_action?.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=a(i.target.value);n(e.entityId,{hold_action:{...t?.hold_action??{action:"dim"},entity:s}})}}/>`:Q}
                  </div>
                  ${"dim"===t?.hold_action?.action?q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=i.target.value,o="perform-action"===t.double_tap_action.action?{perform_action:s.trim()||void 0}:{entity:a(s)};n(e.entityId,{double_tap_action:{...t.double_tap_action,...o}})}}/>`:Q}
                  </div>
                  ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                    <div class="hint" style="margin:-4px 0 8px 34%">
        ...
        ${(()=>{const i=h?.area?this._config.area_styles?.[h.area]?.sensors:void 0;return this._chipPicker(t.sensors,i?.length?i:this._config.sensors,i?.length?`area (${h?.area})`:"global",t=>this._setDeviceStyle(e,{sensors:t}),o?s.chips:void 0)})()}`:Q}
      ...
      <div class="field" style="margin-bottom:4px">
        ${void 0!==t.header_chips?q`<button class="color-reset" style="margin-bottom:4px" @click=${()=>this._setAreaStyle(e,"header_chips",void 0)}>↺ Default</button>`:Q}
        <div class="pill-grp">
        ...
        <div class="color-row">
          ...
          ${t[s]?q`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:Q}
      ...
      <div class="rsp-panel">
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",o=t.buttonSize??"md",a="square"===i||"circle"===i,n="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",r=a?"sm"===o?"3px 5px":"lg"===o?"6px 12px":"4px 8px":"sm"===o?"2px 8px":"lg"===o?"6px 16px":"4px 12px",l="sm"===o?"10px":"lg"===o?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${n};padding:${r};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,u=t.buttonShape||t.buttonVariant||t.buttonSize;return q`
            <div class="btn-preview">
              ...
              ${u?q`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:Q}
            </div>
            <div class="field">
    ...
    `}_renderViewCard(e,t,i,s,o,a,n,r){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,n,r),u=n.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return q`
        ...
        ${l?q`
          <div class="view-card-body">
              ...
              <div class="view-dev-list">
                ${De(n,e=>e.device_id,t=>q`
                  <label class="view-dev-row">
                    ...
                    ${t.area?q`<span class="view-dev-area">${t.area}</span>`:Q}
                  </label>`)}
              </div>
            </div>
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?q`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:Q}
            </div>`)}
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?q`<button class="color-reset" @click=${()=>g("columns",void 0)}>↺</button>`:Q}
            </div>
      ...
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[o]?q`<button class="color-reset" @click=${()=>s(o)}>↺</button>`:Q}
      ...
      ${(t.header_border_width??0)>0?o("Border color","header_border_color","#4ade80"):Q}
      `)}
      <!-- Visibility toggles -->
      <div class="tog-row" style="border:none;padding:4px 0 0">
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?q`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:Q}
          </div>
          <div class="pill-grp">
      ...
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[i]?q`<button class="color-reset" @click=${()=>{const e={...t};delete e[i],this._set("style",e)}}>↺</button>`:Q}
        </div>`},c=q`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?this._renderBgThumb(t.tile_bg_image):Q}
          ...
          ${t.tile_bg_image?q`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:Q}
        </div>
        ${t.tile_bg_image?q`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
    ...
    `,f=q`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${e.card_bg_image?this._renderBgThumb(e.card_bg_image):Q}
          ...
          ${e.card_bg_image?q`<button class="color-reset" @click=${()=>{const e={...this._config};delete e.card_bg_image,delete e.card_bg_image_size,this._emitNow(e)}}>↺</button>`:Q}
        </div>
        ${e.card_bg_image?q`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
      ...
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Q,body:r},lights:{icon:"💡",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"What counts as a light",badge:Q,body:m},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Q,body:v},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Q,body:f},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Q,body:d},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Q,body:h}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",o=t.tile_bg??"#1c1c1e",a=t.tile_border??"#2a2a30",n=t.tile_hover_bg??"rgba(255,255,255,0.07)",r=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",u=t.header_bg??"#1a1a2e",g=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",_=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,C=t.tile_radius??12,S=t.tile_border_width??1,E=t.header_radius??0,T=y>0?`${y}px solid ${x}`:"none",z=q`
      <div class="style-preview" style="font-family:${_};background:${s}">
        <div class="sp-header"
          style="background:linear-gradient(135deg,${u},${g});color:${v};border-radius:${E}px;padding:${Math.round(.55*b)}px 12px;border-bottom:${T};position:relative;overflow:hidden">
      ...
      ${t?this._renderRoomStylePanel(t):q`<div class="hint" style="margin:8px 2px">Pick a room to style its header, columns and tile look.</div>`}`;return this._sec("room-style","⌂","rgba(74,222,128,0.1)","#4ade80","Per-room styling",Q,i)}_globalSectionDescriptors(){return{...this._layoutSectionDescriptors(),...this._graphSectionDescriptors(),...this._sensorSectionDescriptors()}}_renderCustomTab(e){const t=new Set(["electrical","environmental","deviceinfo","alerts"]);return this._renderTabSections(e,this._globalSectionDescriptors(),(e,i)=>{const s=[...i].some(e=>t.has(e));return t.has(e)&&!s?q`<div class="hint" style="margin:4px 2px 8px">Global default — override per room (Layout & Style → room) or per device (Rooms & devices).</div>`:Q})}_graphSectionDescriptors(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},o=q`
      ...
      <div class="tog-row">
        ...
        <div class="color-row">
          ...
          ${a?q`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:Q}
        </div>`},l=q`
      ...
      ${a.filter(e=>!n.find(t=>t.key===e)).length?q`
        ...
        ${a.filter(e=>!n.find(t=>t.key===e)).map(e=>{const t=Jt.find(t=>t.key===e);return r(e,t?.label??e,(e=>s[e]??Jt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Q}
      <div class="field" style="margin-top:10px">
      ...
      </div>`;return{graphtype:{icon:"∿",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Graph Type",badge:Q,body:o},graphcolors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Per-sensor Colors",badge:Q,body:l},graphranges:{icon:"⇕",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Sensor Min / Max",badge:Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):Q,body:p}}}_sensorSectionDescriptors(){const e=this._config,t=e.sensors??[],i={};return Cs.forEach(s=>{const o=s.items.map(e=>e.key),a=o.filter(e=>t.includes(e)).length,n=o.every(e=>t.includes(e)),r=this._badge(`${a||"All"} / ${s.items.length}`,s.iconColor,s.iconBg),l=q`
      ...
      <div class="defaults-panel">
        <div class="dp-grid">
          ...
          <div class="dp-group">
            ...
            ${this._rolled?q`<div class="cr-rolled">${this._rolled} — previous colours are under ★ Saved</div>`:Q}
            ...
            ${"custom"===s?q`<div class="hint">Custom — your colours don't match a preset. 💾 Save keeps them; picking a preset stashes them under ★ first.</div>`:Q}
          </div>
      ...
      <div class="shell">
        ...
        ${this._snapMsg?q`<div class="snap-msg">${this._snapMsg}</div>`:Q}
        ${this._defaultsOpen?this._renderDefaultsPanel():Q}
        ${this._helpOpen?this._renderHelpPanel():Q}
      ...
      </div>`}};zs.ROLL_SLOT="Before roll",zs.ROW_MAX=3,zs.DRAG_SLOP=6,zs._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],zs.styles=[st,r`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],zs.prototype,"hass",void 0),e([fe()],zs.prototype,"_config",void 0),e([fe()],zs.prototype,"_tab",void 0),e([fe()],zs.prototype,"_styleScope",void 0),e([fe()],zs.prototype,"_cardThemeRoom",void 0),e([fe()],zs.prototype,"_newStyleName",void 0),e([fe()],zs.prototype,"_renamingStyle",void 0),e([fe()],zs.prototype,"_advanced",void 0),e([fe()],zs.prototype,"_defaultsOpen",void 0),e([fe()],zs.prototype,"_resetArmed",void 0),e([fe()],zs.prototype,"_xcPlacement",void 0),e([fe()],zs.prototype,"_xcRoom",void 0),e([fe()],zs.prototype,"_xcAdding",void 0),e([fe()],zs.prototype,"_xcEditIndex",void 0),e([fe()],zs.prototype,"_xcDraft",void 0),e([fe()],zs.prototype,"_xcDashboards",void 0),e([fe()],zs.prototype,"_xcImportCards",void 0),e([fe()],zs.prototype,"_xcImportLoading",void 0),e([fe()],zs.prototype,"_palettes",void 0),e([fe()],zs.prototype,"_paletteNaming",void 0),e([fe()],zs.prototype,"_paletteName",void 0),e([fe()],zs.prototype,"_expandedViewId",void 0),e([fe()],zs.prototype,"_openSections",void 0),e([fe()],zs.prototype,"_expandedRooms",void 0),e([fe()],zs.prototype,"_expandedRoomStyle",void 0),e([fe()],zs.prototype,"_selectedDeviceId",void 0),e([fe()],zs.prototype,"_devPanelAll",void 0),e([fe()],zs.prototype,"_conflictsOpen",void 0),e([fe()],zs.prototype,"_localTweaksCleared",void 0),e([fe()],zs.prototype,"_flashControl",void 0),e([fe()],zs.prototype,"_snapshots",void 0),e([fe()],zs.prototype,"_snapMenu",void 0),e([fe()],zs.prototype,"_snapName",void 0),e([fe()],zs.prototype,"_snapMsg",void 0),e([fe()],zs.prototype,"_helpOpen",void 0),e([fe()],zs.prototype,"_helpFilter",void 0),e([fe()],zs.prototype,"_helpTopic",void 0),e([fe()],zs.prototype,"_rolled",void 0),e([fe()],zs.prototype,"_deviceSearch",void 0),e([fe()],zs.prototype,"_styleClipFeedback",void 0),e([fe()],zs.prototype,"_openDiscDropdown",void 0),e([fe()],zs.prototype,"_iconPickerState",void 0),zs=ks=e([he("ha-device-dashboard-editor")],zs);let Is=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Q}};Is.styles=r`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Is.prototype,"hass",void 0),e([ve()],Is.prototype,"entity",void 0),e([ve({attribute:!1})],Is.prototype,"features",void 0),e([fe()],Is.prototype,"_el",void 0),Is=e([he("hdd-delegated")],Is);let Ms=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Q}};Ms.styles=r`
    :host { display: block; }
    :host > * { width: 100%; }
