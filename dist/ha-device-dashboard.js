...
`;function qe(e,t,i="ts-hero-name"){return q`
    ...
    <div class="input-row ${i.isButton?"btn-mode":i.isOn?"active":""}">
      ...
      ${function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputSelectChip(t,i);if(!s)return o?Ze(e,o):Z;const a=e.inputHasHold(t,i),n=()=>e.endInputHold();return q`
    ...
    <div class="tile-effects" @click=${e=>e.stopPropagation()}>
      <select class="effect-sel"
        ...
        ${s.length?q`
          <optgroup label="Sound reactive">${s.map(n)}</optgroup>`:Z}
...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function at(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    <div class="ts-inputs" style="--ts-accent:${i}">
      ...
      ${a.length&&e.showEl("keypad")?q`
        <div class="ts-keys" style="--keys:${r}"
          @click=${e=>e.stopPropagation()}>
          ${a.map(i=>function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputActionState(t,i),a=e.inputHasHold(t,i),n=()=>e.endInputHold(),r=i.label&&i.label.toLowerCase()!==s.toLowerCase()?i.label:"";return q`
    <button
      ...
      ${r&&e.showEl("target_state")?q`<span class="ts-key-sub">${r}</span>`:Z}
    ...
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,o=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),a="W"===e.label||"A"===e.label?"left":"right",n=(h+s*("left"===a?-1:1)).toFixed(1),r=(u+8).toFixed(1),l="left"===a?"start":"end";return G`
            ...
            <text x="${n}" y="${r}" font-size="8" fill="${e.color}" text-anchor="${l}" dominant-baseline="hanging" font-family="monospace" font-weight="700" opacity="${i?.95:.5}">${x(e.val,e.label)} ${e.label}</text>`})}
      </svg>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n):Z}
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:n}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=i.max??Math.max(...e),n=o-s||1,r=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/n*(p-2*h),m=e.indexOf(o);v=r(null,m),f=l(o);const b=c.map((e,t)=>`${r(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      <div class="ts-spark-bottom">
        <div>
          <div class="ts-spark-big" style="color:${i?s:"var(--sc-text-muted)"}">${null!=r.power?r.power.toFixed(r.power<10?1:0):"—"}</div>
          <div class="ts-spark-sub">${i?"W · now":"W · idle"}</div>
        </div>
        ${e.showEl("secondary")?q`<div class="ts-spark-meta">
          ${null!=r.voltage?q`<div class="ts-spark-mrow">${r.voltage.toFixed(1)} <b>V</b></div>`:Z}
          ${null!=r.current?q`<div class="ts-spark-mrow">${r.current.toFixed(2)} <b>A</b></div>`:Z}
          ${null!=r.energy?q`<div class="ts-spark-mrow">${r.energy.toFixed(2)} <b>kWh</b></div>`:Z}
          ${null!=r.temp?q`<div class="ts-spark-mrow">${r.temp.toFixed(1)} <b>°C</b></div>`:Z}
          ${null!=r.rssi?q`<div class="ts-spark-mrow">${r.rssi} <b>dBm</b></div>`:Z}
        </div>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipPowerGraph:!0}):Z}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:o,profile:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t);return q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        ${e.showEl("secondary")?q`<div class="ts-hbar-side">
          ${null!=n.voltage?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${n.voltage.toFixed(0)}</div></div>`:Z}
          ${null!=n.current?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${n.current.toFixed(2)}</div></div>`:Z}
          ${null!=n.temp?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${n.temp.toFixed(1)}</div></div>`:Z}
          ${null!=n.rssi?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${n.rssi}</div></div>`:Z}
        </div>`:Z}
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=n.energy?q`<span class="ts-hbar-badge">${n.energy.toFixed(2)} kWh</span>`:Z}
          ${null!=n.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${Wt(n.uptime)}</span>`:Z}
        </div>
        ${r&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Z}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:n}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${r})"/>
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Z,f=(e,t,i=!1)=>q`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=r.power?f("Power",Ft(r.power),!0):Z}
      ${e.showEl("secondary")?q`
        ${null!=r.voltage?f("Voltage",`${r.voltage.toFixed(1)} V`):Z}
        ${null!=r.current?f("Current",`${r.current.toFixed(3)} A`):Z}
        ${null!=r.energy?f(r.energyLabel,Nt(r.energy)):Z}
        ${null!=r.temp?f("Temp",`${r.temp.toFixed(1)} °C`):Z}
        ${null!=r.rssi?f("WiFi",`${r.rssi} dBm`):Z}`:Z}
      ${null!=r.uptime&&e.showEl("uptime")?f("Uptime",Wt(r.uptime)):Z}
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n,{skipGraphs:!0}):Z}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:n}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${n} ${d},${p-h} 0,${p-h}" fill="url(#${r})"/>
    <polyline points="${n}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Z;return q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-num" style="color:${i?s:"var(--sc-text-muted)"}">${null!=r.power?r.power.toFixed(r.power<10?1:0):"—"}</div>
      ...
      <div class="ts-hero-foot">
        ${e.showEl("secondary")?q`<div class="ts-chips">
          ${null!=r.voltage?q`<span class="ts-chip">${r.voltage.toFixed(1)} V</span>`:Z}
          ${null!=r.current?q`<span class="ts-chip">${r.current.toFixed(2)} A</span>`:Z}
          ${null!=r.energy?q`<span class="ts-chip">${r.energy.toFixed(2)} kWh</span>`:Z}
          ${null!=r.temp?q`<span class="ts-chip">${r.temp.toFixed(1)} °C</span>`:Z}
          ${null!=r.rssi?q`<span class="ts-chip">${r.rssi} dBm</span>`:Z}
        </div>`:Z}
        ${e.showEl("uptime")?q`<span class="ts-uptime">${r.uptime?Wt(r.uptime):""}</span>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,n):Z}
    </div>`}(e)}}const ji=140,Hi=70;function Ui(e){const{device:t,isOn:i,accent:s,online:o,hass:a,profile:n}=e,r=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!r)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(r.entityId.startsWith("switch.")||"dimmer"!==n.type&&"rgb"!==n.type)return q`
      ...
      </div>`;const c=i?Math.max(1,r.brightness??1):0,d=!!r.colorModes?.length,p=d&&(r.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&r.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",u=r.whiteValue??0,g=a.states[r.entityId],v=g?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&r.rgbColor?(()=>{const[e,t,i]=r.rgbColor,s=Math.max(e,t,i),o=s-Math.min(e,t,i);let a=0;o>0&&(a=s===e?((t-i)/o+6)%6:s===t?(i-e)/o+2:(e-t)/o+4);const n=0===s?0:o/s,l=(e=>e*Math.PI/180)(60*a-90);return{x:Hi+62*n*Math.cos(l),y:Hi+62*n*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      <div class="ts-light-top">
        <div class="ts-light-name"><span class="dot ${o?"online":"offline"}"></span>${t.name}</div>
        <button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${i?"ON":"OFF"}</button>
      </div>
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${ji}" height="${ji}" viewBox="0 0 ${ji} ${ji}"
            ...
            <foreignObject x="0" y="0" width="${ji}" height="${ji}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${ji}px;height:${ji}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${Hi}" cy="${Hi}" r="${Hi}" fill="url(#${_})" opacity="${i?1:.3}"/>
      ...
      ${e.showEl("effects")?Ke(f,m,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e})):Z}
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Ft(l.power)}</div>`:Z}
    </div>`}function Wi(e,t){const{device:i,profile:s,config:o,hass:a,online:n}=e,r=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),u=e.getPower(i),g=e.getSensors(i),v=e.getInputChannels(i),f=r?.isOn??!1,m=void 0!==r?.brightness,b=r&&m&&f?Math.max(1,r.brightness??1):0,y=!!r?.colorModes?.length,x=r?.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",w=!!r?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Pt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=tt(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?tt(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?tt(i,!0,"--ent-spd:1","tile-icon"):q``}else a=q``;const p=r?e.renderEntityAnim(r.entityId,f,i.device_id):q``;return q`
        <div class="tile-top">
      ...
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=r?a.states[r.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,o=r?.whiteValue??0;return r&&m?q`
        ...
        `:Z}
        ${Ke(i,s,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e}))}
      ...
      `;default:return q``}var C}const qi=255;function Gi(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=n.rssi?q`<div class="ds-signal">Wi-Fi: ${qt(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?q` · Up ${Wt(n.uptime)}`:Z}</div>`:Z}
    ...
    ${s.length>1?q`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,n=o?.attributes?.friendly_name??s.entity_id,r=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(r)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
    ...
    ${Zi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/qi*100);return q`
    <div class="ds-section">
    ...
    </div>`}function Vi(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const a=(t,s)=>{const o=i.states[t.entity_id],a=o?.attributes?.friendly_name??t.entity_id,n=o?.state??"unknown",r=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===n,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      ...
      </div>`},n=o.filter(e=>"primary"===lt(e)),r=o.filter(e=>"config"===lt(e)),l=o.filter(e=>"diagnostic"===lt(e));return q`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${n.map(e=>a(e,!1))}
      ${r.length?q`<div class="ds-ent-subgroup">Configuration</div>${r.map(e=>a(e,!0))}`:Z}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,T=s[0].t,E=s[s.length-1].t,M=E-T||1,O=e=>(e.t-T)/M*a,D=e=>n-4-(e.v-S)/I*(n-8),R=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=O(s[0]).toFixed(1),P=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,$=A[A.length-1],L=$%1==0?`${$}`:$.toFixed(1),F=Math.max(...A),N=Math.min(...A);let j=A.indexOf(F),H=A.indexOf(N);j<0&&(j=0),H<0&&(H=0);const U=O(s[j]).toFixed(1),W=D(s[j]).toFixed(1),V=O(s[H]).toFixed(1),X=D(s[H]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+E)/2),K=f/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Z:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),n=T+o*M;let r=s[0];for(const e of s)Math.abs(e.t-n)<Math.abs(r.t-n)&&(r=e);const l=O(r),c=D(r),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const h=t.parentElement,u=h?.querySelector(".spark-tooltip");if(u){const e=u.querySelector(".spark-tooltip-val"),t=u.querySelector(".spark-tooltip-time");e&&(e.textContent=`${r.v%1==0?String(r.v):r.v.toFixed(1)} ${w}`),t&&(t.textContent=y(r.t)),u.style.left=`${(l/a*100).toFixed(1)}%`,u.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                `:Z}
                ${"bar"!==h&&g?G`
                  <polygon points="${R} ${a},${n-4} ${B},${n-4}" fill="url(#${P})"/>
                `:Z}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=O(e)-t/2,o=D(e),r=n-4-o;return G`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,r).toFixed(1)}" rx="${u}" fill="${_}" opacity="0.75"/>`}):G`
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const o=e=>{const o=this._trvTempFromEvent(e,s,t,i,a);null!=o&&(this._trvDragTemp=o)},r=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(n,l),s.removeEventListener("pointermove",o),s.removeEventListener("pointerup",r)};s.addEventListener("pointermove",o),s.addEventListener("pointerup",r)}}>
        <defs>
    ...
    `}_trvTempFromEvent(e,t,i,s,o){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const n=(e.clientX-a.left)*(160/a.width),r=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(r-70,n-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=o||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),o=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(o-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const n=(a-210+360)%360;return n>300?null:Math.round(n/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[o,a]=i(e,s),[n,r]=i(t,s);return`M ${o} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${n} ${r}`},o=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,n=(e=>210+e/100*300)(a),[r,l]=i(n,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=o?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},o=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",o)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",o)}:void 0;return G`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${o?"valve-interactive":""}"
        ...
        ${t>0?G`<path d="${s(210,n,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:Z}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:o,isHeating:a,valveOpen:n,hasFan:r}=i,l=e.type;if("relay"===l||"plug"===l)return r?G`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?G`<svg class="tile-icon tile-icon-valve ${n?"on":""}" viewBox="0 0 20 20">
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        </div>`:Z,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=u&&r?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,x=y?.attributes?.effect_list??[],w=y?.attributes?.effect??null,k=u?q`
    ...
    `:Z;return p.length||u||o||a||n||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${_e(l)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?Wi(a,e[0]):q`<div class="tile-row">${e.map(e=>Wi(a,e))}</div>`)}
        </div>`}const f=e.area??"",m=this._tileAccent(e,f);return q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===u?Ni(this._buildTileCtx(e,s,m),v):"light-control"===u?Ui(this._buildTileCtx(e,s,m)):"climate-control"===u?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return Ge(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(o.states[r.entity_id]?.state??"")||null;return q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ...
        ${e.showEl("heating_badge")?q`<div style="display:flex;align-items:center;gap:6px">
          ${n?q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>`:Z}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"cover-control"===u?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=o.position??("open"===o.state?100:0),n="opening"===o.state||"closing"===o.state,r=Math.ceil(a/100*et.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${et.map((e,t)=>G`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<r?"0.85":"0.1"}"/>`)}
        </svg>
        ${n&&e.showEl("moving_label")?q`<span class="ts-cover-state">${"opening"===o.state?"▲ Opening…":"▼ Closing…"}</span>`:Z}
      </div>`:Z}
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"sensor-card"===u?function(e){const{device:t,accent:i,online:s,hass:o,config:a}=e;let n;for(const e of Li)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=o.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const r=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return t&&Fi.includes(t.attributes?.device_class??"")});if(!n&&!r)return Ge(t,s,"ts-sensor","No sensor");if(n){const r=o.states[n.entity_id],l=parseFloat(r?.state??""),c=r?.attributes?.unit_of_measurement??"",d=r?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const h=e.getGraphPoints(n.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${e.showEl("graph")?q`<div class="ts-sensor-spark">
          ${e.renderSparklinesFiltered(t,e.getGraphEntities(t).filter(e=>e.entityId===n.entity_id))}
        </div>`:Z}
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"input-control"===u?at(this._buildTileCtx(e,s,m)):"scene-button"===u?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),n=o.device_styles?.[t.device_id],r=tt(n?.tile_icon??"pulse",!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      ${e.showEl("icon")?q`<div class="ts-scene-icon-wrap">${r}</div>`:Z}
    ...
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(Xi._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return q``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return q``;const o=s.reduce((e,t)=>e+(this._getPower(t)??0),0),a=s.filter(e=>this._isOnline(e)).length,n=Ti(this._config,this._getActiveView()??void 0),r=this._config.area_styles?.Favourites?.tile_style;return q`
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,o=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(ri),a=e=>o.has(e),n={},r=(e,t)=>{n[e]||(n[e]={sum:0,count:0}),n[e].sum+=t,n[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&a(o.key)&&r(o.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ni){if("energy"===t.key&&a("energy")&&"total"!==l){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){n.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",n.energy.sum)});continue}if(s||n.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?Nt(i):"…"})}continue}const i=n[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return Ft(t);case"energy":return Nt(t);case"voltage":return jt(t);case"current":return Ht(t);case"temperature":return Ut(t);case"humidity":return Xt(t);case"co2":return Yt(t);case"illuminance":return Qt(t);case"battery":return Kt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),o=this._config.area_styles?.[t]?.header_chips,a=void 0!==s?new Set(s):void 0!==o?new Set(o):new Set(ri),n=[];for(const e of ni)i.has(e.key)&&n.push({key:e.key,label:e.label,visible:a.has(e.key)});return n}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&t.add(o.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,o=(t,s)=>{const o=new Set(i.filter(e=>e.visible).map(e=>e.key));s?o.add(t):o.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>o.has(e)))};return q`
      ...
      </div>`}_renderAreaSection(e,t){if(!t.length)return q``;const i=e||"No Area",s=this._closedAreas.has(e),o=t.filter(e=>this._isOnline(e)).length,a=this._config.area_styles?.[i],n=Ti(this._config,this._getActiveView()??void 0,a),r={};if(a){if((a.borderColor||a.borderWidth)&&(r.border=`${a.borderWidth??1}px ${a.borderStyle??"solid"} ${a.borderColor??"var(--divider-color)"}`),a.borderRadius&&(r.borderRadius=`${a.borderRadius}px`,r.overflow="hidden"),a.bg_image){r["--area-bg-image"]=`url("${a.bg_image}")`,r["--area-bg-image-sz"]="ambient"===a.bg_image_mode?"cover":"stretch"===a.bg_image_size?"100% 100%":a.bg_image_size??"cover";const e=a.bg_image_pos;r["--area-bg-pos"]="top"===e?"center top":"bottom"===e?"center bottom":"center"}if(a.headerBgColor&&(r["--area-header-bg"]=a.headerBgColor2?`linear-gradient(${a.headerBgDir??"to right"}, ${a.headerBgColor}, ${a.headerBgColor2})`:a.headerBgColor),a.textColor&&(r["--area-header-color"]=a.textColor),a.fontSize&&(r["--area-name-size"]=`${a.fontSize}px`),a.fontWeight&&(r["--area-name-weight"]=a.fontWeight),a.tileBgColor&&(r["--sc-tile-bg"]=a.tileBgColor),a.tileBorderColor&&(r["--sc-tile-border"]=a.tileBorderColor),null!=a.tileBorderRadius&&(r["--tile-radius"]=`${a.tileBorderRadius}px`),null!=a.tileGap&&(r["--tile-gap"]=`${a.tileGap}px`),a.tileTextColor&&(r["--sc-text-primary"]=a.tileTextColor),a.accentColor&&(r["--sc-accent"]=a.accentColor,r["--sc-graph-line"]=a.accentColor,r["--sc-accent-glow"]=`${a.accentColor}59`),a.buttonShape||a.buttonVariant||a.buttonSize){const e=a.buttonShape??"pill",t=a.buttonVariant??"fill",i=a.buttonSize??"md",s="square"===e||"circle"===e,o={sm:"2px 8px",md:"4px 11px",lg:"6px 16px"},n={sm:"3px 5px",md:"4px 8px",lg:"6px 12px"};r["--tog-radius"]="pill"===e?"20px":"rect"===e||"square"===e?"6px":"50%",r["--tog-pad"]=s?n[i]??n.md:o[i]??o.md,r["--tog-fsize"]="sm"===i?".65em":"lg"===i?".8em":".72em",r["--tog-aspect"]=s?"1":"auto","outline"===t?(r["--tog-on-bg"]="transparent",r["--tog-on-border"]="1px solid var(--sc-accent)",r["--tog-on-color"]="var(--sc-accent)",r["--tog-on-shadow"]="none"):"ghost"===t&&(r["--tog-on-bg"]="transparent",r["--tog-on-border"]="none",r["--tog-on-color"]="var(--sc-accent)",r["--tog-on-shadow"]="none")}}const l=a?.tile_style,c=this._getAreaChips(t,i);return q`
      <div class="area-section ${s?"closed":""} ${a?.bg_image&&"ambient"===a.bg_image_mode?"area-bg-ambient":""}" style=${_e(r)}>
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
        ...
        </ha-card>`;const o=this._getActiveView(),a=o?this._applyViewFilter(s,o):s,n=this._groupByArea(a),r=!o||!0===o.show_favourites,l=!o||!1!==o.show_rooms,c=!0===this._config.header_show_cloud?Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")):[],d=c.filter(e=>"on"===e.state),p=c.filter(e=>"off"===e.state),h=c.filter(e=>"unavailable"===e.state),u=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),g=this._buildCardStyles(),v=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,f=v?Gi(this._buildTileCtx(v,this._profile(v),this._tileAccent(v,v.area??""))):Z,m=q`
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(g)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${r?this._renderFavoritesSection(s):Z}
          ${l?De([...n.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):q`<div class="device-grid" style="--cols:${o?.columns??this._config.columns??3}">
                ${De(a,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
        ${this._renderExtraCards(this._config.footer_cards)}
      </ha-card>
    `;return m}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=function(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const i of e){const e=[],a=[];if(Mi(i,t)){const o=Oi(i,t);o.length&&(e.push("alert"),a.push(...o));const n=Di(i,t);null!==n&&n<=s&&(e.push("battery"),a.push(`battery ${Math.round(n)}%`));const r=Ri(i,t);r&&(e.push("update"),a.push(r.next?`update → ${r.next}`:"update available"))}else e.push("offline"),a.push("offline");e.length&&o.push({device:i,kinds:e,detail:a})}const a={offline:0,alert:1,battery:2,update:3},n=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>n(e)-n(t)||e.device.name.localeCompare(t.device.name))}(e,this.hass.states,{batteryBelow:this._config.attention_battery}),i=!1===this._config.show_firmware_summary?[]:Pi(e),s=i.length>1;if(!t.length&&!s)return q``;const o={offline:"○",alert:"▲",battery:"▮",update:"↑"},a=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t));return q`
      <div class="attention">
    ...
    `],e([ve({attribute:!1})],Ji.prototype,"hass",void 0),e([ve({type:Boolean})],Ji.prototype,"preview",void 0),e([fe()],Ji.prototype,"_config",void 0),e([fe()],Ji.prototype,"_closedAreas",void 0),e([fe()],Ji.prototype,"_entityListOpen",void 0),e([fe()],Ji.prototype,"_graphData",void 0),e([fe()],Ji.prototype,"_periodEnergy",void 0),e([fe()],Ji.prototype,"_periodEnergyErrAt",void 0),e([fe()],Ji.prototype,"_valveDragPos",void 0),e([fe()],Ji.prototype,"_trvDragTemp",void 0),e([fe()],Ji.prototype,"_cloudDetailOpen",void 0),e([fe()],Ji.prototype,"_detailDevice",void 0),e([fe()],Ji.prototype,"_detailHistoryRange",void 0),e([fe()],Ji.prototype,"_activeViewId",void 0),e([fe()],Ji.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Ji.prototype,"_tileBlockOverride",void 0),e([fe()],Ji.prototype,"_tileChipOverride",void 0),e([fe()],Ji.prototype,"_areaHeaderOverride",void 0),e([fe()],Ji.prototype,"_attentionOpen",void 0),e([fe()],Ji.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Ji.prototype,"_areaCustomizeOpen",void 0),Ji=Xi=e([he("ha-device-dashboard")],Ji);const es=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),es(e,t);return!0},ts=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},is=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),as(t)}};function ss(e){void 0!==this._$AN?(ts(this),this._$AM=e,is(this)):this._$AM=e}function os(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)es(s[e],!1),ts(s[e]);else null!=s&&(es(s,!1),ts(s));else es(this,e)}const as=e=>{e.type==be&&(e._$AP??=os,e._$AQ??=ss)};class ns extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),is(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(es(this,e),ts(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const rs=new WeakMap,ls=ye(class extends ns{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=rs.get(t);void 0===i&&(i=new WeakMap,rs.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?rs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),cs=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ee(e),this.key=t),i}}),ds=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],ps=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","Two things sit above all of it: your own Customize tweaks on a tile (stored in this browser, see Local tweaks) and, for blocks, whatever a saved custom style defines.","The editor flags the common cases for you — see Conflicts."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:["**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…). **Sensor chips** choose which measurements appear as little pills, in any style.","The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","The Device styling panel goes further and narrows to the device in front of you — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['A Shelly i3, i4 or UNI is a wall switch: it reports presses and controls nothing by itself. Nothing in Home Assistant can make it emit a press, so the card cannot "push" a channel for you.',"What it can do is run the same thing the physical button runs. Give a channel an action and its row becomes a key: tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.","A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to.","Channels you have not wired stay as read-only status rows showing the last event and when it fired, so a half-configured switch shows both."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is."]},{id:"local",title:"Local tweaks live in your browser",body:["The little Customize panel on a tile — which blocks, which chips, graphs on or off — is deliberately *not* saved to your dashboard. It is stored in the browser you did it in, so you can adjust a tile on your phone without changing what everyone else sees.","The catch: those tweaks sit above the config in every cascade. If a YAML edit seems to be ignored on one device only, that is usually why.","Each tile has a reset in its own Customize panel, and **◆ Defaults → Clear local tweaks** wipes all of them for this browser at once."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running."]},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],hs=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Card & Theme → scroll to the room picker at the bottom.","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["This mirrors the physical button rather than driving it — both paths keep working independently."],steps:["Device styling → pick the switch → Input actions.",'For a channel, choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["◆ Defaults → Colour theme.","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Card & Theme → Tiles → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],us=e=>Math.random()<e;const gs=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},vs=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},fs=(e,t)=>{const[i,s]=[vs(e),vs(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function ms(e,t,i,s,o,a){let n=i;for(let i=0;i<40;i++){const i=gs(e,t,n);if(fs(i,s)>=o)return i;if(n+=a?2:-2,n>98||n<2)break}return gs(e,t,a?98:2)}var bs;const ys=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let xs=!1;const ws=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],ks=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],_s=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],As=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Cs=bs=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._localTweaksCleared=null,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;t?.tab&&t.section&&t.flash&&this._gotoControl(t.tab,t.section,t.flash)},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=si(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=ds.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1,this._openSections={...this._openSections,[t]:!0},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(si(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </div>`}_renderHelpPanel(){const e=this._helpFilter.trim().toLowerCase(),t=t=>!e||t.title.toLowerCase().includes(e)||t.body.some(t=>t.toLowerCase().includes(e))||(t.steps??[]).some(t=>t.toLowerCase().includes(e)),i=ps.filter(t),s=hs.filter(t);return q`
      ...
      </span>`}_chipPicker(e,t,i,s,o){const a=t??[],n=void 0!==e,r=t=>!o||o.has(t)||(e??[]).includes(t),l=ws.map(e=>({...e,items:e.items.filter(e=>r(e.key))})).filter(e=>e.items.length),c=ws.flatMap(e=>e.items.map(e=>e.key)).filter(r),d=new Set(n?e:a.length?a:c);return q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${n?"Custom selection":`Inheriting from ${i}`}</span>
          ${this._selAllNone(()=>s([...c]),()=>s([]))}
          ${n?q`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:q`<button class="color-reset" @click=${()=>s([...d])}>Customize</button>`}
        </div>
        ${l.map(t=>q`
          <div class="chip-picker-grp">
            ...
            <div class="pill-grp">
              ${t.items.map(t=>q`
                <span class="pill ${d.has(t.key)?"on":""} ${n?"":"dim"}"
                  @click=${()=>(t=>{const i=n?[...e]:[...d],o=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(o.length?o:void 0)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${i?q`<button class="color-reset" @click=${n}>↺</button>`:Z}
          ...
          ${s?q`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id,a=t.area?q`<span class="fav-dev-area">${t.area}</span>`:Z;return q`
      ...
      ${l.map(t=>{const i=t||"No Room",a=r.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return q`
          <div class="room-row">
          ...
          ${c?q`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${a.length?a.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id;return q`
                    <div class="room-device-row ${o?"selected":""}">
      ...
      ${this._xcDraft?q`
        ...
        </div>`:Z}`,o=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):Z;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",o,s)}_renderCheckDropdown(e,t,i,s,o,a){const n=this._openDiscDropdown===e,r=new Set(s),l=r.size;return q`
      <div class="field">
        <div class="field-lbl">${t}</div>
        <button class="check-dd-btn ${n?"open":""}"
          @click=${()=>{this._openDiscDropdown=n?null:e}}>
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const o=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${ls(e=>e?.focus())}/>`:q`<span class="pill ${e===o?"on":""}" @click=${()=>s(o)}>
                ${i.label||t}
      ...
      ${n?q`
        ...
        </div>`:Z}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,o=s?e.find(e=>e.device_id===s):null,a=o?Dt(o):null,n=this._styleScope,r=a?e.filter(e=>Dt(e).type===a.type).length:0,l=a?mt[a.type]||a.type:"",c=e=>q`
      ...
      <div class="dev-styling-tab">
        ...
        ${o&&a?q`
          <div class="pill-grp" style="margin-bottom:10px">
            <span class="pill ${"device"===n?"on":""}" @click=${()=>{this._styleScope="device"}}>This device</span>
            <span class="pill ${"profile"===n?"on":""}" @click=${()=>{this._styleScope="profile"}}>All ${l}${1!==r?"s":""} (${r})</span>
          </div>
          ${"device"===n?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&o?yt(a.type,o):void 0)??"default";return q`
        ...
        <div class="hint" style="margin:2px 2px 10px">Applies to all ${r} ${l} device${1!==r?"s":""}. A per-device setting still overrides.</div>
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>ks.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>r(e,t,i))}
              ${e.length<bs.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._allDevices().find(t=>t.device_id===e),s=i?yi(i,this.hass?.states??{}):null,o=!!s&&!this._devPanelAll,a=ks.map(e=>e.id),n=this._config.tile_layout??a,r=kt(n),l=kt(t.tile_layout)??null,c=t.entity_animations??{},d=i=>{const s=(l??r).includes(i),o=function(e,t,i,s){const o=wt(e).map(e=>[...e]);if(!i)return o.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(o.some(e=>e.includes(t)))return o;const a=e=>{const t=s.indexOf(e);return t<0?s.length:t},n=o.findIndex(e=>a(e[0])>a(t));return o.splice(n<0?o.length:n,0,[t]),o}(t.tile_layout??n,i,!s,a),c=JSON.stringify(o)===JSON.stringify(wt(n));this._setDeviceStyle(e,{tile_layout:c?void 0:o})},p=(t,i,s)=>{const o={...c[t]??{}};if("speed"===i){const e=Number(s);1===e?delete o.speed:o.speed=e}else"none"===s?delete o[i]:o[i]=s;const a={...c,[t]:o};o.on||o.off||o.speed||delete a[t],this._setDeviceStyle(e,{entity_animations:Object.keys(a).length?a:void 0})},h=this._allDevices().find(t=>t.device_id===e),u=h?Dt(h):null,g=u?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control",generic:"scene-button"}[u.type]:void 0,v=t.tile_style,f=t.power_monitor_variant??"big-number",m=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
      ...
      <div class="dev-style-panel">
        ...
        ${(()=>{const i=h?Dt(h):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&h?yt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(a);return c&&"default"!==c?Z:q`
            ${this._renderLayoutCanvas(t.tile_layout,n,t=>this._setDeviceStyle(e,{tile_layout:t}),o?s.blocks:void 0)}
            ${this._adv(q`
                <div class="field-lbl" style="margin:6px 0 4px">Visible blocks</div>
                <div class="block-toggles">
                  ${ks.filter(e=>"graph"!==e.id).filter(e=>!o||s.blocks.has(e.id)||(l??r).includes(e.id)).map(e=>{const t=null===l?r.includes(e.id):l.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>d(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ${(()=>{const i=h?fi(h,this.hass.states):[];if(!i.length)return Z;const s=t.input_actions??{},o=e=>Array.isArray(e)?e.join(", "):e??"",a=e=>{const t=e.split(",").map(e=>e.trim()).filter(Boolean);return t.length>1?t:t[0]||void 0},n=(t,i)=>{const o={...s};i?o[t]={...o[t]??{action:"none"},...i}:delete o[t],this._setDeviceStyle(e,{input_actions:Object.keys(o).length?o:void 0})};return q`
            ...
            ${i.map(e=>{const t=s[e.entityId]??s[String(e.channel)],i=t?.action??"none";return q`
                <div style="display:flex;gap:6px;align-items:center;margin-bottom:4px">
                  ...
                  <select class="inline-text" style="flex:1"
                    @change=${t=>{const i=t.target.value;n(e.entityId,"none"===i?null:{action:i})}}>
                ...
                ${"perform-action"===i?q`
                  <div style="display:flex;gap:6px;margin:0 0 6px 34%">
                    <input type="text" class="inline-text" style="flex:1" placeholder="script.hall_lights"
                      ...
                      @change=${t=>n(e.entityId,{perform_action:t.target.value.trim()||void 0})}/>
                    <input type="text" class="inline-text" style="flex:1" placeholder="target entity — optional"
                      .value=${o(t?.entity)}
                      @change=${t=>n(e.entityId,{entity:a(t.target.value)})}/>
                  </div>`:Z}
                ${"toggle"===i?q`
                ...
                ${"none"!==i?q`
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    <select class="inline-text" style="flex:1"
                      @change=${t=>{const i=t.target.value;n(e.entityId,{hold_action:"none"===i?void 0:{action:"dim"}})}}>
                    ...
                    ${"dim"===t?.hold_action?.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=a(i.target.value);n(e.entityId,{hold_action:{...t?.hold_action??{action:"dim"},entity:s}})}}/>`:Z}
                  </div>
                  ${"dim"===t?.hold_action?.action?q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    <select class="inline-text" style="flex:1"
                      @change=${t=>{const i=t.target.value;n(e.entityId,{double_tap_action:"none"===i?void 0:{action:i}})}}>
                    ...
                    ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=i.target.value,o="perform-action"===t.double_tap_action.action?{perform_action:s.trim()||void 0}:{entity:a(s)};n(e.entityId,{double_tap_action:{...t.double_tap_action,...o}})}}/>`:Z}
                  </div>
                  ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                    <div class="hint" style="margin:-4px 0 8px 34%">
                  ...
                  ${this._adv(q`
                    <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                      ...
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${t=>{const i=t.target.value.trim();n(e.entityId,{select_chip:i?{entity:i}:void 0})}}/>
                    </div>`)}`:Z}
              `})}
          `})()}
        ${!o||s.chips.size?q`
        ...
        ${this._adv(b.length?q`
          ...
          ${b.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,o=c[t.entity_id]?.on??"none",a=c[t.entity_id]?.off??"none",n=c[t.entity_id]?.speed??1;return q`
              <div class="ent-anim-row">
                ...
                <select class="anim-select" .value=${String(n)}
                  @change=${e=>p(t.entity_id,"speed",e.target.value)}>
                  <option value="0.25" ?selected=${.25===n}>0.25× Slowest</option>
                  <option value="0.5"  ?selected=${.5===n}>0.5× Slow</option>
                  <option value="1"    ?selected=${1===n}>1× Normal</option>
                  <option value="1.5"  ?selected=${1.5===n}>1.5× Fast</option>
                  <option value="2"    ?selected=${2===n}>2× Faster</option>
                  <option value="3"    ?selected=${3===n}>3× Rapid</option>
                  <option value="5"    ?selected=${5===n}>5× Frantic</option>
                </select>
              </div>`})}
        `:Z)}
      ...
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${o.map(t=>{const i=a.includes(t.key);return q`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?a.filter(e=>e!==t.key):[...a,t.key];var o;this._setAreaStyle(e,"header_chips",(o=s).length===ri.length&&ri.every(e=>o.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
    ...
    `}_renderViewCard(e,t,i,s,o,a,n,r){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,n,r),u=n.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return q`
      ...
      </div>`)}`,n=(e,i,s)=>{const o=t[i]??s;return q`
        <div class="color-row">
      ...
      ${n("Tile background","tile_bg","rgba(255,244,232,0.035)")}
      ${n("Tile border","tile_border","rgba(255,244,232,0.08)")}
      ${n("Tile hover BG","tile_hover_bg","rgba(255,244,232,0.06)")}
      ${n("Tile hover shadow","tile_hover_shadow","rgba(0,0,0,0.35)")}
      ${n("Sensor chip BG","tile_sensor_bg","rgba(255,244,232,0.045)")}
      ${n("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=q`
      <div class="subgroup-lbl">Brand</div>
      ${n("Accent / brand","accent_color","#c98a63")}
      ${n("Room header label","area_header_color","#c98a63")}

      <div class="subgroup-lbl">Text &amp; status</div>
      ${n("Text primary","text_primary","#ece5dc")}
      ${n("Text secondary","text_secondary","#b3a596")}
      ${n("Text muted","text_muted","#7e7265")}
      ${n("Online dot","online_color","#93b384")}
      ${n("Offline dot","offline_color","#d47f62")}
      ${n("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=q`
      <div class="field">
    ...
    `,g=q`
      ...
      ${n("Dashboard background","card_bg","#1e1a17")}
      <div class="field">
      ...
      <div class="style-preview" style="font-family:${_};background:${s}">
        ...
        <div class="sp-tile"
          ...
          <div class="sp-row sp-chips" style="color:${c};font-size:${(10*A).toFixed(0)}px">
            <span class="sp-chip" style="background:${r}">4.1 W</span>
            <span class="sp-chip" style="background:${r}">235 V</span>
            <span class="sp-chip" style="background:${r}">44.6 °C</span>
          </div>
        ...
        <div class="sp-tile"
          style="background:${n};border:${S}px solid ${a};border-radius:${C}px">
          <div class="sp-row" style="color:${l};font-size:${(13*A).toFixed(0)}px">
      ...
      </div>`)}`,a=e.graph_sensors??St,n=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],r=(e,t,i)=>{const o=s[e]??i,a=!!s[e];return q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${o}"></div>
      ...
      ${n.map(e=>r(e.key,e.label,e.default))}
      ${a.filter(e=>!n.find(t=>t.key===e)).length?q`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${a.filter(e=>!n.find(t=>t.key===e)).map(e=>{const t=Jt.find(t=>t.key===e);return r(e,t?.label??e,(e=>s[e]??Jt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
      ...
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const o=""===s.trim()?void 0:parseFloat(s),a={...c[e]??{}};void 0===o||isNaN(o)?delete a[i]:a[i]=o;const n={...c,[e]:a};a.min||0===a.min||a.max||0===a.max||delete n[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(n).length?n:void 0})},p=q`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=ii(i.key),a=!!Jt.find(e=>e.key===o),n=e.graph_sensors??St,r=n.some(e=>ii(e)===o);return q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=ds.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(ds.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};ds.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],a=e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t},n=o.length>1,r=e.findIndex(e=>e.id===this._tab);return q`
      <div class="shell">
        <div class="tab-nav-wrap">
          <button class="tab-arrow" title="Previous tab" ?disabled=${r<=0}
          ...
          <button class="tab-arrow" title="Next tab" ?disabled=${r>=e.length-1}
            @click=${()=>this._stepTab(1)}>›</button>
        </div>
      ...
      </div>`}};Cs.ROLL_SLOT="Before roll",Cs.ROW_MAX=3,Cs.DRAG_SLOP=6,Cs._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],Cs.styles=[st,r`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Cs.prototype,"hass",void 0),e([fe()],Cs.prototype,"_config",void 0),e([fe()],Cs.prototype,"_tab",void 0),e([fe()],Cs.prototype,"_styleScope",void 0),e([fe()],Cs.prototype,"_cardThemeRoom",void 0),e([fe()],Cs.prototype,"_newStyleName",void 0),e([fe()],Cs.prototype,"_renamingStyle",void 0),e([fe()],Cs.prototype,"_advanced",void 0),e([fe()],Cs.prototype,"_defaultsOpen",void 0),e([fe()],Cs.prototype,"_resetArmed",void 0),e([fe()],Cs.prototype,"_xcPlacement",void 0),e([fe()],Cs.prototype,"_xcRoom",void 0),e([fe()],Cs.prototype,"_xcAdding",void 0),e([fe()],Cs.prototype,"_xcEditIndex",void 0),e([fe()],Cs.prototype,"_xcDraft",void 0),e([fe()],Cs.prototype,"_xcDashboards",void 0),e([fe()],Cs.prototype,"_xcImportCards",void 0),e([fe()],Cs.prototype,"_xcImportLoading",void 0),e([fe()],Cs.prototype,"_palettes",void 0),e([fe()],Cs.prototype,"_paletteNaming",void 0),e([fe()],Cs.prototype,"_paletteName",void 0),e([fe()],Cs.prototype,"_expandedViewId",void 0),e([fe()],Cs.prototype,"_openSections",void 0),e([fe()],Cs.prototype,"_expandedRooms",void 0),e([fe()],Cs.prototype,"_expandedRoomStyle",void 0),e([fe()],Cs.prototype,"_selectedDeviceId",void 0),e([fe()],Cs.prototype,"_devPanelAll",void 0),e([fe()],Cs.prototype,"_conflictsOpen",void 0),e([fe()],Cs.prototype,"_localTweaksCleared",void 0),e([fe()],Cs.prototype,"_flashControl",void 0),e([fe()],Cs.prototype,"_snapshots",void 0),e([fe()],Cs.prototype,"_snapMenu",void 0),e([fe()],Cs.prototype,"_snapName",void 0),e([fe()],Cs.prototype,"_snapMsg",void 0),e([fe()],Cs.prototype,"_helpOpen",void 0),e([fe()],Cs.prototype,"_helpFilter",void 0),e([fe()],Cs.prototype,"_helpTopic",void 0),e([fe()],Cs.prototype,"_rolled",void 0),e([fe()],Cs.prototype,"_deviceSearch",void 0),e([fe()],Cs.prototype,"_styleClipFeedback",void 0),e([fe()],Cs.prototype,"_openDiscDropdown",void 0),e([fe()],Cs.prototype,"_iconPickerState",void 0),Cs=bs=e([he("ha-device-dashboard-editor")],Cs);let Ss=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Ss.styles=r`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Ss.prototype,"hass",void 0),e([ve()],Ss.prototype,"entity",void 0),e([ve({attribute:!1})],Ss.prototype,"features",void 0),e([fe()],Ss.prototype,"_el",void 0),Ss=e([he("hdd-delegated")],Ss);let zs=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};zs.styles=r`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],zs.prototype,"hass",void 0),e([ve({attribute:!1})],zs.prototype,"config",void 0),e([fe()],zs.prototype,"_el",void 0),zs=e([he("hdd-card")],zs);console.info("%c ha-device-dashboard %c lights-2026-08-23d ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
