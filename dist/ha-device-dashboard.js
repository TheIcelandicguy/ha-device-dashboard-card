          ...
          ${p?G`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${V}</span><span>${K}</span><span>now</span>
              </div>
        ...
        <div class="field">
          ...
          ${i?G`
            <ha-yaml-editor .hass=${this.hass} .defaultValue=${this._xcDraft}
              @value-changed=${e=>{!1!==e.detail?.isValid&&(this._xcLatest=e.detail.value)}}></ha-yaml-editor>`:G`
