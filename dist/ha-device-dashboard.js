...
`,Ge=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ve=["temperature","humidity","carbon_dioxide","illuminance","battery"],_e=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,n]of Object.entries(t)){if(!n?.device_id)continue;if(n.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const o=(n.platform??"").toLowerCase();if("shelly"!==o)continue;const l=n.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??n.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:o,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:n.area_id,platform:o})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],n=s?.via_device_id;if(!n||!r.has(n)||a.has(n))continue;const o=i[n],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),u=!l&&c&&t.integration===r.get(n).integration;if(!p&&!u)continue;const g=r.get(n);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function et(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const tt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const it="—";function st(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:it}function rt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:it}function at(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:it}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:it}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:it}function lt(e){return!Number.isFinite(e)||e<0?it:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function ct(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":it}function dt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:it}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:it}function ut(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:it}function gt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:it}function ht(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:it}function vt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:it}function ft(e){return Number.isFinite(e)?`${Math.round(e)} %`:it}const bt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],mt=Object.fromEntries(bt.map(e=>[e.key,e.label.split(" ")[0]])),xt={co2:"carbon_dioxide",rssi:"signal_strength"};function yt(e){return xt[e]??e}const wt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],kt=["online","offline","power","alerts"];function At(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:n}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),u=110,g=110,h=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+h*Math.min(1,Math.max(0,t)),s=u+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),a=u+e*Math.cos(m(i)),n=g+e*Math.sin(m(i)),o=h*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Q`
    ...
    ${r>s?X`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${h}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${h}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:V}`})():V;return Q`
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      <div class="ts-spark-bottom">
        ...
        <div class="ts-spark-meta">
          ${null!=o.voltage?Q`<div class="ts-spark-mrow">${o.voltage.toFixed(1)} <b>V</b></div>`:V}
          ${null!=o.current?Q`<div class="ts-spark-mrow">${o.current.toFixed(2)} <b>A</b></div>`:V}
          ${null!=o.energy?Q`<div class="ts-spark-mrow">${o.energy.toFixed(2)} <b>kWh</b></div>`:V}
          ${null!=o.temp?Q`<div class="ts-spark-mrow">${o.temp.toFixed(1)} <b>°C</b></div>`:V}
          ${null!=o.rssi?Q`<div class="ts-spark-mrow">${o.rssi} <b>dBm</b></div>`:V}
        </div>
      </div>
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=n.voltage?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${n.voltage.toFixed(0)}</div></div>`:V}
          ${null!=n.current?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${n.current.toFixed(2)}</div></div>`:V}
          ${null!=n.temp?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${n.temp.toFixed(1)}</div></div>`:V}
          ${null!=n.rssi?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${n.rssi}</div></div>`:V}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=n.energy?Q`<span class="ts-hbar-badge">${n.energy.toFixed(2)} kWh</span>`:V}
          ${null!=n.uptime?Q`<span class="ts-hbar-badge">${lt(n.uptime)}</span>`:V}
        </div>
        ${o?Q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(o.entityId,i,t)}>${i?"ON":"OFF"}</button>`:V}
      </div>
    ...
    <polyline points="${n}" fill="none" stroke="${h}" stroke-width="${g}" stroke-linecap="round"/>`})():V,f=(e,t,i=!1)=>Q`
    ...
    <polygon points="${n} ${d},${p-u} 0,${p-u}" fill="url(#${o})"/>
    <polyline points="${n}" fill="none" stroke="${h}" stroke-width="${g}" stroke-linecap="round"/>`})():V;return Q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        <div class="ts-chips">
          ${null!=o.voltage?Q`<span class="ts-chip">${o.voltage.toFixed(1)} V</span>`:V}
          ${null!=o.current?Q`<span class="ts-chip">${o.current.toFixed(2)} A</span>`:V}
          ${null!=o.energy?Q`<span class="ts-chip">${o.energy.toFixed(2)} kWh</span>`:V}
          ${null!=o.temp?Q`<span class="ts-chip">${o.temp.toFixed(1)} °C</span>`:V}
          ${null!=o.rssi?Q`<span class="ts-chip">${o.rssi} dBm</span>`:V}
        </div>
      ...
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${st(l.power)}</div>`:V}
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Ct}" height="${Ct}" viewBox="0 0 ${Ct} ${Ct}"
            ...
            ${k?X`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${u}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:V}
          </svg>
        </div>`:V}
      ...
      ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${st(l.power)}</div>`:V}
        ...
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${u?Q`<span class="update-dot" title="Firmware update">●</span>`:V}
          </div>
          ${c?Q`
          ...
          <div class="tile-stats">
            ${e.map(e=>Q`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?Q`<span class="stat-lbl">${e.ch}</span>`:V}
                ${!e.ch&&e.key&&s.has(e.key)?Q`<span class="stat-lbl">${e.label}</span>`:V}
                ${e.value}
              </span>`)}
          </div>`:V}
        ${t.length?Q`
          <div class="tile-elec-wrap">
            ${[...r.entries()].map(([e,t])=>Q`
              <div class="tile-elec">
                ${e?Q`<span class="stat-lbl">${e}</span>`:V}
                ${t.map((e,t)=>Q`${t>0?Q`<span class="sep">·</span>`:V}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:V}
        ${i.length?Q`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>Q`${t>0?Q`<span class="sep">·</span>`:V}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:V}
      ...
      `:Q``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?Q`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?Q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:V}
            ${null!=s?Q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:V}
          </div>
      ...
      `:Q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Q`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return V;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return Q`
                <div class="virt-row">
      ...
      `:Q``}case"power_bar":return e.renderPowerBar(i);case"badges":return Q`
        <div class="tile-bot">
          ${null!=g?Q`<span class="tile-power">${st(g)}</span>`:V}
          <div class="tile-badges">
            ${p.map(e=>Q`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?Q`<span class="type-badge type-${s.type}">${s.label}</span>`:V}
            ${A?Q`<span class="gen-badge gen-${s.gen}">${A}</span>`:V}
            ${C?Q`<span class="int-badge-tile">${C}</span>`:V}
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?Q`<span class="ds-chip ds-chip--room">${t.area}</span>`:V}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?Q`<span class="ds-chip">${t.model}</span>`:V}
        ${"other"!==i.gen?Q`<span class="ds-chip">Gen ${i.gen}</span>`:V}
        ${t.ip?Q`<span class="ds-chip">${t.ip}</span>`:V}
      </div>
      ${a?Q`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:V}
      ${null!=n.rssi?Q`<div class="ds-signal">Wi-Fi: ${ct(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?Q` · Up ${lt(n.uptime)}`:V}</div>`:V}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,n=r?.attributes?.friendly_name??s.entity_id,o=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(o)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?V:Q`<span class="ds-channel-power">${st(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ${t?Q`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:V}
      ${null!=s.power?Q`<span class="ds-big-power">${st(s.power)}</span>`:V}
    </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?Q`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:V}
      </div>
    </div>
    ...
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?Q`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:V}
      </div>
      ${i?.rgbColor?Q`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:V}
    </div>
    ...
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?Q`<span class="ds-chip">${t.hvacAction}</span>`:V}
          ${t.presetMode?Q`<span class="ds-chip">${t.presetMode}</span>`:V}
        </div>
        ${null!=t.valvePosition?Q`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:V}
    ...
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        ${null!=t.position?Q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:V}
    ...
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        ${null!=t.position?Q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:V}
        ${null!=t.temperature?Q`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:V}
        <span class="ds-chip">${t.state}</span>
    ...
    ${r.length?Q`<div class="ds-section ds-alert-row">${r.map(e=>Q`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:V}
        ...
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,n=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
              <div class="ds-channel-row">
                ...
                ${n?Q`<span class="ds-ent-age">${n}</span>`:V}
              </div>`})}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${st(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:V}
        ${null!=t.voltage?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:V}
        ${null!=t.current?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${nt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:V}
        ${null!=t.energy?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:V}
        ${null!=t.temp?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${ot(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:V}
      </div>
    </div>`:Q``}(e):V}
    ${!r&&s?Bt(e):V}
    ...
    <div class="ds-section">
      ...
      ${t.entities.map(t=>{const s=i.states[t.entity_id],r=s?.attributes?.friendly_name??t.entity_id,a=s?.state??"unknown",n=s?.attributes?.unit_of_measurement??"",o="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===a,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
          <div class="ds-entity-row" @click=${()=>e.fireMoreInfo(t.entity_id)}>
            ...
            ${c?Q`<span class="ds-ent-age">${c}</span>`:V}
            ${o?Q`<button class="tog ${l?"on":"off"}" @click=${i=>{i.stopPropagation(),e.toggle(t.entity_id,l,i)}}>${l?"ON":"OFF"}</button>`:V}
          </div>`})}
    </div>`:Q``}(e)}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ${t.ip?Q`<div class="ds-diag-item"><span class="ds-diag-label">IP</span><span class="ds-diag-val">${t.ip}</span></div>`:V}
        ${null!=r.rssi?Q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${ct(r.rssi)} (${r.rssi} dBm)</span></div>`:V}
        ${null!=r.uptime?Q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${lt(r.uptime)}</span></div>`:V}
        ${s?Q`<div class="ds-diag-item"><span class="ds-diag-label">Firmware</span><span class="ds-diag-val">${s.current} → ${s.newVersion}</span></div>`:V}
        ${i.length?Q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:V}
      </div>
          ...
          ${p?Q`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${_}</span><span>${Y}</span><span>now</span>
              </div>
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const r=e=>{const r=this._trvTempFromEvent(e,s,t,i,a);null!=r&&(this._trvDragTemp=r)},o=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(n,l),s.removeEventListener("pointermove",r),s.removeEventListener("pointerup",o)};s.addEventListener("pointermove",r),s.addEventListener("pointerup",o)}}>
        ...
        ${h>210?X`<path d="${u(210,h,54)}" fill="none" stroke="url(#${y})" stroke-width="8" stroke-linecap="round"/>`:V}
        ${m?X`<circle cx="${m[0]}" cy="${m[1]}" r="5" fill="white" stroke="${x}" stroke-width="2"/>`:V}
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const n=(e.clientX-a.left)*(160/a.width),o=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(o-70,n-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const n=(a-210+360)%360;return n>300?null:Math.round(n/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[n,o]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${n} ${o}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,n=(e=>210+e/100*300)(a),[o,l]=i(n,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return X`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${t>0?X`<path d="${s(210,n,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:V}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:n,hasFan:o}=i,l=e.type;if("relay"===l||"plug"===l)return o?X`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        <div class="metric-list">
          ${r.map(e=>Q`
            <div class="metric-row">
              ...
              ${e.value?Q`<span class="metric-val">${e.value}</span>`:V}
            </div>`)}
        </div>
        ...
        </div>`:V,g=void 0!==s?.brightness,h=!!s?.colorModes?.length,v=h&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=h&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),b=g&&o?Math.max(1,s.brightness??1):0,m=s?.whiteValue??0,x=s?this.hass.states[s.entityId]:null,y=x?.attributes?.effect_list??[],w=x?.attributes?.effect??null,k=g?Q`
    ...
    `:V,z=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),I=z.length>1?Q`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:V;return p.length||g||r||a||n||z.length>1?Q`
    ...
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?Q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:V}
        ${null!=l?Q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:V}
      </div>
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        ...
        ${n?Q`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:V}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let n;for(const e of Ve)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const o=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&_e.includes(t.attributes?.device_class??"")});if(!n&&!o)return He(t,s,"ts-sensor","No sensor");if(n){const o=r.states[n.entity_id],l=parseFloat(o?.state??""),c=o?.attributes?.unit_of_measurement??"",d=o?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const u=e.getGraphPoints(n.entity_id,p);let g=0;if(u.length>=2){const e=Math.floor(u.length/2),t=u.slice(e).reduce((e,t)=>e+t.v,0)/(u.length-e),i=u.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const h=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Q`
    ...
    <div class="ts-sensor" style="--ts-accent:${i}">
      ...
      ${g?Q`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${g}</div>`:V}
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      ${c?Q`<div class="ts-scene-time">${c}</div>`:V}
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?Q`<span class="fav-chip fav-chip-power">${st(r)}</span>`:V}
          </div>
        </div>
        <div class="device-grid fav-grid" style="--cols:${n}">
          ${Re(s,e=>e.device_id,e=>Q`
            <div class="fav-tile-wrap">
              ${e.area?Q`<span class="tile-room-badge">${e.area}</span>`:V}
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Q`<span class="area-power">${st(a)}</span>`:V}
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Q``;const t=this._getActiveView()?.id;return Q`
      <div class="view-tabs">
        ${e.map(e=>Q`
          <button class="view-tab ${e.id===t?"active":""}"
            ...
            ${e.icon?Q`<ha-icon class="view-tab-icon" .icon=${e.icon}></ha-icon>`:V}
            <span>${e.name}</span>
          </button>`)}
      ...
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?Ge.map(i=>{const s=(e.currentValue??"none")===i.value,r="none"!==i.value?Qe[i.value]?.[e.isOn?"on":"off"]??t:t;return Q`
            ...
            <div class="room-expanded">
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${o&&!c.length?Q`<span class="dev-style-dot"></span>`:V}
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?Q`<span class="fav-dev-area">${t.area}</span>`:V;return Q`
                    <div class="room-device-row ${r?"selected":""}">
                      ${a}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?Q`<span class="dev-style-dot"></span>`:V}
                      <label class="sw">
      ...
      ${l.map(t=>{const i=t||"No Room",a=o.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),u=e.area_styles?.[t]??{},g=[u.accentColor,u.tileBgColor,u.headerBgColor,u.bgColor].filter(Boolean);return Q`
          <div class="room-row">
            ...
            ${a.length?Q`<span class="room-count">${a.length}</span>`:V}
          ...
          ${c?Q`
            <div class="room-expanded">
              ...
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${p&&!g.length?Q`<span class="dev-style-dot"></span>`:V}
                  ${p?Q`<button class="color-reset" style="margin-left:auto" @click=${e=>{e.stopPropagation(),this._clearAreaStyle(t)}}>Clear</button>`:V}
            ...
            </div>`:V}`})}`,u=this._selectedDeviceId,g=u?a.find(e=>e.device_id===u):null,h=u&&g?Q`
      ...
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${c&&!d?Q`<span class="dev-style-hint">Recommended: ${c}</span>`:V}
          ${d?Q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:V}
        </div>
      ...
      <div class="dev-style-panel">
        ...
        <div class="color-row">
          ...
          ${t[s]?Q`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:V}
      ...
      <div class="rsp-panel">
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",r=t.buttonSize??"md",a="square"===i||"circle"===i,n="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",o=a?"sm"===r?"3px 5px":"lg"===r?"6px 12px":"4px 8px":"sm"===r?"2px 8px":"lg"===r?"6px 16px":"4px 12px",l="sm"===r?"10px":"lg"===r?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,u=`border-radius:${n};padding:${o};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,g=t.buttonShape||t.buttonVariant||t.buttonSize;return Q`
            <div class="btn-preview">
              ...
              ${g?Q`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:V}
            </div>
            <div class="field">
    ...
    `}_renderViewCard(e,t,i,s,r,a,n,o){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),u=this._countViewMatches(e,n,o),g=n.length,h=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
        ...
        ${l?Q`
          <div class="view-card-body">
              ...
              <div class="view-dev-list">
                ${Re(n,e=>e.device_id,t=>Q`
                  <label class="view-dev-row">
                    ...
                    ${t.area?Q`<span class="view-dev-area">${t.area}</span>`:V}
                  </label>`)}
              </div>
            </div>
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?Q`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:V}
            </div>
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Q`<button class="color-reset" @click=${()=>h("columns",void 0)}>↺</button>`:V}
            </div>
      ...
      ${this._sec("tileorder","↕","rgba(244,96,30,0.12)","#f4601e","Tile Block Order",Q`<span class="tag-new">Drag</span>`,r)}`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},r=(e,r,a)=>{const n=t[r]??a;return Q`
        <div class="color-row">
          ...
          ${t[r]?Q`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:V}
        </div>`},a=Q`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?Q`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?Q`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:V}
          </div>
          <div class="pill-grp">
      ...
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[i]?Q`<button class="color-reset" @click=${()=>{const e={...t};delete e[i],this._set("style",e)}}>↺</button>`:V}
        </div>`},o=Q`
      ...
      <div class="field">
        ...
        <div class="bg-img-row">
          ...
          ${e.card_bg_image?Q`<button class="color-reset" @click=${()=>{const e={...this._config};delete e.card_bg_image,delete e.card_bg_image_size,this._emitNow(e)}}>↺</button>`:V}
        </div>
        ${e.card_bg_image?Q`
      ...
      <div class="field">
        ...
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?Q`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:V}
        </div>
        ${t.tile_bg_image?Q`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
      ...
      <div class="style-toolbar">
        ...
        ${this._styleClipFeedback?Q`<span class="clip-feedback">${this._styleClipFeedback}</span>`:V}
      </div>
      ...
      ${this._sec("typography","T","rgba(251,191,36,0.1)","#fbbf24","Typography",V,c)}`}_renderGraphsTab(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},r=Q`
      <div class="field">
      ...
      <div class="tog-row">
        ...
        <div class="color-row">
          ...
          ${a?Q`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:V}
        </div>`},l=Q`
      ...
      ${this._sec("graphranges","⇕","rgba(251,191,36,0.1)","#fbbf24","Sensor Min / Max",Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):V,p)}`}_renderSensorsTab(){const e=this._config,t=e.sensors??[];return Q`
            ...
            ${i.items.map(i=>{const s=t.includes(i.key),r=yt(i.key),a=!!bt.find(e=>e.key===r),n=e.graph_sensors??[],o=n.some(e=>yt(e)===r);return Q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  <div class="sensor-item-body">
                    ...
                    ${i.unit?Q`<span class="sensor-unit">${i.unit}</span>`:V}
                  </div>
