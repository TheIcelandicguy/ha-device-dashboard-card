...
`,Fe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Pe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Le=["motion","door","window","moisture","smoke","gas"];const Ue=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function je(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},a=new Map;for(const[n,o]of Object.entries(t)){if(!o?.device_id)continue;if(o.hidden_by)continue;const t=n.split(".")[0];if(!Ue.has(t))continue;const r=(o.platform??"").toLowerCase();if("shelly"!==r)continue;const l=o.device_id;if(!a.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),n=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===r,c=e.area_id??o.area_id,d=c?s[c]?.name:void 0;a.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:n,integration:r,entities:[]})}const c=a.get(l);c.isShelly||"shelly"!==r||(c.isShelly=!0,c.integration="shelly");const d=e.states[n];c.entities.push({entity_id:n,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:o.area_id,platform:r})}const n=new Set;for(const[e,t]of a){if(n.has(e))continue;const s=i[e],o=s?.via_device_id;if(!o||!a.has(o)||n.has(o))continue;const r=i[o],l=s?.configuration_url??"",c=r?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),v=!l&&c&&t.integration===a.get(o).integration;if(!p&&!v)continue;const u=a.get(o);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),n.add(e)}for(const e of n)a.delete(e);return Array.from(a.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Ne={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},We={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function He(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),a=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),n=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||a||n?"sensor":"input"}const a=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:a,label:Ne[s],integration:e.integration}}const qe={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};function Ze(e){return e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`}function Qe(e){return`${e.toFixed(3)} kWh`}function Xe(e){return`${e.toFixed(1)} V`}function Ve(e){return`${e.toFixed(3)} A`}function Ge(e){return`${e.toFixed(1)} °C`}function Ye(e){return e<60?`${e}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ke(e){return e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor"}function Je(e){return`${e.toFixed(1)} VA`}function _e(e){return`${e.toFixed(1)} VAr`}function $e(e){return`${e.toFixed(2)} Hz`}function et(e){return`${e.toFixed(1)} %`}function tt(e){return e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`}function it(e){return`${Math.round(e)} ppm`}function st(e){return`${Math.round(e)} %`}const at=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],nt=Object.fromEntries(at.map(e=>[e.key,e.label.split(" ")[0]]));function ot(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:o}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t),c=n.graph_style?.sensor_ranges??{},d=n.graph_sensor_colors??{},p=[{label:"W",val:r.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:r.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:r.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:r.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),v=110,u=110,g=180,h=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=h+g*Math.min(1,Math.max(0,t)),s=v+e*Math.cos(m(h)),a=u+e*Math.sin(m(h)),n=v+e*Math.cos(m(i)),o=u+e*Math.sin(m(i)),r=g*t>180?1:0;return`M ${s.toFixed(2)} ${a.toFixed(2)} A ${e} ${e} 0 ${r} 1 ${n.toFixed(2)} ${o.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return Q`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*v} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=b-t*f,a=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),n="W"===e.label||"A"===e.label?"left":"right",o=(v+s*("left"===n?-1:1)).toFixed(1),r=(u+8).toFixed(1),l="left"===n?"start":"end";return X`
            ...
            <text x="${o}" y="${r}" font-size="8" fill="${e.color}" text-anchor="${l}" dominant-baseline="hanging" font-family="monospace" font-weight="700" opacity="${i?.95:.5}">${y(e.val,e.label)} ${e.label}</text>`})}
      </svg>
      ${e.renderTileLowerBody(t,o)}
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:o}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,v=3,u=n.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)";let h=0,f=p-v;const b=c.length>1?(()=>{const e=c.map(e=>e.v),i=n.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),a=i.max??Math.max(...e),o=a-s||1,r=(e,t)=>t/(c.length-1)*d,l=e=>p-v-(e-s)/o*(p-2*v),b=e.indexOf(a);h=r(null,b),f=l(a);const m=c.map((e,t)=>`${r(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),x=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return X`<defs><linearGradient id="${x}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.25"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${m} ${d},${p-v} 0,${p-v}" fill="url(#${x})"/>
    <polyline points="${m}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>
    ${a>s?X`<circle cx="${h.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${g}"/>
      <line x1="${h.toFixed(1)}" x2="${h.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${g}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:G}`})():G;return Q`
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      <div class="ts-spark-bottom">
        ...
        <div class="ts-spark-meta">
          ${null!=r.voltage?Q`<div class="ts-spark-mrow">${r.voltage.toFixed(1)} <b>V</b></div>`:G}
          ${null!=r.current?Q`<div class="ts-spark-mrow">${r.current.toFixed(2)} <b>A</b></div>`:G}
          ${null!=r.energy?Q`<div class="ts-spark-mrow">${r.energy.toFixed(2)} <b>kWh</b></div>`:G}
          ${null!=r.temp?Q`<div class="ts-spark-mrow">${r.temp.toFixed(1)} <b>°C</b></div>`:G}
          ${null!=r.rssi?Q`<div class="ts-spark-mrow">${r.rssi} <b>dBm</b></div>`:G}
        </div>
      </div>
      ${e.renderTileLowerBody(t,o,{skipPowerGraph:!0})}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:a,profile:n}=e,o=e.tileSensors(t),r=e.getPrimarySwitch(t);return Q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=o.voltage?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${o.voltage.toFixed(0)}</div></div>`:G}
          ${null!=o.current?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${o.current.toFixed(2)}</div></div>`:G}
          ${null!=o.temp?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${o.temp.toFixed(1)}</div></div>`:G}
          ${null!=o.rssi?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${o.rssi}</div></div>`:G}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=o.energy?Q`<span class="ts-hbar-badge">${o.energy.toFixed(2)} kWh</span>`:G}
          ${null!=o.uptime?Q`<span class="ts-hbar-badge">${Ye(o.uptime)}</span>`:G}
        </div>
        ${r?Q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${i?"ON":"OFF"}</button>`:G}
      </div>
      ${e.renderTileLowerBody(t,n)}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:o}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,v=2,u=n.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",h=c.length>1?(()=>{const e=c.map(e=>e.v),i=n.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),a=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-v-(e.v-s)/a*(p-2*v)).toFixed(1)}`).join(" "),r=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return X`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-v} 0,${p-v}" fill="url(#${r})"/>
    <polyline points="${o}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():G,f=(e,t,i=!1)=>Q`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=r.power?f("Power",Ze(r.power),!0):G}
      ${null!=r.voltage?f("Voltage",`${r.voltage.toFixed(1)} V`):G}
      ${null!=r.current?f("Current",`${r.current.toFixed(3)} A`):G}
      ${null!=r.energy?f("Energy",Qe(r.energy)):G}
      ${null!=r.temp?f("Temp",`${r.temp.toFixed(1)} °C`):G}
      ${null!=r.rssi?f("WiFi",`${r.rssi} dBm`):G}
      ${null!=r.uptime?f("Uptime",Ye(r.uptime)):G}
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:o}=e,r=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,v=2,u=n.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",h=c.length>1?(()=>{const e=c.map(e=>e.v),i=n.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),a=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-v-(e.v-s)/a*(p-2*v)).toFixed(1)}`).join(" "),r=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return X`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-v} 0,${p-v}" fill="url(#${r})"/>
    <polyline points="${o}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():G;return Q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        <div class="ts-chips">
          ${null!=r.voltage?Q`<span class="ts-chip">${r.voltage.toFixed(1)} V</span>`:G}
          ${null!=r.current?Q`<span class="ts-chip">${r.current.toFixed(2)} A</span>`:G}
          ${null!=r.energy?Q`<span class="ts-chip">${r.energy.toFixed(2)} kWh</span>`:G}
          ${null!=r.temp?Q`<span class="ts-chip">${r.temp.toFixed(1)} °C</span>`:G}
          ${null!=r.rssi?Q`<span class="ts-chip">${r.rssi} dBm</span>`:G}
        </div>
        <span class="ts-uptime">${r.uptime?Ye(r.uptime):""}</span>
      </div>
      ${e.renderTileLowerBody(t,o)}
    </div>`}(e)}}const rt=140,lt=70;function ct(e){const{device:t,isOn:i,accent:s,online:a,hass:n,profile:o}=e,r=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!r)return Q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(r.entityId.startsWith("switch.")||"dimmer"!==o.type&&"rgb"!==o.type)return Q`
      ...
      </div>`;const c=i?Math.max(1,r.brightness??1):0,d=!!r.colorModes?.length,p=d&&(r.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),v=d&&r.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",u=r.whiteValue??0,g=n.states[r.entityId],h=g?.attributes??{},f=h.effect_list??[],b=h.effect??"",m=(h.supported_color_modes??[]).some(e=>"color_temp"===e),x=h.min_mireds??153,y=h.max_mireds??500,w=h.color_temp??x,k=d&&r.rgbColor?(()=>{const[e,t,i]=r.rgbColor,s=Math.max(e,t,i),a=s-Math.min(e,t,i);let n=0;a>0&&(n=s===e?((t-i)/a+6)%6:s===t?(i-e)/a+2:(e-t)/a+4);const o=0===s?0:a/s,l=(e=>e*Math.PI/180)(60*n-90);return{x:lt+62*o*Math.cos(l),y:lt+62*o*Math.sin(l)}})():null,A=`wsat-${t.device_id.replace(/\W/g,"")}`;return Q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Q`
        <div class="ts-light-wheel-wrap">
          <svg width="${rt}" height="${rt}" viewBox="0 0 ${rt} ${rt}"
            class="ts-light-wheel" @click=${e=>{if(!d||!r)return;e.stopPropagation();const t=e.currentTarget,i=t.getBoundingClientRect(),s=i.left+i.width/2,a=i.top+i.height/2,o=e.clientX-s,l=e.clientY-a,c=Math.sqrt(o*o+l*l),p=i.width/2-8;if(c>p+8){const e=t.parentElement;return void(e&&(e.classList.remove("ts-wheel-pulse"),e.offsetWidth,e.classList.add("ts-wheel-pulse")))}const v=(180*Math.atan2(l,o)/Math.PI+90+360)%360,u=Math.min(1,c/p),g=e=>{const t=(e+v/60)%6;return 1-u*Math.max(0,Math.min(t,4-t,1))},h=Math.round(255*g(5)),f=Math.round(255*g(3)),b=Math.round(255*g(1));n.callService("light","turn_on",{entity_id:r.entityId,rgb_color:[h,f,b]})}} style="cursor:crosshair">
            <defs>
              <radialGradient id="${A}">
            ...
            <foreignObject x="0" y="0" width="${rt}" height="${rt}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${rt}px;height:${rt}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${lt}" cy="${lt}" r="${lt}" fill="url(#${A})" opacity="${i?1:.3}"/>
            ${k?X`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${v}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:G}
          </svg>
        </div>`:G}
      <div class="ts-light-row">
        ...
        <div style="display:flex;align-items:center;gap:6px;flex:1">
          <input type="range" class="dim-slider ts-light-slider" min="1" max="100"
            ...
            style="--sl-color:${i?v:"var(--sc-text-muted)"}"
        ...
        <div class="ts-light-row">
          ...
          <div style="display:flex;align-items:center;gap:6px;flex:1">
            <input type="range" class="dim-slider white-slider ts-light-slider" min="0" max="255"
              ...
              @change=${t=>e.setColor(r.entityId,v,parseInt(t.target.value,10),!0)}/>
        ...
        <div class="tile-effects">
          ${f.filter(e=>"Off"!==e).map(e=>Q`
            <button class="effect-btn ${b===e?"active":""}"
              @click=${()=>n.callService("light","turn_on",{entity_id:r.entityId,effect:b===e?"Off":e})}>${e}</button>`)}
        </div>`:G}
      ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Ze(l.power)}</div>`:G}
    </div>`}function dt(e,t){const{device:i,profile:s,config:a,hass:n,online:o}=e,r=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),v=e.getFirmware(i),u=e.getPower(i),g=e.getSensors(i),h=e.getInputChannels(i),f=r?.isOn??!1,b=void 0!==r?.brightness,m=r&&b&&f?Math.max(1,r.brightness??1):0,x=!!r?.colorModes?.length,y=r?.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",w=!!r?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,A="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,C=(S=i.integration,qe[S.toLowerCase()]??S.toUpperCase().slice(0,6));var S,z;switch(t){case"name_row":{const t=a.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let n;if(s)n=Te(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;n=t?Te(t,!0,"--ent-spd:1","tile-icon"):Q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;n=i?Te(i,!0,"--ent-spd:1","tile-icon"):Q``}else n=Q``;const p=r?e.renderEntityAnim(r.entityId,f,i.device_id):Q``;return Q`
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${v?Q`<span class="update-dot" title="Firmware update">●</span>`:G}
          </div>
          ${c?Q`
      ...
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=r?n.states[r.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,a=r?.whiteValue??0;return r&&b?Q`
        <div class="tile-dim-row" @click=${e=>e.stopPropagation()}>
          ${x?Q`
            <input type="color" class="color-swatch tile-color-swatch" .value=${y}
              ?disabled=${!f}
              @change=${t=>{t.stopPropagation(),e.setColor(r.entityId,t.target.value,a,w)}}/>
          `:G}
        ...
        ${w?Q`
          <div class="tile-dim-row tile-white-row" @click=${e=>e.stopPropagation()}>
            ...
            <input type="range" class="dim-slider white-slider" min="0" max="255"
              ...
              @change=${t=>{const i=parseInt(t.target.value,10);e.setColor(r.entityId,y,i,!0)}}/>
          ...
          <div class="tile-effects" @click=${e=>e.stopPropagation()}>
            ${i.filter(e=>"Off"!==e).map(e=>Q`
              <button class="effect-btn ${s===e?"active":""}"
                @click=${t=>{t.stopPropagation();const i=s===e;n.callService("light","turn_on",{entity_id:r.entityId,effect:i?"Off":e})}}>
                ${e}
              </button>`)}
          </div>
        `:G}
      ...
      `:Q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Q`
        ...
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=n.states[t.entity_id],a="on"===s?.state,o=s?.attributes?.friendly_name??t.entity_id;return Q`
      ...
      `:Q``}case"power_bar":return e.renderPowerBar(i);case"badges":return Q`
        <div class="tile-bot">
          ${null!=u?Q`<span class="tile-power">${Ze(u)}</span>`:G}
      ...
      `;default:return Q``}}const pt=255;function vt(e){return Q`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:a}=e,n=e.getFirmware(t),o=e.tileSensors(t);return Q`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=o.rssi?Q`<div class="ds-signal">Wi-Fi: ${Ke(o.rssi)} (${o.rssi} dBm)${null!=o.uptime?Q` · Up ${Ye(o.uptime)}`:G}</div>`:G}
    ...
    ${s.length>1?Q`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const a=i.states[s.entity_id],n="on"===a?.state,o=a?.attributes?.friendly_name??s.entity_id,r=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(r)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Q`
    ...
    ${gt(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Q`
    ...
    ${gt(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,a=Math.round(s/255*100);return Q`
    <div class="ds-section">
    ...
    ${gt(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,a=i?.brightness??0,n=Math.round(a/pt*100);return Q`
    <div class="ds-section">
    ...
    ${gt(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Q`
    <div class="ds-section">
    ...
    ${gt(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Q`
    <div class="ds-section">
    ...
    ${gt(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Q`
    <div class="ds-section">
    ...
    ${gt(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Q`${gt(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),a=e.getAlerts(t);return Q`
    ...
    ${gt(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Q`
    <div class="ds-section">
      <div class="ds-section-title">Input Channels</div>
      ${s.length?Q`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],a="on"===s?.state,n=s?.attributes?.friendly_name??t.entity_id,o=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${n}</span>
                <span class="ds-chip ${a?"ds-chip--on":""}">${a?"ON":"OFF"}</span>
                ${o?Q`<span class="ds-ent-age">${o}</span>`:G}
              </div>`})}
        </div>`:Q`<span class="ds-muted">No input channels</span>`}
    </div>
    ${gt(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),a=t.entities.filter(e=>"switch"===e.domain);return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    ${gt(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Q`
    ${t?Q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${gt(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    </div>`}function ut(e){if(!e.getGraphEntities(e.device).length)return Q``;const t=e.getDetailHistoryRange();return Q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function gt(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:a=!1}=t;return Q`
    ${a&&s?ut(e):G}
    ...
    <div class="ds-section">
      ...
      ${t.entities.map(t=>{const s=i.states[t.entity_id],a=s?.attributes?.friendly_name??t.entity_id,n=s?.state??"unknown",o=s?.attributes?.unit_of_measurement??"",r="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===n,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
          <div class="ds-entity-row" @click=${()=>e.fireMoreInfo(t.entity_id)}>
            ...
            <span class="ds-ent-state">${n}${o?` ${o}`:""}</span>
            ${c?Q`<span class="ds-ent-age">${c}</span>`:G}
            ${r?Q`<button class="tog ${l?"on":"off"}" @click=${i=>{i.stopPropagation(),e.toggle(t.entity_id,l,i)}}>${l?"ON":"OFF"}</button>`:G}
          </div>`})}
    </div>`:Q``}(e)}
    ...
    <div class="ds-section">
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?G:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${n} ${o}" preserveAspectRatio="none"
                class="sparkline-svg"
                style="height:${r?o:32}px"
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),s=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),o=M+s*B;let r=k[0];for(const e of k)Math.abs(e.t-o)<Math.abs(r.t-o)&&(r=e);const l=E(r),c=T(r),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const v=t.parentElement,u=v?.querySelector(".spark-tooltip");if(u){const e=u.querySelector(".spark-tooltip-val"),t=u.querySelector(".spark-tooltip-time");e&&(e.textContent=`${r.v%1==0?String(r.v):r.v.toFixed(1)} ${a}`),t&&(t.textContent=m(r.t)),u.style.left=`${(l/n*100).toFixed(1)}%`,u.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                ${d?X`
                  ...
                  <line x1="${n}"     x2="${n}"     y1="0" y2="${o}" class="spark-tick"/>
                `:G}
                ${"bar"!==v&&u?X`
                  <polygon points="${R} ${n},${o-4} ${D},${o-4}" fill="url(#${F})"/>
                `:G}
                ${"bar"===v?k.map(e=>{const t=Math.max(2,n/k.length-2),i=E(e)-t/2,s=T(e),a=o-4-s;return X`<rect x="${i.toFixed(1)}" y="${s.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,a).toFixed(1)}" rx="1.5" fill="${y}" opacity="0.75"/>`}):X`
                    <polyline points="${R}" fill="none"
                      stroke="${y}" stroke-width="${l}"
                      stroke-linecap="round" stroke-linejoin="round"/>
                  `}
                <line x1="0" y1="${o}" x2="${n}" y2="${o}"
                  stroke="rgba(255,255,255,0.5)" stroke-width="0.8"
                  stroke-dasharray="${K}" pointer-events="none"
                  vector-effect="non-scaling-stroke"/>
                ${J?X`
                  <circle cx="${N}" cy="${W}" r="3"
                    fill="${y}" stroke="#1e1e2e" stroke-width="1.2"/>
                  <circle cx="${H}" cy="${q}" r="2.5"
      ...
      <div class="sparklines-block ${i?"exp":""}">
        ${x}
      </div>`}_closeDetailSheet(){this._detailDevice=null}_getBlockOrder(e,t){const i=this._config.device_styles?.[e.device_id]?.tile_layout;return i||(this._config.tile_layout?this._config.tile_layout:We[t.type]??We.generic)}_trvColor(e){const t=Math.max(0,Math.min(1,e));let i,s,a;if(t<.5){const e=2*t;i=Math.round(74+156*e),s=Math.round(144+-18*e),a=Math.round(217+-183*e)}else{const e=2*(t-.5);i=Math.round(230+-1*e),s=Math.round(126+-69*e),a=Math.round(34+19*e)}return`rgb(${i},${s},${a})`}_renderTrvDial(e){const{minTemp:t,maxTemp:i,targetTemp:s,currentTemp:a,step:n,entityId:o}=e,r=this._trvDragTemp??s??t,l=Math.max(0,Math.min(1,(r-t)/(i-t))),c=e=>210+(e-t)/(i-t)*300,d=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),70+t*Math.sin((e-90)*Math.PI/180)],p=(e,t,i)=>{const[s,a]=d(e,i),[n,o]=d(t,i);return`M ${s} ${a} A ${i} ${i} 0 ${t-e>180?1:0} 1 ${n} ${o}`},v=this._trvColor(l),u=c(r),[g,h]=d(u,54),f=null!=a?(a-t)/(i-t):null,b=null!=a?d(c(a),54):null,m=null!=f?this._trvColor(f):v,x=`trv-grad-${o.replace(/\W/g,"_")}`;return X`
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const a=e=>{const a=this._trvTempFromEvent(e,s,t,i,n);null!=a&&(this._trvDragTemp=a)},r=e=>{const l=this._trvTempFromEvent(e,s,t,i,n)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(o,l),s.removeEventListener("pointermove",a),s.removeEventListener("pointerup",r)};s.addEventListener("pointermove",a),s.addEventListener("pointerup",r)}}>
        <defs>
        ...
        ${u>210?X`<path d="${p(210,u,54)}" fill="none" stroke="url(#${x})" stroke-width="8" stroke-linecap="round"/>`:G}
        ${b?X`<circle cx="${b[0]}" cy="${b[1]}" r="5" fill="white" stroke="${m}" stroke-width="2"/>`:G}
        <circle cx="${g}" cy="${h}" r="9" fill="${v}" stroke="white" stroke-width="2" style="cursor:grab"/>
    ...
    `}_trvTempFromEvent(e,t,i,s,a){const n=t.getBoundingClientRect(),o=(e.clientX-n.left)*(160/n.width),r=(e.clientY-n.top)*(132/n.height);let l=Math.atan2(r-70,o-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i);return Math.max(i,Math.min(s,Math.round(d/a)*a))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect(),s=(e.clientX-i.left)*(160/i.width),a=(e.clientY-i.top)*(128/i.height);let n=Math.atan2(a-68,s-80)*(180/Math.PI)+90;n<0&&(n+=360);const o=(n-210+360)%360;return o>300?null:Math.round(o/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[a,n]=i(e,s),[o,r]=i(t,s);return`M ${a} ${n} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${o} ${r}`},a=e.supportsPosition||!!e.numEntityId,n=this._valveDragPos??t,o=(e=>210+e/100*300)(n),[r,l]=i(o,54),c=`hsl(${200+.2*n}, ${40+.55*n}%, ${38+.18*n}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=a?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},a=t=>{const n=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=n&&this._setValvePosition(e.entityId,n,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",a)}:void 0;return X`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${a?"valve-interactive":""}"
        ...
        ${t>0?X`<path d="${s(210,o,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:G}
        <circle cx="${r}" cy="${l}" r="9" fill="${c}" stroke="white" stroke-width="2" style="${a?"cursor:grab":""}"/>
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return Q``;const a=(t?s.on:s.off)??"none";return"none"===a?Q``:Te(a,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i){const s=this._tileAccent(t,t.area??"");return dt(this._buildTileCtx(t,i,s),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return Q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return Q`
      <div class="power-bar" title="${t.toFixed(0)} W">
        <div class="power-bar-fill" style="width:${Math.min(100,t/i*100)}%"></div>
      </div>`}_tileSensors(e){let t=null,i=null,s=null,a=null,n=null,o=null,r=null;for(const l of e.entities){if("sensor"!==l.domain)continue;const e=this.hass.states[l.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const c=e.attributes.device_class??"",d=parseFloat(e.state);"power"===c&&null==t&&(t=isNaN(d)?null:d),"voltage"===c&&null==i&&(i=isNaN(d)?null:d),"current"===c&&null==s&&(s=isNaN(d)?null:d),"temperature"===c&&null==a&&(a=isNaN(d)?null:d),"energy"===c&&null==n&&(n=isNaN(d)?null:d);const p=l.entity_id;(p.includes("rssi")||p.includes("signal"))&&(o=isNaN(d)?null:d),p.includes("uptime")&&(r=isNaN(d)?null:d)}return{power:t,voltage:i,current:s,temp:a,energy:n,rssi:o,uptime:r}}_tileAccent(e,t){const i=this._config.device_styles?.[e.device_id]?.color;if(i)return i;const s=this._config.area_styles?.[t];return s?.accentColor?s.accentColor:this._config.style?.accent_color??"var(--sc-accent)"}_renderTileLowerBody(e,t,i={}){const s=this._getPrimarySwitch(e),a=this._getTrv(e),n=this._getValve(e),o=this._getCover(e),r=s?.isOn??!1,l=this._getGraphEntities(e),c=i.skipGraphs?[]:i.skipPowerGraph?l.filter(e=>"power"!==e.dc):l,d=c.length?Q`<div class="ts-lower-section ts-lower-graphs">
          ${this._renderSparklinesFiltered(e,c)}
        </div>`:G,p=void 0!==s?.brightness,v=!!s?.colorModes?.length,u=v&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",g=v&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=p&&r?Math.max(1,s.brightness??1):0,f=s?.whiteValue??0,b=s?this.hass.states[s.entityId]:null,m=b?.attributes?.effect_list??[],x=b?.attributes?.effect??null,y=p?Q`
      <div class="ts-lower-section ts-lower-dimmer" @click=${e=>e.stopPropagation()}>
        <div class="tile-dim-row">
          ${v?Q`
            <input type="color" class="color-swatch tile-color-swatch" .value=${u}
              ?disabled=${!r}
              @change=${e=>{e.stopPropagation(),this._setColor(s.entityId,e.target.value,f,g)}}/>
          `:G}
          <input type="range" class="dim-slider" min="1" max="100"
            .value=${String(r?h:1)}
            ?disabled=${!r}
        ...
        ${g?Q`
          <div class="tile-dim-row tile-white-row">
            ...
            <input type="range" class="dim-slider white-slider" min="0" max="255"
              .value=${String(f)}
              @input=${e=>{const t=e.target.closest(".tile-white-row")?.querySelector(".white-pct");t&&(t.textContent=e.target.value)}}
              @change=${e=>{this._setColor(s.entityId,u,parseInt(e.target.value,10),!0)}}/>
    ...
    `:G;return c.length||p||a||n||o||C.length>1?Q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${we(r)}
          ...
          ${a.map(e=>dt(c,e))}
        </div>`}const g=e.area??"",h=this._tileAccent(e,g);this._getPrimarySwitch(e);return Q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${we(r)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?ot(this._buildTileCtx(e,s,h),u):"light-control"===p?ct(this._buildTileCtx(e,s,h)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:a}=e,n=e.getTrv(t);if(!n)return Oe(t,s,"ts-climate","No climate entity");const o="heating"===n.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(a.states[r.entity_id]?.state??"")||null;return Q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ${Me(t,s)}
        <div style="display:flex;align-items:center;gap:6px">
          ${o?Q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:Q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>
      </div>
      ${e.renderTrvDial(n)}
      <div class="trv-dial-btns">
    ...
    </div>`}(this._buildTileCtx(e,s,h)):"cover-control"===p?function(e){const{device:t,accent:i,online:s}=e,a=e.getCover(t);if(!a)return Q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const n=a.position??("open"===a.state?100:0),o="opening"===a.state||"closing"===a.state,r=Math.ceil(n/100*Ee.length);return Q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${Ee.map((e,t)=>X`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<r?"0.85":"0.1"}"/>`)}
        </svg>
        ${o?Q`<span class="ts-cover-state">${"opening"===a.state?"▲ Opening…":"▼ Closing…"}</span>`:G}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,h)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:a,config:n}=e;let o;for(const e of Pe)if(o=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=a.states[t.entity_id];return i&&i.attributes?.device_class===e}),o)break;const r=o?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=a.states[e.entity_id];return t&&Le.includes(t.attributes?.device_class??"")});if(!o&&!r)return Oe(t,s,"ts-sensor","No sensor");if(o){const r=a.states[o.entity_id],l=parseFloat(r?.state??""),c=r?.attributes?.unit_of_measurement??"",d=r?.attributes?.device_class??"",p=n.graph_hours??24;e.requestGraphData(o.entity_id);const v=e.getGraphPoints(o.entity_id,p);let u=0;if(v.length>=2){const e=Math.floor(v.length/2),t=v.slice(e).reduce((e,t)=>e+t.v,0)/(v.length-e),i=v.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===o.entity_id||"sensor"!==e.domain)return!1;const t=a.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${g.length?Q`<div class="ts-chips" style="margin-top:6px">
          ${g.map(e=>{const t=a.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return Q`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:G}
      </div>`}const l=a.states[r.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",v=c?"#f87171":"var(--sc-online-color)",u=l?.last_changed?e.timeAgo(l.last_changed):"";return Q`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${Me(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      </div>
      <div class="ts-sensor-binary-state" style="color:${v}">
        <span class="ts-sensor-binary-dot" style="background:${v}"></span>
        ${p}
      </div>
      ${u?Q`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${u}</div>`:G}
    </div>`}(this._buildTileCtx(e,s,h)):"scene-button"===p?function(e){const{device:t,accent:i,online:s,config:a}=e,n=e.getInputChannels(t),o=a.device_styles?.[t.device_id],r=Te(o?.tile_icon??"pulse",!0,`--ent-spd:${o?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return n.length>0?Q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      <div class="ts-scene-icon-wrap">${r}</div>
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._config.area_styles?.[t]?.sensors:void 0,s=i?.length?i:this._config.sensors,a=s?.length?new Set(s):null,n=e=>!a||a.has(e),o={},r=(e,t)=>{o[e]||(o[e]={sum:0,count:0}),o[e].sum+=t,o[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"";"power"===s&&n("power")?r("power",i):"energy"===s&&n("energy")?r("energy",i):"temperature"===s&&n("temperature")?r("temperature",i):"humidity"===s&&n("humidity")?r("humidity",i):"carbon_dioxide"===s&&n("co2")?r("co2",i):"illuminance"===s&&n("illuminance")&&r("illuminance",i)}const l=[];return o.power&&l.push({label:"Power",value:Ze(o.power.sum)}),o.energy&&l.push({label:"Energy",value:Qe(o.energy.sum)}),o.temperature&&l.push({label:"Temp",value:Ge(o.temperature.sum/o.temperature.count)}),o.humidity&&l.push({label:"Hum",value:et(o.humidity.sum/o.humidity.count)}),o.co2&&l.push({label:"CO₂",value:it(o.co2.sum/o.co2.count)}),o.illuminance&&l.push({label:"Light",value:tt(o.illuminance.sum/o.illuminance.count)}),l}_renderAreaSection(e,t){if(!t.length)return Q``;const i=e||"No Area",s=this._closedAreas.has(e),a=t.filter(e=>this._isOnline(e)).length,n=t.reduce((e,t)=>e+(this._getPower(t)??0),0),o=this._config.area_styles?.[i],r=o?.columns??this._config.columns??3;this._config.style;const l={};if(o&&((o.borderColor||o.borderWidth)&&(l.border=`${o.borderWidth??1}px ${o.borderStyle??"solid"} ${o.borderColor??"var(--divider-color)"}`),o.borderRadius&&(l.borderRadius=`${o.borderRadius}px`,l.overflow="hidden"),o.headerBgColor&&(l["--area-header-bg"]=o.headerBgColor2?`linear-gradient(${o.headerBgDir??"to right"}, ${o.headerBgColor}, ${o.headerBgColor2})`:o.headerBgColor),o.textColor&&(l["--area-header-color"]=o.textColor),o.fontSize&&(l["--area-name-size"]=`${o.fontSize}px`),o.fontWeight&&(l["--area-name-weight"]=o.fontWeight),o.tileBgColor&&(l["--sc-tile-bg"]=o.tileBgColor),o.tileBorderColor&&(l["--sc-tile-border"]=o.tileBorderColor),null!=o.tileBorderRadius&&(l["--tile-radius"]=`${o.tileBorderRadius}px`),null!=o.tileGap&&(l["--tile-gap"]=`${o.tileGap}px`),o.tileTextColor&&(l["--sc-text-primary"]=o.tileTextColor),o.accentColor&&(l["--sc-accent"]=o.accentColor,l["--sc-graph-line"]=o.accentColor,l["--sc-accent-glow"]=`${o.accentColor}59`),o.buttonShape||o.buttonVariant||o.buttonSize)){const e=o.buttonShape??"pill",t=o.buttonVariant??"fill",i=o.buttonSize??"md",s="square"===e||"circle"===e,a={sm:"2px 8px",md:"4px 11px",lg:"6px 16px"},n={sm:"3px 5px",md:"4px 8px",lg:"6px 12px"};l["--tog-radius"]="pill"===e?"20px":"rect"===e||"square"===e?"6px":"50%",l["--tog-pad"]=s?n[i]??n.md:a[i]??a.md,l["--tog-fsize"]="sm"===i?".65em":"lg"===i?".8em":".72em",l["--tog-aspect"]=s?"1":"auto","outline"===t?(l["--tog-on-bg"]="transparent",l["--tog-on-border"]="1px solid var(--sc-accent)",l["--tog-on-color"]="var(--sc-accent)",l["--tog-on-shadow"]="none"):"ghost"===t&&(l["--tog-on-bg"]="transparent",l["--tog-on-border"]="none",l["--tog-on-color"]="var(--sc-accent)",l["--tog-on-shadow"]="none")}const c=o?.tile_style,d=t.map(e=>this._renderTile(e,c)),p=this._getAreaChips(t,i);return Q`
    ...
    `}_renderExpanded(e){const t=this._getSensors(e),i=this._getFirmware(e),s=this._getTrv(e),a=this._getCover(e),n=this._getValve(e),o=!1!==this._config.show_entity_list,r=this._entityListOpen.has(e.device_id);return Q`
      <div class="expanded" @click=${e=>e.stopPropagation()}>
        ...
        ${o?Q`
          <div class="exp-section exp-section--full">
            <div class="ent-list-header" @click=${t=>{t.stopPropagation();const i=new Set(this._entityListOpen);r?i.delete(e.device_id):i.add(e.device_id),this._entityListOpen=i}}>
              <span class="exp-label" style="margin:0">All Entities (${e.entities.length})</span>
              <span class="ent-caret ${r?"open":""}">▼</span>
            </div>
            ${r?Q`
              <div class="ent-list">
    ...
    `}render(){if(!this._config||!this.hass)return Q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return Q`
        ...
        </ha-card>`;const a=s.filter(e=>this._isOnline(e)).length,n=s.length-a,o=s.reduce((e,t)=>e+(this._getPower(t)??0),0),r=s.filter(e=>this._getAlerts(e).length>0),l=this._getActiveView(),c=l?this._applyViewFilter(s,l):s,d=this._groupByArea(c),p=!l||!0===l.show_favourites,v=!l||!1!==l.show_rooms,u=Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")),g=u.filter(e=>"on"===e.state),h=u.filter(e=>"off"===e.state),f=u.filter(e=>"unavailable"===e.state),b=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),m=this._buildCardStyles(),x=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,y=x?vt(this._buildTileCtx(x,He(x),this._tileAccent(x,x.area??""))):G;return Q`
      <ha-card class=${this._config.effects?"":"no-fx"} style=${we(m)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ${y}
        <div class="dash-header">
          <div class="dash-header-bg"></div>
          ${!1!==this._config.header_show_title?Q`
            <span class="dash-title">${this._config.title??"Shelly"}</span>`:G}
          ${!1!==this._config.header_show_stats?Q`
            <div class="dash-stats">
              <span class="stat online ${"dev-on"===this._cloudDetailOpen?"active":""}"
                @click=${e=>{e.stopPropagation(),this._cloudDetailOpen="dev-on"===this._cloudDetailOpen?null:"dev-on"}}>
                ${a}/${s.length} online</span>
              ${n>0?Q`
                <span class="stat offline-count ${"dev-off"===this._cloudDetailOpen?"active":""}"
                  @click=${e=>{e.stopPropagation(),this._cloudDetailOpen="dev-off"===this._cloudDetailOpen?null:"dev-off"}}>
                  ${n} offline</span>`:G}
              <span class="stat power">${Ze(o)}</span>
              ${r.length>0?Q`<span class="stat alerts-count">⚠ ${r.length}</span>`:G}
            </div>`:G}
            ...
            <div class="cloud-chips">
              ...
              ${f.length>0?Q`
                <span class="cloud-chip cloud-unavail ${"unavailable"===this._cloudDetailOpen?"active":""}"
                  ...
                  ● ${f.length} unavailable</span>`:G}
            </div>`:G}
        </div>
        ${"on"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-on">● Online — ${g.length} devices</div>
            <div class="cloud-grid">
              ${g.map(e=>Q`<div class="cloud-item">${b(e)}</div>`)}
            </div>
          </div>`:G}
        ${"off"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-off">● Offline — ${h.length} devices</div>
            <div class="cloud-grid">
              ${h.map(e=>Q`<div class="cloud-item">${b(e)}</div>`)}
            </div>
          </div>`:G}
        ${"unavailable"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-unavail">● Unavailable — ${f.length} devices</div>
            <div class="cloud-grid">
              ${f.map(e=>Q`<div class="cloud-item">${b(e)}</div>`)}
            </div>
          </div>`:G}
        ${"dev-on"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-on">● Online — ${a} devices</div>
            <div class="cloud-grid">
              ${s.filter(e=>this._isOnline(e)).map(e=>Q`<div class="cloud-item">${e.name}</div>`)}
            </div>
          </div>`:G}
        ${"dev-off"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-off">● Offline — ${n} devices</div>
            <div class="cloud-grid">
              ${s.filter(e=>!this._isOnline(e)).map(e=>Q`<div class="cloud-item">${e.name}</div>`)}
            </div>
          </div>`:G}
        ...
        <div class="dash-body">
          ${p?this._renderFavoritesSection(s):G}
          ${v?[...d.entries()].map(([e,t])=>this._renderAreaSection(e,t)):Q`<div class="device-grid" style="--cols:${l?.columns??this._config.columns??3}">
                ${c.map(e=>this._renderTile(e))}
              </div>`}
        </div>
      </ha-card>
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Q``;const t=this._getActiveView()?.id;return Q`
      ...
      </div>`}_iconPicker(e,t,i,s){const a="#f4601e",n=t?Re[t]?.[i?"on":"off"]??a:a,o=this._iconPickerState?.onSelect===s;return Q`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          @click=${e=>{e.stopPropagation(),t()}}>↺</button>`:G}_clearCfg(e){const t={...this._config};delete t[e];const{type:i,...s}=t;this._config={type:i,...s},Ce(this,"config-changed",{config:this._config})}_clearStyle(e){const t={...this._config.style??{}};delete t[e],this._set("style",Object.keys(t).length?t:void 0)}_clearGraphStyle(e){const t={...this._config.graph_style??{}};delete t[e],this._set("graph_style",Object.keys(t).length?t:void 0)}_renderBgThumb(e){return Q`<div class="bg-thumb" style="background-image:url(${e})" title="Preview"></div>`}_estimateImageSize(e){if(!e.startsWith("data:"))return"";const t=e.indexOf(",");if(t<0)return"";const i=Math.floor(.75*(e.length-t-1));return i>=1048576?`~${(i/1048576).toFixed(1)} MB`:i>=1024?`~${Math.round(i/1024)} KB`:`~${i} B`}_showStyleFeedback(e){this._styleClipFeedback=e,clearTimeout(this._styleClipTimer),this._styleClipTimer=window.setTimeout(()=>{this._styleClipFeedback=""},1500)}_copyStyle(){const e={};for(const t of Ct){const i=this._config[t];void 0!==i&&(e[t]=i)}this._copyJson=JSON.stringify(e),this._copyAreaOpen=!0,this._pasteOpen=!1,navigator.clipboard.writeText(this._copyJson).catch(e=>{console.warn("[editor] clipboard write failed",e)})}_applyPastedStyle(){try{const e=JSON.parse(this._pasteText),t=Ct.some(t=>t in e);if(!t)return void this._showStyleFeedback("Invalid style data");const i={...this._config};for(const t of Ct)t in e&&(i[t]=e[t]);Ce(this,"config-changed",{config:i}),this._showStyleFeedback("Applied!"),this._pasteOpen=!1,this._pasteText=""}catch{this._showStyleFeedback("Invalid style data")}}_getAreas(){return this.hass?Object.values(this.hass.areas??{}).map(e=>({id:e.area_id,name:e.name})).sort((e,t)=>e.name.localeCompare(t.name)):[]}_getAllHADevices(){if(!this.hass)return[];const e=this.hass.devices??{},t=this.hass.entities??{},i=new Set,s=[];for(const a of Object.values(t)){const t=a?.device_id;if(!t||i.has(t))continue;i.add(t);const n=e[t];if(!n)continue;const o=n.area_id??a.area_id,r=o?this.hass.areas?.[o]?.name:void 0;s.push({device_id:t,name:n.name_by_user??n.name??t,area:r})}return s.sort((e,t)=>e.name.localeCompare(t.name))}_getDiscoveredDevices(){if(!this.hass)return[];const e=this._config.areas;let t=je(this.hass);if(void 0!==e){const i=new Set(e.map(e=>e.toLowerCase()));t=t.filter(e=>i.has((e.area??"").toLowerCase()))}return t.map(e=>({device_id:e.device_id,name:e.name,area:e.area})).sort((e,t)=>e.name.localeCompare(t.name))}_getEntitiesForDevice(e){const t=this.hass.entities??{},i=[];for(const[s,a]of Object.entries(t)){if(a.device_id!==e)continue;const t=this.hass.states[s];i.push({entity_id:s,name:t?.attributes?.friendly_name??s,domain:s.split(".")[0]})}return i.sort((e,t)=>e.name.localeCompare(t.name))}_setAreaStyle(e,t,i){const s={...this._config.area_styles?.[e]??{}};void 0===i||""===i?delete s[t]:s[t]=i;const a={...this._config.area_styles??{}};Object.keys(s).length?a[e]=s:delete a[e],this._set("area_styles",Object.keys(a).length?a:void 0)}_clearAreaStyle(e){const t={...this._config.area_styles??{}};delete t[e],this._set("area_styles",Object.keys(t).length?t:void 0)}_chipPicker(e,t,i,s){const a=t??[],n=void 0!==e,o=wt.flatMap(e=>e.items.map(e=>e.key)),r=new Set(n?e:a.length?a:o);return Q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${n?"Custom selection":`Inheriting from ${i}`}</span>
          ${n?Q`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:Q`<button class="color-reset" @click=${()=>s([...r])}>Customize</button>`}
        </div>
        ${wt.map(t=>Q`
          <div class="chip-picker-grp">
            ...
            <div class="pill-grp">
              ${t.items.map(t=>Q`
                <span class="pill ${r.has(t.key)?"on":""} ${n?"":"dim"}"
                  @click=${()=>(t=>{const i=n?[...e]:[...r],a=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(a.length?a:void 0)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
      </div>`}_clearDeviceStyle(e){const t={...this._config.device_styles??{}};delete t[e],this._set("device_styles",Object.keys(t).length?t:void 0)}async _prepareImageForEmbed(e,t={}){const i=t.maxDim??1920,s=t.targetBytes??409600,a=await createImageBitmap(e,{imageOrientation:"from-image"}),n=Math.min(1,i/Math.max(a.width,a.height)),o=Math.max(1,Math.round(a.width*n)),r=Math.max(1,Math.round(a.height*n)),l=document.createElement("canvas");l.width=o,l.height=r;const c=l.getContext("2d");if(!c)throw a.close(),new Error("canvas 2d context unavailable");c.drawImage(a,0,0,o,r),a.close();let d=.85,p=l.toDataURL("image/jpeg",d);for(;.75*p.length>s&&d>.4;)d-=.1,p=l.toDataURL("image/jpeg",d);return l.width=0,l.height=0,p}async _handleBgUpload(e,t,i){const s=e.target,a=s.files?.[0];if(a){try{t(await this._prepareImageForEmbed(a,i))}catch(e){console.warn("[editor] failed to process image",a.name,e),this._showStyleFeedback(`Couldn't process "${a.name}" — try a /local/… URL instead`)}s.value=""}}_handleCardBgUpload(e){return this._handleBgUpload(e,e=>this._set("card_bg_image",e))}_handleTileBgUpload(e){return this._handleBgUpload(e,e=>this._set("style",{...this._config.style??{},tile_bg_image:e}),{maxDim:720})}_sec(e,t,i,s,a,n,o){const r=this._openSections[e];return Q`
      ...
      </div>`}_badge(e,t,i){return Q`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,a=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const a=t.size===i.length?void 0:[...t];this._set("areas",a)},n=this._getDiscoveredDevices(),o=e.hidden_devices??[],r=new Map;for(const e of n){const t=e.area??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const l=[...t.map(e=>e.name)];r.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=Q`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>n.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),a=this._expandedRoomStyle.has(t),r=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length),l=e.area_styles?.Favourites??{},c=[l.accentColor,l.tileBgColor,l.headerBgColor,l.bgColor].filter(Boolean);return Q`
            ...
            <div class="room-expanded">
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${r&&!c.length?Q`<span class="dev-style-dot"></span>`:G}
                  ${r?Q`<button class="color-reset" style="margin-left:auto"
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],a=this._selectedDeviceId===t.device_id,n=t.area?Q`<span class="fav-dev-area">${t.area}</span>`:G;return Q`
      ...
      ${l.map(t=>{const i=t||"No Room",n=r.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),v=e.area_styles?.[t]??{},u=[v.accentColor,v.tileBgColor,v.headerBgColor,v.bgColor].filter(Boolean);return Q`
          <div class="room-row">
          ...
          ${c?Q`
            <div class="room-expanded">
              ...
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${u.length?Q`<div class="room-swatch-strip">
                    ${u.map(e=>Q`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:G}
                  ${p&&!u.length?Q`<span class="dev-style-dot"></span>`:G}
            ...
            </div>`:G}`})}`,v=this._selectedDeviceId,u=v?n.find(e=>e.device_id===v):null,g=v&&u?Q`
      ...
      </div>`,u=r?r.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return Q`
      <div class="dev-style-panel">
        ...
        <div class="block-toggles">
          ${At.map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Q`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
        <div class="field-lbl" style="margin:6px 0 4px">Sensor chips</div>
        ${(()=>{const i=r?.area?this._config.area_styles?.[r.area]?.sensors:void 0;return this._chipPicker(t.sensors,i?.length?i:this._config.sensors,i?.length?`area (${r?.area})`:"global",t=>this._setDeviceStyle(e,{sensors:t}))})()}
        ${u.length?Q`
          ...
          ${u.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,n=a[t.entity_id]?.on??"none",r=a[t.entity_id]?.off??"none",l=a[t.entity_id]?.speed??1;return Q`
              <div class="ent-anim-row">
                <span class="ent-anim-name">${s}</span>
                ${this._iconPicker(`ent-on-${e}-${t.entity_id}`,"none"===n?void 0:n,!0,e=>o(t.entity_id,"on",e??"none"))}
                ${this._iconPicker(`ent-off-${e}-${t.entity_id}`,"none"===r?void 0:r,!1,e=>o(t.entity_id,"off",e??"none"))}
        ...
        </div>`},s=(i,s,a,n,o,r,l)=>{const c=t[s]??r;return Q`
        <div class="sl-row">
          <span class="color-key">${i}</span>
          <input type="range" min="${a}" max="${n}" step="${o}" style="flex:1;accent-color:#f4601e"
            .value=${String(c)}
      ...
      <div class="rsp-panel">
        ...
        ${a("ON / OFF buttons")}
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",a=t.buttonSize??"md",n="square"===i||"circle"===i,o="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",r=n?"sm"===a?"3px 5px":"lg"===a?"6px 12px":"4px 8px":"sm"===a?"2px 8px":"lg"===a?"6px 16px":"4px 12px",l="sm"===a?"10px":"lg"===a?"13px":"11px",c=n?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,v=`border-radius:${o};padding:${r};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,u=t.buttonShape||t.buttonVariant||t.buttonSize;return Q`
            <div class="btn-preview">
              <span class="preview-btn on" style="${v}${p}">ON</span>
              <span class="preview-btn off" style="${v}background:rgba(255,255,255,.08);color:var(--t2);border:none">OFF</span>
              ${u?Q`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:G}
            </div>
            <div class="field">
      ...
      ${e.map((n,o)=>this._renderViewCard(n,o,e.length,t,i,s,a))}
    `}_renderViewCard(e,t,i,s,a,n,o){const r=this._expandedViewId===e.id,l=e.filter??{},c=new Set(l.devices??[]),d=new Set(l.exclude_devices??[]),p=this._countViewMatches(e),v=o.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
      <div class="view-card ${r?"expanded":""}">
        <div class="view-card-hdr" @click=${()=>this._expandedViewId=r?null:e.id}>
          ...
          <span class="view-card-count" title="Devices matching this view's filter">${p}/${v}</span>
          ...
          <span class="view-card-chev">${r?"▲":"▼"}</span>
        </div>
        ...
        ${r?Q`
          <div class="view-card-body">
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Q`<button class="color-reset" @click=${()=>u("columns",void 0)}>↺</button>`:G}
            </div>
      ...
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=At.find(t=>t.id===e);if(!t)return G;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Q`
      ...
      ${this._sec("tileorder","↕","rgba(244,96,30,0.12)","#f4601e","Tile Block Order",Q`<span class="tag-new">Drag</span>`,a)}`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},a=(e,a,n)=>{const o=t[a]??n;return Q`
        <div class="color-row">
      ...
      </div>`,o=(e,i,s)=>{const a=t[i]??s;return Q`
        <div class="color-row">
      ...
      ${o("Dashboard BG","card_bg","#1c1c1e")}
      ${o("Accent / brand","accent_color","#f4601e")}
      ${o("Room header label","area_header_color","#f4601e")}

      <div class="subgroup-lbl">Tiles</div>
      ${o("Tile background","tile_bg","#1c1c1e")}
      ${o("Tile border","tile_border","#2a2a30")}
      ${o("Tile hover BG","tile_hover_bg","rgba(255,255,255,0.07)")}
      ${o("Tile hover shadow","tile_hover_shadow","rgba(0,0,0,0.30)")}
      ${o("Sensor chip BG","tile_sensor_bg","rgba(255,255,255,0.04)")}
      ${o("Expanded panel BG","tile_exp_bg","rgba(255,255,255,0.06)")}

      <div class="subgroup-lbl">Text &amp; status</div>
      ${o("Text primary","text_primary","#e5e7eb")}
      ${o("Text secondary","text_secondary","#9ca3af")}
      ${o("Text muted","text_muted","#6b7280")}
      ${o("Online dot","online_color","#4ade80")}
      ${o("Offline dot","offline_color","#ef4444")}
      ${o("Power reading","power_color","#fb923c")}`,l=t.font_family??"",c=Q`
      <div class="field">
      ...
      </div>`,d=e.card_opacity??100,p=e.tile_opacity??100,v=Q`
      <div class="field">
        <div class="field-lbl">Tile size</div>
        <div class="pill-grp">
          ${["sm","md","lg"].map((t,i)=>Q`
      ...
      ${this._sec("colors","◐","rgba(244,96,30,0.12)","#f4601e","Colors",G,r)}
      ${this._sec("tiles","⊡","rgba(45,212,191,0.1)","#2dd4bf","Tiles",G,v)}
      ...
      </div>`,n=e.graph_sensors??[],o=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],r=(e,t,i)=>{const a=s[e]??i,n=!!s[e];return Q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${a}"></div>
      ...
      ${o.map(e=>r(e.key,e.label,e.default))}
      ${n.filter(e=>!o.find(t=>t.key===e)).length?Q`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${n.filter(e=>!o.find(t=>t.key===e)).map(e=>{const t=kt.find(t=>t.key===e);return r(e,t?.label??e,(e=>s[e]??kt.find(t=>t.key===e)?.color??"#f4601e")(e))})}`:G}
      ...
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const a=""===s.trim()?void 0:parseFloat(s),n={...c[e]??{}};void 0===a||isNaN(a)?delete n[i]:n[i]=a;const o={...c,[e]:n};n.min||0===n.min||n.max||0===n.max||delete o[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(o).length?o:void 0})},p=Q`
      ...
      ${wt.map(i=>{const s=i.items.map(e=>e.key),a=s.filter(e=>t.includes(e)).length,n=s.every(e=>t.includes(e)),o=this._badge(`${a||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),r=Q`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),a=!!kt.find(e=>e.key===i.key),n=e.graph_sensors??[],o=n.includes(i.key);return Q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${a?Q`<button class="sensor-graph-btn ${o?"on":""}"
                    ...
                    @click=${e=>{e.stopPropagation();const t=o?n.filter(e=>e!==i.key):[...n,i.key];this._set("graph_sensors",t)}}>∿</button>`:G}
                </div>`})}
          </div>`;return this._sec(i.group.toLowerCase().replace(" ",""),i.icon,i.iconBg,i.iconColor,i.group,o,r)})}`}_renderYamlTab(){const e=this._config,t=(e,i=0)=>{const s="  ".repeat(i);return Object.entries(e).map(([e,a])=>null==a?"":"object"!=typeof a||Array.isArray(a)?Array.isArray(a)?`${s}${e}:\n${a.map(e=>"object"==typeof e?`${s}  -\n${t(e,i+2)}`:`${s}  - ${e}`).join("\n")}`:`${s}${e}: ${a}`:`${s}${e}:\n${t(a,i+1)}`).filter(Boolean).join("\n")},i=t(e);return Q`
  ...
  `],e([he({attribute:!1})],St.prototype,"hass",void 0),e([fe()],St.prototype,"_config",void 0),e([fe()],St.prototype,"_tab",void 0),e([fe()],St.prototype,"_expandedViewId",void 0),e([fe()],St.prototype,"_openSections",void 0),e([fe()],St.prototype,"_expandedRooms",void 0),e([fe()],St.prototype,"_expandedRoomStyle",void 0),e([fe()],St.prototype,"_selectedDeviceId",void 0),e([fe()],St.prototype,"_deviceSearch",void 0),e([fe()],St.prototype,"_hiddenBlocks",void 0),e([fe()],St.prototype,"_dragOrder",void 0),e([fe()],St.prototype,"_dragOver",void 0),e([fe()],St.prototype,"_styleClipFeedback",void 0),e([fe()],St.prototype,"_copyAreaOpen",void 0),e([fe()],St.prototype,"_copyJson",void 0),e([fe()],St.prototype,"_pasteOpen",void 0),e([fe()],St.prototype,"_pasteText",void 0),e([fe()],St.prototype,"_iconPickerState",void 0),St=e([ve("ha-device-dashboard-editor")],St),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
