...
`;function je(e,t,i="ts-hero-name"){return Z`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function He(e,t,i,s){return Z`
    <div class="${i}">
      ${je(e,t)}
      <span style="color:var(--sc-text-muted);font-size:.8em">${s}</span>
    </div>`}const Ue={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const We=[3,7,11,15,19,23,27];function qe(e,t,i,s){if("none"===e)return Z``;const r=t?"on":"off";return"flame"===e?Z`${G`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake"===e?Z`${G`<svg class="${s} ent-icon-snowflake" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?Z`${G`<svg class="${s} ent-icon-fan ${r}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?Z`${G`<svg class="${s} ent-icon-pulse ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"wave"===e?Z`${G`<svg class="${s} ent-icon-wave" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?Z`${G`<svg class="${s} ent-icon-sun ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?Z`${G`<svg class="${s} ent-icon-lightning ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?Z`${G`<svg class="${s} ent-icon-heart ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?Z`${G`<svg class="${s} ent-icon-bulb ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?Z`${G`<svg class="${s} ent-icon-leaf ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?Z`${G`<svg class="${s} ent-icon-flame2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?Z`${G`<svg class="${s} ent-icon-flame3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake2"===e?Z`${G`<svg class="${s} ent-icon-snowflake2" style="${i}" viewBox="0 0 20 20">
    <g class="snow-arms" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"snowflake3"===e?Z`${G`<svg class="${s} ent-icon-snowflake3" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?Z`${G`<svg class="${s} ent-icon-fan2 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?Z`${G`<svg class="${s} ent-icon-fan3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?Z`${G`<svg class="${s} ent-icon-lightning2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?Z`${G`<svg class="${s} ent-icon-lightning3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?Z`${G`<svg class="${s} ent-icon-bulb2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?Z`${G`<svg class="${s} ent-icon-bulb3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water2"===e?Z`${G`<svg class="${s} ent-icon-water2" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?Z`${G`<svg class="${s} ent-icon-water3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?Z`${G`<svg class="${s} ent-icon-sun2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?Z`${G`<svg class="${s} ent-icon-sun3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?Z`${G`<svg class="${s} ent-icon-moon2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?Z`${G`<svg class="${s} ent-icon-moon3 ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?Z`${G`<svg class="${s} ent-icon-wind ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?Z`${G`<svg class="${s} ent-icon-wind2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?Z`${G`<svg class="${s} ent-icon-wind3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?Z`${G`<svg class="${s} ent-icon-bell ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?Z`${G`<svg class="${s} ent-icon-bell2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?Z`${G`<svg class="${s} ent-icon-bell3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?Z`${G`<svg class="${s} ent-icon-thermometer ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?Z`${G`<svg class="${s} ent-icon-thermometer2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?Z`${G`<svg class="${s} ent-icon-thermometer3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?Z`${G`<svg class="${s} ent-icon-battery ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?Z`${G`<svg class="${s} ent-icon-battery2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?Z`${G`<svg class="${s} ent-icon-battery3 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?Z`${G`<svg class="${s} ent-icon-star ${r}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?Z`${G`<svg class="${s} ent-icon-star2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?Z`${G`<svg class="${s} ent-icon-star3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?Z`${G`<svg class="${s} ent-icon-pulse2 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?Z`${G`<svg class="${s} ent-icon-pulse3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?Z`${G`<svg class="${s} ent-icon-wave2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?Z`${G`<svg class="${s} ent-icon-wave3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?Z`${G`<svg class="${s} ent-icon-wave4 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?Z`${G`<svg class="${s} ent-icon-heart2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?Z`${G`<svg class="${s} ent-icon-leaf2 ${r}" style="${i}" viewBox="0 0 20 20">
...
`,Qe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Xe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ke=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ye(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,o]of Object.entries(t)){if(!o?.device_id)continue;if(o.hidden_by)continue;const t=a.split(".")[0];if(!Ke.has(t))continue;const n=(o.platform??"").toLowerCase();if("shelly"!==n)continue;const l=o.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===n,c=e.area_id??o.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:n,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==n||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:o.area_id,platform:n})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],o=s?.via_device_id;if(!o||!r.has(o)||a.has(o))continue;const n=i[o],l=s?.configuration_url??"",c=n?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(o).integration;if(!p&&!h)continue;const g=r.get(o);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]},et={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",badges:"Type & gen badges"};function tt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const it={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const st="—";function rt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:st}function at(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:st}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:st}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:st}function lt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:st}function ct(e){return!Number.isFinite(e)||e<0?st:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function dt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":st}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:st}function ht(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:st}function gt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:st}function ut(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:st}function vt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:st}function ft(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:st}function bt(e){return Number.isFinite(e)?`${Math.round(e)} %`:st}const mt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],xt=Object.fromEntries(mt.map(e=>[e.key,e.label.split(" ")[0]])),yt={co2:"carbon_dioxide",rssi:"signal_strength"};function wt(e){return yt[e]??e}function kt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(wt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=wt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const At=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Ct=["online","offline","power","alerts"];function St(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),o=g+e*Math.sin(m(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Z`
    ...
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const b=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=i.max??Math.max(...e),o=r-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/o*(p-2*h),b=e.indexOf(r);v=n(null,b),f=l(r);const m=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),x=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${x}" x1="0" y1="0" x2="0" y2="1">
    ...
    ${r>s?G`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${u}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${u}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:X}`})():X;return Z`
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      <div class="ts-spark-bottom">
        ...
        <div class="ts-spark-meta">
          ${null!=n.voltage?Z`<div class="ts-spark-mrow">${n.voltage.toFixed(1)} <b>V</b></div>`:X}
          ${null!=n.current?Z`<div class="ts-spark-mrow">${n.current.toFixed(2)} <b>A</b></div>`:X}
          ${null!=n.energy?Z`<div class="ts-spark-mrow">${n.energy.toFixed(2)} <b>kWh</b></div>`:X}
          ${null!=n.temp?Z`<div class="ts-spark-mrow">${n.temp.toFixed(1)} <b>°C</b></div>`:X}
          ${null!=n.rssi?Z`<div class="ts-spark-mrow">${n.rssi} <b>dBm</b></div>`:X}
        </div>
      </div>
      ${e.renderTileLowerBody(t,o,{skipPowerGraph:!0})}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:r,profile:a}=e,o=e.tileSensors(t),n=e.getPrimarySwitch(t);return Z`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=o.voltage?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${o.voltage.toFixed(0)}</div></div>`:X}
          ${null!=o.current?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${o.current.toFixed(2)}</div></div>`:X}
          ${null!=o.temp?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${o.temp.toFixed(1)}</div></div>`:X}
          ${null!=o.rssi?Z`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${o.rssi}</div></div>`:X}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=o.energy?Z`<span class="ts-hbar-badge">${o.energy.toFixed(2)} kWh</span>`:X}
          ${null!=o.uptime?Z`<span class="ts-hbar-badge">${ct(o.uptime)}</span>`:X}
        </div>
        ${n?Z`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(n.entityId,i,t)}>${i?"ON":"OFF"}</button>`:X}
      </div>
      ${e.renderTileLowerBody(t,a)}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():X,f=(e,t,i=!1)=>Z`
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():X;return Z`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        <div class="ts-chips">
          ${null!=n.voltage?Z`<span class="ts-chip">${n.voltage.toFixed(1)} V</span>`:X}
          ${null!=n.current?Z`<span class="ts-chip">${n.current.toFixed(2)} A</span>`:X}
          ${null!=n.energy?Z`<span class="ts-chip">${n.energy.toFixed(2)} kWh</span>`:X}
          ${null!=n.temp?Z`<span class="ts-chip">${n.temp.toFixed(1)} °C</span>`:X}
          ${null!=n.rssi?Z`<span class="ts-chip">${n.rssi} dBm</span>`:X}
        </div>
        <span class="ts-uptime">${n.uptime?ct(n.uptime):""}</span>
      </div>
      ${e.renderTileLowerBody(t,o)}
    </div>`}(e)}}const _t=140,zt=70;function Ot(e){const{device:t,isOn:i,accent:s,online:r,hass:a,profile:o}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return Z`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==o.type&&"rgb"!==o.type)return Z`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Z`
        <div class="ts-light-wheel-wrap">
          <svg width="${_t}" height="${_t}" viewBox="0 0 ${_t} ${_t}"
            ...
            ${k?G`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${h}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:X}
          </svg>
        </div>`:X}
      ...
      ${null!=l.power?Z`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${rt(l.power)}</div>`:X}
        ...
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${h?Z`<span class="update-dot" title="Firmware update">●</span>`:X}
          </div>
          ${c?Z`
      ...
      `}case"sensors":{if(!u.length)return Z``;const e=u.filter(e=>"primary"===(e.tier??"primary")),t=u.filter(e=>"electrical"===e.tier),i=u.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const a=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return Z`
        ${e.length?Z`
          <div class="tile-stats">
            ${e.map(e=>Z`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?Z`<span class="stat-lbl">${e.ch}</span>`:X}
                ${!e.ch&&e.key&&s.has(e.key)?Z`<span class="stat-lbl">${e.label}</span>`:X}
                ${e.value}
              </span>`)}
          </div>`:X}
        ${t.length?Z`
          <div class="tile-elec-wrap">
            ${[...r.entries()].map(([e,t])=>Z`
              <div class="tile-elec">
                ${e?Z`<span class="stat-lbl">${e}</span>`:X}
                ${t.map((e,t)=>Z`${t>0?Z`<span class="sep">·</span>`:X}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:X}
        ${i.length?Z`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>Z`${t>0?Z`<span class="sep">·</span>`:X}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:X}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=n?a.states[n.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,r=n?.whiteValue??0;return n&&b?Z`
        ...
        `:X}
      `:Z``}case"cover_controls":return c?Z`
      ...
      `:Z``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?Z`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?Z`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:X}
            ${null!=s?Z`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:X}
          </div>
          ${l.presetModes.length?Z`
            <div class="trv-presets">
              ${l.presetModes.map(t=>Z`
      ...
      `:Z``}case"input_channels":return v.length?Z`
      ...
      `:Z``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Z`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return X;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return Z`
                <div class="virt-row">
                ...
                </div>`}if("number"===t.domain){const i=parseFloat(t.value),s=t.step??1,r=s<1?String(s).split(".")[1]?.length??1:0;return Z`
                <div class="virt-row">
                  <span class="virt-lbl">${t.label}</span>
                  <div class="virt-num">
        ...
        </div>`:Z``}case"relay_channels":{const t=i.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id));return t.length<=1?Z``:Z`
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=a.states[t.entity_id],r="on"===s?.state,o=s?.attributes?.friendly_name??t.entity_id;return Z`
        ...
        </div>`}case"valve_controls":{const t=e.getValve(i);return t?Z`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ${e.renderValveDial(t)}
      ...
      `:Z``}case"power_bar":return e.renderPowerBar(i);case"badges":return Z`
        <div class="tile-bot">
          ${null!=g?Z`<span class="tile-power">${rt(g)}</span>`:X}
          <div class="tile-badges">
            ${p.map(e=>Z`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?Z`<span class="type-badge type-${s.type}">${s.label}</span>`:X}
            ${A?Z`<span class="gen-badge gen-${s.gen}">${A}</span>`:X}
            ${C?Z`<span class="int-badge-tile">${C}</span>`:X}
            ${i.isShelly&&i.ip&&(_=i.ip,/^10\./.test(_)||/^192\.168\./.test(_)||/^172\.(1[6-9]|2\d|3[01])\./.test(_)||/^169\.254\./.test(_))?Z`
              <a href="http://${i.ip}" target="_blank" class="tile-ui-link"
                @click=${e=>e.stopPropagation()}>↗</a>
            `:X}
          </div>
        </div>
      `;default:return Z``}}const Mt=255;function Tt(e){return Z`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:r}=e,a=e.getFirmware(t),o=e.tileSensors(t);return Z`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?Z`<span class="ds-chip ds-chip--room">${t.area}</span>`:X}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?Z`<span class="ds-chip">${t.model}</span>`:X}
        ${"other"!==i.gen?Z`<span class="ds-chip">Gen ${i.gen}</span>`:X}
        ${t.ip?Z`<span class="ds-chip">${t.ip}</span>`:X}
      </div>
      ${a?Z`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:X}
      ${null!=o.rssi?Z`<div class="ds-signal">Wi-Fi: ${dt(o.rssi)} (${o.rssi} dBm)${null!=o.uptime?Z` · Up ${ct(o.uptime)}`:X}</div>`:X}
      <div class="ds-accent-bar" style="background:${s}"></div>
    </div>`}(e)}
        <div class="ds-body ds-body--${e.profile.type}">
          ${function(e){switch(e.profile.type){case"relay":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"switch"===e.domain);return Z`
    ${s.length>1?Z`
      <div class="ds-section">
        <div class="ds-section-title">Relay Channels</div>
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,o=r?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Z`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${o}</span>
                ${isNaN(c)?X:Z`<span class="ds-channel-power">${rt(c)}</span>`}
                <button class="tog ${a?"on":"off"}" @click=${t=>e.toggle(s.entity_id,a,t)}>${a?"ON":"OFF"}</button>
              </div>`})}
        </div>
      </div>`:1===s.length?Z`
      <div class="ds-section ds-single-toggle">
        ${(()=>{const t=i.states[s[0].entity_id],r="on"===t?.state;return Z`
          <button class="tog ds-big-toggle ${r?"on":"off"}" @click=${t=>e.toggle(s[0].entity_id,r,t)}>${r?"ON":"OFF"}</button>`})()}
      </div>`:X}
    ${Et(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Z`
    <div class="ds-section ds-plug-hero">
      ${t?Z`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:X}
      ${null!=s.power?Z`<span class="ds-big-power">${rt(s.power)}</span>`:X}
    </div>
    ${Et(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return Z`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?Z`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:X}
      </div>
    </div>
    ${Et(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/Mt*100);return Z`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?Z`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:X}
      </div>
      ${i?.rgbColor?Z`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:X}
    </div>
    ${Et(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Z`
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?Z`<span class="ds-chip">${t.hvacAction}</span>`:X}
          ${t.presetMode?Z`<span class="ds-chip">${t.presetMode}</span>`:X}
        </div>
        ${null!=t.valvePosition?Z`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:X}
      `:Z`<span class="ds-muted">No climate entity</span>`}
    </div>
    ${Et(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Z`
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        ${null!=t.position?Z`<div class="ds-cover-pos">Position: ${t.position}%</div>`:X}
        <span class="ds-chip">${t.state}</span>
      `:Z`<span class="ds-muted">No cover entity</span>`}
    </div>
    ${Et(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Z`
    <div class="ds-section">
      ...
      ${t?Z`
        ...
        ${null!=t.position?Z`<div class="ds-cover-pos">Position: ${t.position}%</div>`:X}
        ${null!=t.temperature?Z`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:X}
        <span class="ds-chip">${t.state}</span>
      `:Z`<span class="ds-muted">No valve entity</span>`}
    </div>
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Z`${Et(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return Z`
    ${s?(()=>{const e=i.states[s.entity_id],t=parseFloat(e?.state??""),r=e?.attributes?.unit_of_measurement??"";return Z`
        <div class="ds-section ds-sensor-hero">
          <span class="ds-big-value">${isNaN(t)?"—":t.toFixed(1)}</span>
          <span class="ds-big-unit">${r}</span>
        </div>`})():X}
    ${r.length?Z`<div class="ds-section ds-alert-row">${r.map(e=>Z`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:X}
    ${Et(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Z`
    <div class="ds-section">
      <div class="ds-section-title">Input Channels</div>
      ${s.length?Z`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,o=s?.last_changed?e.timeAgo(s.last_changed):"";return Z`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
                <span class="ds-chip ${r?"ds-chip--on":""}">${r?"ON":"OFF"}</span>
                ${o?Z`<span class="ds-ent-age">${o}</span>`:X}
              </div>`})}
        </div>`:Z`<span class="ds-muted">No input channels</span>`}
    </div>
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return Z`
    ${s.length?Z`
      <div class="ds-section">
        <div class="ds-section-title">ADC Inputs</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",r=t?.attributes?.unit_of_measurement??"",a=t?.attributes?.friendly_name??e.entity_id;return Z`<div class="ds-channel-row"><span class="ds-channel-name">${a}</span><span>${s} ${r}</span></div>`})}
      </div>`:X}
    ${r.length?Z`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${r.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id;return Z`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
    ...
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Z`
    ${t?Z`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${Et(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Z`
    ${s.length?Z`
      <div class="ds-section">
        <div class="ds-section-title">Controls</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.attributes?.friendly_name??e.entity_id;return Z`<div class="ds-channel-row"><span class="ds-channel-name">${s}</span><span>${t?.state??"unknown"}</span></div>`})}
      </div>`:X}
    ${Et(e,{sensors:!1})}`}(e)}}(e)}
          ${function(e){const t=e.customize;return Z`
    <details class="ds-customize">
      <summary class="ds-cz-summary">⚙ Customise tile${t.customized?Z`<span class="ds-cz-dot" title="This tile has custom visibility"></span>`:X}</summary>
      <div class="ds-cz-body">
        ...
        ${t.customized?Z`<button class="ds-cz-reset" @click=${()=>t.reset()}>↺ Reset to default</button>`:X}
      </div>
    </details>`}(e)}
        </div>
      </div>
    </div>`}function Bt(e){if(!e.getGraphEntities(e.device).length)return Z``;const t=e.getDetailHistoryRange();return Z`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function Et(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return Z`
    ${r&&s?Bt(e):X}
    ${i?function(e){const t=e.tileSensors(e.device);return null!=t.power||null!=t.voltage||null!=t.current||null!=t.energy||null!=t.temp?Z`
    <div class="ds-section">
      <div class="ds-section-title">Sensors</div>
      <div class="ds-sensor-grid">
        ${null!=t.power?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:X}
        ${null!=t.voltage?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${ot(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:X}
        ${null!=t.current?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${nt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:X}
        ${null!=t.energy?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:X}
        ${null!=t.temp?Z`<div class="ds-sensor-item"><span class="ds-sensor-val">${lt(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:X}
      </div>
    </div>`:Z``}(e):X}
    ${!r&&s?Bt(e):X}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return Z``;const s=new Set(e.config.hidden_entities??[]),r=t.entities.filter(e=>!s.has(e.entity_id));return Z`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${r.map(t=>{const s=i.states[t.entity_id],r=s?.attributes?.friendly_name??t.entity_id,a=s?.state??"unknown",o=s?.attributes?.unit_of_measurement??"",n="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===a,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Z`
    ...
    <div class="ds-section">
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?X:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="none"
                ...
                `:X}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=T(e)-t/2,r=B(e),n=o-4-r;return G`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):G`
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const r=e=>{const r=this._trvTempFromEvent(e,s,t,i,a);null!=r&&(this._trvDragTemp=r)},n=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(o,l),s.removeEventListener("pointermove",r),s.removeEventListener("pointerup",n)};s.addEventListener("pointermove",r),s.addEventListener("pointerup",n)}}>
        ...
        ${u>210?G`<path d="${h(210,u,54)}" fill="none" stroke="url(#${y})" stroke-width="8" stroke-linecap="round"/>`:X}
        ${m?G`<circle cx="${m[0]}" cy="${m[1]}" r="5" fill="white" stroke="${x}" stroke-width="2"/>`:X}
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const o=(e.clientX-a.left)*(160/a.width),n=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(n-70,o-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const o=(a-210+360)%360;return o>300?null:Math.round(o/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[o,n]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${o} ${n}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,o=(e=>210+e/100*300)(a),[n,l]=i(o,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return G`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${r?G`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:X}
        <path d="${s(210,510,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${t>0?G`<path d="${s(210,o,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:X}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:o,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?G`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`;if("cover"===l){const e=s??("open"===r?100:"closed"===r?0:50),t="opening"===r||"closing"===r,i=[2,5.5,9,12.5,16],a=Math.ceil(e/100*i.length);return G`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?G`<svg class="tile-icon tile-icon-valve ${o?"on":""}" viewBox="0 0 20 20">
        ...
        <div class="metric-list">
          ${r.map(e=>Z`
            <div class="metric-row">
              ...
              ${e.value?Z`<span class="metric-val">${e.value}</span>`:X}
            </div>`)}
        </div>
      </div>`:Z``}_tileAccent(e,t){const i=this._config.device_styles?.[e.device_id]?.color;if(i)return i;const s=this._config.area_styles?.[t];return s?.accentColor?s.accentColor:this._config.style?.accent_color??"var(--sc-accent)"}_renderTileLowerBody(e,t,i={}){const s=this._getPrimarySwitch(e),r=this._getTrv(e),a=this._getValve(e),o=this._getCover(e),n=s?.isOn??!1;let l=null;const c=()=>l??(l=this._buildTileCtx(e,t,this._tileAccent(e,e.area??""))),d=this._getGraphEntities(e),p=i.skipGraphs?[]:i.skipPowerGraph?d.filter(e=>"power"!==e.dc):d,h=p.length?Z`<div class="ts-lower-section ts-lower-graphs">
          ${this._renderSparklinesFiltered(e,p)}
        </div>`:X,g=void 0!==s?.brightness,u=!!s?.colorModes?.length,v=u&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=u&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),b=g&&n?Math.max(1,s.brightness??1):0,m=s?.whiteValue??0,x=s?this.hass.states[s.entityId]:null,y=x?.attributes?.effect_list??[],w=x?.attributes?.effect??null,k=g?Z`
    ...
    `:X,_=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),z=_.length>1?Z`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:X;return p.length||g||r||a||o||_.length>1?Z`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${Ae(n)}
          ...
          ${Ee(r,e=>e,e=>It(c,e))}
        </div>`}const u=e.area??"",v=this._tileAccent(e,u);this._getPrimarySwitch(e);return Z`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${Ae(n)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?St(this._buildTileCtx(e,s,v),g):"light-control"===p?Ot(this._buildTileCtx(e,s,v)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return He(t,s,"ts-climate","No climate entity");const o="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return Z`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ${je(t,s)}
        <div style="display:flex;align-items:center;gap:6px">
          ${o?Z`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:Z`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>
      </div>
      ${e.renderTrvDial(a)}
      <div class="trv-dial-btns">
      ...
      <div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?Z`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:X}
        ${null!=l?Z`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:X}
      </div>
      ${a.presetModes.length?Z`<div class="trv-presets">${a.presetModes.map(t=>Z`
        <button class="trv-preset-btn ${a.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(a.entityId,t)}>${(Ue[t]??"")+t}</button>`)}
      </div>`:X}
    </div>`}(this._buildTileCtx(e,s,v)):"cover-control"===p?function(e){const{device:t,accent:i,online:s}=e,r=e.getCover(t);if(!r)return Z`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=r.position??("open"===r.state?100:0),o="opening"===r.state||"closing"===r.state,n=Math.ceil(a/100*We.length);return Z`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${We.map((e,t)=>G`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<n?"0.85":"0.1"}"/>`)}
        </svg>
        ${o?Z`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:X}
      </div>
      ...
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${u.length?Z`<div class="ts-chips" style="margin-top:6px">
          ${u.map(e=>{const t=r.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return Z`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:X}
      </div>`}const l=r.states[n.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",h=c?"#f87171":"var(--sc-online-color)",g=l?.last_changed?e.timeAgo(l.last_changed):"";return Z`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${je(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      ...
      ${g?Z`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${g}</div>`:X}
    </div>`}(this._buildTileCtx(e,s,v)):"scene-button"===p?function(e){const{device:t,accent:i,online:s,config:r}=e,a=e.getInputChannels(t),o=r.device_styles?.[t.device_id],n=qe(o?.tile_icon??"pulse",!0,`--ent-spd:${o?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?Z`
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Z`<span class="area-power">${rt(a)}</span>`:X}
    ...
    `}render(){if(!this._config||!this.hass)return Z``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return Z`
        <ha-card>
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${Ae(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?Ee([...o.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):Z`<div class="device-grid" style="--cols:${r?.columns??this._config.columns??3}">
                ${Ee(a,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
      </ha-card>
    `;return b}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Z``;const t=this._getActiveView()?.id;return Z`
      <div class="view-tabs">
        ${e.map(e=>Z`
          <button class="view-tab ${e.id===t?"active":""}"
            @click=${()=>this._setActiveView(e.id)}>
            ${e.icon?Z`<ha-icon class="view-tab-icon" .icon=${e.icon}></ha-icon>`:X}
            <span>${e.name}</span>
          </button>`)}
    ...
    `],e([ve({attribute:!1})],Pt.prototype,"hass",void 0),e([ve({type:Boolean})],Pt.prototype,"preview",void 0),e([fe()],Pt.prototype,"_config",void 0),e([fe()],Pt.prototype,"_closedAreas",void 0),e([fe()],Pt.prototype,"_entityListOpen",void 0),e([fe()],Pt.prototype,"_graphData",void 0),e([fe()],Pt.prototype,"_valveDragPos",void 0),e([fe()],Pt.prototype,"_trvDragTemp",void 0),e([fe()],Pt.prototype,"_cloudDetailOpen",void 0),e([fe()],Pt.prototype,"_detailDevice",void 0),e([fe()],Pt.prototype,"_detailHistoryRange",void 0),e([fe()],Pt.prototype,"_activeViewId",void 0),e([fe()],Pt.prototype,"_tileBlockOverride",void 0),e([fe()],Pt.prototype,"_tileChipOverride",void 0),e([fe()],Pt.prototype,"_areaHeaderOverride",void 0),e([fe()],Pt.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Pt.prototype,"_areaCustomizeOpen",void 0),Pt=Rt=e([he("ha-device-dashboard")],Pt);const Lt={warm_dusk:{accent_color:"#c98a63",card_bg:"#1e1a17",tile_bg:"rgba(255,244,232,0.035)",tile_border:"rgba(255,244,232,0.08)",tile_hover_bg:"rgba(255,244,232,0.06)",tile_hover_shadow:"rgba(0,0,0,0.35)",tile_sensor_bg:"rgba(255,244,232,0.045)",tile_exp_bg:"rgba(255,244,232,0.05)",text_primary:"#ece5dc",text_secondary:"#b3a596",text_muted:"#7e7265",header_bg:"#241f1b",header_bg2:"#33291f",header_text_color:"#f3ece3",header_orb_color:"#c98a63",online_color:"#93b384",offline_color:"#d47f62",power_color:"#dba25c",area_header_color:"#c98a63"},dark_industrial:{accent_color:"#f4601e",card_bg:"#1c1c1e",tile_bg:"rgba(255,255,255,0.04)",tile_border:"rgba(255,255,255,0.07)",tile_hover_bg:"rgba(255,255,255,0.07)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(255,255,255,0.04)",tile_exp_bg:"rgba(255,255,255,0.06)",text_primary:"#e5e7eb",text_secondary:"#9ca3af",text_muted:"#6b7280",header_bg:"#1a1a2e",header_bg2:"#0f3460",header_text_color:"#ffffff",header_orb_color:"#3b82f6",online_color:"#4ade80",offline_color:"#ef4444",power_color:"#fb923c",area_header_color:"#f4601e"},teal_terminal:{accent_color:"#2dd4bf",card_bg:"#0b0f0e",tile_bg:"#0f1917",tile_border:"#1e2b28",tile_hover_bg:"rgba(45,212,191,0.08)",tile_hover_shadow:"rgba(0,0,0,0.40)",tile_sensor_bg:"rgba(45,212,191,0.05)",tile_exp_bg:"rgba(45,212,191,0.07)",text_primary:"#d1fae5",text_secondary:"#6ee7b7",text_muted:"#4b5563",header_bg:"#042f2e",header_bg2:"#0b6157",header_text_color:"#ccfbf1",header_orb_color:"#2dd4bf",online_color:"#34d399",offline_color:"#f87171",power_color:"#fbbf24",area_header_color:"#2dd4bf"},brutalist:{accent_color:"#facc15",card_bg:"#000000",tile_bg:"#0a0a0a",tile_border:"#ffffff",tile_hover_bg:"rgba(255,255,255,0.12)",tile_hover_shadow:"rgba(250,204,21,0.25)",tile_sensor_bg:"rgba(255,255,255,0.06)",tile_exp_bg:"rgba(255,255,255,0.09)",text_primary:"#ffffff",text_secondary:"#d4d4d4",text_muted:"#a3a3a3",header_bg:"#000000",header_bg2:"#171717",header_text_color:"#facc15",header_orb_color:"#facc15",online_color:"#22c55e",offline_color:"#ef4444",power_color:"#facc15",area_header_color:"#ffffff"},frosted_light:{accent_color:"#0071e3",card_bg:"#f2f2f7",tile_bg:"#ffffff",tile_border:"#d1d1d6",tile_hover_bg:"rgba(0,0,0,0.04)",tile_hover_shadow:"rgba(0,0,0,0.12)",tile_sensor_bg:"rgba(0,0,0,0.04)",tile_exp_bg:"rgba(0,0,0,0.05)",text_primary:"#1c1c1e",text_secondary:"#48484a",text_muted:"#8e8e93",header_bg:"#e8eef7",header_bg2:"#cfe0f5",header_text_color:"#1c1c1e",header_orb_color:"#0071e3",online_color:"#34c759",offline_color:"#ff3b30",power_color:"#ff9500",area_header_color:"#0071e3"},nordic_warm:{accent_color:"#d08770",card_bg:"#2e3440",tile_bg:"#3b4252",tile_border:"#434c5e",tile_hover_bg:"rgba(236,239,244,0.06)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(236,239,244,0.04)",tile_exp_bg:"rgba(236,239,244,0.06)",text_primary:"#eceff4",text_secondary:"#d8dee9",text_muted:"#9aa4b8",header_bg:"#3b4252",header_bg2:"#434c5e",header_text_color:"#eceff4",header_orb_color:"#ebcb8b",online_color:"#a3be8c",offline_color:"#bf616a",power_color:"#d08770",area_header_color:"#d08770"},midnight_purple:{accent_color:"#a78bfa",card_bg:"#0f0a1e",tile_bg:"#1a1030",tile_border:"#2e1f4d",tile_hover_bg:"rgba(167,139,250,0.10)",tile_hover_shadow:"rgba(0,0,0,0.45)",tile_sensor_bg:"rgba(167,139,250,0.06)",tile_exp_bg:"rgba(167,139,250,0.08)",text_primary:"#ede9fe",text_secondary:"#c4b5fd",text_muted:"#7c6ba8",header_bg:"#1e1b4b",header_bg2:"#4c1d95",header_text_color:"#ede9fe",header_orb_color:"#a78bfa",online_color:"#4ade80",offline_color:"#fb7185",power_color:"#c084fc",area_header_color:"#a78bfa"}},Nt=["warm_dusk","dark_industrial","teal_terminal","brutalist","frosted_light","nordic_warm","midnight_purple"],jt={warm_dusk:"Warm Dusk",dark_industrial:"Dark Industrial",teal_terminal:"Teal Terminal",brutalist:"Brutalist",frosted_light:"Frosted Light",nordic_warm:"Nordic Warm",midnight_purple:"Midnight Purple",custom:"Custom"},Ht=Object.keys(Lt.dark_industrial);function Ut(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of Nt){const i=Lt[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}const Wt=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let qt=!1;const Zt=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"}]}],Gt=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Qt=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Xt=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}],Vt=["style","tile_size","tile_opacity","card_opacity","card_bg_image","card_bg_image_size","tile_layout","graph_style","graph_sensors","graph_hours","graph_line_color","graph_sensor_colors","sensors","sort_by","columns","show_power_bar","power_bar_max","area_styles","device_styles","views","default_view"];let Kt=class extends de{constructor(){super(...arguments),this._tab="devices",this._advanced=!1,this._defaultsOpen=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._hiddenBlocks=new Set,this._dragOrder=Gt.map(e=>e.id),this._dragOver=null,this._styleClipFeedback="",this._copyAreaOpen=!1,this._copyJson="",this._pasteOpen=!1,this._pasteText="",this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCache=[]}setConfig(e){this._config=kt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of Ht)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:X}connectedCallback(){super.connectedCallback(),function(){if(qt||"undefined"==typeof document)return;const e=Wt.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),qt=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;const a="ha-device-dashboard-editor-fix";if(!r.getElementById(a)){const e=document.createElement("style");e.id=a,e.textContent="\n          div.element-editor { height:100% !important; max-height:100% !important; overflow:hidden !important; box-sizing:border-box !important; }\n          hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n          div.element-preview { height:100% !important; max-height:100% !important; overflow-y:auto !important; overflow-x:hidden !important; box-sizing:border-box !important; }\n        ",r.appendChild(e)}const o=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=window.innerHeight,a=i?.offsetHeight??0,o=e.getBoundingClientRect().top,n=Math.max(300,s-o-a);e.style.cssText+=`;height:${n}px !important;max-height:${n}px !important;overflow:hidden !important;align-items:stretch !important;box-sizing:border-box !important`;const l=r.querySelector("div.element-editor"),c=t.getBoundingClientRect().top,d=l?l.getBoundingClientRect().bottom:s,p=Math.max(400,d-c);t.style.height=`${p}px`,t.style.maxHeight=`${p}px`};if(o(),this._editorLayoutTimers.push(window.setTimeout(o,50),window.setTimeout(o,250),window.setTimeout(o,700)),this._editorResizeHandler=o,window.addEventListener("resize",o),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(o);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return Z`
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?Qe.map(i=>{const s=(e.currentValue??"none")===i.value,r="none"!==i.value?Ze[i.value]?.[e.isOn?"on":"off"]??t:t;return Z`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?Z`<span class="icon-grid-none">—</span>`:qe(i.value,e.isOn,`--ent-spd:1;color:${r};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):X}
      </div>`}_iconPicker(e,t,i,s){const r="#f4601e",a=t?Ze[t]?.[i?"on":"off"]??r:r,o=this._iconPickerState?.onSelect===s;return Z`
      ...
      </div>`}_badge(e,t,i){return Z`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,r=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const r=t.size===i.length?void 0:[...t];this._set("areas",r)},a=this._getDiscoveredDevices(),o=e.hidden_devices??[],n=new Map;for(const e of a){const t=e.area??"";n.has(t)||n.set(t,[]),n.get(t).push(e)}const l=[...t.map(e=>e.name)];n.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=Z`
      <div class="rooms-toolbar">
        <div class="toolbar-group">
          <span class="toolbar-lbl">Sort</span>
          <div class="pill-grp">
            ${["name","power","online"].map(t=>Z`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>a.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),r=this._expandedRoomStyle.has(t),n=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length),l=e.area_styles?.Favourites??{},c=[l.accentColor,l.tileBgColor,l.headerBgColor,l.bgColor].filter(Boolean);return Z`
          <div class="room-row fav-room-row">
            ...
            ${n?Z`<button class="room-reset-btn" title="Set Favourites style to default"
            ...
            <div class="room-expanded">
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${c.length?Z`<div class="room-swatch-strip">
                    ${c.map(e=>Z`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:X}
                  ${n&&!c.length?Z`<span class="dev-style-dot"></span>`:X}
                  ${n?Z`<button class="color-reset" style="margin-left:auto"
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?Z`<span class="fav-dev-area">${t.area}</span>`:X;return Z`
                    <div class="room-device-row ${r?"selected":""}">
                      ${a}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?Z`<span class="dev-style-dot"></span>`:X}
                      <label class="sw">
                      ...
                      ${s?Z`<button class="room-reset-btn" title="Set device style to default"
      ...
      ${l.map(t=>{const i=t||"No Room",a=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),h=e.area_styles?.[t]??{},g=[h.accentColor,h.tileBgColor,h.headerBgColor,h.bgColor].filter(Boolean);return Z`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${a.length?Z`<span class="room-count">${a.length}</span>`:X}
            <label class="sw"><input type="checkbox" .checked=${l}
              @change=${()=>r(t)}>
              <span class="sw-t"></span><span class="sw-b"></span></label>
            ${p?Z`<button class="room-reset-btn" title="Set room style to default"
            ...
            <div class="room-expanded">
              ...
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${g.length?Z`<div class="room-swatch-strip">
                    ${g.map(e=>Z`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:X}
                  ${p&&!g.length?Z`<span class="dev-style-dot"></span>`:X}
                  ${p?Z`<button class="color-reset" style="margin-left:auto" @click=${e=>{e.stopPropagation(),this._clearAreaStyle(t)}}>Clear</button>`:X}
              ...
              <!-- Device list -->
              <div class="room-devices">
                ${a.length?a.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id;return Z`
                    <div class="room-device-row ${r?"selected":""}">
                      ...
                      ${s?Z`<button class="room-reset-btn" title="Set device style to default"
                        @click=${e=>{e.stopPropagation(),this._clearDeviceStyle(t.device_id)}}>↺</button>`:X}
                      <button class="room-style-btn ${r?"active":""}" title="Edit device style" @click=${e=>{e.stopPropagation(),this._selectedDeviceId=r?null:t.device_id}}>✎</button>
                    </div>`}):Z`<div class="room-device-empty">No devices in this room</div>`}
              </div>
            </div>`:X}`})}`,h=this._selectedDeviceId,g=h?a.find(e=>e.device_id===h):null,u=h&&g?Z`
      ...
      ${o?Z`
        ...
        </div>`:X}`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._config.tile_layout??Gt.map(e=>e.id),s=t.tile_layout??null,r=t.entity_animations??{},a=t=>{const r=null===s?i.includes(t):s.includes(t),a=Gt.map(e=>e.id).filter(e=>e===t?!r:null===s?i.includes(e):s.includes(e)),o=a.length===i.length&&a.every(e=>i.includes(e));this._setDeviceStyle(e,{tile_layout:o?void 0:a})},o=(t,i,s)=>{const a={...r[t]??{}};if("speed"===i){const e=Number(s);1===e?delete a.speed:a.speed=e}else"none"===s?delete a[i]:a[i]=s;const o={...r,[t]:a};a.on||a.off||a.speed||delete o[t],this._setDeviceStyle(e,{entity_animations:Object.keys(o).length?o:void 0})},n=this._allDevices().find(t=>t.device_id===e),l=n?tt(n):null,c=l?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[l.type]:void 0,d=t.tile_style,p=t.power_monitor_variant??"big-number",h=Z`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${c&&!d?Z`<span class="dev-style-hint">Recommended: ${c}</span>`:X}
          ${d?Z`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:X}
        </div>
        ${this._renderTileStylePicker(d,p,c,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}))}
      </div>`,g=n?n.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return Z`
      <div class="dev-style-panel">
        ...
        <div class="color-row">
          ...
          ${t.color?Z`<button class="color-reset"
        ...
        <div class="pill-grp" style="margin-bottom:8px">
          ${[["Inherit",void 0],["On",!0],["Off",!1]].map(([i,s])=>Z`
        ...
        <div class="block-toggles">
          ${Gt.filter(e=>"graph"!==e.id).map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Z`<span class="block-tog ${t?"on":""}" @click=${()=>a(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
        ...
        ${this._adv(g.length?Z`
          ...
          ${g.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,a=r[t.entity_id]?.on??"none",n=r[t.entity_id]?.off??"none",l=r[t.entity_id]?.speed??1;return Z`
        ...
        ${this._adv(n?.entities.length?Z`
          ...
          <div class="block-toggles">
            ${n.entities.map(e=>{const t=this._config.hidden_entities??[],i=t.includes(e.entity_id),s=this.hass?.states[e.entity_id]?.attributes?.friendly_name??e.entity_id.split(".").pop()??e.entity_id;return Z`<span class="block-tog ${i?"":"on"}"
      ...
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,r)=>{const a=t[s]??r;return Z`
        <div class="color-row">
          ...
          ${t[s]?Z`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:X}
        </div>`},s=(i,s,r,a,o,n,l)=>{const c=t[s]??n;return Z`
        <div class="sl-row">
          <span class="color-key">${i}</span>
        ...
        </div>`},r=e=>Z`<div class="rsp-section-lbl">${e}</div>`;return Z`
      <div class="rsp-panel">
        ${r("Layout")}
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",r=t.buttonSize??"md",a="square"===i||"circle"===i,o="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",n=a?"sm"===r?"3px 5px":"lg"===r?"6px 12px":"4px 8px":"sm"===r?"2px 8px":"lg"===r?"6px 16px":"4px 12px",l="sm"===r?"10px":"lg"===r?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${o};padding:${n};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,g=t.buttonShape||t.buttonVariant||t.buttonSize;return Z`
            <div class="btn-preview">
              ...
              ${g?Z`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:X}
            </div>
            <div class="field">
              <div class="field-lbl">Shape</div>
              <div class="pill-grp">
                ${["pill","rect","square","circle"].map(t=>Z`
    ...
    `}_renderViewCard(e,t,i,s,r,a,o,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,o,n),g=o.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return Z`
      <div class="view-card ${l?"expanded":""}">
        <div class="view-card-hdr" @click=${()=>this._expandedViewId=l?null:e.id}>
          <span class="view-card-icon">${e.icon?Z`<ha-icon .icon=${e.icon}></ha-icon>`:"☰"}</span>
        ...
        ${l?Z`
          <div class="view-card-body">
              ...
              <div class="view-dev-list">
                ${Ee(o,e=>e.device_id,t=>Z`
                  <label class="view-dev-row">
                    ...
                    ${t.area?Z`<span class="view-dev-area">${t.area}</span>`:X}
                  </label>`)}
              </div>
            </div>
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?Z`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:X}
            </div>`)}
            ...
            <div class="field">
              ...
              <div class="pill-grp">
                ${["default","power-monitor","light-control","climate-control","cover-control","sensor-card","scene-button"].map(t=>Z`
                  <span class="pill ${(e.tile_style??"default")===t?"on":""}"
                    @click=${()=>u("tile_style","default"===t?void 0:t)}>${t}</span>`)}
              </div>
            </div>
            ${"power-monitor"===e.tile_style?Z`
              <div class="field">
                <div class="field-lbl">Power-monitor variant</div>
                <div class="pill-grp">
                  ${["big-number","gauge","graph","compact","table"].map(t=>Z`
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Z`<button class="color-reset" @click=${()=>u("columns",void 0)}>↺</button>`:X}
            </div>
      ...
      </div>`}_gridBody(){const e=this._config;return Z`
      <div class="field">
      ...
      </div>`}_tileOrderBody(){const e=this._config.style?.accent_color??"#f4601e",t=this._dragOrder.filter(e=>!this._hiddenBlocks.has(e));return Z`
      <div class="tile-preview-live">
        ${t.length?t.map(t=>{switch(t){case"name_row":return Z`<div class="tp-row tp-name-row"><div class="tp-dot" style="background:#4ade80"></div><span class="tp-name">Ljós yfir vaska</span><span class="tp-tog" style="background:${e}">ON</span></div>`;case"sensors":return Z`<div class="tp-row tp-chips"><span class="tp-chip">4.1 W</span><span class="tp-chip">235 V</span><span class="tp-chip">44.6 °C</span><span class="tp-chip">−54 dBm</span></div>`;case"graph":return Z`<div class="tp-row"><svg viewBox="0 0 200 28" preserveAspectRatio="none" style="width:100%;height:28px;display:block"><polygon points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5 200,28 0,28" fill="${e}" fill-opacity="0.15"/><polyline points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5" fill="none" stroke="${e}" stroke-width="1.5" stroke-linecap="round"/></svg></div>`;case"dimmer":return Z`<div class="tp-row" style="gap:8px"><span class="tp-lbl">Brightness</span><div class="tp-strack"><div class="tp-sfill" style="width:68%;background:${e}"></div></div><span class="tp-val">68%</span></div>`;case"cover_controls":return Z`<div class="tp-row" style="gap:4px"><button class="tp-btn">▲</button><button class="tp-btn">■</button><button class="tp-btn">▼</button></div>`;case"trv_control":return Z`<div class="tp-row" style="gap:8px"><svg viewBox="0 0 80 44" style="width:60px;height:34px;flex-shrink:0"><path d="M 8 40 A 32 32 0 1 1 72 40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="6" stroke-linecap="round"/><path d="M 8 40 A 32 32 0 0 1 52 10" fill="none" stroke="${e}" stroke-width="6" stroke-linecap="round"/><text x="40" y="34" text-anchor="middle" font-size="11" font-weight="700" fill="white">21°</text></svg><span class="tp-val">Now 20°</span></div>`;case"valve_controls":return Z`<div class="tp-row" style="gap:4px"><button class="tp-btn">Open</button><button class="tp-btn">Close</button></div>`;case"input_channels":return Z`<div class="tp-row tp-chips"><span class="tp-chip" style="color:${e}">● CH1</span><span class="tp-chip">○ CH2</span></div>`;case"relay_channels":return Z`<div class="tp-row tp-chips"><span class="tp-chip" style="background:${e}20;color:${e}">CH1 ON</span><span class="tp-chip">CH2 OFF</span></div>`;case"power_bar":return Z`<div class="tp-row" style="gap:8px"><div class="tp-strack" style="flex:1"><div class="tp-sfill" style="width:22%;background:${e}"></div></div><span class="tp-val">4.1 W</span></div>`;case"virtual_controls":return Z`<div class="tp-row tp-chips"><span class="tp-chip">Mode ▾</span><span class="tp-chip" style="background:${e}20;color:${e}">Script</span></div>`;case"badges":return Z`<div class="tp-row tp-chips"><span class="tp-chip" style="background:rgba(234,179,8,.18);color:#fde047">Dimmer</span><span class="tp-chip" style="background:rgba(34,197,94,.18);color:#86efac">G3</span></div>`;default:return X}}):Z`<div style="color:var(--t3);font-size:11px;padding:8px;text-align:center">All blocks hidden</div>`}
      </div>
      <div class="field-lbl" style="margin:10px 0 6px">Drag to reorder · 👁 to hide</div>
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=Gt.find(t=>t.id===e);if(!t)return X;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Z`
      ...
      </div>`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},r=(e,r,a)=>{const o=t[r]??a;return Z`
        <div class="color-row">
          ...
          ${t[r]?Z`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:X}
        </div>`},a=Z`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?Z`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?Z`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:X}
          </div>
          <div class="pill-grp">
            ${At.map(t=>{const i=e.header_chips??Ct,s=i.includes(t.key);return Z`
      ...
      ${o("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=Z`
      ...
      ${o("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=Z`
      <div class="field">
        ...
        <select class="font-select" style=${c?`font-family:${c}`:""}
          ...
          ${["System","Bundled","Display"].map(e=>Z`
            <optgroup label="${e}">
              ${Wt.filter(t=>t.group===e).map(e=>Z`
      ...
      </div>`,p=e.card_opacity??100,h=e.tile_opacity??100,g=Z`
      ${this._gridBody()}
      <div class="field">
        <div class="field-lbl">Tile size</div>
        <div class="pill-grp">
      ...
      <div class="field">
        ...
        <div class="pill-grp">
          ${["none","soft","medium","strong"].map(e=>Z`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?.startsWith("data:")?Z`<span class="bg-embedded-note">Embedded · ${this._estimateImageSize(t.tile_bg_image)}</span>`:Z`<input type="text" class="inline-text" placeholder="/local/image.png or https://…"
          ...
          ${t.tile_bg_image?Z`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:X}
        </div>
        ${t.tile_bg_image?Z`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
            ${["cover","contain","stretch"].map(e=>Z`
    ...
    `,u=Z`
      ...
      <div class="style-toolbar">
        ...
        ${this._styleClipFeedback?Z`<span class="clip-feedback">${this._styleClipFeedback}</span>`:X}
      </div>
      ${this._copyAreaOpen?Z`
      ...
      ${this._adv(this._sec("typography","T","rgba(251,191,36,0.1)","#fbbf24","Typography",X,d))}`}_renderGraphsTab(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},r=Z`
      ...
      </div>`)}`,a=e.graph_sensors??[],o=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const r=s[e]??i,a=!!s[e];return Z`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${r}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${a?Z`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:X}
        </div>`},l=Z`
      <div class="field-lbl" style="margin-bottom:6px">Gauge ring colours</div>
      ${o.map(e=>n(e.key,e.label,e.default))}
      ${a.filter(e=>!o.find(t=>t.key===e)).length?Z`
      ...
      <div class="field" style="margin-top:10px">
        ...
        <div class="pill-grp">
          ${mt.map(e=>{const t=a.some(t=>wt(t)===e.key);return Z`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>wt(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const r=""===s.trim()?void 0:parseFloat(s),a={...c[e]??{}};void 0===r||isNaN(r)?delete a[i]:a[i]=r;const o={...c,[e]:a};a.min||0===a.min||a.max||0===a.max||delete o[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(o).length?o:void 0})},p=Z`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return Z`
            <div class="range-row ${s?"set":""}">
              ...
              ${s?Z`<button class="color-reset" @click=${()=>{const i={...c};delete i[e.key],this._set("graph_style",{...t,sensor_ranges:Object.keys(i).length?i:void 0})}}>↺</button>`:Z`<span></span>`}
            </div>`})}
      </div>`;return Z`
      ...
      ${this._adv(this._sec("graphranges","⇕","rgba(251,191,36,0.1)","#fbbf24","Sensor Min / Max",Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):X,p))}`}_renderSensorsTab(){const e=this._config,t=e.sensors??[];return Z`
      ...
      ${Zt.map(i=>{const s=i.items.map(e=>e.key),r=s.filter(e=>t.includes(e)).length,a=s.every(e=>t.includes(e)),o=this._badge(`${r||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),n=Z`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),r=wt(i.key),a=!!mt.find(e=>e.key===r),o=e.graph_sensors??[],n=o.some(e=>wt(e)===r);return Z`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  <div class="sensor-item-body">
                    ...
                    ${i.unit?Z`<span class="sensor-unit">${i.unit}</span>`:X}
                  </div>
                  ${a?Z`<button class="sensor-graph-btn ${n?"on":""}"
        ...
        <div class="dp-grid">
          <div class="dp-group">
            ...
            ${i.length?Z`
              ...
              </div>`:Z`<div class="hint">No views yet — add them in the Views tab.</div>`}
          </div>
          ...
          <div class="dp-group">
            ...
            <div class="theme-grid">
              ...
              ${Nt.map(e=>{const t=Lt[e];return Z`
            ...
            ${this._pendingTheme?Z`
              ...
              </div>`:"custom"===s?Z`<div class="hint">Custom — your colours don't match a preset.${this._savedTheme?"":" Applying one will offer to save these first."}</div>`:X}
          </div>

          <div class="dp-group">
            <div class="dp-title">Default tile style
              ${e.tile_style?Z`<button class="color-reset" @click=${()=>{this._set("tile_style",void 0),this._set("power_monitor_variant",void 0)}}>↺ reset</button>`:Z`<span class="dp-hint-inline">adaptive</span>`}
            </div>
      ...
      <div class="shell">
        ...
        <div class="tab-body">
          ${"devices"===this._tab?this._renderDevicesTab():"views"===this._tab?this._renderViewsTab():"layout"===this._tab?this._renderStyleTab():"graphs"===this._tab?Z`${this._renderGraphsTab()}${this._renderSensorsTab()}`:this._renderYamlTab()}
        </div>
