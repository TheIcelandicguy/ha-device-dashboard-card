...
`;function je(e,t,i="ts-hero-name"){return Z`
    ...
    </div>`}function _e(e,t,i,s){return Z`
    <div class="${i}">
      ${je(e,t)}
...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ge=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,n]of Object.entries(t)){if(!n?.device_id)continue;if(n.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const o=(n.platform??"").toLowerCase();if("shelly"!==o)continue;const l=n.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??n.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:o,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:n.area_id,platform:o})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],n=s?.via_device_id;if(!n||!r.has(n)||a.has(n))continue;const o=i[n],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(n).integration;if(!p&&!h)continue;const u=r.get(n);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function et(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const tt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const it="—";function st(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:it}function rt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:it}function at(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:it}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:it}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:it}function lt(e){return!Number.isFinite(e)||e<0?it:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function ct(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":it}function dt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:it}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:it}function ht(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:it}function ut(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:it}function gt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:it}function vt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:it}function ft(e){return Number.isFinite(e)?`${Math.round(e)} %`:it}const bt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],mt=Object.fromEntries(bt.map(e=>[e.key,e.label.split(" ")[0]])),xt={co2:"carbon_dioxide",rssi:"signal_strength"};function yt(e){return xt[e]??e}function wt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(yt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=yt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const kt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],At=["online","offline","power","alerts"];function Ct(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:n}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,u=110,g=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+g*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=u+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),n=u+e*Math.sin(m(i)),o=g*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return Z`
    ...
    ${Et(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/Ot*100);return Z`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?Z`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:G}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,M=s[0].t,O=s[s.length-1].t,B=O-M||1,T=e=>(e.t-M)/B*a,E=e=>n-4-(e.v-S)/I*(n-8),R=s.map(e=>`${T(e).toFixed(1)},${E(e).toFixed(1)}`).join(" "),F=T(s[0]).toFixed(1),D=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),N=Math.max(...A),U=Math.min(...A);let j=A.indexOf(N),_=A.indexOf(U);j<0&&(j=0),_<0&&(_=0);const H=T(s[j]).toFixed(1),W=E(s[j]).toFixed(1),q=T(s[_]).toFixed(1),X=E(s[_]).toFixed(1),V=m(s[0].t),Y=m((s[0].t+O)/2),K=v/B*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&z-S>0;return Z`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?G:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                `:G}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=T(e)-t/2,r=E(e),o=n-4-r;return Q`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,o).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):Q`
    ...
    `:G;return p.length||u||r||a||n||z.length>1?Z`
      ...
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?Ct(this._buildTileCtx(e,s,v),u):"light-control"===p?It(this._buildTileCtx(e,s,v)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return _e(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,o=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=o&&parseFloat(r.states[o.entity_id]?.state??"")||null;return Z`
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let n;for(const e of Ge)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const o=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&Ve.includes(t.attributes?.device_class??"")});if(!n&&!o)return _e(t,s,"ts-sensor","No sensor");if(n){const o=r.states[n.entity_id],l=parseFloat(o?.state??""),c=o?.attributes?.unit_of_measurement??"",d=o?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const h=e.getGraphPoints(n.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Z`
    ...
    `;this._getAreas();const u=t.accent_color??"#f4601e",g=t.card_bg??"#1c1c1e",v=t.tile_bg??"#1c1c1e",f=t.tile_border??"#2a2a30",b=t.tile_hover_bg??"rgba(255,255,255,0.07)",m=t.tile_sensor_bg??"rgba(255,255,255,0.04)",x=t.text_primary??"#e5e7eb",y=t.text_secondary??"#9ca3af",w=t.text_muted??"#6b7280",k=t.online_color??"#4ade80",A=t.offline_color??"#ef4444";t.power_color;const C=t.header_bg??"#1a1a2e",S=t.header_bg2??"#0f3460",z=t.header_text_color??"#ffffff",I=t.header_orb_color??"#3b82f6",M=t.header_title_size??1.1,O=t.header_padding??16,B=t.header_border_width??0,T=t.header_border_color??"#4ade80",E=t.header_stat_online??"#4ade80",R=t.header_stat_power??"#fb923c",F=t.font_family?`'${t.font_family}', sans-serif`:"inherit",D=t.text_size_scale??1,P=t.tile_radius??12,L=t.tile_border_width??1,N=t.header_radius??0,U=B>0?`${B}px solid ${T}`:"none",j=Z`
