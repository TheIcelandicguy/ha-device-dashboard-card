...
`,Ve=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ge=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ye=["motion","door","window","moisture","smoke","gas"];const Ke=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Je(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,n]of Object.entries(t)){if(!n?.device_id)continue;if(n.hidden_by)continue;const t=a.split(".")[0];if(!Ke.has(t))continue;const o=(n.platform??"").toLowerCase();if("shelly"!==o)continue;const l=n.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??n.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:o,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:n.area_id,platform:o})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],n=s?.via_device_id;if(!n||!r.has(n)||a.has(n))continue;const o=i[n],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),u=!l&&c&&t.integration===r.get(n).integration;if(!p&&!u)continue;const g=r.get(n);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const _e={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function et(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:_e[s],integration:e.integration}}const tt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};function it(e){return e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`}function st(e){return`${e.toFixed(3)} kWh`}function rt(e){return`${e.toFixed(1)} V`}function at(e){return`${e.toFixed(3)} A`}function nt(e){return`${e.toFixed(1)} °C`}function ot(e){return e<60?`${e}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function lt(e){return e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor"}function ct(e){return`${e.toFixed(1)} VA`}function dt(e){return`${e.toFixed(1)} VAr`}function pt(e){return`${e.toFixed(2)} Hz`}function ut(e){return`${e.toFixed(1)} %`}function gt(e){return e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`}function ht(e){return`${Math.round(e)} ppm`}function vt(e){return`${Math.round(e)} %`}const ft=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],bt=Object.fromEntries(ft.map(e=>[e.key,e.label.split(" ")[0]])),mt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],xt=["online","offline","power","alerts"];function yt(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:n}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),u=110,g=110,h=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+h*Math.min(1,Math.max(0,t)),s=u+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),a=u+e*Math.cos(m(i)),n=g+e*Math.sin(m(i)),o=h*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Q`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=n.uptime?Q`<span class="ts-hbar-badge">${ot(n.uptime)}</span>`:G}
        </div>
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ...
        <span class="ts-uptime">${o.uptime?ot(o.uptime):""}</span>
      </div>
      ${e.renderTileLowerBody(t,n)}
    </div>`}(e)}}const wt=140,kt=70;function At(e){const{device:t,isOn:i,accent:s,online:r,hass:a,profile:n}=e,o=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!o)return Q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(o.entityId.startsWith("switch.")||"dimmer"!==n.type&&"rgb"!==n.type)return Q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Q`
        <div class="ts-light-wheel-wrap">
          <svg width="${wt}" height="${wt}" viewBox="0 0 ${wt} ${wt}"
            ...
            <foreignObject x="0" y="0" width="${wt}" height="${wt}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${wt}px;height:${wt}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
      ...
      `:Q``}case"power_bar":return e.renderPowerBar(i);case"badges":return Q`
        <div class="tile-bot">
          ${null!=g?Q`<span class="tile-power">${it(g)}</span>`:G}
      ...
      `;default:return Q``}}const St=255;function zt(e){return Q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=n.rssi?Q`<div class="ds-signal">Wi-Fi: ${lt(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?Q` · Up ${ot(n.uptime)}`:G}</div>`:G}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,n=r?.attributes?.friendly_name??s.entity_id,o=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(o)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?G:Q`<span class="ds-channel-power">${it(c)}</span>`}
    ...
    ${Mt(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Q`
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?Q`<span class="ds-big-power">${it(s.power)}</span>`:G}
    </div>
    ${Mt(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return Q`
    <div class="ds-section">
    ...
    ${Mt(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/St*100);return Q`
    <div class="ds-section">
    ...
    ${Mt(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Q`
    <div class="ds-section">
    ...
    ${Mt(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Q`
    <div class="ds-section">
    ...
    ${Mt(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Q`
    <div class="ds-section">
    ...
    ${Mt(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Q`${Mt(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return Q`
    ...
    ${Mt(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Q`
    <div class="ds-section">
    ...
    ${Mt(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    ${Mt(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Q`
    ${t?Q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${Mt(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    </div>`}function It(e){if(!e.getGraphEntities(e.device).length)return Q``;const t=e.getDetailHistoryRange();return Q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function Mt(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return Q`
    ${r&&s?It(e):G}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${it(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:G}
        ${null!=t.voltage?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:G}
        ${null!=t.current?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:G}
        ${null!=t.energy?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${st(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:G}
        ${null!=t.temp?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${nt(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:G}
      </div>
    </div>`:Q``}(e):G}
    ${!r&&s?It(e):G}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?Q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${lt(r.rssi)} (${r.rssi} dBm)</span></div>`:G}
        ${null!=r.uptime?Q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${ot(r.uptime)}</span></div>`:G}
        ...
        ${i.length?Q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:G}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,M=s[0].t,O=s[s.length-1].t,B=O-M||1,E=e=>(e.t-M)/B*a,T=e=>n-4-(e.v-S)/I*(n-8),R=s.map(e=>`${E(e).toFixed(1)},${T(e).toFixed(1)}`).join(" "),D=E(s[0]).toFixed(1),F=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),U=Math.max(...A),N=Math.min(...A);let j=A.indexOf(U),H=A.indexOf(N);j<0&&(j=0),H<0&&(H=0);const W=E(s[j]).toFixed(1),q=T(s[j]).toFixed(1),Z=E(s[H]).toFixed(1),V=T(s[H]).toFixed(1),Y=m(s[0].t),K=m((s[0].t+O)/2),J=v/B*a,_=`${Math.max(.3,.7*J).toFixed(2)} ${Math.max(.3,.3*J).toFixed(2)}`,$=c&&z-S>0;return Q`
    ...
    `:G;return p.length||g||r||a||n||z.length>1?Q`
      ...
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?yt(this._buildTileCtx(e,s,v),g):"light-control"===p?At(this._buildTileCtx(e,s,v)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return He(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,o=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=o&&parseFloat(r.states[o.entity_id]?.state??"")||null;return Q`
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?Q`<span class="fav-chip fav-chip-power">${it(r)}</span>`:G}
          </div>
        </div>
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Q`<span class="area-power">${it(a)}</span>`:G}
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Q``;const t=this._getActiveView()?.id;return Q`
      ...
      <div class="dev-style-panel">
        ...
        <div class="block-toggles">
          ${Lt.map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Q`<span class="block-tog ${t?"on":""}" @click=${()=>a(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
    ...
    `}_renderViewCard(e,t,i,s,r,a,n,o){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),u=this._countViewMatches(e,n,o),g=n.length,h=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
      ...
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=Lt.find(t=>t.id===e);if(!t)return G;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Q`
      ...
      ${!1!==e.header_show_stats?Q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${mt.map(t=>{const i=e.header_chips??xt,s=i.includes(t.key);return Q`
      ...
      <div class="field">
        ...
        `:G}
      </div>`;this._getAreas();const g=t.accent_color??"#f4601e",h=t.card_bg??"#1c1c1e",v=t.tile_bg??"#1c1c1e",f=t.tile_border??"#2a2a30",b=t.tile_hover_bg??"rgba(255,255,255,0.07)",m=t.tile_sensor_bg??"rgba(255,255,255,0.04)",x=t.text_primary??"#e5e7eb",y=t.text_secondary??"#9ca3af",w=t.text_muted??"#6b7280",k=t.online_color??"#4ade80",A=t.offline_color??"#ef4444";t.power_color;const C=t.header_bg??"#1a1a2e",S=t.header_bg2??"#0f3460",z=t.header_text_color??"#ffffff",I=t.header_orb_color??"#3b82f6",M=t.header_title_size??1.1,O=t.header_padding??16,B=t.header_border_width??0,E=t.header_border_color??"#4ade80",T=t.header_stat_online??"#4ade80",R=t.header_stat_power??"#fb923c",D=t.font_family?`'${t.font_family}', sans-serif`:"inherit",F=t.text_size_scale??1,P=t.tile_radius??12,L=t.tile_border_width??1,U=t.header_radius??0,N=B>0?`${B}px solid ${E}`:"none",j=Q`
      ...
      ${Ft.map(i=>{const s=i.items.map(e=>e.key),r=s.filter(e=>t.includes(e)).length,a=s.every(e=>t.includes(e)),n=this._badge(`${r||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),o=Q`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),r=!!Pt.find(e=>e.key===i.key),a=e.graph_sensors??[],n=a.includes(i.key);return Q`
