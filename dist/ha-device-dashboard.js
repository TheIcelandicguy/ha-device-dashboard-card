...
`;function Ke(e){return e.showEl("header_chips")&&e.showEl("secondary")}function Ye(e,t,i="ts-hero-name"){return q`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function Xe(e,t,i,s){return q`
    <div class="${i}">
      ${Ye(e,t)}
      <span style="color:var(--sc-text-muted);font-size:.8em">${s}</span>
    </div>`}function Qe(e,t,i){const s=null!=e.getInputActionLabel(t,i),o="button"===i.kind?i.lastEvent?i.lastEvent.replace(/_/g," "):"no press yet":i.isOn?"On":"Off",a=s?void 0:t=>{t.stopPropagation(),e.fireMoreInfo(i.entityId)};return q`
    <div class="input-row ${"button"===i.kind?"btn-mode":"sw-mode"} ${i.isOn?"active":""} ${a?"tappable":""}"
      ...
      <span class="input-row-act">${function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputSelectChip(t,i);if(!s)return o?Ze(e,o):K;const a=e.inputHasHold(t,i),n=()=>e.endInputHold(),r=e.getInputDimFeedback(i);return q`
    ...
    </select>`}const Je=/^\s*[♪♫♬♩]\s*/,et=new Set(["pixels","pixelwave","juggles","matripix","gravimeter","plasmoid","puddles","midnoise","noisemeter","freqwave","freqmatrix","geq","waterfall","freqpixels","noisefire","puddlepeak","noisemove","ripple peak","freqmap","gravcenter","gravcentric","gravfreq","dj light","funky plank","blurz","waverly","swirl","rocktaves","akemi","ps spray","ps geq 2d","ps geq nova","ps blobs","ps geq 1d","ps sonic stream","ps sonic boom","ps springy"]),tt=e=>Je.test(e)||et.has(e.replace(Je,"").trim().toLowerCase());function it(e,t,i){if(e.length<=1)return K;const s=e.filter(tt),o=e.filter(e=>!tt(e)&&"Off"!==e),a=e.find(e=>"Off"===e)??e.find(e=>"Solid"===e),n=e=>q`
    ...
    </div>`}const st={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const ot=[3,7,11,15,19,23,27];function at(e,t,i,s){if("none"===e)return q``;const o=t?"on":"off";if("flame"===e)return q`${V`<svg class="${s} ent-icon-flame ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("snowflake"===e)return q`${V`<svg class="${s} ent-icon-snowflake" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("fan"===e)return q`${V`<svg class="${s} ent-icon-fan ${o}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`;if("pulse"===e)return q`${V`<svg class="${s} ent-icon-pulse ${o}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`;if("wave"===e)return q`${V`<svg class="${s} ent-icon-wave" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("sun"===e)return q`${V`<svg class="${s} ent-icon-sun ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("lightning"===e)return q`${V`<svg class="${s} ent-icon-lightning ${o}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`;if("heart"===e)return q`${V`<svg class="${s} ent-icon-heart ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bulb"===e)return q`${V`<svg class="${s} ent-icon-bulb ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("leaf"===e)return q`${V`<svg class="${s} ent-icon-leaf ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("moon"===e)return q`${V`<svg class="${s} ent-icon-moon ${o}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  </svg>`}`;if("water"===e)return q`${V`<svg class="${s} ent-icon-water ${o}" style="${i}" viewBox="0 0 20 20">
    <path class="drop-body" d="M10 3 C10 3 5 9 5 13 C5 16 7.2 18 10 18 C12.8 18 15 16 15 13 C15 9 10 3 10 3Z" fill="currentColor"/>
  </svg>`}`;if("lock"===e)return q`${V`<svg class="${s} ent-icon-lock ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("flame2"===e)return q`${V`<svg class="${s} ent-icon-flame2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("flame3"===e)return q`${V`<svg class="${s} ent-icon-flame3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("snowflake2"===e)return q`${V`<svg class="${s} ent-icon-snowflake2" style="${i}" viewBox="0 0 20 20">
    <g class="snow-arms" style="transform-origin:10px 10px">
  ...
  </svg>`}`;if("snowflake3"===e)return q`${V`<svg class="${s} ent-icon-snowflake3" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("fan2"===e)return q`${V`<svg class="${s} ent-icon-fan2 ${o}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`;if("fan3"===e)return q`${V`<svg class="${s} ent-icon-fan3 ${o}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`;if("lightning2"===e)return q`${V`<svg class="${s} ent-icon-lightning2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("lightning3"===e)return q`${V`<svg class="${s} ent-icon-lightning3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bulb2"===e)return q`${V`<svg class="${s} ent-icon-bulb2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bulb3"===e)return q`${V`<svg class="${s} ent-icon-bulb3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("water2"===e)return q`${V`<svg class="${s} ent-icon-water2" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("water3"===e)return q`${V`<svg class="${s} ent-icon-water3 ${o}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`;if("sun2"===e)return q`${V`<svg class="${s} ent-icon-sun2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("sun3"===e)return q`${V`<svg class="${s} ent-icon-sun3 ${o}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`;if("moon2"===e)return q`${V`<svg class="${s} ent-icon-moon2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("moon3"===e)return q`${V`<svg class="${s} ent-icon-moon3 ${o}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`;if("wind"===e)return q`${V`<svg class="${s} ent-icon-wind ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("wind2"===e)return q`${V`<svg class="${s} ent-icon-wind2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("wind3"===e)return q`${V`<svg class="${s} ent-icon-wind3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bell"===e)return q`${V`<svg class="${s} ent-icon-bell ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bell2"===e)return q`${V`<svg class="${s} ent-icon-bell2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("bell3"===e)return q`${V`<svg class="${s} ent-icon-bell3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("thermometer"===e)return q`${V`<svg class="${s} ent-icon-thermometer ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("thermometer2"===e)return q`${V`<svg class="${s} ent-icon-thermometer2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("thermometer3"===e)return q`${V`<svg class="${s} ent-icon-thermometer3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("battery"===e)return q`${V`<svg class="${s} ent-icon-battery ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("battery2"===e)return q`${V`<svg class="${s} ent-icon-battery2 ${o}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`;if("battery3"===e)return q`${V`<svg class="${s} ent-icon-battery3 ${o}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`;if("star"===e)return q`${V`<svg class="${s} ent-icon-star ${o}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`;if("star2"===e)return q`${V`<svg class="${s} ent-icon-star2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("star3"===e)return q`${V`<svg class="${s} ent-icon-star3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("pulse2"===e)return q`${V`<svg class="${s} ent-icon-pulse2 ${o}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`;if("pulse3"===e)return q`${V`<svg class="${s} ent-icon-pulse3 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("wave2"===e)return q`${V`<svg class="${s} ent-icon-wave2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("wave3"===e)return q`${V`<svg class="${s} ent-icon-wave3 ${o}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`;if("wave4"===e)return q`${V`<svg class="${s} ent-icon-wave4 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("heart2"===e)return q`${V`<svg class="${s} ent-icon-heart2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("leaf2"===e)return q`${V`<svg class="${s} ent-icon-leaf2 ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`;if("lock2"===e)return q`${V`<svg class="${s} ent-icon-lock2 ${o}" style="${i}" viewBox="0 0 20 20">
    <rect x="5" y="9" width="10" height="8" rx="2" fill="currentColor" opacity="0.9"/>
    ...
    <line x1="10" y1="14" x2="10" y2="17.5" stroke="currentColor" stroke-width="1.4"/>`;return"display"===e?q`${V`<svg class="${s} ent-icon-display ${o}" style="${i}" viewBox="0 0 20 20">
    ${a}
    <rect class="scr-panel" x="3.5" y="4.5" width="13" height="8" rx="0.8" fill="currentColor" opacity="0.35"/>
  </svg>`}`:"display2"===e?q`${V`<svg class="${s} ent-icon-display2 ${o}" style="${i}" viewBox="0 0 20 20">
    ${a}
  ...
  </svg>`}`:"display3"===e?q`${V`<svg class="${s} ent-icon-display3 ${o}" style="${i}" viewBox="0 0 20 20">
    ${a}
    <rect class="scr-wake" x="3.5" y="4.5" width="13" height="8" rx="0.8" fill="currentColor" opacity="0.4" style="transform-origin:10px 8.5px"/>
  </svg>`}`:"oven"===e?q`${V`<svg class="${s} ent-icon-oven ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"washer"===e||"washer2"===e?q`${V`<svg class="${s} ent-icon-${e} ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"dishwasher"===e?q`${V`<svg class="${s} ent-icon-dishwasher ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"floorheat"===e?q`${V`<svg class="${s} ent-icon-floorheat ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"radiator"===e?q`${V`<svg class="${s} ent-icon-radiator ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"valve"===e?q`${V`<svg class="${s} ent-icon-valve ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"smoke"===e?q`${V`<svg class="${s} ent-icon-smoke ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"camera"===e?q`${V`<svg class="${s} ent-icon-camera ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"strip"===e||"strip2"===e?q`${V`<svg class="${s} ent-icon-${e} ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"plug"===e?q`${V`<svg class="${s} ent-icon-plug ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"garage"===e?q`${V`<svg class="${s} ent-icon-garage ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"router"===e?q`${V`<svg class="${s} ent-icon-router ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pc"===e?q`${V`<svg class="${s} ent-icon-pc ${o}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"ble"===e?q`${V`<svg class="${s} ent-icon-ble ${o}" style="${i}" viewBox="0 0 20 20">
...
`,lt=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"},{value:"display",label:"Flicker",group:"🖥️"},{value:"display2",label:"Scanline",group:"🖥️"},{value:"display3",label:"Wake",group:"🖥️"},{value:"oven",label:"Oven",group:"🍳"},{value:"washer",label:"Washer",group:"🫧"},{value:"washer2",label:"Tumble",group:"🫧"},{value:"dishwasher",label:"Dishes",group:"🫧"},{value:"floorheat",label:"Floor heat",group:"♨️"},{value:"radiator",label:"Radiator",group:"♨️"},{value:"valve",label:"Valve",group:"🚰"},{value:"smoke",label:"Smoke det.",group:"🚨"},{value:"camera",label:"Camera",group:"📷"},{value:"strip",label:"LED strip",group:"🌈"},{value:"strip2",label:"Rainbow",group:"🌈"},{value:"plug",label:"Plug",group:"🔌"},{value:"garage",label:"Garage",group:"🚗"},{value:"ble",label:"Bluetooth",group:"📡"},{value:"router",label:"Router",group:"📡"},{value:"pc",label:"PC",group:"💻"}];function ct(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    </div>`}const dt=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function pt(e,t,i,s){return{entity_id:e,domain:e.split(".")[0],state:i?.state??"unavailable",attributes:i?.attributes??{},device_id:t?.device_id,area_id:t?.area_id,platform:t?.platform?String(t.platform).toLowerCase():void 0,entity_category:t?.entity_category??void 0,...s}}function ht(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,o=i?new Set([...gt,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,a=i&&t.includeDomains?.length?new Set(t.includeDomains):null,n=i?new Set(t.excludeDomains??[]):null,r=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(r)){if(!p?.device_id)continue;if(p.hidden_by)continue;const r=t.split(".")[0];if(!dt.has(r))continue;if(n?.has(r))continue;if(a&&!a.has(r))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(o?.has(h)&&!s?.has(h))continue;const u=p.device_id;if(!d.has(u)){const e=l[u];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const o=e.area_id??p.area_id,a=o?c[o]?.name:void 0;d.set(u,{device_id:u,name:e.name_by_user??e.name??u,area:a,model:null==e.model?void 0:String(e.model),sw_version:null==e.sw_version?void 0:String(e.sw_version),ip:t?t[1]:void 0,isShelly:s,integration:h,labels:Array.isArray(e.labels)?[...e.labels]:void 0,entities:[]})}const g=d.get(u);"shelly"===h&&(g.isShelly=!0,g.integration="shelly"),g.entities.push(pt(t,p,e.states[t]))}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const o=l[s],a=i?.configuration_url??"",n=o?.configuration_url??"",r=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=a&&n&&r(a)===r(n),h=!a&&n&&t.isShelly&&t.integration===d.get(s).integration;if(!c&&!h)continue;const u=d.get(s);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},u=new Map;for(const e of d.keys())for(const t of h(l[e]))u.has(t)||u.set(t,[]),u.get(t).push(e);const g=new Map,v=e=>{let t=e;for(let e=0;g.has(t)&&e<8;e++)t=g.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of u.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),t.labels?.length&&(s.labels=[...new Set([...s.labels??[],...t.labels])]),g.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!xt(e)||"devices"===t&&wt(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function ut(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const gt=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),vt=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),ft=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),mt=new Set(["switch","light","cover","climate","valve","media_player"]),bt={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function yt(e){return e.entities.filter(e=>"primary"===ut(e)&&!mt.has(e.domain)&&e.domain in bt)}const xt=e=>e.entities.some(e=>"primary"===ut(e)&&vt.has(e.domain)),wt=e=>e.entities.some(e=>"primary"===ut(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&ft.has(e.attributes?.device_class??""));const kt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},_t={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control"};function At(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:_t[e]}const St={default:[{id:"toggle",label:"On/off button"}],"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Graphs (spark + sensor rows)"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"header_chips",label:"Chips in the name row",def:!1},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"toggle",label:"On/off button"},{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"},{id:"position_slider",label:"Position slider (covers that report one)"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graphs"},{id:"secondary",label:"Secondary chips"},{id:"header_chips",label:"Chips in the name row",def:!1}],"input-control":[{id:"name",label:"Name"},{id:"keypad",label:"Channel keys"},{id:"input_rows",label:"Unassigned channel rows"},{id:"target_state",label:"Channel name under the key"},{id:"last_event",label:"Last-pressed time"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function Ct(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}const $t={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","media_controls","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","media_controls","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},Et=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const Tt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},It=["power","temperature","humidity","battery"];function Ot(e,t){const i={},s=s=>{for(const o of e.entities){if("sensor"!==o.domain||!!o.entity_category!==s)continue;const e=t[o.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const a=e.attributes?.device_class??o.attributes?.device_class;if(!a||a in i)continue;const n=parseFloat(e.state??"");isNaN(n)||(i[a]={value:n,diagnostic:s})}};return s(!1),s(!0),i}const Mt=[{key:"power",label:"W",min:0,max:3e3,digits:0},{key:"voltage",label:"V",min:0,max:250,digits:0},{key:"current",label:"A",min:0,max:16,digits:2},{key:"temperature",label:"°C",min:-10,max:40,digits:1,stops:["#38bdf8","#fde047","#f87171"],diag:{min:0,max:100}},{key:"humidity",label:"%",min:0,max:100,digits:0,stops:["#fde68a","#2dd4bf","#0ea5e9"]},{key:"illuminance",label:"lx",min:0,max:2e3,digits:0,stops:["#94a3b8","#fde047","#fffbeb"]},{key:"carbon_dioxide",label:"ppm",min:400,max:2e3,digits:0,stops:["#4ade80","#fde047","#f87171"]},{key:"battery",label:"%",min:0,max:100,digits:0,stops:["#f87171","#fde047","#4ade80"]}];function Dt(e){const t=(e??"").trim();if(!t)return null;const i=/^#([0-9a-f]{3,8})$/i.exec(t);if(i){const e=i[1],t=e=>e+e;return 3===e.length||4===e.length?{hex:"#"+[...e.slice(0,3)].map(t).join(""),alpha:4===e.length?parseInt(t(e[3]),16)/255:1}:6===e.length||8===e.length?{hex:"#"+e.slice(0,6).toLowerCase(),alpha:8===e.length?parseInt(e.slice(6,8),16)/255:1}:null}const s=/^rgba?\(([^)]+)\)$/i.exec(t);if(s){const e=s[1].split(/[,\s/]+/).filter(Boolean);if(e.length<3)return null;const t=e.slice(0,3).map(e=>{const t=e.endsWith("%")?parseFloat(e)/100*255:parseFloat(e);return Math.max(0,Math.min(255,Math.round(t)))});if(t.some(isNaN))return null;const i=e[3],o=void 0===i?1:i.endsWith("%")?parseFloat(i)/100:parseFloat(i);return{hex:"#"+t.map(e=>e.toString(16).padStart(2,"0")).join(""),alpha:isNaN(o)?1:o}}return null}function zt(e,t){if(t>=1)return e;const i=Dt(e);if(!i)return e;const[s,o,a]=[1,3,5].map(e=>parseInt(i.hex.slice(e,e+2),16));return`rgba(${s}, ${o}, ${a}, ${Math.max(0,Math.round(1e3*t)/1e3)})`}function Rt(e){const t=/^#?([0-9a-f]{6})$/i.exec(e.trim());if(!t)return{h:0,s:0,v:0};const i=parseInt(t[1].slice(0,2),16)/255,s=parseInt(t[1].slice(2,4),16)/255,o=parseInt(t[1].slice(4,6),16)/255,a=Math.max(i,s,o),n=a-Math.min(i,s,o);let r=0;return n>0&&(r=a===i?(s-o)/n%6:a===s?(o-i)/n+2:(i-s)/n+4,r=(60*r+360)%360),{h:r,s:0===a?0:n/a,v:a}}function Pt(e,t,i){const s=i*t,o=s*(1-Math.abs(e/60%2-1)),a=i-s,[n,r,l]=e<60?[s,o,0]:e<120?[o,s,0]:e<180?[0,s,o]:e<240?[0,o,s]:e<300?[o,0,s]:[s,0,o];return"#"+[n,r,l].map(e=>Math.round(255*(e+a)).toString(16).padStart(2,"0")).join("")}function Bt(e,t){if(1===e.length)return e[0];const i=e.map(e=>/^#[0-9a-f]{6}$/i.test(e)?[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)):null);if(i.some(e=>!e))return e[e.length-1];const s=Math.min(1,Math.max(0,t))*(e.length-1),o=Math.min(e.length-2,Math.floor(s)),a=s-o,n=i[o],r=i[o+1],l=n.map((e,t)=>Math.round(e+(r[t]-e)*a));return"#"+l.map(e=>e.toString(16).padStart(2,"0")).join("")}function Ft(e,t){const i=Mt.find(t=>t.key===e),s=t.gradients?.[e],o=Array.isArray(s)?s.filter(e=>"string"==typeof e&&e):void 0;if(o&&o.length>=2)return o;const a=t.colors?.[e];if("string"==typeof a&&a)return[a];if(i?.stops)return i.stops;const n=di.find(t=>t.key===e)?.defaultColor;return["power"===e?t.accent:n??t.accent]}function Lt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch")&&e.isShelly)s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),o=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||o||a?"sensor":"input"}else s="input";return s}const Nt=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),jt={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=Lt(e);if(Nt.has(t)){const i=function(e){if(e)for(const t of Et)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:qt(e.model??""),label:kt[t],integration:e.integration}}},Ht={id:"generic",matches:()=>!0,detect:e=>{const t=Lt(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":kt[t],integration:e.integration}}},Wt=[jt,Ht];function Ut(e){for(const t of Wt)if(t.matches(e))return t.detect(e);return Ht.detect(e)}function qt(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Vt={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Gt(e){return Vt[e.toLowerCase()]??e.toUpperCase().slice(0,6)}function Kt(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,o]of Object.entries(t)){if(!o?.device_id||o.hidden_by)continue;const t=e.split(".")[0];if(!dt.has(t))continue;s.add(t);const a=(o.platform??"").toLowerCase();a&&i.add(a)}return{integrations:[...i].sort((e,t)=>Gt(e).localeCompare(Gt(t))),domains:[...s].sort()}}const Yt="—";function Xt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Yt}function Qt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Yt}function Zt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Yt}function Jt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Yt}function ei(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Yt}function ti(e){return!Number.isFinite(e)||e<0?Yt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function ii(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Yt}function si(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Yt}function oi(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Yt}function ai(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Yt}function ni(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Yt}function ri(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Yt}function li(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Yt}function ci(e){return Number.isFinite(e)?`${Math.round(e)} %`:Yt}const di=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],pi=Object.fromEntries(di.map(e=>[e.key,e.label.split(" ")[0]])),hi={co2:"carbon_dioxide",rssi:"signal_strength"};function ui(e){return hi[e]??e}function gi(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(ui).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,o]of Object.entries(s)){const s=ui(t);s!==t&&(e=!0),s in i||(i[s]=o)}e&&(s=i,t=!0)}let o=e.style,a=e.theme;if(o&&"object"==typeof o){const e=We(o);if("custom"!==e&&(void 0===a||a===e)){const i={...o};for(const e of He)delete i[e];Object.keys(i).length!==Object.keys(o).length&&(o=Object.keys(i).length?i:void 0,a=e,t=!0)}}const n=e;let r,l=!1;if(n.elements&&"object"==typeof n.elements){let e=n.tile_style;"string"==typeof e&&e.startsWith("custom:")&&(e=n.custom_styles?.[e.slice(7)]?.base??"default");const i=e&&{hero:"power-monitor",ring:"power-monitor",spark:"power-monitor",hbar:"power-monitor",list:"power-monitor",command:"scene-button"}[e]||e;if(i&&St[i]){const e={...n.style_presets?.[i]??{}};e.elements={...n.elements,...e.elements??{}},r={...n.style_presets??{},[i]:e}}l=!0,t=!0}const c=e;let d=!1;const p=e=>{if(!Array.isArray(e))return e;if(e.some(e=>Array.isArray(e))){let t=!1;const i=e.map(e=>Array.isArray(e)&&e.includes("delegated_controls")&&!e.includes("media_controls")?(t=!0,e.flatMap(e=>"delegated_controls"===e?["media_controls",e]:[e])):e);return t?(d=!0,i):e}return!e.includes("delegated_controls")||e.includes("media_controls")?e:(d=!0,e.flatMap(e=>"delegated_controls"===e?["media_controls",e]:[e]))},h=e=>{if(!e)return e;let t=!1;const i={};for(const[s,o]of Object.entries(e)){const e=p(o?.tile_layout);o&&e!==o.tile_layout?(i[s]={...o,tile_layout:e},t=!0):i[s]=o}return t?i:e},u=p(c.tile_layout),g=h(c.device_styles),v=h(c.profile_styles),f=h(c.area_styles),m=h(c.custom_styles),b=h(c.style_presets);let y=c.views;if(Array.isArray(y)){let e=!1;const t=y.map(t=>{const i=p(t?.tile_layout);return t&&i!==t.tile_layout?(e=!0,{...t,tile_layout:i}):t});e&&(y=t)}if(d&&(t=!0),!t)return e;const x={...e};if(d){const e=x;u!==c.tile_layout&&(e.tile_layout=u),g!==c.device_styles&&(e.device_styles=g),v!==c.profile_styles&&(e.profile_styles=v),f!==c.area_styles&&(e.area_styles=f),m!==c.custom_styles&&(e.custom_styles=m),b!==c.style_presets&&(e.style_presets=b),y!==c.views&&(e.views=y)}return o!==e.style&&(void 0===o?delete x.style:x.style=o),a!==e.theme&&(x.theme=a),i&&(x.graph_sensors=i),s&&(x.graph_sensor_colors=s),l&&(delete x.elements,r&&(x.style_presets=r)),x}const vi=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Lux",agg:"avg"},{key:"lights",label:"Lights",agg:"count"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],fi=["online","offline","power","alerts"],mi=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Lux",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],bi=["power","energy","voltage","current","temperature"],yi=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,graph_hours:24,header_chips:fi});function xi(){return{...yi,header_chips:[...yi.header_chips??[]]}}const wi=["type","views","default_view","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","delegate_controls","header_cards","footer_cards","area_cards","areas","hidden_devices","favorites","hidden_entities","show_offline","title","columns","tile_size","sort_by","tile_style","smart_tile_styles","power_monitor_variant","show_graphs","tile_layout","tile_opacity","card_opacity","header_opacity","header_show_title","header_show_stats","header_show_cloud","header_show_orbs","effects","header_chips","area_header_chips","show_collapse_all","card_bg_image","card_bg_image_size","show_power_bar","power_bar_max","show_entity_list","theme","light_labels","light_entities","show_attention","attention_battery","show_firmware_summary","include_beta_updates","style","area_styles","device_styles","profile_styles","style_presets","custom_styles","energy_period","graph_sensors","graph_hours","graph_style","graph_line_color","radio_stations","extra_card_style","graph_sensor_colors","sensors"],ki=["grid_options","view_layout","layout_options","visibility","card_mod"];function _i(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function Ai(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function Si(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function Ci(e,t,i){if("input"===i||"uni"===i)return;const s=e.entities.filter(e=>("switch"===e.domain||"light"===e.domain)&&!e.entity_category);if(s.length){if(1===s.length)return s[0].entity_id;if(null!=t){const e=s.find(e=>function(e){const t=e.match(/(?:switch|relay|light|channel)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}(e.entity_id)===t);if(e)return e.entity_id}}}function $i(e,t){const i=(e??"").trim(),s=(t??"").trim();return s&&i.toLowerCase().startsWith(s.toLowerCase())?i.slice(s.length).trim():i}function Ei(e,t,i,s){const o=$i(e,t);return o||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function Ti(e,t){const i=e.entities.filter(_i),s=e.entities.filter(Ai),o=new Set,a=[],n=i.length||s.length?Ut(e).type:"generic";return i.forEach((i,r)=>{const l=t[i.entity_id],c=Si(i.entity_id),d=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),a=s.find(e=>!o.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return a||(null!=t?s.find(e=>!o.has(e.entity_id)&&Si(e.entity_id)===t):void 0)})(i,c);d&&o.add(d.entity_id);const p=d?t[d.entity_id]:null,h=p?.attributes?.event_type;a.push({entityId:i.entity_id,label:Ei(l?.attributes?.friendly_name??"",e.name,c,i.entity_id),isOn:"on"===l?.state,kind:d?"button":"switch",channel:c??0,lastEvent:h??null,lastChanged:l?.last_changed??null,output:Ci(e,c,n),_sort:c??50+r})}),s.filter(e=>!o.has(e.entity_id)).forEach((i,s)=>{const o=t[i.entity_id],r=Si(i.entity_id),l=o?.state&&"unknown"!==o.state&&"unavailable"!==o.state?o.state:null;a.push({entityId:i.entity_id,label:Ei(o?.attributes?.friendly_name??"",e.name,r,i.entity_id),isOn:!1,kind:"button",channel:r??0,lastEvent:o?.attributes?.event_type??null,lastChanged:o?.last_changed??l,output:Ci(e,r,n),_sort:r??50+s})}),a.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}const Ii=e=>e.config.device_styles?.[e.device.device_id],Oi=e=>e.config.profile_styles?.[e.profile],Mi=e=>e.device.area?e.config.area_styles?.[e.device.area]:void 0,Di={hero:"big-number",ring:"gauge",spark:"graph",hbar:"compact",list:"table"};function zi(e){return Ii(e)?.tile_style??Oi(e)?.tile_style??Mi(e)?.tile_style??e.view?.tile_style??e.config.tile_style??(e.config.smart_tile_styles?At(e.profile,e.device):void 0)}function Ri(e,t){if("string"==typeof t&&t.startsWith("custom:")){const i=e.custom_styles?.[t.slice(7)];return{base:i?.base??"default",custom:i}}return{base:t}}function Pi(e){return e&&e in Di?{style:"power-monitor",variant:Di[e]}:"command"===e?{style:"scene-button",variant:"big-number"}:{style:e??"default",variant:"big-number"}}const Bi=e=>Ri(e.config,zi(e)).custom;function Fi(e){const{base:t}=Ri(e.config,zi(e));return Pi(t).style}function Li(e,t){const i=Fi(e);return Ii(e)?.elements?.[t]??Oi(e)?.elements?.[t]??Mi(e)?.elements?.[t]??e.view?.elements?.[t]??Bi(e)?.elements?.[t]??e.config.style_presets?.[i]?.elements?.[t]??function(e,t){return St[e]?.find(e=>e.id===t)?.def??!0}(i,t)}function Ni(e,t,i){return t?.[i]??e[i]}function ji(e,t){return t?.extra_card_style??e.extra_card_style??"ha"}function Hi(e,t,i){return i?.columns??t?.columns??e.columns??3}function Wi(e,t){const i=e=>e&&"custom"!==e?e:void 0;return i(t?.theme)??i(e?.theme)}const Ui=new Set(["unavailable","unknown"]),qi=e=>!e.borrowed_from;function Vi(e){return e.entities.some(e=>e.borrowed_from)?{...e,entities:e.entities.filter(qi)}:e}function Gi(e,t){return e.entities.some(e=>{if(!qi(e))return!1;const i=t[e.entity_id];return!!i&&!Ui.has(i.state??"")})}function Ki(e,t){const i=[];for(const s of e.entities){if("binary_sensor"!==s.domain||!qi(s))continue;const e=t[s.entity_id];if(!e||"on"!==e.state)continue;const o=e.attributes?.device_class??"";"heat"===o||s.entity_id.includes("overtemp")?i.push("overtemp"):("safety"===o||s.entity_id.includes("overpower"))&&i.push("overpower")}return[...new Set(i)]}function Yi(e,t){const i=[];for(const s of e.entities){if("binary_sensor"!==s.domain||!qi(s))continue;const e=t[s.entity_id];if(!e||"on"!==e.state)continue;const o=e.attributes?.device_class??"";"smoke"===o?i.push("smoke"):"moisture"===o?i.push("water"):"gas"===o&&i.push("gas")}return[...new Set(i)]}function Xi(e,t){return[...Ki(e,t),...Yi(e,t)]}function Qi(e,t,i={}){const s=es(e,t,i);return!!s&&!!s.next&&s.next!==s.current}function Zi(e,t){let i=null;for(const s of e.entities){if("sensor"!==s.domain||!qi(s))continue;const e=t[s.entity_id];if(!e||"battery"!==e.attributes?.device_class)continue;const o=parseFloat(e.state??"");isNaN(o)||(i=null===i?o:Math.min(i,o))}return i}function Ji(e,t){return/beta/i.test(e)||/beta/i.test(t?.friendly_name??"")}function es(e,t,i={}){for(const s of e.entities){if("update"!==s.domain||!qi(s))continue;const e=t[s.entity_id];if(e&&"on"===e.state&&(i.includeBeta||!Ji(s.entity_id,e.attributes)))return{entityId:s.entity_id,current:e.attributes?.installed_version??"",next:e.attributes?.latest_version??""}}return null}function ts(e,t,i={}){const s=new Set(i.labels??[]),o=new Set(i.entities??[]);let a=0,n=0;const r=[],l=new Set,c=(e,i)=>{if(l.has(e))return;const s=t[e];s&&!Ui.has(s.state??"")&&(l.add(e),n++,"on"===s.state&&(a++,r.push(s.attributes?.friendly_name??i)))};for(const t of e){const e=!!t.labels?.some(e=>s.has(e));for(const i of t.entities)("light"===i.domain||o.has(i.entity_id)||e&&"switch"===i.domain)&&c(i.entity_id,t.name)}for(const e of o)c(e,e);return{on:a,total:n,onNames:r}}function is(e){const t=new Map;for(const i of e){const e=i.sw_version;if(null==e||""===e)continue;const s=ss(e);t.has(s)||t.set(s,[]),t.get(s).push(i)}const i=[...t.entries()].map(([e,t])=>({version:e,devices:t,current:!1})).sort((e,t)=>function(e,t){const i=e.split(".").map(e=>parseInt(e,10)),s=t.split(".").map(e=>parseInt(e,10));for(let o=0;o<Math.max(i.length,s.length);o++){const a=i[o]??0,n=s[o]??0;if(isNaN(a)||isNaN(n))return e.localeCompare(t);if(a!==n)return a-n}return 0}(t.version,e.version));return i.length&&(i[0].current=!0),i}function ss(e){const t="string"==typeof e?e:String(e??""),i=t.match(/(\d+\.\d+(?:\.\d+)?)/);return i?i[1]:t}const os=["temperature","humidity","carbon_dioxide","illuminance","battery"],as=["motion","door","window","moisture","smoke","gas"];function ns(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t),l=function(e,t){const i=[];for(const s of Mt){const o=e[s.key];if(null==o)continue;const a=o.value,n=t.ranges?.[s.key]??{},r=o.diagnostic&&s.diag?s.diag:s,l=n.min??r.min,c=n.max??r.max,d=Ft(s.key,t),p=Math.min(1,Math.max(0,(a-l)/(c-l||1)));if(i.push({key:s.key,label:s.label,val:a,digits:s.digits,min:l,max:c,stops:d,pct:p,color:Bt(d,p)}),i.length>=4)break}return i}(e.sensorValues(t),{ranges:a.graph_style?.sensor_ranges,colors:a.graph_sensor_colors,gradients:a.graph_style?.gauge_gradients,accent:s}),c=e=>`pm-gg-${t.device_id.replace(/\W/g,"")}-${e}`,d=new Set(["power","voltage","current"]),p=110,h=110,u=180,g=180,v=22,f=102,m=e=>e*Math.PI/180,b=(e,t)=>{const i=g+u*Math.min(1,Math.max(0,t)),s=p+e*Math.cos(m(g)),o=h+e*Math.sin(m(g)),a=p+e*Math.cos(m(i)),n=h+e*Math.sin(m(i)),r=u*t>180?1:0;return`M ${s.toFixed(2)} ${o.toFixed(2)} A ${e} ${e} 0 ${r} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t,i)=>"power"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:e.toFixed(i),x=7,w=h+8;return q`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      <div class="ts-ring-top" style="width:100%">
        ...
        ${Ye(t,o,"ts-ring-name")}
        ${Ke(e)?ls(n,"ts-chips ts-chips-hdr"):K}
      </div>
      ${l.length?q`
      <svg viewBox="0 0 ${2*p} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        <defs>
          ${l.map((e,t)=>{if(e.stops.length<2)return K;const i=f-t*v;return V`
              <linearGradient id="${c(e.key)}" gradientUnits="userSpaceOnUse"
                x1="${p-i}" y1="0" x2="${p+i}" y2="0">
                ${e.stops.map((t,i)=>V`<stop offset="${i/(e.stops.length-1)*100}%" stop-color="${t}"/>`)}
              </linearGradient>`})}
        </defs>
        ${l.map((e,t)=>{const s=f-t*v,o=e.stops.length>1?`url(#${c(e.key)})`:e.stops[0],a=18,n=(h-Math.sqrt(Math.max(0,s*s-a*a))+x/2+1.5).toFixed(1),r=i||!d.has(e.key);return V`
      ...
      ${rs(e)}
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t),l=Ke(e);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=c.filter(e=>!e.live).map(e=>e.v),s=a.graph_style?.sensor_ranges?.power??{},o=s.min??Math.min(...i),n=s.max??Math.max(...i),r=n-o||1,l=(e,t)=>t/(c.length-1)*d,m=e=>p-h-(e-o)/r*(p-2*h),b=e.indexOf(n);v=l(null,Math.max(0,b)),f=m(n);const y=c.map((e,t)=>`${l(null,t).toFixed(1)},${m(e.v).toFixed(1)}`).join(" "),x=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return V`<defs><linearGradient id="${x}" x1="0" y1="0" x2="0" y2="1">
    ...
    ${n>o?V`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${g}"/>
    ...
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ...
        ${l?ls(n,"ts-chips ts-chips-hdr"):K}
      </div>
      ...
      ${rs(e,{skipPowerGraph:!0})}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:o}=e,a=e.tileSensors(t),n=e.getPrimarySwitch(t),r=Ke(e);return q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=a.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${ti(a.uptime)}</span>`:K}
        </div>
        ${n&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(n.entityId,i,t)}>${i?"ON":"OFF"}</button>`:K}
      </div>
      ${rs(e)}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t),l=Ke(e);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.filter(e=>!e.live).map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return V`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${rs(e,{skipPowerGraph:!0})}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:o,config:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t),l=e.getPowerSparks(t),c=Ke(e);e.ensureGraphData(t);const d=200,p=32,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=l.length>1?(()=>{const e=l.filter(e=>!e.live).map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,n=l.map((e,t)=>`${(t/(l.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),r=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return V`<defs><linearGradient id="${r}" x1="0" y1="0" x2="0" y2="1">
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-top">
        ${r&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${i?"ON":"OFF"}</button>`:K}
        ${Ye(t,o,"ts-hero-name")}
        ${c?ls(n,"ts-chips ts-chips-hdr"):K}
      </div>
      ...
      <div class="ts-hero-foot">
        ${!c&&e.showEl("secondary")?ls(n):K}
        ${e.showEl("uptime")?q`<span class="ts-uptime">${n.uptime?ti(n.uptime):""}</span>`:K}
      </div>
      ${rs(e,{skipPowerGraph:!0})}
    </div>`}(e)}}function rs(e,t={}){return e.showEl("lower_body")?e.renderTileLowerBody(e.device,e.profile,{...t,skipGraphs:!e.showEl("graph")}):K}function ls(e,t="ts-chips"){return q`<div class="${t}">
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${cs}" height="${cs}" viewBox="0 0 ${cs} ${cs}"
            ...
            <foreignObject x="0" y="0" width="${cs}" height="${cs}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${cs}px;height:${cs}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${ds}" cy="${ds}" r="${ds}" fill="url(#${_})" opacity="${i?1:.3}"/>
      ...
      ${e.showEl("effects")?it(f,m,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e})):K}
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Xt(l.power)}</div>`:K}
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:K}
    </div>`}function hs(e,t){const{device:i,profile:s,config:o,hass:a,online:n}=e,r=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),u=e.getPower(i),g=e.getSensors(i),v=e.getInputChannels(i),f=r?.isOn??!1,m=void 0!==r?.brightness,b=r&&m&&f?Math.max(1,r.brightness??1):0,y=!!r?.colorModes?.length,x=r?.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",w=!!r?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Gt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=at(s,f,`--ent-spd:${t?.tile_icon_speed??1};--ent-size:${t?.tile_icon_size??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?at(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?at(i,!0,"--ent-spd:1","tile-icon"):q``}else a=q``;const p=r?e.renderEntityAnim(r.entityId,f,i.device_id):q``,u=r&&e.showEl("toggle")?q`
      ...
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=r?a.states[r.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,o=r?.whiteValue??0;return r&&m?q`
        ...
        `:K}
        ${it(i,s,e=>a.callService("light","turn_on",{entity_id:r.entityId,effect:e}))}
      ...
      `:q``}case"media_controls":{const t=i.entities.find(e=>"media_player"===e.domain&&!e.entity_category),s=t?a.states[t.entity_id]:void 0;if(!t||!s)return q``;const n=s.attributes,r=Number(n.supported_features??0),l={PAUSE:1,VOLUME_SET:4,VOLUME_MUTE:8,PREV:16,NEXT:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,STOP:4096,PLAY:16384,BROWSE:131072},c=e=>0!==(r&e),d=s.state,p="playing"===d,h="off"===d||"standby"===d||"unavailable"===d,u=[n.media_title,n.media_artist].filter(Boolean).join(" · ")||n.source||"",g="number"==typeof n.volume_level?Math.round(100*n.volume_level):null,v=!0===n.is_volume_muted,f=(e,i={})=>a.callService("media_player",e,{entity_id:t.entity_id,...i}),m=p?"Playing":"paused"===d?"Paused":"idle"===d?"Idle":"unavailable"===d?"Unavailable":h?"Off":d,b=function(e,t){const i=e.device_styles?.[t.device_id]?.radio_stations??e.radio_stations;return(Array.isArray(i)?i:[]).filter(e=>e&&"string"==typeof e.url&&!!e.url)}(o,i),y=c(l.BROWSE)?e.getBrowseGroups(t.entity_id):null,x=Array.isArray(y)?y:[],w=new Map;for(const e of x)for(const t of e.items)w.set(t.id,t.type);for(const e of b)w.has(e.url)||w.set(e.url,"music");const k=n.media_content_id,_=n.media_title,A=()=>{for(const e of x)for(const t of e.items)if(t.title===_)return t.id;return b.find(e=>e.name===_)?.url},S=(k&&w.has(k)?k:void 0)??(_?A():void 0)??"",C=c(l.PLAY_MEDIA)&&(c(l.BROWSE)||b.length>0),$=Array.isArray(y)&&!x.some(e=>e.items.length)&&!b.length,E=i=>{i.stopPropagation(),c(l.BROWSE)&&e.requestBrowse(t.entity_id)};return q`
          ...
          <div class="tile-media-row">
            ${c(l.TURN_ON)||c(l.TURN_OFF)?q`
              <button class="tile-media-btn ${h?"":"on"}" title=${h?"Turn on":"Turn off"}
                @click=${()=>f(h?"turn_on":"turn_off")}>⏻</button>`:K}
            ${c(l.PREV)?q`<button class="tile-media-btn" title="Previous" @click=${()=>f("media_previous_track")}>⏮</button>`:K}
            ${c(l.PLAY)||c(l.PAUSE)?q`
              <button class="tile-media-btn tile-media-play ${p?"on":""}" title=${p?"Pause":"Play"}
                @click=${()=>f(p?c(l.PAUSE)?"media_pause":"media_stop":"media_play")}>${p?"⏸":"▶"}</button>`:K}
            ${c(l.STOP)?q`<button class="tile-media-btn" title="Stop" @click=${()=>f("media_stop")}>⏹</button>`:K}
            ${c(l.NEXT)?q`<button class="tile-media-btn" title="Next" @click=${()=>f("media_next_track")}>⏭</button>`:K}
            ${null!=g&&c(l.VOLUME_SET)?q`
              ${c(l.VOLUME_MUTE)?q`
                <button class="tile-media-btn" title=${v?"Unmute":"Mute"}
                  @click=${()=>f("volume_mute",{is_volume_muted:!v})}>${v?"🔇":"🔊"}</button>`:K}
        ...
        </div>`}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=yt(i);return e.length?q`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>q`
            <hdd-delegated .hass=${a} .entity=${e.entity_id} .features=${bt[e.domain]}></hdd-delegated>
          `)}
        </div>`:q``}case"power_bar":return e.renderPowerBar(i);case"badges":return q`
        <div class="tile-bot">
          ${null!=u?q`<span class="tile-power">${Xt(u)}</span>`:K}
      ...
      `;default:return q``}var S}const us=255;function gs(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${a?q`<div class="ds-fw-update">
        <span>FW update: ${a.current} → ${a.newVersion}</span>
        <button class="ds-fw-install" title="Install ${a.newVersion} now"
          @click=${t=>e.installUpdate(a.entityId,t)}>Install</button>
      </div>`:K}
      ${null!=n.rssi?q`<div class="ds-signal">Wi-Fi: ${ii(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?q` · Up ${ti(n.uptime)}`:K}</div>`:K}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,n=o?.attributes?.friendly_name??s.entity_id,r=s.entity_id.match(/_(?:switch|relay|channel)_\d+/)?.[0]??"",l=r?t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(r)&&"power"===i.states[e.entity_id]?.attributes?.device_class):void 0,c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?K:q`<span class="ds-channel-power">${Xt(c)}</span>`}
    ...
    ${fs(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return q`
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?q`<span class="ds-big-power">${Xt(s.power)}</span>`:K}
    </div>
    ${fs(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,o=Math.round(s/255*100);return q`
    <div class="ds-section">
    ...
    ${fs(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/us*100);return q`
    <div class="ds-section">
    ...
    ${fs(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return q`
    <div class="ds-section">
    ...
    ${fs(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return q`
    <div class="ds-section">
    ...
    ${fs(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return q`
    <div class="ds-section">
    ...
    ${fs(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return q`${fs(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),o=e.getAlerts(t);return q`
    ...
    ${fs(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t}=e,i=e.getInputChannels(t);return q`
    <div class="ds-section">
    ...
    ${fs(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),o=t.entities.filter(e=>"switch"===e.domain);return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    ${fs(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return q`
    ${t?q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${fs(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    </div>`}function vs(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function fs(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:o=!1}=t;return q`
    ${o&&s?vs(e):K}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Xt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:K}
        ${null!=t.voltage?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Zt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:K}
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Jt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:K}
        ...
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${ei(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:K}
      </div>
    </div>`:q``}(e):K}
    ${!o&&s?vs(e):K}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const a=(t,s)=>{const o=i.states[t.entity_id],a=o?.attributes?.friendly_name??t.entity_id,n=o?.state??"unknown",r=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===n,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      ...
      </div>`},n=o.filter(e=>"primary"===ut(e)),r=o.filter(e=>"config"===ut(e)),l=o.filter(e=>"diagnostic"===ut(e));return q`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=o.rssi?q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${ii(o.rssi)} (${o.rssi} dBm)</span></div>`:K}
        ${null!=o.uptime?q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${ti(o.uptime)}</span></div>`:K}
      ...
      <div class="cf-backdrop" @click=${t}>
        <div class="cf-box" role="alertdialog" aria-modal="true" aria-label="Confirm turn off"
          ...
          </div>`;const C=s.map(e=>e.v),$=s.filter(e=>!e.live).map(e=>e.v),E=(this._config.graph_style?.sensor_ranges??{})[_]??{},T=E.min??Math.min(...$),I=E.max??Math.max(...$),O=I-T||1,M=s[0].t,D=s[s.length-1].t,z=D-M||1,R=e=>(e.t-M)/z*a,P=e=>n-4-(e.v-T)/O*(n-8),B=s.map(e=>`${R(e).toFixed(1)},${P(e).toFixed(1)}`).join(" "),F=R(s[0]).toFixed(1),L=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,N=C[C.length-1],j=N%1==0?`${N}`:N.toFixed(1),H=Math.max(...$),W=Math.min(...$);let U=C.indexOf(H),G=C.indexOf(W);U<0&&(U=0),G<0&&(G=0);const Y=R(s[U]).toFixed(1),X=P(s[U]).toFixed(1),Q=R(s[G]).toFixed(1),Z=P(s[G]).toFixed(1),J=x(s[0].t),ee=x((s[0].t+D)/2),te=f/z*a,ie=`${Math.max(.3,.7*te).toFixed(2)} ${Math.max(.3,.3*te).toFixed(2)}`,se=c&&I-T>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?K:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),n=M+o*z;let r=s[0];for(const e of s)Math.abs(e.t-n)<Math.abs(r.t-n)&&(r=e);const l=R(r),c=P(r),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const h=t.parentElement,u=h?.querySelector(".spark-tooltip");if(u){const e=u.querySelector(".spark-tooltip-val"),t=u.querySelector(".spark-tooltip-time");e&&(e.textContent=`${r.v%1==0?String(r.v):r.v.toFixed(1)} ${k}`),t&&(t.textContent=x(r.t)),u.style.left=`${(l/a*100).toFixed(1)}%`,u.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                `:K}
                ${"bar"!==h&&g?V`
                  <polygon points="${B} ${a},${n-4} ${F},${n-4}" fill="url(#${L})"/>
                `:K}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=R(e)-t/2,o=P(e),r=n-4-o;return V`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,r).toFixed(1)}" rx="${u}" fill="${S}" opacity="0.75"/>`}):V`
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return q``;const o=(t?s.on:s.off)??"none";return"none"===o?q``:at(o,t,`--ent-spd:${s.speed??1};--ent-size:${s.size??1}`,"ent-icon")}_renderBlock(e,t,i,s){return hs(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return q`
      ...
      <div class="ts-lower-section ts-lower-dimmer" @click=${e=>e.stopPropagation()}>
        ...
        `:K}
        ${it(x,w,e=>this.hass.callService("light","turn_on",{entity_id:s.entityId,effect:e}))}
      </div>
    `:K,_=o?q`
    ...
    `:K;return p.length||u||o||a||n||C.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${_e(p)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?hs(a,e[0]):q`<div class="tile-row">${e.map(e=>hs(a,e))}</div>`)}
        </div>`}const y=e.area??"",x=this._tileAccent(e,y);return q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${_e(p)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===f?ns(this._buildTileCtx(e,s,x),b):"light-control"===f?ps(this._buildTileCtx(e,s,x)):"climate-control"===f?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return Xe(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(o.states[r.entity_id]?.state??"")||null;return q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("presets")&&a.presetModes.length?q`<div class="trv-presets">${a.presetModes.map(t=>q`
        <button class="trv-preset-btn ${a.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(a.entityId,t)}>${(st[t]??"")+t}</button>`)}
      </div>`:K}
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:K}
    </div>`}(this._buildTileCtx(e,s,x)):"cover-control"===f?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=o.position??("open"===o.state?100:0),n="opening"===o.state||"closing"===o.state,r=Math.ceil(a/100*ot.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${ot.map((e,t)=>V`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<r?"0.85":"0.1"}"/>`)}
        </svg>
      ...
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:K}
    </div>`}(this._buildTileCtx(e,s,x)):"sensor-card"===f?function(e){const{device:t,accent:i,online:s,hass:o,config:a}=e;let n;for(const e of os)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=o.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const r=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return t&&as.includes(t.attributes?.device_class??"")});if(!n&&!r)return Xe(t,s,"ts-sensor","No sensor");if(n){const r=o.states[n.entity_id],l=parseFloat(r?.state??""),c=r?.attributes?.unit_of_measurement??"",d=r?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const h=e.getGraphPoints(n.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;if(e.entity_category)return!1;const t=o.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||!t.attributes?.unit_of_measurement||isNaN(parseFloat(t.state)))}).slice(0,4),v=Ke(e),f=!v&&e.showEl("secondary"),m=(v||f)&&g.length?g.map(e=>{const t=o.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return q`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`}):null;return q`
    ...
    </div>`}(this._buildTileCtx(e,s,x)):"input-control"===f?ct(this._buildTileCtx(e,s,x)):"scene-button"===f?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),n=o.device_styles?.[t.device_id],r=n?.tile_icon??"pulse",l=n?.tile_icon_size??1,c=at(r,!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),d=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),p=d?e.timeAgo(d):"";return a.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${o>0?q`<span class="fav-chip fav-chip-power">${Xt(o)}</span>`:K}
          </div>
        </div>
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._config.area_styles?.[t]?.header_chips:void 0,s=void 0!==i?new Set(i):void 0!==this._config.area_header_chips?new Set(this._config.area_header_chips):new Set(bi),o=e=>s.has(e),a={},n=(e,t)=>{a[e]||(a[e]={sum:0,count:0}),a[e].sum+=t,a[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain||!qi(e))continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",a=mi.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));a&&o(a.key)&&n(a.key,i)}const r=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",l=[];for(const t of mi){if("energy"===t.key&&o("energy")&&"total"!==r){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,r);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){a.energy&&l.push({key:"energy",label:t.label,value:this._formatAreaChip("energy",a.energy.sum)});continue}if(s||a.energy){const e="today"===r?"Today":"week"===r?"Week":"Month";l.push({key:"energy",label:e,value:s?Qt(i):"…"})}continue}const i=a[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;l.push({key:t.key,label:t.label,value:this._formatAreaChip(t.key,s)})}return l}_areaChipDeviceValues(e,t,i){const s=mi.find(e=>e.key===t);if(!s)return[];if("energy"===t){const t=(i?this._config.area_styles?.[i]?.energy_period:void 0)??this._config.energy_period??"total";if("total"!==t){const i=[];for(const s of e){let e=0,o=!1;for(const i of this._energyEntitiesFor(s)){const s=this._periodEnergyValue(i,t);null!=s.kwh&&(e+=s.kwh,o=!0)}o&&i.push({name:s.name,value:e})}if(i.length)return i.sort((e,t)=>t.value-e.value)}}const o=[];for(const t of e){let e=0,i=0;for(const o of t.entities){if("sensor"!==o.domain)continue;const t=this.hass.states[o.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const a=parseFloat(t.state);if(isNaN(a))continue;const n=t.attributes.device_class??"";(s.dc===n||"rssi"===s.key&&("signal_strength"===n||o.entity_id.includes("_rssi")))&&(e+=a,i++)}i&&o.push({name:t.name,value:"sum"===s.agg?e:e/i})}return o.sort((e,t)=>t.value-e.value)}_formatAreaChip(e,t){switch(e){case"power":return Xt(t);case"energy":return Qt(t);case"voltage":return Zt(t);case"current":return Jt(t);case"temperature":return ei(t);case"humidity":return ni(t);case"co2":return li(t);case"illuminance":return ri(t);case"battery":return ci(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_renderCollapseAll(e){const t=e.every(e=>this._closedAreas.has(e));return q`
      ...
      <div class="area-section ${s?"closed":""} ${a?.bg_image&&"ambient"===a.bg_image_mode?"area-bg-ambient":""}" style=${_e(r)}>
        ...
        ${(()=>{const s=this._areaChipOpen;if(!s||!s.startsWith(`${e}::`))return K;const o=s.slice(e.length+2),a=this._areaChipDeviceValues(t,o,i);if(!a.length)return K;const n=mi.find(e=>e.key===o);return q`
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(g)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        ${this._renderExtraCards(Ni(this._config,o??void 0,"header_cards"))}
        <div class="dash-body">
        ...
        ${this._renderExtraCards(Ni(this._config,o??void 0,"footer_cards"))}
      </ha-card>
    `;return m}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=function(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const a of e){const e=[],n=[];if(Gi(a,t)){const o=Xi(a,t);o.length&&(e.push("alert"),n.push(...o));const r=Zi(a,t);null!==r&&r<=s&&(e.push("battery"),n.push(`battery ${Math.round(r)}%`));const l=Qi(a,t,i)?es(a,t,i):null;l&&(e.push("update"),n.push(`update → ${l.next}`))}else e.push("offline"),n.push("offline");e.length&&o.push({device:a,kinds:e,detail:n})}const a={offline:0,alert:1,battery:2,update:3},n=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>n(e)-n(t)||e.device.name.localeCompare(t.device.name))}(e,this.hass.states,{batteryBelow:this._config.attention_battery,includeBeta:this._config.include_beta_updates}),i=!1===this._config.show_firmware_summary?[]:is(e),s=i.length>1;if(!t.length&&!s)return q``;const o={offline:"○",alert:"▲",battery:"▮",update:"↑"},a=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t));return q`
      <div class="attention">
      ...
      </div>`}_renderExtraCards(e){if(!e?.length)return q``;const t=this.preview||this.hasAttribute("data-edit-preview"),i="match"===ji(this._config,this._getActiveView()??void 0);return q`
      <div class="extra-cards ${i?"xc-match":""}">
        ${e.map(e=>q`
          <hdd-card style=${_e(this._extraCardGrid(e))}
            .hass=${this.hass} .config=${e} .preview=${t}></hdd-card>`)}
      </div>`}_extraCardGrid(e){const t=e.grid_options;if(!t||"object"!=typeof t)return{};const i={},s=t.columns;"number"==typeof s&&s>0&&s<12&&(i["grid-column"]=`span ${Math.round(s)}`);const o=t.rows;return"number"==typeof o&&o>1&&(i["min-height"]=`calc(${Math.round(o)} * var(--hdd-grid-row, 56px))`),i}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return q``;const t=e.filter(e=>yt(e).length>0).length;if(!t)return q``;const i=this.preview||this.hasAttribute("data-edit-preview"),s=i?q`<button class="dn-link" @click=${e=>{e.stopPropagation(),window.dispatchEvent(new CustomEvent("hdd-editor-goto",{detail:{tab:"design",section:"design-tiles",flash:"delegate_controls"}}))}}>Native controls</button>`:q`<b>Native controls</b>`;return q`
    ...
    `],e([ve({attribute:!1})],ws.prototype,"hass",void 0),e([ve({type:Boolean})],ws.prototype,"preview",void 0),e([fe()],ws.prototype,"_config",void 0),e([fe()],ws.prototype,"_closedAreas",void 0),e([fe()],ws.prototype,"_areaChipOpen",void 0),e([fe()],ws.prototype,"_graphData",void 0),e([fe()],ws.prototype,"_periodEnergy",void 0),e([fe()],ws.prototype,"_periodEnergyErrAt",void 0),e([fe()],ws.prototype,"_valveDragPos",void 0),e([fe()],ws.prototype,"_trvDragTemp",void 0),e([fe()],ws.prototype,"_cloudDetailOpen",void 0),e([fe()],ws.prototype,"_detailDevice",void 0),e([fe()],ws.prototype,"_confirmOff",void 0),e([fe()],ws.prototype,"_detailHistoryRange",void 0),e([fe()],ws.prototype,"_activeViewId",void 0),e([fe()],ws.prototype,"_delegateNoticeDismissed",void 0),e([fe()],ws.prototype,"_attentionOpen",void 0),e([fe()],ws.prototype,"_dimFeedback",void 0),ws=ms=e([he("ha-device-dashboard")],ws);const ks=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),ks(e,t);return!0},_s=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},As=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),$s(t)}};function Ss(e){void 0!==this._$AN?(_s(this),this._$AM=e,As(this)):this._$AM=e}function Cs(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)ks(s[e],!1),_s(s[e]);else null!=s&&(ks(s,!1),_s(s));else ks(this,e)}const $s=e=>{e.type==be&&(e._$AP??=Cs,e._$AQ??=Ss)};class Es extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),As(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ks(this,e),_s(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ts=new WeakMap,Is=ye(class extends Es{render(e){return K}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),K}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ts.get(t);void 0===i&&(i=new WeakMap,Ts.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ts.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Os=ye(class extends xe{constructor(){super(...arguments),this.key=K}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ie(e),this.key=t),i}}),Ms={kind:"global"};function Ds(e,t){switch(t){case"tile":return!0;case"container":return"global"===e.kind||"view"===e.kind||"room"===e.kind;case"chrome":return"global"===e.kind||"view"===e.kind}}function zs(e){switch(e.kind){case"global":return"global";case"view":return`view:${e.id}`;case"room":return`room:${e.name}`;case"type":return`type:${e.profile}`;case"device":return`device:${e.id}`}}function Rs(e,t){switch(e.kind){case"global":return"Global";case"view":return`View · ${t.viewName(e.id)}`;case"room":return`Room · ${e.name||"No room"}`;case"type":return`Type · ${e.profile}`;case"device":return`Device · ${t.deviceName(e.id)}`}}const Ps={tile:["theme","color","tile_style","power_monitor_variant","tile_layout","sensors","show_graphs","elements","energy_period"],container:["columns","tile_size","tileGap","tile_gap"],chrome:["style","header_cards","footer_cards","extra_card_style"]},Bs=["bg_image","bg_image_size","tile_icon","tile_icon_off","tile_icon_speed","tile_icon_size","entity_animations","extra_sensors","radio_stations","input_actions","confirm_off"],Fs=[...Ps.tile,...Ps.container,...Ps.chrome];function Ls(e){return"device"===e.kind?[...Fs,...Bs]:Fs}function Ns(e){let t=(e??"").trim();if(t&&(t=t.replace(/^[a-z]+:\/\//i,""),t=t.split("/")[0].split(":")[0],/^[a-z0-9][a-z0-9.-]+\.[a-z]{2,}$/i.test(t)))return`https://${t}`}function js(e,t,i=!1){if(e){if(/^https?:\/\//i.test(e))return e;if(e.startsWith("images/")){return"https://control.shelly.cloud/"+(i?e.replace(/_m\.(jpe?g|png)$/i,"_l.$1"):e)}if(e.startsWith("assets/")){const s=i?e.replace(/thumb_(?=[^/]+$)/,""):e;return`${t.replace(/\/$/,"")}/shelly_files/${s}`}}}function Hs(e){return!!e&&e.startsWith("images/room_def/")}function Ws(e){const t=/^([0-9a-f]{12})(?:_\d+)?$/i.exec(e??"");return t?t[1].toLowerCase():void 0}const Us=e=>e.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\s+/g," ").trim();function qs(e,t){const i=new Map;for(const e of t){const t=new Set;for(const[i,s]of e.connections??[])"mac"===i&&t.add(s.replace(/[:-]/g,"").toLowerCase());for(const[i,s]of e.identifiers??[])"shelly"===i&&/^[0-9a-f]{12}$/i.test(s)&&t.add(s.toLowerCase());for(const s of t){const t=i.get(s)??[];t.push(e.id),i.set(s,t)}}const s=new Map;for(const t of e){const e=Ws(t.id);if(!e)continue;const o=i.get(e);o?.length&&s.set(e,o)}return s}const Vs=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"lights",label:"What counts as a light"},{id:"extra-cards",label:"Extra cards"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"design",label:"Design",icon:"◈",sections:[{id:"design-scope",label:"Scope"},{id:"design-panel",label:"Controls for the selected scope"},{id:"theme",label:"Colour theme"},{id:"content",label:"Chips & metrics"},{id:"tiles",label:"Tiles"},{id:"electrical",label:"Sensor chips — Electrical"},{id:"environmental",label:"Sensor chips — Environmental"},{id:"deviceinfo",label:"Sensor chips — Device info",advanced:!0},{id:"alerts",label:"Sensor chips — Alerts",advanced:!0},{id:"header",label:"Header"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours"},{id:"typography",label:"Typography",advanced:!0}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],Gs=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","For blocks there is one extra rung: a saved custom style's own layout sits above the room and card-wide values, since choosing a saved look is more deliberate than leaving the global default in place.","The editor flags the common cases for you — see Conflicts."]},{id:"design-scopes",title:"Where a setting lives",body:["Everything about how the card looks is in one tab: **Design**. It is *scope-first* — you pick **where** you are editing, and the same control list redraws for that layer. Global, a view, a room, a device type, or one device.","Pick the scope in the map at the top. Devices are grouped by room, type or integration; room and type headings are clickable because they are layers you can style, while an integration is only a way to find a device. The number on a chip is how many settings that layer overrides, so you can see where customisation lives without opening everything.","Every control says where its value is coming from — **set here**, with a ↺ to drop it, or **from Room · Kitchen** / **from Card**. Most specific wins, always.","What you can set depends on the layer, and the tab says why. There are three groups. **Tile** settings — theme, colour, tile style, blocks, chips, graphs, energy window — can be set anywhere: device, type, room, view, card. **Container** settings — columns and tile size — stop at the room, because a grid needs something to hold it and one device has no column count. **Card chrome** — the header, the card surface, typography — only a view or the card can set, because a room does not contain the card's header.","Two scopes also hold settings with no ladder under them at all. Global has the theme picker, chips & metrics, tiles, the sensor-chip groups, and the card's own header and type. A room has **Room chrome** — the room block's backdrop photo, tile gap, header colours, borders, per-room header chips and button shapes — things that exist exactly once per room.","A shortcut worth knowing: in the card editor, tapping a device tile in the **live preview** jumps straight to that device's scope in Design — same landing as the ✎ button in Rooms & devices. Buttons and sliders on the tile still work normally, so you can test controls in the preview too."]},{id:"content-defaults",title:"Global defaults vs. per-room overrides",body:["The **Chips & metrics** section in Design (at Global scope) sets three things card-wide: which chips each room header shows, which window the energy readout totals (Total / Today / Week / Month), and which sensor chips appear on tiles. Treat it as the first stop — decide what data is on show, then style it.","These are *defaults*. Every room and device inherits them, but any room or device can override any of them — by picking that room or device as the scope in Design — and the moment it does, it stops listening to the global. A global toggle only moves scopes that are still inheriting: turning a chip on globally will **not** turn it on in a room that has set its own chips, and turning it off will not turn it off there.",'Each picker tells you which state it is in. **Inheriting from …** means a global change still reaches it; **Custom selection** means it is pinned to its own value. Setting a room or device to an empty selection is itself a custom choice ("show none"), not the same as inheriting.',"To hand control back to the global default, use that scope's reset — `↺ Default` for room header chips, `↺ Inherit` for the chip pickers. Room header chips resolve room → global → built-in; energy and sensor chips also allow a per-device override (and, for sensor chips, a per-type one) in front of the room."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:['**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…) — and carry the odd placement choice, like "Chips in the name row" on the power-monitor and sensor styles, which moves the secondary readings up beside the device name. **Sensor chips** choose which measurements appear as little pills, in any style.',"The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","Design narrows to whatever scope you pick: choose one device and it offers only the chips that device can produce and the blocks it can render — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['An input is one of two things, and the card reads which from Home Assistant. A **button** input is momentary — it reports presses (single, double, long) on an `event` entity, and its row shows the last press and how long ago. A **switch** input is steady — it reports its position on a `binary_sensor`, and its row shows an ON/OFF pill. Relays have inputs too: a Plus 1PM\'s "Input 0" is the wall switch wired to it.',"An input that is wired to an output on its own device (`input_0` → `switch_0`) needs no setup: tapping its row toggles that output, and the row lights with the output's state. That is the one thing the physical input does that Home Assistant can replay.",'A Shelly i3, i4 or UNI has no output of its own — it reports presses and controls nothing by itself, so the card cannot "push" a channel for you. What it can do is run the same thing the physical button runs. In Design, pick the device as the scope and use **Input actions**: give a channel an action and its row becomes a key — tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.',"A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to. Channels you have not wired stay as status rows; tapping one opens its press history."]},{id:"lights",title:"What counts as a light",body:["The **Lights** header chip counts `light` entities that are on. A relay or plug wired to a lamp is a `switch` as far as Home Assistant is concerned — it has no way to know what is on the other end of the wire, and neither does the card.","You do. Label those devices in Home Assistant (Settings → Areas & labels), then tick the label under **Header → What counts as a light**. Every `switch` on a labelled device is counted from then on. The picker only offers labels that exist on your devices, with how many carry each.","For the stragglers a label does not cover, name entities directly in the same panel. A device caught by both routes is still counted once."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","**Follow HA** is the exception: instead of a palette it points every colour at Home Assistant’s own theme variables, so the card matches whatever HA theme is active and follows it into light or dark. Available per card, per view and per room like any other theme.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is.","A **view** and a **room** can each take a theme of their own, resolved room → view → card. A view theme repaints the whole card, header included, while that view is showing, and outranks the colours in `style`. A room theme repaints what the room contains — its block background, tiles, text, accent and its own header — but not the card header, which no room encloses; the room's individual colour fields still override it key by key."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running.",'**Beta firmware does not count as an update.** A Shelly exposes a `beta_firmware` entity that is on nearly permanently — on one real fleet that was 21 of 25 "available updates". Turn on `include_beta_updates` if you actually run betas.']},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],Ks=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"confirm-off",title:"Guard a device you must not switch off by accident",body:["A freezer, a server, the router, the heating — a mis-tap costs you something real. Turning the device ON is never confirmed, so the guard only slows you down in the direction that hurts.","It is set per device on purpose. Two identical plugs in the same room can disagree, which is what you want: arming a whole type or room would put the prompt in front of you constantly and train you to tap straight through it."],steps:["Design → pick the device in the scope picker.",'Under "Safety — this device only", turn on "Ask before turning off".','Tapping OFF now opens a prompt. Cancel is the wide button; the red "Turn off" is the narrow one.',"It covers every on/off the card draws for that device, including the per-channel relay rows and the detail sheet. It cannot cover a control drawn by Home Assistant itself under Native controls."]},{id:"extra-card-layout",title:"Show an embedded card only sometimes, or put two side by side",body:["Cards you embed under Extra cards are rendered by Home Assistant itself, so anything a card can normally do in a dashboard it can do here."],steps:["Extra cards → pick the placement (header, footer or a room) → Add card.","The Preview under the YAML draws the card as you type, exactly as the dashboard will — including an error card if the config is wrong.",'Header and footer cards can differ per view: set "Applies to" to a view and that view gets its own list, replacing the card-wide one. An empty list on a view means no cards there at all. "Use the card-wide list" clears the override.',"Use ▲ ▼ on a row to reorder.","Set Look to \"Match this card\" and embedded cards take the dashboard's background, border, radius, text and accent instead of Home Assistant's theme — so they sit in the card rather than on it. A card that hard-codes its own colours keeps them.","To show it conditionally, give the card a `visibility:` block — the same state, user and screen conditions a dashboard card takes. A card hidden by its condition leaves no gap.","To make it narrower, give it `grid_options: {columns: 6}` — the strip is twelve columns wide, so two sixes sit side by side. Leave `grid_options` out for full width.","`rows` sets a minimum height; the strip grows to fit its content rather than clipping."]},{id:"hide-onoff",title:"Hide the on/off button on a tile",body:["For a device you only want to watch, or one whose switching belongs somewhere else."],steps:["Design → pick the scope (device, type, room, view or Global).",'Open the tile style block and untick "On/off button".',"Available on the default, Power and Light tile styles — the three that draw a primary on/off button.","The device can still be switched from its detail sheet; this hides the button on the tile."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"cloud-import",title:"Import your Shelly app setup",body:["Coming from the Shelly app? The card can pull each room's photo and the official product image for every device from your Shelly Cloud account. The auth key is used for the one fetch and never saved; imported images stay hosted on Shelly's cloud."],steps:["Get your key: control.shelly.cloud → user settings → Authorization cloud key. Note the server shown next to it.","Rooms & devices → Import from Shelly Cloud → paste both → Fetch my Shelly setup.","Pair any cloud rooms that did not auto-match with a room here (name matching ignores accents).","Pick what to import — room photos, product images on tiles, full-size vs thumbnails — and Apply.","A custom room photo's cloud URL is unlisted but not private. Swap in a /local/… photo later if that matters.","To invalidate a key you have shared or leaked, change your Shelly account password — the key only rotates with it."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Design → Scope → pick the room (or expand it to reach one device).","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["The card only reacts to taps on the screen — it cannot give the wall button a job. The physical press is handled by the Shelly's own action/script or by a Home Assistant automation, and which of those you have decides the setup.","A relay with its own output (a 1PM, a Dimmer) needs none of this: its input toggles its own relay by default."],steps:["Design → Scope → expand a room → pick the switch → Input actions.",'No automation, Shelly handles the wall itself: choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','An automation already reacts to the button (a Shelly "Button N single push" device trigger): choose "Replay the press" instead — the row fires the same event the wall does, the automation runs, and nothing is configured twice. Hold and double tap can replay long and double pushes the same way.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"extra-sensors",title:"Show a reading from another device on a tile",body:["A Wall Display XL has a light sensor but no temperature or humidity sensor; the room's readings come from a BLU H&T beside it. Borrow them and the tile shows them as its own — chips, graphs, gauge rings and the detail sheet included."],steps:["Design → Scope → expand the room → pick the device → Extra sensors.","Search for the sensor entity on the other device (sensor.blu_ht_temperature, say) and pick it. Several work.","The other device keeps showing the reading too, and a borrowed sensor never decides whether this device counts as online."]},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["Design → Colour theme. Global sets the card; pick a view, room, type or device first to set one just there.","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Design → Tiles (Global scope) → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],Ys=e=>Math.random()<e;const Xs=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},Qs=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},Zs=(e,t)=>{const[i,s]=[Qs(e),Qs(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function Js(e,t,i,s,o,a){let n=i;for(let i=0;i<40;i++){const i=Xs(e,t,n);if(Zs(i,s)>=o)return i;if(n+=a?2:-2,n>98||n<2)break}return Xs(e,t,a?98:2)}var eo;const to=[["Name","name"],["Power","power"],["Online","online"],["Room","area"]],io=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let so=!1;const oo=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],ao=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"media_controls",label:"Media controls",sub:"the card’s own player: now playing, play/pause, volume, browse"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],no=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],ro=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let lo=eo=class extends de{constructor(){super(...arguments),this._tab="devices",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._viewDeleteArmed=null,this._xcPlacement="header",this._xcRoom="",this._xcView="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcPreview=null,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewIds=new Set,this._openSections={rooms:!0,theme:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1,"design-scope":!0,"design-panel":!0},this._haPickersReady=!1,this._iaAllEntities=null,this._expandedRooms=new Set,this._designScope=Ms,this._designGroupBy="room",this._designOpenGroups=new Set,this._designScopeLoaded=!1,this._changesOpen=!1,this._changesResetArmed=!1,this._selectedDeviceId=null,this._conflictsOpen=!1,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._styleClipFeedback="",this._openDiscDropdown=null,this._sciServer="",this._sciKey="",this._sciBusy=!1,this._sciError="",this._sciDone="",this._sciData=null,this._sciRoomMap={},this._sciOptRooms=!0,this._sciOptDevices=!0,this._sciOptStock=!1,this._sciOptFull=!0,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;if(t?.device)return e.preventDefault(),void this._gotoDevice(t.device);t?.tab&&t.section&&t.flash&&(e.preventDefault(),this._gotoControl(t.tab,t.section,t.flash))},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._wheel=null,this._closeWheel=()=>{const e=this.renderRoot.querySelector("#ha-dd-color-wheel");e?.hidePopover&&e.matches(":popover-open")&&e.hidePopover(),this._wheel=null},this._onWheelOutsideClick=e=>{if(!this._wheel)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-color-wheel"===e.id||e.classList?.contains("cw-btn")));t||this._closeWheel()},this._wheelPointer=e=>{if("pointermove"===e.type&&!(1&e.buttons))return;const t=e.currentTarget;"pointerdown"===e.type&&t.setPointerCapture(e.pointerId);const i=t.getBoundingClientRect(),s=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-s,n=e.clientY-o,r=Math.min(1,Math.hypot(a,n)/(i.width/2)),l=(180*Math.atan2(a,-n)/Math.PI+360)%360;this._setWheel({h:l,s:r}),e.preventDefault()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++,this._xcPreviewTimer&&(clearTimeout(this._xcPreviewTimer),this._xcPreviewTimer=void 0),this._xcPreview=e}_queueXcPreview(e){this._xcPreviewTimer&&clearTimeout(this._xcPreviewTimer),this._xcPreviewTimer=setTimeout(()=>{this._xcPreviewTimer=void 0,this._xcPreview=e},400)}setConfig(e){this._config=gi(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=Vs.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1;const s={[t]:!0};"design"===e&&t.startsWith("design-")&&this._globalSectionDescriptors()[t.slice(7)]&&(this._designScope=Ms,s["design-panel"]=!0),this._openSections={...this._openSections,...s},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_gotoDevice(e){this._selectedDeviceId=e,this._setDesignScope({kind:"device",id:e}),this._gotoControl("design","design-panel","design-scope")}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(gi(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </div>`}_renderHelpPanel(){const e=this._helpFilter.trim().toLowerCase(),t=t=>!e||t.title.toLowerCase().includes(e)||t.body.some(t=>t.toLowerCase().includes(e))||(t.steps??[]).some(t=>t.toLowerCase().includes(e)),i=Gs.filter(t),s=Ks.filter(t);return q`
      ...
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?lt.map(i=>{const s=(e.currentValue??"none")===i.value,o="none"!==i.value?nt[i.value]?.[e.isOn?"on":"off"]??t:t;return q`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?q`<span class="icon-grid-none">—</span>`:at(i.value,e.isOn,`--ent-spd:1;color:${o};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):K}
      </div>`}_openWheel(e,t){const i=Dt(e),{h:s,s:o,v:a}=Rt(i?.hex??"#808080");this._wheel={hex:Pt(s,o,a),h:s,s:o,v:a,alpha:i?.alpha??1,unparsed:i?void 0:e||void 0,onSelect:t},this.updateComplete.then(()=>{const e=this.renderRoot.querySelector("#ha-dd-color-wheel");if(e)try{e.showPopover&&!e.matches(":popover-open")&&e.showPopover()}catch{}})}_setWheel(e){if(!this._wheel)return;const t={...this._wheel,...e};t.hex=Pt(t.h,t.s,t.v),t.unparsed=void 0,this._wheel=t,t.onSelect(zt(t.hex,t.alpha))}_wheelButton(e,t,i="Pick a colour"){return q`
      <button class="cw-btn" style="background:${e}" title=${i}
        @click=${i=>{i.stopPropagation(),this._openWheel(e,t)}}></button>`}_renderColorWheel(){const e=this._wheel,t=[...new Set([...di.map(e=>e.defaultColor),"#ffffff","#e2e8f0","#94a3b8","#4b5563","#000000"])],i=e?50+50*e.s*Math.sin(e.h*Math.PI/180):50,s=e?50-50*e.s*Math.cos(e.h*Math.PI/180):50;return q`
      <div popover="manual" id="ha-dd-color-wheel" class="cw-pop" @click=${e=>e.stopPropagation()}>
        ${e?q`
          ...
          <div class="cw-row">
            <span class="cw-swatch" style="background:${zt(e.hex,e.alpha)}"></span>
            <input type="text" class="inline-text" style="width:90px;font-family:monospace" .value=${e.hex} maxlength="7"
              @change=${e=>{const t=e.target.value.trim();if(/^#[0-9a-f]{6}$/i.test(t)){const{h:e,s:i,v:s}=Rt(t);this._setWheel({h:e,s:i,v:s})}}}/>
          ...
          <div class="cw-presets">
            ${t.map(t=>q`
              <span class="cw-preset ${t===e.hex?"on":""}" style="background:${t}" title=${t}
                @click=${()=>{const{h:e,s:i,v:s}=Rt(t);this._setWheel({h:e,s:i,v:s})}}></span>`)}
          </div>`:K}
      </div>`}_iconPicker(e,t,i){const s="#f4601e",o=e?nt[e]?.[t?"on":"off"]??s:s,a=this._iconPickerState?.onSelect===i;return q`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          ${e?at(e,t,`--ent-spd:1;color:${o}`,"icon-preview-sm"):q`<span class="icon-cell-none">—</span>`}
        </button>
      ...
      </span>`}_chipPicker(e,t,i,s,o){const a=t??[],n=void 0!==e,r=t=>!o||o.has(t)||(e??[]).includes(t),l=oo.map(e=>({...e,items:e.items.filter(e=>r(e.key))})).filter(e=>e.items.length),c=oo.flatMap(e=>e.items.map(e=>e.key)).filter(r),d=new Set(n?e:a.length?a:c);return q`
      ...
      <div class="rooms-toolbar">
        ...
        <div class="toolbar-group">
          ...
          ${this._pills(e.sort_by??"name",to,e=>this._set("sort_by",e))}
        </div>
        <div class="toolbar-group">
      ...
      ${e.favorites?.length?(()=>{const t=eo.FAV_ROW_KEY,i=(e.favorites??[]).map(e=>a.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),o=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return q`
      ...
      `:K}`;return this._sec("cloud-import","☁","rgba(62,161,245,0.12)","#3ea1f5","Import from Shelly Cloud",this._sciDone?this._badge("imported","#3ea1f5","rgba(62,161,245,0.12)"):K,a)}_renderXcPreview(){const e=this._xcPreview,t=e&&"string"==typeof e.type?e.type:"",i=this._xcView?(this._config.views??[]).find(e=>e.id===this._xcView):void 0,s="match"===ji(this._config,i);return q`
      <div class="field-lbl" style="margin-top:10px">Preview</div>
      <div class="xc-preview ${s?"xc-match":""}"
        style=${_e(s?this._xcPreviewVars():{})}>
      ...
      ${s?q`
        <div class="dp-hint-inline">Shown in this card's palette, because Look is set to Match this card.</div>`:K}`}_xcPreviewVars(){const e=this._effectivePalette(),t=this._config.style??{},i={},s=(e,t)=>{null!=t&&""!==t&&(i[e]=String(t))};return s("--sc-tile-bg",e.tile_bg),s("--sc-tile-border",e.tile_border),s("--sc-text-primary",e.text_primary),s("--sc-text-secondary",e.text_secondary),s("--sc-text-muted",e.text_muted),s("--sc-accent",e.accent_color),null!=t.tile_radius&&s("--tile-radius",`${t.tile_radius}px`),null!=t.tile_border_width&&s("--sc-tile-border-width",`${t.tile_border_width}px`),s("--sc-font-family",t.font_family),i}_xcMove(e,t){const i=this._xcArray().slice(),s=e+t;s<0||s>=i.length||([i[e],i[s]]=[i[s],i[e]],this._xcSetArray(i))}_renderExtraCardsSection(){const e=this._xcArray(),t=this._getAreas().map(e=>e.name),i=this._config.views??[],s=!!customElements.get("ha-yaml-editor"),o=q`
      <div class="field">
      ...
      ${this._xcDraft?q`
        ...
        </div>`:K}`,a=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):K;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",a,o)}_renderCheckDropdown(e,t,i,s,o,a){const n=this._openDiscDropdown===e,r=new Set(s),l=r.size;return q`
      <div class="field">
      ...
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?Kt(this.hass):{integrations:[],domains:[]},o=q`
      <div class="field">
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const o=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${Is(e=>e?.focus())}/>`:q`<span class="pill ${e===o?"on":""}" @click=${()=>s(o)}>
                ${i.label||t}
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>ao.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>r(e,t,i))}
              ${e.length<eo.ROW_MAX?q`<span class="lay-slot">drop here</span>`:K}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=St[e];if(!s)return q``;const o=t=>this._inheritedElementValue(e,t.id,t.def??!0);return q`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderRoomHeaderChips(e,t){const i=this._allDevices().filter(t=>(t.area??"")===e),s=new Set;for(const e of i)for(const t of e.entities){if("sensor"!==t.domain)continue;const e=t.attributes?.device_class??"",i=mi.find(i=>i.dc===e||"rssi"===i.key&&("signal_strength"===e||t.entity_id.includes("_rssi")));i&&s.add(i.key)}const o=mi.filter(e=>s.has(e.key));if(!o.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors in this room.</div>`;const a=this._config.area_header_chips??bi,n=t.header_chips??a;return q`
      ...
      </div>`}_renderGlobalRoomHeaderChips(){const e=new Set;for(const t of this._allDevices())for(const i of t.entities){if("sensor"!==i.domain)continue;const t=i.attributes?.device_class??"",s=mi.find(e=>e.dc===t||"rssi"===e.key&&("signal_strength"===t||i.entity_id.includes("_rssi")));s&&e.add(s.key)}const t=mi.filter(t=>e.has(t.key));if(!t.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors discovered yet.</div>`;const i=this._config.area_header_chips??bi;return q`
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${t.map(e=>{const t=i.includes(e.key);return q`<span class="pill ${t?"on":""}" @click=${()=>{const s=t?i.filter(t=>t!==e.key):[...i,e.key];var o;this._set("area_header_chips",(o=s).length===bi.length&&bi.every(e=>o.includes(e))?void 0:s)}}>${e.label}</span>`})}
        </div>
      ...
      </div>`}_designKnown(){const e=this._allDevices();return{views:(this._config.views??[]).map(e=>e.id),rooms:[...new Set(e.map(e=>e.area??""))],types:[...new Set(e.map(e=>this._deviceProfile(e)))],devices:e.map(e=>e.device_id)}}_designScopeStorageKey(){return`hdd:designScope:${this._config?.title??"default"}`}_hydrateDesignScope(){if(!this._designScopeLoaded&&this.hass&&this._config){this._designScopeLoaded=!0;try{this._designScope=function(e,t){if(!e||"global"===e)return Ms;const i=e.indexOf(":");if(i<0)return Ms;const s=e.slice(0,i),o=e.slice(i+1);return"view"===s&&t.views.includes(o)?{kind:"view",id:o}:"room"===s&&t.rooms.includes(o)?{kind:"room",name:o}:"type"===s&&t.types.includes(o)?{kind:"type",profile:o}:"device"===s&&t.devices.includes(o)?{kind:"device",id:o}:Ms}(localStorage.getItem(this._designScopeStorageKey()),this._designKnown())}catch{}}}_setDesignScope(e){this._designScope=e,this._iaAllEntities=null;try{localStorage.setItem(this._designScopeStorageKey(),zs(e))}catch{}}_deviceProfile(e){return this._config.device_styles?.[e.device_id]?.profile??Ut(e).type}_designOverrides(){return this._config?function(e,t){const i=[],s=(e,t,s)=>{if(t)for(const o of s)void 0!==t[o]&&i.push({scope:e,key:o,value:t[o]})};s(Ms,e,Fs.filter(e=>"style"!==e&&"theme"!==e&&"tileGap"!==e));const o=e.style??{};for(const[e,s]of Object.entries(o)){if(void 0===s)continue;const o=t?.[e];void 0!==o&&o===s||i.push({scope:Ms,key:e,value:s,palette:void 0!==o})}for(const t of e.views??[])s({kind:"view",id:t.id},t,Fs);for(const[t,i]of Object.entries(e.area_styles??{}))s({kind:"room",name:t},i,Fs);for(const[t,i]of Object.entries(e.profile_styles??{}))s({kind:"type",profile:t},i,Fs);for(const[t,i]of Object.entries(e.device_styles??{}))s({kind:"device",id:t},i,[...Fs,...Bs]);return i}(this._config,je(this._config.theme)):[]}_clearOverride(e){const t=this._config;switch(e.scope.kind){case"global":if(e.palette||void 0!==t.style?.[e.key]){const i={...t.style??{}};delete i[e.key],this._set("style",Object.keys(i).length?i:void 0)}else this._set(e.key,void 0);return;case"view":return void this._updateView(e.scope.id,{[e.key]:void 0});case"room":return void this._setAreaStyle(e.scope.name,e.key,void 0);case"type":return void this._setProfileStyle(e.scope.profile,{[e.key]:void 0});case"device":return void this._setDeviceStyle(e.scope.id,{[e.key]:void 0})}}_renderChangesPanel(){const e=this._designOverrides(),t=this._allDevices(),i=e=>Rs(e.scope,{viewName:e=>(this._config.views??[]).find(t=>t.id===e)?.name||e,deviceName:e=>t.find(t=>t.device_id===e)?.name??e}),s=new Map;for(const t of e){const e=i(t);s.has(e)||s.set(e,[]),s.get(e).push(t)}return q`
      ...
      </div>`}_designFamily(e,t,i){return Ds(this._designScope,e)?q`
      ...
      </div>`}_designGlobalSections(e){const t=this._globalSectionDescriptors(),i=new Set(Vs.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id)));return q`${e.map(e=>{const s=t[e];if(!s)return K;const o=this._sec(`design-${e}`,s.icon,s.bg,s.fg,s.label,s.badge,s.body);return i.has(e)?this._adv(o):o})}`}_renderDesignPanel(){const e=this._designScope,t=this._scopeValues(),i=this._allDevices(),s=Rs(e,{viewName:e=>(this._config.views??[]).find(t=>t.id===e)?.name||e,deviceName:e=>i.find(t=>t.device_id===e)?.name??e}),o=Ls(e).filter(e=>void 0!==t[e]).length,a=()=>{"device"===e.kind?this._saveDeviceAsStyle(e.id):"type"===e.kind&&this._saveProfileAsStyle(e.profile)},n=("device"===e.kind||"type"===e.kind)&&o>0;return q`
      <div class="dsn-panel">
        ...
        ${this._designFamily("tile","Tile — device → type → room → view → card",()=>{const i=this._effectiveScopeStyle(),s=no.find(e=>e.v===i)?.label??i,o="global"===e.kind&&"default"!==i&&(()=>{const e=e=>void 0!==e&&"default"===Pi(this._baseStyleOf(e)).style;return Object.values(this._config.device_styles??{}).some(t=>e(t.tile_style))||Object.values(this._config.profile_styles??{}).some(t=>e(t.tile_style))||Object.values(this._config.area_styles??{}).some(t=>e(t.tile_style))||(this._config.views??[]).some(t=>e(t.tile_style))})(),a="default"===i||o;return q`
      ...
      ${this._designRow("Blocks","tile_layout",a?q`
            ...
            ${this._renderLayoutCanvas(t.tile_layout,Ct(this._inheritedFrom("tile_layout")?.value??$t.generic),e=>this._patchScope({tile_layout:e}))}`:q`<div class="hint">
      ...
      ${(()=>St[i]?this._designRow("Elements","elements",this._renderStyleElementToggles(i,t.elements??{},e=>this._patchScope({elements:e}))):K)()}
      ...
      <div class="dsn-family">
        ...
        ${!this._advanced&&a.length?q`
          <div class="dp-hint-inline">Turn on Advanced for per-switch icons (${a.length} on this device).</div>`:K}
      ...
      </div>`}_renderInputActionsBlock(e){const t=this._allDevices().find(t=>t.device_id===e),i=t?Ti(t,this.hass.states):[];if(!i.length)return q``;const s=(this._config.device_styles?.[e]??{}).input_actions??{},o=e=>Array.isArray(e)?e.join(", "):e??"",a=e=>void 0!==s[e.entityId]?e.entityId:void 0!==s[String(e.channel)]?String(e.channel):e.entityId,n=(t,i)=>{const o={...s};i?o[t]={...o[t]??{action:"none"},...i}:delete o[t],this._setDeviceStyle(e,{input_actions:Object.keys(o).length?o:void 0})},r=t?t.entities.map(e=>e.entity_id):[],l=!!t&&xt(t),c=this._iaAllEntities??!l,d=(e,t,i,s=!0,o)=>this._entityField(e,t,{deviceEntities:r,scopeAll:c,placeholder:i,multi:s,note:o});return q`
      <div class="dsn-family">
              ...
              ${l?q`
                <div class="ia-grid">
                  ...
                  ${"press"===r?q`
                    ...
                    ${this._advanced?q`
                      ...
                      <input type="number" class="inline-text" min="1" max="8" style="max-width:90px"
                        ...
                        @change=${t=>{const i=parseInt(t.target.value,10);n(a(e),{channel:Number.isFinite(i)&&i>0?i:void 0})}}/>`:K}`:K}
                  ...
                  ${this._advanced?q`
                    ...
                    <div>${d(i?.select_chip?.entity,t=>{const i=(e=>Array.isArray(e)?e[0]:e)(t);n(a(e),{select_chip:i?{entity:i}:void 0})},"A select entity — WLED presets, say (optional)",!1)}</div>`:K}
                </div>`:K}
            </div>`})}
    ...
    `}_renderViewCard(e,t,i,s,o,a,n,r){const l=this._expandedViewIds.has(e.id),c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,n,r),u=n.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return q`
        ...
        ${l?q`
          <div class="view-card-body">
            ...
            <div class="field">
              ...
              ${this._pills(e.sort_by,[...to,["inherit",void 0]],e=>g("sort_by",e))}
            </div>`)}
          </div>`:K}
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${vi.map(t=>{const i=e.header_chips??fi,s=i.includes(t.key);return q`
    ...
    `,f=q`
        ...
        <div class="gg-row">
          <div class="gg-hdr">
            ...
            ${p?q`<button class="color-reset" title=${3===d.length?"Drop the middle stop":"Add a middle stop"}
              @click=${3===d.length?()=>r(e.key,[d[0],d[2]]):()=>r(e.key,[d[0],Bt(d,.5),d[1]])}>${3===d.length?"− mid":"+ mid"}</button>`:K}
      ...
      ${Mt.map(e=>c(e))}
      ${a.filter(e=>!Mt.find(t=>t.key===e)).length?q`
        ...
        ${a.filter(e=>!Mt.find(t=>t.key===e)).map(e=>{const t=di.find(t=>t.key===e);return d(e,t?.label??e,(e=>s[e]??di.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:K}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",di.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${di.map(e=>{const t=a.some(t=>ui(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>ui(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,h=t.sensor_ranges??{},u=(e,i,s)=>{const o=""===s.trim()?void 0:parseFloat(s),a={...h[e]??{}};void 0===o||isNaN(o)?delete a[i]:a[i]=o;const n={...h,[e]:a};a.min||0===a.min||a.max||0===a.max||delete n[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(n).length?n:void 0})},g=q`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=h[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=ui(i.key),a=!!di.find(e=>e.key===o),n=e.graph_sensors??It,r=n.some(e=>ui(e)===o);return q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=Vs.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(Vs.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};Vs.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms","lights"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],a=()=>[eo.FAV_ROW_KEY,...new Set(this._allDevices().map(e=>e.area??""))],n="views"===this._tab?{keys:(this._config.views??[]).map(e=>e.id),isOpen:e=>this._expandedViewIds.has(e),setAll:e=>{this._expandedViewIds=e?new Set((this._config.views??[]).map(e=>e.id)):new Set}}:"devices"===this._tab?{keys:a(),isOpen:e=>this._expandedRooms.has(e),setAll:e=>{this._expandedRooms=e?new Set(a()):new Set}}:{keys:o,isOpen:e=>!!this._openSections[e],setAll:e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t}},r=n.keys.length>0&&n.keys.every(n.isOpen),l=n.keys.length>1,c=e.findIndex(e=>e.id===this._tab);return q`
      <div class="shell">
      ...
      </div>`}};lo.FAV_ROW_KEY="★ Favourites",lo.ROLL_SLOT="Before roll",lo.ROW_MAX=3,lo.DRAG_SLOP=6,lo._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls","sensors","graph_sensors","energy_period","header_chips","area_header_chips"],lo.styles=[rt,Ue,r`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],lo.prototype,"hass",void 0),e([fe()],lo.prototype,"_config",void 0),e([fe()],lo.prototype,"_tab",void 0),e([fe()],lo.prototype,"_newStyleName",void 0),e([fe()],lo.prototype,"_renamingStyle",void 0),e([fe()],lo.prototype,"_advanced",void 0),e([fe()],lo.prototype,"_defaultsOpen",void 0),e([fe()],lo.prototype,"_resetArmed",void 0),e([fe()],lo.prototype,"_viewDeleteArmed",void 0),e([fe()],lo.prototype,"_xcPlacement",void 0),e([fe()],lo.prototype,"_xcRoom",void 0),e([fe()],lo.prototype,"_xcView",void 0),e([fe()],lo.prototype,"_xcAdding",void 0),e([fe()],lo.prototype,"_xcEditIndex",void 0),e([fe()],lo.prototype,"_xcDraft",void 0),e([fe()],lo.prototype,"_xcPreview",void 0),e([fe()],lo.prototype,"_xcDashboards",void 0),e([fe()],lo.prototype,"_xcImportCards",void 0),e([fe()],lo.prototype,"_xcImportLoading",void 0),e([fe()],lo.prototype,"_palettes",void 0),e([fe()],lo.prototype,"_paletteNaming",void 0),e([fe()],lo.prototype,"_paletteName",void 0),e([fe()],lo.prototype,"_expandedViewIds",void 0),e([fe()],lo.prototype,"_openSections",void 0),e([fe()],lo.prototype,"_haPickersReady",void 0),e([fe()],lo.prototype,"_iaAllEntities",void 0),e([fe()],lo.prototype,"_expandedRooms",void 0),e([fe()],lo.prototype,"_designScope",void 0),e([fe()],lo.prototype,"_designGroupBy",void 0),e([fe()],lo.prototype,"_designOpenGroups",void 0),e([fe()],lo.prototype,"_changesOpen",void 0),e([fe()],lo.prototype,"_changesResetArmed",void 0),e([fe()],lo.prototype,"_selectedDeviceId",void 0),e([fe()],lo.prototype,"_conflictsOpen",void 0),e([fe()],lo.prototype,"_flashControl",void 0),e([fe()],lo.prototype,"_snapshots",void 0),e([fe()],lo.prototype,"_snapMenu",void 0),e([fe()],lo.prototype,"_snapName",void 0),e([fe()],lo.prototype,"_snapMsg",void 0),e([fe()],lo.prototype,"_helpOpen",void 0),e([fe()],lo.prototype,"_helpFilter",void 0),e([fe()],lo.prototype,"_helpTopic",void 0),e([fe()],lo.prototype,"_rolled",void 0),e([fe()],lo.prototype,"_styleClipFeedback",void 0),e([fe()],lo.prototype,"_openDiscDropdown",void 0),e([fe()],lo.prototype,"_sciServer",void 0),e([fe()],lo.prototype,"_sciKey",void 0),e([fe()],lo.prototype,"_sciBusy",void 0),e([fe()],lo.prototype,"_sciError",void 0),e([fe()],lo.prototype,"_sciDone",void 0),e([fe()],lo.prototype,"_sciData",void 0),e([fe()],lo.prototype,"_sciRoomMap",void 0),e([fe()],lo.prototype,"_sciOptRooms",void 0),e([fe()],lo.prototype,"_sciOptDevices",void 0),e([fe()],lo.prototype,"_sciOptStock",void 0),e([fe()],lo.prototype,"_sciOptFull",void 0),e([fe()],lo.prototype,"_iconPickerState",void 0),e([fe()],lo.prototype,"_wheel",void 0),lo=eo=e([he("ha-device-dashboard-editor")],lo);let co=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??K}};co.styles=r`
    :host {
      display: block;
