...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function at(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ...
        ${"ble"===i.gen?q`<span class="ds-chip">BLE</span>`:"other"!==i.gen?q`<span class="ds-chip">Gen ${i.gen}</span>`:Z}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),T=z-S||1,E=s[0].t,I=s[s.length-1].t,M=I-E||1,O=e=>(e.t-E)/M*a,D=e=>n-4-(e.v-S)/T*(n-8),R=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=O(s[0]).toFixed(1),$=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),F=Math.max(...A),N=Math.min(...A);let H=A.indexOf(F),j=A.indexOf(N);H<0&&(H=0),j<0&&(j=0);const U=O(s[H]).toFixed(1),W=D(s[H]).toFixed(1),V=O(s[j]).toFixed(1),X=D(s[j]).toFixed(1),Y=y(s[0].t),Q=y((s[0].t+I)/2),K=f/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return q`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(g)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?De([...n.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):q`<div class="device-grid" style="--cols:${o?.columns??this._config.columns??3}">
                ${De(a,e=>e.device_id,e=>this._renderTile(e,this._config.area_styles?.[e.area??""]?.tile_style))}
              </div>`}
        </div>
            ...
            <div class="pill-grp">
              ${t.items.map(t=>q`
                <span class="pill ${d.has(t.key)?"on":""} ${n?"":"dim"}"
                  @click=${()=>(t=>{const i=n?[...e]:[...d],o=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(o)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
    ...
    `,f=q`
      ...
      </div>`}};Es.ROLL_SLOT="Before roll",Es.ROW_MAX=3,Es.DRAG_SLOP=6,Es._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],Es.styles=[st,r`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Es.prototype,"hass",void 0),e([fe()],Es.prototype,"_config",void 0),e([fe()],Es.prototype,"_tab",void 0),e([fe()],Es.prototype,"_styleScope",void 0),e([fe()],Es.prototype,"_cardThemeRoom",void 0),e([fe()],Es.prototype,"_newStyleName",void 0),e([fe()],Es.prototype,"_renamingStyle",void 0),e([fe()],Es.prototype,"_advanced",void 0),e([fe()],Es.prototype,"_defaultsOpen",void 0),e([fe()],Es.prototype,"_resetArmed",void 0),e([fe()],Es.prototype,"_xcPlacement",void 0),e([fe()],Es.prototype,"_xcRoom",void 0),e([fe()],Es.prototype,"_xcAdding",void 0),e([fe()],Es.prototype,"_xcEditIndex",void 0),e([fe()],Es.prototype,"_xcDraft",void 0),e([fe()],Es.prototype,"_xcDashboards",void 0),e([fe()],Es.prototype,"_xcImportCards",void 0),e([fe()],Es.prototype,"_xcImportLoading",void 0),e([fe()],Es.prototype,"_palettes",void 0),e([fe()],Es.prototype,"_paletteNaming",void 0),e([fe()],Es.prototype,"_paletteName",void 0),e([fe()],Es.prototype,"_expandedViewId",void 0),e([fe()],Es.prototype,"_openSections",void 0),e([fe()],Es.prototype,"_expandedRooms",void 0),e([fe()],Es.prototype,"_expandedRoomStyle",void 0),e([fe()],Es.prototype,"_selectedDeviceId",void 0),e([fe()],Es.prototype,"_devPanelAll",void 0),e([fe()],Es.prototype,"_conflictsOpen",void 0),e([fe()],Es.prototype,"_localTweaksCleared",void 0),e([fe()],Es.prototype,"_flashControl",void 0),e([fe()],Es.prototype,"_snapshots",void 0),e([fe()],Es.prototype,"_snapMenu",void 0),e([fe()],Es.prototype,"_snapName",void 0),e([fe()],Es.prototype,"_snapMsg",void 0),e([fe()],Es.prototype,"_helpOpen",void 0),e([fe()],Es.prototype,"_helpFilter",void 0),e([fe()],Es.prototype,"_helpTopic",void 0),e([fe()],Es.prototype,"_rolled",void 0),e([fe()],Es.prototype,"_deviceSearch",void 0),e([fe()],Es.prototype,"_styleClipFeedback",void 0),e([fe()],Es.prototype,"_openDiscDropdown",void 0),e([fe()],Es.prototype,"_iconPickerState",void 0),Es=ks=e([he("ha-device-dashboard-editor")],Es);let Is=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Is.styles=r`
    :host {
      display: block;
