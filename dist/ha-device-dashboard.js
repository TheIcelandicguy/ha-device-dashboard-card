...
`;function je(e,t,i="ts-hero-name"){return Q`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function He(e,t,i,s){return Q`
    <div class="${i}">
      ${je(e,t)}
      <span style="color:var(--sc-text-muted);font-size:.8em">${s}</span>
    </div>`}const We={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const qe=[3,7,11,15,19,23,27];function Ze(e,t,i,s){if("none"===e)return Q``;const r=t?"on":"off";return"flame"===e?Q`${X`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?Q`${X`<svg class="${s} ent-icon-fan ${r}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?Q`${X`<svg class="${s} ent-icon-pulse ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?Q`${X`<svg class="${s} ent-icon-sun ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?Q`${X`<svg class="${s} ent-icon-lightning ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?Q`${X`<svg class="${s} ent-icon-heart ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?Q`${X`<svg class="${s} ent-icon-bulb ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?Q`${X`<svg class="${s} ent-icon-leaf ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?Q`${X`<svg class="${s} ent-icon-flame2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?Q`${X`<svg class="${s} ent-icon-flame3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?Q`${X`<svg class="${s} ent-icon-fan2 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?Q`${X`<svg class="${s} ent-icon-fan3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?Q`${X`<svg class="${s} ent-icon-lightning2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?Q`${X`<svg class="${s} ent-icon-lightning3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?Q`${X`<svg class="${s} ent-icon-bulb2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?Q`${X`<svg class="${s} ent-icon-bulb3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?Q`${X`<svg class="${s} ent-icon-water3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?Q`${X`<svg class="${s} ent-icon-sun2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?Q`${X`<svg class="${s} ent-icon-sun3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?Q`${X`<svg class="${s} ent-icon-moon2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?Q`${X`<svg class="${s} ent-icon-moon3 ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?Q`${X`<svg class="${s} ent-icon-wind ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?Q`${X`<svg class="${s} ent-icon-wind2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?Q`${X`<svg class="${s} ent-icon-wind3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?Q`${X`<svg class="${s} ent-icon-bell ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?Q`${X`<svg class="${s} ent-icon-bell2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?Q`${X`<svg class="${s} ent-icon-bell3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?Q`${X`<svg class="${s} ent-icon-thermometer ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?Q`${X`<svg class="${s} ent-icon-thermometer2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?Q`${X`<svg class="${s} ent-icon-thermometer3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?Q`${X`<svg class="${s} ent-icon-battery ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?Q`${X`<svg class="${s} ent-icon-battery2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?Q`${X`<svg class="${s} ent-icon-battery3 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?Q`${X`<svg class="${s} ent-icon-star ${r}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?Q`${X`<svg class="${s} ent-icon-star2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?Q`${X`<svg class="${s} ent-icon-star3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?Q`${X`<svg class="${s} ent-icon-pulse2 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?Q`${X`<svg class="${s} ent-icon-pulse3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?Q`${X`<svg class="${s} ent-icon-wave2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?Q`${X`<svg class="${s} ent-icon-wave3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?Q`${X`<svg class="${s} ent-icon-wave4 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?Q`${X`<svg class="${s} ent-icon-heart2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?Q`${X`<svg class="${s} ent-icon-leaf2 ${r}" style="${i}" viewBox="0 0 20 20">
...
`,_e=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Ge=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,n]of Object.entries(t)){if(!n?.device_id)continue;if(n.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const o=(n.platform??"").toLowerCase();if("shelly"!==o)continue;const l=n.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??n.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:o,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:n.area_id,platform:o})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],n=s?.via_device_id;if(!n||!r.has(n)||a.has(n))continue;const o=i[n],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),u=!l&&c&&t.integration===r.get(n).integration;if(!p&&!u)continue;const g=r.get(n);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},$e={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function et(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}const r=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:r,label:Je[s],integration:e.integration}}const tt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const it="—";function st(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:it}function rt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:it}function at(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:it}function nt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:it}function ot(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:it}function lt(e){return!Number.isFinite(e)||e<0?it:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function ct(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":it}function dt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:it}function pt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:it}function ut(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:it}function gt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:it}function ht(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:it}function vt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:it}function ft(e){return Number.isFinite(e)?`${Math.round(e)} %`:it}const bt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],mt=Object.fromEntries(bt.map(e=>[e.key,e.label.split(" ")[0]])),xt={co2:"carbon_dioxide",rssi:"signal_strength"};function yt(e){return xt[e]??e}const wt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],kt=["online","offline","power","alerts"];function At(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:n}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),u=110,g=110,h=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=v+h*Math.min(1,Math.max(0,t)),s=u+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),a=u+e*Math.cos(m(i)),n=g+e*Math.sin(m(i)),o=h*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Q`
    ...
    ${r>s?X`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${h}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${h}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:G}`})():G;return Q`
    ...
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:r,profile:a}=e,n=e.tileSensors(t),o=e.getPrimarySwitch(t);return Q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=n.voltage?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${n.voltage.toFixed(0)}</div></div>`:G}
          ${null!=n.current?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${n.current.toFixed(2)}</div></div>`:G}
          ${null!=n.temp?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${n.temp.toFixed(1)}</div></div>`:G}
          ${null!=n.rssi?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${n.rssi}</div></div>`:G}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=n.energy?Q`<span class="ts-hbar-badge">${n.energy.toFixed(2)} kWh</span>`:G}
          ${null!=n.uptime?Q`<span class="ts-hbar-badge">${lt(n.uptime)}</span>`:G}
        </div>
    ...
    <polyline points="${n}" fill="none" stroke="${h}" stroke-width="${g}" stroke-linecap="round"/>`})():G,f=(e,t,i=!1)=>Q`
    ...
    <polygon points="${n} ${d},${p-u} 0,${p-u}" fill="url(#${o})"/>
    <polyline points="${n}" fill="none" stroke="${h}" stroke-width="${g}" stroke-linecap="round"/>`})():G;return Q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.renderTileLowerBody(t,n)}
    </div>`}(e)}}const Ct=140,St=70;function zt(e){const{device:t,isOn:i,accent:s,online:r,hass:a,profile:n}=e,o=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!o)return Q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(o.entityId.startsWith("switch.")||"dimmer"!==n.type&&"rgb"!==n.type)return Q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Ct}" height="${Ct}" viewBox="0 0 ${Ct} ${Ct}"
            ...
            <circle cx="${St}" cy="${St}" r="${St}" fill="url(#${A})" opacity="${i?1:.3}"/>
      ...
      ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${st(l.power)}</div>`:G}
    </div>`}function It(e,t){const{device:i,profile:s,config:r,hass:a,online:n}=e,o=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),u=e.getFirmware(i),g=e.getPower(i),h=e.getSensors(i),v=e.getInputChannels(i),f=o?.isOn??!1,b=void 0!==o?.brightness,m=o&&b&&f?Math.max(1,o.brightness??1):0,x=!!o?.colorModes?.length,y=o?.rgbColor?e.rgbToHex(...o.rgbColor):"#ffffff",w=!!o?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,A="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,C=(S=i.integration,tt[S.toLowerCase()]??S.toUpperCase().slice(0,6));var S,z;switch(t){case"name_row":{const t=r.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=Ze(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?Ze(t,!0,"--ent-spd:1","tile-icon"):Q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?Ze(i,!0,"--ent-spd:1","tile-icon"):Q``}else a=Q``;const p=o?e.renderEntityAnim(o.entityId,f,i.device_id):Q``;return Q`
        <div class="tile-top">
      ...
      `}case"sensors":{if(!h.length)return Q``;const e=h.filter(e=>"primary"===(e.tier??"primary")),t=h.filter(e=>"electrical"===e.tier),i=h.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const a=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return Q`
        ${e.length?Q`
        ...
        ${i.length?Q`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>Q`${t>0?Q`<span class="sep">·</span>`:G}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:G}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=o?a.states[o.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,r=o?.whiteValue??0;return o&&b?Q`
      ...
      `:Q``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?Q`
      ...
      `:Q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Q`
        ...
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=a.states[t.entity_id],r="on"===s?.state,n=s?.attributes?.friendly_name??t.entity_id;return Q`
      ...
      `:Q``}case"power_bar":return e.renderPowerBar(i);case"badges":return Q`
        <div class="tile-bot">
          ${null!=g?Q`<span class="tile-power">${st(g)}</span>`:G}
      ...
      `;default:return Q``}}const Mt=255;function Ot(e){return Q`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:r}=e,a=e.getFirmware(t),n=e.tileSensors(t);return Q`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${a?Q`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:G}
      ${null!=n.rssi?Q`<div class="ds-signal">Wi-Fi: ${ct(n.rssi)} (${n.rssi} dBm)${null!=n.uptime?Q` · Up ${lt(n.uptime)}`:G}</div>`:G}
    ...
    ${s.length>1?Q`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,n=r?.attributes?.friendly_name??s.entity_id,o=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(o)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${n}</span>
                ${isNaN(c)?G:Q`<span class="ds-channel-power">${st(c)}</span>`}
    ...
    ${Et(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Q`
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?Q`<span class="ds-big-power">${st(s.power)}</span>`:G}
    </div>
    ${Et(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return Q`
    <div class="ds-section">
    ...
    ${Et(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/Mt*100);return Q`
    <div class="ds-section">
    ...
    ${Et(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Q`
    <div class="ds-section">
    ...
    ${Et(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Q`
    <div class="ds-section">
    ...
    ${Et(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Q`
    <div class="ds-section">
    ...
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Q`${Et(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return Q`
    ...
    ${r.length?Q`<div class="ds-section ds-alert-row">${r.map(e=>Q`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:G}
    ${Et(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Q`
    <div class="ds-section">
      <div class="ds-section-title">Input Channels</div>
      ${s.length?Q`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,n=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
                <span class="ds-chip ${r?"ds-chip--on":""}">${r?"ON":"OFF"}</span>
                ${n?Q`<span class="ds-ent-age">${n}</span>`:G}
              </div>`})}
        </div>`:Q`<span class="ds-muted">No input channels</span>`}
    </div>
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return Q`
    ${s.length?Q`
      <div class="ds-section">
        <div class="ds-section-title">ADC Inputs</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",r=t?.attributes?.unit_of_measurement??"",a=t?.attributes?.friendly_name??e.entity_id;return Q`<div class="ds-channel-row"><span class="ds-channel-name">${a}</span><span>${s} ${r}</span></div>`})}
      </div>`:G}
    ${r.length?Q`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${r.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id;return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
    ...
    ${Et(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Q`
    ${t?Q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${Et(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    </div>`}function Bt(e){if(!e.getGraphEntities(e.device).length)return Q``;const t=e.getDetailHistoryRange();return Q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function Et(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return Q`
    ${r&&s?Bt(e):G}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${st(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:G}
        ${null!=t.voltage?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${at(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:G}
        ${null!=t.current?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${nt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:G}
        ${null!=t.energy?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${rt(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:G}
        ${null!=t.temp?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${ot(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:G}
      </div>
    </div>`:Q``}(e):G}
    ${!r&&s?Bt(e):G}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return Q``;const s=new Set(e.config.hidden_entities??[]),r=t.entities.filter(e=>!s.has(e.entity_id));return Q`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${r.map(t=>{const s=i.states[t.entity_id],r=s?.attributes?.friendly_name??t.entity_id,a=s?.state??"unknown",n=s?.attributes?.unit_of_measurement??"",o="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===a,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?Q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${ct(r.rssi)} (${r.rssi} dBm)</span></div>`:G}
        ${null!=r.uptime?Q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${lt(r.uptime)}</span></div>`:G}
        ...
        ${i.length?Q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:G}
          ...
          <div class="spark-row">
            ...
            <button class="spark-retry" @click=${e=>{e.stopPropagation(),this._retryGraphData(r,h)}}>↺</button>
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[w]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,M=s[0].t,O=s[s.length-1].t,B=O-M||1,E=e=>(e.t-M)/B*a,T=e=>n-4-(e.v-S)/I*(n-8),R=s.map(e=>`${E(e).toFixed(1)},${T(e).toFixed(1)}`).join(" "),F=E(s[0]).toFixed(1),D=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),N=Math.max(...A),U=Math.min(...A);let j=A.indexOf(N),H=A.indexOf(U);j<0&&(j=0),H<0&&(H=0);const W=E(s[j]).toFixed(1),q=T(s[j]).toFixed(1),Z=E(s[H]).toFixed(1),_=T(s[H]).toFixed(1),V=m(s[0].t),Y=m((s[0].t+O)/2),K=v/B*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&z-S>0;return Q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?G:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                `:G}
                ${"bar"===u?s.map(e=>{const t=Math.max(2,a/s.length-2),i=E(e)-t/2,r=T(e),o=n-4-r;return X`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,o).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):X`
      ...
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const r=e=>{const r=this._trvTempFromEvent(e,s,t,i,a);null!=r&&(this._trvDragTemp=r)},o=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(n,l),s.removeEventListener("pointermove",r),s.removeEventListener("pointerup",o)};s.addEventListener("pointermove",r),s.addEventListener("pointerup",o)}}>
        ...
        ${h>210?X`<path d="${u(210,h,54)}" fill="none" stroke="url(#${y})" stroke-width="8" stroke-linecap="round"/>`:G}
        ${m?X`<circle cx="${m[0]}" cy="${m[1]}" r="5" fill="white" stroke="${x}" stroke-width="2"/>`:G}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:n,hasFan:o}=i,l=e.type;if("relay"===l||"plug"===l)return o?X`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </div>`:Q``}_tileAccent(e,t){const i=this._config.device_styles?.[e.device_id]?.color;if(i)return i;const s=this._config.area_styles?.[t];return s?.accentColor?s.accentColor:this._config.style?.accent_color??"var(--sc-accent)"}_renderTileLowerBody(e,t,i={}){const s=this._getPrimarySwitch(e),r=this._getTrv(e),a=this._getValve(e),n=this._getCover(e),o=s?.isOn??!1;let l=null;const c=()=>l??(l=this._buildTileCtx(e,t,this._tileAccent(e,e.area??""))),d=this._getGraphEntities(e),p=i.skipGraphs?[]:i.skipPowerGraph?d.filter(e=>"power"!==e.dc):d,u=p.length?Q`<div class="ts-lower-section ts-lower-graphs">
          ${this._renderSparklinesFiltered(e,p)}
        </div>`:G,g=void 0!==s?.brightness,h=!!s?.colorModes?.length,v=h&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=h&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),b=g&&o?Math.max(1,s.brightness??1):0,m=s?.whiteValue??0,x=s?this.hass.states[s.entityId]:null,y=x?.attributes?.effect_list??[],w=x?.attributes?.effect??null,k=g?Q`
    ...
    `:G,z=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),I=z.length>1?Q`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:G;return p.length||g||r||a||n||z.length>1?Q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${Ae(o)}
          ...
          ${Re(r,e=>e,e=>It(c,e))}
        </div>`}const h=e.area??"",v=this._tileAccent(e,h);this._getPrimarySwitch(e);return Q`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${Ae(o)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?At(this._buildTileCtx(e,s,v),g):"light-control"===p?zt(this._buildTileCtx(e,s,v)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return He(t,s,"ts-climate","No climate entity");const n="heating"===a.hvacAction,o=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=o&&parseFloat(r.states[o.entity_id]?.state??"")||null;return Q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?Q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:G}
        ${null!=l?Q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:G}
      </div>
      ${a.presetModes.length?Q`<div class="trv-presets">${a.presetModes.map(t=>Q`
        <button class="trv-preset-btn ${a.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(a.entityId,t)}>${(We[t]??"")+t}</button>`)}
      </div>`:G}
    </div>`}(this._buildTileCtx(e,s,v)):"cover-control"===p?function(e){const{device:t,accent:i,online:s}=e,r=e.getCover(t);if(!r)return Q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=r.position??("open"===r.state?100:0),n="opening"===r.state||"closing"===r.state,o=Math.ceil(a/100*qe.length);return Q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${qe.map((e,t)=>X`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<o?"0.85":"0.1"}"/>`)}
        </svg>
        ${n?Q`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:G}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let n;for(const e of Ge)if(n=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),n)break;const o=n?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&Ve.includes(t.attributes?.device_class??"")});if(!n&&!o)return He(t,s,"ts-sensor","No sensor");if(n){const o=r.states[n.entity_id],l=parseFloat(o?.state??""),c=o?.attributes?.unit_of_measurement??"",d=o?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(n.entity_id);const u=e.getGraphPoints(n.entity_id,p);let g=0;if(u.length>=2){const e=Math.floor(u.length/2),t=u.slice(e).reduce((e,t)=>e+t.v,0)/(u.length-e),i=u.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const h=t.entities.filter(e=>{if(e.entity_id===n.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${h.length?Q`<div class="ts-chips" style="margin-top:6px">
          ${h.map(e=>{const t=r.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return Q`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:G}
      </div>`}const l=r.states[o.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",u=c?"#f87171":"var(--sc-online-color)",g=l?.last_changed?e.timeAgo(l.last_changed):"";return Q`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${je(t,s)}
        <span class="ts-sensor-dc">${d}</span>
    ...
    </div>`}(this._buildTileCtx(e,s,v)):"scene-button"===p?function(e){const{device:t,accent:i,online:s,config:r}=e,a=e.getInputChannels(t),n=r.device_styles?.[t.device_id],o=Ze(n?.tile_icon??"pulse",!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?Q`
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?Q`<span class="fav-chip fav-chip-power">${st(r)}</span>`:G}
          </div>
        </div>
        <div class="device-grid fav-grid" style="--cols:${n}">
          ${Re(s,e=>e.device_id,e=>Q`
      ...
      <div class="area-section ${s?"closed":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?Q`<span class="area-power">${st(a)}</span>`:G}
    ...
    `}render(){if(!this._config||!this.hass)return Q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return Q`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${Ae(h)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?Re([...n.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):Q`<div class="device-grid" style="--cols:${r?.columns??this._config.columns??3}">
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Q``;const t=this._getActiveView()?.id;return Q`
      ...
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?_e.map(i=>{const s=(e.currentValue??"none")===i.value,r="none"!==i.value?Qe[i.value]?.[e.isOn?"on":"off"]??t:t;return Q`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?Q`<span class="icon-grid-none">—</span>`:Ze(i.value,e.isOn,`--ent-spd:1;color:${r};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):G}
      </div>`}_iconPicker(e,t,i,s){const r="#f4601e",a=t?Qe[t]?.[i?"on":"off"]??r:r,n=this._iconPickerState?.onSelect===s;return Q`
      ...
      </div>`}_badge(e,t,i){return Q`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,r=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const r=t.size===i.length?void 0:[...t];this._set("areas",r)},a=this._getDiscoveredDevices(),n=e.hidden_devices??[],o=new Map;for(const e of a){const t=e.area??"";o.has(t)||o.set(t,[]),o.get(t).push(e)}const l=[...t.map(e=>e.name)];o.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=Q`
          ...
          ${s?Q`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?Q`<span class="fav-dev-area">${t.area}</span>`:G;return Q`
      ...
      ${l.map(t=>{const i=t||"No Room",a=o.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),u=e.area_styles?.[t]??{},g=[u.accentColor,u.tileBgColor,u.headerBgColor,u.bgColor].filter(Boolean);return Q`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${a.length?Q`<span class="room-count">${a.length}</span>`:G}
          ...
          ${c?Q`
            <div class="room-expanded">
              ...
              <!-- Device list -->
              <div class="room-devices">
                ${a.length?a.map(t=>{const i=n.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id;return Q`
                    <div class="room-device-row ${r?"selected":""}">
            ...
            </div>`:G}`})}`,u=this._selectedDeviceId,g=u?a.find(e=>e.device_id===u):null,h=u&&g?Q`
      ...
      <div class="dev-style-panel">
        ...
        <div class="block-toggles">
          ${Ut.map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Q`<span class="block-tog ${t?"on":""}" @click=${()=>a(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
        ...
        ${g.length?Q`
          ...
          ${g.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,a=r[t.entity_id]?.on??"none",o=r[t.entity_id]?.off??"none",l=r[t.entity_id]?.speed??1;return Q`
        ...
        ${o?.entities.length?Q`
          ...
          <div class="block-toggles">
            ${o.entities.map(e=>{const t=this._config.hidden_entities??[],i=t.includes(e.entity_id),s=this.hass?.states[e.entity_id]?.attributes?.friendly_name??e.entity_id.split(".").pop()??e.entity_id;return Q`<span class="block-tog ${i?"":"on"}"
      ...
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,r)=>{const a=t[s]??r;return Q`
        <div class="color-row">
        ...
        </div>`},s=(i,s,r,a,n,o,l)=>{const c=t[s]??o;return Q`
        <div class="sl-row">
          <span class="color-key">${i}</span>
    ...
    `}_renderViewCard(e,t,i,s,r,a,n,o){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),u=this._countViewMatches(e,n,o),g=n.length,h=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
        ...
        ${l?Q`
          <div class="view-card-body">
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?Q`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:G}
            </div>
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Q`<button class="color-reset" @click=${()=>h("columns",void 0)}>↺</button>`:G}
            </div>
      ...
      </div>`,i=this._config.style?.accent_color??"#f4601e",s=this._dragOrder.filter(e=>!this._hiddenBlocks.has(e)),r=Q`
      ...
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=Ut.find(t=>t.id===e);if(!t)return G;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Q`
      ...
      ${this._sec("tileorder","↕","rgba(244,96,30,0.12)","#f4601e","Tile Block Order",Q`<span class="tag-new">Drag</span>`,r)}`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},r=(e,r,a)=>{const n=t[r]??a;return Q`
        <div class="color-row">
          ...
          ${t[r]?Q`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:G}
        </div>`},a=Q`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?Q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${wt.map(t=>{const i=e.header_chips??kt,s=i.includes(t.key);return Q`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],r=e.length===kt.length&&kt.every(t=>e.includes(t));this._set("header_chips",r?void 0:e)}}>${t.label}</span>`})}
          </div>
      ...
      </div>`,n=(e,i,s)=>{const r=t[i]??s;return Q`
        <div class="color-row">
      ...
      ${n("Power reading","power_color","#fb923c")}`,l=t.font_family??"",c=Q`
      <div class="field">
      ...
      ${this._sec("typography","T","rgba(251,191,36,0.1)","#fbbf24","Typography",G,c)}`}_renderGraphsTab(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},r=Q`
      <div class="field">
      ...
      </div>`,a=e.graph_sensors??[],n=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],o=(e,t,i)=>{const r=s[e]??i,a=!!s[e];return Q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${r}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${a?Q`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:G}
        </div>`},l=Q`
      ...
      <div class="field" style="margin-top:10px">
        ...
        <div class="pill-grp">
          ${bt.map(e=>{const t=a.some(t=>yt(t)===e.key);return Q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>yt(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const r=""===s.trim()?void 0:parseFloat(s),a={...c[e]??{}};void 0===r||isNaN(r)?delete a[i]:a[i]=r;const n={...c,[e]:a};a.min||0===a.min||a.max||0===a.max||delete n[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(n).length?n:void 0})},p=Q`
      ...
      ${Nt.map(i=>{const s=i.items.map(e=>e.key),r=s.filter(e=>t.includes(e)).length,a=s.every(e=>t.includes(e)),n=this._badge(`${r||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),o=Q`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),r=yt(i.key),a=!!bt.find(e=>e.key===r),n=e.graph_sensors??[],o=n.some(e=>yt(e)===r);return Q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${a?Q`<button class="sensor-graph-btn ${o?"on":""}"
  ...
  `],e([ve({attribute:!1})],Ht.prototype,"hass",void 0),e([fe()],Ht.prototype,"_config",void 0),e([fe()],Ht.prototype,"_tab",void 0),e([fe()],Ht.prototype,"_expandedViewId",void 0),e([fe()],Ht.prototype,"_openSections",void 0),e([fe()],Ht.prototype,"_expandedRooms",void 0),e([fe()],Ht.prototype,"_expandedRoomStyle",void 0),e([fe()],Ht.prototype,"_selectedDeviceId",void 0),e([fe()],Ht.prototype,"_deviceSearch",void 0),e([fe()],Ht.prototype,"_hiddenBlocks",void 0),e([fe()],Ht.prototype,"_dragOrder",void 0),e([fe()],Ht.prototype,"_dragOver",void 0),e([fe()],Ht.prototype,"_styleClipFeedback",void 0),e([fe()],Ht.prototype,"_copyAreaOpen",void 0),e([fe()],Ht.prototype,"_copyJson",void 0),e([fe()],Ht.prototype,"_pasteOpen",void 0),e([fe()],Ht.prototype,"_pasteText",void 0),e([fe()],Ht.prototype,"_iconPickerState",void 0),Ht=e([ue("ha-device-dashboard-editor")],Ht),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
