...
`;function Ge(e,t,i="ts-hero-name"){return G`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function $e(e,t,i,s){return G`
    <div class="${i}">
      ${Ge(e,t)}
      <span style="color:var(--sc-text-muted);font-size:.8em">${s}</span>
    </div>`}const Ve={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const Ze=[3,7,11,15,19,23,27];function Xe(e,t,i,s){if("none"===e)return G``;const r=t?"on":"off";return"flame"===e?G`${$`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake"===e?G`${$`<svg class="${s} ent-icon-snowflake" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?G`${$`<svg class="${s} ent-icon-fan ${r}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?G`${$`<svg class="${s} ent-icon-pulse ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"wave"===e?G`${$`<svg class="${s} ent-icon-wave" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?G`${$`<svg class="${s} ent-icon-sun ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?G`${$`<svg class="${s} ent-icon-lightning ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?G`${$`<svg class="${s} ent-icon-heart ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?G`${$`<svg class="${s} ent-icon-bulb ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?G`${$`<svg class="${s} ent-icon-leaf ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?G`${$`<svg class="${s} ent-icon-flame2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?G`${$`<svg class="${s} ent-icon-flame3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake2"===e?G`${$`<svg class="${s} ent-icon-snowflake2" style="${i}" viewBox="0 0 20 20">
    <g class="snow-arms" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"snowflake3"===e?G`${$`<svg class="${s} ent-icon-snowflake3" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?G`${$`<svg class="${s} ent-icon-fan2 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?G`${$`<svg class="${s} ent-icon-fan3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?G`${$`<svg class="${s} ent-icon-lightning2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?G`${$`<svg class="${s} ent-icon-lightning3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?G`${$`<svg class="${s} ent-icon-bulb2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?G`${$`<svg class="${s} ent-icon-bulb3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water2"===e?G`${$`<svg class="${s} ent-icon-water2" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?G`${$`<svg class="${s} ent-icon-water3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?G`${$`<svg class="${s} ent-icon-sun2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?G`${$`<svg class="${s} ent-icon-sun3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?G`${$`<svg class="${s} ent-icon-moon2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?G`${$`<svg class="${s} ent-icon-moon3 ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?G`${$`<svg class="${s} ent-icon-wind ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?G`${$`<svg class="${s} ent-icon-wind2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?G`${$`<svg class="${s} ent-icon-wind3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?G`${$`<svg class="${s} ent-icon-bell ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?G`${$`<svg class="${s} ent-icon-bell2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?G`${$`<svg class="${s} ent-icon-bell3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?G`${$`<svg class="${s} ent-icon-thermometer ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?G`${$`<svg class="${s} ent-icon-thermometer2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?G`${$`<svg class="${s} ent-icon-thermometer3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?G`${$`<svg class="${s} ent-icon-battery ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?G`${$`<svg class="${s} ent-icon-battery2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?G`${$`<svg class="${s} ent-icon-battery3 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?G`${$`<svg class="${s} ent-icon-star ${r}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?G`${$`<svg class="${s} ent-icon-star2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?G`${$`<svg class="${s} ent-icon-star3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?G`${$`<svg class="${s} ent-icon-pulse2 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?G`${$`<svg class="${s} ent-icon-pulse3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?G`${$`<svg class="${s} ent-icon-wave2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?G`${$`<svg class="${s} ent-icon-wave3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?G`${$`<svg class="${s} ent-icon-wave4 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?G`${$`<svg class="${s} ent-icon-heart2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?G`${$`<svg class="${s} ent-icon-leaf2 ${r}" style="${i}" viewBox="0 0 20 20">
...
`,Ke=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Je=["temperature","humidity","carbon_dioxide","illuminance","battery"],et=["motion","door","window","moisture","smoke","gas"];const tt=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function it(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,r=i?new Set([...rt,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,a=i&&t.includeDomains?.length?new Set(t.includeDomains):null,o=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!tt.has(n))continue;if(o?.has(n))continue;if(a&&!a.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(r?.has(h)&&!s?.has(h))continue;const g=p.device_id;if(!d.has(g)){const e=l[g];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const r=e.area_id??p.area_id,a=r?c[r]?.name:void 0;d.set(g,{device_id:g,name:e.name_by_user??e.name??g,area:a,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const u=d.get(g);"shelly"===h&&(u.isShelly=!0,u.integration="shelly");const v=e.states[t];u.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:g,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const r=l[s],a=i?.configuration_url??"",o=r?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=a&&o&&n(a)===n(o),h=!a&&o&&t.integration===d.get(s).integration;if(!c&&!h)continue;const g=d.get(s);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},g=new Map;for(const e of d.keys())for(const t of h(l[e]))g.has(t)||g.set(t,[]),g.get(t).push(e);const u=new Map,v=e=>{let t=e;for(let e=0;u.has(t)&&e<8;e++)t=u.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of g.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),u.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!dt(e)||"devices"===t&&pt(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function st(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const rt=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),at=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),ot=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),nt=new Set(["switch","light","cover","climate","valve"]),lt={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function ct(e){return e.entities.filter(e=>"primary"===st(e)&&!nt.has(e.domain)&&e.domain in lt)}const dt=e=>e.entities.some(e=>"primary"===st(e)&&at.has(e.domain)),pt=e=>e.entities.some(e=>"primary"===st(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&ot.has(e.attributes?.device_class??""));const ht={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},gt={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function ut(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:gt[e]}const vt={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function ft(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function mt(e){const t=ft(e);return t&&t.flat()}const bt={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},yt=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const xt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},wt=["power","temperature","humidity","battery"],kt={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function _t(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}else s="input";return s}const At=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),Ct={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=_t(e);if(At.has(t)){const i=function(e){if(e)for(const t of yt)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:It(e.model??""),label:ht[t],integration:e.integration}}},St={id:"generic",matches:()=>!0,detect:e=>{const t=_t(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":ht[t],integration:e.integration}}},zt=[Ct,St];function Et(e){for(const t of zt)if(t.matches(e))return t.detect(e);return St.detect(e)}function It(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Tt={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Mt(e){return Tt[e.toLowerCase()]??e.toUpperCase().slice(0,6)}const Ot="—";function Dt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Ot}function Bt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Ot}function Rt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Ot}function Pt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Ot}function Ft(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Ot}function Lt(e){return!Number.isFinite(e)||e<0?Ot:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Nt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Ot}function jt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Ot}function Ut(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Ot}function Ht(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Ot}function Wt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Ot}function qt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Ot}function Gt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Ot}function $t(e){return Number.isFinite(e)?`${Math.round(e)} %`:Ot}const Vt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Zt=Object.fromEntries(Vt.map(e=>[e.key,e.label.split(" ")[0]])),Xt={co2:"carbon_dioxide",rssi:"signal_strength"};function Qt(e){return Xt[e]??e}function Yt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(Qt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=Qt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Kt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Jt=["online","offline","power","alerts"],ei=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Light",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],ti=["power","energy","voltage","current","temperature"],ii=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:Jt});function si(){return{...ii,header_chips:[...ii.header_chips??[]]}}function ri(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),r=g+e*Math.sin(b(v)),a=h+e*Math.cos(b(i)),o=g+e*Math.sin(b(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return G`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      <div class="ts-ring-top" style="width:100%">
        ${Ge(t,r,"ts-ring-name")}
        ${l&&e.showEl("toggle")?G`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(l.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Z}
      </div>
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,r=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),a="W"===e.label||"A"===e.label?"left":"right",o=(h+s*("left"===a?-1:1)).toFixed(1),n=(g+8).toFixed(1),l="left"===a?"start":"end";return $`
            ...
            <text x="${o}" y="${n}" font-size="8" fill="${e.color}" text-anchor="${l}" dominant-baseline="hanging" font-family="monospace" font-weight="700" opacity="${i?.95:.5}">${x(e.val,e.label)} ${e.label}</text>`})}
      </svg>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,o):Z}
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=i.max??Math.max(...e),o=r-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/o*(p-2*h),m=e.indexOf(r);v=n(null,m),f=l(r);const b=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return $`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    ${r>s?$`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${u}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${u}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:Z}`})():Z;return G`
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ${Ge(t,r,"ts-spark-name")}
        ${l&&e.showEl("toggle")?G`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(l.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Z}
      </div>
      ${e.showEl("graph")?G`<div class="ts-spark-graph"><svg viewBox="0 0 ${d} ${p}" preserveAspectRatio="none" style="width:100%;height:${p}px;display:block;overflow:visible">${m}</svg></div>`:Z}
      <div class="ts-spark-bottom">
        ...
        ${e.showEl("secondary")?G`<div class="ts-spark-meta">
          ${null!=n.voltage?G`<div class="ts-spark-mrow">${n.voltage.toFixed(1)} <b>V</b></div>`:Z}
          ${null!=n.current?G`<div class="ts-spark-mrow">${n.current.toFixed(2)} <b>A</b></div>`:Z}
          ${null!=n.energy?G`<div class="ts-spark-mrow">${n.energy.toFixed(2)} <b>kWh</b></div>`:Z}
          ${null!=n.temp?G`<div class="ts-spark-mrow">${n.temp.toFixed(1)} <b>°C</b></div>`:Z}
          ${null!=n.rssi?G`<div class="ts-spark-mrow">${n.rssi} <b>dBm</b></div>`:Z}
        </div>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,o,{skipPowerGraph:!0}):Z}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:r,profile:a}=e,o=e.tileSensors(t),n=e.getPrimarySwitch(t);return G`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-main">
          ${Ge(t,r,"ts-hbar-name")}
          <div class="ts-hbar-num" style="color:${i?s:"var(--sc-text-muted)"}">${null!=o.power?o.power.toFixed(o.power<10?1:0):"—"}</div>
          <div class="ts-hbar-unit">watts</div>
        </div>
        ${e.showEl("secondary")?G`<div class="ts-hbar-side">
          ${null!=o.voltage?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${o.voltage.toFixed(0)}</div></div>`:Z}
          ${null!=o.current?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${o.current.toFixed(2)}</div></div>`:Z}
          ${null!=o.temp?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${o.temp.toFixed(1)}</div></div>`:Z}
          ${null!=o.rssi?G`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${o.rssi}</div></div>`:Z}
        </div>`:Z}
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=o.energy?G`<span class="ts-hbar-badge">${o.energy.toFixed(2)} kWh</span>`:Z}
          ${null!=o.uptime&&e.showEl("uptime")?G`<span class="ts-hbar-badge">${Lt(o.uptime)}</span>`:Z}
        </div>
        ${n&&e.showEl("toggle")?G`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(n.entityId,i,t)}>${i?"ON":"OFF"}</button>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Z}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return $`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():Z,f=(e,t,i=!1)=>G`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=n.power?f("Power",Dt(n.power),!0):Z}
      ${e.showEl("secondary")?G`
      ...
      ${null!=n.uptime&&e.showEl("uptime")?f("Uptime",Lt(n.uptime)):Z}
      ${e.showEl("graph")?G`<div class="ts-list-spark">
        <svg viewBox="0 0 ${d} ${p}" preserveAspectRatio="none" style="width:100%;height:${p}px;display:block">${v}</svg>
      </div>`:Z}
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,o,{skipGraphs:!0}):Z}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return $`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${o} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${o}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():Z;return G`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.showEl("graph")?G`<div class="ts-hero-spark"><svg viewBox="0 0 ${d} ${p}" preserveAspectRatio="none" style="width:100%;height:${p}px;display:block">${v}</svg></div>`:Z}
      <div class="ts-hero-foot">
        ${e.showEl("secondary")?G`<div class="ts-chips">
          ${null!=n.voltage?G`<span class="ts-chip">${n.voltage.toFixed(1)} V</span>`:Z}
          ${null!=n.current?G`<span class="ts-chip">${n.current.toFixed(2)} A</span>`:Z}
          ${null!=n.energy?G`<span class="ts-chip">${n.energy.toFixed(2)} kWh</span>`:Z}
          ${null!=n.temp?G`<span class="ts-chip">${n.temp.toFixed(1)} °C</span>`:Z}
          ${null!=n.rssi?G`<span class="ts-chip">${n.rssi} dBm</span>`:Z}
        </div>`:Z}
        ${e.showEl("uptime")?G`<span class="ts-uptime">${n.uptime?Lt(n.uptime):""}</span>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,o):Z}
    </div>`}(e)}}const ai=140,oi=70;function ni(e){const{device:t,isOn:i,accent:s,online:r,hass:a,profile:o}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return G`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==o.type&&"rgb"!==o.type)return G`
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?G`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${Dt(l.power)}</div>`:Z}
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",g=n.whiteValue??0,u=a.states[n.entityId],v=u?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),r=s-Math.min(e,t,i);let a=0;r>0&&(a=s===e?((t-i)/r+6)%6:s===t?(i-e)/r+2:(e-t)/r+4);const o=0===s?0:r/s,l=(e=>e*Math.PI/180)(60*a-90);return{x:oi+62*o*Math.cos(l),y:oi+62*o*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return G`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?G`
        <div class="ts-light-wheel-wrap">
          <svg width="${ai}" height="${ai}" viewBox="0 0 ${ai} ${ai}"
            class="ts-light-wheel" @click=${e=>{if(!d||!n)return;e.stopPropagation();const t=e.currentTarget,i=t.getBoundingClientRect(),s=i.left+i.width/2,r=i.top+i.height/2,o=e.clientX-s,l=e.clientY-r,c=Math.sqrt(o*o+l*l),p=i.width/2-8;if(c>p+8){const e=t.parentElement;return void(e&&(e.classList.remove("ts-wheel-pulse"),e.offsetWidth,e.classList.add("ts-wheel-pulse")))}const h=(180*Math.atan2(l,o)/Math.PI+90+360)%360,g=Math.min(1,c/p),u=e=>{const t=(e+h/60)%6;return 1-g*Math.max(0,Math.min(t,4-t,1))},v=Math.round(255*u(5)),f=Math.round(255*u(3)),m=Math.round(255*u(1));a.callService("light","turn_on",{entity_id:n.entityId,rgb_color:[v,f,m]})}} style="cursor:crosshair">
            <defs>
              <radialGradient id="${_}">
            ...
            <foreignObject x="0" y="0" width="${ai}" height="${ai}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${ai}px;height:${ai}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${oi}" cy="${oi}" r="${oi}" fill="url(#${_})" opacity="${i?1:.3}"/>
            ${k?$`<circle cx="${k.x.toFixed(1)}" cy="${k.y.toFixed(1)}" r="7" fill="${h}" stroke="white" stroke-width="2" filter="drop-shadow(0 0 4px rgba(0,0,0,0.6))"/>`:Z}
          </svg>
        </div>`:Z}
      ${e.showEl("brightness")?G`<div class="ts-light-row">
      ...
      ${f.length>1&&e.showEl("effects")?G`
        <div class="tile-effects">
          ${f.filter(e=>"Off"!==e).map(e=>G`
            <button class="effect-btn ${m===e?"active":""}"
              @click=${()=>a.callService("light","turn_on",{entity_id:n.entityId,effect:m===e?"Off":e})}>${e}</button>`)}
        </div>`:Z}
      ${null!=l.power&&e.showEl("power")?G`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Dt(l.power)}</div>`:Z}
    </div>`}function li(e,t){const{device:i,profile:s,config:r,hass:a,online:o}=e,n=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),g=e.getPower(i),u=e.getSensors(i),v=e.getInputChannels(i),f=n?.isOn??!1,m=void 0!==n?.brightness,b=n&&m&&f?Math.max(1,n.brightness??1):0,y=!!n?.colorModes?.length,x=n?.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",w=!!n?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Mt(i.integration);switch(t){case"name_row":{const t=r.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=Xe(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?Xe(t,!0,"--ent-spd:1","tile-icon"):G``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?Xe(i,!0,"--ent-spd:1","tile-icon"):G``}else a=G``;const p=n?e.renderEntityAnim(n.entityId,f,i.device_id):G``;return G`
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${h?G`<span class="update-dot" title="Firmware update">●</span>`:Z}
          </div>
          ${c?G`
      ...
      `}case"sensors":{if(!u.length)return G``;const e=u.filter(e=>"primary"===(e.tier??"primary")),t=u.filter(e=>"electrical"===e.tier),i=u.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const a=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return G`
        ${e.length?G`
          <div class="tile-stats">
            ${e.map(e=>G`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?G`<span class="stat-lbl">${e.ch}</span>`:Z}
                ${!e.ch&&e.key&&s.has(e.key)?G`<span class="stat-lbl">${e.label}</span>`:Z}
                ${e.value}
              </span>`)}
          </div>`:Z}
        ${t.length?G`
          <div class="tile-elec-wrap">
            ${[...r.entries()].map(([e,t])=>G`
              <div class="tile-elec">
                ${e?G`<span class="stat-lbl">${e}</span>`:Z}
                ${t.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:Z}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:Z}
        ${i.length?G`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:Z}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:Z}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=n?a.states[n.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,r=n?.whiteValue??0;return n&&m?G`
        ...
        ${i.length>1?G`
          <div class="tile-effects" @click=${e=>e.stopPropagation()}>
            ${i.filter(e=>"Off"!==e).map(e=>G`
              <button class="effect-btn ${s===e?"active":""}"
                @click=${t=>{t.stopPropagation();const i=s===e;a.callService("light","turn_on",{entity_id:n.entityId,effect:i?"Off":e})}}>
                ${e}
              </button>`)}
          </div>
        `:Z}
      `:G``}case"cover_controls":return c?G`
      ...
      `:G``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(a.states[t.entity_id]?.state??"")||null,r={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?G`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?G`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:Z}
            ${null!=s?G`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:Z}
          </div>
          ${l.presetModes.length?G`
            <div class="trv-presets">
              ${l.presetModes.map(t=>G`
      ...
      `:G``}case"input_channels":return v.length?G`
      ...
      `:G``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?G`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return Z;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return G`
                <div class="virt-row">
                ...
                </div>`}if("number"===t.domain){const i=parseFloat(t.value),s=t.step??1,r=s<1?String(s).split(".")[1]?.length??1:0;return G`
                <div class="virt-row">
                  <span class="virt-lbl">${t.label}</span>
                  <div class="virt-num">
        ...
        </div>`:G``}case"relay_channels":{const t=i.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id));return t.length<=1?G``:G`
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=a.states[t.entity_id],r="on"===s?.state,o=s?.attributes?.friendly_name??t.entity_id;return G`
              <div class="relay-ch-row">
                <span class="relay-ch-dot ${r?"on":""}"></span>
                ${e.renderEntityAnim(t.entity_id,r,i.device_id)}
                <span class="relay-ch-name">${o}</span>
                <button class="tog sm ${r?"on":"off"}"
                  @click=${i=>e.toggle(t.entity_id,r,i)}>
                  ${r?"ON":"OFF"}
                </button>
              </div>`})}
        </div>`}case"valve_controls":{const t=e.getValve(i);return t?G`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ${e.renderValveDial(t)}
      ...
      `:G``}case"delegated_controls":{if(!r.delegate_controls)return G``;const e=ct(i);return e.length?G`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>G`
            <hdd-delegated .hass=${a} .entity=${e.entity_id} .features=${lt[e.domain]}></hdd-delegated>
          `)}
        </div>`:G``}case"power_bar":return e.renderPowerBar(i);case"badges":return G`
        <div class="tile-bot">
          ${null!=g?G`<span class="tile-power">${Dt(g)}</span>`:Z}
          <div class="tile-badges">
            ${p.map(e=>G`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?G`<span class="type-badge type-${s.type}">${s.label}</span>`:Z}
            ${_?G`<span class="gen-badge gen-${s.gen}">${_}</span>`:Z}
            ${A?G`<span class="int-badge-tile">${A}</span>`:Z}
            ${i.isShelly&&i.ip&&(C=i.ip,/^10\./.test(C)||/^192\.168\./.test(C)||/^172\.(1[6-9]|2\d|3[01])\./.test(C)||/^169\.254\./.test(C))?G`
              <a href="http://${i.ip}" target="_blank" class="tile-ui-link"
                @click=${e=>e.stopPropagation()}>↗</a>
            `:Z}
          </div>
        </div>
      `;default:return G``}var C}const ci=255;function di(e){return G`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:r}=e,a=e.getFirmware(t),o=e.tileSensors(t);return G`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?G`<span class="ds-chip ds-chip--room">${t.area}</span>`:Z}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?G`<span class="ds-chip">${t.model}</span>`:Z}
        ${"other"!==i.gen?G`<span class="ds-chip">Gen ${i.gen}</span>`:Z}
        ${t.ip?G`<span class="ds-chip">${t.ip}</span>`:Z}
      </div>
      ${a?G`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:Z}
      ${null!=o.rssi?G`<div class="ds-signal">Wi-Fi: ${Nt(o.rssi)} (${o.rssi} dBm)${null!=o.uptime?G` · Up ${Lt(o.uptime)}`:Z}</div>`:Z}
      <div class="ds-accent-bar" style="background:${s}"></div>
    </div>`}(e)}
        <div class="ds-body ds-body--${e.profile.type}">
          ${function(e){switch(e.profile.type){case"relay":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"switch"===e.domain);return G`
    ${s.length>1?G`
      <div class="ds-section">
        <div class="ds-section-title">Relay Channels</div>
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,o=r?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return G`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${o}</span>
                ${isNaN(c)?Z:G`<span class="ds-channel-power">${Dt(c)}</span>`}
                <button class="tog ${a?"on":"off"}" @click=${t=>e.toggle(s.entity_id,a,t)}>${a?"ON":"OFF"}</button>
              </div>`})}
        </div>
      </div>`:1===s.length?G`
      <div class="ds-section ds-single-toggle">
        ${(()=>{const t=i.states[s[0].entity_id],r="on"===t?.state;return G`
          <button class="tog ds-big-toggle ${r?"on":"off"}" @click=${t=>e.toggle(s[0].entity_id,r,t)}>${r?"ON":"OFF"}</button>`})()}
      </div>`:Z}
    ${hi(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return G`
    <div class="ds-section ds-plug-hero">
      ${t?G`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:Z}
      ${null!=s.power?G`<span class="ds-big-power">${Dt(s.power)}</span>`:Z}
    </div>
    ${hi(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return G`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?G`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:Z}
      </div>
    </div>
    ${hi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/ci*100);return G`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?G`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:Z}
      </div>
      ${i?.rgbColor?G`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:Z}
    </div>
    ${hi(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return G`
    <div class="ds-section">
      ...
      ${t?G`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?G`<span class="ds-chip">${t.hvacAction}</span>`:Z}
          ${t.presetMode?G`<span class="ds-chip">${t.presetMode}</span>`:Z}
        </div>
        ${null!=t.valvePosition?G`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:Z}
      `:G`<span class="ds-muted">No climate entity</span>`}
    </div>
    ${hi(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return G`
    <div class="ds-section">
      ...
      ${t?G`
        ...
        ${null!=t.position?G`<div class="ds-cover-pos">Position: ${t.position}%</div>`:Z}
        <span class="ds-chip">${t.state}</span>
      `:G`<span class="ds-muted">No cover entity</span>`}
    </div>
    ${hi(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return G`
    <div class="ds-section">
      ...
      ${t?G`
        ...
        ${null!=t.position?G`<div class="ds-cover-pos">Position: ${t.position}%</div>`:Z}
        ${null!=t.temperature?G`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:Z}
        <span class="ds-chip">${t.state}</span>
      `:G`<span class="ds-muted">No valve entity</span>`}
    </div>
    ${hi(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return G`${hi(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return G`
    ${s?(()=>{const e=i.states[s.entity_id],t=parseFloat(e?.state??""),r=e?.attributes?.unit_of_measurement??"";return G`
        <div class="ds-section ds-sensor-hero">
          <span class="ds-big-value">${isNaN(t)?"—":t.toFixed(1)}</span>
          <span class="ds-big-unit">${r}</span>
        </div>`})():Z}
    ${r.length?G`<div class="ds-section ds-alert-row">${r.map(e=>G`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:Z}
    ${hi(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return G`
    <div class="ds-section">
      <div class="ds-section-title">Input Channels</div>
      ${s.length?G`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id,o=s?.last_changed?e.timeAgo(s.last_changed):"";return G`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
                <span class="ds-chip ${r?"ds-chip--on":""}">${r?"ON":"OFF"}</span>
                ${o?G`<span class="ds-ent-age">${o}</span>`:Z}
              </div>`})}
        </div>`:G`<span class="ds-muted">No input channels</span>`}
    </div>
    ${hi(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return G`
    ${s.length?G`
      <div class="ds-section">
        <div class="ds-section-title">ADC Inputs</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",r=t?.attributes?.unit_of_measurement??"",a=t?.attributes?.friendly_name??e.entity_id;return G`<div class="ds-channel-row"><span class="ds-channel-name">${a}</span><span>${s} ${r}</span></div>`})}
      </div>`:Z}
    ${r.length?G`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${r.map(t=>{const s=i.states[t.entity_id],r="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id;return G`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
    ...
    ${hi(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return G`
    ${t?G`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${hi(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return G`
    ${s.length?G`
      <div class="ds-section">
        <div class="ds-section-title">Controls</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.attributes?.friendly_name??e.entity_id;return G`<div class="ds-channel-row"><span class="ds-channel-name">${s}</span><span>${t?.state??"unknown"}</span></div>`})}
      </div>`:Z}
    ${hi(e,{sensors:!1})}`}(e)}}(e)}
          ${function(e){const t=e.customize;return G`
    <details class="ds-customize">
      <summary class="ds-cz-summary">⚙ Customise tile${t.customized?G`<span class="ds-cz-dot" title="This tile has custom visibility"></span>`:Z}</summary>
      <div class="ds-cz-body">
        ...
        ${t.customized?G`<button class="ds-cz-reset" @click=${()=>t.reset()}>↺ Reset to default</button>`:Z}
      </div>
    </details>`}(e)}
        </div>
      </div>
    </div>`}function pi(e){if(!e.getGraphEntities(e.device).length)return G``;const t=e.getDetailHistoryRange();return G`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function hi(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return G`
    ${r&&s?pi(e):Z}
    ${i?function(e){const t=e.tileSensors(e.device);return null!=t.power||null!=t.voltage||null!=t.current||null!=t.energy||null!=t.temp?G`
    <div class="ds-section">
      <div class="ds-section-title">Sensors</div>
      <div class="ds-sensor-grid">
        ${null!=t.power?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${Dt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Z}
        ${null!=t.voltage?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${Rt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:Z}
        ${null!=t.current?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${Pt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Z}
        ${null!=t.energy?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${Bt(t.energy)}</span><span class="ds-sensor-label">${t.energyLabel}</span></div>`:Z}
        ${null!=t.temp?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ft(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Z}
      </div>
    </div>`:G``}(e):Z}
    ${!r&&s?pi(e):Z}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return G``;if(!1===e.config.show_entity_list)return G``;const s=new Set(e.config.hidden_entities??[]),r=t.entities.filter(e=>!s.has(e.entity_id));if(!r.length)return G``;const a=(t,s)=>{const r=i.states[t.entity_id],a=r?.attributes?.friendly_name??t.entity_id,o=r?.state??"unknown",n=r?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===o,d=r?.last_changed?e.timeAgo(r.last_changed):"";return G`
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?G`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),E=z-S||1,I=s[0].t,T=s[s.length-1].t,M=T-I||1,O=e=>(e.t-I)/M*a,D=e=>o-4-(e.v-S)/E*(o-8),B=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),R=O(s[0]).toFixed(1),P=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,F=A[A.length-1],L=F%1==0?`${F}`:F.toFixed(1),N=Math.max(...A),j=Math.min(...A);let U=A.indexOf(N),H=A.indexOf(j);U<0&&(U=0),H<0&&(H=0);const W=O(s[U]).toFixed(1),q=D(s[U]).toFixed(1),V=O(s[H]).toFixed(1),X=D(s[H]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+T)/2),K=f/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return G`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Z:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="none"
                ...
                ${d?$`
                  <line x1="0"        x2="0"        y1="0" y2="${o}" class="spark-tick"/>
                  <line x1="${100}" x2="${100}" y1="0" y2="${o}" class="spark-tick"/>
                  <line x1="${a}"     x2="${a}"     y1="0" y2="${o}" class="spark-tick"/>
                `:Z}
                ${"bar"!==h&&u?$`
                  <polygon points="${B} ${a},${o-4} ${R},${o-4}" fill="url(#${P})"/>
                `:Z}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=O(e)-t/2,r=D(e),n=o-4-r;return $`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="${g}" fill="${_}" opacity="0.75"/>`}):$`
                    <polyline points="${B}" fill="none"
                      stroke="${_}" stroke-width="${l}"
                      stroke-linecap="round" stroke-linejoin="round"/>
                  `}
                <line x1="0" y1="${o}" x2="${a}" y2="${o}"
                  stroke="rgba(255,255,255,0.5)" stroke-width="0.8"
                  stroke-dasharray="${J}" pointer-events="none"
                  vector-effect="non-scaling-stroke"/>
                ${ee?$`
                  <circle cx="${W}" cy="${q}" r="3"
                    fill="${_}" stroke="#1e1e2e" stroke-width="1.2"/>
                  <circle cx="${V}" cy="${X}" r="2.5"
                    fill="#6b7280" stroke="#1e1e2e" stroke-width="1.2"/>
                `:Z}
                <line class="spark-crosshair" x1="0" x2="0" y1="0" y2="${o}" style="display:none"/>
      ...
      <div class="sparklines-block ${i?"exp":""}">
        ${w}
      </div>`}_closeDetailSheet(){this._detailDevice=null}_getBlockOrder(e,t){const i=this._tileBlockOverride.get(e.device_id);if(i)return i;const s=mt(this._config.device_styles?.[e.device_id]?.tile_layout);if(s)return s;const r=mt(this._config.tile_layout);return r||(bt[t.type]??bt.generic)}_trvColor(e){const t=Math.max(0,Math.min(1,e));let i,s,r;if(t<.5){const e=2*t;i=Math.round(74+156*e),s=Math.round(144+-18*e),r=Math.round(217+-183*e)}else{const e=2*(t-.5);i=Math.round(230+-1*e),s=Math.round(126+-69*e),r=Math.round(34+19*e)}return`rgb(${i},${s},${r})`}_renderTrvDial(e){const{minTemp:t,maxTemp:i,targetTemp:s,currentTemp:r,step:a,entityId:o}=e,n=this._trvDragTemp??s??t,l=i-t||1,c=Math.max(0,Math.min(1,(n-t)/l)),d=e=>210+(e-t)/l*300,p=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),70+t*Math.sin((e-90)*Math.PI/180)],h=(e,t,i)=>{const[s,r]=p(e,i),[a,o]=p(t,i);return`M ${s} ${r} A ${i} ${i} 0 ${t-e>180?1:0} 1 ${a} ${o}`},g=this._trvColor(c),u=d(n),[v,f]=p(u,54),m=null!=r?(r-t)/(i-t):null,b=null!=r?p(d(r),54):null,y=null!=m?this._trvColor(m):g,x=`trv-grad-${o.replace(/\W/g,"_")}`;return $`
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const r=e=>{const r=this._trvTempFromEvent(e,s,t,i,a);null!=r&&(this._trvDragTemp=r)},n=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(o,l),s.removeEventListener("pointermove",r),s.removeEventListener("pointerup",n)};s.addEventListener("pointermove",r),s.addEventListener("pointerup",n)}}>
        <defs>
        ...
        ${u>210?$`<path d="${h(210,u,54)}" fill="none" stroke="url(#${x})" stroke-width="8" stroke-linecap="round"/>`:Z}
        ${b?$`<circle cx="${b[0]}" cy="${b[1]}" r="5" fill="white" stroke="${y}" stroke-width="2"/>`:Z}
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const o=(e.clientX-a.left)*(160/a.width),n=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(n-70,o-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const o=(a-210+360)%360;return o>300?null:Math.round(o/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[o,n]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${o} ${n}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,o=(e=>210+e/100*300)(a),[n,l]=i(o,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return $`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${r?$`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:Z}
        <path d="${s(210,510,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${t>0?$`<path d="${s(210,o,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:Z}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:o,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?$`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
          ...
          <circle cx="10" cy="10" r="2" fill="currentColor"/>
        </svg>`:$`<svg class="tile-icon tile-icon-relay ${t?"on":""}" viewBox="0 0 20 20">
        <path d="M11 2L4 11h6l-1 7 7-9h-6l1-7z" fill="currentColor"/>
      </svg>`;if("dimmer"===l||"rgb"===l)return $`<svg class="tile-icon tile-icon-sun ${t?"on":""}" viewBox="0 0 20 20">
        <circle cx="10" cy="10" r="3.5" fill="currentColor"/>
      ...
      </svg>`;if("cover"===l){const e=s??("open"===r?100:"closed"===r?0:50),t="opening"===r||"closing"===r,i=[2,5.5,9,12.5,16],a=Math.ceil(e/100*i.length);return $`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
        ...
        ${i.map((e,t)=>$`<rect x="3" y="${e}" width="14" height="1.8" rx="0.5"
          fill="currentColor" opacity="${t<a?"0.85":"0.2"}"/>`)}
      </svg>`}return"climate"===l||"wall_display"===l?$`<svg class="tile-icon tile-icon-flame ${a?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?$`<svg class="tile-icon tile-icon-valve ${o?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"energy"===l?$`<svg class="tile-icon tile-icon-energy" viewBox="0 0 20 20">
        <polyline class="energy-wave" points="1,10 4,6 7,14 10,4 13,14 16,6 19,10"
          fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>`:"sensor"===l?$`<svg class="tile-icon tile-icon-sensor" viewBox="0 0 20 20">
      ...
      </svg>`:"input"===l||"uni"===l?$`<svg class="tile-icon tile-icon-input ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:$`<svg class="tile-icon tile-icon-generic" viewBox="0 0 20 20">
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return G``;const r=(t?s.on:s.off)??"none";return"none"===r?G``:Xe(r,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i,s){return li(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return G``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return G`
      <div class="power-bar" title="${t.toFixed(0)} W">
        <div class="power-bar-fill" style="width:${Math.min(100,t/i*100)}%"></div>
      </div>`}_tileSensors(e){let t=null,i=null,s=null,r=null,a=null,o=null,n=null;for(const l of e.entities){if("sensor"!==l.domain)continue;const e=this.hass.states[l.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const c=e.attributes.device_class??"",d=parseFloat(e.state);"power"===c&&null==t&&(t=isNaN(d)?null:d),"voltage"===c&&null==i&&(i=isNaN(d)?null:d),"current"===c&&null==s&&(s=isNaN(d)?null:d),"temperature"===c&&null==r&&(r=isNaN(d)?null:d),"energy"===c&&null==a&&(a=isNaN(d)?null:d);const p=l.entity_id;(p.includes("rssi")||p.includes("signal"))&&(o=isNaN(d)?null:d),p.includes("uptime")&&(n=isNaN(d)?null:d)}let l="Energy";const c=this._config.device_styles?.[e.device_id]?.energy_entity;if(c){const e=this.hass.states[c],t=e&&"unavailable"!==e.state&&"unknown"!==e.state?parseFloat(e.state):NaN;a=isNaN(t)?null:t}const d=this._energyPeriod(e);if("total"!==d){const t=c??this._energyEntitiesFor(e)[0];if(t){const e=this._periodEnergyValue(t,d);e.failed||(a=e.kwh,l=this._energyPeriodLabel(d))}}return{power:t,voltage:i,current:s,temp:r,energy:a,energyLabel:l,rssi:o,uptime:n}}_deviceMetric(e,t){if("power"===t)return this._getPower(e);if("energy"===t)return this._deviceEnergy(e).value;const i={temperature:"temperature",humidity:"humidity",illuminance:"illuminance"};for(const s of e.entities){if("sensor"!==s.domain)continue;const e=this.hass.states[s.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const r=parseFloat(e.state);if(isNaN(r))continue;const a=e.attributes.device_class??"";if("rssi"===t){if("signal_strength"===a||s.entity_id.includes("rssi"))return r}else if(a===i[t])return r}return null}_deviceEnergy(e){const t=this._energyEntitiesFor(e);if(!t.length)return{value:null,period:"total"};const i=this._energyPeriod(e);if("total"===i)return{value:this._deviceEnergyLifetime(e),period:"total"};let s=0,r=!1;for(const a of t){const t=this._periodEnergyValue(a,i);if(t.failed)return{value:this._deviceEnergyLifetime(e),period:"total"};null!=t.kwh&&(s+=t.kwh,r=!0)}return r?{value:s,period:i}:{value:null,period:i}}_deviceEnergyLifetime(e){let t=0,i=!1;for(const s of this._energyEntitiesFor(e)){const e=this.hass.states[s];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const r=parseFloat(e.state);isNaN(r)||(t+=r,i=!0)}return i?t:null}_headerEnergyAgg(e){const t=e.map(e=>({d:e,e:this._deviceEnergy(e)})).filter(e=>null!=e.e.value);if(!t.length)return null;const i=new Set(t.map(e=>e.e.period));if(1===i.size){const e=[...i][0];return{value:t.reduce((e,t)=>e+t.e.value,0),label:this._energyPeriodLabel(e)}}let s=0,r=!1;for(const{d:e}of t){const t=this._deviceEnergyLifetime(e);null!=t&&(s+=t,r=!0)}return r?{value:s,label:"Energy"}:null}_formatHeaderMetric(e,t){switch(e){case"power":return Dt(t);case"energy":return Bt(t);case"temperature":return Ft(t);case"humidity":return Wt(t);case"illuminance":return qt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(t)}}_devicesWithUpdates(e){return e.map(e=>({device:e,fw:this._getFirmware(e)})).filter(e=>!!e.fw?.newVersion&&e.fw.newVersion!==e.fw.current)}_headerMetricAggs(e,t){const i={temperature:"temperature",humidity:"humidity",illuminance:"illuminance"},s=t.filter(e=>i[e]),r=t.includes("power"),a=t.includes("rssi"),o=new Map,n=(e,t)=>{const i=o.get(e)??{sum:0,count:0};i.sum+=t,i.count++,o.set(e,i)};for(const t of e){if(r){const e=this._getPower(t);null!=e&&n("power",e)}if(!s.length&&!a)continue;const e=new Set;for(const r of t.entities){if("sensor"!==r.domain)continue;const t=this.hass.states[r.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const o=parseFloat(t.state);if(isNaN(o))continue;const l=t.attributes.device_class??"";!a||e.has("rssi")||"signal_strength"!==l&&!r.entity_id.includes("rssi")||(e.add("rssi"),n("rssi",o));for(const t of s)e.has(t)||l!==i[t]||(e.add(t),n(t,o))}}return o}_renderHeaderChips(e){const t=this._config.header_chips??Jt,i=e.filter(e=>this._isOnline(e)).length,s=this._headerMetricAggs(e,t),r=e=>t=>{t.stopPropagation(),this._cloudDetailOpen=this._cloudDetailOpen===`m:${e}`?null:`m:${e}`};return G`
      <div class="dash-stats">
        ${t.map(t=>{const a=Kt.find(e=>e.key===t);if(!a)return Z;let o="",n="metric";if("online"===t)o=`${i}/${e.length} online`,n="online";else if("offline"===t){const t=e.length-i;if(!t)return Z;o=`${t} offline`,n="offline-count"}else if("alerts"===t){const t=e.filter(e=>this._getAlerts(e).length>0).length;if(!t)return Z;o=`⚠ ${t}`,n="alerts-count"}else if("updates"===t){const t=this._devicesWithUpdates(e).length;if(!t)return Z;o=`⬆ ${t} update${t>1?"s":""}`,n="updates-count"}else if("energy"===t){const t=this._headerEnergyAgg(e);if(!t)return Z;o=`${t.label} ${this._formatHeaderMetric("energy",t.value)}`}else{const e=s.get(t);if(!e||!e.count)return Z;const i="sum"===a.agg?e.sum:e.sum/e.count;o="power"===t?this._formatHeaderMetric(t,i):`${a.label} ${this._formatHeaderMetric(t,i)}`,"power"===t&&(n="power")}const l=this._cloudDetailOpen===`m:${t}`;return G`<span class="stat ${n} ${l?"active":""}" @click=${r(t)}>${o}</span>`})}
      </div>`}_renderHeaderDetail(e){const t=this._cloudDetailOpen;if(!t?.startsWith("m:"))return G``;const i=t.slice(2),s=Kt.find(e=>e.key===i);if(!s)return G``;let r=[],a="cloud-on";if("online"===i?r=e.filter(e=>this._isOnline(e)).map(e=>({name:e.name,value:""})):"offline"===i?(r=e.filter(e=>!this._isOnline(e)).map(e=>({name:e.name,value:""})),a="cloud-off"):"alerts"===i?(r=e.map(e=>({d:e,a:this._getAlerts(e)})).filter(e=>e.a.length).sort((e,t)=>t.a.length-e.a.length).map(e=>({name:e.d.name,value:e.a.join(", ")})),a="cloud-off"):r="updates"===i?this._devicesWithUpdates(e).map(e=>({name:e.device.name,value:`${e.fw.current} → ${e.fw.newVersion}`})):e.map(e=>({d:e,v:this._deviceMetric(e,i)})).filter(e=>null!=e.v).sort((e,t)=>t.v-e.v).map(e=>({name:e.d.name,value:this._formatHeaderMetric(i,e.v)})),!r.length)return G``;const o="energy"===i?this._headerEnergyAgg(e)?.label??s.label:s.label;return G`
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        <div class="cloud-detail-hdr ${a}">● ${o} — ${r.length} device${r.length>1?"s":""}</div>
        <div class="metric-list">
          ${r.map(e=>G`
            <div class="metric-row">
              <span class="metric-name">${e.name}</span>
              ${e.value?G`<span class="metric-val">${e.value}</span>`:Z}
            </div>`)}
        </div>
      </div>`}_tileAccent(e,t){const i=this._config.device_styles?.[e.device_id]?.color;if(i)return i;const s=this._profileStyle(e)?.color;if(s)return s;const r=this._config.area_styles?.[t];return r?.accentColor?r.accentColor:this._styleTokens().accent_color??"var(--sc-accent)"}_renderTileLowerBody(e,t,i={}){const s=this._getPrimarySwitch(e),r=this._getTrv(e),a=this._getValve(e),o=this._getCover(e),n=s?.isOn??!1;let l=null;const c=()=>l??(l=this._buildTileCtx(e,t,this._tileAccent(e,e.area??""))),d=this._getGraphEntities(e),p=i.skipGraphs?[]:i.skipPowerGraph?d.filter(e=>"power"!==e.dc):d,h=p.length?G`<div class="ts-lower-section ts-lower-graphs">
          ${this._renderSparklinesFiltered(e,p)}
        </div>`:Z,g=void 0!==s?.brightness,u=!!s?.colorModes?.length,v=u&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=u&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=g&&n?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,x=y?.attributes?.effect_list??[],w=y?.attributes?.effect??null,k=g?G`
    ...
    `:Z,S=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),z=S.length>1?G`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:Z;return p.length||g||r||a||o||S.length>1?G`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${o}" style=${_e(l)}
          ...
          ${De(a,e=>e.join("+"),e=>1===e.length?li(c,e[0]):G`<div class="tile-row">${e.map(e=>li(c,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return G`<div class="${`tile tile-${o} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?ri(this._buildTileCtx(e,s,y),m):"light-control"===v?ni(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return $e(t,s,"ts-climate","No climate entity");const o="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return G`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ${Ge(t,s)}
        ${e.showEl("heating_badge")?G`<div style="display:flex;align-items:center;gap:6px">
          ${o?G`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:G`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>`:Z}
      </div>
      ${e.showEl("dial")?e.renderTrvDial(a):Z}
      ${e.showEl("adjust_buttons")?G`<div class="trv-dial-btns">
        <button class="trv-step" @click=${()=>e.adjustTrvTemp(a,-1)}>−</button>
        <span class="trv-flame">${o?"🔥":""}</span>
        <button class="trv-step" @click=${()=>e.adjustTrvTemp(a,1)}>+</button>
      </div>`:Z}
      ${e.showEl("stats")?G`<div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?G`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:Z}
        ${null!=l?G`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:Z}
      </div>`:Z}
      ${e.showEl("presets")&&a.presetModes.length?G`<div class="trv-presets">${a.presetModes.map(t=>G`
        <button class="trv-preset-btn ${a.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(a.entityId,t)}>${(Ve[t]??"")+t}</button>`)}
      </div>`:Z}
    </div>`}(this._buildTileCtx(e,s,y)):"cover-control"===v?function(e){const{device:t,accent:i,online:s}=e,r=e.getCover(t);if(!r)return G`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=r.position??("open"===r.state?100:0),o="opening"===r.state||"closing"===r.state,n=Math.ceil(a/100*Ze.length);return G`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-cover-top">
        ${Ge(t,s)}
        ${e.showEl("position_pct")?G`<span class="ts-cover-pct" style="color:${i}">${Math.round(a)}%</span>`:Z}
      </div>
      ${e.showEl("shutter_graphic")?G`<div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${Ze.map((e,t)=>$`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<n?"0.85":"0.1"}"/>`)}
        </svg>
        ${o&&e.showEl("moving_label")?G`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:Z}
      </div>`:Z}
      ${e.showEl("buttons")?G`<div class="ts-cover-btns">
    ...
    </div>`}(this._buildTileCtx(e,s,y)):"sensor-card"===v?function(e){const{device:t,accent:i,online:s,hass:r,config:a}=e;let o;for(const e of Je)if(o=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=r.states[t.entity_id];return i&&i.attributes?.device_class===e}),o)break;const n=o?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return t&&et.includes(t.attributes?.device_class??"")});if(!o&&!n)return $e(t,s,"ts-sensor","No sensor");if(o){const n=r.states[o.entity_id],l=parseFloat(n?.state??""),c=n?.attributes?.unit_of_measurement??"",d=n?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(o.entity_id);const h=e.getGraphPoints(o.entity_id,p);let g=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const u=t.entities.filter(e=>{if(e.entity_id===o.entity_id||"sensor"!==e.domain)return!1;const t=r.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return G`
      <div class="ts-sensor" style="--ts-accent:${i}">
        <div class="ts-sensor-top">
          ${Ge(t,s)}
          <span class="ts-sensor-dc">${d}</span>
        </div>
        ${e.showEl("primary_value")?G`<div class="ts-sensor-main">
          <span class="ts-sensor-val" style="color:${i}">${isNaN(l)?n?.state:l%1==0?l:l.toFixed(1)}</span>
          <span class="ts-sensor-unit">${c}</span>
        </div>`:Z}
        ${e.showEl("trend")&&h.length>=2?G`
          <div class="ts-sensor-trend ${g>0?"up":g<0?"down":""}">
            ${g>0?"↑":g<0?"↓":"→"} ${Math.abs(g)<.05?"stable":Math.abs(g).toFixed(1)+" "+c+"/hr"}
          </div>`:Z}
        ${e.showEl("graph")?G`<div class="ts-sensor-spark">
          ${e.renderSparklinesFiltered(t,e.getGraphEntities(t).filter(e=>e.entityId===o.entity_id))}
        </div>`:Z}
        ${e.showEl("secondary")&&u.length?G`<div class="ts-chips" style="margin-top:6px">
          ${u.map(e=>{const t=r.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return G`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:Z}
      </div>`}const l=r.states[n.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",h=c?"#f87171":"var(--sc-online-color)",g=l?.last_changed?e.timeAgo(l.last_changed):"";return G`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${Ge(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      </div>
      ${e.showEl("primary_value")?G`<div class="ts-sensor-binary-state" style="color:${h}">
        <span class="ts-sensor-binary-dot" style="background:${h}"></span>
        ${p}
      </div>`:Z}
      ${g?G`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${g}</div>`:Z}
    </div>`}(this._buildTileCtx(e,s,y)):"scene-button"===v?function(e){const{device:t,accent:i,online:s,config:r}=e,a=e.getInputChannels(t),o=r.device_styles?.[t.device_id],n=Xe(o?.tile_icon??"pulse",!0,`--ent-spd:${o?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?G`
      <div class="ts-scene" style="--ts-accent:${i}">
        <div class="ts-scene-top">
          ${Ge(t,s)}
        </div>
        ${e.showEl("input_rows")?G`<div class="tile-inputs">
          ${a.map(t=>G`
            <div class="input-row ${t.isButton?"btn-mode":t.isOn?"active":""}">
              <span class="${t.isButton?"input-btn-dot":"input-row-dot"}"></span>
              <span class="input-row-name">${t.label}</span>
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      ${e.showEl("icon")?G`<div class="ts-scene-icon-wrap">${n}</div>`:Z}
      ${e.showEl("name")?G`<div class="ts-scene-name">${t.name}</div>`:Z}
      ${c&&e.showEl("timestamp")?G`<div class="ts-scene-time">${c}</div>`:Z}
      <div class="ts-scene-ripple"></div>
    </div>`}(this._buildTileCtx(e,s,y)):Z}
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(gi._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return G``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return G``;const r=s.reduce((e,t)=>e+(this._getPower(t)??0),0),a=s.filter(e=>this._isOnline(e)).length,o=this._config.columns??3,n=this._config.area_styles?.Favourites?.tile_style;return G`
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?G`<span class="fav-chip fav-chip-power">${Dt(r)}</span>`:Z}
          </div>
        </div>
        <div class="device-grid fav-grid" style="--cols:${o}">
          ${De(s,e=>e.device_id,e=>G`
            <div class="fav-tile-wrap">
              ${e.area?G`<span class="tile-room-badge">${e.area}</span>`:Z}
              ${this._renderTile(e,n)}
            </div>
          `)}
        </div>
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,r=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(ti),a=e=>r.has(e),o={},n=(e,t)=>{o[e]||(o[e]={sum:0,count:0}),o[e].sum+=t,o[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",r=ei.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));r&&a(r.key)&&n(r.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ei){if("energy"===t.key&&a("energy")&&"total"!==l){let i=0,s=!1,r=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?r=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(r){o.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",o.energy.sum)});continue}if(s||o.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?Bt(i):"…"})}continue}const i=o[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return Dt(t);case"energy":return Bt(t);case"voltage":return Rt(t);case"current":return Pt(t);case"temperature":return Ft(t);case"humidity":return Wt(t);case"co2":return Gt(t);case"illuminance":return qt(t);case"battery":return $t(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),r=this._config.area_styles?.[t]?.header_chips,a=void 0!==s?new Set(s):void 0!==r?new Set(r):new Set(ti),o=[];for(const e of ei)i.has(e.key)&&o.push({key:e.key,label:e.label,visible:a.has(e.key)});return o}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",r=ei.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));r&&t.add(r.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,r=(t,s)=>{const r=new Set(i.filter(e=>e.visible).map(e=>e.key));s?r.add(t):r.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>r.has(e)))};return G`
      ...
      <div class="area-section ${s?"closed":""} ${a?.bg_image&&"ambient"===a.bg_image_mode?"area-bg-ambient":""}" style=${_e(n)}>
        ...
        ${s?Z:G`
          ...
          <div class="device-grid" style="--cols:${o}">
            ${De(t,e=>e.device_id,e=>this._renderTile(e,l))}
          </div>
        `}
      </div>
    `}render(){if(!this._config||!this.hass)return G``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return G`
        <ha-card>
        ...
        </ha-card>`;const s=this._getDevices();if(!s.length)return G`
        <ha-card>
          <div class="empty">
            <p>No devices found.</p>
            <p class="hint">No devices found matching your filters.</p>
          </div>
        </ha-card>`;const r=this._getActiveView(),a=r?this._applyViewFilter(s,r):s,o=this._groupByArea(a),n=!r||!0===r.show_favourites,l=!r||!1!==r.show_rooms,c=!0===this._config.header_show_cloud?Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")):[],d=c.filter(e=>"on"===e.state),p=c.filter(e=>"off"===e.state),h=c.filter(e=>"unavailable"===e.state),g=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),u=this._buildCardStyles(),v=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,f=v?di(this._buildTileCtx(v,this._profile(v),this._tileAccent(v,v.area??""))):Z,m=G`
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?De([...o.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):G`<div class="device-grid" style="--cols:${r?.columns??this._config.columns??3}">
                ${De(a,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
        ${this._renderExtraCards(this._config.footer_cards)}
      </ha-card>
    `;return m}_renderExtraCards(e){return e?.length?G`
      <div class="extra-cards">
        ${e.map(e=>G`<hdd-card .hass=${this.hass} .config=${e}></hdd-card>`)}
      </div>`:G``}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return G``;const t=e.filter(e=>ct(e).length>0).length;return t?G`
    ...
    `],e([ve({attribute:!1})],fi.prototype,"hass",void 0),e([ve({type:Boolean})],fi.prototype,"preview",void 0),e([fe()],fi.prototype,"_config",void 0),e([fe()],fi.prototype,"_closedAreas",void 0),e([fe()],fi.prototype,"_entityListOpen",void 0),e([fe()],fi.prototype,"_graphData",void 0),e([fe()],fi.prototype,"_periodEnergy",void 0),e([fe()],fi.prototype,"_periodEnergyErrAt",void 0),e([fe()],fi.prototype,"_valveDragPos",void 0),e([fe()],fi.prototype,"_trvDragTemp",void 0),e([fe()],fi.prototype,"_cloudDetailOpen",void 0),e([fe()],fi.prototype,"_detailDevice",void 0),e([fe()],fi.prototype,"_detailHistoryRange",void 0),e([fe()],fi.prototype,"_activeViewId",void 0),e([fe()],fi.prototype,"_delegateNoticeDismissed",void 0),e([fe()],fi.prototype,"_tileBlockOverride",void 0),e([fe()],fi.prototype,"_tileChipOverride",void 0),e([fe()],fi.prototype,"_areaHeaderOverride",void 0),e([fe()],fi.prototype,"_tileShowGraphsOverride",void 0),e([fe()],fi.prototype,"_areaCustomizeOpen",void 0),fi=gi=e([he("ha-device-dashboard")],fi);const mi=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),mi(e,t);return!0},bi=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},yi=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),ki(t)}};function xi(e){void 0!==this._$AN?(bi(this),this._$AM=e,yi(this)):this._$AM=e}function wi(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)mi(s[e],!1),bi(s[e]);else null!=s&&(mi(s,!1),bi(s));else mi(this,e)}const ki=e=>{e.type==be&&(e._$AP??=wi,e._$AQ??=xi)};class _i extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),yi(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(mi(this,e),bi(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ai=new WeakMap,Ci=ye(class extends _i{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ai.get(t);void 0===i&&(i=new WeakMap,Ai.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ai.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Si=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Te(e),this.key=t),i}}),zi=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Ei;const Ii=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Ti=!1;const Mi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Oi=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Di=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Bi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Ri=Ei=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=Yt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of je)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Z}connectedCallback(){super.connectedCallback(),function(){if(Ti||"undefined"==typeof document)return;const e=Ii.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),Ti=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;try{if(window.matchMedia("(min-width: 1600px)").matches){const e=s;!1===e.large&&"function"==typeof e._enlarge&&e._enlarge()}}catch{}const a="ha-device-dashboard-editor-fix";if(!r.getElementById(a)){const e=document.createElement("style");e.id=a,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const o=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),a=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(a,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);o(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),o(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),o(a,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return G`
      ...
      </span>`}_chipPicker(e,t,i,s){const r=t??[],a=void 0!==e,o=Mi.flatMap(e=>e.items.map(e=>e.key)),n=new Set(a?e:r.length?r:o);return G`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${a?"Custom selection":`Inheriting from ${i}`}</span>
          ${this._selAllNone(()=>s([...o]),()=>s([]))}
          ${a?G`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:G`<button class="color-reset" @click=${()=>s([...n])}>Customize</button>`}
        </div>
        ${Mi.map(t=>G`
          <div class="chip-picker-grp">
            ...
            <div class="pill-grp">
              ${t.items.map(t=>G`
                <span class="pill ${n.has(t.key)?"on":""} ${a?"":"dim"}"
                  @click=${()=>(t=>{const i=a?[...e]:[...n],r=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(r.length?r:void 0)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
      </div>`}_clearDeviceStyle(e){const t={...this._config.device_styles??{}};delete t[e],this._set("device_styles",Object.keys(t).length?t:void 0)}async _prepareImageForEmbed(e,t={}){const i=t.maxDim??1920,s=t.targetBytes??409600,r=await createImageBitmap(e,{imageOrientation:"from-image"}),a=Math.min(1,i/Math.max(r.width,r.height)),o=Math.max(1,Math.round(r.width*a)),n=Math.max(1,Math.round(r.height*a)),l=document.createElement("canvas");l.width=o,l.height=n;const c=l.getContext("2d");if(!c)throw r.close(),new Error("canvas 2d context unavailable");c.drawImage(r,0,0,o,n),r.close();let d=.85,p=l.toDataURL("image/jpeg",d);for(;.75*p.length>s&&d>.4;)d-=.1,p=l.toDataURL("image/jpeg",d);return l.width=0,l.height=0,p}async _handleBgUpload(e,t,i){const s=e.target,r=s.files?.[0];if(r){try{t(await this._prepareImageForEmbed(r,i))}catch(e){console.warn("[editor] failed to process image",r.name,e),this._showStyleFeedback(`Couldn't process "${r.name}" — try a /local/… URL instead`)}s.value=""}}_renderBgImagePicker(e,t,i,s,r,a,o,n){const l=n?.maxDim??720,c=n?.showFit??!0;return G`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${i?.startsWith("data:")?G`<span class="bg-embedded-note">Embedded · ${this._estimateImageSize(i)}</span>`:G`<input type="text" class="inline-text" placeholder="/local/image.png or https://…"
                .value=${i??""}
                @change=${e=>{const t=e.target.value.trim();r(t||void 0)}}/>`}
          ${i?G`<button class="color-reset" @click=${o}>↺</button>`:Z}
          ${this._styleClipFeedback?G`<span class="clip-feedback">${this._styleClipFeedback}</span>`:Z}
        </div>
        ${i&&c?G`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
            ${["cover","contain","stretch"].map(e=>G`
              <span class="pill ${(s??"cover")===e?"on":""}"
                @click=${()=>a(e)}>${e[0].toUpperCase()+e.slice(1)}</span>`)}
          </div>`:Z}
        ${i?n?.extra??Z:Z}
      </div>`}_handleCardBgUpload(e){return this._handleBgUpload(e,e=>this._set("card_bg_image",e))}_handleTileBgUpload(e){return this._handleBgUpload(e,e=>this._set("style",{...this._config.style??{},tile_bg_image:e}),{maxDim:720})}_sec(e,t,i,s,r,a,o){const n=this._openSections[e];return G`
      ...
      </div>`}_badge(e,t,i){return G`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,r=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const r=t.size===i.length?void 0:[...t];this._set("areas",r)},a=this._getDiscoveredDevices(),o=e.hidden_devices??[],n=new Map;for(const e of a){const t=e.area??"";n.has(t)||n.set(t,[]),n.get(t).push(e)}const l=[...t.map(e=>e.name)];n.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=n.get("")?.length??0,h=G`
      <div class="rooms-toolbar">
        ...
        <div class="toolbar-group">
          ...
          <div class="pill-grp">
            ${[["name","Name"],["power","Power"],["online","Online"],["area","Room"]].map(([t,i])=>G`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>a.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),r=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return G`
          <div class="room-row fav-room-row">
            ...
            ${r?G`<button class="room-reset-btn" title="Set Favourites style to default"
          ...
          ${s?G`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?G`<span class="fav-dev-area">${t.area}</span>`:Z;return G`
                    <div class="room-device-row ${r?"selected":""}">
                      ${a}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?G`<span class="dev-style-dot"></span>`:Z}
                      <label class="sw">
                      ...
                      ${s?G`<button class="room-reset-btn" title="Set device style to default"
      ...
      ${l.map(t=>{const i=t||"No Room",a=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return G`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${a.length?G`<span class="room-count">${a.length}</span>`:Z}
            <label class="sw"><input type="checkbox" .checked=${l}
              @change=${()=>r(t)}>
              <span class="sw-t"></span><span class="sw-b"></span></label>
            ${d?G`<button class="room-reset-btn" title="Set room style to default"
          ...
          ${c?G`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${a.length?a.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id;return G`
                    <div class="room-device-row ${r?"selected":""}">
      ...
      <div class="xc-list">
        ${e.length?e.map((t,i)=>G`
          ...
          </div>`):G`<div class="dp-hint-inline">No cards here yet.</div>`}
      </div>
      ${this._xcAdding||null!==this._xcEditIndex?Z:G`
      ...
      ${this._xcAdding?G`
        <div class="field">
          ...
          <select @change=${e=>this._xcLoadCardsFrom(e.target.value)}>
            ...
            ${(this._xcDashboards??[]).map(e=>G`<option value=${e.url_path}>${e.title}</option>`)}
          </select>
          ${this._xcImportLoading?G`<div class="dp-hint-inline">Loading cards…</div>`:Z}
          ${this._xcImportCards?this._xcImportCards.length?G`
            <div class="xc-import-list">
              ${this._xcImportCards.map(e=>G`
                <button class="xc-import-row" title="Use this card" @click=${()=>this._setXcDraft({...e.config})}>${e.label}</button>`)}
            </div>`:G`<div class="dp-hint-inline">No cards found on that dashboard.</div>`:Z}
        </div>
        <div class="field">
          ...
          <select @change=${e=>{const t=e.target.value;this._setXcDraft(t?{type:t}:{})}}>
            ...
            ${this._cardTypeOptions().map(e=>G`<option value=${e.value}>${e.label}</option>`)}
          </select>
      ...
      ${this._xcDraft?G`
        <div class="field">
          ...
          ${Si(this._xcDraftKey,i?G`
            <ha-yaml-editor .hass=${this.hass} .defaultValue=${this._xcDraft}
              @value-changed=${e=>{e.stopPropagation(),!1!==e.detail?.isValid&&(this._xcLatest=e.detail.value)}}></ha-yaml-editor>`:G`
        ...
        </div>`:Z}`,r=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):Z;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",r,s)}_renderCheckDropdown(e,t,i,s,r,a){const o=this._openDiscDropdown===e,n=new Set(s),l=n.size;return G`
      <div class="field">
        <div class="field-lbl">${t}</div>
        <button class="check-dd-btn ${o?"open":""}"
          @click=${()=>{this._openDiscDropdown=o?null:e}}>
          ...
          <div class="check-dd-panel">
            ${i.length?i.map(e=>G`
              <label class="check-dd-row">
                ...
                <span>${e.label}</span>
              </label>`):G`<div class="check-dd-empty">Nothing discovered.</div>`}
          </div>`:Z}
        <div class="dp-hint-inline">${a}</div>
      </div>`}_renderEnergyPeriodPicker(e,t,i=!1){const s=e??(i?void 0:"total");return G`
      <div class="pill-grp">
        ${(i?[["Inherit",void 0],["Total","total"],["Today","today"],["Week","week"],["Month","month"]]:[["Total","total"],["Today","today"],["Week","week"],["Month","month"]]).map(([e,i])=>G`
          <span class="pill ${s===i?"on":""}" @click=${()=>t(i)}>${e}</span>`)}
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?function(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,r]of Object.entries(t)){if(!r?.device_id||r.hidden_by)continue;const t=e.split(".")[0];if(!tt.has(t))continue;s.add(t);const a=(r.platform??"").toLowerCase();a&&i.add(a)}return{integrations:[...i].sort((e,t)=>Mt(e).localeCompare(Mt(t))),domains:[...s].sort()}}(this.hass):{integrations:[],domains:[]},r=G`
      <div class="field">
      ...
      ${t?G`
        <div class="field">
          ...
          <div class="pill-grp">
            ${["devices","controllable","all"].map((e,t)=>G`
        ...
        ${this._renderCheckDropdown("disc-int","Hide integrations",s.integrations.map(e=>({value:e,label:Mt(e)})),e.exclude_integrations??[],e=>this._set("exclude_integrations",e),"Tick the integrations to drop. The built-in list (phones, browsers, routers…) is always hidden on top of these.")}
      ...
      `:Z}`,a=this._badge(t?"Universal":"Shelly",t?"#c98a63":"#4ade80",t?"rgba(201,138,99,0.12)":"rgba(74,222,128,0.1)");return this._sec("discovery","◎","rgba(201,138,99,0.12)","#c98a63","Discovery",a,r)}_setDeviceStyle(e,t){const i={...this._config.device_styles?.[e]??{},...t};void 0===i.energy_period&&delete i.energy_period,void 0===i.energy_entity&&delete i.energy_entity,void 0===i.bg_image&&delete i.bg_image,void 0===i.bg_image_size&&delete i.bg_image_size,void 0===i.color&&delete i.color,void 0===i.tile_layout&&delete i.tile_layout,void 0===i.profile&&delete i.profile,void 0===i.tile_style&&delete i.tile_style,void 0===i.power_monitor_variant&&delete i.power_monitor_variant,void 0===i.tile_icon&&delete i.tile_icon,void 0===i.tile_icon_off&&delete i.tile_icon_off,void 0===i.tile_icon_speed&&delete i.tile_icon_speed,void 0===i.entity_animations&&delete i.entity_animations,void 0===i.sensors&&delete i.sensors,void 0===i.show_graphs&&delete i.show_graphs,void 0===i.elements&&delete i.elements;const s={...this._config.device_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("device_styles",Object.keys(s).length?s:void 0)}_setProfileStyle(e,t){const i={...this._config.profile_styles?.[e]??{},...t};for(const e of["color","tile_layout","tile_style","power_monitor_variant","sensors","show_graphs","elements"])void 0===i[e]&&delete i[e];const s={...this._config.profile_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("profile_styles",Object.keys(s).length?s:void 0)}_styleSlug(e){const t=e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"style",i=this._config.custom_styles??{};if(!i[t])return t;let s=2;for(;i[`${t}-${s}`];)s++;return`${t}-${s}`}_saveAsStyle(e,t,i){const s=this._newStyleName.trim();if(!s)return;const r=this._styleSlug(s),a=e.tile_style,o={label:s,base:"string"==typeof a&&a.startsWith("custom:")?this._config.custom_styles?.[a.slice(7)]?.base??t:a??t};e.power_monitor_variant&&(o.variant=e.power_monitor_variant),e.elements&&(o.elements={...e.elements}),e.sensors&&(o.sensors=[...e.sensors]),e.tile_layout&&(o.tile_layout=e.tile_layout.map(e=>Array.isArray(e)?[...e]:e)),this._set("custom_styles",{...this._config.custom_styles??{},[r]:o}),i(`custom:${r}`),this._newStyleName=""}_saveDeviceAsStyle(e){const t=this._allDevices().find(t=>t.device_id===e),i=t?Et(t):null,s=(this._config.smart_tile_styles&&i&&t?ut(i.type,t):void 0)??"default";this._saveAsStyle(this._config.device_styles?.[e]??{},s,t=>this._setDeviceStyle(e,{tile_style:t}))}_saveProfileAsStyle(e){const t=gt[e]??"default";this._saveAsStyle(this._config.profile_styles?.[e]??{},t,t=>this._setProfileStyle(e,{tile_style:t}))}_renameCustomStyle(e,t){const i=t.trim(),s=this._config.custom_styles?.[e];this._renamingStyle=null,s&&i&&i!==s.label&&this._set("custom_styles",{...this._config.custom_styles??{},[e]:{...s,label:i}})}_deleteCustomStyle(e){const t=`custom:${e}`,i={...this._config.custom_styles??{}};delete i[e],this._set("custom_styles",Object.keys(i).length?i:void 0);const s=e=>{if(!e||!Object.values(e).some(e=>e.tile_style===t))return null;const i={};for(const[s,r]of Object.entries(e)){const e={...r};e.tile_style===t&&delete e.tile_style,Object.keys(e).length&&(i[s]=e)}return Object.keys(i).length?i:void 0},r=s(this._config.device_styles);null!==r&&this._set("device_styles",r);const a=s(this._config.profile_styles);null!==a&&this._set("profile_styles",a);const o=s(this._config.area_styles);null!==o&&this._set("area_styles",o),this._config.views?.some(e=>e.tile_style===t)&&this._set("views",this._config.views.map(e=>{if(e.tile_style!==t)return e;const i={...e};return delete i.tile_style,i})),this._config.tile_style===t&&this._set("tile_style",void 0),this._flushConfig()}_renderTileStylePicker(e,t,i,s,r){const a=e??"default",o="power-monitor"===a||!e&&"power-monitor"===i;return G`
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?G`
          <div class="field-lbl" style="margin-top:8px">Saved styles</div>
          <div class="pill-grp">
            ${t.map(([t,i])=>{const r=`custom:${t}`;return this._renamingStyle===t?G`<input type="text" class="inline-text" style="width:9em"
                  .value=${i.label||t}
                  @click=${e=>e.stopPropagation()}
                  ...
                  ${Ci(e=>e?.focus())}/>`:G`<span class="pill ${e===r?"on":""}" @click=${()=>s(r)}>
                ${i.label||t}
      ...
      ${o?G`
        ...
        </div>`:Z}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,r=s?e.find(e=>e.device_id===s):null,a=r?Et(r):null,o=this._styleScope,n=a?e.filter(e=>Et(e).type===a.type).length:0,l=a?ht[a.type]||a.type:"",c=e=>G`
      ...
      <div class="dev-styling-tab">
        <div class="field" style="margin-bottom:8px">
          ...
          <select class="inline-text" style="width:100%"
            ...
            ${i.map(e=>G`<optgroup label=${e}>
              ${t.get(e).map(e=>G`<option value=${e.device_id} ?selected=${e.device_id===s}>${e.name}</option>`)}
            </optgroup>`)}
          </select>
        </div>
        ${r&&a?G`
          <div class="pill-grp" style="margin-bottom:10px">
            <span class="pill ${"device"===o?"on":""}" @click=${()=>{this._styleScope="device"}}>This device</span>
            <span class="pill ${"profile"===o?"on":""}" @click=${()=>{this._styleScope="profile"}}>All ${l}${1!==n?"s":""} (${n})</span>
          </div>
          ${"device"===o?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&r?ut(a.type,r):void 0)??"default";return G`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[a.type]??{},t=e.tile_style??(this._config.smart_tile_styles?gt[a.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return G`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",gt[a.type],e=>this._setProfileStyle(a.type,{tile_style:e}),e=>this._setProfileStyle(a.type,{power_monitor_variant:e}))}
          </div>
          <div class="tog-row" style="border:none;padding:6px 0 0">
            <div class="tog-lbl">Sparkline graphs</div>
            <div class="pill-grp">
              ${[["inherit",void 0],["on",!0],["off",!1]].map(([t,i])=>G`
          ...
          ${"default"===i?this._renderLayoutCanvas(e.tile_layout,this._config.tile_layout??bt[a.type],e=>this._setProfileStyle(a.type,{tile_layout:e})):Z}
          ${c(()=>this._saveProfileAsStyle(a.type))}
        </div>`})()}
        `:G`<div class="hint" style="margin:12px 2px">Pick a device above to style it.</div>`}
      </div>`}_blockPreview(e,t){switch(e){case"name_row":return G`<div class="tp-row tp-name-row"><div class="tp-dot" style="background:#4ade80"></div><span class="tp-name">Ljós yfir vaska</span><span class="tp-tog" style="background:${t}">ON</span></div>`;case"sensors":return G`<div class="tp-row tp-chips"><span class="tp-chip">4.1 W</span><span class="tp-chip">235 V</span><span class="tp-chip">44.6 °C</span><span class="tp-chip">−54 dBm</span></div>`;case"graph":return G`<div class="tp-row"><svg viewBox="0 0 200 28" preserveAspectRatio="none" style="width:100%;height:28px;display:block"><polygon points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5 200,28 0,28" fill="${t}" fill-opacity="0.15"/><polyline points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5" fill="none" stroke="${t}" stroke-width="1.5" stroke-linecap="round"/></svg></div>`;case"dimmer":return G`<div class="tp-row" style="gap:8px"><span class="tp-lbl">Brightness</span><div class="tp-strack"><div class="tp-sfill" style="width:68%;background:${t}"></div></div><span class="tp-val">68%</span></div>`;case"cover_controls":return G`<div class="tp-row" style="gap:4px"><button class="tp-btn">▲</button><button class="tp-btn">■</button><button class="tp-btn">▼</button></div>`;case"trv_control":return G`<div class="tp-row" style="gap:8px"><svg viewBox="0 0 80 44" style="width:60px;height:34px;flex-shrink:0"><path d="M 8 40 A 32 32 0 1 1 72 40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="6" stroke-linecap="round"/><path d="M 8 40 A 32 32 0 0 1 52 10" fill="none" stroke="${t}" stroke-width="6" stroke-linecap="round"/><text x="40" y="34" text-anchor="middle" font-size="11" font-weight="700" fill="white">21°</text></svg><span class="tp-val">Now 20°</span></div>`;case"valve_controls":return G`<div class="tp-row" style="gap:4px"><button class="tp-btn">Open</button><button class="tp-btn">Close</button></div>`;case"input_channels":return G`<div class="tp-row tp-chips"><span class="tp-chip" style="color:${t}">● CH1</span><span class="tp-chip">○ CH2</span></div>`;case"relay_channels":return G`<div class="tp-row tp-chips"><span class="tp-chip" style="background:${t}20;color:${t}">CH1 ON</span><span class="tp-chip">CH2 OFF</span></div>`;case"power_bar":return G`<div class="tp-row" style="gap:8px"><div class="tp-strack" style="flex:1"><div class="tp-sfill" style="width:22%;background:${t}"></div></div><span class="tp-val">4.1 W</span></div>`;case"virtual_controls":return G`<div class="tp-row tp-chips"><span class="tp-chip">Mode ▾</span><span class="tp-chip" style="background:${t}20;color:${t}">Script</span></div>`;case"badges":return G`<div class="tp-row tp-chips"><span class="tp-chip" style="background:rgba(234,179,8,.18);color:#fde047">Dimmer</span><span class="tp-chip" style="background:rgba(34,197,94,.18);color:#86efac">G3</span></div>`;default:return Z}}_layPointerDown(e,t,i){if("mouse"===e.pointerType&&0!==e.button)return;const s=e.currentTarget;try{s.setPointerCapture(e.pointerId)}catch{}this._layDrag={from:{r:t,i:i},chip:s,x:e.clientX,y:e.clientY,pointerId:e.pointerId,active:!1,over:null}}_layTargetAt(e,t){const i=this.shadowRoot?.elementFromPoint(e,t);return i?.closest(".lay-row, .lay-palette")??null}_layPointerMove(e){const t=this._layDrag;if(!t||e.pointerId!==t.pointerId)return;if(!t.active){if(Math.hypot(e.clientX-t.x,e.clientY-t.y)<Ei.DRAG_SLOP)return;t.active=!0,t.chip.classList.add("lay-dragging"),t.chip.style.pointerEvents="none"}e.preventDefault();const i=this._layTargetAt(e.clientX,e.clientY);i!==t.over&&(t.over?.classList.remove("lay-over"),i?.classList.add("lay-over"),t.over=i)}_layPointerUp(e){const t=this._layDrag;if(!t||e.pointerId!==t.pointerId)return;const i=t.active?this._layTargetAt(e.clientX,e.clientY):null,s=t.from;if(this._layDragEnd(),i&&this._layMove)if(i.classList.contains("lay-palette"))this._layMove(s,"hide");else if(i.classList.contains("lay-new"))this._layMove(s,"new");else{const e=[...this.shadowRoot?.querySelectorAll(".lay-canvas .lay-row:not(.lay-new)")??[]].indexOf(i);e>=0&&this._layMove(s,{r:e})}}_layDragEnd(){const e=this._layDrag;if(e){e.chip.classList.remove("lay-dragging"),e.chip.style.removeProperty("pointer-events"),e.over?.classList.remove("lay-over");try{e.chip.releasePointerCapture(e.pointerId)}catch{}this._layDrag=null}}_baseStyleOf(e){return"string"==typeof e&&e.startsWith("custom:")?this._config.custom_styles?.[e.slice(7)]?.base??"default":e}_renderLayoutCanvas(e,t,i){const s=ft(e??t),r=new Set(s.flat()),a=Oi.map(e=>e.id).filter(e=>!r.has(e));this._layMove=(e,t)=>{const r=s.map(e=>[...e]);let o;if(e.r<0?o=a[e.i]:(o=r[e.r][e.i],r[e.r].splice(e.i,1)),"new"===t)r.push([o]);else if("hide"!==t){const e=r[t.r];e?e.length<Ei.ROW_MAX?e.push(o):r.splice(t.r+1,0,[o]):r.push([o])}const n=r.filter(e=>e.length>0);i(n.length?n:void 0)};const o=(e,t,i)=>G`
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>Oi.find(t=>t.id===e)?.label??e)(e)}</span>`,n=this._config.style?.accent_color??"#f4601e";return G`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout
          ${e?this._resetBtn(!0,()=>i(void 0)):Z}
        </div>
        <div class="tile-preview-live" style="--accent:${n}">
          ${s.length?s.map(e=>G`<div class="tp-prow">${e.map(e=>this._blockPreview(e,n))}</div>`):G`<div style="color:var(--t3);font-size:11px;padding:8px;text-align:center">All blocks hidden</div>`}
        </div>
        <div class="lay-canvas">
          ${s.map((e,t)=>G`
            <div class="lay-row">
              ${e.map((e,i)=>o(e,t,i))}
              ${e.length<Ei.ROW_MAX?G`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
          <div class="lay-row lay-new">＋ new row</div>
        </div>
        <div class="field-lbl" style="margin-top:6px">Hidden blocks</div>
        <div class="lay-palette">
          ${a.length?a.map((e,t)=>o(e,-1,t)):G`<span class="dev-style-hint">drag a block here to hide it</span>`}
        </div>
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=vt[e];if(!s)return G``;return G`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=Oi.map(e=>e.id),s=this._config.tile_layout??i,r=mt(s),a=mt(t.tile_layout)??null,o=t.entity_animations??{},n=o=>{const n=(a??r).includes(o),l=function(e,t,i,s){const r=ft(e).map(e=>[...e]);if(!i)return r.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(r.some(e=>e.includes(t)))return r;const a=e=>{const t=s.indexOf(e);return t<0?s.length:t},o=r.findIndex(e=>a(e[0])>a(t));return r.splice(o<0?r.length:o,0,[t]),r}(t.tile_layout??s,o,!n,i),c=JSON.stringify(l)===JSON.stringify(ft(s));this._setDeviceStyle(e,{tile_layout:c?void 0:l})},l=(t,i,s)=>{const r={...o[t]??{}};if("speed"===i){const e=Number(s);1===e?delete r.speed:r.speed=e}else"none"===s?delete r[i]:r[i]=s;const a={...o,[t]:r};r.on||r.off||r.speed||delete a[t],this._setDeviceStyle(e,{entity_animations:Object.keys(a).length?a:void 0})},c=this._allDevices().find(t=>t.device_id===e),d=c?Et(c):null,p=d?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[d.type]:void 0,h=t.tile_style,g=t.power_monitor_variant??"big-number",u=G`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${p&&!h?G`<span class="dev-style-hint">Recommended: ${p}</span>`:Z}
          ${h?G`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:Z}
        </div>
        ${this._renderTileStylePicker(h,g,p,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}))}
      </div>`,v=c?c.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return G`
      <div class="dev-style-panel">
        <div class="field" style="margin-bottom:6px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
            Type
            ${c?.model?G`<span class="dev-style-hint">${c.model}</span>`:Z}
            ${t.profile?G`<button class="color-reset"
          ...
          <select class="inline-text" style="width:100%"
            ...
            <option value="" ?selected=${!t.profile}>Auto${d?` — detected: ${ht[d.type]||d.type||"generic"}`:""}</option>
            ${["relay","plug","dimmer","rgb","climate","cover","valve","energy","sensor","input","uni","wall_display","generic"].map(e=>G`
              <option value=${e} ?selected=${t.profile===e}>${ht[e]||e}</option>`)}
          </select>
        </div>
        ${u}
        <div class="color-row">
          ...
          ${t.color?G`<button class="color-reset"
        ...
        <div class="pill-grp" style="margin-bottom:8px">
          ${[["Inherit",void 0],["On",!0],["Off",!1]].map(([i,s])=>G`
            <span class="pill ${t.show_graphs===s?"on":""}"
              @click=${()=>this._setDeviceStyle(e,{show_graphs:s})}>${i}</span>`)}
        </div>
        ${(()=>{const i=c?Et(c):null,o=t.tile_style??(this._config.smart_tile_styles&&i&&c?ut(i.type,c):void 0)??this._config.tile_style,l=this._baseStyleOf(o);return l&&"default"!==l?Z:G`
            ...
            ${this._adv(G`
                ...
                <div class="block-toggles">
                  ${Oi.filter(e=>"graph"!==e.id).map(e=>{const t=null===a?r.includes(e.id):a.includes(e.id);return G`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ...
        ${this._adv(v.length?G`
          ...
          ${v.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,r=o[t.entity_id]?.on??"none",a=o[t.entity_id]?.off??"none",n=o[t.entity_id]?.speed??1;return G`
              <div class="ent-anim-row">
                <span class="ent-anim-name">${s}</span>
                ${this._iconPicker(`ent-on-${e}-${t.entity_id}`,"none"===r?void 0:r,!0,e=>l(t.entity_id,"on",e??"none"))}
                ${this._iconPicker(`ent-off-${e}-${t.entity_id}`,"none"===a?void 0:a,!1,e=>l(t.entity_id,"off",e??"none"))}
                <select class="anim-select" .value=${String(n)}
                  @change=${e=>l(t.entity_id,"speed",e.target.value)}>
        ...
        ${this._adv(c?.entities.length?G`
          ...
          <div class="block-toggles">
            ${c.entities.map(e=>{const t=this._config.hidden_entities??[],i=t.includes(e.entity_id),s=this.hass?.states[e.entity_id]?.attributes?.friendly_name??e.entity_id.split(".").pop()??e.entity_id;return G`<span class="block-tog ${i?"":"on"}"
      ...
      </div>`}_renderRoomHeaderChips(e,t){const i=this._allDevices().filter(t=>(t.area??"")===e),s=new Set;for(const e of i)for(const t of e.entities){if("sensor"!==t.domain)continue;const e=t.attributes?.device_class??"",i=ei.find(i=>i.dc===e||"rssi"===i.key&&("signal_strength"===e||t.entity_id.includes("_rssi")));i&&s.add(i.key)}const r=ei.filter(e=>s.has(e.key));if(!r.length)return G`<div class="hint" style="margin:2px 2px 6px">No summary sensors in this room.</div>`;const a=t.header_chips??ti;return G`
      <div class="field" style="margin-bottom:4px">
        ${void 0!==t.header_chips?G`<button class="color-reset" style="margin-bottom:4px" @click=${()=>this._setAreaStyle(e,"header_chips",void 0)}>↺ Default</button>`:Z}
        <div class="pill-grp">
          ${r.map(t=>{const i=a.includes(t.key);return G`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?a.filter(e=>e!==t.key):[...a,t.key];var r;this._setAreaStyle(e,"header_chips",(r=s).length===ti.length&&ti.every(e=>r.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
        <div class="hint" style="margin-top:4px">Live power already shows in the room's meta row; add Energy/Voltage/etc. here.</div>
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,r)=>{const a=t[s]??r;return G`
        <div class="color-row">
          ...
          ${t[s]?G`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:Z}
        </div>`},s=(i,s,r,a,o,n,l)=>{const c=t[s]??n;return G`
        <div class="sl-row">
          <span class="color-key">${i}</span>
          <input type="range" min="${r}" max="${a}" step="${o}" style="flex:1;accent-color:#f4601e"
            .value=${String(c)}
            @input=${t=>this._setAreaStyle(e,s,parseInt(t.target.value,10))}/>
          <span class="sl-val">${c}${l}</span>
        </div>`},r=e=>G`<div class="rsp-section-lbl">${e}</div>`;return G`
      <div class="rsp-panel">
        ${r("Layout")}
        ...
        ${this._renderBgImagePicker("Room background photo",`room-bg-${e}`,t.bg_image,t.bg_image_size,t=>this._setAreaStyle(e,"bg_image",t),t=>this._setAreaStyle(e,"bg_image_size",t),()=>["bg_image","bg_image_size","bg_image_mode","bg_image_pos"].forEach(t=>this._setAreaStyle(e,t,void 0)),{maxDim:1600,showFit:"sharp"===(t.bg_image_mode??"sharp"),extra:G`
              <div class="field-lbl" style="margin-top:8px">Backdrop mode
                <span class="dev-style-hint">a room section is a wide strip</span></div>
              <div class="pill-grp">
                ${[["Sharp","sharp"],["Ambient","ambient"]].map(([i,s])=>G`
                  <span class="pill ${(t.bg_image_mode??"sharp")===s?"on":""}"
                    @click=${()=>this._setAreaStyle(e,"bg_image_mode","sharp"===s?void 0:s)}>${i}</span>`)}
              </div>
              ${"sharp"===(t.bg_image_mode??"sharp")?G`
                <div class="field-lbl" style="margin-top:6px">Show which part</div>
                <div class="pill-grp">
                  ${[["Top","top"],["Center","center"],["Bottom","bottom"]].map(([i,s])=>G`
        ...
        ${this._adv(G`
        ${r("ON / OFF buttons")}
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",r=t.buttonSize??"md",a="square"===i||"circle"===i,o="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",n=a?"sm"===r?"3px 5px":"lg"===r?"6px 12px":"4px 8px":"sm"===r?"2px 8px":"lg"===r?"6px 16px":"4px 12px",l="sm"===r?"10px":"lg"===r?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${o};padding:${n};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,g=t.buttonShape||t.buttonVariant||t.buttonSize;return G`
            <div class="btn-preview">
              ...
              ${g?G`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:Z}
            </div>
            <div class="field">
              <div class="field-lbl">Shape</div>
              <div class="pill-grp">
                ${["pill","rect","square","circle"].map(t=>G`
        ...
        `)}
      </div>`}_updateView(e,t){const i=(this._config.views??[]).map(i=>i.id===e?{...i,...t}:i);this._set("views",i)}_updateViewFilter(e,t){const i=(this._config.views??[]).map(i=>{if(i.id!==e)return i;const s={...i.filter??{},...t};for(const e of Object.keys(s)){const t=s[e];(null==t||Array.isArray(t)&&0===t.length||"string"==typeof t&&""===t)&&delete s[e]}return{...i,filter:Object.keys(s).length?s:void 0}});this._set("views",i)}_toggleViewFilterValue(e,t,i){const s=(this._config.views??[]).find(t=>t.id===e),r=s?.filter?.[t]??[],a=r.includes(i)?r.filter(e=>e!==i):[...r,i];this._updateViewFilter(e,{[t]:a})}_addView(){const e=this._config.views??[];let t=e.length+1;for(;e.some(e=>e.id===`view_${t}`);)t++;const i={id:`view_${t}`,name:`View ${t}`};this._set("views",[...e,i]),this._flushConfig(),this._expandedViewId=i.id}_regexError(e){if(!e)return null;try{return new RegExp(e),null}catch(e){return e.message}}_deleteView(e){const t=(this._config.views??[]).filter(t=>t.id!==e);this._set("views",t.length?t:void 0),this._config.default_view===e&&this._set("default_view",void 0),this._flushConfig()}_moveView(e,t){const i=[...this._config.views??[]],s=i.findIndex(t=>t.id===e);if(s<0)return;const r=s+t;r<0||r>=i.length||([i[s],i[r]]=[i[r],i[s]],this._set("views",i),this._flushConfig())}_countViewMatches(e,t,i){const s=e.filter;let r=t;if(!s)return r.length;if(s.profiles?.length){const e=new Set(s.profiles);r=r.filter(t=>{const s=i.get(t.device_id);return s&&e.has(Et(s).type)})}if(s.domains?.length){const e=new Set(s.domains);r=r.filter(t=>i.get(t.device_id)?.entities.some(t=>e.has(t.domain)))}if(s.areas?.length){const e=new Set(s.areas.map(e=>e.toLowerCase()));r=r.filter(t=>e.has((t.area??"").toLowerCase()))}if(s.devices?.length){const e=new Set(s.devices);r=r.filter(t=>e.has(t.device_id))}if(s.exclude_devices?.length){const e=new Set(s.exclude_devices);r=r.filter(t=>!e.has(t.device_id))}if(s.entity_id_pattern)try{const e=new RegExp(s.entity_id_pattern);r=r.filter(t=>i.get(t.device_id)?.entities.some(t=>e.test(t.entity_id)))}catch{}return r.length}_renderViewsTab(){const e=this._config.views??[],t=["relay","plug","dimmer","rgb","climate","wall_display","cover","valve","energy","sensor","input","uni"],i=["light","switch","sensor","binary_sensor","climate","cover","valve","button","select","number"],s=this._getAreas(),r=this._getDiscoveredDevices(),a=new Map(this._allDevices().map(e=>[e.device_id,e]));return G`
      ...
      ${e.map((o,n)=>this._renderViewCard(o,n,e.length,t,i,s,r,a))}
    `}_renderViewCard(e,t,i,s,r,a,o,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,o,n),g=o.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return G`
      <div class="view-card ${l?"expanded":""}">
        <div class="view-card-hdr" @click=${()=>this._expandedViewId=l?null:e.id}>
          <span class="view-card-icon">${e.icon?G`<ha-icon .icon=${e.icon}></ha-icon>`:"☰"}</span>
        ...
        ${l?G`
          <div class="view-card-body">
              ...
              <div class="view-dev-list">
                ${De(o,e=>e.device_id,t=>G`
                  <label class="view-dev-row">
                    ...
                    ${t.area?G`<span class="view-dev-area">${t.area}</span>`:Z}
                  </label>`)}
              </div>
            </div>
            ...
            <div class="field">
              ...
              ${this._regexError(c.entity_id_pattern)?G`<div class="input-err">Invalid regex: ${this._regexError(c.entity_id_pattern)}</div>`:Z}
            </div>`)}
            ...
            <div class="field">
              ...
              <div class="pill-grp">
                ${["default","power-monitor","light-control","climate-control","cover-control","sensor-card","scene-button"].map(t=>G`
                  <span class="pill ${(e.tile_style??"default")===t?"on":""}"
                    @click=${()=>u("tile_style","default"===t?void 0:t)}>${t}</span>`)}
              </div>
            </div>
            ${"power-monitor"===e.tile_style?G`
              <div class="field">
                <div class="field-lbl">Power-monitor variant</div>
                <div class="pill-grp">
                  ${["big-number","gauge","graph","compact","table"].map(t=>G`
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?G`<button class="color-reset" @click=${()=>u("columns",void 0)}>↺</button>`:Z}
            </div>
      ...
      </div>`}_gridBody(){const e=this._config;return G`
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[r]?G`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:Z}
        </div>`},a=G`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?G`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?G`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:Z}
          </div>
          <div class="pill-grp">
            ${Kt.map(t=>{const i=e.header_chips??Jt,s=i.includes(t.key);return G`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],r=e.length===Jt.length&&Jt.every(t=>e.includes(t));this._set("header_chips",r?void 0:e)}}>${t.label}</span>`})}
          </div>
      ...
      </div>`)}`,o=(e,i,s)=>{const r=t[i]??s;return G`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
          <span class="color-key">${e}</span>
          <input type="color" .value=${r}
            @input=${e=>this._set("style",{...t,[i]:e.target.value})}/>
          ${t[i]?G`<button class="color-reset" @click=${()=>{const e={...t};delete e[i],this._set("style",e)}}>↺</button>`:Z}
        </div>`},n=G`
      ${o("Tile background","tile_bg","rgba(255,244,232,0.035)")}
      ${o("Tile border","tile_border","rgba(255,244,232,0.08)")}
      ${o("Tile hover BG","tile_hover_bg","rgba(255,244,232,0.06)")}
      ${o("Tile hover shadow","tile_hover_shadow","rgba(0,0,0,0.35)")}
      ${o("Sensor chip BG","tile_sensor_bg","rgba(255,244,232,0.045)")}
      ${o("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=G`
      <div class="subgroup-lbl">Brand</div>
      ${o("Accent / brand","accent_color","#c98a63")}
      ${o("Room header label","area_header_color","#c98a63")}

      <div class="subgroup-lbl">Text &amp; status</div>
      ${o("Text primary","text_primary","#ece5dc")}
      ${o("Text secondary","text_secondary","#b3a596")}
      ${o("Text muted","text_muted","#7e7265")}
      ${o("Online dot","online_color","#93b384")}
      ${o("Offline dot","offline_color","#d47f62")}
      ${o("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=G`
      <div class="field">
        ...
        <select class="font-select" style=${c?`font-family:${c}`:""}
          ...
          ${["System","Bundled","Display"].map(e=>G`
            <optgroup label="${e}">
              ${Ii.filter(t=>t.group===e).map(e=>G`
      ...
      </div>`,p=e.card_opacity??100,h=e.tile_opacity??100,g=G`
      ${this._gridBody()}
      <div class="field">
        <div class="field-lbl">Tile size</div>
        <div class="pill-grp">
      ...
      <div class="field">
        ...
        <div class="pill-grp">
          ${["none","soft","medium","strong"].map(e=>G`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?.startsWith("data:")?G`<span class="bg-embedded-note">Embedded · ${this._estimateImageSize(t.tile_bg_image)}</span>`:G`<input type="text" class="inline-text" placeholder="/local/image.png or https://…"
          ...
          ${t.tile_bg_image?G`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:Z}
        </div>
        ${t.tile_bg_image?G`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
      ...
      `)}
    `,u=G`
      ${o("Dashboard background","card_bg","#1e1a17")}
      <div class="field">
      ...
      ${this._renderRoomStyleSection()}`}_renderRoomStyleSection(){const e=this._getAreas().map(e=>e.name),t=this._cardThemeRoom,i=G`
      <div class="field" style="margin-bottom:8px">
        <div class="field-lbl">Room</div>
        <select class="inline-text" style="width:100%"
          ...
          ${e.map(e=>G`<option value=${e} ?selected=${e===t}>${e}</option>`)}
        </select>
      </div>
      ${t?this._renderRoomStylePanel(t):G`<div class="hint" style="margin:8px 2px">Pick a room to style its header, columns and tile look.</div>`}`;return this._sec("room-style","⌂","rgba(74,222,128,0.1)","#4ade80","Per-room styling",Z,i)}_globalSectionDescriptors(){return{...this._layoutSectionDescriptors(),...this._graphSectionDescriptors(),...this._sensorSectionDescriptors()}}_renderCustomTab(e){const t=new Set(["electrical","environmental","deviceinfo","alerts"]);return this._renderTabSections(e,this._globalSectionDescriptors(),(e,i)=>{const s=[...i].some(e=>t.has(e));return t.has(e)&&!s?G`<div class="hint" style="margin:4px 2px 8px">Global default — override per room (Layout & Style → room) or per device (Rooms & devices).</div>`:Z})}_graphSectionDescriptors(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},r=G`
      ...
      </div>`)}`,a=e.graph_sensors??wt,o=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const r=s[e]??i,a=!!s[e];return G`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${r}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${a?G`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:Z}
        </div>`},l=G`
      <div class="field-lbl" style="margin-bottom:6px">Gauge ring colours</div>
      ${o.map(e=>n(e.key,e.label,e.default))}
      ${a.filter(e=>!o.find(t=>t.key===e)).length?G`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${a.filter(e=>!o.find(t=>t.key===e)).map(e=>{const t=Vt.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??Vt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",Vt.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${Vt.map(e=>{const t=a.some(t=>Qt(t)===e.key);return G`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>Qt(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const r=""===s.trim()?void 0:parseFloat(s),a={...c[e]??{}};void 0===r||isNaN(r)?delete a[i]:a[i]=r;const o={...c,[e]:a};a.min||0===a.min||a.max||0===a.max||delete o[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(o).length?o:void 0})},p=G`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return G`
            <div class="range-row ${s?"set":""}">
              ...
              ${s?G`<button class="color-reset" @click=${()=>{const i={...c};delete i[e.key],this._set("graph_style",{...t,sensor_ranges:Object.keys(i).length?i:void 0})}}>↺</button>`:G`<span></span>`}
            </div>`})}
      </div>`;return{graphtype:{icon:"∿",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Graph Type",badge:Z,body:r},graphcolors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Per-sensor Colors",badge:Z,body:l},graphranges:{icon:"⇕",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Sensor Min / Max",badge:Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):Z,body:p}}}_sensorSectionDescriptors(){const e=this._config,t=e.sensors??[],i={};return Mi.forEach(s=>{const r=s.items.map(e=>e.key),a=r.filter(e=>t.includes(e)).length,o=r.every(e=>t.includes(e)),n=this._badge(`${a||"All"} / ${s.items.length}`,s.iconColor,s.iconBg),l=G`
          <div class="sensors-hdr">
            <span class="sensors-hdr-lbl">${0===a?"All shown (default)":`${a} of ${s.items.length} shown`}</span>
            <button class="sensors-all-btn" @click=${e=>{e.stopPropagation();const i=o?t.filter(e=>!r.includes(e)):[...new Set([...t,...r])];this._set("sensors",i)}}>${o?"− Deselect all":"+ Select all"}</button>
          </div>
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),r=Qt(i.key),a=!!Vt.find(e=>e.key===r),o=e.graph_sensors??wt,n=o.some(e=>Qt(e)===r);return G`
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...Fe[t]}}(this._config.style,e)),this._set("theme",e)}_onPickTheme(e){const t=this._config.style??{},i=je.some(e=>void 0!==t[e]);i&&"custom"===Ue(t)?this._pendingTheme=e:this._applyTheme(e)}_applySaved(){this._savedTheme&&(this._set("style",{...this._config.style??{},...this._savedTheme}),this._set("theme","custom"))}_resetLook(){const e=this._config,t={};for(const i of Ei._CONTENT_KEYS)void 0!==e[i]&&(t[i]=e[i]);this._emitNow({type:"custom:ha-device-dashboard",...si(),...t})}_onResetEverything(){this._resetArmed?(this._resetArmed=!1,this._emitNow({type:"custom:ha-device-dashboard",...si()})):this._resetArmed=!0}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=Ue(t),r=!!this._savedTheme&&Object.entries(this._savedTheme).every(([e,i])=>t[e]===i);return G`
        ...
        <div class="dp-grid">
          <div class="dp-group">
            ...
            ${i.length?G`
              ...
              </div>`:G`<div class="hint">No views yet — add them in the Views tab.</div>`}
          </div>
          ...
          <div class="dp-group">
            ...
            <div class="theme-grid">
              ...
              ${Le.map(e=>{const t=Fe[e];return G`
            ...
            ${this._pendingTheme?G`
              ...
              </div>`:"custom"===s?G`<div class="hint">Custom — your colours don't match a preset.${this._savedTheme?"":" Applying one will offer to save these first."}</div>`:Z}
          </div>

          <div class="dp-group">
            <div class="dp-title">Default tile style
              ${e.tile_style?G`<button class="color-reset" @click=${()=>{this._set("tile_style",void 0),this._set("power_monitor_variant",void 0)}}>↺ reset</button>`:G`<span class="dp-hint-inline">adaptive</span>`}
            </div>
      ...
      </div>`}render(){if(!this._config)return G``;const e=zi.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(zi.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};zi.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),r=s[this._tab]??[],a=e=>{if(!r.length)return;const t={...this._openSections};for(const i of r)t[i]=e;this._openSections=t},o=r.length>1;return G`
      <div class="shell">
        <div class="tab-nav">
          ${e.map(e=>G`
      ...
      </div>`}};Ri.ROW_MAX=3,Ri.DRAG_SLOP=6,Ri._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],Ri.styles=[Ye,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Ri.prototype,"hass",void 0),e([fe()],Ri.prototype,"_config",void 0),e([fe()],Ri.prototype,"_tab",void 0),e([fe()],Ri.prototype,"_styleScope",void 0),e([fe()],Ri.prototype,"_cardThemeRoom",void 0),e([fe()],Ri.prototype,"_newStyleName",void 0),e([fe()],Ri.prototype,"_renamingStyle",void 0),e([fe()],Ri.prototype,"_advanced",void 0),e([fe()],Ri.prototype,"_defaultsOpen",void 0),e([fe()],Ri.prototype,"_resetArmed",void 0),e([fe()],Ri.prototype,"_xcPlacement",void 0),e([fe()],Ri.prototype,"_xcRoom",void 0),e([fe()],Ri.prototype,"_xcAdding",void 0),e([fe()],Ri.prototype,"_xcEditIndex",void 0),e([fe()],Ri.prototype,"_xcDraft",void 0),e([fe()],Ri.prototype,"_xcDashboards",void 0),e([fe()],Ri.prototype,"_xcImportCards",void 0),e([fe()],Ri.prototype,"_xcImportLoading",void 0),e([fe()],Ri.prototype,"_pendingTheme",void 0),e([fe()],Ri.prototype,"_savedTheme",void 0),e([fe()],Ri.prototype,"_expandedViewId",void 0),e([fe()],Ri.prototype,"_openSections",void 0),e([fe()],Ri.prototype,"_expandedRooms",void 0),e([fe()],Ri.prototype,"_expandedRoomStyle",void 0),e([fe()],Ri.prototype,"_selectedDeviceId",void 0),e([fe()],Ri.prototype,"_deviceSearch",void 0),e([fe()],Ri.prototype,"_styleClipFeedback",void 0),e([fe()],Ri.prototype,"_openDiscDropdown",void 0),e([fe()],Ri.prototype,"_iconPickerState",void 0),Ri=Ei=e([he("ha-device-dashboard-editor")],Ri);let Pi=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Pi.styles=n`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Pi.prototype,"hass",void 0),e([ve()],Pi.prototype,"entity",void 0),e([ve({attribute:!1})],Pi.prototype,"features",void 0),e([fe()],Pi.prototype,"_el",void 0),Pi=e([he("hdd-delegated")],Pi);let Fi=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Fi.styles=n`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Fi.prototype,"hass",void 0),e([ve({attribute:!1})],Fi.prototype,"config",void 0),e([fe()],Fi.prototype,"_el",void 0),Fi=e([he("hdd-card")],Fi);console.info("%c ha-device-dashboard %c dedupe-2026-08-19c ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
