...
`,Fe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Pe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Le=["motion","door","window","moisture","smoke","gas"];const Ue=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function je(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},a=new Map;for(const[n,r]of Object.entries(t)){if(!r?.device_id)continue;if(r.hidden_by)continue;const t=n.split(".")[0];if(!Ue.has(t))continue;const o=(r.platform??"").toLowerCase();if("shelly"!==o)continue;const l=r.device_id;if(!a.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),n=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??r.area_id,d=c?s[c]?.name:void 0;a.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:n,integration:o,entities:[]})}const c=a.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[n];c.entities.push({entity_id:n,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:r.area_id,platform:o})}const n=new Set;for(const[e,t]of a){if(n.has(e))continue;const s=i[e],r=s?.via_device_id;if(!r||!a.has(r)||n.has(r))continue;const o=i[r],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),u=!l&&c&&t.integration===a.get(r).integration;if(!p&&!u)continue;const g=a.get(r);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),n.add(e)}for(const e of n)a.delete(e);return Array.from(a.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const Ne={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},We={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function He(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),a=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),n=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||a||n?"sensor":"input"}const a=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:a,label:Ne[s],integration:e.integration}}const qe={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};function Ze(e){return e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`}function Qe(e){return`${e.toFixed(3)} kWh`}function Xe(e){return`${e.toFixed(1)} V`}function Ve(e){return`${e.toFixed(3)} A`}function Ge(e){return`${e.toFixed(1)} °C`}function Ye(e){return e<60?`${e}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ke(e){return e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor"}function Je(e){return`${e.toFixed(1)} VA`}function _e(e){return`${e.toFixed(1)} VAr`}function $e(e){return`${e.toFixed(2)} Hz`}function et(e){return`${e.toFixed(1)} %`}function tt(e){return e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`}function it(e){return`${Math.round(e)} ppm`}function st(e){return`${Math.round(e)} %`}const at=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],nt=Object.fromEntries(at.map(e=>[e.key,e.label.split(" ")[0]]));function rt(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:r}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=n.graph_style?.sensor_ranges??{},d=n.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),u=110,g=110,v=180,h=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=h+v*Math.min(1,Math.max(0,t)),s=u+e*Math.cos(m(h)),a=g+e*Math.sin(m(h)),n=u+e*Math.cos(m(i)),r=g+e*Math.sin(m(i)),o=v*t>180?1:0;return`M ${s.toFixed(2)} ${a.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${n.toFixed(2)} ${r.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Q`
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.renderTileLowerBody(t,r)}
    </div>`}(e)}}const ot=140,lt=70;function ct(e){const{device:t,isOn:i,accent:s,online:a,hass:n,profile:r}=e,o=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!o)return Q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(o.entityId.startsWith("switch.")||"dimmer"!==r.type&&"rgb"!==r.type)return Q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      `}case"sensors":return v.length?Q`
      ...
      `:Q``;case"graph":return e.renderSparklines(i);case"dimmer":{const t=o?n.states[o.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,a=o?.whiteValue??0;return o&&b?Q`
      ...
      `;default:return Q``}}const pt=255;function ut(e){return Q`
    ...
    ${vt(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Q`
    ...
    ${vt(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,a=Math.round(s/255*100);return Q`
    <div class="ds-section">
    ...
    ${vt(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,a=i?.brightness??0,n=Math.round(a/pt*100);return Q`
    <div class="ds-section">
    ...
    ${vt(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Q`
    <div class="ds-section">
    ...
    ${vt(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Q`
    <div class="ds-section">
    ...
    ${vt(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Q`
    <div class="ds-section">
    ...
    ${vt(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Q`${vt(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),a=e.getAlerts(t);return Q`
    ...
    ${vt(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Q`
    <div class="ds-section">
    ...
    ${vt(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),a=t.entities.filter(e=>"switch"===e.domain);return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    ${vt(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Q`
    ${t?Q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${vt(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    </div>`}function gt(e){if(!e.getGraphEntities(e.device).length)return Q``;const t=e.getDetailHistoryRange();return Q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function vt(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:a=!1}=t;return Q`
    ${a&&s?gt(e):G}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?Q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:G}
          ...
          </div>`;const A=k.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[x]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,M=k[0].t,O=k[k.length-1].t,B=O-M||1,E=e=>(e.t-M)/B*n,T=e=>r-4-(e.v-S)/I*(r-8),R=k.map(e=>`${E(e).toFixed(1)},${T(e).toFixed(1)}`).join(" "),D=E(k[0]).toFixed(1),F=`sg-${t.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),U=A.indexOf(z),j=A.indexOf(S),N=E(k[U]).toFixed(1),W=T(k[U]).toFixed(1),H=E(k[j]).toFixed(1),q=T(k[j]).toFixed(1),Z=m(k[0].t),V=m((k[0].t+O)/2),Y=h/B*n,K=`${Math.max(.3,.7*Y).toFixed(2)} ${Math.max(.3,.3*Y).toFixed(2)}`,J=c&&z-S>0;return Q`
    ...
    `}render(){if(!this._config||!this.hass)return Q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return Q`
        ...
        </ha-card>`;const a=s.filter(e=>this._isOnline(e)).length,n=s.length-a,r=s.reduce((e,t)=>e+(this._getPower(t)??0),0),o=s.filter(e=>this._getAlerts(e).length>0),l=this._getActiveView(),c=l?this._applyViewFilter(s,l):s,d=this._groupByArea(c),p=!l||!0===l.show_favourites,u=!l||!1!==l.show_rooms,g=Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")),v=g.filter(e=>"on"===e.state),h=g.filter(e=>"off"===e.state),f=g.filter(e=>"unavailable"===e.state),b=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),m=this._buildCardStyles(),x=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,y=x?ut(this._buildTileCtx(x,He(x),this._tileAccent(x,x.area??""))):G;return Q`
      <ha-card style=${we(m)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ${y}
        <div class="dash-header">
          ...
          ${!1!==this._config.header_show_stats?Q`
            <div class="dash-stats">
              <span class="stat online">${a}/${s.length} online</span>
              ${n>0?Q`<span class="stat offline-count">${n} offline</span>`:G}
              <span class="stat power">${Ze(r)}</span>
              ${o.length>0?Q`<span class="stat alerts-count">⚠ ${o.length}</span>`:G}
            </div>`:G}
          ${!1!==this._config.header_show_cloud?Q`
        ...
        ${"on"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            <div class="cloud-detail-hdr cloud-on">● Online — ${v.length} devices</div>
            <div class="cloud-grid">
              ${v.map(e=>Q`<div class="cloud-item">${b(e)}</div>`)}
            </div>
          </div>`:G}
        ...
        <div class="dash-body">
          ...
          ${u?[...d.entries()].map(([e,t])=>this._renderAreaSection(e,t)):Q`<div class="device-grid" style="--cols:${l?.columns??this._config.columns??3}">
    ...
    `}_renderViewCard(e,t,i,s,a,n,r){const o=this._expandedViewId===e.id,l=e.filter??{},c=new Set(l.devices??[]),d=new Set(l.exclude_devices??[]),p=this._countViewMatches(e),u=r.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
      ...
      ${n.filter(e=>!r.find(t=>t.key===e)).length?Q`
        ...
        ${n.filter(e=>!r.find(t=>t.key===e)).map(e=>{const t=kt.find(t=>t.key===e);return o(e,t?.label??e,(e=>s[e]??kt.find(t=>t.key===e)?.color??"#f4601e")(e))})}`:G}
      ...
      ${wt.map(i=>{const s=i.items.map(e=>e.key),a=s.filter(e=>t.includes(e)).length,n=s.every(e=>t.includes(e)),r=this._badge(`${a||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),o=Q`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),a=!!kt.find(e=>e.key===i.key),n=e.graph_sensors??[],r=n.includes(i.key);return Q`
