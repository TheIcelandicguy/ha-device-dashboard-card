...
`,Je=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const et=["temperature","humidity","carbon_dioxide","illuminance","battery"],tt=["motion","door","window","moisture","smoke","gas"];const it=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function st(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,r=i?new Set([...ot,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,o=i&&t.includeDomains?.length?new Set(t.includeDomains):null,a=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!it.has(n))continue;if(a?.has(n))continue;if(o&&!o.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(r?.has(h)&&!s?.has(h))continue;const g=p.device_id;if(!d.has(g)){const e=l[g];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const r=e.area_id??p.area_id,o=r?c[r]?.name:void 0;d.set(g,{device_id:g,name:e.name_by_user??e.name??g,area:o,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const u=d.get(g);"shelly"===h&&(u.isShelly=!0,u.integration="shelly");const v=e.states[t];u.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:g,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const r=l[s],o=i?.configuration_url??"",a=r?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=o&&a&&n(o)===n(a),h=!o&&a&&t.integration===d.get(s).integration;if(!c&&!h)continue;const g=d.get(s);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},g=new Map;for(const e of d.keys())for(const t of h(l[e]))g.has(t)||g.set(t,[]),g.get(t).push(e);const u=new Map,v=e=>{let t=e;for(let e=0;u.has(t)&&e<8;e++)t=u.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of g.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),u.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!pt(e)||"devices"===t&&ht(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function rt(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const ot=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),at=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),nt=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),lt=new Set(["switch","light","cover","climate","valve"]),ct={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function dt(e){return e.entities.filter(e=>"primary"===rt(e)&&!lt.has(e.domain)&&e.domain in ct)}const pt=e=>e.entities.some(e=>"primary"===rt(e)&&at.has(e.domain)),ht=e=>e.entities.some(e=>"primary"===rt(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&nt.has(e.attributes?.device_class??""));const gt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},ut={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function vt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:ut[e]}const ft={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function mt(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function bt(e){const t=mt(e);return t&&t.flat()}const yt={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},xt=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const wt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},kt=["power","temperature","humidity","battery"],_t={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function At(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),o=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||o?"sensor":"input"}else s="input";return s}const Ct=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),St={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=At(e);if(Ct.has(t)){const i=function(e){if(e)for(const t of xt)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:Tt(e.model??""),label:gt[t],integration:e.integration}}},zt={id:"generic",matches:()=>!0,detect:e=>{const t=At(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":gt[t],integration:e.integration}}},Et=[St,zt];function It(e){for(const t of Et)if(t.matches(e))return t.detect(e);return zt.detect(e)}function Tt(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Mt={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Ot(e){return Mt[e.toLowerCase()]??e.toUpperCase().slice(0,6)}const Dt="—";function Rt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Dt}function Bt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Dt}function Pt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Dt}function Ft(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Dt}function Lt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Dt}function Nt(e){return!Number.isFinite(e)||e<0?Dt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ht(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Dt}function jt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Dt}function Ut(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Dt}function Wt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Dt}function $t(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Dt}function qt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Dt}function Gt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Dt}function Vt(e){return Number.isFinite(e)?`${Math.round(e)} %`:Dt}const Zt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Xt=Object.fromEntries(Zt.map(e=>[e.key,e.label.split(" ")[0]])),Qt={co2:"carbon_dioxide",rssi:"signal_strength"};function Yt(e){return Qt[e]??e}function Kt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(Yt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=Yt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Jt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],ei=["online","offline","power","alerts"],ti=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Light",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],ii=["power","energy","voltage","current","temperature"],si=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:ei});function ri(){return{...si,header_chips:[...si.header_chips??[]]}}function oi(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function ai(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function ni(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function li(e,t,i,s){let r=e.trim();const o=t.trim();return o&&r.toLowerCase().startsWith(o.toLowerCase())&&(r=r.slice(o.length).trim()),r||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function ci(e,t){const i=e.entities.filter(oi),s=e.entities.filter(ai),r=new Set,o=[];return i.forEach((i,a)=>{const n=t[i.entity_id],l=ni(i.entity_id),c=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),o=s.find(e=>!r.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return o||(null!=t?s.find(e=>!r.has(e.entity_id)&&ni(e.entity_id)===t):void 0)})(i,l);c&&r.add(c.entity_id);const d=c?t[c.entity_id]:null,p=d?.attributes?.event_type;o.push({entityId:i.entity_id,label:li(n?.attributes?.friendly_name??"",e.name,l,i.entity_id),isOn:"on"===n?.state,isButton:!!c,channel:l??0,lastEvent:p??null,lastChanged:n?.last_changed??null,_sort:l??50+a})}),s.filter(e=>!r.has(e.entity_id)).forEach((i,s)=>{const r=t[i.entity_id],a=ni(i.entity_id),n=r?.state&&"unknown"!==r.state&&"unavailable"!==r.state?r.state:null;o.push({entityId:i.entity_id,label:li(r?.attributes?.friendly_name??"",e.name,a,i.entity_id),isOn:!1,isButton:!0,channel:a??0,lastEvent:r?.attributes?.event_type??null,lastChanged:r?.last_changed??n,_sort:a??50+s})}),o.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}function di(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:o,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=o.graph_style?.sensor_ranges??{},d=o.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),r=g+e*Math.sin(b(v)),o=h+e*Math.cos(b(i)),a=g+e*Math.sin(b(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${o.toFixed(2)} ${a.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return q`
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",g=n.whiteValue??0,u=o.states[n.entityId],v=u?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),r=s-Math.min(e,t,i);let o=0;r>0&&(o=s===e?((t-i)/r+6)%6:s===t?(i-e)/r+2:(e-t)/r+4);const a=0===s?0:r/s,l=(e=>e*Math.PI/180)(60*o-90);return{x:hi+62*a*Math.cos(l),y:hi+62*a*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${pi}" height="${pi}" viewBox="0 0 ${pi} ${pi}"
            ...
            <foreignObject x="0" y="0" width="${pi}" height="${pi}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${pi}px;height:${pi}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
      ...
      `;default:return q``}var C}const vi=255;function fi(e){return q`
    ...
    ${bi(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return q`
    ...
    ${bi(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return q`
    <div class="ds-section">
    ...
    ${bi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,o=Math.round(r/vi*100);return q`
    <div class="ds-section">
    ...
    ${bi(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return q`
    <div class="ds-section">
    ...
    ${bi(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return q`
    <div class="ds-section">
    ...
    ${bi(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return q`
    <div class="ds-section">
    ...
    ${bi(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return q`${bi(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return q`
    ...
    ${bi(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return q`
    <div class="ds-section">
    ...
    ${bi(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    ${bi(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return q`
    ${t?q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${bi(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    </div>`}function mi(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function bi(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return q`
    ${r&&s?mi(e):Z}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),E=z-S||1,I=s[0].t,T=s[s.length-1].t,M=T-I||1,O=e=>(e.t-I)/M*o,D=e=>a-4-(e.v-S)/E*(a-8),R=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=O(s[0]).toFixed(1),P=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,F=A[A.length-1],L=F%1==0?`${F}`:F.toFixed(1),N=Math.max(...A),H=Math.min(...A);let j=A.indexOf(N),U=A.indexOf(H);j<0&&(j=0),U<0&&(U=0);const W=O(s[j]).toFixed(1),$=D(s[j]).toFixed(1),V=O(s[U]).toFixed(1),X=D(s[U]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+T)/2),K=f/M*o,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return q`
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return q``;const r=(t?s.on:s.off)??"none";return"none"===r?q``:Qe(r,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i,s){return ui(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return q`
    ...
    `:Z;return p.length||g||r||o||a||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${_e(l)}
          ...
          ${De(o,e=>e.join("+"),e=>1===e.length?ui(c,e[0]):q`<div class="tile-row">${e.map(e=>ui(c,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return q`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?di(this._buildTileCtx(e,s,y),m):"light-control"===v?gi(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:r}=e,o=e.getTrv(t);if(!o)return Ge(t,s,"ts-climate","No climate entity");const a="heating"===o.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return q`
    ...
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(yi._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return q``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return q``;const r=s.reduce((e,t)=>e+(this._getPower(t)??0),0),o=s.filter(e=>this._isOnline(e)).length,a=this._config.columns??3,n=this._config.area_styles?.Favourites?.tile_style;return q`
    ...
    `],e([ve({attribute:!1})],ki.prototype,"hass",void 0),e([ve({type:Boolean})],ki.prototype,"preview",void 0),e([fe()],ki.prototype,"_config",void 0),e([fe()],ki.prototype,"_closedAreas",void 0),e([fe()],ki.prototype,"_entityListOpen",void 0),e([fe()],ki.prototype,"_graphData",void 0),e([fe()],ki.prototype,"_periodEnergy",void 0),e([fe()],ki.prototype,"_periodEnergyErrAt",void 0),e([fe()],ki.prototype,"_valveDragPos",void 0),e([fe()],ki.prototype,"_trvDragTemp",void 0),e([fe()],ki.prototype,"_cloudDetailOpen",void 0),e([fe()],ki.prototype,"_detailDevice",void 0),e([fe()],ki.prototype,"_detailHistoryRange",void 0),e([fe()],ki.prototype,"_activeViewId",void 0),e([fe()],ki.prototype,"_delegateNoticeDismissed",void 0),e([fe()],ki.prototype,"_tileBlockOverride",void 0),e([fe()],ki.prototype,"_tileChipOverride",void 0),e([fe()],ki.prototype,"_areaHeaderOverride",void 0),e([fe()],ki.prototype,"_tileShowGraphsOverride",void 0),e([fe()],ki.prototype,"_areaCustomizeOpen",void 0),ki=yi=e([he("ha-device-dashboard")],ki);const _i=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),_i(e,t);return!0},Ai=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Ci=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Ei(t)}};function Si(e){void 0!==this._$AN?(Ai(this),this._$AM=e,Ci(this)):this._$AM=e}function zi(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)_i(s[e],!1),Ai(s[e]);else null!=s&&(_i(s,!1),Ai(s));else _i(this,e)}const Ei=e=>{e.type==be&&(e._$AP??=zi,e._$AQ??=Si)};class Ii extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Ci(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(_i(this,e),Ai(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ti=new WeakMap,Mi=ye(class extends Ii{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ti.get(t);void 0===i&&(i=new WeakMap,Ti.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ti.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Oi=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Te(e),this.key=t),i}}),Di=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Ri;const Bi=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Pi=!1;const Fi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Li=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Ni=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Hi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let ji=Ri=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=Kt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of He)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Z}connectedCallback(){super.connectedCallback(),function(){if(Pi||"undefined"==typeof document)return;const e=Bi.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),Pi=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;try{if(window.matchMedia("(min-width: 1600px)").matches){const e=s;!1===e.large&&"function"==typeof e._enlarge&&e._enlarge()}}catch{}const o="ha-device-dashboard-editor-fix";if(!r.getElementById(o)){const e=document.createElement("style");e.id=o,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const a=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),o=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(o,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);a(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),a(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),a(o,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return q`
      ...
      </span>`}_chipPicker(e,t,i,s){const r=t??[],o=void 0!==e,a=Fi.flatMap(e=>e.items.map(e=>e.key)),n=new Set(o?e:r.length?r:a);return q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${o?"Custom selection":`Inheriting from ${i}`}</span>
          ${this._selAllNone(()=>s([...a]),()=>s([]))}
          ${o?q`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:q`<button class="color-reset" @click=${()=>s([...n])}>Customize</button>`}
        </div>
        ${Fi.map(t=>q`
          <div class="chip-picker-grp">
            ...
            <div class="pill-grp">
              ${t.items.map(t=>q`
                <span class="pill ${n.has(t.key)?"on":""} ${o?"":"dim"}"
                  @click=${()=>(t=>{const i=o?[...e]:[...n],r=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(r.length?r:void 0)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const r=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${Mi(e=>e?.focus())}/>`:q`<span class="pill ${e===r?"on":""}" @click=${()=>s(r)}>
                ${i.label||t}
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>Li.find(t=>t.id===e)?.label??e)(e)}</span>`,n=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="tile-preview-live" style="--accent:${n}">
          ${s.length?s.map(e=>q`<div class="tp-prow">${e.map(e=>this._blockPreview(e,n))}</div>`):q`<div style="color:var(--t3);font-size:11px;padding:8px;text-align:center">All blocks hidden</div>`}
        </div>
        <div class="lay-canvas">
          ${s.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>a(e,t,i))}
              ${e.length<Ri.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
          <div class="lay-row lay-new">＋ new row</div>
        </div>
        <div class="field-lbl" style="margin-top:6px">Hidden blocks</div>
        <div class="lay-palette">
          ${o.length?o.map((e,t)=>a(e,-1,t)):q`<span class="dev-style-hint">drag a block here to hide it</span>`}
        </div>
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=Li.map(e=>e.id),s=this._config.tile_layout??i,r=bt(s),o=bt(t.tile_layout)??null,a=t.entity_animations??{},n=a=>{const n=(o??r).includes(a),l=function(e,t,i,s){const r=mt(e).map(e=>[...e]);if(!i)return r.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(r.some(e=>e.includes(t)))return r;const o=e=>{const t=s.indexOf(e);return t<0?s.length:t},a=r.findIndex(e=>o(e[0])>o(t));return r.splice(a<0?r.length:a,0,[t]),r}(t.tile_layout??s,a,!n,i),c=JSON.stringify(l)===JSON.stringify(mt(s));this._setDeviceStyle(e,{tile_layout:c?void 0:l})},l=(t,i,s)=>{const r={...a[t]??{}};if("speed"===i){const e=Number(s);1===e?delete r.speed:r.speed=e}else"none"===s?delete r[i]:r[i]=s;const o={...a,[t]:r};r.on||r.off||r.speed||delete o[t],this._setDeviceStyle(e,{entity_animations:Object.keys(o).length?o:void 0})},c=this._allDevices().find(t=>t.device_id===e),d=c?It(c):null,p=d?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[d.type]:void 0,h=t.tile_style,g=t.power_monitor_variant??"big-number",u=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${p&&!h?q`<span class="dev-style-hint">Recommended: ${p}</span>`:Z}
          ${h?q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:Z}
        </div>
        ${this._renderTileStylePicker(h,g,p,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}))}
      </div>`,v=c?c.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return q`
      <div class="dev-style-panel">
        <div class="field" style="margin-bottom:6px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
            Type
            ${c?.model?q`<span class="dev-style-hint">${c.model}</span>`:Z}
          ...
          <select class="inline-text" style="width:100%"
            ...
            <option value="" ?selected=${!t.profile}>Auto${d?` — detected: ${gt[d.type]||d.type||"generic"}`:""}</option>
        ...
        ${(()=>{const i=c?It(c):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&c?vt(i.type,c):void 0)??this._config.tile_style,l=this._baseStyleOf(a);return l&&"default"!==l?Z:q`
            ...
            ${this._adv(q`
                ...
                <div class="block-toggles">
                  ${Li.filter(e=>"graph"!==e.id).map(e=>{const t=null===o?r.includes(e.id):o.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ${(()=>{const i=c?ci(c,this.hass.states):[];if(!i.length)return Z;const s=t.input_actions??{},r=(t,i)=>{const r={...s};i?r[t]={...r[t]??{action:"none"},...i}:delete r[t],this._setDeviceStyle(e,{input_actions:Object.keys(r).length?r:void 0})};return q`
        ...
        ${this._adv(v.length?q`
          ...
          ${v.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,r=a[t.entity_id]?.on??"none",o=a[t.entity_id]?.off??"none",n=a[t.entity_id]?.speed??1;return q`
              <div class="ent-anim-row">
                ...
                ${this._iconPicker(`ent-off-${e}-${t.entity_id}`,"none"===o?void 0:o,!1,e=>l(t.entity_id,"off",e??"none"))}
        ...
        ${this._adv(c?.entities.length?q`
          ...
          <div class="block-toggles">
            ${c.entities.map(e=>{const t=this._config.hidden_entities??[],i=t.includes(e.entity_id),s=this.hass?.states[e.entity_id]?.attributes?.friendly_name??e.entity_id.split(".").pop()??e.entity_id;return q`<span class="block-tog ${i?"":"on"}"
    ...
    `,u=q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=Di.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(Di.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};Di.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),r=s[this._tab]??[],o=e=>{if(!r.length)return;const t={...this._openSections};for(const i of r)t[i]=e;this._openSections=t},a=r.length>1;return q`
      <div class="shell">
        <div class="tab-nav">
          ${e.map(e=>q`
      ...
      </div>`}};ji.ROW_MAX=3,ji.DRAG_SLOP=6,ji._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],ji.styles=[Ke,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],ji.prototype,"hass",void 0),e([fe()],ji.prototype,"_config",void 0),e([fe()],ji.prototype,"_tab",void 0),e([fe()],ji.prototype,"_styleScope",void 0),e([fe()],ji.prototype,"_cardThemeRoom",void 0),e([fe()],ji.prototype,"_newStyleName",void 0),e([fe()],ji.prototype,"_renamingStyle",void 0),e([fe()],ji.prototype,"_advanced",void 0),e([fe()],ji.prototype,"_defaultsOpen",void 0),e([fe()],ji.prototype,"_resetArmed",void 0),e([fe()],ji.prototype,"_xcPlacement",void 0),e([fe()],ji.prototype,"_xcRoom",void 0),e([fe()],ji.prototype,"_xcAdding",void 0),e([fe()],ji.prototype,"_xcEditIndex",void 0),e([fe()],ji.prototype,"_xcDraft",void 0),e([fe()],ji.prototype,"_xcDashboards",void 0),e([fe()],ji.prototype,"_xcImportCards",void 0),e([fe()],ji.prototype,"_xcImportLoading",void 0),e([fe()],ji.prototype,"_pendingTheme",void 0),e([fe()],ji.prototype,"_savedTheme",void 0),e([fe()],ji.prototype,"_expandedViewId",void 0),e([fe()],ji.prototype,"_openSections",void 0),e([fe()],ji.prototype,"_expandedRooms",void 0),e([fe()],ji.prototype,"_expandedRoomStyle",void 0),e([fe()],ji.prototype,"_selectedDeviceId",void 0),e([fe()],ji.prototype,"_deviceSearch",void 0),e([fe()],ji.prototype,"_styleClipFeedback",void 0),e([fe()],ji.prototype,"_openDiscDropdown",void 0),e([fe()],ji.prototype,"_iconPickerState",void 0),ji=Ri=e([he("ha-device-dashboard-editor")],ji);let Ui=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Ui.styles=n`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Ui.prototype,"hass",void 0),e([ve()],Ui.prototype,"entity",void 0),e([ve({attribute:!1})],Ui.prototype,"features",void 0),e([fe()],Ui.prototype,"_el",void 0),Ui=e([he("hdd-delegated")],Ui);let Wi=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Wi.styles=n`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Wi.prototype,"hass",void 0),e([ve({attribute:!1})],Wi.prototype,"config",void 0),e([fe()],Wi.prototype,"_el",void 0),Wi=e([he("hdd-card")],Wi);console.info("%c ha-device-dashboard %c inputs-2026-08-19e ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
