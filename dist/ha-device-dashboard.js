...
`;function je(e,t,i="ts-hero-name"){return G`
    ...
    </div>`}const Ue={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const We=[3,7,11,15,19,23,27];function qe(e,t,i,s){if("none"===e)return G``;const r=t?"on":"off";return"flame"===e?G`${Z`<svg class="${s} ent-icon-flame ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?G`${Z`<svg class="${s} ent-icon-fan ${r}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?G`${Z`<svg class="${s} ent-icon-pulse ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?G`${Z`<svg class="${s} ent-icon-sun ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?G`${Z`<svg class="${s} ent-icon-lightning ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?G`${Z`<svg class="${s} ent-icon-heart ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?G`${Z`<svg class="${s} ent-icon-bulb ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?G`${Z`<svg class="${s} ent-icon-leaf ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?G`${Z`<svg class="${s} ent-icon-flame2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?G`${Z`<svg class="${s} ent-icon-flame3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?G`${Z`<svg class="${s} ent-icon-fan2 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?G`${Z`<svg class="${s} ent-icon-fan3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?G`${Z`<svg class="${s} ent-icon-lightning2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?G`${Z`<svg class="${s} ent-icon-lightning3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?G`${Z`<svg class="${s} ent-icon-bulb2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?G`${Z`<svg class="${s} ent-icon-bulb3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?G`${Z`<svg class="${s} ent-icon-water3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?G`${Z`<svg class="${s} ent-icon-sun2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?G`${Z`<svg class="${s} ent-icon-sun3 ${r}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?G`${Z`<svg class="${s} ent-icon-moon2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?G`${Z`<svg class="${s} ent-icon-moon3 ${r}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?G`${Z`<svg class="${s} ent-icon-wind ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?G`${Z`<svg class="${s} ent-icon-wind2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?G`${Z`<svg class="${s} ent-icon-wind3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?G`${Z`<svg class="${s} ent-icon-bell ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?G`${Z`<svg class="${s} ent-icon-bell2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?G`${Z`<svg class="${s} ent-icon-bell3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?G`${Z`<svg class="${s} ent-icon-thermometer ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?G`${Z`<svg class="${s} ent-icon-thermometer2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?G`${Z`<svg class="${s} ent-icon-thermometer3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?G`${Z`<svg class="${s} ent-icon-battery ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?G`${Z`<svg class="${s} ent-icon-battery2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?G`${Z`<svg class="${s} ent-icon-battery3 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?G`${Z`<svg class="${s} ent-icon-star ${r}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?G`${Z`<svg class="${s} ent-icon-star2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?G`${Z`<svg class="${s} ent-icon-star3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?G`${Z`<svg class="${s} ent-icon-pulse2 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?G`${Z`<svg class="${s} ent-icon-pulse3 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?G`${Z`<svg class="${s} ent-icon-wave2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?G`${Z`<svg class="${s} ent-icon-wave3 ${r}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?G`${Z`<svg class="${s} ent-icon-wave4 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?G`${Z`<svg class="${s} ent-icon-heart2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?G`${Z`<svg class="${s} ent-icon-leaf2 ${r}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lock2"===e?G`${Z`<svg class="${s} ent-icon-lock2 ${r}" style="${i}" viewBox="0 0 20 20">
    <rect x="5" y="9" width="10" height="8" rx="2" fill="currentColor" opacity="0.9"/>
...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Qe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,r=i?new Set([...$e,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,a=i&&t.includeDomains?.length?new Set(t.includeDomains):null,o=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!Ye.has(n))continue;if(o?.has(n))continue;if(a&&!a.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(r?.has(h)&&!s?.has(h))continue;const g=p.device_id;if(!d.has(g)){const e=l[g];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const r=e.area_id??p.area_id,a=r?c[r]?.name:void 0;d.set(g,{device_id:g,name:e.name_by_user??e.name??g,area:a,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const u=d.get(g);"shelly"===h&&(u.isShelly=!0,u.integration="shelly");const v=e.states[t];u.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:g,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const r=l[s],a=i?.configuration_url??"",o=r?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=a&&o&&n(a)===n(o),h=!a&&o&&t.integration===d.get(s).integration;if(!c&&!h)continue;const g=d.get(s);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),p.add(e)}for(const e of p)d.delete(e);let h=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(h=h.filter(e=>function(e,t){return"all"===t||(!!at(e)||"devices"===t&&ot(e))}(e,t.scope??"devices"))),h.sort((e,t)=>e.name.localeCompare(t.name))}function Je(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const $e=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),et=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),tt=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),it=new Set(["switch","light","cover","climate","valve"]),st={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function rt(e){return e.entities.filter(e=>"primary"===Je(e)&&!it.has(e.domain)&&e.domain in st)}const at=e=>e.entities.some(e=>"primary"===Je(e)&&et.has(e.domain)),ot=e=>e.entities.some(e=>"primary"===Je(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&tt.has(e.attributes?.device_class??""));const nt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},lt={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function ct(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:lt[e]}const dt={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function pt(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function ht(e){const t=pt(e);return t&&t.flat()}const gt={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},ut=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const vt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},ft=["power","temperature","humidity","battery"],mt={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function bt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}else s="input";return s}const yt=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),xt={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=bt(e);if(yt.has(t)){const i=function(e){if(e)for(const t of ut)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:At(e.model??""),label:nt[t],integration:e.integration}}},wt={id:"generic",matches:()=>!0,detect:e=>{const t=bt(e);return{type:t,gen:"other",label:nt[t],integration:e.integration}}},kt=[xt,wt];function _t(e){for(const t of kt)if(t.matches(e))return t.detect(e);return wt.detect(e)}function At(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Ct={shelly:"Shelly",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const St="—";function zt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:St}function It(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:St}function Ot(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:St}function Mt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:St}function Tt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:St}function Et(e){return!Number.isFinite(e)||e<0?St:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Bt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":St}function Dt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:St}function Rt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:St}function Pt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:St}function Ft(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:St}function Lt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:St}function Nt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:St}function jt(e){return Number.isFinite(e)?`${Math.round(e)} %`:St}const Ht=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Ut=Object.fromEntries(Ht.map(e=>[e.key,e.label.split(" ")[0]])),Wt={co2:"carbon_dioxide",rssi:"signal_strength"};function qt(e){return Wt[e]??e}function Gt(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(qt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=qt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Zt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Xt=["online","offline","power","alerts"],Qt=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:Xt});function Vt(){return{...Qt,header_chips:[...Qt.header_chips??[]]}}function Yt(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),r=g+e*Math.sin(b(v)),a=h+e*Math.cos(b(i)),o=g+e*Math.sin(b(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return G`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,r=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),a="W"===e.label||"A"===e.label?"left":"right",o=(h+s*("left"===a?-1:1)).toFixed(1),n=(g+8).toFixed(1),l="left"===a?"start":"end";return Z`
    ...
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=i.max??Math.max(...e),o=r-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/o*(p-2*h),m=e.indexOf(r);v=n(null,m),f=l(r);const b=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return Z`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    ${r>s?Z`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${u}"/>
    ...
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return Z`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=a.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),r=(i.max??Math.max(...e))-s||1,o=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/r*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return Z`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      ...
      `}case"sensors":{if(!u.length)return G``;const e=u.filter(e=>"primary"===(e.tier??"primary")),t=u.filter(e=>"electrical"===e.tier),i=u.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),r=new Map;for(const e of t){const t=e.ch??"";r.has(t)||r.set(t,[]),r.get(t).push(e)}const a=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return G`
        ...
        ${i.length?G`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>G`${t>0?G`<span class="sep">·</span>`:Q}<span class="${e.warn?"warn":""}">${a(e)}</span>`)}
          </div>`:Q}
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${a?G`<div class="ds-fw-update"><span>FW update: ${a.current} → ${a.newVersion}</span></div>`:Q}
    ...
    ${ri(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return G`
    ...
    ${ri(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return G`
    <div class="ds-section">
    ...
    ${ri(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/ti*100);return G`
    <div class="ds-section">
    ...
    ${ri(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return G`
    <div class="ds-section">
    ...
    ${ri(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return G`
    <div class="ds-section">
    ...
    ${ri(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return G`
    <div class="ds-section">
    ...
    ${ri(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return G`${ri(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return G`
    ...
    ${r.length?G`<div class="ds-section ds-alert-row">${r.map(e=>G`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:Q}
    ${ri(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return G`
    <div class="ds-section">
    ...
    ${ri(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return G`
    ${s.length?G`
      <div class="ds-section">
    ...
    ${ri(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return G`
    ${t?G`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${ri(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return G`
    ${s.length?G`
      <div class="ds-section">
    ...
    </div>`}function ri(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return G`
    ${r&&s?si(e):Q}
    ...
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return G``;const s=new Set(e.config.hidden_entities??[]),r=t.entities.filter(e=>!s.has(e.entity_id));if(!r.length)return G``;const a=(t,s)=>{const r=i.states[t.entity_id],a=r?.attributes?.friendly_name??t.entity_id,o=r?.state??"unknown",n=r?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===o,d=r?.last_changed?e.timeAgo(r.last_changed):"";return G`
      ...
      </div>`},o=r.filter(e=>"primary"===Je(e)),n=r.filter(e=>"config"===Je(e)),l=r.filter(e=>"diagnostic"===Je(e));return G`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${o.map(e=>a(e,!1))}
      ${n.length?G`<div class="ds-ent-subgroup">Configuration</div>${n.map(e=>a(e,!0))}`:Q}
      ${l.length?G`<div class="ds-ent-subgroup">Diagnostic</div>${l.map(e=>a(e,!0))}`:Q}
    </div>`}(e)}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?G`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${Bt(r.rssi)} (${r.rssi} dBm)</span></div>`:Q}
        ${null!=r.uptime?G`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${Et(r.uptime)}</span></div>`:Q}
        ...
        ${i.length?G`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Q}
          ...
          </div>`;const _=s.map(e=>e.v),A=(this._config.graph_style?.sensor_ranges??{})[w]??{},C=A.min??Math.min(..._),S=A.max??Math.max(..._),z=S-C||1,I=s[0].t,O=s[s.length-1].t,M=O-I||1,T=e=>(e.t-I)/M*a,E=e=>o-4-(e.v-C)/z*(o-8),B=s.map(e=>`${T(e).toFixed(1)},${E(e).toFixed(1)}`).join(" "),D=T(s[0]).toFixed(1),R=`sg-${r.replace(/[^a-z0-9]/gi,"")}`,P=_[_.length-1],F=P%1==0?`${P}`:P.toFixed(1),L=Math.max(..._),N=Math.min(..._);let j=_.indexOf(L),H=_.indexOf(N);j<0&&(j=0),H<0&&(H=0);const U=T(s[j]).toFixed(1),W=E(s[j]).toFixed(1),q=T(s[H]).toFixed(1),X=E(s[H]).toFixed(1),V=b(s[0].t),Y=b((s[0].t+O)/2),K=v/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,$=c&&S-C>0;return G`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Q:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="none"
                ...
                `:Q}
                ${"bar"!==h&&g?Z`
                  <polygon points="${B} ${a},${o-4} ${D},${o-4}" fill="url(#${R})"/>
                `:Q}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=T(e)-t/2,r=E(e),n=o-4-r;return Z`<rect x="${i.toFixed(1)}" y="${r.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="1.5" fill="${k}" opacity="0.75"/>`}):Z`
    ...
    `}_trvTempFromEvent(e,t,i,s,r){const a=t.getBoundingClientRect();if(!a.width||!a.height)return null;const o=(e.clientX-a.left)*(160/a.width),n=(e.clientY-a.top)*(132/a.height);let l=Math.atan2(n-70,o-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=r||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),r=(e.clientY-i.top)*(128/i.height);let a=Math.atan2(r-68,s-80)*(180/Math.PI)+90;a<0&&(a+=360);const o=(a-210+360)%360;return o>300?null:Math.round(o/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[r,a]=i(e,s),[o,n]=i(t,s);return`M ${r} ${a} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${o} ${n}`},r=e.supportsPosition||!!e.numEntityId,a=this._valveDragPos??t,o=(e=>210+e/100*300)(a),[n,l]=i(o,54),c=`hsl(${200+.2*a}, ${40+.55*a}%, ${38+.18*a}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=r?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},r=t=>{const a=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=a&&this._setValvePosition(e.entityId,a,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",r)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",r)}:void 0;return Z`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${r?"valve-interactive":""}"
        ...
        ${r?Z`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:Q}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:r,isHeating:a,valveOpen:o,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?Z`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`;if("cover"===l){const e=s??("open"===r?100:"closed"===r?0:50),t="opening"===r||"closing"===r,i=[2,5.5,9,12.5,16],a=Math.ceil(e/100*i.length);return Z`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
      ...
      </svg>`}return"climate"===l||"wall_display"===l?Z`<svg class="tile-icon tile-icon-flame ${a?"on":""}" viewBox="0 0 20 20">
    ...
    `:Q;return p.length||g||r||a||o||S.length>1?G`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${o}" style=${_e(l)}
          ...
          ${Be(a,e=>e.join("+"),e=>1===e.length?ei(c,e[0]):G`<div class="tile-row">${e.map(e=>ei(c,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return G`<div class="${`tile tile-${o} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?Yt(this._buildTileCtx(e,s,y),m):"light-control"===v?$t(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return He(t,s,"ts-climate","No climate entity");const o="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return G`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("stats")?G`<div class="trv-stat-row">
        ...
        ${null!=a.valvePosition?G`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(a.valvePosition)}%</span></div>`:Q}
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-cover-top">
        ${je(t,s)}
        ${e.showEl("position_pct")?G`<span class="ts-cover-pct" style="color:${i}">${Math.round(a)}%</span>`:Q}
      </div>
      ${e.showEl("shutter_graphic")?G`<div class="ts-cover-graphic">
        ...
        ${o&&e.showEl("moving_label")?G`<span class="ts-cover-state">${"opening"===r.state?"▲ Opening…":"▼ Closing…"}</span>`:Q}
      </div>`:Q}
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?G`<span class="fav-chip fav-chip-power">${zt(r)}</span>`:Q}
          </div>
        </div>
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0;let r;if(void 0!==i)r=new Set(i);else if(void 0!==s)r=new Set(s);else{const e=t?this._config.area_styles?.[t]?.sensors:void 0,i=e?.length?e:this._config.sensors;r=i?.length?new Set(i):null}const a=e=>!r||r.has(e),o={},n=(e,t)=>{o[e]||(o[e]={sum:0,count:0}),o[e].sum+=t,o[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"";"power"===s&&a("power")?n("power",i):"energy"===s&&a("energy")?n("energy",i):"temperature"===s&&a("temperature")?n("temperature",i):"humidity"===s&&a("humidity")?n("humidity",i):"carbon_dioxide"===s&&a("co2")?n("co2",i):"illuminance"===s&&a("illuminance")&&n("illuminance",i)}const l=[];return o.power&&l.push({label:"Power",value:zt(o.power.sum)}),o.energy&&l.push({label:"Energy",value:It(o.energy.sum)}),o.temperature&&l.push({label:"Temp",value:Tt(o.temperature.sum/o.temperature.count)}),o.humidity&&l.push({label:"Hum",value:Ft(o.humidity.sum/o.humidity.count)}),o.co2&&l.push({label:"CO₂",value:Nt(o.co2.sum/o.co2.count)}),o.illuminance&&l.push({label:"Light",value:Lt(o.illuminance.sum/o.illuminance.count)}),l}_areaHeaderCandidates(e,t){const i=[["power","Power","power"],["energy","Energy","energy"],["temperature","Temp","temperature"],["humidity","Hum","humidity"],["co2","CO₂","carbon_dioxide"],["illuminance","Light","illuminance"]],s=new Set;for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];t&&s.add(t.attributes.device_class??"")}const r=this._areaHeaderOverride.get(t),a=this._config.area_styles?.[t]?.header_chips;let o;if(void 0!==r)o=new Set(r);else if(void 0!==a)o=new Set(a);else{const e=this._config.area_styles?.[t]?.sensors,i=e?.length?e:this._config.sensors;o=i?.length?new Set(i):null}const n=[];for(const[e,t,r]of i)s.has(r)&&n.push({key:e,label:t,visible:!o||o.has(e)});return n}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,r=(t,s)=>{const r=new Set(i.filter(e=>e.visible).map(e=>e.key));s?r.add(t):r.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>r.has(e)))};return G`
      ...
      <div class="area-section ${s?"closed":""} ${o?.bg_image&&"ambient"===o.bg_image_mode?"area-bg-ambient":""}" style=${_e(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?G`<span class="area-power">${zt(a)}</span>`:Q}
    ...
    `}render(){if(!this._config||!this.hass)return G``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return G`
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?Be([...o.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):G`<div class="device-grid" style="--cols:${r?.columns??this._config.columns??3}">
                ${Be(a,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
      </ha-card>
    `;return m}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return G``;const t=e.filter(e=>rt(e).length>0).length;return t?G`
    ...
    `],e([ve({attribute:!1})],li.prototype,"hass",void 0),e([ve({type:Boolean})],li.prototype,"preview",void 0),e([fe()],li.prototype,"_config",void 0),e([fe()],li.prototype,"_closedAreas",void 0),e([fe()],li.prototype,"_entityListOpen",void 0),e([fe()],li.prototype,"_graphData",void 0),e([fe()],li.prototype,"_valveDragPos",void 0),e([fe()],li.prototype,"_trvDragTemp",void 0),e([fe()],li.prototype,"_cloudDetailOpen",void 0),e([fe()],li.prototype,"_detailDevice",void 0),e([fe()],li.prototype,"_detailHistoryRange",void 0),e([fe()],li.prototype,"_activeViewId",void 0),e([fe()],li.prototype,"_delegateNoticeDismissed",void 0),e([fe()],li.prototype,"_tileBlockOverride",void 0),e([fe()],li.prototype,"_tileChipOverride",void 0),e([fe()],li.prototype,"_areaHeaderOverride",void 0),e([fe()],li.prototype,"_tileShowGraphsOverride",void 0),e([fe()],li.prototype,"_areaCustomizeOpen",void 0),li=ai=e([he("ha-device-dashboard")],li);const ci=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),ci(e,t);return!0},di=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},pi=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),ui(t)}};function hi(e){void 0!==this._$AN?(di(this),this._$AM=e,pi(this)):this._$AM=e}function gi(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)ci(s[e],!1),di(s[e]);else null!=s&&(ci(s,!1),di(s));else ci(this,e)}const ui=e=>{e.type==be&&(e._$AP??=gi,e._$AQ??=hi)};class vi extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),pi(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ci(this,e),di(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const fi=new WeakMap,mi=ye(class extends vi{render(e){return Q}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Q}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=fi.get(t);void 0===i&&(i=new WeakMap,fi.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?fi.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),bi={warm_dusk:{accent_color:"#c98a63",card_bg:"#1e1a17",tile_bg:"rgba(255,244,232,0.035)",tile_border:"rgba(255,244,232,0.08)",tile_hover_bg:"rgba(255,244,232,0.06)",tile_hover_shadow:"rgba(0,0,0,0.35)",tile_sensor_bg:"rgba(255,244,232,0.045)",tile_exp_bg:"rgba(255,244,232,0.05)",text_primary:"#ece5dc",text_secondary:"#b3a596",text_muted:"#7e7265",header_bg:"#241f1b",header_bg2:"#33291f",header_text_color:"#f3ece3",header_orb_color:"#c98a63",online_color:"#93b384",offline_color:"#d47f62",power_color:"#dba25c",area_header_color:"#c98a63"},dark_industrial:{accent_color:"#f4601e",card_bg:"#1c1c1e",tile_bg:"rgba(255,255,255,0.04)",tile_border:"rgba(255,255,255,0.07)",tile_hover_bg:"rgba(255,255,255,0.07)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(255,255,255,0.04)",tile_exp_bg:"rgba(255,255,255,0.06)",text_primary:"#e5e7eb",text_secondary:"#9ca3af",text_muted:"#6b7280",header_bg:"#1a1a2e",header_bg2:"#0f3460",header_text_color:"#ffffff",header_orb_color:"#3b82f6",online_color:"#4ade80",offline_color:"#ef4444",power_color:"#fb923c",area_header_color:"#f4601e"},teal_terminal:{accent_color:"#2dd4bf",card_bg:"#0b0f0e",tile_bg:"#0f1917",tile_border:"#1e2b28",tile_hover_bg:"rgba(45,212,191,0.08)",tile_hover_shadow:"rgba(0,0,0,0.40)",tile_sensor_bg:"rgba(45,212,191,0.05)",tile_exp_bg:"rgba(45,212,191,0.07)",text_primary:"#d1fae5",text_secondary:"#6ee7b7",text_muted:"#4b5563",header_bg:"#042f2e",header_bg2:"#0b6157",header_text_color:"#ccfbf1",header_orb_color:"#2dd4bf",online_color:"#34d399",offline_color:"#f87171",power_color:"#fbbf24",area_header_color:"#2dd4bf"},brutalist:{accent_color:"#facc15",card_bg:"#000000",tile_bg:"#0a0a0a",tile_border:"#ffffff",tile_hover_bg:"rgba(255,255,255,0.12)",tile_hover_shadow:"rgba(250,204,21,0.25)",tile_sensor_bg:"rgba(255,255,255,0.06)",tile_exp_bg:"rgba(255,255,255,0.09)",text_primary:"#ffffff",text_secondary:"#d4d4d4",text_muted:"#a3a3a3",header_bg:"#000000",header_bg2:"#171717",header_text_color:"#facc15",header_orb_color:"#facc15",online_color:"#22c55e",offline_color:"#ef4444",power_color:"#facc15",area_header_color:"#ffffff"},frosted_light:{accent_color:"#0071e3",card_bg:"#f2f2f7",tile_bg:"#ffffff",tile_border:"#d1d1d6",tile_hover_bg:"rgba(0,0,0,0.04)",tile_hover_shadow:"rgba(0,0,0,0.12)",tile_sensor_bg:"rgba(0,0,0,0.04)",tile_exp_bg:"rgba(0,0,0,0.05)",text_primary:"#1c1c1e",text_secondary:"#48484a",text_muted:"#8e8e93",header_bg:"#e8eef7",header_bg2:"#cfe0f5",header_text_color:"#1c1c1e",header_orb_color:"#0071e3",online_color:"#34c759",offline_color:"#ff3b30",power_color:"#ff9500",area_header_color:"#0071e3"},nordic_warm:{accent_color:"#d08770",card_bg:"#2e3440",tile_bg:"#3b4252",tile_border:"#434c5e",tile_hover_bg:"rgba(236,239,244,0.06)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(236,239,244,0.04)",tile_exp_bg:"rgba(236,239,244,0.06)",text_primary:"#eceff4",text_secondary:"#d8dee9",text_muted:"#9aa4b8",header_bg:"#3b4252",header_bg2:"#434c5e",header_text_color:"#eceff4",header_orb_color:"#ebcb8b",online_color:"#a3be8c",offline_color:"#bf616a",power_color:"#d08770",area_header_color:"#d08770"},midnight_purple:{accent_color:"#a78bfa",card_bg:"#0f0a1e",tile_bg:"#1a1030",tile_border:"#2e1f4d",tile_hover_bg:"rgba(167,139,250,0.10)",tile_hover_shadow:"rgba(0,0,0,0.45)",tile_sensor_bg:"rgba(167,139,250,0.06)",tile_exp_bg:"rgba(167,139,250,0.08)",text_primary:"#ede9fe",text_secondary:"#c4b5fd",text_muted:"#7c6ba8",header_bg:"#1e1b4b",header_bg2:"#4c1d95",header_text_color:"#ede9fe",header_orb_color:"#a78bfa",online_color:"#4ade80",offline_color:"#fb7185",power_color:"#c084fc",area_header_color:"#a78bfa"}},yi=["warm_dusk","dark_industrial","teal_terminal","brutalist","frosted_light","nordic_warm","midnight_purple"],xi={warm_dusk:"Warm Dusk",dark_industrial:"Dark Industrial",teal_terminal:"Teal Terminal",brutalist:"Brutalist",frosted_light:"Frosted Light",nordic_warm:"Nordic Warm",midnight_purple:"Midnight Purple",custom:"Custom"},wi=Object.keys(bi.dark_industrial);function ki(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of yi){const i=bi[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}const _i=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"device-panel",label:"Per-device style panel"},{id:"room-panel",label:"Per-room style panel"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Ai;const Ci=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Si=!1;const zi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"}]}],Ii=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Oi=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Mi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}],Ti=["style","tile_size","tile_opacity","card_opacity","card_bg_image","card_bg_image_size","tile_layout","graph_style","graph_sensors","graph_hours","graph_line_color","graph_sensor_colors","sensors","sort_by","columns","show_power_bar","power_bar_max","area_styles","device_styles","views","default_view"];let Ei=Ai=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._styleClipFeedback="",this._copyAreaOpen=!1,this._copyJson="",this._pasteOpen=!1,this._pasteText="",this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}setConfig(e){this._config=Gt(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of wi)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Q}connectedCallback(){super.connectedCallback(),function(){if(Si||"undefined"==typeof document)return;const e=Ci.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),Si=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;const a="ha-device-dashboard-editor-fix";if(!r.getElementById(a)){const e=document.createElement("style");e.id=a,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const o=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),a=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(a,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);o(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),o(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),o(a,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return G`
      ...
      </span>`}_chipPicker(e,t,i,s){const r=t??[],a=void 0!==e,o=zi.flatMap(e=>e.items.map(e=>e.key)),n=new Set(a?e:r.length?r:o);return G`
          ...
          ${s?G`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=o.includes(t.device_id),s=!!e.device_styles?.[t.device_id],r=this._selectedDeviceId===t.device_id,a=t.area?G`<span class="fav-dev-area">${t.area}</span>`:Q;return G`
      ...
      ${l.map(t=>{const i=t||"No Room",a=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return G`
          <div class="room-row">
            ...
            ${a.length?G`<span class="room-count">${a.length}</span>`:Q}
      ...
      ${g}`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=(e,t,i,s,r)=>G`
      <div class="field">
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?G`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const r=`custom:${t}`;return this._renamingStyle===t?G`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${mi(e=>e?.focus())}/>`:G`<span class="pill ${e===r?"on":""}" @click=${()=>s(r)}>
                ${i.label||t}
        ...
        ${(()=>{const i=c?_t(c):null,o=t.tile_style??(this._config.smart_tile_styles&&i&&c?ct(i.type,c):void 0)??this._config.tile_style,l=this._baseStyleOf(o);return l&&"default"!==l?Q:G`
            ...
            ${this._adv(G`
                ...
                <div class="block-toggles">
                  ${Ii.filter(e=>"graph"!==e.id).map(e=>{const t=null===a?r.includes(e.id):a.includes(e.id);return G`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
    ...
    `}_renderViewCard(e,t,i,s,r,a,o,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,o,n),g=o.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return G`
      ...
      <div class="field">
        ...
        <div class="color-row">
          ...
          ${t[r]?G`<button class="color-reset" @click=${()=>s(r)}>↺</button>`:Q}
        </div>`},a=G`
      <!-- Title -->
      <div class="field">
      ...
      ${(t.header_border_width??0)>0?r("Border color","header_border_color","#4ade80"):Q}
      `)}
      <!-- Visibility toggles -->
      <div class="tog-row" style="border:none;padding:4px 0 0">
    ...
    `,u=G`
      ...
      <div class="field">
        ...
        `:Q}
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Q,body:a},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Q,body:g},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Q,body:u},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Q,body:l},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Q,body:d}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",r=t.tile_bg??"#1c1c1e",a=t.tile_border??"#2a2a30",o=t.tile_hover_bg??"rgba(255,255,255,0.07)",n=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",g=t.header_bg??"#1a1a2e",u=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",_=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,C=t.tile_radius??12,S=t.tile_border_width??1,z=t.header_radius??0,I=y>0?`${y}px solid ${x}`:"none",O=G`
      ...
      <div class="tog-row">
        ...
        <div class="color-row">
          ...
          ${a?G`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:Q}
        </div>`},l=G`
      ...
      ${a.filter(e=>!o.find(t=>t.key===e)).length?G`
        ...
        ${a.filter(e=>!o.find(t=>t.key===e)).map(e=>{const t=Ht.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??Ht.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Q}
      <div class="field" style="margin-top:10px">
        ...
        <div class="pill-grp">
          ${Ht.map(e=>{const t=a.some(t=>qt(t)===e.key);return G`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return G`
      ...
      </div>`;return{graphtype:{icon:"∿",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Graph Type",badge:Q,body:r},graphcolors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Per-sensor Colors",badge:Q,body:l},graphranges:{icon:"⇕",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Sensor Min / Max",badge:Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):Q,body:p}}}_sensorSectionDescriptors(){const e=this._config,t=e.sensors??[],i={};return zi.forEach(s=>{const r=s.items.map(e=>e.key),a=r.filter(e=>t.includes(e)).length,o=r.every(e=>t.includes(e)),n=this._badge(`${a||"All"} / ${s.items.length}`,s.iconColor,s.iconBg),l=G`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),r=qt(i.key),a=!!Ht.find(e=>e.key===r),o=e.graph_sensors??ft,n=o.some(e=>qt(e)===r);return G`
