...
`;function qe(e,t,i="ts-hero-name"){return q`
    ...
    <div class="input-row ${i.isButton?"btn-mode":i.isOn?"active":""}">
      ...
      ${function(e,t,i){const s=e.getInputActionLabel(t,i),o=e.getInputSelectChip(t,i);if(!s)return o?Ze(e,o):Z;const r=e.inputHasHold(t,i),a=()=>e.endInputHold();return q`
    <button class="input-act ${r?"holdable":""}"
    ...
    <div class="tile-effects" @click=${e=>e.stopPropagation()}>
      <select class="effect-sel"
        ...
        ${r?q`
          <option value=${r} ?selected=${!t||t===r}>— no effect —</option>`:Z}
        ${s.length?q`
          <optgroup label="Sound reactive">${s.map(a)}</optgroup>`:Z}
        <optgroup label="Effects">${o.filter(e=>e!==r).map(a)}</optgroup>
      </select>
...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function rt(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),r=o.filter(i=>null!=e.getInputActionLabel(t,i)),a=o.filter(i=>null==e.getInputActionLabel(t,i)),n=r.length<=1?1:r.length<=4?2:3,l=r.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    <button
      ...
      ${a.length&&e.showEl("input_rows")?q`
        <div class="tile-inputs ${r.length?"ts-inputs-rest":""}"
          @click=${e=>e.stopPropagation()}>
          ${a.map(i=>Ve(e,t,i))}
        </div>`:Z}
    ...
    </div>`}const at=["temperature","humidity","carbon_dioxide","illuminance","battery"],nt=["motion","door","window","moisture","smoke","gas"];const lt=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function ct(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,o=i?new Set([...pt,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,r=i&&t.includeDomains?.length?new Set(t.includeDomains):null,a=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!lt.has(n))continue;if(a?.has(n))continue;if(r&&!r.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(o?.has(h)&&!s?.has(h))continue;const g=p.device_id;if(!d.has(g)){const e=l[g];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const o=e.area_id??p.area_id,r=o?c[o]?.name:void 0;d.set(g,{device_id:g,name:e.name_by_user??e.name??g,area:r,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const u=d.get(g);"shelly"===h&&(u.isShelly=!0,u.integration="shelly");const v=e.states[t];u.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:g,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const o=l[s],r=i?.configuration_url??"",a=o?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=r&&a&&n(r)===n(a),h=!r&&a&&t.integration===d.get(s).integration;if(!c&&!h)continue;const g=d.get(s);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},g=new Map;for(const e of d.keys())for(const t of h(l[e]))g.has(t)||g.set(t,[]),g.get(t).push(e);const u=new Map,v=e=>{let t=e;for(let e=0;u.has(t)&&e<8;e++)t=u.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of g.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),u.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!mt(e)||"devices"===t&&bt(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function dt(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const pt=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),ht=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),gt=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),ut=new Set(["switch","light","cover","climate","valve"]),vt={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function ft(e){return e.entities.filter(e=>"primary"===dt(e)&&!ut.has(e.domain)&&e.domain in vt)}const mt=e=>e.entities.some(e=>"primary"===dt(e)&&ht.has(e.domain)),bt=e=>e.entities.some(e=>"primary"===dt(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&gt.has(e.attributes?.device_class??""));const yt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},xt={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control"};function wt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:xt[e]}const kt={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"input-control":[{id:"name",label:"Name"},{id:"keypad",label:"Channel keys"},{id:"input_rows",label:"Unassigned channel rows"},{id:"target_state",label:"Channel name under the key"},{id:"last_event",label:"Last-pressed time"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function _t(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function At(e){const t=_t(e);return t&&t.flat()}const Ct={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},St=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const zt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},Et=["power","temperature","humidity","battery"],It={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function Tt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),o=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),r=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||o||r?"sensor":"input"}else s="input";return s}const Ot=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),Mt={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=Tt(e);if(Ot.has(t)){const i=function(e){if(e)for(const t of St)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:Pt(e.model??""),label:yt[t],integration:e.integration}}},Dt={id:"generic",matches:()=>!0,detect:e=>{const t=Tt(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":yt[t],integration:e.integration}}},Rt=[Mt,Dt];function Bt(e){for(const t of Rt)if(t.matches(e))return t.detect(e);return Dt.detect(e)}function Pt(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Ft={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Lt(e){return Ft[e.toLowerCase()]??e.toUpperCase().slice(0,6)}const Nt="—";function $t(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Nt}function jt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Nt}function Ht(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Nt}function Ut(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Nt}function Wt(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Nt}function qt(e){return!Number.isFinite(e)||e<0?Nt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Gt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Nt}function Vt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Nt}function Zt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Nt}function Xt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Nt}function Qt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Nt}function Yt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Nt}function Kt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Nt}function Jt(e){return Number.isFinite(e)?`${Math.round(e)} %`:Nt}const ei=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],ti=Object.fromEntries(ei.map(e=>[e.key,e.label.split(" ")[0]])),ii={co2:"carbon_dioxide",rssi:"signal_strength"};function si(e){return ii[e]??e}function oi(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(si).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,o]of Object.entries(s)){const s=si(t);s!==t&&(e=!0),s in i||(i[s]=o)}e&&(s=i,t=!0)}let o=e.style,r=e.theme;if(o&&"object"==typeof o){const e=je(o);if("custom"!==e&&(void 0===r||r===e)){const i={...o};for(const e of $e)delete i[e];Object.keys(i).length!==Object.keys(o).length&&(o=Object.keys(i).length?i:void 0,r=e,t=!0)}}if(!t)return e;const a={...e};return o!==e.style&&(void 0===o?delete a.style:a.style=o),r!==e.theme&&(a.theme=r),i&&(a.graph_sensors=i),s&&(a.graph_sensor_colors=s),a}const ri=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],ai=["online","offline","power","alerts"],ni=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Light",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],li=["power","energy","voltage","current","temperature"],ci=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:ai});function di(){return{...ci,header_chips:[...ci.header_chips??[]]}}function pi(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function hi(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function gi(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function ui(e,t,i,s){let o=e.trim();const r=t.trim();return r&&o.toLowerCase().startsWith(r.toLowerCase())&&(o=o.slice(r.length).trim()),o||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function vi(e,t){const i=e.entities.filter(pi),s=e.entities.filter(hi),o=new Set,r=[];return i.forEach((i,a)=>{const n=t[i.entity_id],l=gi(i.entity_id),c=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),r=s.find(e=>!o.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return r||(null!=t?s.find(e=>!o.has(e.entity_id)&&gi(e.entity_id)===t):void 0)})(i,l);c&&o.add(c.entity_id);const d=c?t[c.entity_id]:null,p=d?.attributes?.event_type;r.push({entityId:i.entity_id,label:ui(n?.attributes?.friendly_name??"",e.name,l,i.entity_id),isOn:"on"===n?.state,isButton:!!c,channel:l??0,lastEvent:p??null,lastChanged:n?.last_changed??null,_sort:l??50+a})}),s.filter(e=>!o.has(e.entity_id)).forEach((i,s)=>{const o=t[i.entity_id],a=gi(i.entity_id),n=o?.state&&"unknown"!==o.state&&"unavailable"!==o.state?o.state:null;r.push({entityId:i.entity_id,label:ui(o?.attributes?.friendly_name??"",e.name,a,i.entity_id),isOn:!1,isButton:!0,channel:a??0,lastEvent:o?.attributes?.event_type??null,lastChanged:o?.last_changed??n,_sort:a??50+s})}),r.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}const fi=new Set(["power","voltage","current","energy","apparent_power","reactive_power","frequency","power_factor","temperature","humidity","illuminance","co2","battery","rssi"]),mi={select:/_enum_\d+$/i,number:/_number_\d+$/i,button:/_button_\d+$/i,text:/_text_\d+$/i,switch:/_boolean_\d+$/i};function bi(e,t){const i=function(e){const t=new Set;for(const i of e.entities){const e=i.attributes?.device_class??"",s=i.entity_id;if("sensor"===i.domain){if(!e&&(s.endsWith("_ip")||s.endsWith("_ip_address"))){t.add("ip");continue}if(!e&&s.endsWith("_ssid")){t.add("ssid");continue}if(!e&&(s.endsWith("_firmware")||s.endsWith("_fw"))){t.add("fw_version");continue}if(!e&&s.endsWith("_mac")){t.add("mac");continue}"carbon_dioxide"===e?t.add("co2"):"signal_strength"===e||s.includes("rssi")?t.add("rssi"):s.includes("uptime")?t.add("uptime"):["power","apparent_power","reactive_power","power_factor","frequency","energy","voltage","current","temperature","humidity","illuminance","gas","battery"].includes(e)&&t.add(e)}else"binary_sensor"===i.domain&&("door"===e||"window"===e||"opening"===e?t.add("door"):"moisture"===e?t.add("flood"):"heat"===e||s.includes("overtemp")?t.add("overtemp"):"safety"===e||s.includes("overpower")?t.add("overpower"):"connectivity"===e?s.includes("cloud")?t.add("cloud"):s.includes("mqtt")?t.add("mqtt"):s.includes("eth")&&t.add("eth"):["motion","smoke","gas","vibration"].includes(e)&&t.add(e))}return t}(e),s=t=>e.entities.some(e=>e.domain===t),o=t=>e.entities.filter(e=>e.domain===t).length,r=new Set(["name_row","badges"]);i.size&&r.add("sensors");const a=[...i].some(e=>fi.has(e));return a&&r.add("graph"),s("light")&&r.add("dimmer"),s("cover")&&r.add("cover_controls"),s("climate")&&r.add("trv_control"),s("valve")&&r.add("valve_controls"),vi(e,t).length&&r.add("input_channels"),o("switch")+o("light")>1&&r.add("relay_channels"),i.has("power")&&r.add("power_bar"),e.entities.some(e=>mi[e.domain]?.test(e.entity_id))&&r.add("virtual_controls"),["lock","media_player","fan","vacuum"].some(s)&&r.add("delegated_controls"),{chips:i,blocks:r,hasEnergy:i.has("energy")||i.has("power"),hasGraphs:a,hasOnOff:["switch","light","cover","valve","fan","lock","climate","binary_sensor"].some(s)}}function yi(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:o,config:r,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=r.graph_style?.sensor_ranges??{},d=r.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),o=g+e*Math.sin(b(v)),r=h+e*Math.cos(b(i)),a=g+e*Math.sin(b(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${o.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${r.toFixed(2)} ${a.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return q`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,o=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),r="W"===e.label||"A"===e.label?"left":"right",a=(h+s*("left"===r?-1:1)).toFixed(1),n=(g+8).toFixed(1),l="left"===r?"start":"end";return G`
            ...
            <text x="${a}" y="${n}" font-size="8" fill="${e.color}" text-anchor="${l}" dominant-baseline="hanging" font-family="monospace" font-weight="700" opacity="${i?.95:.5}">${x(e.val,e.label)} ${e.label}</text>`})}
      </svg>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Z}
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:o,config:r,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,g=r.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=r.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=i.max??Math.max(...e),a=o-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/a*(p-2*h),m=e.indexOf(o);v=n(null,m),f=l(o);const b=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    <div class="ts-spark" style="--ts-accent:${s}">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a,{skipPowerGraph:!0}):Z}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:o,profile:r}=e,a=e.tileSensors(t),n=e.getPrimarySwitch(t);return q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        ${e.showEl("secondary")?q`<div class="ts-hbar-side">
          ${null!=a.voltage?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${a.voltage.toFixed(0)}</div></div>`:Z}
          ${null!=a.current?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${a.current.toFixed(2)}</div></div>`:Z}
          ${null!=a.temp?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${a.temp.toFixed(1)}</div></div>`:Z}
          ${null!=a.rssi?q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${a.rssi}</div></div>`:Z}
        </div>`:Z}
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=a.energy?q`<span class="ts-hbar-badge">${a.energy.toFixed(2)} kWh</span>`:Z}
          ${null!=a.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${qt(a.uptime)}</span>`:Z}
        </div>
    ...
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:o,config:r,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,g=r.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=r.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,a=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${a} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${a}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():Z,f=(e,t,i=!1)=>q`
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=n.power?f("Power",$t(n.power),!0):Z}
      ...
      ${null!=n.uptime&&e.showEl("uptime")?f("Uptime",qt(n.uptime)):Z}
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a,{skipGraphs:!0}):Z}
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:o,config:r,profile:a}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,g=r.graph_style?.line_width??1.5,u=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=r.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,a=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${u}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${u}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${a} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${a}" fill="none" stroke="${u}" stroke-width="${g}" stroke-linecap="round"/>`})():Z;return q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ...
        ${e.showEl("uptime")?q`<span class="ts-uptime">${n.uptime?qt(n.uptime):""}</span>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,a):Z}
    </div>`}(e)}}const xi=140,wi=70;function ki(e){const{device:t,isOn:i,accent:s,online:o,hass:r,profile:a}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==a.type&&"rgb"!==a.type)return q`
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${$t(l.power)}</div>`:Z}
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",g=n.whiteValue??0,u=r.states[n.entityId],v=u?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),o=s-Math.min(e,t,i);let r=0;o>0&&(r=s===e?((t-i)/o+6)%6:s===t?(i-e)/o+2:(e-t)/o+4);const a=0===s?0:o/s,l=(e=>e*Math.PI/180)(60*r-90);return{x:wi+62*a*Math.cos(l),y:wi+62*a*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${xi}" height="${xi}" viewBox="0 0 ${xi} ${xi}"
            class="ts-light-wheel" @click=${e=>{if(!d||!n)return;e.stopPropagation();const t=e.currentTarget,i=t.getBoundingClientRect(),s=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-s,l=e.clientY-o,c=Math.sqrt(a*a+l*l),p=i.width/2-8;if(c>p+8){const e=t.parentElement;return void(e&&(e.classList.remove("ts-wheel-pulse"),e.offsetWidth,e.classList.add("ts-wheel-pulse")))}const h=(180*Math.atan2(l,a)/Math.PI+90+360)%360,g=Math.min(1,c/p),u=e=>{const t=(e+h/60)%6;return 1-g*Math.max(0,Math.min(t,4-t,1))},v=Math.round(255*u(5)),f=Math.round(255*u(3)),m=Math.round(255*u(1));r.callService("light","turn_on",{entity_id:n.entityId,rgb_color:[v,f,m]})}} style="cursor:crosshair">
            <defs>
              <radialGradient id="${_}">
            ...
            <foreignObject x="0" y="0" width="${xi}" height="${xi}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${xi}px;height:${xi}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${wi}" cy="${wi}" r="${wi}" fill="url(#${_})" opacity="${i?1:.3}"/>
        ...
        <div class="ts-light-row">
          ...
          <div style="display:flex;align-items:center;gap:6px;flex:1">
            <input type="range" class="dim-slider ts-light-slider ts-light-ct" min="${y}" max="${x}"
              ...
              @change=${e=>{r.callService("light","turn_on",{entity_id:n.entityId,color_temp:parseInt(e.target.value,10)})}}/>
      ...
      ${e.showEl("effects")?Ke(f,m,e=>r.callService("light","turn_on",{entity_id:n.entityId,effect:e})):Z}
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${$t(l.power)}</div>`:Z}
    </div>`}function _i(e,t){const{device:i,profile:s,config:o,hass:r,online:a}=e,n=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),g=e.getPower(i),u=e.getSensors(i),v=e.getInputChannels(i),f=n?.isOn??!1,m=void 0!==n?.brightness,b=n&&m&&f?Math.max(1,n.brightness??1):0,y=!!n?.colorModes?.length,x=n?.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",w=!!n?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Lt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let r;if(s)r=tt(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;r=t?tt(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;r=i?tt(i,!0,"--ent-spd:1","tile-icon"):q``}else r=q``;const p=n?e.renderEntityAnim(n.entityId,f,i.device_id):q``;return q`
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            <span class="dot ${a?"online":"offline"}"></span>
            ${r}
            ${p}
      ...
      `}case"sensors":{if(!u.length)return q``;const e=u.filter(e=>"primary"===(e.tier??"primary")),t=u.filter(e=>"electrical"===e.tier),i=u.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),o=new Map;for(const e of t){const t=e.ch??"";o.has(t)||o.set(t,[]),o.get(t).push(e)}const r=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return q`
        ...
        ${i.length?q`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>q`${t>0?q`<span class="sep">·</span>`:Z}<span class="${e.warn?"warn":""}">${r(e)}</span>`)}
          </div>`:Z}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=n?r.states[n.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,o=n?.whiteValue??0;return n&&m?q`
        ...
        `:Z}
        ${Ke(i,s,e=>r.callService("light","turn_on",{entity_id:n.entityId,effect:e}))}
      ...
      `:q``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(r.states[t.entity_id]?.state??"")||null,o={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?q`
      ...
      `:q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?q`
        ...
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=r.states[t.entity_id],o="on"===s?.state,a=s?.attributes?.friendly_name??t.entity_id;return q`
      ...
      `:q``}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=ft(i);return e.length?q`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>q`
            <hdd-delegated .hass=${r} .entity=${e.entity_id} .features=${vt[e.domain]}></hdd-delegated>
          `)}
        </div>`:q``}case"power_bar":return e.renderPowerBar(i);case"badges":return q`
        <div class="tile-bot">
          ${null!=g?q`<span class="tile-power">${$t(g)}</span>`:Z}
      ...
      `;default:return q``}var C}const Ai=255;function Ci(e){return q`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:o}=e,r=e.getFirmware(t),a=e.tileSensors(t);return q`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${r?q`<div class="ds-fw-update"><span>FW update: ${r.current} → ${r.newVersion}</span></div>`:Z}
      ${null!=a.rssi?q`<div class="ds-signal">Wi-Fi: ${Gt(a.rssi)} (${a.rssi} dBm)${null!=a.uptime?q` · Up ${qt(a.uptime)}`:Z}</div>`:Z}
    ...
    ${s.length>1?q`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],r="on"===o?.state,a=o?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${a}</span>
                ${isNaN(c)?Z:q`<span class="ds-channel-power">${$t(c)}</span>`}
                <button class="tog ${r?"on":"off"}" @click=${t=>e.toggle(s.entity_id,r,t)}>${r?"ON":"OFF"}</button>
              </div>`})}
        </div>
      </div>`:1===s.length?q`
    ...
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?q`<span class="ds-big-power">${$t(s.power)}</span>`:Z}
    </div>
    ...
    ${zi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,r=Math.round(o/Ai*100);return q`
    <div class="ds-section">
      <div class="ds-section-title">Light Controls</div>
      <div class="ds-dimmer-control">
        <span class="ds-dimmer-pct">${r}%</span>
    ...
    <div class="ds-section">
      ...
      ${i.length?q`
        <div class="ds-channel-list">
          ${i.map(i=>{const s=e.getInputActionLabel(t,i),o=e.getInputActionState(t,i),r=i.lastChanged?e.timeAgo(i.lastChanged):"";return q`
              <div class="ds-channel-row">
                ...
                ${r?q`<span class="ds-ent-age">${r}</span>`:Z}
              </div>`})}
    ...
    ${s.length?q`
      <div class="ds-section">
        ...
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",o=t?.attributes?.unit_of_measurement??"",r=t?.attributes?.friendly_name??e.entity_id;return q`<div class="ds-channel-row"><span class="ds-channel-name">${r}</span><span>${s} ${o}</span></div>`})}
      </div>`:Z}
    ${o.length?q`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${o.map(t=>{const s=i.states[t.entity_id],o="on"===s?.state,r=s?.attributes?.friendly_name??t.entity_id;return q`
              <div class="ds-channel-row">
    ...
    </div>`}function Si(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${$t(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Z}
        ...
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ut(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Z}
        ...
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Wt(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Z}
      </div>
    </div>`:q``}(e):Z}
    ${!o&&s?Si(e):Z}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const r=(t,s)=>{const o=i.states[t.entity_id],r=o?.attributes?.friendly_name??t.entity_id,a=o?.state??"unknown",n=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===a,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      <div class="ds-entity-row ${s?"is-secondary":""}" @click=${()=>e.fireMoreInfo(t.entity_id)}>
        ...
        <span class="ds-ent-name">${r}</span>
        <span class="ds-ent-state">${a}${n?` ${n}`:""}</span>
      ...
      </div>`},a=o.filter(e=>"primary"===dt(e)),n=o.filter(e=>"config"===dt(e)),l=o.filter(e=>"diagnostic"===dt(e));return q`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${a.map(e=>r(e,!1))}
      ${n.length?q`<div class="ds-ent-subgroup">Configuration</div>${n.map(e=>r(e,!0))}`:Z}
      ${l.length?q`<div class="ds-ent-subgroup">Diagnostic</div>${l.map(e=>r(e,!0))}`:Z}
    </div>`}(e)}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=o.rssi?q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${Gt(o.rssi)} (${o.rssi} dBm)</span></div>`:Z}
        ${null!=o.uptime?q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${qt(o.uptime)}</span></div>`:Z}
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),E=z-S||1,I=s[0].t,T=s[s.length-1].t,O=T-I||1,M=e=>(e.t-I)/O*r,D=e=>a-4-(e.v-S)/E*(a-8),R=s.map(e=>`${M(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=M(s[0]).toFixed(1),P=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,F=A[A.length-1],L=F%1==0?`${F}`:F.toFixed(1),N=Math.max(...A),$=Math.min(...A);let j=A.indexOf(N),H=A.indexOf($);j<0&&(j=0),H<0&&(H=0);const U=M(s[j]).toFixed(1),W=D(s[j]).toFixed(1),V=M(s[H]).toFixed(1),X=D(s[H]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+T)/2),K=f/O*r,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Z:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${r} ${a}" preserveAspectRatio="none"
                ...
                `:Z}
                ${"bar"!==h&&u?G`
                  <polygon points="${R} ${r},${a-4} ${B},${a-4}" fill="url(#${P})"/>
                `:Z}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,r/s.length-2),i=M(e)-t/2,o=D(e),n=a-4-o;return G`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="${g}" fill="${_}" opacity="0.75"/>`}):G`
    ...
    `}_trvTempFromEvent(e,t,i,s,o){const r=t.getBoundingClientRect();if(!r.width||!r.height)return null;const a=(e.clientX-r.left)*(160/r.width),n=(e.clientY-r.top)*(132/r.height);let l=Math.atan2(n-70,a-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i),p=o||.5;return Math.max(i,Math.min(s,Math.round(d/p)*p))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect();if(!i.width||!i.height)return null;const s=(e.clientX-i.left)*(160/i.width),o=(e.clientY-i.top)*(128/i.height);let r=Math.atan2(o-68,s-80)*(180/Math.PI)+90;r<0&&(r+=360);const a=(r-210+360)%360;return a>300?null:Math.round(a/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[o,r]=i(e,s),[a,n]=i(t,s);return`M ${o} ${r} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${a} ${n}`},o=e.supportsPosition||!!e.numEntityId,r=this._valveDragPos??t,a=(e=>210+e/100*300)(r),[n,l]=i(a,54),c=`hsl(${200+.2*r}, ${40+.55*r}%, ${38+.18*r}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=o?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},o=t=>{const r=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=r&&this._setValvePosition(e.entityId,r,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",o)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",o)}:void 0;return G`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${o?"valve-interactive":""}"
        ...
        ${t>0?G`<path d="${s(210,a,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:Z}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:o,isHeating:r,valveOpen:a,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?G`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`;if("cover"===l){const e=s??("open"===o?100:"closed"===o?0:50),t="opening"===o||"closing"===o,i=[2,5.5,9,12.5,16],r=Math.ceil(e/100*i.length);return G`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
      ...
      </svg>`}return"climate"===l||"wall_display"===l?G`<svg class="tile-icon tile-icon-flame ${r?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?G`<svg class="tile-icon tile-icon-valve ${a?"on":""}" viewBox="0 0 20 20">
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return q``;const o=(t?s.on:s.off)??"none";return"none"===o?q``:tt(o,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i,s){return _i(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return q`
      <div class="power-bar" title="${t.toFixed(0)} W">
        <div class="power-bar-fill" style="width:${Math.min(100,t/i*100)}%"></div>
      </div>`}_tileSensors(e){let t=null,i=null,s=null,o=null,r=null,a=null,n=null;for(const l of e.entities){if("sensor"!==l.domain)continue;const e=this.hass.states[l.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const c=e.attributes.device_class??"",d=parseFloat(e.state);"power"===c&&null==t&&(t=isNaN(d)?null:d),"voltage"===c&&null==i&&(i=isNaN(d)?null:d),"current"===c&&null==s&&(s=isNaN(d)?null:d),"temperature"===c&&null==o&&(o=isNaN(d)?null:d),"energy"===c&&null==r&&(r=isNaN(d)?null:d);const p=l.entity_id;(p.includes("rssi")||p.includes("signal"))&&(a=isNaN(d)?null:d),p.includes("uptime")&&(n=isNaN(d)?null:d)}let l="Energy";const c=this._config.device_styles?.[e.device_id]?.energy_entity;if(c){const e=this.hass.states[c],t=e&&"unavailable"!==e.state&&"unknown"!==e.state?parseFloat(e.state):NaN;r=isNaN(t)?null:t}const d=this._energyPeriod(e);if("total"!==d){const t=c??this._energyEntitiesFor(e)[0];if(t){const e=this._periodEnergyValue(t,d);e.failed||(r=e.kwh,l=this._energyPeriodLabel(d))}}return{power:t,voltage:i,current:s,temp:o,energy:r,energyLabel:l,rssi:a,uptime:n}}_deviceMetric(e,t){if("power"===t)return this._getPower(e);if("energy"===t)return this._deviceEnergy(e).value;const i={temperature:"temperature",humidity:"humidity",illuminance:"illuminance"};for(const s of e.entities){if("sensor"!==s.domain)continue;const e=this.hass.states[s.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const o=parseFloat(e.state);if(isNaN(o))continue;const r=e.attributes.device_class??"";if("rssi"===t){if("signal_strength"===r||s.entity_id.includes("rssi"))return o}else if(r===i[t])return o}return null}_deviceEnergy(e){const t=this._energyEntitiesFor(e);if(!t.length)return{value:null,period:"total"};const i=this._energyPeriod(e);if("total"===i)return{value:this._deviceEnergyLifetime(e),period:"total"};let s=0,o=!1;for(const r of t){const t=this._periodEnergyValue(r,i);if(t.failed)return{value:this._deviceEnergyLifetime(e),period:"total"};null!=t.kwh&&(s+=t.kwh,o=!0)}return o?{value:s,period:i}:{value:null,period:i}}_deviceEnergyLifetime(e){let t=0,i=!1;for(const s of this._energyEntitiesFor(e)){const e=this.hass.states[s];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const o=parseFloat(e.state);isNaN(o)||(t+=o,i=!0)}return i?t:null}_headerEnergyAgg(e){const t=e.map(e=>({d:e,e:this._deviceEnergy(e)})).filter(e=>null!=e.e.value);if(!t.length)return null;const i=new Set(t.map(e=>e.e.period));if(1===i.size){const e=[...i][0];return{value:t.reduce((e,t)=>e+t.e.value,0),label:this._energyPeriodLabel(e)}}let s=0,o=!1;for(const{d:e}of t){const t=this._deviceEnergyLifetime(e);null!=t&&(s+=t,o=!0)}return o?{value:s,label:"Energy"}:null}_formatHeaderMetric(e,t){switch(e){case"power":return $t(t);case"energy":return jt(t);case"temperature":return Wt(t);case"humidity":return Qt(t);case"illuminance":return Yt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(t)}}_devicesWithUpdates(e){return e.map(e=>({device:e,fw:this._getFirmware(e)})).filter(e=>!!e.fw?.newVersion&&e.fw.newVersion!==e.fw.current)}_headerMetricAggs(e,t){const i={temperature:"temperature",humidity:"humidity",illuminance:"illuminance"},s=t.filter(e=>i[e]),o=t.includes("power"),r=t.includes("rssi"),a=new Map,n=(e,t)=>{const i=a.get(e)??{sum:0,count:0};i.sum+=t,i.count++,a.set(e,i)};for(const t of e){if(o){const e=this._getPower(t);null!=e&&n("power",e)}if(!s.length&&!r)continue;const e=new Set;for(const o of t.entities){if("sensor"!==o.domain)continue;const t=this.hass.states[o.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const a=parseFloat(t.state);if(isNaN(a))continue;const l=t.attributes.device_class??"";!r||e.has("rssi")||"signal_strength"!==l&&!o.entity_id.includes("rssi")||(e.add("rssi"),n("rssi",a));for(const t of s)e.has(t)||l!==i[t]||(e.add(t),n(t,a))}}return a}_renderHeaderChips(e){const t=this._config.header_chips??ai,i=e.filter(e=>this._isOnline(e)).length,s=this._headerMetricAggs(e,t),o=e=>t=>{t.stopPropagation(),this._cloudDetailOpen=this._cloudDetailOpen===`m:${e}`?null:`m:${e}`};return q`
      <div class="dash-stats">
        ${t.map(t=>{const r=ri.find(e=>e.key===t);if(!r)return Z;let a="",n="metric";if("online"===t)a=`${i}/${e.length} online`,n="online";else if("offline"===t){const t=e.length-i;if(!t)return Z;a=`${t} offline`,n="offline-count"}else if("alerts"===t){const t=e.filter(e=>this._getAlerts(e).length>0).length;if(!t)return Z;a=`⚠ ${t}`,n="alerts-count"}else if("updates"===t){const t=this._devicesWithUpdates(e).length;if(!t)return Z;a=`⬆ ${t} update${t>1?"s":""}`,n="updates-count"}else if("energy"===t){const t=this._headerEnergyAgg(e);if(!t)return Z;a=`${t.label} ${this._formatHeaderMetric("energy",t.value)}`}else{const e=s.get(t);if(!e||!e.count)return Z;const i="sum"===r.agg?e.sum:e.sum/e.count;a="power"===t?this._formatHeaderMetric(t,i):`${r.label} ${this._formatHeaderMetric(t,i)}`,"power"===t&&(n="power")}const l=this._cloudDetailOpen===`m:${t}`;return q`<span class="stat ${n} ${l?"active":""}" @click=${o(t)}>${a}</span>`})}
      </div>`}_renderHeaderDetail(e){const t=this._cloudDetailOpen;if(!t?.startsWith("m:"))return q``;const i=t.slice(2),s=ri.find(e=>e.key===i);if(!s)return q``;let o=[],r="cloud-on";if("online"===i?o=e.filter(e=>this._isOnline(e)).map(e=>({name:e.name,value:""})):"offline"===i?(o=e.filter(e=>!this._isOnline(e)).map(e=>({name:e.name,value:""})),r="cloud-off"):"alerts"===i?(o=e.map(e=>({d:e,a:this._getAlerts(e)})).filter(e=>e.a.length).sort((e,t)=>t.a.length-e.a.length).map(e=>({name:e.d.name,value:e.a.join(", ")})),r="cloud-off"):o="updates"===i?this._devicesWithUpdates(e).map(e=>({name:e.device.name,value:`${e.fw.current} → ${e.fw.newVersion}`})):e.map(e=>({d:e,v:this._deviceMetric(e,i)})).filter(e=>null!=e.v).sort((e,t)=>t.v-e.v).map(e=>({name:e.d.name,value:this._formatHeaderMetric(i,e.v)})),!o.length)return q``;const a="energy"===i?this._headerEnergyAgg(e)?.label??s.label:s.label;return q`
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        <div class="cloud-detail-hdr ${r}">● ${a} — ${o.length} device${o.length>1?"s":""}</div>
    ...
    `:Z;return p.length||g||o||r||a||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${a}" style=${_e(l)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?_i(r,e[0]):q`<div class="tile-row">${e.map(e=>_i(r,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return q`<div class="${`tile tile-${a} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?yi(this._buildTileCtx(e,s,y),m):"light-control"===v?ki(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:o}=e,r=e.getTrv(t);if(!r)return Ge(t,s,"ts-climate","No climate entity");const a="heating"===r.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(o.states[n.entity_id]?.state??"")||null;return q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-climate-top">
        ...
        ${e.showEl("heating_badge")?q`<div style="display:flex;align-items:center;gap:6px">
          ${a?q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(249,115,22,0.18);color:#f97316;font-weight:600">🔥 Heating</span>`:q`<span style="font-size:11px;padding:2px 7px;border-radius:10px;background:rgba(255,255,255,0.06);color:var(--sc-text-muted)">Idle</span>`}
        </div>`:Z}
      </div>
      ${e.showEl("dial")?e.renderTrvDial(r):Z}
      ${e.showEl("adjust_buttons")?q`<div class="trv-dial-btns">
        <button class="trv-step" @click=${()=>e.adjustTrvTemp(r,-1)}>−</button>
        <span class="trv-flame">${a?"🔥":""}</span>
        <button class="trv-step" @click=${()=>e.adjustTrvTemp(r,1)}>+</button>
      </div>`:Z}
      ${e.showEl("stats")?q`<div class="trv-stat-row">
        <div class="trv-stat"><span class="trv-stat-lbl">Now</span><span class="trv-stat-val">${null!=r.currentTemp?`${r.currentTemp}°`:"—"}</span></div>
        <div class="trv-stat"><span class="trv-stat-lbl">Set</span><span class="trv-stat-val">${null!=r.targetTemp?`${r.targetTemp.toFixed(1)}°`:"—"}</span></div>
        ${null!=r.valvePosition?q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(r.valvePosition)}%</span></div>`:Z}
        ${null!=l?q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:Z}
      </div>`:Z}
      ${e.showEl("presets")&&r.presetModes.length?q`<div class="trv-presets">${r.presetModes.map(t=>q`
        <button class="trv-preset-btn ${r.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(r.entityId,t)}>${(Je[t]??"")+t}</button>`)}
      </div>`:Z}
    </div>`}(this._buildTileCtx(e,s,y)):"cover-control"===v?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const r=o.position??("open"===o.state?100:0),a="opening"===o.state||"closing"===o.state,n=Math.ceil(r/100*et.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      <div class="ts-cover-top">
        ${qe(t,s)}
        ${e.showEl("position_pct")?q`<span class="ts-cover-pct" style="color:${i}">${Math.round(r)}%</span>`:Z}
      </div>
      ${e.showEl("shutter_graphic")?q`<div class="ts-cover-graphic">
        ...
        ${a&&e.showEl("moving_label")?q`<span class="ts-cover-state">${"opening"===o.state?"▲ Opening…":"▼ Closing…"}</span>`:Z}
      </div>`:Z}
    ...
    </div>`}(this._buildTileCtx(e,s,y)):"sensor-card"===v?function(e){const{device:t,accent:i,online:s,hass:o,config:r}=e;let a;for(const e of at)if(a=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=o.states[t.entity_id];return i&&i.attributes?.device_class===e}),a)break;const n=a?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return t&&nt.includes(t.attributes?.device_class??"")});if(!a&&!n)return Ge(t,s,"ts-sensor","No sensor");if(a){const n=o.states[a.entity_id],l=parseFloat(n?.state??""),c=n?.attributes?.unit_of_measurement??"",d=n?.attributes?.device_class??"",p=r.graph_hours??24;e.requestGraphData(a.entity_id);const h=e.getGraphPoints(a.entity_id,p);let g=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const u=t.entities.filter(e=>{if(e.entity_id===a.entity_id||"sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${e.showEl("graph")?q`<div class="ts-sensor-spark">
          ${e.renderSparklinesFiltered(t,e.getGraphEntities(t).filter(e=>e.entityId===a.entity_id))}
        </div>`:Z}
    ...
    </div>`}(this._buildTileCtx(e,s,y)):"input-control"===v?rt(this._buildTileCtx(e,s,y)):"scene-button"===v?function(e){const{device:t,accent:i,online:s,config:o}=e,r=e.getInputChannels(t),a=o.device_styles?.[t.device_id],n=tt(a?.tile_icon??"pulse",!0,`--ent-spd:${a?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return r.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,o=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(li),r=e=>o.has(e),a={},n=(e,t)=>{a[e]||(a[e]={sum:0,count:0}),a[e].sum+=t,a[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&r(o.key)&&n(o.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ni){if("energy"===t.key&&r("energy")&&"total"!==l){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){a.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",a.energy.sum)});continue}if(s||a.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?jt(i):"…"})}continue}const i=a[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return $t(t);case"energy":return jt(t);case"voltage":return Ht(t);case"current":return Ut(t);case"temperature":return Wt(t);case"humidity":return Qt(t);case"co2":return Kt(t);case"illuminance":return Yt(t);case"battery":return Jt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),o=this._config.area_styles?.[t]?.header_chips,r=void 0!==s?new Set(s):void 0!==o?new Set(o):new Set(li),a=[];for(const e of ni)i.has(e.key)&&a.push({key:e.key,label:e.label,visible:r.has(e.key)});return a}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&t.add(o.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,o=(t,s)=>{const o=new Set(i.filter(e=>e.visible).map(e=>e.key));s?o.add(t):o.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>o.has(e)))};return q`
      ...
      </div>`}_renderAreaSection(e,t){if(!t.length)return q``;const i=e||"No Area",s=this._closedAreas.has(e),o=t.filter(e=>this._isOnline(e)).length,r=this._config.area_styles?.[i],a=r?.columns??this._getActiveView()?.columns??this._config.columns??3,n={};if(r){if((r.borderColor||r.borderWidth)&&(n.border=`${r.borderWidth??1}px ${r.borderStyle??"solid"} ${r.borderColor??"var(--divider-color)"}`),r.borderRadius&&(n.borderRadius=`${r.borderRadius}px`,n.overflow="hidden"),r.bg_image){n["--area-bg-image"]=`url("${r.bg_image}")`,n["--area-bg-image-sz"]="ambient"===r.bg_image_mode?"cover":"stretch"===r.bg_image_size?"100% 100%":r.bg_image_size??"cover";const e=r.bg_image_pos;n["--area-bg-pos"]="top"===e?"center top":"bottom"===e?"center bottom":"center"}if(r.headerBgColor&&(n["--area-header-bg"]=r.headerBgColor2?`linear-gradient(${r.headerBgDir??"to right"}, ${r.headerBgColor}, ${r.headerBgColor2})`:r.headerBgColor),r.textColor&&(n["--area-header-color"]=r.textColor),r.fontSize&&(n["--area-name-size"]=`${r.fontSize}px`),r.fontWeight&&(n["--area-name-weight"]=r.fontWeight),r.tileBgColor&&(n["--sc-tile-bg"]=r.tileBgColor),r.tileBorderColor&&(n["--sc-tile-border"]=r.tileBorderColor),null!=r.tileBorderRadius&&(n["--tile-radius"]=`${r.tileBorderRadius}px`),null!=r.tileGap&&(n["--tile-gap"]=`${r.tileGap}px`),r.tileTextColor&&(n["--sc-text-primary"]=r.tileTextColor),r.accentColor&&(n["--sc-accent"]=r.accentColor,n["--sc-graph-line"]=r.accentColor,n["--sc-accent-glow"]=`${r.accentColor}59`),r.buttonShape||r.buttonVariant||r.buttonSize){const e=r.buttonShape??"pill",t=r.buttonVariant??"fill",i=r.buttonSize??"md",s="square"===e||"circle"===e,o={sm:"2px 8px",md:"4px 11px",lg:"6px 16px"},a={sm:"3px 5px",md:"4px 8px",lg:"6px 12px"};n["--tog-radius"]="pill"===e?"20px":"rect"===e||"square"===e?"6px":"50%",n["--tog-pad"]=s?a[i]??a.md:o[i]??o.md,n["--tog-fsize"]="sm"===i?".65em":"lg"===i?".8em":".72em",n["--tog-aspect"]=s?"1":"auto","outline"===t?(n["--tog-on-bg"]="transparent",n["--tog-on-border"]="1px solid var(--sc-accent)",n["--tog-on-color"]="var(--sc-accent)",n["--tog-on-shadow"]="none"):"ghost"===t&&(n["--tog-on-bg"]="transparent",n["--tog-on-border"]="none",n["--tog-on-color"]="var(--sc-accent)",n["--tog-on-shadow"]="none")}}const l=r?.tile_style,c=this._getAreaChips(t,i);return q`
      <div class="area-section ${s?"closed":""} ${r?.bg_image&&"ambient"===r.bg_image_mode?"area-bg-ambient":""}" style=${_e(n)}>
        ...
        ${s?Z:q`
          ...
          <div class="device-grid" style="--cols:${a}">
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
        ...
        </ha-card>`;const o=this._getActiveView(),r=o?this._applyViewFilter(s,o):s,a=this._groupByArea(r),n=!o||!0===o.show_favourites,l=!o||!1!==o.show_rooms,c=!0===this._config.header_show_cloud?Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")):[],d=c.filter(e=>"on"===e.state),p=c.filter(e=>"off"===e.state),h=c.filter(e=>"unavailable"===e.state),g=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),u=this._buildCardStyles(),v=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,f=v?Ci(this._buildTileCtx(v,this._profile(v),this._tileAccent(v,v.area??""))):Z,m=q`
      <ha-card class=${this._config.effects?"":"no-fx"} style=${_e(u)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        <div class="dash-body">
          ...
          ${l?De([...a.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):q`<div class="device-grid" style="--cols:${o?.columns??this._config.columns??3}">
                ${De(r,e=>e.device_id,e=>this._renderTile(e))}
              </div>`}
        </div>
    ...
    `;return m}_renderExtraCards(e){return e?.length?q`
      ...
      </div>`:q``}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return q``;const t=e.filter(e=>ft(e).length>0).length;return t?q`
      ...
      </div>`:q``}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return q``;const t=this._getActiveView()?.id;return q`
      <div class="view-tabs">
        ${e.map(e=>q`
    ...
    `],e([ve({attribute:!1})],Mi.prototype,"hass",void 0),e([ve({type:Boolean})],Mi.prototype,"preview",void 0),e([fe()],Mi.prototype,"_config",void 0),e([fe()],Mi.prototype,"_closedAreas",void 0),e([fe()],Mi.prototype,"_entityListOpen",void 0),e([fe()],Mi.prototype,"_graphData",void 0),e([fe()],Mi.prototype,"_periodEnergy",void 0),e([fe()],Mi.prototype,"_periodEnergyErrAt",void 0),e([fe()],Mi.prototype,"_valveDragPos",void 0),e([fe()],Mi.prototype,"_trvDragTemp",void 0),e([fe()],Mi.prototype,"_cloudDetailOpen",void 0),e([fe()],Mi.prototype,"_detailDevice",void 0),e([fe()],Mi.prototype,"_detailHistoryRange",void 0),e([fe()],Mi.prototype,"_activeViewId",void 0),e([fe()],Mi.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Mi.prototype,"_tileBlockOverride",void 0),e([fe()],Mi.prototype,"_tileChipOverride",void 0),e([fe()],Mi.prototype,"_areaHeaderOverride",void 0),e([fe()],Mi.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Mi.prototype,"_areaCustomizeOpen",void 0),Mi=Ei=e([he("ha-device-dashboard")],Mi);const Di=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Di(e,t);return!0},Ri=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Bi=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Li(t)}};function Pi(e){void 0!==this._$AN?(Ri(this),this._$AM=e,Bi(this)):this._$AM=e}function Fi(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Di(s[e],!1),Ri(s[e]);else null!=s&&(Di(s,!1),Ri(s));else Di(this,e)}const Li=e=>{e.type==be&&(e._$AP??=Fi,e._$AQ??=Pi)};class Ni extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Bi(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Di(this,e),Ri(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const $i=new WeakMap,ji=ye(class extends Ni{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=$i.get(t);void 0===i&&(i=new WeakMap,$i.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?$i.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Hi=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Te(e),this.key=t),i}}),Ui=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Wi;const qi=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Gi=!1;const Vi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Zi=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Xi=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Qi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Yi=Wi=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._localTweaksCleared=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=oi(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of $e)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Z}connectedCallback(){super.connectedCallback(),function(){if(Gi||"undefined"==typeof document)return;const e=qi.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),Gi=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const o=s.shadowRoot;if(!o)return;try{if(window.matchMedia("(min-width: 1600px)").matches){const e=s;!1===e.large&&"function"==typeof e._enlarge&&e._enlarge()}}catch{}const r="ha-device-dashboard-editor-fix";if(!o.getElementById(r)){const e=document.createElement("style");e.id=r,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",o.appendChild(e)}const a=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=o.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=o.querySelector("ha-dialog-footer");if(!e||!t)return;const s=o.querySelector("div.element-editor"),r=o.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(r,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);a(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),a(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),a(r,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=o.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return q`
      ...
      </span>`}_chipPicker(e,t,i,s,o){const r=t??[],a=void 0!==e,n=t=>!o||o.has(t)||(e??[]).includes(t),l=Vi.map(e=>({...e,items:e.items.filter(e=>n(e.key))})).filter(e=>e.items.length),c=Vi.flatMap(e=>e.items.map(e=>e.key)).filter(n),d=new Set(a?e:r.length?r:c);return q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${a?"Custom selection":`Inheriting from ${i}`}</span>
          ${this._selAllNone(()=>s([...c]),()=>s([]))}
          ${a?q`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:q`<button class="color-reset" @click=${()=>s([...d])}>Customize</button>`}
        </div>
        ${l.map(t=>q`
          <div class="chip-picker-grp">
            ...
            <div class="pill-grp">
              ${t.items.map(t=>q`
                <span class="pill ${d.has(t.key)?"on":""} ${a?"":"dim"}"
                  @click=${()=>(t=>{const i=a?[...e]:[...d],o=i.includes(t)?i.filter(e=>e!==t):[...i,t];s(o.length?o:void 0)})(t.key)}>${t.label}</span>`)}
            </div>
          </div>`)}
      </div>`}_clearDeviceStyle(e){const t={...this._config.device_styles??{}};delete t[e],this._set("device_styles",Object.keys(t).length?t:void 0)}async _prepareImageForEmbed(e,t={}){const i=t.maxDim??1920,s=t.targetBytes??409600,o=await createImageBitmap(e,{imageOrientation:"from-image"}),r=Math.min(1,i/Math.max(o.width,o.height)),a=Math.max(1,Math.round(o.width*r)),n=Math.max(1,Math.round(o.height*r)),l=document.createElement("canvas");l.width=a,l.height=n;const c=l.getContext("2d");if(!c)throw o.close(),new Error("canvas 2d context unavailable");c.drawImage(o,0,0,a,n),o.close();let d=.85,p=l.toDataURL("image/jpeg",d);for(;.75*p.length>s&&d>.4;)d-=.1,p=l.toDataURL("image/jpeg",d);return l.width=0,l.height=0,p}async _handleBgUpload(e,t,i){const s=e.target,o=s.files?.[0];if(o){try{t(await this._prepareImageForEmbed(o,i))}catch(e){console.warn("[editor] failed to process image",o.name,e),this._showStyleFeedback(`Couldn't process "${o.name}" — try a /local/… URL instead`)}s.value=""}}_renderBgImagePicker(e,t,i,s,o,r,a,n){const l=n?.maxDim??720,c=n?.showFit??!0;return q`
      ...
      <div class="field">
        <div class="bg-img-row">
          ...
          ${i?q`<button class="color-reset" @click=${a}>↺</button>`:Z}
          ...
          <div class="pill-grp">
            ${["cover","contain","stretch"].map(e=>q`
              <span class="pill ${(s??"cover")===e?"on":""}"
                @click=${()=>r(e)}>${e[0].toUpperCase()+e.slice(1)}</span>`)}
          </div>`:Z}
        ${i?n?.extra??Z:Z}
      </div>`}_handleCardBgUpload(e){return this._handleBgUpload(e,e=>this._set("card_bg_image",e))}_handleTileBgUpload(e){return this._handleBgUpload(e,e=>this._set("style",{...this._config.style??{},tile_bg_image:e}),{maxDim:720})}_sec(e,t,i,s,o,r,a){const n=this._openSections[e];return q`
      <div class="sec ${n?"open":""}">
        ...
        <div class="sec-body">${a}</div>
      </div>`}_badge(e,t,i){return q`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,o=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const o=t.size===i.length?void 0:[...t];this._set("areas",o)},r=this._getDiscoveredDevices(),a=e.hidden_devices??[],n=new Map;for(const e of r){const t=e.area??"";n.has(t)||n.set(t,[]),n.get(t).push(e)}const l=[...t.map(e=>e.name)];n.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=n.get("")?.length??0,h=q`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>r.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),o=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return q`
          ...
          ${s?q`
            <div class="room-expanded">
              <div class="room-devices">
                ${i.map(t=>{const i=a.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id,r=t.area?q`<span class="fav-dev-area">${t.area}</span>`:Z;return q`
                    <div class="room-device-row ${o?"selected":""}">
                      ...
                      <label class="sw">
                        <input type="checkbox" .checked=${!i} @change=${()=>{const e=i?a.filter(e=>e!==t.device_id):[...a,t.device_id];this._set("hidden_devices",e.length?e:void 0)}}>
      ...
      ${l.map(t=>{const i=t||"No Room",r=n.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return q`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${r.length?q`<span class="room-count">${r.length}</span>`:Z}
          ...
          ${c?q`
            <div class="room-expanded">
              ...
              <div class="room-devices">
                ${r.length?r.map(t=>{const i=a.includes(t.device_id),s=!!e.device_styles?.[t.device_id],o=this._selectedDeviceId===t.device_id;return q`
                    <div class="room-device-row ${o?"selected":""}">
      ...
      ${this._xcDraft?q`
        ...
        </div>`:Z}`,o=e.length?this._badge(String(e.length),"#8aa0ff","rgba(120,140,255,0.12)"):Z;return this._sec("extra-cards","▤","rgba(120,140,255,0.12)","#8aa0ff","Extra cards",o,s)}_renderCheckDropdown(e,t,i,s,o,r){const a=this._openDiscDropdown===e,n=new Set(s),l=n.size;return q`
      <div class="field">
        <div class="field-lbl">${t}</div>
        <button class="check-dd-btn ${a?"open":""}"
          @click=${()=>{this._openDiscDropdown=a?null:e}}>
        ...
        <div class="dp-hint-inline">${r}</div>
      ...
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?function(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,o]of Object.entries(t)){if(!o?.device_id||o.hidden_by)continue;const t=e.split(".")[0];if(!lt.has(t))continue;s.add(t);const r=(o.platform??"").toLowerCase();r&&i.add(r)}return{integrations:[...i].sort((e,t)=>Lt(e).localeCompare(Lt(t))),domains:[...s].sort()}}(this.hass):{integrations:[],domains:[]},o=q`
      <div class="field">
      ...
      <div class="dev-styling-tab">
        ...
        ${o&&r?q`
          <div class="pill-grp" style="margin-bottom:10px">
            <span class="pill ${"device"===a?"on":""}" @click=${()=>{this._styleScope="device"}}>This device</span>
            <span class="pill ${"profile"===a?"on":""}" @click=${()=>{this._styleScope="profile"}}>All ${l}${1!==n?"s":""} (${n})</span>
          </div>
          ${"device"===a?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&o?wt(r.type,o):void 0)??"default";return q`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[r.type]??{},t=e.tile_style??(this._config.smart_tile_styles?xt[r.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return q`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",xt[r.type],e=>this._setProfileStyle(r.type,{tile_style:e}),e=>this._setProfileStyle(r.type,{power_monitor_variant:e}))}
          </div>
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>Zi.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>n(e,t,i))}
              ${e.length<Wi.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
          <div class="lay-row lay-new">＋ new row</div>
        </div>
        <div class="field-lbl" style="margin-top:6px">Hidden blocks</div>
        <div class="lay-palette">
          ${a.length?a.map((e,t)=>n(e,-1,t)):q`<span class="dev-style-hint">drag a block here to hide it</span>`}
        </div>
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._allDevices().find(t=>t.device_id===e),s=i?bi(i,this.hass?.states??{}):null,o=!!s&&!this._devPanelAll,r=Zi.map(e=>e.id),a=this._config.tile_layout??r,n=At(a),l=At(t.tile_layout)??null,c=t.entity_animations??{},d=i=>{const s=(l??n).includes(i),o=function(e,t,i,s){const o=_t(e).map(e=>[...e]);if(!i)return o.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(o.some(e=>e.includes(t)))return o;const r=e=>{const t=s.indexOf(e);return t<0?s.length:t},a=o.findIndex(e=>r(e[0])>r(t));return o.splice(a<0?o.length:a,0,[t]),o}(t.tile_layout??a,i,!s,r),c=JSON.stringify(o)===JSON.stringify(_t(a));this._setDeviceStyle(e,{tile_layout:c?void 0:o})},p=(t,i,s)=>{const o={...c[t]??{}};if("speed"===i){const e=Number(s);1===e?delete o.speed:o.speed=e}else"none"===s?delete o[i]:o[i]=s;const r={...c,[t]:o};o.on||o.off||o.speed||delete r[t],this._setDeviceStyle(e,{entity_animations:Object.keys(r).length?r:void 0})},h=this._allDevices().find(t=>t.device_id===e),g=h?Bt(h):null,u=g?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control",generic:"scene-button"}[g.type]:void 0,v=t.tile_style,f=t.power_monitor_variant??"big-number",m=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
      ...
      <div class="dev-style-panel">
        ...
        ${(()=>{const i=h?Bt(h):null,r=t.tile_style??(this._config.smart_tile_styles&&i&&h?wt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(r);return c&&"default"!==c?Z:q`
            ${this._renderLayoutCanvas(t.tile_layout,a,t=>this._setDeviceStyle(e,{tile_layout:t}),o?s.blocks:void 0)}
            ${this._adv(q`
                <div class="field-lbl" style="margin:6px 0 4px">Visible blocks</div>
                <div class="block-toggles">
                  ${Zi.filter(e=>"graph"!==e.id).filter(e=>!o||s.blocks.has(e.id)||(l??n).includes(e.id)).map(e=>{const t=null===l?n.includes(e.id):l.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>d(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
        ${(()=>{const i=h?vi(h,this.hass.states):[];if(!i.length)return Z;const s=t.input_actions??{},o=e=>Array.isArray(e)?e.join(", "):e??"",r=e=>{const t=e.split(",").map(e=>e.trim()).filter(Boolean);return t.length>1?t:t[0]||void 0},a=(t,i)=>{const o={...s};i?o[t]={...o[t]??{action:"none"},...i}:delete o[t],this._setDeviceStyle(e,{input_actions:Object.keys(o).length?o:void 0})};return q`
            ...
            ${i.map(e=>{const t=s[e.entityId]??s[String(e.channel)],i=t?.action??"none";return q`
                <div style="display:flex;gap:6px;align-items:center;margin-bottom:4px">
                  ...
                  <select class="inline-text" style="flex:1"
                    @change=${t=>{const i=t.target.value;a(e.entityId,"none"===i?null:{action:i})}}>
                ...
                ${"perform-action"===i?q`
                  <div style="display:flex;gap:6px;margin:0 0 6px 34%">
                    <input type="text" class="inline-text" style="flex:1" placeholder="script.hall_lights"
                      ...
                      @change=${t=>a(e.entityId,{perform_action:t.target.value.trim()||void 0})}/>
                    <input type="text" class="inline-text" style="flex:1" placeholder="target entity — optional"
                      .value=${o(t?.entity)}
                      @change=${t=>a(e.entityId,{entity:r(t.target.value)})}/>
                  </div>`:Z}
                ${"toggle"===i?q`
                ...
                ${"none"!==i?q`
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    <select class="inline-text" style="flex:1"
                      @change=${t=>{const i=t.target.value;a(e.entityId,{hold_action:"none"===i?void 0:{action:"dim"}})}}>
                    ...
                    ${"dim"===t?.hold_action?.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=r(i.target.value);a(e.entityId,{hold_action:{...t?.hold_action??{action:"dim"},entity:s}})}}/>`:Z}
                  </div>
                  ${"dim"===t?.hold_action?.action?q`
                  ...
                  <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                    ...
                    <select class="inline-text" style="flex:1"
                      @change=${t=>{const i=t.target.value;a(e.entityId,{double_tap_action:"none"===i?void 0:{action:i}})}}>
                    ...
                    ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${i=>{const s=i.target.value,o="perform-action"===t.double_tap_action.action?{perform_action:s.trim()||void 0}:{entity:r(s)};a(e.entityId,{double_tap_action:{...t.double_tap_action,...o}})}}/>`:Z}
                  </div>
                  ${t?.double_tap_action&&"none"!==t.double_tap_action.action?q`
                    <div class="hint" style="margin:-4px 0 8px 34%">
                  ...
                  ${this._adv(q`
                    <div style="display:flex;gap:6px;align-items:center;margin:0 0 8px 34%">
                      ...
                      <input type="text" class="inline-text" style="flex:1"
                        ...
                        @change=${t=>{const i=t.target.value.trim();a(e.entityId,{select_chip:i?{entity:i}:void 0})}}/>
                    </div>`)}`:Z}
              `})}
          `})()}
        ${!o||s.chips.size?q`
        ...
        ${this._adv(b.length?q`
          ...
          ${b.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,o=c[t.entity_id]?.on??"none",r=c[t.entity_id]?.off??"none",a=c[t.entity_id]?.speed??1;return q`
              <div class="ent-anim-row">
                ...
                ${this._iconPicker(`ent-off-${e}-${t.entity_id}`,"none"===r?void 0:r,!1,e=>p(t.entity_id,"off",e??"none"))}
                <select class="anim-select" .value=${String(a)}
                  @change=${e=>p(t.entity_id,"speed",e.target.value)}>
                  <option value="0.25" ?selected=${.25===a}>0.25× Slowest</option>
                  <option value="0.5"  ?selected=${.5===a}>0.5× Slow</option>
                  <option value="1"    ?selected=${1===a}>1× Normal</option>
                  <option value="1.5"  ?selected=${1.5===a}>1.5× Fast</option>
                  <option value="2"    ?selected=${2===a}>2× Faster</option>
                  <option value="3"    ?selected=${3===a}>3× Rapid</option>
                  <option value="5"    ?selected=${5===a}>5× Frantic</option>
                </select>
              </div>`})}
        `:Z)}
      ...
      </div>`}_renderRoomHeaderChips(e,t){const i=this._allDevices().filter(t=>(t.area??"")===e),s=new Set;for(const e of i)for(const t of e.entities){if("sensor"!==t.domain)continue;const e=t.attributes?.device_class??"",i=ni.find(i=>i.dc===e||"rssi"===i.key&&("signal_strength"===e||t.entity_id.includes("_rssi")));i&&s.add(i.key)}const o=ni.filter(e=>s.has(e.key));if(!o.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors in this room.</div>`;const r=t.header_chips??li;return q`
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${o.map(t=>{const i=r.includes(t.key);return q`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?r.filter(e=>e!==t.key):[...r,t.key];var o;this._setAreaStyle(e,"header_chips",(o=s).length===li.length&&li.every(e=>o.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
        <div class="hint" style="margin-top:4px">Live power already shows in the room's meta row; add Energy/Voltage/etc. here.</div>
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,o)=>{const r=t[s]??o;return q`
        <div class="color-row">
        ...
        </div>`},s=(i,s,o,r,a,n,l)=>{const c=t[s]??n;return q`
        <div class="sl-row">
          <span class="color-key">${i}</span>
          <input type="range" min="${o}" max="${r}" step="${a}" style="flex:1;accent-color:#f4601e"
            .value=${String(c)}
      ...
      <div class="rsp-panel">
        ...
        ${this._adv(q`
        ${o("ON / OFF buttons")}
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",o=t.buttonSize??"md",r="square"===i||"circle"===i,a="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",n=r?"sm"===o?"3px 5px":"lg"===o?"6px 12px":"4px 8px":"sm"===o?"2px 8px":"lg"===o?"6px 16px":"4px 12px",l="sm"===o?"10px":"lg"===o?"13px":"11px",c=r?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${a};padding:${n};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,g=t.buttonShape||t.buttonVariant||t.buttonSize;return q`
      ...
      ${e.map((a,n)=>this._renderViewCard(a,n,e.length,t,i,s,o,r))}
    `}_renderViewCard(e,t,i,s,o,r,a,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,a,n),g=a.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return q`
            ...
            ${r.length?q`
              <div class="field">
                <div class="field-lbl">Areas
                  ${this._selAllNone(()=>this._updateViewFilter(e.id,{areas:r.map(e=>e.name)}),()=>this._updateViewFilter(e.id,{areas:[]}))}</div>
                <div class="pill-grp">
                  ${r.map(t=>q`
      ...
      </div>`}_layoutSectionDescriptors(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},o=(e,o,r)=>{const a=t[o]??r;return q`
        <div class="color-row">
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${ri.map(t=>{const i=e.header_chips??ai,s=i.includes(t.key);return q`
      ...
      </div>`)}`,a=(e,i,s)=>{const o=t[i]??s;return q`
        <div class="color-row">
      ...
      ${a("Tile background","tile_bg","rgba(255,244,232,0.035)")}
      ${a("Tile border","tile_border","rgba(255,244,232,0.08)")}
      ${a("Tile hover BG","tile_hover_bg","rgba(255,244,232,0.06)")}
      ${a("Tile hover shadow","tile_hover_shadow","rgba(0,0,0,0.35)")}
      ${a("Sensor chip BG","tile_sensor_bg","rgba(255,244,232,0.045)")}
      ${a("Expanded panel BG","tile_exp_bg","rgba(255,244,232,0.05)")}`,l=q`
      <div class="subgroup-lbl">Brand</div>
      ${a("Accent / brand","accent_color","#c98a63")}
      ${a("Room header label","area_header_color","#c98a63")}

      <div class="subgroup-lbl">Text &amp; status</div>
      ${a("Text primary","text_primary","#ece5dc")}
      ${a("Text secondary","text_secondary","#b3a596")}
      ${a("Text muted","text_muted","#7e7265")}
      ${a("Online dot","online_color","#93b384")}
      ${a("Offline dot","offline_color","#d47f62")}
      ${a("Power reading","power_color","#dba25c")}`,c=t.font_family??"",d=q`
      <div class="field">
      ...
      `)}
    `,u=q`
      ${a("Dashboard background","card_bg","#1e1a17")}
      <div class="field">
      ...
      <div class="field">
        ...
        `:Z}
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Z,body:r},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Z,body:g},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Z,body:u},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Z,body:l},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Z,body:d}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",o=t.tile_bg??"#1c1c1e",r=t.tile_border??"#2a2a30",a=t.tile_hover_bg??"rgba(255,255,255,0.07)",n=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",g=t.header_bg??"#1a1a2e",u=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",_=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,C=t.tile_radius??12,S=t.tile_border_width??1,z=t.header_radius??0,E=y>0?`${y}px solid ${x}`:"none",I=q`
      <div class="style-preview" style="font-family:${_};background:${s}">
        ...
        <div class="sp-tile"
          style="background:${o};border:${S}px solid ${r};border-radius:${C}px">
        ...
        <div class="sp-tile"
          style="background:${a};border:${S}px solid ${r};border-radius:${C}px">
          <div class="sp-row" style="color:${l};font-size:${(13*A).toFixed(0)}px">
      ...
      </div>`)}`,r=e.graph_sensors??Et,a=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const o=s[e]??i,r=!!s[e];return q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${o}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${o}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${r?q`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:Z}
        </div>`},l=q`
      <div class="field-lbl" style="margin-bottom:6px">Gauge ring colours</div>
      ${a.map(e=>n(e.key,e.label,e.default))}
      ${r.filter(e=>!a.find(t=>t.key===e)).length?q`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${r.filter(e=>!a.find(t=>t.key===e)).map(e=>{const t=ei.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??ei.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",ei.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${ei.map(e=>{const t=r.some(t=>si(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?r.filter(t=>si(t)!==e.key):[...r,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const o=""===s.trim()?void 0:parseFloat(s),r={...c[e]??{}};void 0===o||isNaN(o)?delete r[i]:r[i]=o;const a={...c,[e]:r};r.min||0===r.min||r.max||0===r.max||delete a[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(a).length?a:void 0})},p=q`
      ...
      </div>`;return{graphtype:{icon:"∿",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Graph Type",badge:Z,body:o},graphcolors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Per-sensor Colors",badge:Z,body:l},graphranges:{icon:"⇕",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Sensor Min / Max",badge:Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):Z,body:p}}}_sensorSectionDescriptors(){const e=this._config,t=e.sensors??[],i={};return Vi.forEach(s=>{const o=s.items.map(e=>e.key),r=o.filter(e=>t.includes(e)).length,a=o.every(e=>t.includes(e)),n=this._badge(`${r||"All"} / ${s.items.length}`,s.iconColor,s.iconBg),l=q`
          <div class="sensors-hdr">
            <span class="sensors-hdr-lbl">${0===r?"All shown (default)":`${r} of ${s.items.length} shown`}</span>
            <button class="sensors-all-btn" @click=${e=>{e.stopPropagation();const i=a?t.filter(e=>!o.includes(e)):[...new Set([...t,...o])];this._set("sensors",i)}}>${a?"− Deselect all":"+ Select all"}</button>
          </div>
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=si(i.key),r=!!ei.find(e=>e.key===o),a=e.graph_sensors??Et,n=a.some(e=>si(e)===o);return q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${r?q`<button class="sensor-graph-btn ${n?"on":""}"
                    title="${n?"Remove from graphs":"Add to graphs"}"
                    @click=${e=>{e.stopPropagation();const t=n?a.filter(e=>si(e)!==o):[...a,o];this._set("graph_sensors",t)}}>∿</button>`:Z}
                </div>`})}
          </div>`,c=s.group.toLowerCase().replace(" ","");i[c]={icon:s.icon,bg:s.iconBg,fg:s.iconColor,label:s.group,badge:n,body:l}}),i}_renderTabSections(e,t,i){const s=Ui.find(t=>t.id===e);if(!s)return q``;const o=new Set;return q`${s.sections.map(e=>{const s=t[e.id];if(!s)return Z;const r=i?i(e.id,o):Z;o.add(e.id);const a=q`${r}${this._sec(e.id,s.icon,s.bg,s.fg,e.label??s.label,s.badge,s.body)}`;return e.advanced?this._adv(a):a})}`}_renderGraphsSensorsTab(){const e=this._globalSectionDescriptors(),t=new Set(["electrical","environmental","deviceinfo","alerts"]);return this._renderTabSections("graphs",e,(e,i)=>{const s=[...i].some(e=>t.has(e));return t.has(e)&&!s?q`<div class="hint" style="margin:4px 2px 8px">Global default — override per room (Layout & Style → room) or per device (Rooms & devices).</div>`:Z})}_renderYamlTab(){const e=this._config,t=(e,i=0)=>{const s="  ".repeat(i);return Object.entries(e).map(([e,o])=>null==o?"":"object"!=typeof o||Array.isArray(o)?Array.isArray(o)?`${s}${e}:\n${o.map(e=>"object"==typeof e?`${s}  -\n${t(e,i+2)}`:`${s}  - ${e}`).join("\n")}`:`${s}${e}: ${o}`:`${s}${e}:\n${t(o,i+1)}`).filter(Boolean).join("\n")},i=t(e);return q`
      ...
      </div>`:Z}_applyTheme(e){const t={...this._config.style??{}};for(const e of $e)delete t[e];this._set("style",Object.keys(t).length?t:void 0),this._set("theme",e)}_onPickTheme(e){const t=this._config.style??{},i=$e.some(e=>void 0!==t[e]);i?this._pendingTheme=e:this._applyTheme(e)}_applySaved(){this._savedTheme&&(this._set("style",{...this._config.style??{},...this._savedTheme}),this._set("theme","custom"))}_clearLocalTweaks(){try{const e=[];for(let t=0;t<localStorage.length;t++){const i=localStorage.key(t);i&&i.startsWith("shelly-dashboard:")&&e.push(i)}for(const t of e)localStorage.removeItem(t);this._localTweaksCleared=e.length}catch{}}_resetLook(){const e=this._config,t={};for(const i of Wi._CONTENT_KEYS)void 0!==e[i]&&(t[i]=e[i]);this._emitNow({type:"custom:ha-device-dashboard",...di(),...t})}_onResetEverything(){this._resetArmed?(this._resetArmed=!1,this._emitNow({type:"custom:ha-device-dashboard",...di()})):this._resetArmed=!0}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=je(t),o=!!this._savedTheme&&Object.entries(this._savedTheme).every(([e,i])=>t[e]===i);return q`
          ...
          <div class="dp-group">
            ...
            <div class="theme-grid">
              ...
              ${Le.map(e=>{const t=Fe[e];return q`
                  <button class="theme-swatch ${s===e?"on":""}" title=${Ne[e]}
                    ...
                    <span class="ts-name">${Ne[e]}</span>
                  </button>`})}
            </div>
            ${this._pendingTheme?q`
              <div class="theme-warn">
                <div class="tw-msg">Replace your current custom colours with <b>${Ne[this._pendingTheme]}</b>?</div>
                <div class="tw-btns">
      ...
      </div>`}render(){if(!this._config)return q``;const e=Ui.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(Ui.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};Ui.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],r=e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t},a=o.length>1;return q`
      <div class="shell">
        <div class="tab-nav">
          ${e.map(e=>q`
        ...
        <div class="sec-toolbar">
          ...
          ${a?q`
            <button class="sec-toolbar-btn" title="Expand all sections" @click=${()=>r(!0)}>▾ Expand all</button>
            <button class="sec-toolbar-btn" title="Collapse all sections" @click=${()=>r(!1)}>▸ Collapse all</button>
          `:Z}
        </div>
      ...
      </div>`}};Yi.ROW_MAX=3,Yi.DRAG_SLOP=6,Yi._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],Yi.styles=[st,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Yi.prototype,"hass",void 0),e([fe()],Yi.prototype,"_config",void 0),e([fe()],Yi.prototype,"_tab",void 0),e([fe()],Yi.prototype,"_styleScope",void 0),e([fe()],Yi.prototype,"_cardThemeRoom",void 0),e([fe()],Yi.prototype,"_newStyleName",void 0),e([fe()],Yi.prototype,"_renamingStyle",void 0),e([fe()],Yi.prototype,"_advanced",void 0),e([fe()],Yi.prototype,"_defaultsOpen",void 0),e([fe()],Yi.prototype,"_resetArmed",void 0),e([fe()],Yi.prototype,"_xcPlacement",void 0),e([fe()],Yi.prototype,"_xcRoom",void 0),e([fe()],Yi.prototype,"_xcAdding",void 0),e([fe()],Yi.prototype,"_xcEditIndex",void 0),e([fe()],Yi.prototype,"_xcDraft",void 0),e([fe()],Yi.prototype,"_xcDashboards",void 0),e([fe()],Yi.prototype,"_xcImportCards",void 0),e([fe()],Yi.prototype,"_xcImportLoading",void 0),e([fe()],Yi.prototype,"_pendingTheme",void 0),e([fe()],Yi.prototype,"_savedTheme",void 0),e([fe()],Yi.prototype,"_expandedViewId",void 0),e([fe()],Yi.prototype,"_openSections",void 0),e([fe()],Yi.prototype,"_expandedRooms",void 0),e([fe()],Yi.prototype,"_expandedRoomStyle",void 0),e([fe()],Yi.prototype,"_selectedDeviceId",void 0),e([fe()],Yi.prototype,"_devPanelAll",void 0),e([fe()],Yi.prototype,"_conflictsOpen",void 0),e([fe()],Yi.prototype,"_localTweaksCleared",void 0),e([fe()],Yi.prototype,"_deviceSearch",void 0),e([fe()],Yi.prototype,"_styleClipFeedback",void 0),e([fe()],Yi.prototype,"_openDiscDropdown",void 0),e([fe()],Yi.prototype,"_iconPickerState",void 0),Yi=Wi=e([he("ha-device-dashboard-editor")],Yi);let Ki=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Ki.styles=n`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Ki.prototype,"hass",void 0),e([ve()],Ki.prototype,"entity",void 0),e([ve({attribute:!1})],Ki.prototype,"features",void 0),e([fe()],Ki.prototype,"_el",void 0),Ki=e([he("hdd-delegated")],Ki);let Ji=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Ji.styles=n`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Ji.prototype,"hass",void 0),e([ve({attribute:!1})],Ji.prototype,"config",void 0),e([fe()],Ji.prototype,"_el",void 0),Ji=e([he("hdd-card")],Ji);console.info("%c ha-device-dashboard %c cascade-2026-08-22b ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
