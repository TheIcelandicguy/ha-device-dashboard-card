...
`;function qe(e,t,i="ts-hero-name"){return q`
    ...
    </select>`}const Xe=/^\s*[♪♫♬♩]\s*/,Qe=new Set(["pixels","pixelwave","juggles","matripix","gravimeter","plasmoid","puddles","midnoise","noisemeter","freqwave","freqmatrix","geq","waterfall","freqpixels","noisefire","puddlepeak","noisemove","ripple peak","freqmap","gravcenter","gravcentric","gravfreq","dj light","funky plank","blurz","waverly","swirl","rocktaves","akemi","ps spray","ps geq 2d","ps geq nova","ps blobs","ps geq 1d","ps sonic stream","ps sonic boom","ps springy"]),Ye=e=>Xe.test(e)||Qe.has(e.replace(Xe,"").trim().toLowerCase());function Ke(e,t,i){if(e.length<=1)return Z;const s=e.filter(Ye),o=e.filter(e=>!Ye(e)&&"Off"!==e),a=e.find(e=>"Off"===e)??e.find(e=>"Solid"===e),r=e=>q`
...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function at(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),r=o.filter(i=>null==e.getInputActionLabel(t,i)),n=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    </div>`}const rt=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function nt(e,t={}){const i=!0===t.universal,s=i?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,o=i?new Set([...ct,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,a=i&&t.includeDomains?.length?new Set(t.includeDomains):null,r=i?new Set(t.excludeDomains??[]):null,n=e.entities??{},l=e.devices??{},c=e.areas??{},d=new Map;for(const[t,p]of Object.entries(n)){if(!p?.device_id)continue;if(p.hidden_by)continue;const n=t.split(".")[0];if(!rt.has(n))continue;if(r?.has(n))continue;if(a&&!a.has(n))continue;const h=(p.platform??"").toLowerCase();if(!i&&"shelly"!==h&&"bthome"!==h)continue;if(o?.has(h)&&!s?.has(h))continue;const u=p.device_id;if(!d.has(u)){const e=l[u];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),s=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!i&&"bthome"===h&&!s)continue;const o=e.area_id??p.area_id,a=o?c[o]?.name:void 0;d.set(u,{device_id:u,name:e.name_by_user??e.name??u,area:a,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:s,integration:h,entities:[]})}const g=d.get(u);"shelly"===h&&(g.isShelly=!0,g.integration="shelly");const v=e.states[t];g.entities.push({entity_id:t,domain:n,state:v?.state??"unavailable",attributes:v?.attributes??{},device_id:u,area_id:p.area_id,platform:h,entity_category:p.entity_category??void 0})}const p=new Set;for(const[e,t]of d){if(p.has(e))continue;const i=l[e],s=i?.via_device_id;if(!s||!d.has(s)||p.has(s))continue;const o=l[s],a=i?.configuration_url??"",r=o?.configuration_url??"",n=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},c=a&&r&&n(a)===n(r),h=!a&&r&&t.integration===d.get(s).integration;if(!c&&!h)continue;const u=d.get(s);u.entities.push(...t.entities),!u.ip&&t.ip&&(u.ip=t.ip),!u.model&&t.model&&(u.model=t.model),p.add(e)}for(const e of p)d.delete(e);const h=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},u=new Map;for(const e of d.keys())for(const t of h(l[e]))u.has(t)||u.set(t,[]),u.get(t).push(e);const g=new Map,v=e=>{let t=e;for(let e=0;g.has(t)&&e<8;e++)t=g.get(t);return t},f=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of u.values()){if(e.length<2)continue;const t=[...new Set(e.map(v))].filter(e=>d.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=d.get(t),s=d.get(e);return f(i)!==f(s)?f(i)>f(s)?t:e:i.entities.length>s.entities.length?t:e}),s=d.get(i);for(const e of t){if(e===i)continue;const t=d.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),g.set(e,i),d.delete(e)}}let m=Array.from(d.values()).filter(e=>e.entities.length>0);return i&&(m=m.filter(e=>function(e,t){return"all"===t||(!!vt(e)||"devices"===t&&ft(e))}(e,t.scope??"devices"))),m.sort((e,t)=>e.name.localeCompare(t.name))}function lt(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const ct=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),dt=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),pt=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),ht=new Set(["switch","light","cover","climate","valve"]),ut={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function gt(e){return e.entities.filter(e=>"primary"===lt(e)&&!ht.has(e.domain)&&e.domain in ut)}const vt=e=>e.entities.some(e=>"primary"===lt(e)&&dt.has(e.domain)),ft=e=>e.entities.some(e=>"primary"===lt(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&pt.has(e.attributes?.device_class??""));const mt={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},bt={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control"};function yt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:bt[e]}const xt={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"input-control":[{id:"name",label:"Name"},{id:"keypad",label:"Channel keys"},{id:"input_rows",label:"Unassigned channel rows"},{id:"target_state",label:"Channel name under the key"},{id:"last_event",label:"Last-pressed time"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function wt(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function kt(e){const t=wt(e);return t&&t.flat()}const _t={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},At=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const Ct={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},St=["power","temperature","humidity","battery"],zt={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",delegated_controls:"Native controls",badges:"Type & gen badges"};function It(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),o=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||o||a?"sensor":"input"}else s="input";return s}const Tt=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),Et={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=It(e);if(Tt.has(t)){const i=function(e){if(e)for(const t of At)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:Rt(e.model??""),label:mt[t],integration:e.integration}}},Mt={id:"generic",matches:()=>!0,detect:e=>{const t=It(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":mt[t],integration:e.integration}}},Ot=[Et,Mt];function Dt(e){for(const t of Ot)if(t.matches(e))return t.detect(e);return Mt.detect(e)}function Rt(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const Bt={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function Pt(e){return Bt[e.toLowerCase()]??e.toUpperCase().slice(0,6)}function $t(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,o]of Object.entries(t)){if(!o?.device_id||o.hidden_by)continue;const t=e.split(".")[0];if(!rt.has(t))continue;s.add(t);const a=(o.platform??"").toLowerCase();a&&i.add(a)}return{integrations:[...i].sort((e,t)=>Pt(e).localeCompare(Pt(t))),domains:[...s].sort()}}const Lt="—";function Ft(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:Lt}function Nt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:Lt}function jt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:Lt}function Ht(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:Lt}function Ut(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:Lt}function Wt(e){return!Number.isFinite(e)||e<0?Lt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function qt(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":Lt}function Gt(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:Lt}function Vt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:Lt}function Zt(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:Lt}function Xt(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:Lt}function Qt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:Lt}function Yt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:Lt}function Kt(e){return Number.isFinite(e)?`${Math.round(e)} %`:Lt}const Jt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],ei=Object.fromEntries(Jt.map(e=>[e.key,e.label.split(" ")[0]])),ti={co2:"carbon_dioxide",rssi:"signal_strength"};function ii(e){return ti[e]??e}function si(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(ii).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,o]of Object.entries(s)){const s=ii(t);s!==t&&(e=!0),s in i||(i[s]=o)}e&&(s=i,t=!0)}let o=e.style,a=e.theme;if(o&&"object"==typeof o){const e=je(o);if("custom"!==e&&(void 0===a||a===e)){const i={...o};for(const e of Ne)delete i[e];Object.keys(i).length!==Object.keys(o).length&&(o=Object.keys(i).length?i:void 0,a=e,t=!0)}}if(!t)return e;const r={...e};return o!==e.style&&(void 0===o?delete r.style:r.style=o),a!==e.theme&&(r.theme=a),i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const oi=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],ai=["online","offline","power","alerts"],ri=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Light",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],ni=["power","energy","voltage","current","temperature"],li=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:ai});function ci(){return{...li,header_chips:[...li.header_chips??[]]}}const di=["type","views","default_view","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","delegate_controls","header_cards","footer_cards","area_cards","areas","hidden_devices","favorites","hidden_entities","show_offline","title","columns","tile_size","sort_by","tile_style","smart_tile_styles","power_monitor_variant","show_graphs","tile_layout","tile_opacity","card_opacity","header_opacity","header_show_title","header_show_stats","header_show_cloud","header_show_orbs","effects","header_chips","card_bg_image","card_bg_image_size","show_power_bar","power_bar_max","show_entity_list","theme","show_attention","attention_battery","show_firmware_summary","style","area_styles","device_styles","profile_styles","style_presets","custom_styles","energy_period","graph_sensors","graph_hours","graph_style","graph_line_color","graph_sensor_colors","sensors"],pi=["grid_options","view_layout","layout_options","visibility","card_mod"];function hi(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function ui(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function gi(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function vi(e,t,i,s){let o=e.trim();const a=t.trim();return a&&o.toLowerCase().startsWith(a.toLowerCase())&&(o=o.slice(a.length).trim()),o||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function fi(e,t){const i=e.entities.filter(hi),s=e.entities.filter(ui),o=new Set,a=[];return i.forEach((i,r)=>{const n=t[i.entity_id],l=gi(i.entity_id),c=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),a=s.find(e=>!o.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return a||(null!=t?s.find(e=>!o.has(e.entity_id)&&gi(e.entity_id)===t):void 0)})(i,l);c&&o.add(c.entity_id);const d=c?t[c.entity_id]:null,p=d?.attributes?.event_type;a.push({entityId:i.entity_id,label:vi(n?.attributes?.friendly_name??"",e.name,l,i.entity_id),isOn:"on"===n?.state,isButton:!!c,channel:l??0,lastEvent:p??null,lastChanged:n?.last_changed??null,_sort:l??50+r})}),s.filter(e=>!o.has(e.entity_id)).forEach((i,s)=>{const o=t[i.entity_id],r=gi(i.entity_id),n=o?.state&&"unknown"!==o.state&&"unavailable"!==o.state?o.state:null;a.push({entityId:i.entity_id,label:vi(o?.attributes?.friendly_name??"",e.name,r,i.entity_id),isOn:!1,isButton:!0,channel:r??0,lastEvent:o?.attributes?.event_type??null,lastChanged:o?.last_changed??n,_sort:r??50+s})}),a.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}const mi=new Set(["power","voltage","current","energy","apparent_power","reactive_power","frequency","power_factor","temperature","humidity","illuminance","co2","battery","rssi"]),bi={select:/_enum_\d+$/i,number:/_number_\d+$/i,button:/_button_\d+$/i,text:/_text_\d+$/i,switch:/_boolean_\d+$/i};function yi(e,t){const i=function(e){const t=new Set;for(const i of e.entities){const e=i.attributes?.device_class??"",s=i.entity_id;if("sensor"===i.domain){if(!e&&(s.endsWith("_ip")||s.endsWith("_ip_address"))){t.add("ip");continue}if(!e&&s.endsWith("_ssid")){t.add("ssid");continue}if(!e&&(s.endsWith("_firmware")||s.endsWith("_fw"))){t.add("fw_version");continue}if(!e&&s.endsWith("_mac")){t.add("mac");continue}"carbon_dioxide"===e?t.add("co2"):"signal_strength"===e||s.includes("rssi")?t.add("rssi"):s.includes("uptime")?t.add("uptime"):["power","apparent_power","reactive_power","power_factor","frequency","energy","voltage","current","temperature","humidity","illuminance","gas","battery"].includes(e)&&t.add(e)}else"binary_sensor"===i.domain&&("door"===e||"window"===e||"opening"===e?t.add("door"):"moisture"===e?t.add("flood"):"heat"===e||s.includes("overtemp")?t.add("overtemp"):"safety"===e||s.includes("overpower")?t.add("overpower"):"connectivity"===e?s.includes("cloud")?t.add("cloud"):s.includes("mqtt")?t.add("mqtt"):s.includes("eth")&&t.add("eth"):["motion","smoke","gas","vibration"].includes(e)&&t.add(e))}return t}(e),s=t=>e.entities.some(e=>e.domain===t),o=t=>e.entities.filter(e=>e.domain===t).length,a=new Set(["name_row","badges"]);i.size&&a.add("sensors");const r=[...i].some(e=>mi.has(e));return r&&a.add("graph"),s("light")&&a.add("dimmer"),s("cover")&&a.add("cover_controls"),s("climate")&&a.add("trv_control"),s("valve")&&a.add("valve_controls"),fi(e,t).length&&a.add("input_channels"),o("switch")+o("light")>1&&a.add("relay_channels"),i.has("power")&&a.add("power_bar"),e.entities.some(e=>bi[e.domain]?.test(e.entity_id))&&a.add("virtual_controls"),["lock","media_player","fan","vacuum"].some(s)&&a.add("delegated_controls"),{chips:i,blocks:a,hasEnergy:i.has("energy")||i.has("power"),hasGraphs:r,hasOnOff:["switch","light","cover","valve","fan","lock","climate","binary_sensor"].some(s)}}const xi=e=>e.config.device_styles?.[e.device.device_id],wi=e=>e.config.profile_styles?.[e.profile],ki=e=>e.device.area?e.config.area_styles?.[e.device.area]:void 0,_i={hero:"big-number",ring:"gauge",spark:"graph",hbar:"compact",list:"table"};function Ai(e){return xi(e)?.tile_style??wi(e)?.tile_style??ki(e)?.tile_style??e.view?.tile_style??e.config.tile_style??(e.config.smart_tile_styles?yt(e.profile,e.device):void 0)}function Ci(e,t){if("string"==typeof t&&t.startsWith("custom:")){const i=e.custom_styles?.[t.slice(7)];return{base:i?.base??"default",custom:i}}return{base:t}}function Si(e){return e&&e in _i?{style:"power-monitor",variant:_i[e]}:"command"===e?{style:"scene-button",variant:"big-number"}:{style:e??"default",variant:"big-number"}}const zi=e=>Ci(e.config,Ai(e)).custom;function Ii(e){const{base:t}=Ci(e.config,Ai(e));return Si(t).style}function Ti(e,t,i){return i?.columns??t?.columns??e.columns??3}const Ei=new Set(["unavailable","unknown"]);function Mi(e,t){return e.entities.some(e=>{const i=t[e.entity_id];return!!i&&!Ei.has(i.state??"")})}function Oi(e,t){const i=[];for(const s of e.entities){if("binary_sensor"!==s.domain)continue;const e=t[s.entity_id];if(!e||"on"!==e.state)continue;const o=e.attributes?.device_class??"";"heat"===o||s.entity_id.includes("overtemp")?i.push("overtemp"):"safety"===o||s.entity_id.includes("overpower")?i.push("overpower"):"smoke"===o?i.push("smoke"):"moisture"===o?i.push("water"):"gas"===o&&i.push("gas")}return[...new Set(i)]}function Di(e,t){let i=null;for(const s of e.entities){if("sensor"!==s.domain)continue;const e=t[s.entity_id];if(!e||"battery"!==e.attributes?.device_class)continue;const o=parseFloat(e.state??"");isNaN(o)||(i=null===i?o:Math.min(i,o))}return i}function Ri(e,t){for(const i of e.entities){if("update"!==i.domain)continue;const e=t[i.entity_id];if(e&&"on"===e.state)return{current:e.attributes?.installed_version??"",next:e.attributes?.latest_version??""}}return null}function Bi(e){const t=new Map;for(const i of e){const e=i.sw_version;if(!e)continue;const s=Pi(e);t.has(s)||t.set(s,[]),t.get(s).push(i)}const i=[...t.entries()].map(([e,t])=>({version:e,devices:t,current:!1})).sort((e,t)=>function(e,t){const i=e.split(".").map(e=>parseInt(e,10)),s=t.split(".").map(e=>parseInt(e,10));for(let o=0;o<Math.max(i.length,s.length);o++){const a=i[o]??0,r=s[o]??0;if(isNaN(a)||isNaN(r))return e.localeCompare(t);if(a!==r)return a-r}return 0}(t.version,e.version));return i.length&&(i[0].current=!0),i}function Pi(e){const t=e.match(/(\d+\.\d+(?:\.\d+)?)/);return t?t[1]:e}const $i=["temperature","humidity","carbon_dioxide","illuminance","battery"],Li=["motion","door","window","moisture","smoke","gas"];function Fi(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:r}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,u=110,g=180,v=180,f=22,m=102,b=e=>e*Math.PI/180,y=(e,t)=>{const i=v+g*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(b(v)),o=u+e*Math.sin(b(v)),a=h+e*Math.cos(b(i)),r=u+e*Math.sin(b(i)),n=g*t>180?1:0;return`M ${s.toFixed(2)} ${o.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${r.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=u+22;return q`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      ...
      <svg viewBox="0 0 ${2*h} ${w}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        ${p.map((e,t)=>{const s=m-t*f,o=Math.min(1,Math.max(0,((e.val??e.min)-e.min)/(e.max-e.min||1))),a="W"===e.label||"A"===e.label?"left":"right",r=(h+s*("left"===a?-1:1)).toFixed(1),n=(u+8).toFixed(1),l="left"===a?"start":"end";return G`
    ...
    </div>`}(e);case"graph":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:r}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=48,h=3,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)";let v=0,f=p-h;const m=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=i.max??Math.max(...e),r=o-s||1,n=(e,t)=>t/(c.length-1)*d,l=e=>p-h-(e-s)/r*(p-2*h),m=e.indexOf(o);v=n(null,m),f=l(o);const b=c.map((e,t)=>`${n(null,t).toFixed(1)},${l(e.v).toFixed(1)}`).join(" "),y=`pm-gr-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">
    ...
    <polyline points="${b}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>
    ${o>s?G`<circle cx="${v.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${g}"/>
      <line x1="${v.toFixed(1)}" x2="${v.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${g}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:Z}`})():Z;return q`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=r.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${Wt(r.uptime)}</span>`:Z}
        </div>
    ...
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:r}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,r=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${r} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${r}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Z,f=(e,t,i=!1)=>q`
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:o,config:a,profile:r}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,h=2,u=a.graph_style?.line_width??1.5,g=i?s:"var(--sc-text-muted)",v=c.length>1?(()=>{const e=c.map(e=>e.v),i=a.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),o=(i.max??Math.max(...e))-s||1,r=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-h-(e.v-s)/o*(p-2*h)).toFixed(1)}`).join(" "),n=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return G`<defs><linearGradient id="${n}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${g}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${g}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${r} ${d},${p-h} 0,${p-h}" fill="url(#${n})"/>
    <polyline points="${r}" fill="none" stroke="${g}" stroke-width="${u}" stroke-linecap="round"/>`})():Z;return q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ...
        ${e.showEl("uptime")?q`<span class="ts-uptime">${n.uptime?Wt(n.uptime):""}</span>`:Z}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,r):Z}
    </div>`}(e)}}const Ni=140,ji=70;function Hi(e){const{device:t,isOn:i,accent:s,online:o,hass:a,profile:r}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==r.type&&"rgb"!==r.type)return q`
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${Ft(l.power)}</div>`:Z}
      </div>`;const c=i?Math.max(1,n.brightness??1):0,d=!!n.colorModes?.length,p=d&&(n.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&n.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",u=n.whiteValue??0,g=a.states[n.entityId],v=g?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,x=v.max_mireds??500,w=v.color_temp??y,k=d&&n.rgbColor?(()=>{const[e,t,i]=n.rgbColor,s=Math.max(e,t,i),o=s-Math.min(e,t,i);let a=0;o>0&&(a=s===e?((t-i)/o+6)%6:s===t?(i-e)/o+2:(e-t)/o+4);const r=0===s?0:o/s,l=(e=>e*Math.PI/180)(60*a-90);return{x:ji+62*r*Math.cos(l),y:ji+62*r*Math.sin(l)}})():null,_=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Ni}" height="${Ni}" viewBox="0 0 ${Ni} ${Ni}"
            class="ts-light-wheel" @click=${e=>{if(!d||!n)return;e.stopPropagation();const t=e.currentTarget,i=t.getBoundingClientRect(),s=i.left+i.width/2,o=i.top+i.height/2,r=e.clientX-s,l=e.clientY-o,c=Math.sqrt(r*r+l*l),p=i.width/2-8;if(c>p+8){const e=t.parentElement;return void(e&&(e.classList.remove("ts-wheel-pulse"),e.offsetWidth,e.classList.add("ts-wheel-pulse")))}const h=(180*Math.atan2(l,r)/Math.PI+90+360)%360,u=Math.min(1,c/p),g=e=>{const t=(e+h/60)%6;return 1-u*Math.max(0,Math.min(t,4-t,1))},v=Math.round(255*g(5)),f=Math.round(255*g(3)),m=Math.round(255*g(1));a.callService("light","turn_on",{entity_id:n.entityId,rgb_color:[v,f,m]})}} style="cursor:crosshair">
            <defs>
              <radialGradient id="${_}">
            ...
            <foreignObject x="0" y="0" width="${Ni}" height="${Ni}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${Ni}px;height:${Ni}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${ji}" cy="${ji}" r="${ji}" fill="url(#${_})" opacity="${i?1:.3}"/>
      ...
      ${null!=l.power&&e.showEl("power")?q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Ft(l.power)}</div>`:Z}
    </div>`}function Ui(e,t){const{device:i,profile:s,config:o,hass:a,online:r}=e,n=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),h=e.getFirmware(i),u=e.getPower(i),g=e.getSensors(i),v=e.getInputChannels(i),f=n?.isOn??!1,m=void 0!==n?.brightness,b=n&&m&&f?Math.max(1,n.brightness??1):0,y=!!n?.colorModes?.length,x=n?.rgbColor?e.rgbToHex(...n.rgbColor):"#ffffff",w=!!n?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,_="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,A=Pt(i.integration);switch(t){case"name_row":{const t=o.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let a;if(s)a=tt(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;a=t?tt(t,!0,"--ent-spd:1","tile-icon"):q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;a=i?tt(i,!0,"--ent-spd:1","tile-icon"):q``}else a=q``;const p=n?e.renderEntityAnim(n.entityId,f,i.device_id):q``;return q`
        <div class="tile-top">
      ...
      `:q``}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=gt(i);return e.length?q`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>q`
            <hdd-delegated .hass=${a} .entity=${e.entity_id} .features=${ut[e.domain]}></hdd-delegated>
          `)}
        </div>`:q``}case"power_bar":return e.renderPowerBar(i);case"badges":return q`
        <div class="tile-bot">
          ${null!=u?q`<span class="tile-power">${Ft(u)}</span>`:Z}
      ...
      `;default:return q``}var C}const Wi=255;function qi(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=r.rssi?q`<div class="ds-signal">Wi-Fi: ${qt(r.rssi)} (${r.rssi} dBm)${null!=r.uptime?q` · Up ${Wt(r.uptime)}`:Z}</div>`:Z}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,r=o?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?Z:q`<span class="ds-channel-power">${Ft(c)}</span>`}
    ...
    ${Vi(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return q`
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?q`<span class="ds-big-power">${Ft(s.power)}</span>`:Z}
    </div>
    ${Vi(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,o=Math.round(s/255*100);return q`
    <div class="ds-section">
    ...
    ${Vi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Wi*100);return q`
    <div class="ds-section">
    ...
    ${Vi(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return q`
    <div class="ds-section">
    ...
    ${Vi(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return q`
    <div class="ds-section">
    ...
    ${Vi(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return q`
    <div class="ds-section">
    ...
    ${Vi(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return q`${Vi(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),o=e.getAlerts(t);return q`
    ...
    ${Vi(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t}=e,i=e.getInputChannels(t);return q`
    <div class="ds-section">
    ...
    ${Vi(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),o=t.entities.filter(e=>"switch"===e.domain);return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    ${Vi(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return q`
    ${t?q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${Vi(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return q`
    ${s.length?q`
      <div class="ds-section">
    ...
    </div>`}function Gi(e){if(!e.getGraphEntities(e.device).length)return q``;const t=e.getDetailHistoryRange();return q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function Vi(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:o=!1}=t;return q`
    ${o&&s?Gi(e):Z}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ft(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Z}
        ${null!=t.voltage?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${jt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:Z}
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ht(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Z}
        ${null!=t.energy?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Nt(t.energy)}</span><span class="ds-sensor-label">${t.energyLabel}</span></div>`:Z}
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ut(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Z}
      </div>
    </div>`:q``}(e):Z}
    ${!o&&s?Gi(e):Z}
    ${function(e){const{device:t,hass:i}=e;if(!t.entities.length)return q``;if(!1===e.config.show_entity_list)return q``;const s=new Set(e.config.hidden_entities??[]),o=t.entities.filter(e=>!s.has(e.entity_id));if(!o.length)return q``;const a=(t,s)=>{const o=i.states[t.entity_id],a=o?.attributes?.friendly_name??t.entity_id,r=o?.state??"unknown",n=o?.attributes?.unit_of_measurement??"",l="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,c="on"===r,d=o?.last_changed?e.timeAgo(o.last_changed):"";return q`
      ...
      </div>`},r=o.filter(e=>"primary"===lt(e)),n=o.filter(e=>"config"===lt(e)),l=o.filter(e=>"diagnostic"===lt(e));return q`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=o.rssi?q`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${qt(o.rssi)} (${o.rssi} dBm)</span></div>`:Z}
        ${null!=o.uptime?q`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${Wt(o.uptime)}</span></div>`:Z}
        ...
        ${i.length?q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:Z}
          ...
          </div>`;const A=s.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[k]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,T=s[0].t,E=s[s.length-1].t,M=E-T||1,O=e=>(e.t-T)/M*a,D=e=>r-4-(e.v-S)/I*(r-8),R=s.map(e=>`${O(e).toFixed(1)},${D(e).toFixed(1)}`).join(" "),B=O(s[0]).toFixed(1),P=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,$=A[A.length-1],L=$%1==0?`${$}`:$.toFixed(1),F=Math.max(...A),N=Math.min(...A);let j=A.indexOf(F),H=A.indexOf(N);j<0&&(j=0),H<0&&(H=0);const U=O(s[j]).toFixed(1),W=D(s[j]).toFixed(1),V=O(s[H]).toFixed(1),X=D(s[H]).toFixed(1),Q=y(s[0].t),Y=y((s[0].t+E)/2),K=f/M*a,J=`${Math.max(.3,.7*K).toFixed(2)} ${Math.max(.3,.3*K).toFixed(2)}`,ee=c&&z-S>0;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Z:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${r}" preserveAspectRatio="none"
                ...
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),r=T+o*M;let n=s[0];for(const e of s)Math.abs(e.t-r)<Math.abs(n.t-r)&&(n=e);const l=O(n),c=D(n),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const h=t.parentElement,u=h?.querySelector(".spark-tooltip");if(u){const e=u.querySelector(".spark-tooltip-val"),t=u.querySelector(".spark-tooltip-time");e&&(e.textContent=`${n.v%1==0?String(n.v):n.v.toFixed(1)} ${w}`),t&&(t.textContent=y(n.t)),u.style.left=`${(l/a*100).toFixed(1)}%`,u.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                `:Z}
                ${"bar"===h?s.map(e=>{const t=Math.max(2,a/s.length-2),i=O(e)-t/2,o=D(e),n=r-4-o;return G`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,n).toFixed(1)}" rx="${u}" fill="${_}" opacity="0.75"/>`}):G`
          ...
          ${p?q`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${Q}</span><span>${Y}</span><span>now</span>
              </div>
      ...
      <div class="sparklines-block ${i?"exp":""}">
        ${w}
      </div>`}_closeDetailSheet(){this._detailDevice=null}_blockLayout(e,t){return function(e){return xi(e)?.tile_layout??wi(e)?.tile_layout??zi(e)?.tile_layout??e.config.style_presets?.default?.tile_layout??e.config.tile_layout??_t[e.profile]??_t.generic}(this._cascade(e,t))}_getBlockOrder(e,t){const i=this._tileBlockOverride.get(e.device_id);return i||(kt(this._blockLayout(e,t))??_t[t.type]??_t.generic)}_trvColor(e){const t=Math.max(0,Math.min(1,e));let i,s,o;if(t<.5){const e=2*t;i=Math.round(74+156*e),s=Math.round(144+-18*e),o=Math.round(217+-183*e)}else{const e=2*(t-.5);i=Math.round(230+-1*e),s=Math.round(126+-69*e),o=Math.round(34+19*e)}return`rgb(${i},${s},${o})`}_renderTrvDial(e){const{minTemp:t,maxTemp:i,targetTemp:s,currentTemp:o,step:a,entityId:r}=e,n=this._trvDragTemp??s??t,l=i-t||1,c=Math.max(0,Math.min(1,(n-t)/l)),d=e=>210+(e-t)/l*300,p=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),70+t*Math.sin((e-90)*Math.PI/180)],h=(e,t,i)=>{const[s,o]=p(e,i),[a,r]=p(t,i);return`M ${s} ${o} A ${i} ${i} 0 ${t-e>180?1:0} 1 ${a} ${r}`},u=this._trvColor(c),g=d(n),[v,f]=p(g,54),m=null!=o?(o-t)/(i-t):null,b=null!=o?p(d(o),54):null,y=null!=m?this._trvColor(m):u,x=`trv-grad-${r.replace(/\W/g,"_")}`;return G`
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const o=e=>{const o=this._trvTempFromEvent(e,s,t,i,a);null!=o&&(this._trvDragTemp=o)},n=e=>{const l=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=l&&this._setTemp(r,l),s.removeEventListener("pointermove",o),s.removeEventListener("pointerup",n)};s.addEventListener("pointermove",o),s.addEventListener("pointerup",n)}}>
        ...
        ${g>210?G`<path d="${h(210,g,54)}" fill="none" stroke="url(#${x})" stroke-width="8" stroke-linecap="round"/>`:Z}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:o,isHeating:a,valveOpen:r,hasFan:n}=i,l=e.type;if("relay"===l||"plug"===l)return n?G`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        </div>`:Z,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=u&&n?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,x=y?.attributes?.effect_list??[],w=y?.attributes?.effect??null,k=u?q`
    ...
    `:Z,S=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),z=S.length>1?q`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t,c())}
      </div>
    `:Z;return p.length||u||o||a||r||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${r}" style=${_e(l)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?Ui(a,e[0]):q`<div class="tile-row">${e.map(e=>Ui(a,e))}</div>`)}
        </div>`}const f=e.area??"",m=this._tileAccent(e,f);return q`<div class="${`tile tile-${r} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===u?Fi(this._buildTileCtx(e,s,m),v):"light-control"===u?Hi(this._buildTileCtx(e,s,m)):"climate-control"===u?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return Ge(t,s,"ts-climate","No climate entity");const r="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(o.states[n.entity_id]?.state??"")||null;return q`
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"cover-control"===u?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const a=o.position??("open"===o.state?100:0),r="opening"===o.state||"closing"===o.state,n=Math.ceil(a/100*et.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
    ...
    </div>`}(this._buildTileCtx(e,s,m)):"sensor-card"===u?function(e){const{device:t,accent:i,online:s,hass:o,config:a}=e;let r;for(const e of $i)if(r=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=o.states[t.entity_id];return i&&i.attributes?.device_class===e}),r)break;const n=r?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return t&&Li.includes(t.attributes?.device_class??"")});if(!r&&!n)return Ge(t,s,"ts-sensor","No sensor");if(r){const n=o.states[r.entity_id],l=parseFloat(n?.state??""),c=n?.attributes?.unit_of_measurement??"",d=n?.attributes?.device_class??"",p=a.graph_hours??24;e.requestGraphData(r.entity_id);const h=e.getGraphPoints(r.entity_id,p);let u=0;if(h.length>=2){const e=Math.floor(h.length/2),t=h.slice(e).reduce((e,t)=>e+t.v,0)/(h.length-e),i=h.slice(0,e).reduce((e,t)=>e+t.v,0)/e;u=t-i}const g=t.entities.filter(e=>{if(e.entity_id===r.entity_id||"sensor"!==e.domain)return!1;const t=o.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${e.showEl("trend")&&h.length>=2?q`
          <div class="ts-sensor-trend ${u>0?"up":u<0?"down":""}">
            ${u>0?"↑":u<0?"↓":"→"} ${Math.abs(u)<.05?"stable":Math.abs(u).toFixed(1)+" "+c+"/hr"}
          </div>`:Z}
        ...
        ${e.showEl("secondary")&&g.length?q`<div class="ts-chips" style="margin-top:6px">
          ${g.map(e=>{const t=o.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return q`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:Z}
      </div>`}const l=o.states[n.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",h=c?"#f87171":"var(--sc-online-color)",u=l?.last_changed?e.timeAgo(l.last_changed):"";return q`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${qe(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      ...
      ${u?q`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${u}</div>`:Z}
    </div>`}(this._buildTileCtx(e,s,m)):"input-control"===u?at(this._buildTileCtx(e,s,m)):"scene-button"===u?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),r=o.device_styles?.[t.device_id],n=tt(r?.tile_icon??"pulse",!0,`--ent-spd:${r?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return a.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
    ...
    </div>`}(this._buildTileCtx(e,s,m)):Z}
    </div>`}_tileTapIsControl(e){const t=e.target;return!!t?.closest?.(Zi._TILE_CONTROL_SEL)}_onTilePointerDown(e,t){this._tileTapIsControl(t)||(this._lpStart={x:t.clientX,y:t.clientY})}_onTilePointerUp(e,t){if(this._tileTapIsControl(t))return;const i=this._lpStart;this._lpStart=null,i&&(this._detailDevice=e.device_id,this._detailHistoryRange=24)}_onTilePointerCancel(){this._lpStart=null}_onTilePointerMove(e){if(!this._lpStart)return;const t=e.clientX-this._lpStart.x,i=e.clientY-this._lpStart.y;t*t+i*i>100&&(this._lpStart=null)}_renderFavoritesSection(e){const t=this._config.favorites;if(!t?.length)return q``;const i=new Map(t.map((e,t)=>[e,t])),s=e.filter(e=>i.has(e.device_id)).sort((e,t)=>(i.get(e.device_id)??0)-(i.get(t.device_id)??0));if(!s.length)return q``;const o=s.reduce((e,t)=>e+(this._getPower(t)??0),0),a=s.filter(e=>this._isOnline(e)).length,r=Ti(this._config,this._getActiveView()??void 0),n=this._config.area_styles?.Favourites?.tile_style;return q`
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${o>0?q`<span class="fav-chip fav-chip-power">${Ft(o)}</span>`:Z}
          </div>
        </div>
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,o=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(ni),a=e=>o.has(e),r={},n=(e,t)=>{r[e]||(r[e]={sum:0,count:0}),r[e].sum+=t,r[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",o=ri.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&a(o.key)&&n(o.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ri){if("energy"===t.key&&a("energy")&&"total"!==l){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){r.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",r.energy.sum)});continue}if(s||r.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?Nt(i):"…"})}continue}const i=r[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return Ft(t);case"energy":return Nt(t);case"voltage":return jt(t);case"current":return Ht(t);case"temperature":return Ut(t);case"humidity":return Xt(t);case"co2":return Yt(t);case"illuminance":return Qt(t);case"battery":return Kt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),o=this._config.area_styles?.[t]?.header_chips,a=void 0!==s?new Set(s):void 0!==o?new Set(o):new Set(ni),r=[];for(const e of ri)i.has(e.key)&&r.push({key:e.key,label:e.label,visible:a.has(e.key)});return r}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",o=ri.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&t.add(o.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,o=(t,s)=>{const o=new Set(i.filter(e=>e.visible).map(e=>e.key));s?o.add(t):o.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>o.has(e)))};return q`
    ...
    `;return m}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=function(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const i of e){const e=[],a=[];if(Mi(i,t)){const o=Oi(i,t);o.length&&(e.push("alert"),a.push(...o));const r=Di(i,t);null!==r&&r<=s&&(e.push("battery"),a.push(`battery ${Math.round(r)}%`));const n=Ri(i,t);n&&(e.push("update"),a.push(n.next?`update → ${n.next}`:"update available"))}else e.push("offline"),a.push("offline");e.length&&o.push({device:i,kinds:e,detail:a})}const a={offline:0,alert:1,battery:2,update:3},r=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>r(e)-r(t)||e.device.name.localeCompare(t.device.name))}(e,this.hass.states,{batteryBelow:this._config.attention_battery}),i=!1===this._config.show_firmware_summary?[]:Bi(e),s=i.length>1;if(!t.length&&!s)return q``;const o={offline:"○",alert:"▲",battery:"▮",update:"↑"},a=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t));return q`
      <div class="attention">
        <div class="att-hdr" @click=${()=>{this._attentionOpen=!this._attentionOpen}}>
          ...
          ${t.length?q`<span class="att-count">${t.length}</span>`:Z}
          ${s?q`<span class="att-fw-chip">${i.length} firmware versions</span>`:Z}
        </div>
          ...
          <div class="att-body">
            ${t.map(e=>q`
              <button class="att-row att-${a(e)}" @click=${()=>{this._detailDevice=e.device.device_id}}>
                ...
                ${e.device.area?q`<span class="att-area">${e.device.area}</span>`:Z}
              </button>`)}
            ${s?q`
              <div class="att-fw">
    ...
    `],e([ve({attribute:!1})],Ki.prototype,"hass",void 0),e([ve({type:Boolean})],Ki.prototype,"preview",void 0),e([fe()],Ki.prototype,"_config",void 0),e([fe()],Ki.prototype,"_closedAreas",void 0),e([fe()],Ki.prototype,"_entityListOpen",void 0),e([fe()],Ki.prototype,"_graphData",void 0),e([fe()],Ki.prototype,"_periodEnergy",void 0),e([fe()],Ki.prototype,"_periodEnergyErrAt",void 0),e([fe()],Ki.prototype,"_valveDragPos",void 0),e([fe()],Ki.prototype,"_trvDragTemp",void 0),e([fe()],Ki.prototype,"_cloudDetailOpen",void 0),e([fe()],Ki.prototype,"_detailDevice",void 0),e([fe()],Ki.prototype,"_detailHistoryRange",void 0),e([fe()],Ki.prototype,"_activeViewId",void 0),e([fe()],Ki.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Ki.prototype,"_tileBlockOverride",void 0),e([fe()],Ki.prototype,"_tileChipOverride",void 0),e([fe()],Ki.prototype,"_areaHeaderOverride",void 0),e([fe()],Ki.prototype,"_attentionOpen",void 0),e([fe()],Ki.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Ki.prototype,"_areaCustomizeOpen",void 0),Ki=Zi=e([he("ha-device-dashboard")],Ki);const Ji=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Ji(e,t);return!0},es=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},ts=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),os(t)}};function is(e){void 0!==this._$AN?(es(this),this._$AM=e,ts(this)):this._$AM=e}function ss(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Ji(s[e],!1),es(s[e]);else null!=s&&(Ji(s,!1),es(s));else Ji(this,e)}const os=e=>{e.type==be&&(e._$AP??=ss,e._$AQ??=is)};class as extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),ts(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ji(this,e),es(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const rs=new WeakMap,ns=ye(class extends as{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=rs.get(t);void 0===i&&(i=new WeakMap,rs.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?rs.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),ls=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ee(e),this.key=t),i}}),cs=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],ds=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","Two things sit above all of it: your own Customize tweaks on a tile (stored in this browser, see Local tweaks) and, for blocks, whatever a saved custom style defines.","The editor flags the common cases for you — see Conflicts."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:["**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…). **Sensor chips** choose which measurements appear as little pills, in any style.","The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","The Device styling panel goes further and narrows to the device in front of you — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['A Shelly i3, i4 or UNI is a wall switch: it reports presses and controls nothing by itself. Nothing in Home Assistant can make it emit a press, so the card cannot "push" a channel for you.',"What it can do is run the same thing the physical button runs. Give a channel an action and its row becomes a key: tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.","A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to.","Channels you have not wired stay as read-only status rows showing the last event and when it fired, so a half-configured switch shows both."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is."]},{id:"local",title:"Local tweaks live in your browser",body:["The little Customize panel on a tile — which blocks, which chips, graphs on or off — is deliberately *not* saved to your dashboard. It is stored in the browser you did it in, so you can adjust a tile on your phone without changing what everyone else sees.","The catch: those tweaks sit above the config in every cascade. If a YAML edit seems to be ignored on one device only, that is usually why.","Each tile has a reset in its own Customize panel, and **◆ Defaults → Clear local tweaks** wipes all of them for this browser at once."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running."]},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],ps=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Card & Theme → scroll to the room picker at the bottom.","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["This mirrors the physical button rather than driving it — both paths keep working independently."],steps:["Device styling → pick the switch → Input actions.",'For a channel, choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["◆ Defaults → Colour theme.","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Card & Theme → Tiles → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],hs=e=>Math.random()<e;const us=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},gs=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},vs=(e,t)=>{const[i,s]=[gs(e),gs(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function fs(e,t,i,s,o,a){let r=i;for(let i=0;i<40;i++){const i=us(e,t,r);if(vs(i,s)>=o)return i;if(r+=a?2:-2,r>98||r<2)break}return us(e,t,a?98:2)}var ms;const bs=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let ys=!1;const xs=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],ws=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],ks=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],_s=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let As=ms=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._localTweaksCleared=null,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;t?.tab&&t.section&&t.flash&&this._gotoControl(t.tab,t.section,t.flash)},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=si(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=cs.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1,this._openSections={...this._openSections,[t]:!0},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(si(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </div>`}_renderHelpPanel(){const e=this._helpFilter.trim().toLowerCase(),t=t=>!e||t.title.toLowerCase().includes(e)||t.body.some(t=>t.toLowerCase().includes(e))||(t.steps??[]).some(t=>t.toLowerCase().includes(e)),i=ds.filter(t),s=ps.filter(t);return q`
      ...
      </span>`}_chipPicker(e,t,i,s,o){const a=t??[],r=void 0!==e,n=t=>!o||o.has(t)||(e??[]).includes(t),l=xs.map(e=>({...e,items:e.items.filter(e=>n(e.key))})).filter(e=>e.items.length),c=xs.flatMap(e=>e.items.map(e=>e.key)).filter(n),d=new Set(r?e:a.length?a:c);return q`
      ...
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?$t(this.hass):{integrations:[],domains:[]},o=q`
      <div class="field">
      ...
      ${t?q`
        ...
        ${this._renderCheckDropdown("disc-int","Hide integrations",s.integrations.map(e=>({value:e,label:Pt(e)})),e.exclude_integrations??[],e=>this._set("exclude_integrations",e),"Tick the integrations to drop. The built-in list (phones, browsers, routers…) is always hidden on top of these.")}
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const o=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${ns(e=>e?.focus())}/>`:q`<span class="pill ${e===o?"on":""}" @click=${()=>s(o)}>
                ${i.label||t}
      ...
      ${r?q`
        ...
        </div>`:Z}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,o=s?e.find(e=>e.device_id===s):null,a=o?Dt(o):null,r=this._styleScope,n=a?e.filter(e=>Dt(e).type===a.type).length:0,l=a?mt[a.type]||a.type:"",c=e=>q`
      ...
      <div class="dev-styling-tab">
        ...
        ${o&&a?q`
          ...
          ${"device"===r?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&o?yt(a.type,o):void 0)??"default";return q`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[a.type]??{},t=e.tile_style??(this._config.smart_tile_styles?bt[a.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return q`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",bt[a.type],e=>this._setProfileStyle(a.type,{tile_style:e}),e=>this._setProfileStyle(a.type,{power_monitor_variant:e}))}
          </div>
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>ws.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>n(e,t,i))}
              ${e.length<ms.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Z}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=xt[e];if(!s)return q``;return q`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._allDevices().find(t=>t.device_id===e),s=i?yi(i,this.hass?.states??{}):null,o=!!s&&!this._devPanelAll,a=ws.map(e=>e.id),r=this._config.tile_layout??a,n=kt(r),l=kt(t.tile_layout)??null,c=t.entity_animations??{},d=i=>{const s=(l??n).includes(i),o=function(e,t,i,s){const o=wt(e).map(e=>[...e]);if(!i)return o.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(o.some(e=>e.includes(t)))return o;const a=e=>{const t=s.indexOf(e);return t<0?s.length:t},r=o.findIndex(e=>a(e[0])>a(t));return o.splice(r<0?o.length:r,0,[t]),o}(t.tile_layout??r,i,!s,a),c=JSON.stringify(o)===JSON.stringify(wt(r));this._setDeviceStyle(e,{tile_layout:c?void 0:o})},p=(t,i,s)=>{const o={...c[t]??{}};if("speed"===i){const e=Number(s);1===e?delete o.speed:o.speed=e}else"none"===s?delete o[i]:o[i]=s;const a={...c,[t]:o};o.on||o.off||o.speed||delete a[t],this._setDeviceStyle(e,{entity_animations:Object.keys(a).length?a:void 0})},h=this._allDevices().find(t=>t.device_id===e),u=h?Dt(h):null,g=u?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control",generic:"scene-button"}[u.type]:void 0,v=t.tile_style,f=t.power_monitor_variant??"big-number",m=q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${g&&!v?q`<span class="dev-style-hint">Recommended: ${g}</span>`:Z}
          ${v?q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:Z}
        </div>
        ${this._renderTileStylePicker(v,f,g,t=>this._setDeviceStyle(e,{tile_style:t}),t=>this._setDeviceStyle(e,{power_monitor_variant:t}))}
      ...
      <div class="dev-style-panel">
        ...
        <div class="field" style="margin-bottom:6px">
          ...
          <select class="inline-text" style="width:100%"
            ...
            <option value="" ?selected=${!t.profile}>Auto${u?` — detected: ${mt[u.type]||u.type||"generic"}`:""}</option>
            ${["relay","plug","dimmer","rgb","climate","cover","valve","energy","sensor","input","uni","wall_display","generic"].map(e=>q`
              <option value=${e} ?selected=${t.profile===e}>${mt[e]||e}</option>`)}
          </select>
        </div>
        ${m}
        <div class="color-row">
        ...
        ${(()=>{const i=h?Dt(h):null,a=t.tile_style??(this._config.smart_tile_styles&&i&&h?yt(i.type,h):void 0)??this._config.tile_style,c=this._baseStyleOf(a);return c&&"default"!==c?Z:q`
            ...
            ${this._adv(q`
                ...
                <div class="block-toggles">
                  ${ws.filter(e=>"graph"!==e.id).filter(e=>!o||s.blocks.has(e.id)||(l??n).includes(e.id)).map(e=>{const t=null===l?n.includes(e.id):l.includes(e.id);return q`<span class="block-tog ${t?"on":""}" @click=${()=>d(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
      ...
      </div>`}_renderRoomHeaderChips(e,t){const i=this._allDevices().filter(t=>(t.area??"")===e),s=new Set;for(const e of i)for(const t of e.entities){if("sensor"!==t.domain)continue;const e=t.attributes?.device_class??"",i=ri.find(i=>i.dc===e||"rssi"===i.key&&("signal_strength"===e||t.entity_id.includes("_rssi")));i&&s.add(i.key)}const o=ri.filter(e=>s.has(e.key));if(!o.length)return q`<div class="hint" style="margin:2px 2px 6px">No summary sensors in this room.</div>`;const a=t.header_chips??ni;return q`
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${o.map(t=>{const i=a.includes(t.key);return q`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?a.filter(e=>e!==t.key):[...a,t.key];var o;this._setAreaStyle(e,"header_chips",(o=s).length===ni.length&&ni.every(e=>o.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
      ...
      <div class="rsp-panel">
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",o=t.buttonSize??"md",a="square"===i||"circle"===i,r="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",n=a?"sm"===o?"3px 5px":"lg"===o?"6px 12px":"4px 8px":"sm"===o?"2px 8px":"lg"===o?"6px 16px":"4px 12px",l="sm"===o?"10px":"lg"===o?"13px":"11px",c=a?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,h=`border-radius:${r};padding:${n};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,u=t.buttonShape||t.buttonVariant||t.buttonSize;return q`
            <div class="btn-preview">
              ...
              ${u?q`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:Z}
            </div>
            <div class="field">
    ...
    `}_renderViewCard(e,t,i,s,o,a,r,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,r,n),u=r.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return q`
        ...
        ${l?q`
          <div class="view-card-body">
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?q`<button class="color-reset" @click=${()=>g("columns",void 0)}>↺</button>`:Z}
            </div>
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${oi.map(t=>{const i=e.header_chips??ai,s=i.includes(t.key);return q`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],o=e.length===ai.length&&ai.every(t=>e.includes(t));this._set("header_chips",o?void 0:e)}}>${t.label}</span>`})}
          </div>
      ...
      </div>`,p=e.card_opacity??100,h=e.tile_opacity??100,u=q`
      ${this._gridBody()}
    ...
    `,g=q`
      ...
      <div class="field">
        ...
        `:Z}
      </div>`;return{header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Z,body:a},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Z,body:u},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Z,body:g},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Z,body:l},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Z,body:d}}}_renderStyleTab(){const e=this._config,t=e.style??{},i=t.accent_color??"#f4601e",s=t.card_bg??"#1c1c1e",o=t.tile_bg??"#1c1c1e",a=t.tile_border??"#2a2a30",r=t.tile_hover_bg??"rgba(255,255,255,0.07)",n=t.tile_sensor_bg??"rgba(255,255,255,0.04)",l=t.text_primary??"#e5e7eb",c=t.text_secondary??"#9ca3af",d=t.text_muted??"#6b7280",p=t.online_color??"#4ade80",h=t.offline_color??"#ef4444",u=t.header_bg??"#1a1a2e",g=t.header_bg2??"#0f3460",v=t.header_text_color??"#ffffff",f=t.header_orb_color??"#3b82f6",m=t.header_title_size??1.1,b=t.header_padding??16,y=t.header_border_width??0,x=t.header_border_color??"#4ade80",w=t.header_stat_online??"#4ade80",k=t.header_stat_power??"#fb923c",_=t.font_family?`'${t.font_family}', sans-serif`:"inherit",A=t.text_size_scale??1,C=t.tile_radius??12,S=t.tile_border_width??1,z=t.header_radius??0,I=y>0?`${y}px solid ${x}`:"none",T=q`
      <div class="style-preview" style="font-family:${_};background:${s}">
        <div class="sp-header"
          style="background:linear-gradient(135deg,${u},${g});color:${v};border-radius:${z}px;padding:${Math.round(.55*b)}px 12px;border-bottom:${I};position:relative;overflow:hidden">
      ...
      </div>`)}`,a=e.graph_sensors??St,r=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const o=s[e]??i,a=!!s[e];return q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${o}"></div>
      ...
      ${a.filter(e=>!r.find(t=>t.key===e)).length?q`
        ...
        ${a.filter(e=>!r.find(t=>t.key===e)).map(e=>{const t=Jt.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??Jt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",Jt.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${Jt.map(e=>{const t=a.some(t=>ii(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>ii(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=ii(i.key),a=!!Jt.find(e=>e.key===o),r=e.graph_sensors??St,n=r.some(e=>ii(e)===o);return q`
      ...
      <pre class="yaml-out">${i}</pre>`}_configConflicts(){const e=this._config,t=[];if(!e)return t;const i=e.style??{};if(e.theme&&"custom"!==e.theme&&Object.keys(i).length){const s=je(i);s!==e.theme&&t.push({title:`Theme is set to "${Fe[e.theme]??e.theme}" but the colours do not match it`,detail:`style: overrides the theme on every palette key it sets, so the card renders ${"custom"===s?"your custom colours":`"${Fe[s]??s}"`} instead. Re-pick a theme here to bring the two back in step.`})}if(e.smart_tile_styles&&e.tile_style&&t.push({title:"Smart tile styles never apply",detail:`A global tile style (${e.tile_style}) outranks the per-profile defaults that smart tile styles turns on. Clear the global style, or set styles per device type instead.`}),"universal"!==(e.mode??"shelly")){const i=["universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains"].filter(t=>null!=e[t]);i.length&&t.push({title:"Discovery filters are set but do nothing in Shelly mode",detail:`${i.join(", ")} only apply when mode is universal. Shelly mode already keeps just Shelly and BTHome devices.`})}if("universal"===(e.mode??"shelly")&&this.hass&&(e.exclude_integrations?.length||e.exclude_domains?.length)){const i=$t(this.hass),s=(e,t)=>e.length>0&&e.every(e=>(t??[]).includes(e));s(i.integrations,e.exclude_integrations)&&!(e.include_integrations??[]).length&&t.push({title:"Every discovered integration is hidden",detail:"Nothing is left to discover, so the card renders empty. Clear some in Discovery, or force one back with include_integrations."}),s(i.domains,e.exclude_domains)&&t.push({title:"Every entity type is hidden",detail:"No entity domain is left, so no device has anything to show. Clear some in Discovery."})}const s=(e,t)=>(e??[]).filter(e=>(t??[]).includes(e)),o=s(e.include_domains,e.exclude_domains);o.length&&t.push({title:`Domain both included and excluded: ${o.join(", ")}`,detail:"Excluded wins for domains — those entities are dropped."});const a=s(e.include_integrations,e.exclude_integrations);if(a.length&&t.push({title:`Integration both included and excluded: ${a.join(", ")}`,detail:"Included wins for integrations — the opposite of how domains resolve, so this is worth a second look."}),!e.delegate_controls){const i=[e.tile_layout,...Object.values(e.device_styles??{}).map(e=>e.tile_layout),...Object.values(e.profile_styles??{}).map(e=>e.tile_layout),...Object.values(e.custom_styles??{}).map(e=>e.tile_layout)];i.some(e=>(kt(e)??[]).includes("delegated_controls"))&&t.push({title:"The Native controls block is in a layout but the feature is off",detail:"delegate_controls is off, so that block renders nothing. Turn it on under Rooms & devices, or drop the block."})}const r=new Set(Object.keys(e.custom_styles??{})),n=[e.tile_style,...Object.values(e.device_styles??{}).map(e=>e.tile_style),...Object.values(e.profile_styles??{}).map(e=>e.tile_style),...Object.values(e.area_styles??{}).map(e=>e.tile_style)],l=[...new Set(n.filter(e=>"string"==typeof e&&e.startsWith("custom:")&&!r.has(e.slice(7))))];l.length&&t.push({title:`Saved style not found: ${l.join(", ")}`,detail:"Whatever points at it falls back to the default tile style."});const c=this._allDevices(),d=new Set(c.map(e=>e.device_id)),p=Object.keys(e.device_styles??{}).filter(e=>!d.has(e));p.length&&t.push({title:`${p.length} device styling block${p.length>1?"s":""} for a device that is not here`,detail:"The device was removed, re-added with a new id, or is filtered out by discovery. Harmless, but it will never apply."});const h=new Set(c.map(e=>e.area??"").filter(Boolean)),u=Object.keys(e.area_styles??{}).filter(e=>"Favourites"!==e&&!h.has(e));u.length&&t.push({title:`Room styling for rooms with no devices: ${u.join(", ")}`,detail:"Usually a renamed area — room styles are keyed by name, so a rename orphans them."});const g=Object.keys(e).filter(e=>!di.includes(e)&&!pi.includes(e)&&!e.startsWith("_"));g.length&&t.push({title:`The card does not read: ${g.join(", ")}`,detail:"Unknown keys are ignored in silence — usually a typo, an option from another card, or one this card has dropped."});const v=[];for(const[t,i]of Object.entries(e.device_styles??{})){const e=Object.keys(i.input_actions??{});if(!e.length||!this.hass)continue;const s=c.find(e=>e.device_id===t);if(!s)continue;const o=fi(s,this.hass.states);for(const t of e){(/^\d+$/.test(t)?o.some(e=>String(e.channel)===t):o.some(e=>e.entityId===t))||v.push(`${s.name} → ${t}`)}}v.length&&t.push({title:`Input action for a channel that is not there: ${v.join("; ")}`,detail:"That channel entity was renamed or removed, so the key never renders. Re-add the action against the current channel."});const f=new Set;for(const t of Object.values(e.device_styles??{}))for(const e of Object.values(t.input_actions??{})){const t=[e.entity,e.hold_action?.entity,e.double_tap_action?.entity,e.select_chip?.entity].flatMap(e=>Array.isArray(e)?e:e?[e]:[]);for(const e of t)this.hass&&!this.hass.states[e]&&f.add(e)}return f.size&&t.push({title:`Input action target does not exist: ${[...f].join(", ")}`,detail:"The key still renders, but pressing it does nothing."}),t}_renderConflicts(){const e=this._configConflicts();return e.length?q`
      ...
      </div>`:Z}_applyTheme(e){const t={...this._config.style??{}};for(const e of Ne)delete t[e];this._set("style",Object.keys(t).length?t:void 0),this._set("theme",e)}_onPickTheme(e){const t=this._config.style??{};Ne.some(e=>void 0!==t[e])&&this._stashColours("Before theme change"),this._applyTheme(e),this._rolled=`${Fe[e]??e} — previous colours are under ★ Before theme change`,this._clearRolledSoon()}_applyPalette(e){const t=this._palettes[e];t&&(this._set("style",{...this._config.style??{},...t}),this._set("theme","custom"))}_clearLocalTweaks(){try{const e=[];for(let t=0;t<localStorage.length;t++){const i=localStorage.key(t);i&&i.startsWith("shelly-dashboard:")&&e.push(i)}for(const t of e)localStorage.removeItem(t);this._localTweaksCleared=e.length}catch{}}_resetLook(){const e=this._config,t={};for(const i of ms._CONTENT_KEYS)void 0!==e[i]&&(t[i]=e[i]);this._emitNow({type:"custom:ha-device-dashboard",...ci(),...t})}_onResetEverything(){this._resetArmed?(this._resetArmed=!1,this._emitNow({type:"custom:ha-device-dashboard",...ci()})):this._resetArmed=!0}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=je(t);return q`
      <div class="defaults-panel">
        <div class="dp-grid">
          ...
          <div class="dp-group">
            ...
            ${this._rolled?q`<div class="cr-rolled">${this._rolled} — previous colours are under ★ Saved</div>`:Z}
            <div class="theme-grid">
              ${Object.entries(this._palettes).map(([e,i])=>q`
                <div class="saved-wrap">
                  <button class="theme-swatch saved ${(e=>Object.entries(e).every(([e,i])=>t[e]===i))(i)?"on":""}"
                    title="Restore “${e}”" @click=${()=>this._applyPalette(e)}>
                  ...
                  <button class="saved-x" title="Forget “${e}”"
                    @click=${t=>{t.stopPropagation(),this._deletePalette(e)}}>✕</button>
                </div>`)}
            ...
            ${"custom"===s?q`<div class="hint">Custom — your colours don't match a preset. 💾 Save keeps them; picking a preset stashes them under ★ first.</div>`:Z}
          </div>
      ...
      </div>`}render(){if(!this._config)return q``;const e=cs.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(cs.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};cs.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],a=e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t},r=o.length>1,n=e.findIndex(e=>e.id===this._tab);return q`
      <div class="shell">
      ...
      </div>`}};As.ROLL_SLOT="Before roll",As.ROW_MAX=3,As.DRAG_SLOP=6,As._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls"],As.styles=[st,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],As.prototype,"hass",void 0),e([fe()],As.prototype,"_config",void 0),e([fe()],As.prototype,"_tab",void 0),e([fe()],As.prototype,"_styleScope",void 0),e([fe()],As.prototype,"_cardThemeRoom",void 0),e([fe()],As.prototype,"_newStyleName",void 0),e([fe()],As.prototype,"_renamingStyle",void 0),e([fe()],As.prototype,"_advanced",void 0),e([fe()],As.prototype,"_defaultsOpen",void 0),e([fe()],As.prototype,"_resetArmed",void 0),e([fe()],As.prototype,"_xcPlacement",void 0),e([fe()],As.prototype,"_xcRoom",void 0),e([fe()],As.prototype,"_xcAdding",void 0),e([fe()],As.prototype,"_xcEditIndex",void 0),e([fe()],As.prototype,"_xcDraft",void 0),e([fe()],As.prototype,"_xcDashboards",void 0),e([fe()],As.prototype,"_xcImportCards",void 0),e([fe()],As.prototype,"_xcImportLoading",void 0),e([fe()],As.prototype,"_palettes",void 0),e([fe()],As.prototype,"_paletteNaming",void 0),e([fe()],As.prototype,"_paletteName",void 0),e([fe()],As.prototype,"_expandedViewId",void 0),e([fe()],As.prototype,"_openSections",void 0),e([fe()],As.prototype,"_expandedRooms",void 0),e([fe()],As.prototype,"_expandedRoomStyle",void 0),e([fe()],As.prototype,"_selectedDeviceId",void 0),e([fe()],As.prototype,"_devPanelAll",void 0),e([fe()],As.prototype,"_conflictsOpen",void 0),e([fe()],As.prototype,"_localTweaksCleared",void 0),e([fe()],As.prototype,"_flashControl",void 0),e([fe()],As.prototype,"_snapshots",void 0),e([fe()],As.prototype,"_snapMenu",void 0),e([fe()],As.prototype,"_snapName",void 0),e([fe()],As.prototype,"_snapMsg",void 0),e([fe()],As.prototype,"_helpOpen",void 0),e([fe()],As.prototype,"_helpFilter",void 0),e([fe()],As.prototype,"_helpTopic",void 0),e([fe()],As.prototype,"_rolled",void 0),e([fe()],As.prototype,"_deviceSearch",void 0),e([fe()],As.prototype,"_styleClipFeedback",void 0),e([fe()],As.prototype,"_openDiscDropdown",void 0),e([fe()],As.prototype,"_iconPickerState",void 0),As=ms=e([he("ha-device-dashboard-editor")],As);let Cs=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Cs.styles=n`
    :host {
      display: block;
  ...
  `,e([ve({attribute:!1})],Cs.prototype,"hass",void 0),e([ve()],Cs.prototype,"entity",void 0),e([ve({attribute:!1})],Cs.prototype,"features",void 0),e([fe()],Cs.prototype,"_el",void 0),Cs=e([he("hdd-delegated")],Cs);let Ss=class extends de{constructor(){super(...arguments),this._builtKey=""}willUpdate(e){const t=this.config?JSON.stringify(this.config):"";t&&t!==this._builtKey&&this._build(t)}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(e){this._builtKey=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||JSON.stringify(this.config)!==e)return;const s=i.createCardElement(this.config);this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Z}};Ss.styles=n`
    :host { display: block; }
    :host > * { width: 100%; }
  `,e([ve({attribute:!1})],Ss.prototype,"hass",void 0),e([ve({attribute:!1})],Ss.prototype,"config",void 0),e([fe()],Ss.prototype,"_el",void 0),Ss=e([he("hdd-card")],Ss);console.info("%c ha-device-dashboard %c attention-2026-08-23c ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
