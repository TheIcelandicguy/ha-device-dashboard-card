...
`;function Me(e,t,i="ts-hero-name"){return Q`
    <div class="${i} tile-trigger">
      <span class="dot ${t?"online":"offline"}"></span>${e.name}
    </div>`}function Oe(e,t,i,s){return Q`
    <div class="${i}">
      ${Me(e,t)}
      <span style="color:var(--sc-text-muted);font-size:.8em">${s}</span>
    </div>`}const Be={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};const Te=[3,7,11,15,19,23,27];function Ee(e,t,i,s){if("none"===e)return Q``;const a=t?"on":"off";return"flame"===e?Q`${X`<svg class="${s} ent-icon-flame ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake"===e?Q`${X`<svg class="${s} ent-icon-snowflake" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan"===e?Q`${X`<svg class="${s} ent-icon-fan ${a}" style="${i}" viewBox="0 0 20 20">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"pulse"===e?Q`${X`<svg class="${s} ent-icon-pulse ${a}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"wave"===e?Q`${X`<svg class="${s} ent-icon-wave" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun"===e?Q`${X`<svg class="${s} ent-icon-sun ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning"===e?Q`${X`<svg class="${s} ent-icon-lightning ${a}" style="${i}" viewBox="0 0 20 20">
    <path d="M11.5 2 L5 11 L9.5 11 L8.5 18 L15 9 L10.5 9 Z" fill="currentColor"/>
  </svg>`}`:"heart"===e?Q`${X`<svg class="${s} ent-icon-heart ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb"===e?Q`${X`<svg class="${s} ent-icon-bulb ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf"===e?Q`${X`<svg class="${s} ent-icon-leaf ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame2"===e?Q`${X`<svg class="${s} ent-icon-flame2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"flame3"===e?Q`${X`<svg class="${s} ent-icon-flame3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"snowflake2"===e?Q`${X`<svg class="${s} ent-icon-snowflake2" style="${i}" viewBox="0 0 20 20">
    <g class="snow-arms" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"snowflake3"===e?Q`${X`<svg class="${s} ent-icon-snowflake3" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"fan2"===e?Q`${X`<svg class="${s} ent-icon-fan2 ${a}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
    ...
    <circle cx="10" cy="10" r="1.5" fill="currentColor"/>
  </svg>`}`:"fan3"===e?Q`${X`<svg class="${s} ent-icon-fan3 ${a}" style="${i}" viewBox="0 0 20 20">
    <g class="fan-blades" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"lightning2"===e?Q`${X`<svg class="${s} ent-icon-lightning2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"lightning3"===e?Q`${X`<svg class="${s} ent-icon-lightning3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb2"===e?Q`${X`<svg class="${s} ent-icon-bulb2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bulb3"===e?Q`${X`<svg class="${s} ent-icon-bulb3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water2"===e?Q`${X`<svg class="${s} ent-icon-water2" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"water3"===e?Q`${X`<svg class="${s} ent-icon-water3 ${a}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"sun2"===e?Q`${X`<svg class="${s} ent-icon-sun2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"sun3"===e?Q`${X`<svg class="${s} ent-icon-sun3 ${a}" style="${i}" viewBox="0 0 20 20">
    <g class="sun-group" style="transform-origin:10px 10px">
  ...
  </svg>`}`:"moon2"===e?Q`${X`<svg class="${s} ent-icon-moon2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"moon3"===e?Q`${X`<svg class="${s} ent-icon-moon3 ${a}" style="${i}" viewBox="0 0 20 20">
    <path d="M14 4 C10.7 4 8 6.7 8 10 C8 13.3 10.7 16 14 16 C11.4 16 9.4 13.3 9.4 10 C9.4 6.7 11.4 4 14 4Z" fill="currentColor"/>
  ...
  </svg>`}`:"wind"===e?Q`${X`<svg class="${s} ent-icon-wind ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind2"===e?Q`${X`<svg class="${s} ent-icon-wind2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wind3"===e?Q`${X`<svg class="${s} ent-icon-wind3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell"===e?Q`${X`<svg class="${s} ent-icon-bell ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell2"===e?Q`${X`<svg class="${s} ent-icon-bell2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"bell3"===e?Q`${X`<svg class="${s} ent-icon-bell3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer"===e?Q`${X`<svg class="${s} ent-icon-thermometer ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer2"===e?Q`${X`<svg class="${s} ent-icon-thermometer2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"thermometer3"===e?Q`${X`<svg class="${s} ent-icon-thermometer3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery"===e?Q`${X`<svg class="${s} ent-icon-battery ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"battery2"===e?Q`${X`<svg class="${s} ent-icon-battery2 ${a}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
  ...
  </svg>`}`:"battery3"===e?Q`${X`<svg class="${s} ent-icon-battery3 ${a}" style="${i}" viewBox="0 0 20 20">
    <rect x="2" y="6.5" width="14" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <rect x="16" y="9" width="2" height="2" rx="0.5" fill="currentColor"/>
    <rect x="3.5" y="8" width="2" height="4" rx="0.8" fill="currentColor"/>
  </svg>`}`:"star"===e?Q`${X`<svg class="${s} ent-icon-star ${a}" style="${i}" viewBox="0 0 20 20">
    <polygon points="10,2 12.2,7.6 18.1,7.6 13.5,11.4 15.3,17.1 10,13.6 4.7,17.1 6.5,11.4 1.9,7.6 7.8,7.6" fill="currentColor"/>
  </svg>`}`:"star2"===e?Q`${X`<svg class="${s} ent-icon-star2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"star3"===e?Q`${X`<svg class="${s} ent-icon-star3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"pulse2"===e?Q`${X`<svg class="${s} ent-icon-pulse2 ${a}" style="${i}" viewBox="0 0 20 20">
    <circle class="pulse-ring" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.3"/>
    <circle class="pulse-ring2" cx="10" cy="10" r="7" fill="none" stroke="currentColor" stroke-width="1" opacity="0.2"/>
    <circle cx="10" cy="10" r="2.5" fill="currentColor"/>
  </svg>`}`:"pulse3"===e?Q`${X`<svg class="${s} ent-icon-pulse3 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave2"===e?Q`${X`<svg class="${s} ent-icon-wave2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"wave3"===e?Q`${X`<svg class="${s} ent-icon-wave3 ${a}" style="${i}" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="2" fill="currentColor"/>
  ...
  </svg>`}`:"wave4"===e?Q`${X`<svg class="${s} ent-icon-wave4 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"heart2"===e?Q`${X`<svg class="${s} ent-icon-heart2 ${a}" style="${i}" viewBox="0 0 20 20">
  ...
  </svg>`}`:"leaf2"===e?Q`${X`<svg class="${s} ent-icon-leaf2 ${a}" style="${i}" viewBox="0 0 20 20">
...
`,Fe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Pe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Le=["motion","door","window","moisture","smoke","gas"];const Ue=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ne(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},a=new Map;for(const[n,r]of Object.entries(t)){if(!r?.device_id)continue;if(r.hidden_by)continue;const t=n.split(".")[0];if(!Ue.has(t))continue;const o=(r.platform??"").toLowerCase();if("shelly"!==o)continue;const l=r.device_id;if(!a.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),n=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===o,c=e.area_id??r.area_id,d=c?s[c]?.name:void 0;a.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:n,integration:o,entities:[]})}const c=a.get(l);c.isShelly||"shelly"!==o||(c.isShelly=!0,c.integration="shelly");const d=e.states[n];c.entities.push({entity_id:n,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:r.area_id,platform:o})}const n=new Set;for(const[e,t]of a){if(n.has(e))continue;const s=i[e],r=s?.via_device_id;if(!r||!a.has(r)||n.has(r))continue;const o=i[r],l=s?.configuration_url??"",c=o?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),u=!l&&c&&t.integration===a.get(r).integration;if(!p&&!u)continue;const g=a.get(r);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),n.add(e)}for(const e of n)a.delete(e);return Array.from(a.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}const je={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},He={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]};function We(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)&&!e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id)))s="input";else if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),a=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),n=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||a||n?"sensor":"input"}const a=e.isShelly?function(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}(e.model??""):"other";return{type:s,gen:a,label:je[s],integration:e.integration}}const qe={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};function Ze(e){return e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`}function Qe(e){return`${e.toFixed(3)} kWh`}function Xe(e){return`${e.toFixed(1)} V`}function Ve(e){return`${e.toFixed(3)} A`}function Ge(e){return`${e.toFixed(1)} °C`}function Ye(e){return e<60?`${e}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ke(e){return e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor"}function Je(e){return`${e.toFixed(1)} VA`}function _e(e){return`${e.toFixed(1)} VAr`}function $e(e){return`${e.toFixed(2)} Hz`}function et(e){return`${e.toFixed(1)} %`}function tt(e){return e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`}function it(e){return`${Math.round(e)} ppm`}function st(e){return`${Math.round(e)} %`}const at=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],nt=Object.fromEntries(at.map(e=>[e.key,e.label.split(" ")[0]])),rt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],ot=["online","offline","power","alerts"];function lt(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:r}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=n.graph_style?.sensor_ranges??{},d=n.graph_sensor_colors??{},p=[{label:"W",val:o.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:o.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:o.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:o.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),u=110,g=110,v=180,h=180,f=22,b=102,m=e=>e*Math.PI/180,x=(e,t)=>{const i=h+v*Math.min(1,Math.max(0,t)),s=u+e*Math.cos(m(h)),a=g+e*Math.sin(m(h)),n=u+e*Math.cos(m(i)),r=g+e*Math.sin(m(i)),o=v*t>180?1:0;return`M ${s.toFixed(2)} ${a.toFixed(2)} A ${e} ${e} 0 ${o} 1 ${n.toFixed(2)} ${r.toFixed(2)}`},y=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return Q`
    ...
    ${a>s?X`<circle cx="${h.toFixed(1)}" cy="${f.toFixed(1)}" r="3" fill="${v}"/>
      <line x1="${h.toFixed(1)}" x2="${h.toFixed(1)}" y1="${f.toFixed(1)}" y2="${p}" stroke="${v}" stroke-width="0.5" stroke-dasharray="2,2" opacity="0.4"/>`:G}`})():G;return Q`
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ${Me(t,a,"ts-spark-name")}
        ${l?Q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(l.entityId,i,t)}>${i?"ON":"OFF"}</button>`:G}
      </div>
      ...
      <div class="ts-spark-bottom">
        ...
        <div class="ts-spark-meta">
          ${null!=o.voltage?Q`<div class="ts-spark-mrow">${o.voltage.toFixed(1)} <b>V</b></div>`:G}
          ${null!=o.current?Q`<div class="ts-spark-mrow">${o.current.toFixed(2)} <b>A</b></div>`:G}
          ${null!=o.energy?Q`<div class="ts-spark-mrow">${o.energy.toFixed(2)} <b>kWh</b></div>`:G}
          ${null!=o.temp?Q`<div class="ts-spark-mrow">${o.temp.toFixed(1)} <b>°C</b></div>`:G}
          ${null!=o.rssi?Q`<div class="ts-spark-mrow">${o.rssi} <b>dBm</b></div>`:G}
        </div>
      </div>
      ${e.renderTileLowerBody(t,r,{skipPowerGraph:!0})}
    </div>`}(e);case"compact":return function(e){const{device:t,isOn:i,accent:s,online:a,profile:n}=e,r=e.tileSensors(t),o=e.getPrimarySwitch(t);return Q`
    <div class="ts-hbar" style="--ts-accent:${s}">
      <div class="ts-hbar-top">
        ...
        <div class="ts-hbar-side">
          ${null!=r.voltage?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">V</div><div class="ts-hbar-sv">${r.voltage.toFixed(0)}</div></div>`:G}
          ${null!=r.current?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">A</div><div class="ts-hbar-sv">${r.current.toFixed(2)}</div></div>`:G}
          ${null!=r.temp?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">°C</div><div class="ts-hbar-sv">${r.temp.toFixed(1)}</div></div>`:G}
          ${null!=r.rssi?Q`<div class="ts-hbar-sstat"><div class="ts-hbar-sk">dBm</div><div class="ts-hbar-sv">${r.rssi}</div></div>`:G}
        </div>
      </div>
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ${null!=r.energy?Q`<span class="ts-hbar-badge">${r.energy.toFixed(2)} kWh</span>`:G}
          ${null!=r.uptime?Q`<span class="ts-hbar-badge">${Ye(r.uptime)}</span>`:G}
        </div>
        ${o?Q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(o.entityId,i,t)}>${i?"ON":"OFF"}</button>`:G}
      </div>
      ${e.renderTileLowerBody(t,n)}
    </div>`}(e);case"table":return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:r}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t);e.ensureGraphData(t);const c=e.getPowerSparks(t),d=200,p=24,u=2,g=n.graph_style?.line_width??1.5,v=i?s:"var(--sc-text-muted)",h=c.length>1?(()=>{const e=c.map(e=>e.v),i=n.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),a=(i.max??Math.max(...e))-s||1,r=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-u-(e.v-s)/a*(p-2*u)).toFixed(1)}`).join(" "),o=`pm-tbl-${t.device_id.replace(/\W/g,"")}`;return X`<defs><linearGradient id="${o}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${v}" stop-opacity="0.2"/>
      <stop offset="100%" stop-color="${v}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${r} ${d},${p-u} 0,${p-u}" fill="url(#${o})"/>
    <polyline points="${r}" fill="none" stroke="${v}" stroke-width="${g}" stroke-linecap="round"/>`})():G,f=(e,t,i=!1)=>Q`
    ...
    </div>`}(e);default:return function(e){const{device:t,isOn:i,accent:s,online:a,config:n,profile:r}=e,o=e.tileSensors(t),l=e.getPrimarySwitch(t),c=e.getPowerSparks(t);e.ensureGraphData(t);const d=200,p=32,u=2,g=n.graph_style?.line_width??1.5,v=i?s:"var(--sc-text-muted)",h=c.length>1?(()=>{const e=c.map(e=>e.v),i=n.graph_style?.sensor_ranges?.power??{},s=i.min??Math.min(...e),a=(i.max??Math.max(...e))-s||1,r=c.map((e,t)=>`${(t/(c.length-1)*d).toFixed(1)},${(p-u-(e.v-s)/a*(p-2*u)).toFixed(1)}`).join(" "),o=`pm-bn-${t.device_id.replace(/\W/g,"")}`;return X`<defs><linearGradient id="${o}" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="${v}" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="${v}" stop-opacity="0"/>
    </linearGradient></defs>
    <polygon points="${r} ${d},${p-u} 0,${p-u}" fill="url(#${o})"/>
    <polyline points="${r}" fill="none" stroke="${v}" stroke-width="${g}" stroke-linecap="round"/>`})():G;return Q`
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        <div class="ts-chips">
          ${null!=o.voltage?Q`<span class="ts-chip">${o.voltage.toFixed(1)} V</span>`:G}
          ${null!=o.current?Q`<span class="ts-chip">${o.current.toFixed(2)} A</span>`:G}
          ${null!=o.energy?Q`<span class="ts-chip">${o.energy.toFixed(2)} kWh</span>`:G}
          ${null!=o.temp?Q`<span class="ts-chip">${o.temp.toFixed(1)} °C</span>`:G}
          ${null!=o.rssi?Q`<span class="ts-chip">${o.rssi} dBm</span>`:G}
        </div>
        <span class="ts-uptime">${o.uptime?Ye(o.uptime):""}</span>
      </div>
      ${e.renderTileLowerBody(t,r)}
    </div>`}(e)}}const ct=140,dt=70;function pt(e){const{device:t,isOn:i,accent:s,online:a,hass:n,profile:r}=e,o=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!o)return Q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(o.entityId.startsWith("switch.")||"dimmer"!==r.type&&"rgb"!==r.type)return Q`
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${Ze(l.power)}</div>`:G}
      </div>`;const c=i?Math.max(1,o.brightness??1):0,d=!!o.colorModes?.length,p=d&&(o.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),u=d&&o.rgbColor?e.rgbToHex(...o.rgbColor):"#ffffff",g=o.whiteValue??0,v=n.states[o.entityId],h=v?.attributes??{},f=h.effect_list??[],b=h.effect??"",m=(h.supported_color_modes??[]).some(e=>"color_temp"===e),x=h.min_mireds??153,y=h.max_mireds??500,w=h.color_temp??x,k=d&&o.rgbColor?(()=>{const[e,t,i]=o.rgbColor,s=Math.max(e,t,i),a=s-Math.min(e,t,i);let n=0;a>0&&(n=s===e?((t-i)/a+6)%6:s===t?(i-e)/a+2:(e-t)/a+4);const r=0===s?0:a/s,l=(e=>e*Math.PI/180)(60*n-90);return{x:dt+62*r*Math.cos(l),y:dt+62*r*Math.sin(l)}})():null,A=`wsat-${t.device_id.replace(/\W/g,"")}`;return Q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d?Q`
        <div class="ts-light-wheel-wrap">
          <svg width="${ct}" height="${ct}" viewBox="0 0 ${ct} ${ct}"
            ...
            <foreignObject x="0" y="0" width="${ct}" height="${ct}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${ct}px;height:${ct}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
      ...
      ${null!=l.power?Q`<div style="font-size:.72em;color:var(--sc-text-muted);margin-top:6px">${Ze(l.power)}</div>`:G}
    </div>`}function ut(e,t){const{device:i,profile:s,config:a,hass:n,online:r}=e,o=e.getPrimarySwitch(i),l=e.getTrv(i),c=e.getCover(i),d=e.getValve(i),p=e.getAlerts(i),u=e.getFirmware(i),g=e.getPower(i),v=e.getSensors(i),h=e.getInputChannels(i),f=o?.isOn??!1,b=void 0!==o?.brightness,m=o&&b&&f?Math.max(1,o.brightness??1):0,x=!!o?.colorModes?.length,y=o?.rgbColor?e.rgbToHex(...o.rgbColor):"#ffffff",w=!!o?.colorModes?.some(e=>"rgbw"===e||"rgbww"===e),k="heat"===l?.hvacMode,A="ble"===s.gen?"BLE":"other"===s.gen?"":`G${s.gen}`,C=(S=i.integration,qe[S.toLowerCase()]??S.toUpperCase().slice(0,6));var S,z;switch(t){case"name_row":{const t=a.device_styles?.[i.device_id],s=f?t?.tile_icon:t?.tile_icon_off??t?.tile_icon;let n;if(s)n=Ee(s,f,`--ent-spd:${t?.tile_icon_speed??1}`,"tile-icon");else if(d){const e=d.position??("open"===d.state?100:0),t=e>66?"water2":e>33?"water3":e>0?"water":void 0;n=t?Ee(t,!0,"--ent-spd:1","tile-icon"):Q``}else if(l){const e="heating"===l.hvacAction,t=l.valvePosition,i=e?null!=t?t>66?"flame3":t>33?"flame2":"flame":"flame":void 0;n=i?Ee(i,!0,"--ent-spd:1","tile-icon"):Q``}else n=Q``;const p=o?e.renderEntityAnim(o.entityId,f,i.device_id):Q``;return Q`
        <div class="tile-top">
          <div class="tile-left tile-trigger">
            ...
            ${u?Q`<span class="update-dot" title="Firmware update">●</span>`:G}
          </div>
          ${c?Q`
      ...
      `}case"sensors":{if(!v.length)return Q``;const e=v.filter(e=>"primary"===(e.tier??"primary")),t=v.filter(e=>"electrical"===e.tier),i=v.filter(e=>"diag"===e.tier),s=new Set(["humidity","battery","gas","co2","door","motion","flood","smoke","vibration","overtemp","overpower"]),a=new Map;for(const e of t){const t=e.ch??"";a.has(t)||a.set(t,[]),a.get(t).push(e)}const n=e=>"cloud"===e.key||"mqtt"===e.key||"eth"===e.key?`${e.label} ${"Connected"===e.value?"✓":"✗"}`:`${e.label} ${e.value}`;return Q`
        ${e.length?Q`
          <div class="tile-stats">
            ${e.map(e=>Q`
              <span class="stat-item ${e.warn?"warn":""}">
                ${e.ch?Q`<span class="stat-lbl">${e.ch}</span>`:G}
                ${!e.ch&&e.key&&s.has(e.key)?Q`<span class="stat-lbl">${e.label}</span>`:G}
                ${e.value}
              </span>`)}
          </div>`:G}
        ${t.length?Q`
          <div class="tile-elec-wrap">
            ${[...a.entries()].map(([e,t])=>Q`
              <div class="tile-elec">
                ${e?Q`<span class="stat-lbl">${e}</span>`:G}
                ${t.map((e,t)=>Q`${t>0?Q`<span class="sep">·</span>`:G}${"power_factor"===e.key?`PF ${e.value}`:e.value}`)}
              </div>`)}
          </div>`:G}
        ${i.length?Q`
          <div class="tile-diag" title=${i.map(e=>`${e.label}: ${e.value}`).join("  ·  ")}>
            ${i.map((e,t)=>Q`${t>0?Q`<span class="sep">·</span>`:G}<span class="${e.warn?"warn":""}">${n(e)}</span>`)}
          </div>`:G}
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=o?n.states[o.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,a=o?.whiteValue??0;return o&&b?Q`
      ...
      `:Q``;case"trv_control":{const t=i.entities.find(e=>"sensor"===e.domain&&"battery"===n.states[e.entity_id]?.attributes?.device_class),s=null!=t&&parseFloat(n.states[t.entity_id]?.state??"")||null,a={comfort:"🏠",eco:"🌿",boost:"🚀",away:"🌙",none:"❄️"};return l?Q`
        <div class="tile-trv-dial" @click=${e=>e.stopPropagation()}>
          ...
          <div class="trv-stat-row">
            ...
            ${null!=l.valvePosition?Q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(l.valvePosition)}%</span></div>`:G}
            ${null!=s?Q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${s}%</span></div>`:G}
          </div>
      ...
      `:Q``}case"input_channels":return h.length?Q`
      ...
      `:Q``;case"virtual_controls":{const t=e.getVirtualControls(i);return t.length?Q`
        <div class="tile-virtuals" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{if("unavailable"===t.value)return G;if("select"===t.domain){const i=t.options??[],s=i.indexOf(t.value);return Q`
                <div class="virt-row">
                ...
                </div>`}if("number"===t.domain){const i=parseFloat(t.value),s=t.step??1,a=s<1?String(s).split(".")[1]?.length??1:0;return Q`
                <div class="virt-row">
                  <span class="virt-lbl">${t.label}</span>
                  <div class="virt-num">
        ...
        <div class="relay-channels" @click=${e=>e.stopPropagation()}>
          ${t.map(t=>{const s=n.states[t.entity_id],a="on"===s?.state,r=s?.attributes?.friendly_name??t.entity_id;return Q`
      ...
      `:Q``}case"power_bar":return e.renderPowerBar(i);case"badges":return Q`
        <div class="tile-bot">
          ${null!=g?Q`<span class="tile-power">${Ze(g)}</span>`:G}
          <div class="tile-badges">
            ${p.map(e=>Q`<span class="alert-badge alert-${e}">${"overtemp"===e?"🌡":"⚡"}!</span>`)}
            ${s.label?Q`<span class="type-badge type-${s.type}">${s.label}</span>`:G}
            ${A?Q`<span class="gen-badge gen-${s.gen}">${A}</span>`:G}
            ${C?Q`<span class="int-badge-tile">${C}</span>`:G}
            ${i.isShelly&&i.ip&&(z=i.ip,/^10\./.test(z)||/^192\.168\./.test(z)||/^172\.(1[6-9]|2\d|3[01])\./.test(z)||/^169\.254\./.test(z))?Q`
              <a href="http://${i.ip}" target="_blank" class="tile-ui-link"
                @click=${e=>e.stopPropagation()}>↗</a>
            `:G}
          </div>
        </div>
      `;default:return Q``}}const gt=255;function vt(e){return Q`
    <div class="ds-backdrop" @click=${()=>e.closeDetailSheet()}>
      <div class="ds-sheet" @click=${e=>e.stopPropagation()}>
        ${function(e){const{device:t,profile:i,accent:s,online:a}=e,n=e.getFirmware(t),r=e.tileSensors(t);return Q`
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      <div class="ds-header-meta">
        ${t.area?Q`<span class="ds-chip ds-chip--room">${t.area}</span>`:G}
        <span class="ds-chip ds-chip--type">${i.label}</span>
        ${t.model?Q`<span class="ds-chip">${t.model}</span>`:G}
        ${"other"!==i.gen?Q`<span class="ds-chip">Gen ${i.gen}</span>`:G}
        ${t.ip?Q`<span class="ds-chip">${t.ip}</span>`:G}
      </div>
      ${n?Q`<div class="ds-fw-update"><span>FW update: ${n.current} → ${n.newVersion}</span></div>`:G}
      ${null!=r.rssi?Q`<div class="ds-signal">Wi-Fi: ${Ke(r.rssi)} (${r.rssi} dBm)${null!=r.uptime?Q` · Up ${Ye(r.uptime)}`:G}</div>`:G}
    ...
    ${s.length>1?Q`
      <div class="ds-section">
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const a=i.states[s.entity_id],n="on"===a?.state,r=a?.attributes?.friendly_name??s.entity_id,o=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(o)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${r}</span>
                ${isNaN(c)?G:Q`<span class="ds-channel-power">${Ze(c)}</span>`}
                <button class="tog ${n?"on":"off"}" @click=${t=>e.toggle(s.entity_id,n,t)}>${n?"ON":"OFF"}</button>
              </div>`})}
        </div>
      </div>`:1===s.length?Q`
      <div class="ds-section ds-single-toggle">
        ${(()=>{const t=i.states[s[0].entity_id],a="on"===t?.state;return Q`
          <button class="tog ds-big-toggle ${a?"on":"off"}" @click=${t=>e.toggle(s[0].entity_id,a,t)}>${a?"ON":"OFF"}</button>`})()}
      </div>`:G}
    ${ft(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return Q`
    <div class="ds-section ds-plug-hero">
      ${t?Q`<button class="tog ds-big-toggle ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:G}
      ${null!=s.power?Q`<span class="ds-big-power">${Ze(s.power)}</span>`:G}
    </div>
    ${ft(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,a=Math.round(s/255*100);return Q`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        <input type="range" min="0" max="255" .value=${String(s)}
          ...
          class="ds-slider">
        ${t?Q`<button class="tog ${i?"on":"off"}" @click=${s=>e.toggle(t.entityId,i,s)}>${i?"ON":"OFF"}</button>`:G}
      </div>
    </div>
    ${ft(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,a=i?.brightness??0,n=Math.round(a/gt*100);return Q`
    <div class="ds-section">
      ...
      <div class="ds-dimmer-control">
        ...
        ${i?Q`<button class="tog ${s?"on":"off"}" @click=${t=>e.toggle(i.entityId,s,t)}>${s?"ON":"OFF"}</button>`:G}
      </div>
      ${i?.rgbColor?Q`<div class="ds-color-swatch" style="background:rgb(${i.rgbColor.join(",")})"></div>`:G}
    </div>
    ${ft(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return Q`
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        <div class="ds-climate-modes">
          ...
          ${t.hvacAction?Q`<span class="ds-chip">${t.hvacAction}</span>`:G}
          ${t.presetMode?Q`<span class="ds-chip">${t.presetMode}</span>`:G}
        </div>
        ${null!=t.valvePosition?Q`<div class="ds-valve-pos">Valve: ${t.valvePosition}%</div>`:G}
      `:Q`<span class="ds-muted">No climate entity</span>`}
    </div>
    ${ft(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return Q`
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        ${null!=t.position?Q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:G}
        <span class="ds-chip">${t.state}</span>
      `:Q`<span class="ds-muted">No cover entity</span>`}
    </div>
    ${ft(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return Q`
    <div class="ds-section">
      ...
      ${t?Q`
        ...
        ${null!=t.position?Q`<div class="ds-cover-pos">Position: ${t.position}%</div>`:G}
        ${null!=t.temperature?Q`<div class="ds-cover-pos">Temp: ${t.temperature.toFixed(1)}°C</div>`:G}
        <span class="ds-chip">${t.state}</span>
      `:Q`<span class="ds-muted">No valve entity</span>`}
    </div>
    ${ft(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return Q`${ft(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),a=e.getAlerts(t);return Q`
    ${s?(()=>{const e=i.states[s.entity_id],t=parseFloat(e?.state??""),a=e?.attributes?.unit_of_measurement??"";return Q`
        <div class="ds-section ds-sensor-hero">
          <span class="ds-big-value">${isNaN(t)?"—":t.toFixed(1)}</span>
          <span class="ds-big-unit">${a}</span>
        </div>`})():G}
    ${a.length?Q`<div class="ds-section ds-alert-row">${a.map(e=>Q`<span class="ds-chip ds-chip--alert">${e}</span>`)}</div>`:G}
    ${ft(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return Q`
    <div class="ds-section">
      <div class="ds-section-title">Input Channels</div>
      ${s.length?Q`
        <div class="ds-channel-list">
          ${s.map(t=>{const s=i.states[t.entity_id],a="on"===s?.state,n=s?.attributes?.friendly_name??t.entity_id,r=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${n}</span>
                <span class="ds-chip ${a?"ds-chip--on":""}">${a?"ON":"OFF"}</span>
                ${r?Q`<span class="ds-ent-age">${r}</span>`:G}
              </div>`})}
        </div>`:Q`<span class="ds-muted">No input channels</span>`}
    </div>
    ${ft(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),a=t.entities.filter(e=>"switch"===e.domain);return Q`
    ${s.length?Q`
      <div class="ds-section">
        <div class="ds-section-title">ADC Inputs</div>
        ${s.map(e=>{const t=i.states[e.entity_id],s=t?.state??"—",a=t?.attributes?.unit_of_measurement??"",n=t?.attributes?.friendly_name??e.entity_id;return Q`<div class="ds-channel-row"><span class="ds-channel-name">${n}</span><span>${s} ${a}</span></div>`})}
      </div>`:G}
    ${a.length?Q`
      <div class="ds-section">
        <div class="ds-section-title">Outputs</div>
        <div class="ds-channel-list">
          ${a.map(t=>{const s=i.states[t.entity_id],a="on"===s?.state,n=s?.attributes?.friendly_name??t.entity_id;return Q`
              <div class="ds-channel-row">
                <span class="ds-channel-name">${n}</span>
    ...
    ${ft(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return Q`
    ${t?Q`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${ft(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return Q`
    ${s.length?Q`
      <div class="ds-section">
    ...
    </div>`}function ht(e){if(!e.getGraphEntities(e.device).length)return Q``;const t=e.getDetailHistoryRange();return Q`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function ft(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:a=!1}=t;return Q`
    ${a&&s?ht(e):G}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ze(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:G}
        ${null!=t.voltage?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Xe(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:G}
        ${null!=t.current?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ve(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:G}
        ${null!=t.energy?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Qe(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:G}
        ${null!=t.temp?Q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Ge(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:G}
      </div>
    </div>`:Q``}(e):G}
    ${!a&&s?ht(e):G}
    ${function(e){const{device:t,hass:i}=e;return t.entities.length?Q`
    <div class="ds-section">
      <div class="ds-section-title">All Entities</div>
      ${t.entities.map(t=>{const s=i.states[t.entity_id],a=s?.attributes?.friendly_name??t.entity_id,n=s?.state??"unknown",r=s?.attributes?.unit_of_measurement??"",o="switch"===t.domain||"light"===t.domain||"input_boolean"===t.domain,l="on"===n,c=s?.last_changed?e.timeAgo(s.last_changed):"";return Q`
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${i.length?Q`<div class="ds-diag-item ds-diag-alert"><span class="ds-diag-label">Alerts</span><span class="ds-diag-val">${i.join(", ")}</span></div>`:G}
          ...
          </div>`;const A=k.map(e=>e.v),C=(this._config.graph_style?.sensor_ranges??{})[x]??{},S=C.min??Math.min(...A),z=C.max??Math.max(...A),I=z-S||1,M=k[0].t,O=k[k.length-1].t,B=O-M||1,T=e=>(e.t-M)/B*n,E=e=>r-4-(e.v-S)/I*(r-8),R=k.map(e=>`${T(e).toFixed(1)},${E(e).toFixed(1)}`).join(" "),D=T(k[0]).toFixed(1),F=`sg-${t.replace(/[^a-z0-9]/gi,"")}`,P=A[A.length-1],L=P%1==0?`${P}`:P.toFixed(1),U=A.indexOf(z),N=A.indexOf(S),j=T(k[U]).toFixed(1),H=E(k[U]).toFixed(1),W=T(k[N]).toFixed(1),q=E(k[N]).toFixed(1),Z=m(k[0].t),V=m((k[0].t+O)/2),Y=h/B*n,K=`${Math.max(.3,.7*Y).toFixed(2)} ${Math.max(.3,.3*Y).toFixed(2)}`,J=c&&z-S>0;return Q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?G:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${n} ${r}" preserveAspectRatio="none"
                ...
                `:G}
                ${"bar"===u?k.map(e=>{const t=Math.max(2,n/k.length-2),i=T(e)-t/2,s=E(e),a=r-4-s;return X`<rect x="${i.toFixed(1)}" y="${s.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,a).toFixed(1)}" rx="1.5" fill="${y}" opacity="0.75"/>`}):X`
          ...
          ${p?Q`
            <div class="spark-time-row">
              ...
              <div class="spark-time-labels">
                <span>${Z}</span><span>${V}</span><span>now</span>
              </div>
    ...
    `}_trvTempFromEvent(e,t,i,s,a){const n=t.getBoundingClientRect(),r=(e.clientX-n.left)*(160/n.width),o=(e.clientY-n.top)*(132/n.height);let l=Math.atan2(o-70,r-80)*(180/Math.PI)+90;l<0&&(l+=360);const c=(l-210+360)%360;if(c>300)return null;const d=i+c/300*(s-i);return Math.max(i,Math.min(s,Math.round(d/a)*a))}_valvePosFromEvent(e,t){const i=t.getBoundingClientRect(),s=(e.clientX-i.left)*(160/i.width),a=(e.clientY-i.top)*(128/i.height);let n=Math.atan2(a-68,s-80)*(180/Math.PI)+90;n<0&&(n+=360);const r=(n-210+360)%360;return r>300?null:Math.round(r/300*100)}_renderValveDial(e){const t=e.position??("open"===e.state?100:0),i=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),68+t*Math.sin((e-90)*Math.PI/180)],s=(e,t,s)=>{const[a,n]=i(e,s),[r,o]=i(t,s);return`M ${a} ${n} A ${s} ${s} 0 ${t-e>180?1:0} 1 ${r} ${o}`},a=e.supportsPosition||!!e.numEntityId,n=this._valveDragPos??t,r=(e=>210+e/100*300)(n),[o,l]=i(r,54),c=`hsl(${200+.2*n}, ${40+.55*n}%, ${38+.18*n}%)`,d=null!=this._valveDragPos?`${Math.round(this._valveDragPos)}%`:"opening"===e.state?"Opening…":"closing"===e.state?"Closing…":100===t?"Open":0===t?"Closed":"Partial",p=a?t=>{t.stopPropagation();const i=t.currentTarget;i.setPointerCapture(t.pointerId);const s=e=>{const t=this._valvePosFromEvent(e,i);null!=t&&(this._valveDragPos=t)},a=t=>{const n=this._valvePosFromEvent(t,i)??this._valveDragPos;this._valveDragPos=null,null!=n&&this._setValvePosition(e.entityId,n,e.numEntityId),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a)};i.addEventListener("pointermove",s),i.addEventListener("pointerup",a)}:void 0;return X`
      <svg viewBox="0 0 160 128" class="trv-dial-svg ${a?"valve-interactive":""}"
        ...
        ${a?X`<path d="${s(210,510,54)}" fill="none" stroke="transparent" stroke-width="22" stroke-linecap="round"/>`:G}
        <path d="${s(210,510,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${t>0?X`<path d="${s(210,r,54)}" fill="none" stroke="url(#valve-grad)" stroke-width="8" stroke-linecap="round"/>`:G}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderTileIcon(e,t,i={}){const{coverPos:s,coverState:a,isHeating:n,valveOpen:r,hasFan:o}=i,l=e.type;if("relay"===l||"plug"===l)return o?X`<svg class="tile-icon tile-icon-fan ${t?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`;if("cover"===l){const e=s??("open"===a?100:"closed"===a?0:50),t="opening"===a||"closing"===a,i=[2,5.5,9,12.5,16],n=Math.ceil(e/100*i.length);return X`<svg class="tile-icon tile-icon-cover ${t?"moving":""}" viewBox="0 0 20 20">
      ...
      </svg>`}return"climate"===l||"wall_display"===l?X`<svg class="tile-icon tile-icon-flame ${n?"on":""}" viewBox="0 0 20 20">
      ...
      </svg>`:"valve"===l?X`<svg class="tile-icon tile-icon-valve ${r?"on":""}" viewBox="0 0 20 20">
    ...
    </svg>`}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return Q``;const a=(t?s.on:s.off)??"none";return"none"===a?Q``:Ee(a,t,`--ent-spd:${s.speed??1}`,"ent-icon")}_renderBlock(e,t,i){const s=this._tileAccent(t,t.area??"");return ut(this._buildTileCtx(t,i,s),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return Q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return Q`
      <div class="power-bar" title="${t.toFixed(0)} W">
        <div class="power-bar-fill" style="width:${Math.min(100,t/i*100)}%"></div>
      </div>`}_tileSensors(e){let t=null,i=null,s=null,a=null,n=null,r=null,o=null;for(const l of e.entities){if("sensor"!==l.domain)continue;const e=this.hass.states[l.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const c=e.attributes.device_class??"",d=parseFloat(e.state);"power"===c&&null==t&&(t=isNaN(d)?null:d),"voltage"===c&&null==i&&(i=isNaN(d)?null:d),"current"===c&&null==s&&(s=isNaN(d)?null:d),"temperature"===c&&null==a&&(a=isNaN(d)?null:d),"energy"===c&&null==n&&(n=isNaN(d)?null:d);const p=l.entity_id;(p.includes("rssi")||p.includes("signal"))&&(r=isNaN(d)?null:d),p.includes("uptime")&&(o=isNaN(d)?null:d)}return{power:t,voltage:i,current:s,temp:a,energy:n,rssi:r,uptime:o}}_deviceMetric(e,t){if("power"===t)return this._getPower(e);const i={energy:"energy",temperature:"temperature",humidity:"humidity",illuminance:"illuminance"};for(const s of e.entities){if("sensor"!==s.domain)continue;const e=this.hass.states[s.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const a=parseFloat(e.state);if(isNaN(a))continue;const n=e.attributes.device_class??"";if("rssi"===t){if("signal_strength"===n||s.entity_id.includes("rssi"))return a}else if(n===i[t])return a}return null}_formatHeaderMetric(e,t){switch(e){case"power":return Ze(t);case"energy":return Qe(t);case"temperature":return Ge(t);case"humidity":return et(t);case"illuminance":return tt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(t)}}_devicesWithUpdates(e){return e.map(e=>({device:e,fw:this._getFirmware(e)})).filter(e=>!!e.fw?.newVersion&&e.fw.newVersion!==e.fw.current)}_renderHeaderChips(e){const t=this._config.header_chips??ot,i=e.filter(e=>this._isOnline(e)).length,s=e=>t=>{t.stopPropagation(),this._cloudDetailOpen=this._cloudDetailOpen===`m:${e}`?null:`m:${e}`};return Q`
      <div class="dash-stats">
        ${t.map(t=>{const a=rt.find(e=>e.key===t);if(!a)return G;let n="",r="metric";if("online"===t)n=`${i}/${e.length} online`,r="online";else if("offline"===t){const t=e.length-i;if(!t)return G;n=`${t} offline`,r="offline-count"}else if("alerts"===t){const t=e.filter(e=>this._getAlerts(e).length>0).length;if(!t)return G;n=`⚠ ${t}`,r="alerts-count"}else if("updates"===t){const t=this._devicesWithUpdates(e).length;if(!t)return G;n=`⬆ ${t} update${t>1?"s":""}`,r="updates-count"}else{const i=e.map(e=>this._deviceMetric(e,t)).filter(e=>null!=e);if(!i.length)return G;const s=i.reduce((e,t)=>e+t,0),o="sum"===a.agg?s:s/i.length;n="power"===t?this._formatHeaderMetric(t,o):`${a.label} ${this._formatHeaderMetric(t,o)}`,"power"===t&&(r="power")}const o=this._cloudDetailOpen===`m:${t}`;return Q`<span class="stat ${r} ${o?"active":""}" @click=${s(t)}>${n}</span>`})}
      </div>`}_renderHeaderDetail(e){const t=this._cloudDetailOpen;if(!t?.startsWith("m:"))return Q``;const i=t.slice(2),s=rt.find(e=>e.key===i);if(!s)return Q``;let a=[],n="cloud-on";return"online"===i?a=e.filter(e=>this._isOnline(e)).map(e=>({name:e.name,value:""})):"offline"===i?(a=e.filter(e=>!this._isOnline(e)).map(e=>({name:e.name,value:""})),n="cloud-off"):"alerts"===i?(a=e.map(e=>({d:e,a:this._getAlerts(e)})).filter(e=>e.a.length).sort((e,t)=>t.a.length-e.a.length).map(e=>({name:e.d.name,value:e.a.join(", ")})),n="cloud-off"):a="updates"===i?this._devicesWithUpdates(e).map(e=>({name:e.device.name,value:`${e.fw.current} → ${e.fw.newVersion}`})):e.map(e=>({d:e,v:this._deviceMetric(e,i)})).filter(e=>null!=e.v).sort((e,t)=>t.v-e.v).map(e=>({name:e.d.name,value:this._formatHeaderMetric(i,e.v)})),a.length?Q`
        ...
        <div class="metric-list">
          ${a.map(e=>Q`
            <div class="metric-row">
              ...
              ${e.value?Q`<span class="metric-val">${e.value}</span>`:G}
            </div>`)}
        </div>
      </div>`:Q``}_tileAccent(e,t){const i=this._config.device_styles?.[e.device_id]?.color;if(i)return i;const s=this._config.area_styles?.[t];return s?.accentColor?s.accentColor:this._config.style?.accent_color??"var(--sc-accent)"}_renderTileLowerBody(e,t,i={}){const s=this._getPrimarySwitch(e),a=this._getTrv(e),n=this._getValve(e),r=this._getCover(e),o=s?.isOn??!1,l=this._getGraphEntities(e),c=i.skipGraphs?[]:i.skipPowerGraph?l.filter(e=>"power"!==e.dc):l,d=c.length?Q`<div class="ts-lower-section ts-lower-graphs">
          ${this._renderSparklinesFiltered(e,c)}
        </div>`:G,p=void 0!==s?.brightness,u=!!s?.colorModes?.length,g=u&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",v=u&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=p&&o?Math.max(1,s.brightness??1):0,f=s?.whiteValue??0,b=s?this.hass.states[s.entityId]:null,m=b?.attributes?.effect_list??[],x=b?.attributes?.effect??null,y=p?Q`
    ...
    `:G,C=e.entities.filter(e=>"switch"===e.domain&&/_(switch|relay|channel)_\d/.test(e.entity_id)),S=C.length>1?Q`
      <div class="ts-lower-section ts-lower-relay" @click=${e=>e.stopPropagation()}>
        ${this._renderBlock("relay_channels",e,t)}
      </div>
    `:G;return c.length||p||a||n||r||C.length>1?Q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${we(o)}
          ...
          ${a.map(e=>ut(c,e))}
        </div>`}const v=e.area??"",h=this._tileAccent(e,v);this._getPrimarySwitch(e);return Q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${we(o)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===p?lt(this._buildTileCtx(e,s,h),g):"light-control"===p?pt(this._buildTileCtx(e,s,h)):"climate-control"===p?function(e){const{device:t,accent:i,online:s,hass:a}=e,n=e.getTrv(t);if(!n)return Oe(t,s,"ts-climate","No climate entity");const r="heating"===n.hvacAction,o=t.entities.find(e=>"sensor"===e.domain&&"battery"===a.states[e.entity_id]?.attributes?.device_class),l=o&&parseFloat(a.states[o.entity_id]?.state??"")||null;return Q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="trv-stat-row">
        ...
        ${null!=n.valvePosition?Q`<div class="trv-stat"><span class="trv-stat-lbl">Valve</span><span class="trv-stat-val">${Math.round(n.valvePosition)}%</span></div>`:G}
        ${null!=l?Q`<div class="trv-stat"><span class="trv-stat-lbl">Batt</span><span class="trv-stat-val">${l}%</span></div>`:G}
      </div>
      ${n.presetModes.length?Q`<div class="trv-presets">${n.presetModes.map(t=>Q`
        <button class="trv-preset-btn ${n.presetMode===t?"active":""}"
          @click=${()=>e.setPresetMode(n.entityId,t)}>${(Be[t]??"")+t}</button>`)}
      </div>`:G}
    </div>`}(this._buildTileCtx(e,s,h)):"cover-control"===p?function(e){const{device:t,accent:i,online:s}=e,a=e.getCover(t);if(!a)return Q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">No cover entity</span></div>`;const n=a.position??("open"===a.state?100:0),r="opening"===a.state||"closing"===a.state,o=Math.ceil(n/100*Te.length);return Q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      <div class="ts-cover-graphic">
        <svg viewBox="0 0 60 32" style="width:100%;height:40px">
          ...
          ${Te.map((e,t)=>X`<rect x="3" y="${e}" width="54" height="3" rx="1" fill="${i}" opacity="${t<o?"0.85":"0.1"}"/>`)}
        </svg>
        ${r?Q`<span class="ts-cover-state">${"opening"===a.state?"▲ Opening…":"▼ Closing…"}</span>`:G}
      </div>
    ...
    </div>`}(this._buildTileCtx(e,s,h)):"sensor-card"===p?function(e){const{device:t,accent:i,online:s,hass:a,config:n}=e;let r;for(const e of Pe)if(r=t.entities.find(t=>{if("sensor"!==t.domain)return!1;const i=a.states[t.entity_id];return i&&i.attributes?.device_class===e}),r)break;const o=r?void 0:t.entities.find(e=>{if("binary_sensor"!==e.domain)return!1;const t=a.states[e.entity_id];return t&&Le.includes(t.attributes?.device_class??"")});if(!r&&!o)return Oe(t,s,"ts-sensor","No sensor");if(r){const o=a.states[r.entity_id],l=parseFloat(o?.state??""),c=o?.attributes?.unit_of_measurement??"",d=o?.attributes?.device_class??"",p=n.graph_hours??24;e.requestGraphData(r.entity_id);const u=e.getGraphPoints(r.entity_id,p);let g=0;if(u.length>=2){const e=Math.floor(u.length/2),t=u.slice(e).reduce((e,t)=>e+t.v,0)/(u.length-e),i=u.slice(0,e).reduce((e,t)=>e+t.v,0)/e;g=t-i}const v=t.entities.filter(e=>{if(e.entity_id===r.entity_id||"sensor"!==e.domain)return!1;const t=a.states[e.entity_id];return!(!t||"unavailable"===t.state||"unknown"===t.state||isNaN(parseFloat(t.state)))}).slice(0,4);return Q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        ...
        ${v.length?Q`<div class="ts-chips" style="margin-top:6px">
          ${v.map(e=>{const t=a.states[e.entity_id],i=parseFloat(t?.state??""),s=t?.attributes?.unit_of_measurement??"";return Q`<span class="ts-chip">${isNaN(i)?t?.state:i.toFixed(1)} ${s}</span>`})}
        </div>`:G}
      </div>`}const l=a.states[o.entity_id],c="on"===l?.state,d=l?.attributes?.device_class??"",p=c?"motion"===d?"Motion":"moisture"===d?"Flooded":"smoke"===d?"Smoke!":"Open":"motion"===d?"Clear":"moisture"===d?"Dry":"smoke"===d?"Clear":"Closed",u=c?"#f87171":"var(--sc-online-color)",g=l?.last_changed?e.timeAgo(l.last_changed):"";return Q`
    <div class="ts-sensor" style="--ts-accent:${i}">
      <div class="ts-sensor-top">
        ${Me(t,s)}
        <span class="ts-sensor-dc">${d}</span>
      ...
      ${g?Q`<div style="font-size:.7em;color:var(--sc-text-muted);margin-top:4px">${g}</div>`:G}
    </div>`}(this._buildTileCtx(e,s,h)):"scene-button"===p?function(e){const{device:t,accent:i,online:s,config:a}=e,n=e.getInputChannels(t),r=a.device_styles?.[t.device_id],o=Ee(r?.tile_icon??"pulse",!0,`--ent-spd:${r?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),l=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),c=l?e.timeAgo(l):"";return n.length>0?Q`
      ...
      <div class="area-section ${s?"closed":""}" style=${we(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${n>0?Q`<span class="area-power">${Ze(n)}</span>`:G}
    ...
    `}_renderExpanded(e){const t=this._getSensors(e),i=this._getFirmware(e),s=this._getTrv(e),a=this._getCover(e),n=this._getValve(e),r=!1!==this._config.show_entity_list,o=this._entityListOpen.has(e.device_id);return Q`
      <div class="expanded" @click=${e=>e.stopPropagation()}>
          ...
          <div class="exp-section exp-section--trv">
            ...
            <div class="trv-ctrl-row">
              ...
              <div class="trv-display">
                ...
                ${null!=s.currentTemp?Q`<span class="trv-current-sub">now ${s.currentTemp}°</span>`:G}
                ${"heating"===s.hvacAction?Q`<span class="trv-action-badge heating">Heating</span>`:G}
              </div>
        ...
        ${r?Q`
          <div class="exp-section exp-section--full">
            ...
            ${o?Q`
              <div class="ent-list">
                ${e.entities.filter(e=>!(this._config.hidden_entities??[]).includes(e.entity_id)).map(e=>{const t=this.hass.states[e.entity_id],i=t?.state??"unavailable",s=t?.attributes?.unit_of_measurement??"",a=t?.attributes?.friendly_name??e.entity_id.split(".")[1].replace(/_/g," "),n=["switch","light","input_boolean","fan"].includes(e.domain);return Q`
                      <div class="ent-row">
      ...
      <ha-card class=${this._config.effects?"":"no-fx"} style=${we(v)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ...
        ${"unavailable"===this._cloudDetailOpen?Q`
          <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
            ...
            <div class="cloud-grid">
              ${u.map(e=>Q`<div class="cloud-item">${g(e)}</div>`)}
            </div>
          </div>`:G}
    ...
    `}_renderViewTabs(){const e=this._config.views;if(!e?.length||e.length<2)return Q``;const t=this._getActiveView()?.id;return Q`
      ...
      <div popover="manual" class="icon-grid-popover" id="ha-dd-icon-grid-popover"
        ...
        ${e?Fe.map(i=>{const s=(e.currentValue??"none")===i.value,a="none"!==i.value?Re[i.value]?.[e.isOn?"on":"off"]??t:t;return Q`
            <button class="icon-grid-cell ${s?"sel":""}"
              ...
              ${"none"===i.value?Q`<span class="icon-grid-none">—</span>`:Ee(i.value,e.isOn,`--ent-spd:1;color:${a};width:20px;height:20px`,"icon-preview")}
              <span class="icon-grid-lbl">${i.label}</span>
            </button>`}):G}
      </div>`}_iconPicker(e,t,i,s){const a="#f4601e",n=t?Re[t]?.[i?"on":"off"]??a:a,r=this._iconPickerState?.onSelect===s;return Q`
      <div class="icon-picker-wrap">
        <button class="icon-picker-btn compact"
          ...
          ${t?Ee(t,i,`--ent-spd:1;color:${n}`,"icon-preview-sm"):Q`<span class="icon-cell-none">—</span>`}
        </button>
      </div>`}_set(e,t){if(!this._config)return;const i={...this._config,[e]:t};(""===t||void 0===t||Array.isArray(t)&&0===t.length&&"areas"!==e)&&delete i[e],this._emitConfig(i)}_emitConfig(e){this._config=e,this._pendingConfig=e,null!=this._emitTimer&&clearTimeout(this._emitTimer),this._emitTimer=window.setTimeout(()=>this._flushConfig(),300)}_flushConfig(){null!=this._emitTimer&&(clearTimeout(this._emitTimer),this._emitTimer=null);const e=this._pendingConfig;this._pendingConfig=null,e&&Ce(this,"config-changed",{config:e})}_emitNow(e){this._config=e,this._pendingConfig=e,this._flushConfig()}_toggleSec(e){this._openSections={...this._openSections,[e]:!this._openSections[e]}}_resetBtn(e,t){return e?Q`<button class="field-reset" title="Reset to default"
          @click=${e=>{e.stopPropagation(),t()}}>↺</button>`:G}_clearCfg(e){const t={...this._config};delete t[e];const{type:i,...s}=t;this._emitNow({type:i,...s})}_clearStyle(e){const t={...this._config.style??{}};delete t[e],this._set("style",Object.keys(t).length?t:void 0)}_clearGraphStyle(e){const t={...this._config.graph_style??{}};delete t[e],this._set("graph_style",Object.keys(t).length?t:void 0)}_renderBgThumb(e){return Q`<div class="bg-thumb" style="background-image:url(${e})" title="Preview"></div>`}_estimateImageSize(e){if(!e.startsWith("data:"))return"";const t=e.indexOf(",");if(t<0)return"";const i=Math.floor(.75*(e.length-t-1));return i>=1048576?`~${(i/1048576).toFixed(1)} MB`:i>=1024?`~${Math.round(i/1024)} KB`:`~${i} B`}_showStyleFeedback(e){this._styleClipFeedback=e,clearTimeout(this._styleClipTimer),this._styleClipTimer=window.setTimeout(()=>{this._styleClipFeedback=""},1500)}_copyStyle(){const e={};for(const t of zt){const i=this._config[t];void 0!==i&&(e[t]=i)}this._copyJson=JSON.stringify(e),this._copyAreaOpen=!0,this._pasteOpen=!1,navigator.clipboard.writeText(this._copyJson).catch(e=>{console.warn("[editor] clipboard write failed",e)})}_applyPastedStyle(){try{const e=JSON.parse(this._pasteText),t=zt.some(t=>t in e);if(!t)return void this._showStyleFeedback("Invalid style data");const i={...this._config};for(const t of zt)t in e&&(i[t]=e[t]);this._emitNow(i),this._showStyleFeedback("Applied!"),this._pasteOpen=!1,this._pasteText=""}catch{this._showStyleFeedback("Invalid style data")}}_getAreas(){return this.hass?Object.values(this.hass.areas??{}).map(e=>({id:e.area_id,name:e.name})).sort((e,t)=>e.name.localeCompare(t.name)):[]}_getAllHADevices(){if(!this.hass)return[];const e=this.hass.devices??{},t=this.hass.entities??{},i=new Set,s=[];for(const a of Object.values(t)){const t=a?.device_id;if(!t||i.has(t))continue;i.add(t);const n=e[t];if(!n)continue;const r=n.area_id??a.area_id,o=r?this.hass.areas?.[r]?.name:void 0;s.push({device_id:t,name:n.name_by_user??n.name??t,area:o})}return s.sort((e,t)=>e.name.localeCompare(t.name))}_allDevices(){return this.hass?(this._devCacheHass!==this.hass&&(this._devCache=Ne(this.hass),this._devCacheHass=this.hass),this._devCache):[]}_getDiscoveredDevices(){if(!this.hass)return[];const e=this._config.areas;let t=this._allDevices();if(void 0!==e){const i=new Set(e.map(e=>e.toLowerCase()));t=t.filter(e=>i.has((e.area??"").toLowerCase()))}return t.map(e=>({device_id:e.device_id,name:e.name,area:e.area})).sort((e,t)=>e.name.localeCompare(t.name))}_getEntitiesForDevice(e){const t=this.hass.entities??{},i=[];for(const[s,a]of Object.entries(t)){if(a.device_id!==e)continue;const t=this.hass.states[s];i.push({entity_id:s,name:t?.attributes?.friendly_name??s,domain:s.split(".")[0]})}return i.sort((e,t)=>e.name.localeCompare(t.name))}_setAreaStyle(e,t,i){const s={...this._config.area_styles?.[e]??{}};void 0===i||""===i?delete s[t]:s[t]=i;const a={...this._config.area_styles??{}};Object.keys(s).length?a[e]=s:delete a[e],this._set("area_styles",Object.keys(a).length?a:void 0)}_clearAreaStyle(e){const t={...this._config.area_styles??{}};delete t[e],this._set("area_styles",Object.keys(t).length?t:void 0)}_chipPicker(e,t,i,s){const a=t??[],n=void 0!==e,r=At.flatMap(e=>e.items.map(e=>e.key)),o=new Set(n?e:a.length?a:r);return Q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${n?"Custom selection":`Inheriting from ${i}`}</span>
          ${n?Q`<button class="color-reset" @click=${()=>s(void 0)}>↺ Inherit</button>`:Q`<button class="color-reset" @click=${()=>s([...o])}>Customize</button>`}
        </div>
        ${At.map(t=>Q`
      ...
      </div>`}_badge(e,t,i){return Q`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=t.map(e=>e.name),s=e.areas,a=e=>{const t=void 0===s?new Set(i):new Set(s);t.has(e)?t.delete(e):t.add(e);const a=t.size===i.length?void 0:[...t];this._set("areas",a)},n=this._getDiscoveredDevices(),r=e.hidden_devices??[],o=new Map;for(const e of n){const t=e.area??"";o.has(t)||o.set(t,[]),o.get(t).push(e)}const l=[...t.map(e=>e.name)];o.has("")&&l.push("");const c=void 0===s?t.length:s.length,d=this._badge(`${c} / ${t.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=Q`
      <div class="rooms-toolbar">
        <div class="toolbar-group">
          <span class="toolbar-lbl">Sort</span>
          <div class="pill-grp">
            ${["name","power","online"].map(t=>Q`
      ...
      ${e.favorites?.length?(()=>{const t="★ Favourites",i=(e.favorites??[]).map(e=>n.find(t=>t.device_id===e)).filter(Boolean),s=this._expandedRooms.has(t),a=this._expandedRoomStyle.has(t),o=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length),l=e.area_styles?.Favourites??{},c=[l.accentColor,l.tileBgColor,l.headerBgColor,l.bgColor].filter(Boolean);return Q`
            ...
            <div class="room-expanded">
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${c.length?Q`<div class="room-swatch-strip">
                    ${c.map(e=>Q`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:G}
                  ${o&&!c.length?Q`<span class="dev-style-dot"></span>`:G}
                  ${o?Q`<button class="color-reset" style="margin-left:auto"
              ...
              <div class="room-devices">
                ${i.map(t=>{const i=r.includes(t.device_id),s=!!e.device_styles?.[t.device_id],a=this._selectedDeviceId===t.device_id,n=t.area?Q`<span class="fav-dev-area">${t.area}</span>`:G;return Q`
                    <div class="room-device-row ${a?"selected":""}">
                      ${n}
                      <span class="room-device-name" style="color:${i?"var(--t3)":"var(--t2)"};flex:1">${t.name}</span>
                      ${s?Q`<span class="dev-style-dot"></span>`:G}
                      <label class="sw">
      ...
      ${l.map(t=>{const i=t||"No Room",n=o.get(t)??[],l=(e=>void 0===s||s.includes(e))(t),c=this._expandedRooms.has(t),d=this._expandedRoomStyle.has(t),p=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length),u=e.area_styles?.[t]??{},g=[u.accentColor,u.tileBgColor,u.headerBgColor,u.bgColor].filter(Boolean);return Q`
          <div class="room-row">
            <div class="room-dot" style="background:${l?"#4ade80":"var(--t3)"}"></div>
            <span class="room-name" style="color:${l?"var(--text)":"var(--t2)"}">${i}</span>
            ${n.length?Q`<span class="room-count">${n.length}</span>`:G}
            <label class="sw"><input type="checkbox" .checked=${l}
              @change=${()=>a(t)}>
              <span class="sw-t"></span><span class="sw-b"></span></label>
            ${p?Q`<button class="room-reset-btn" title="Set room style to default"
          ...
          ${c?Q`
            <div class="room-expanded">
              ...
              <div class="room-style-subsec">
                <div class="room-style-subsec-hdr" @click=${()=>{const e=new Set(this._expandedRoomStyle);e.has(t)?e.delete(t):e.add(t),this._expandedRoomStyle=e}}>
                  ...
                  ${g.length?Q`<div class="room-swatch-strip">
                    ${g.map(e=>Q`<span class="room-swatch" style="background:${e}"></span>`)}
                  </div>`:G}
                  ${p&&!g.length?Q`<span class="dev-style-dot"></span>`:G}
                  ${p?Q`<button class="color-reset" style="margin-left:auto" @click=${e=>{e.stopPropagation(),this._clearAreaStyle(t)}}>Clear</button>`:G}
              ...
              <!-- Device list -->
              <div class="room-devices">
                ${n.length?n.map(t=>{const i=r.includes(t.device_id),s=!!e.device_styles?.[t.device_id],a=this._selectedDeviceId===t.device_id;return Q`
                    <div class="room-device-row ${a?"selected":""}">
            ...
            </div>`:G}`})}`,u=this._selectedDeviceId,g=u?n.find(e=>e.device_id===u):null,v=u&&g?Q`
      ...
      ${v}`}_setDeviceStyle(e,t){const i={...this._config.device_styles?.[e]??{},...t};void 0===i.color&&delete i.color,void 0===i.tile_layout&&delete i.tile_layout,void 0===i.tile_style&&delete i.tile_style,void 0===i.power_monitor_variant&&delete i.power_monitor_variant,void 0===i.tile_icon&&delete i.tile_icon,void 0===i.tile_icon_off&&delete i.tile_icon_off,void 0===i.tile_icon_speed&&delete i.tile_icon_speed,void 0===i.entity_animations&&delete i.entity_animations,void 0===i.sensors&&delete i.sensors;const s={...this._config.device_styles??{},[e]:i};Object.keys(i).length||delete s[e],this._set("device_styles",Object.keys(s).length?s:void 0)}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=this._config.tile_layout??St.map(e=>e.id),s=t.tile_layout??null,a=t.entity_animations??{},n=t=>{const a=null===s?i.includes(t):s.includes(t),n=St.map(e=>e.id).filter(e=>e===t?!a:null===s?i.includes(e):s.includes(e)),r=n.length===i.length&&n.every(e=>i.includes(e));this._setDeviceStyle(e,{tile_layout:r?void 0:n})},r=(t,i,s)=>{const n={...a[t]??{}};if("speed"===i){const e=Number(s);1===e?delete n.speed:n.speed=e}else"none"===s?delete n[i]:n[i]=s;const r={...a,[t]:n};n.on||n.off||n.speed||delete r[t],this._setDeviceStyle(e,{entity_animations:Object.keys(r).length?r:void 0})},o=this._allDevices().find(t=>t.device_id===e),l=o?We(o):null,c=l?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[l.type]:void 0,d=t.tile_style,p=t.power_monitor_variant??"big-number",u=Q`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
          ${c&&!d?Q`<span class="dev-style-hint">Recommended: ${c}</span>`:G}
          ${d?Q`<button class="color-reset" @click=${()=>this._setDeviceStyle(e,{tile_style:void 0})}>↺ reset</button>`:G}
        </div>
        <div class="ts-style-grid" style="grid-template-columns:repeat(4,minmax(0,1fr))">
          ${[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}].map(t=>Q`
        ...
        ${"power-monitor"===d||!d&&"power-monitor"===c?Q`
          <div class="field-lbl" style="margin-top:8px">Power monitor variant</div>
          <div class="pill-grp">
            ${[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}].map(t=>Q`
              <span class="pill ${p===t.v?"on":""}"
                @click=${()=>this._setDeviceStyle(e,{power_monitor_variant:"big-number"===t.v?void 0:t.v})}>
                ${t.icon} ${t.label}
              </span>`)}
          </div>`:G}
      </div>`,g=o?o.entities.filter(e=>"switch"===e.domain||"light"===e.domain):[];return Q`
      <div class="dev-style-panel">
        ...
        <div class="block-toggles">
          ${St.map(e=>{const t=null===s?i.includes(e.id):s.includes(e.id);return Q`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
              ${t?"👁":"○"} ${e.label}
            </span>`})}
        </div>
        ...
        ${g.length?Q`
          ...
          ${g.map(t=>{const i=this.hass?.states[t.entity_id],s=i?.attributes?.friendly_name??t.entity_id.split(".").pop()??t.entity_id,n=a[t.entity_id]?.on??"none",o=a[t.entity_id]?.off??"none",l=a[t.entity_id]?.speed??1;return Q`
      ...
      </div>`}_renderRoomStylePanel(e){const t=this._config.area_styles?.[e]??{},i=(i,s,a)=>{const n=t[s]??a;return Q`
        <div class="color-row">
          ...
          ${t[s]?Q`<button class="color-reset" @click=${()=>this._setAreaStyle(e,s,void 0)}>↺</button>`:G}
        </div>`},s=(i,s,a,n,r,o,l)=>{const c=t[s]??o;return Q`
        <div class="sl-row">
          <span class="color-key">${i}</span>
      ...
      <div class="rsp-panel">
        ...
        <div class="ts-style-grid">
          ${[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Value"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Button"}].map(i=>{const s=t.tile_style??"default";return Q`
        ...
        ${"power-monitor"===t.tile_style?Q`
          <div class="pill-grp" style="margin-top:6px">
            ${[{v:"big-number",label:"▲ Number"},{v:"gauge",label:"◉ Gauge"},{v:"graph",label:"∿ Graph"},{v:"compact",label:"⊟ Compact"},{v:"table",label:"≡ Table"}].map(i=>Q`
        ...
        ${(()=>{const i=t.buttonShape??"pill",s=t.buttonVariant??"fill",a=t.buttonSize??"md",n="square"===i||"circle"===i,r="pill"===i?"20px":"rect"===i||"square"===i?"6px":"50%",o=n?"sm"===a?"3px 5px":"lg"===a?"6px 12px":"4px 8px":"sm"===a?"2px 8px":"lg"===a?"6px 16px":"4px 12px",l="sm"===a?"10px":"lg"===a?"13px":"11px",c=n?"1":"auto",d=t.accentColor??"var(--accent)",p="outline"===s?`background:transparent;color:${d};border:1px solid ${d};box-shadow:none`:"ghost"===s?`background:transparent;color:${d};border:none;box-shadow:none`:`background:${d};color:white;border:none`,u=`border-radius:${r};padding:${o};font-size:${l};aspect-ratio:${c};display:inline-flex;align-items:center;justify-content:center;cursor:default;`,g=t.buttonShape||t.buttonVariant||t.buttonSize;return Q`
            <div class="btn-preview">
              ...
              ${g?Q`<button class="color-reset" style="margin-left:auto" @click=${()=>{this._setAreaStyle(e,"buttonShape",void 0),this._setAreaStyle(e,"buttonVariant",void 0),this._setAreaStyle(e,"buttonSize",void 0)}}>↺ Reset</button>`:G}
            </div>
            <div class="field">
      ...
      ${e.map((n,r)=>this._renderViewCard(n,r,e.length,t,i,s,a))}
    `}_renderViewCard(e,t,i,s,a,n,r){const o=this._expandedViewId===e.id,l=e.filter??{},c=new Set(l.devices??[]),d=new Set(l.exclude_devices??[]),p=this._countViewMatches(e),u=r.length,g=(t,i)=>this._updateView(e.id,{[t]:i});return Q`
      <div class="view-card ${o?"expanded":""}">
        <div class="view-card-hdr" @click=${()=>this._expandedViewId=o?null:e.id}>
          ...
          <span class="view-card-count" title="Devices matching this view's filter">${p}/${u}</span>
          ...
          <span class="view-card-chev">${o?"▲":"▼"}</span>
        </div>
        ...
        ${o?Q`
          <div class="view-card-body">
            ...
            <div class="field">
              ...
              <div class="pill-grp">
                ${s.map(t=>Q`
                  <span class="pill ${(l.profiles??[]).includes(t)?"on":""}"
            ...
            <div class="field">
              ...
              <div class="pill-grp">
                ${a.map(t=>Q`
                  <span class="pill ${(l.domains??[]).includes(t)?"on":""}"
            ...
            ${n.length?Q`
              <div class="field">
                ...
                <div class="pill-grp">
                  ${n.map(t=>Q`
                    <span class="pill ${(l.areas??[]).includes(t.name)?"on":""}"
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?Q`<button class="color-reset" @click=${()=>g("columns",void 0)}>↺</button>`:G}
            </div>
      ...
      </div>`}_renderLayoutTab(){const e=this._config,t=Q`
      <div class="field">
      ...
      </div>`,i=this._config.style?.accent_color??"#f4601e",s=this._dragOrder.filter(e=>!this._hiddenBlocks.has(e)),a=Q`
      <div class="tile-preview-live">
        ${s.length?s.map(e=>{switch(e){case"name_row":return Q`<div class="tp-row tp-name-row"><div class="tp-dot" style="background:#4ade80"></div><span class="tp-name">Ljós yfir vaska</span><span class="tp-tog" style="background:${i}">ON</span></div>`;case"sensors":return Q`<div class="tp-row tp-chips"><span class="tp-chip">4.1 W</span><span class="tp-chip">235 V</span><span class="tp-chip">44.6 °C</span><span class="tp-chip">−54 dBm</span></div>`;case"graph":return Q`<div class="tp-row"><svg viewBox="0 0 200 28" preserveAspectRatio="none" style="width:100%;height:28px;display:block"><polygon points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5 200,28 0,28" fill="${i}" fill-opacity="0.15"/><polyline points="0,24 25,20 50,22 75,15 100,17 125,11 150,13 175,7 200,5" fill="none" stroke="${i}" stroke-width="1.5" stroke-linecap="round"/></svg></div>`;case"dimmer":return Q`<div class="tp-row" style="gap:8px"><span class="tp-lbl">Brightness</span><div class="tp-strack"><div class="tp-sfill" style="width:68%;background:${i}"></div></div><span class="tp-val">68%</span></div>`;case"cover_controls":return Q`<div class="tp-row" style="gap:4px"><button class="tp-btn">▲</button><button class="tp-btn">■</button><button class="tp-btn">▼</button></div>`;case"trv_control":return Q`<div class="tp-row" style="gap:8px"><svg viewBox="0 0 80 44" style="width:60px;height:34px;flex-shrink:0"><path d="M 8 40 A 32 32 0 1 1 72 40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="6" stroke-linecap="round"/><path d="M 8 40 A 32 32 0 0 1 52 10" fill="none" stroke="${i}" stroke-width="6" stroke-linecap="round"/><text x="40" y="34" text-anchor="middle" font-size="11" font-weight="700" fill="white">21°</text></svg><span class="tp-val">Now 20°</span></div>`;case"valve_controls":return Q`<div class="tp-row" style="gap:4px"><button class="tp-btn">Open</button><button class="tp-btn">Close</button></div>`;case"input_channels":return Q`<div class="tp-row tp-chips"><span class="tp-chip" style="color:${i}">● CH1</span><span class="tp-chip">○ CH2</span></div>`;case"relay_channels":return Q`<div class="tp-row tp-chips"><span class="tp-chip" style="background:${i}20;color:${i}">CH1 ON</span><span class="tp-chip">CH2 OFF</span></div>`;case"power_bar":return Q`<div class="tp-row" style="gap:8px"><div class="tp-strack" style="flex:1"><div class="tp-sfill" style="width:22%;background:${i}"></div></div><span class="tp-val">4.1 W</span></div>`;case"virtual_controls":return Q`<div class="tp-row tp-chips"><span class="tp-chip">Mode ▾</span><span class="tp-chip" style="background:${i}20;color:${i}">Script</span></div>`;case"badges":return Q`<div class="tp-row tp-chips"><span class="tp-chip" style="background:rgba(234,179,8,.18);color:#fde047">Dimmer</span><span class="tp-chip" style="background:rgba(34,197,94,.18);color:#86efac">G3</span></div>`;default:return G}}):Q`<div style="color:var(--t3);font-size:11px;padding:8px;text-align:center">All blocks hidden</div>`}
      </div>
      <div class="field-lbl" style="margin:10px 0 6px">Drag to reorder · 👁 to hide</div>
      <div class="drag-list">
        ${this._dragOrder.map(e=>{const t=St.find(t=>t.id===e);if(!t)return G;const i=this._hiddenBlocks.has(e),s=this._dragOver===e;return Q`
      ...
      ${this._sec("tileorder","↕","rgba(244,96,30,0.12)","#f4601e","Tile Block Order",Q`<span class="tag-new">Drag</span>`,a)}`}_renderStyleTab(){const e=this._config,t=e.style??{},i=(e,i)=>this._set("style",{...t,[e]:i}),s=e=>{const i={...t};delete i[e],this._set("style",i)},a=(e,a,n)=>{const r=t[a]??n;return Q`
        <div class="color-row">
          ...
          ${t[a]?Q`<button class="color-reset" @click=${()=>s(a)}>↺</button>`:G}
        </div>`},n=Q`
      <!-- Title -->
      <div class="field">
      ...
      ${!1!==e.header_show_stats?Q`
        <div class="field" style="margin:6px 0 2px">
          <div class="field-lbl" style="display:flex;align-items:center;gap:8px">
            Header chips
            ${e.header_chips?Q`<button class="color-reset" @click=${()=>this._set("header_chips",void 0)}>↺ Default</button>`:G}
          </div>
          <div class="pill-grp">
            ${rt.map(t=>{const i=e.header_chips??ot,s=i.includes(t.key);return Q`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],a=e.length===ot.length&&ot.every(t=>e.includes(t));this._set("header_chips",a?void 0:e)}}>${t.label}</span>`})}
          </div>
      ...
      ${r("Power reading","power_color","#fb923c")}`,l=t.font_family??"",c=Q`
      <div class="field">
      ...
      </div>`,d=e.card_opacity??100,p=e.tile_opacity??100,u=Q`
      <div class="field">
        <div class="field-lbl">Tile size</div>
        <div class="pill-grp">
          ${["sm","md","lg"].map((t,i)=>Q`
      ...
      <div class="field">
        ...
        <div class="bg-img-row">
          ...
          ${e.card_bg_image?Q`<button class="color-reset" @click=${()=>{const e={...this._config};delete e.card_bg_image,delete e.card_bg_image_size,this._emitNow(e)}}>↺</button>`:G}
        </div>
        ${e.card_bg_image?Q`
      ...
      <div class="field">
        ...
        <div class="bg-img-row">
          ...
          ${t.tile_bg_image?Q`<button class="color-reset" @click=${()=>{const e={...t};delete e.tile_bg_image,delete e.tile_bg_image_size,this._set("style",Object.keys(e).length?e:void 0)}}>↺</button>`:G}
        </div>
        ${t.tile_bg_image?Q`
          <div class="field-lbl" style="margin-top:6px">Image fit</div>
          <div class="pill-grp">
        ...
        `:G}
      </div>`;this._getAreas();const g=t.accent_color??"#f4601e",v=t.card_bg??"#1c1c1e",h=t.tile_bg??"#1c1c1e",f=t.tile_border??"#2a2a30",b=t.tile_hover_bg??"rgba(255,255,255,0.07)",m=t.tile_sensor_bg??"rgba(255,255,255,0.04)",x=t.text_primary??"#e5e7eb",y=t.text_secondary??"#9ca3af",w=t.text_muted??"#6b7280",k=t.online_color??"#4ade80",A=t.offline_color??"#ef4444";t.power_color;const C=t.header_bg??"#1a1a2e",S=t.header_bg2??"#0f3460",z=t.header_text_color??"#ffffff",I=t.header_orb_color??"#3b82f6",M=t.header_title_size??1.1,O=t.header_padding??16,B=t.header_border_width??0,T=t.header_border_color??"#4ade80",E=t.header_stat_online??"#4ade80",R=t.header_stat_power??"#fb923c",D=t.font_family?`'${t.font_family}', sans-serif`:"inherit",F=t.text_size_scale??1,P=t.tile_radius??12,L=t.tile_border_width??1,U=t.header_radius??0,N=B>0?`${B}px solid ${T}`:"none",j=Q`
      ...
      <div class="style-toolbar">
        ...
        ${this._styleClipFeedback?Q`<span class="clip-feedback">${this._styleClipFeedback}</span>`:G}
      </div>
      ${this._copyAreaOpen?Q`
      ...
      ${j}
      ${this._sec("header","◈","rgba(99,102,241,0.1)","#818cf8","Header",G,n)}
      ${this._sec("colors","◐","rgba(244,96,30,0.12)","#f4601e","Colors",G,o)}
      ${this._sec("tiles","⊡","rgba(45,212,191,0.1)","#2dd4bf","Tiles",G,u)}
      ${this._sec("typography","T","rgba(251,191,36,0.1)","#fbbf24","Typography",G,c)}`}_renderGraphsTab(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},a=Q`
      <div class="field">
      ...
      </div>`,n=e.graph_sensors??[],r=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],o=(e,t,i)=>{const a=s[e]??i,n=!!s[e];return Q`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${a}"></div>
          <span class="color-key">${t}</span>
          <input type="color" .value=${a}
            @input=${t=>{const i=t.target.value;this._set("graph_sensor_colors",{...s,[e]:i})}}/>
          ${n?Q`<button class="color-reset" @click=${()=>{const t={...s};delete t[e],this._set("graph_sensor_colors",Object.keys(t).length?t:void 0)}}>↺</button>`:G}
        </div>`},l=Q`
      <div class="field-lbl" style="margin-bottom:6px">Gauge ring colours</div>
      ${r.map(e=>o(e.key,e.label,e.default))}
      ${n.filter(e=>!r.find(t=>t.key===e)).length?Q`
        <div class="field-lbl" style="margin:10px 0 6px">Sparkline colours</div>
        ${n.filter(e=>!r.find(t=>t.key===e)).map(e=>{const t=Ct.find(t=>t.key===e);return o(e,t?.label??e,(e=>s[e]??Ct.find(t=>t.key===e)?.color??"#f4601e")(e))})}`:G}
      ...
      </div>`,c=t.sensor_ranges??{},d=(e,i,s)=>{const a=""===s.trim()?void 0:parseFloat(s),n={...c[e]??{}};void 0===a||isNaN(a)?delete n[i]:n[i]=a;const r={...c,[e]:n};n.min||0===n.min||n.max||0===n.max||delete r[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(r).length?r:void 0})},p=Q`
      ...
      ${this._sec("graphranges","⇕","rgba(251,191,36,0.1)","#fbbf24","Sensor Min / Max",Object.keys(c).length?this._badge(`${Object.keys(c).length} set`,"#fbbf24","rgba(251,191,36,0.1)"):G,p)}`}_renderSensorsTab(){const e=this._config,t=e.sensors??[];return Q`
      ...
      ${At.map(i=>{const s=i.items.map(e=>e.key),a=s.filter(e=>t.includes(e)).length,n=s.every(e=>t.includes(e)),r=this._badge(`${a||"All"} / ${i.items.length}`,i.iconColor,i.iconBg),o=Q`
          ...
          <div class="sensor-grid">
            ${i.items.map(i=>{const s=t.includes(i.key),a=!!Ct.find(e=>e.key===i.key),n=e.graph_sensors??[],r=n.includes(i.key);return Q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  <div class="sensor-item-body">
                    ...
                    ${i.unit?Q`<span class="sensor-unit">${i.unit}</span>`:G}
                  </div>
                  ${a?Q`<button class="sensor-graph-btn ${r?"on":""}"
                    title="${r?"Remove from graphs":"Add to graphs"}"
                    @click=${e=>{e.stopPropagation();const t=r?n.filter(e=>e!==i.key):[...n,i.key];this._set("graph_sensors",t)}}>∿</button>`:G}
                </div>`})}
      ...
      <pre class="yaml-out">${i}</pre>`}render(){if(!this._config)return Q``;this._config;const e={devices:["rooms"],views:[],layout:["grid","tileorder","header","colors","tiles","typography"],graphs:["graphtype","graphcolors","graphranges","electrical","environmental","deviceinfo","alerts"],yaml:[]},t=t=>{const i=e[this._tab];if(!i.length)return;const s={...this._openSections};for(const e of i)s[e]=t;this._openSections=s},i=e[this._tab].length>1;return Q`
      <div class="shell">
        <div class="tab-nav">
          ${[{id:"devices",label:"Rooms & devices",icon:"⌂"},{id:"views",label:"Views",icon:"☰"},{id:"layout",label:"Layout & Style",icon:"⊡"},{id:"graphs",label:"Graphs & Sensors",icon:"∿"},{id:"yaml",label:"YAML",icon:"</>"}].map(e=>Q`
        ...
        <div class="tab-body">
          ${"devices"===this._tab?this._renderDevicesTab():"views"===this._tab?this._renderViewsTab():"layout"===this._tab?Q`${this._renderLayoutTab()}${this._renderStyleTab()}`:"graphs"===this._tab?Q`${this._renderGraphsTab()}${this._renderSensorsTab()}`:this._renderYamlTab()}
        </div>
