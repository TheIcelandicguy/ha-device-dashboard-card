...
`,ot=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];function at(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),r=o.filter(i=>null==e.getInputActionLabel(t,i)),n=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=r.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${qt(r.uptime)}</span>`:Z}
        </div>
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=n.power?f("Power",Nt(n.power),!0):Z}
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,r):Z}
    </div>`}(e)}}const xi=140,wi=70;function ki(e){const{device:t,isOn:i,accent:s,online:o,hass:a,profile:r}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return q`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==r.type&&"rgb"!==r.type)return q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      `:q``}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=ft(i);return e.length?q`
        ...
        <div class="tile-bot">
          ${null!=g?q`<span class="tile-power">${Nt(g)}</span>`:Z}
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=r.rssi?q`<div class="ds-signal">Wi-Fi: ${Gt(r.rssi)} (${r.rssi} dBm)${null!=r.uptime?q` · Up ${qt(r.uptime)}`:Z}</div>`:Z}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,r=o?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?Z:q`<span class="ds-channel-power">${Nt(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?q`<span class="ds-big-power">${Nt(s.power)}</span>`:Z}
    </div>
    ...
    ${zi(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Ai*100);return q`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${Nt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Z}
    ...
    `:Z;return p.length||g||o||a||r||S.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${r}" style=${_e(l)}
          ...
          ${De(t,e=>e.join("+"),e=>1===e.length?_i(a,e[0]):q`<div class="tile-row">${e.map(e=>_i(a,e))}</div>`)}
        </div>`}const b=e.area??"",y=this._tileAccent(e,b);return q`<div class="${`tile tile-${r} ${i?"":"offline"} tile--clickable`}" style=${_e(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?yi(this._buildTileCtx(e,s,y),m):"light-control"===v?ki(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return Ge(t,s,"ts-climate","No climate entity");const r="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(o.states[n.entity_id]?.state??"")||null;return q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${o>0?q`<span class="fav-chip fav-chip-power">${Nt(o)}</span>`:Z}
          </div>
        </div>
      ...
      </div>`}_getAreaChips(e,t){const i=t?this._areaHeaderOverride.get(t):void 0,s=t?this._config.area_styles?.[t]?.header_chips:void 0,o=void 0!==i?new Set(i):void 0!==s?new Set(s):new Set(li),a=e=>o.has(e),r={},n=(e,t)=>{r[e]||(r[e]={sum:0,count:0}),r[e].sum+=t,r[e].count++};for(const t of e)for(const e of t.entities){if("sensor"!==e.domain)continue;const t=this.hass.states[e.entity_id];if(!t||"unavailable"===t.state||"unknown"===t.state)continue;const i=parseFloat(t.state);if(isNaN(i))continue;const s=t.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&a(o.key)&&n(o.key,i)}const l=(t?this._config.area_styles?.[t]?.energy_period:void 0)??this._config.energy_period??"total",c=[];for(const t of ni){if("energy"===t.key&&a("energy")&&"total"!==l){let i=0,s=!1,o=!1;for(const t of e)for(const e of this._energyEntitiesFor(t)){const t=this._periodEnergyValue(e,l);t.failed?o=!0:null!=t.kwh&&(i+=t.kwh,s=!0)}if(o){r.energy&&c.push({label:t.label,value:this._formatAreaChip("energy",r.energy.sum)});continue}if(s||r.energy){const e="today"===l?"Today":"week"===l?"Week":"Month";c.push({label:e,value:s?jt(i):"…"})}continue}const i=r[t.key];if(!i)continue;const s="sum"===t.agg?i.sum:i.sum/i.count;c.push({label:t.label,value:this._formatAreaChip(t.key,s)})}return c}_formatAreaChip(e,t){switch(e){case"power":return Nt(t);case"energy":return jt(t);case"voltage":return Ht(t);case"current":return Ut(t);case"temperature":return Wt(t);case"humidity":return Qt(t);case"co2":return Kt(t);case"illuminance":return Yt(t);case"battery":return Jt(t);case"rssi":return`${Math.round(t)} dBm`;default:return String(Math.round(t))}}_areaHeaderCandidates(e,t){const i=this._areaChipsPresent(e),s=this._areaHeaderOverride.get(t),o=this._config.area_styles?.[t]?.header_chips,a=void 0!==s?new Set(s):void 0!==o?new Set(o):new Set(li),r=[];for(const e of ni)i.has(e.key)&&r.push({key:e.key,label:e.label,visible:a.has(e.key)});return r}_areaChipsPresent(e){const t=new Set;for(const i of e)for(const e of i.entities){if("sensor"!==e.domain)continue;const i=this.hass.states[e.entity_id];if(!i)continue;const s=i.attributes.device_class??"",o=ni.find(t=>t.dc===s||"rssi"===t.key&&("signal_strength"===s||e.entity_id.includes("_rssi")));o&&t.add(o.key)}return t}_renderAreaHeaderCustomize(e,t){const i=this._areaHeaderCandidates(t,e),s=this._areaHeaderOverride.has(e)||void 0!==this._config.area_styles?.[e]?.header_chips,o=(t,s)=>{const o=new Set(i.filter(e=>e.visible).map(e=>e.key));s?o.add(t):o.delete(t),this._setAreaHeaderChips(e,i.map(e=>e.key).filter(e=>o.has(e)))};return q`
    ...
    `],e([ve({attribute:!1})],Oi.prototype,"hass",void 0),e([ve({type:Boolean})],Oi.prototype,"preview",void 0),e([fe()],Oi.prototype,"_config",void 0),e([fe()],Oi.prototype,"_closedAreas",void 0),e([fe()],Oi.prototype,"_entityListOpen",void 0),e([fe()],Oi.prototype,"_graphData",void 0),e([fe()],Oi.prototype,"_periodEnergy",void 0),e([fe()],Oi.prototype,"_periodEnergyErrAt",void 0),e([fe()],Oi.prototype,"_valveDragPos",void 0),e([fe()],Oi.prototype,"_trvDragTemp",void 0),e([fe()],Oi.prototype,"_cloudDetailOpen",void 0),e([fe()],Oi.prototype,"_detailDevice",void 0),e([fe()],Oi.prototype,"_detailHistoryRange",void 0),e([fe()],Oi.prototype,"_activeViewId",void 0),e([fe()],Oi.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Oi.prototype,"_tileBlockOverride",void 0),e([fe()],Oi.prototype,"_tileChipOverride",void 0),e([fe()],Oi.prototype,"_areaHeaderOverride",void 0),e([fe()],Oi.prototype,"_tileShowGraphsOverride",void 0),e([fe()],Oi.prototype,"_areaCustomizeOpen",void 0),Oi=Ei=e([he("ha-device-dashboard")],Oi);const Di=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Di(e,t);return!0},Ri=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Bi=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Li(t)}};function Pi(e){void 0!==this._$AN?(Ri(this),this._$AM=e,Bi(this)):this._$AM=e}function Fi(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Di(s[e],!1),Ri(s[e]);else null!=s&&(Di(s,!1),Ri(s));else Di(this,e)}const Li=e=>{e.type==be&&(e._$AP??=Fi,e._$AQ??=Pi)};class $i extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Bi(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Di(this,e),Ri(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const Ni=new WeakMap,ji=ye(class extends $i{render(e){return Z}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Z}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=Ni.get(t);void 0===i&&(i=new WeakMap,Ni.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?Ni.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Hi=ye(class extends xe{constructor(){super(...arguments),this.key=Z}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ie(e),this.key=t),i}}),Ui=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"extra-cards",label:"Extra cards"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[{id:"device-panel",label:"Per-device style panel"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0},{id:"room-panel",label:"Per-room style panel"}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var Wi;const qi=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let Gi=!1;const Vi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Zi=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, media, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Xi=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Qi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Yi=Wi=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._xcPlacement="header",this._xcRoom="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._devPanelAll=!1,this._conflictsOpen=!1,this._localTweaksCleared=null,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._deviceSearch="",this._styleClipFeedback="",this._openDiscDropdown=null,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;t?.tab&&t.section&&t.flash&&this._gotoControl(t.tab,t.section,t.flash)},this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++}setConfig(e){this._config=oi(e),this._loadAdvanced(),this._loadSavedTheme()}_stepTab(e){const t=Ui.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1,this._openSections={...this._openSections,[t]:!0},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_snapshotKey(){return`shelly-dashboard:cardSnapshots:${this._config?.title??"default"}`}_loadSnapshots(){try{const e=localStorage.getItem(this._snapshotKey());this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(this._snapshotKey(),JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(oi(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </span>`}_chipPicker(e,t,i,s,o){const a=t??[],r=void 0!==e,n=t=>!o||o.has(t)||(e??[]).includes(t),l=Vi.map(e=>({...e,items:e.items.filter(e=>n(e.key))})).filter(e=>e.items.length),c=Vi.flatMap(e=>e.items.map(e=>e.key)).filter(n),d=new Set(r?e:a.length?a:c);return q`
      ...
      <div class="field" style="margin-bottom:4px">
        ...
        <div class="pill-grp">
          ${o.map(t=>{const i=a.includes(t.key);return q`<span class="pill ${i?"on":""}" @click=${()=>{const s=i?a.filter(e=>e!==t.key):[...a,t.key];var o;this._setAreaStyle(e,"header_chips",(o=s).length===li.length&&li.every(e=>o.includes(e))?void 0:s)}}>${t.label}</span>`})}
        </div>
    ...
    `}_renderViewCard(e,t,i,s,o,a,r,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,r,n),g=r.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return q`
      ...
      ${!1!==e.header_show_stats?q`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${ai.map(t=>{const i=e.header_chips??ri,s=i.includes(t.key);return q`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],o=e.length===ri.length&&ri.every(t=>e.includes(t));this._set("header_chips",o?void 0:e)}}>${t.label}</span>`})}
          </div>
    ...
    `,u=q`
      ...
      ${a.filter(e=>!r.find(t=>t.key===e)).length?q`
        ...
        ${a.filter(e=>!r.find(t=>t.key===e)).map(e=>{const t=ei.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??ei.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Z}
      <div class="field" style="margin-top:10px">
        ...
        <div class="pill-grp">
          ${ei.map(e=>{const t=a.some(t=>si(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>si(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=si(i.key),a=!!ei.find(e=>e.key===o),r=e.graph_sensors??Et,n=r.some(e=>si(e)===o);return q`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${a?q`<button class="sensor-graph-btn ${n?"on":""}"
                    ...
                    @click=${e=>{e.stopPropagation();const t=n?r.filter(e=>si(e)!==o):[...r,o];this._set("graph_sensors",t)}}>∿</button>`:Z}
                </div>`})}
