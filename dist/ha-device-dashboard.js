...
`,bt=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"},{value:"display",label:"Flicker",group:"🖥️"},{value:"display2",label:"Scanline",group:"🖥️"},{value:"display3",label:"Wake",group:"🖥️"},{value:"oven",label:"Oven",group:"🍳"},{value:"washer",label:"Washer",group:"🫧"},{value:"washer2",label:"Tumble",group:"🫧"},{value:"dishwasher",label:"Dishes",group:"🫧"},{value:"floorheat",label:"Floor heat",group:"♨️"},{value:"radiator",label:"Radiator",group:"♨️"},{value:"valve",label:"Valve",group:"🚰"},{value:"smoke",label:"Smoke det.",group:"🚨"},{value:"camera",label:"Camera",group:"📷"},{value:"strip",label:"LED strip",group:"🌈"},{value:"strip2",label:"Rainbow",group:"🌈"},{value:"plug",label:"Plug",group:"🔌"},{value:"garage",label:"Garage",group:"🚗"},{value:"ble",label:"Bluetooth",group:"📡"},{value:"router",label:"Router",group:"📡"},{value:"pc",label:"PC",group:"💻"}];function yt(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    </div>`}const wt=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function xt(e,t,i,s){return{entity_id:e,domain:e.split(".")[0],state:i?.state??"unavailable",attributes:i?.attributes??{},device_id:t?.device_id,area_id:t?.area_id,platform:t?.platform?String(t.platform).toLowerCase():void 0,entity_category:t?.entity_category??void 0,...s}}function _t(e,t={},i){const s=!0===t.universal,o=s?new Set((t.includeIntegrations??[]).map(e=>e.toLowerCase())):null,a=s?new Set([...At,...t.excludeIntegrations??[]].map(e=>e.toLowerCase())):null,n=s&&t.includeDomains?.length?new Set(t.includeDomains):null,r=s?new Set(t.excludeDomains??[]):null,l=e.entities??{},c=e.devices??{},d=e.areas??{},p=new Map,h=new Map,u=new Map,g=new Set,v=(e,t,i)=>{h.has(e)||(h.set(e,t),i&&u.set(e,i))};for(const[t,i]of Object.entries(l)){if(!i?.device_id)continue;if(i.hidden_by)continue;const l=t.split(".")[0];if(!wt.has(l))continue;if(r?.has(l)){v(i.device_id,"domain");continue}if(n&&!n.has(l)){v(i.device_id,"domain");continue}const h=(i.platform??"").toLowerCase();if(!s&&"shelly"!==h&&"bthome"!==h){v(i.device_id,"shelly");continue}if(a?.has(h)&&!o?.has(h)){v(i.device_id,"integration",h);continue}const u=i.device_id;if(!p.has(u)){const e=c[u];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),o=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===h;if(!s&&"bthome"===h&&!o){v(u,"shelly");continue}const a=e.area_id??i.area_id,n=a?d[a]?.name:void 0;g.add(u),p.set(u,{device_id:u,name:e.name_by_user??e.name??u,area:n,model:null==e.model?void 0:String(e.model),model_id:null==e.model_id?void 0:String(e.model_id),hw_version:null==e.hw_version?void 0:String(e.hw_version),sw_version:null==e.sw_version?void 0:String(e.sw_version),ip:t?t[1]:void 0,isShelly:o,integration:h,labels:Array.isArray(e.labels)?[...e.labels]:void 0,entities:[]})}const f=p.get(u);"shelly"===h&&(f.isShelly=!0,f.integration="shelly"),f.entities.push(xt(t,i,e.states[t]))}const f=new Set;for(const[e,t]of p){if(f.has(e))continue;const i=c[e],s=i?.via_device_id;if(!s||!p.has(s)||f.has(s))continue;const o=c[s],a=i?.configuration_url??"",n=o?.configuration_url??"",r=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},l=a&&n&&r(a)===r(n),d=!a&&n&&t.isShelly&&t.integration===p.get(s).integration;if(!l&&!d)continue;const h=p.get(s);h.entities.push(...t.entities),!h.ip&&t.ip&&(h.ip=t.ip),!h.model&&t.model&&(h.model=t.model),f.add(e)}for(const e of f)p.delete(e);const m=e=>{const t=[];for(const[i,s]of e?.connections??[])"mac"===i&&s&&t.push(`mac:${s.toLowerCase()}`);for(const[i,s]of e?.identifiers??[])i&&s&&t.push(`id:${i}:${String(s).toLowerCase()}`);return t},b=new Map;for(const e of p.keys())for(const t of m(c[e]))b.has(t)||b.set(t,[]),b.get(t).push(e);const y=new Map,w=e=>{let t=e;for(let e=0;y.has(t)&&e<8;e++)t=y.get(t);return t},x=e=>(e.ip?4:0)+("shelly"===e.integration?2:0);for(const e of b.values()){if(e.length<2)continue;const t=[...new Set(e.map(w))].filter(e=>p.has(e));if(t.length<2)continue;const i=t.reduce((e,t)=>{const i=p.get(t),s=p.get(e);return x(i)!==x(s)?x(i)>x(s)?t:e:i.entities.length>s.entities.length?t:e}),s=p.get(i);for(const e of t){if(e===i)continue;const t=p.get(e);s.entities.push(...t.entities),!s.ip&&t.ip&&(s.ip=t.ip),!s.model&&t.model&&(s.model=t.model),!s.area&&t.area&&(s.area=t.area),t.isShelly&&(s.isShelly=!0),t.labels?.length&&(s.labels=[...new Set([...s.labels??[],...t.labels])]),y.set(e,i),p.delete(e)}}let _=Array.from(p.values()).filter(e=>e.entities.length>0);const k=_.length;if(s&&(_=_.filter(e=>function(e,t){return"all"===t||(!!Mt(e)||"devices"===t&&Dt(e))}(e,t.scope??"devices"))),i){const e=new Map;i.notShelly=i.byIntegration=i.byDomain=0;for(const[t,s]of h)if(!g.has(t))if("shelly"===s)i.notShelly++;else if("domain"===s)i.byDomain++;else{i.byIntegration++;const s=u.get(t);s&&e.set(s,(e.get(s)??0)+1)}i.byScope=k-_.length,i.integrations=[...e.entries()].sort((e,t)=>t[1]-e[1]).map(([e])=>e)}return _.sort((e,t)=>e.name.localeCompare(t.name))}function kt(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const At=new Set(["mobile_app","browser_mod","hassio","systemmonitor","backup","sun","nws","netgear","tplink_router","huawei_lte","huawei_ont","asuswrt","fritzbox_tools","fritz"]),St=[...wt].sort(),Ct=new Set(["switch","light","cover","climate","lock","media_player","fan","valve","vacuum","siren","humidifier","water_heater","lawn_mower","alarm_control_panel"]),$t=new Set(["temperature","humidity","illuminance","carbon_dioxide","gas","battery","power","energy","voltage","current","apparent_power","reactive_power","power_factor","pressure","moisture","motion","door","window","opening","smoke","vibration","occupancy"]),Et=new Set(["switch","light","cover","climate","valve","media_player"]),Tt={media_player:[{type:"media-player-playback"},{type:"media-player-volume-slider"}],lock:[{type:"lock-commands"}],fan:[{type:"fan-speed"}],vacuum:[{type:"vacuum-commands"}],humidifier:[{type:"humidifier-toggle"},{type:"humidifier-modes"}],water_heater:[{type:"water-heater-operation-modes"}],lawn_mower:[{type:"lawn-mower-commands"}],siren:[{type:"toggle"}],alarm_control_panel:[{type:"alarm-modes"}]};function It(e){return e.entities.filter(e=>"primary"===kt(e)&&!Et.has(e.domain)&&e.domain in Tt)}const Mt=e=>e.entities.some(e=>"primary"===kt(e)&&Ct.has(e.domain)),Dt=e=>e.entities.some(e=>"primary"===kt(e)&&("sensor"===e.domain||"binary_sensor"===e.domain)&&$t.has(e.attributes?.device_class??""));const Ot={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",lock:"Lock",media:"Media",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},zt=Object.keys(Ot),Pt={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"input-control"};function Rt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:Pt[e]}const Bt={default:[{id:"toggle",label:"On/off button"}],"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Graphs (spark + sensor rows)"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"header_chips",label:"Chips in the name row",def:!1},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"toggle",label:"On/off button"},{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"},{id:"position_slider",label:"Position slider (covers that report one)"},{id:"graphs",label:"Sensor graphs (with Show graphs)"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graphs"},{id:"secondary",label:"Secondary chips"},{id:"header_chips",label:"Chips in the name row",def:!1}],"input-control":[{id:"name",label:"Name"},{id:"keypad",label:"Channel keys"},{id:"input_rows",label:"Unassigned channel rows"},{id:"target_state",label:"Channel name under the key"},{id:"last_event",label:"Last-pressed time"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function Lt(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}const Ft={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","delegated_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","delegated_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","delegated_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","delegated_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","delegated_controls","badges"],lock:["name_row","sensors","virtual_controls","delegated_controls","badges"],media:["name_row","media_controls","sensors","virtual_controls","delegated_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","delegated_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","delegated_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","delegated_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","media_controls","virtual_controls","delegated_controls","badges"],generic:["name_row","sensors","virtual_controls","delegated_controls","badges"]},Nt=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const jt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],lock:["battery"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},Ht=["power","temperature","humidity","battery"];function Ut(e,t){const i={},s=s=>{for(const o of e.entities){if("sensor"!==o.domain||!!o.entity_category!==s)continue;const e=t[o.entity_id];if(!e||"unavailable"===e.state||"unknown"===e.state)continue;const a=e.attributes?.device_class??o.attributes?.device_class;if(!a||a in i)continue;const n=parseFloat(e.state??"");isNaN(n)||(i[a]={value:n,diagnostic:s})}};return s(!1),s(!0),i}const Wt=[{key:"power",label:"W",min:0,max:3e3,digits:0},{key:"voltage",label:"V",min:0,max:250,digits:0},{key:"current",label:"A",min:0,max:16,digits:2},{key:"temperature",label:"°C",min:-10,max:40,digits:1,stops:["#38bdf8","#fde047","#f87171"],diag:{min:0,max:100}},{key:"humidity",label:"%",min:0,max:100,digits:0,stops:["#fde68a","#2dd4bf","#0ea5e9"]},{key:"illuminance",label:"lx",min:0,max:2e3,digits:0,stops:["#94a3b8","#fde047","#fffbeb"]},{key:"carbon_dioxide",label:"ppm",min:400,max:2e3,digits:0,stops:["#4ade80","#fde047","#f87171"]},{key:"battery",label:"%",min:0,max:100,digits:0,stops:["#f87171","#fde047","#4ade80"]}];function qt(e){const t=(e??"").trim();if(!t)return null;const i=/^#([0-9a-f]{3,8})$/i.exec(t);if(i){const e=i[1],t=e=>e+e;return 3===e.length||4===e.length?{hex:"#"+[...e.slice(0,3)].map(t).join(""),alpha:4===e.length?parseInt(t(e[3]),16)/255:1}:6===e.length||8===e.length?{hex:"#"+e.slice(0,6).toLowerCase(),alpha:8===e.length?parseInt(e.slice(6,8),16)/255:1}:null}const s=/^rgba?\(([^)]+)\)$/i.exec(t);if(s){const e=s[1].split(/[,\s/]+/).filter(Boolean);if(e.length<3)return null;const t=e.slice(0,3).map(e=>{const t=e.endsWith("%")?parseFloat(e)/100*255:parseFloat(e);return Math.max(0,Math.min(255,Math.round(t)))});if(t.some(isNaN))return null;const i=e[3],o=void 0===i?1:i.endsWith("%")?parseFloat(i)/100:parseFloat(i);return{hex:"#"+t.map(e=>e.toString(16).padStart(2,"0")).join(""),alpha:isNaN(o)?1:o}}return null}function Gt(e,t){if(t>=1)return e;const i=qt(e);if(!i)return e;const[s,o,a]=[1,3,5].map(e=>parseInt(i.hex.slice(e,e+2),16));return`rgba(${s}, ${o}, ${a}, ${Math.max(0,Math.round(1e3*t)/1e3)})`}function Vt(e){const t=/^#?([0-9a-f]{6})$/i.exec(e.trim());if(!t)return{h:0,s:0,v:0};const i=parseInt(t[1].slice(0,2),16)/255,s=parseInt(t[1].slice(2,4),16)/255,o=parseInt(t[1].slice(4,6),16)/255,a=Math.max(i,s,o),n=a-Math.min(i,s,o);let r=0;return n>0&&(r=a===i?(s-o)/n%6:a===s?(o-i)/n+2:(i-s)/n+4,r=(60*r+360)%360),{h:r,s:0===a?0:n/a,v:a}}function Yt(e,t,i){const s=i*t,o=s*(1-Math.abs(e/60%2-1)),a=i-s,[n,r,l]=e<60?[s,o,0]:e<120?[o,s,0]:e<180?[0,s,o]:e<240?[0,o,s]:e<300?[o,0,s]:[s,0,o];return"#"+[n,r,l].map(e=>Math.round(255*(e+a)).toString(16).padStart(2,"0")).join("")}function Kt(e,t){if(1===e.length)return e[0];const i=e.map(e=>/^#[0-9a-f]{6}$/i.test(e)?[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)):null);if(i.some(e=>!e))return e[e.length-1];const s=Math.min(1,Math.max(0,t))*(e.length-1),o=Math.min(e.length-2,Math.floor(s)),a=s-o,n=i[o],r=i[o+1],l=n.map((e,t)=>Math.round(e+(r[t]-e)*a));return"#"+l.map(e=>e.toString(16).padStart(2,"0")).join("")}function Xt(e,t){const i=Wt.find(t=>t.key===e),s=t.gradients?.[e],o=Array.isArray(s)?s.filter(e=>"string"==typeof e&&e):void 0;if(o&&o.length>=2)return o;const a=t.colors?.[e];if("string"==typeof a&&a)return[a];if(i?.stops)return i.stops;const n=Ai.find(t=>t.key===e)?.defaultColor;return["power"===e?t.accent:n??t.accent]}function Qt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch")&&e.isShelly)s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("lock"))s="lock";else if(i.has("media_player"))s="media";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),o=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||o||a?"sensor":"input"}else s="input";return s}const Zt=new Set(["relay","plug","energy","sensor","input","uni","generic","media","lock"]),Jt={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=Qt(e);if(Zt.has(t)){const i=function(e){if(e)for(const t of Nt)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:oi(e.model??"",e.hw_version,e.model_id),label:Ot[t],integration:e.integration}}},ei={id:"generic",matches:()=>!0,detect:e=>{const t=Qt(e);return{type:t,gen:"other",label:"climate"===t?"Climate":"relay"===t?"Switch":Ot[t],integration:e.integration}}},ti=[Jt,ei];function ii(e){for(const t of ti)if(t.matches(e))return t.detect(e);return ei.detect(e)}function si(e){return"ble"===e?"BLE":"other"===e?"":`G${e}`}function oi(e,t,i){const s=e.toLowerCase(),o=/^gen\s*([1-9])$/i.exec((t??"").trim());if(o){const e=Number(o[1]);if(e>=1&&e<=4)return e}const a=(i??"").toUpperCase();return/^SB/.test(a)?"ble":/^S4/.test(a)?4:/^S3/.test(a)?3:/^S[NA]/.test(a)?2:/^SH/.test(a)?1:!s.includes("blu")&&!s.includes("bluetooth")||s.includes("gateway")?s.includes("g4")||s.includes("gen4")||s.includes("gen 4")?4:s.includes("g3")||s.includes("gen3")||s.includes("gen 3")||/^s3/i.test(e)?3:s.includes("plus")||s.includes("pro")||/^sn/i.test(e)?2:"other":"ble"}const ai={shelly:"Shelly",bthome:"BTHome",zha:"Zigbee",zwave_js:"Z-Wave",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos",music_assistant:"Music",spotify:"Spotify",spotifyplus:"Spotify",cast:"Cast",yamaha_musiccast:"Yamaha",androidtv_remote:"Android",philips_js:"Philips",roborock:"Roborock",reolink:"Reolink",gecko:"Gecko",upnp:"UPnP",ipp:"Printer",bermuda:"Bermuda",template:"Template",device_pulse:"Pulse"};function ni(e){return ai[e.toLowerCase()]??e.toUpperCase().slice(0,6)}function ri(e){const t=e.entities??{},i=new Set,s=new Set;for(const[e,o]of Object.entries(t)){if(!o?.device_id||o.hidden_by)continue;const t=e.split(".")[0];if(!wt.has(t))continue;s.add(t);const a=(o.platform??"").toLowerCase();a&&i.add(a)}return{integrations:[...i].sort((e,t)=>ni(e).localeCompare(ni(t))),domains:[...s].sort()}}const li="—";function ci(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:li}function di(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:li}function pi(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:li}function hi(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:li}function ui(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:li}function gi(e){return!Number.isFinite(e)||e<0?li:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function vi(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":li}function fi(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:li}function mi(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:li}function bi(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:li}function yi(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:li}function wi(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:li}function xi(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:li}function _i(e){return Number.isFinite(e)?`${Math.round(e)} %`:li}function ki(e,t){if(!Number.isFinite(e))return li;const i=Math.abs(e)>=1e3?Math.round(e):parseFloat(e.toFixed(2));return t?`${i} ${t}`:`${i}`}const Ai=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Si=Object.fromEntries(Ai.map(e=>[e.key,e.label.split(" ")[0]])),Ci={co2:"carbon_dioxide",rssi:"signal_strength"};function $i(e){return Ci[e]??e}function Ei(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map($i).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,o]of Object.entries(s)){const s=$i(t);s!==t&&(e=!0),s in i||(i[s]=o)}e&&(s=i,t=!0)}let o=e.style,a=e.theme;if(o&&"object"==typeof o){const e=Ve(o);if("custom"!==e&&(void 0===a||a===e)){const i={...o};for(const e of Ge)delete i[e];Object.keys(i).length!==Object.keys(o).length&&(o=Object.keys(i).length?i:void 0,a=e,t=!0)}}const n=e;let r,l=!1;if(n.elements&&"object"==typeof n.elements){let e=n.tile_style;"string"==typeof e&&e.startsWith("custom:")&&(e=n.custom_styles?.[e.slice(7)]?.base??"default");const i=e&&{hero:"power-monitor",ring:"power-monitor",spark:"power-monitor",hbar:"power-monitor",list:"power-monitor",command:"scene-button"}[e]||e;if(i&&Bt[i]){const e={...n.style_presets?.[i]??{}};e.elements={...n.elements,...e.elements??{}},r={...n.style_presets??{},[i]:e}}l=!0,t=!0}const c=e;let d=!1;const p=e=>{if(!Array.isArray(e))return e;if(e.some(e=>Array.isArray(e))){let t=!1;const i=e.map(e=>Array.isArray(e)&&e.includes("delegated_controls")&&!e.includes("media_controls")?(t=!0,e.flatMap(e=>"delegated_controls"===e?["media_controls",e]:[e])):e);return t?(d=!0,i):e}return!e.includes("delegated_controls")||e.includes("media_controls")?e:(d=!0,e.flatMap(e=>"delegated_controls"===e?["media_controls",e]:[e]))},h=e=>{if(!e)return e;let t=!1;const i={};for(const[s,o]of Object.entries(e)){const e=p(o?.tile_layout);o&&e!==o.tile_layout?(i[s]={...o,tile_layout:e},t=!0):i[s]=o}return t?i:e},u=p(c.tile_layout),g=h(c.device_styles),v=h(c.profile_styles),f=h(c.area_styles),m=h(c.custom_styles),b=h(c.style_presets);let y=c.views;if(Array.isArray(y)){let e=!1;const t=y.map(t=>{let i=t;const s=p(t?.tile_layout);t&&s!==t.tile_layout&&(i={...i,tile_layout:s},e=!0);const o=i?.filter;if(o&&Array.isArray(o.devices)){const{devices:t,...s}=o;i={...i,filter:s},e=!0}return i});e&&(y=t,d=!0)}if(d&&(t=!0),!t)return e;const w={...e};if(d){const e=w;u!==c.tile_layout&&(e.tile_layout=u),g!==c.device_styles&&(e.device_styles=g),v!==c.profile_styles&&(e.profile_styles=v),f!==c.area_styles&&(e.area_styles=f),m!==c.custom_styles&&(e.custom_styles=m),b!==c.style_presets&&(e.style_presets=b),y!==c.views&&(e.views=y)}return o!==e.style&&(void 0===o?delete w.style:w.style=o),a!==e.theme&&(w.theme=a),i&&(w.graph_sensors=i),s&&(w.graph_sensor_colors=s),l&&(delete w.elements,r&&(w.style_presets=r)),w}const Ti=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Lux",agg:"avg"},{key:"lights",label:"Lights",agg:"count"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Ii=["online","offline","power","alerts"],Mi=[{key:"power",label:"Power",dc:"power",agg:"sum"},{key:"energy",label:"Energy",dc:"energy",agg:"sum"},{key:"voltage",label:"Volt",dc:"voltage",agg:"avg"},{key:"current",label:"Amp",dc:"current",agg:"sum"},{key:"temperature",label:"Temp",dc:"temperature",agg:"avg"},{key:"humidity",label:"Hum",dc:"humidity",agg:"avg"},{key:"co2",label:"CO₂",dc:"carbon_dioxide",agg:"avg"},{key:"illuminance",label:"Lux",dc:"illuminance",agg:"avg"},{key:"battery",label:"Batt",dc:"battery",agg:"avg"},{key:"rssi",label:"Wi-Fi",dc:"signal_strength",agg:"avg"}],Di=["power","energy","voltage","current","temperature"],Oi=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,graph_hours:24,header_chips:Ii});function zi(){return{...Oi,header_chips:[...Oi.header_chips??[]]}}const Pi=["type","views","default_view","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","delegate_controls","header_cards","footer_cards","area_cards","areas","hidden_devices","favorites","hidden_entities","show_offline","title","columns","tile_size","sort_by","tile_style","smart_tile_styles","power_monitor_variant","show_graphs","tile_layout","tile_opacity","card_opacity","header_opacity","header_show_title","header_show_stats","header_show_cloud","header_show_orbs","effects","header_chips","area_header_chips","show_collapse_all","card_bg_image","card_bg_image_size","show_power_bar","power_bar_max","show_entity_list","theme","light_labels","light_entities","show_attention","attention_battery","show_firmware_summary","include_beta_updates","attention_muted_integrations","style","area_styles","device_styles","profile_styles","style_presets","custom_styles","energy_period","graph_sensors","graph_hours","graph_style","graph_line_color","radio_stations","extra_card_style","area_card_placement","devices","show_header","show_rooms","graph_sensor_colors","sensors"],Ri=["grid_options","view_layout","layout_options","visibility","card_mod"];function Bi(e){if("binary_sensor"!==e.domain)return!1;if(/external_power|power_supply|charging/.test(e.entity_id))return!1;if(/(?:input|channel|button)/i.test(e.entity_id))return!0;const t=e.attributes?.device_class;return null==t||"power"===t}function Li(e){return"event"===e.domain&&("button"===e.attributes?.device_class||/(?:input|channel|button)/i.test(e.entity_id))}function Fi(e){const t=e.match(/(?:input|channel|button)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}function Ni(e,t,i){if("input"===i||"uni"===i)return;const s=e.entities.filter(e=>("switch"===e.domain||"light"===e.domain)&&!e.entity_category);if(s.length){if(1===s.length)return s[0].entity_id;if(null!=t){const e=s.find(e=>function(e){const t=e.match(/(?:switch|relay|light|channel)[_\s]*(\d+)/i);return t?parseInt(t[1],10):null}(e.entity_id)===t);if(e)return e.entity_id}}}function ji(e,t){const i=(e??"").trim(),s=(t??"").trim();return s&&i.toLowerCase().startsWith(s.toLowerCase())?i.slice(s.length).trim():i}function Hi(e,t,i,s){const o=ji(e,t);return o||(null!=i?`Input ${i}`:s.split(".")[1]??s)}function Ui(e,t){const i=e.entities.filter(Bi),s=e.entities.filter(Li),o=new Set,a=[],n=i.length||s.length?ii(e).type:"generic";return i.forEach((i,r)=>{const l=t[i.entity_id],c=Fi(i.entity_id),d=((e,t)=>{const i=e.entity_id.replace(/^binary_sensor\./,""),a=s.find(e=>!o.has(e.entity_id)&&e.entity_id.replace(/^event\./,"")===i);return a||(null!=t?s.find(e=>!o.has(e.entity_id)&&Fi(e.entity_id)===t):void 0)})(i,c);d&&o.add(d.entity_id);const p=d?t[d.entity_id]:null,h=p?.attributes?.event_type;a.push({entityId:i.entity_id,label:Hi(l?.attributes?.friendly_name??"",e.name,c,i.entity_id),isOn:"on"===l?.state,kind:d?"button":"switch",channel:c??0,lastEvent:h??null,lastChanged:l?.last_changed??null,output:Ni(e,c,n),_sort:c??50+r})}),s.filter(e=>!o.has(e.entity_id)).forEach((i,s)=>{const o=t[i.entity_id],r=Fi(i.entity_id),l=o?.state&&"unknown"!==o.state&&"unavailable"!==o.state?o.state:null;a.push({entityId:i.entity_id,label:Hi(o?.attributes?.friendly_name??"",e.name,r,i.entity_id),isOn:!1,kind:"button",channel:r??0,lastEvent:o?.attributes?.event_type??null,lastChanged:o?.last_changed??l,output:Ni(e,r,n),_sort:r??50+s})}),a.sort((e,t)=>e._sort-t._sort).map(({_sort:e,...t})=>t)}const Wi=e=>e.config.device_styles?.[e.device.device_id],qi=e=>e.config.profile_styles?.[e.profile],Gi=e=>e.device.area?e.config.area_styles?.[e.device.area]:void 0,Vi={hero:"big-number",ring:"gauge",spark:"graph",hbar:"compact",list:"table"};function Yi(e){return Wi(e)?.tile_style??qi(e)?.tile_style??Gi(e)?.tile_style??e.view?.tile_style??e.config.tile_style??(e.config.smart_tile_styles?Rt(e.profile,e.device):void 0)}function Ki(e,t){if("string"==typeof t&&t.startsWith("custom:")){const i=e.custom_styles?.[t.slice(7)];return{base:i?.base??"default",custom:i}}return{base:t}}function Xi(e){return e&&e in Vi?{style:"power-monitor",variant:Vi[e]}:"command"===e?{style:"scene-button",variant:"big-number"}:{style:e??"default",variant:"big-number"}}const Qi=e=>Ki(e.config,Yi(e)).custom;function Zi(e){const{base:t}=Ki(e.config,Yi(e));return Xi(t).style}function Ji(e,t){const i=Zi(e);return Wi(e)?.elements?.[t]??qi(e)?.elements?.[t]??Gi(e)?.elements?.[t]??e.view?.elements?.[t]??Qi(e)?.elements?.[t]??e.config.style_presets?.[i]?.elements?.[t]??function(e,t){return Bt[e]?.find(e=>e.id===t)?.def??!0}(i,t)}function es(e,t,i){return t?.[i]??e[i]}function ts(e,t){return t?.extra_card_style??e.extra_card_style??"ha"}function is(e,t,i){return i?.columns??t?.columns??e.columns??3}function ss(e,t){const i=e=>e&&"custom"!==e?e:void 0;return i(t?.theme)??i(e?.theme)}const os=new Set(["unavailable","unknown"]),as=e=>!e.borrowed_from;function ns(e){return e.entities.some(e=>e.borrowed_from)?{...e,entities:e.entities.filter(as)}:e}function rs(e,t){return e.entities.some(e=>{if(!as(e))return!1;const i=t[e.entity_id];return!!i&&!os.has(i.state??"")})}function ls(e,t){const i=[];for(const s of e.entities){if("binary_sensor"!==s.domain||!as(s))continue;const e=t[s.entity_id];if(!e||"on"!==e.state)continue;const o=e.attributes?.device_class??"";"heat"===o||s.entity_id.includes("overtemp")?i.push("overtemp"):("safety"===o||s.entity_id.includes("overpower"))&&i.push("overpower")}return[...new Set(i)]}function cs(e,t){const i=[];for(const s of e.entities){if("binary_sensor"!==s.domain||!as(s))continue;const e=t[s.entity_id];if(!e||"on"!==e.state)continue;const o=e.attributes?.device_class??"";"smoke"===o?i.push("smoke"):"moisture"===o?i.push("water"):"gas"===o&&i.push("gas")}return[...new Set(i)]}function ds(e,t){return[...ls(e,t),...cs(e,t)]}function ps(e,t,i={}){const s=gs(e,t,i);return!!s&&!!s.next&&s.next!==s.current}function hs(e,t){let i=null;for(const s of e.entities){if("sensor"!==s.domain||!as(s))continue;const e=t[s.entity_id];if(!e||"battery"!==e.attributes?.device_class)continue;const o=parseFloat(e.state??"");isNaN(o)||(i=null===i?o:Math.min(i,o))}return i}function us(e,t){return/beta/i.test(e)||/beta/i.test(t?.friendly_name??"")}function gs(e,t,i={}){for(const s of e.entities){if("update"!==s.domain||!as(s))continue;const e=t[s.entity_id];if(e&&"on"===e.state&&(i.includeBeta||!us(s.entity_id,e.attributes)))return{entityId:s.entity_id,current:e.attributes?.installed_version??"",next:e.attributes?.latest_version??""}}return null}function vs(e,t,i={}){const s=i.batteryBelow??20,o=[];for(const a of e){const e=[],n=[];if(rs(a,t)){const o=ds(a,t);o.length&&(e.push("alert"),n.push(...o));const r=hs(a,t);null!==r&&r<=s&&(e.push("battery"),n.push(`battery ${Math.round(r)}%`));const l=ps(a,t,i)?gs(a,t,i):null;l&&(e.push("update"),n.push(`update → ${l.next}`))}else e.push("offline"),n.push("offline");e.length&&o.push({device:a,kinds:e,detail:n})}const a={offline:0,alert:1,battery:2,update:3},n=e=>Math.min(...e.kinds.map(e=>a[e]));return o.sort((e,t)=>n(e)-n(t)||e.device.name.localeCompare(t.device.name))}function fs(e,t,i={}){const s=new Set(i.labels??[]),o=new Set(i.entities??[]);let a=0,n=0;const r=[],l=new Set,c=(e,i)=>{if(l.has(e))return;const s=t[e];s&&!os.has(s.state??"")&&(l.add(e),n++,"on"===s.state&&(a++,r.push(s.attributes?.friendly_name??i)))};for(const t of e){const e=!!t.labels?.some(e=>s.has(e));for(const i of t.entities)("light"===i.domain||o.has(i.entity_id)||e&&"switch"===i.domain)&&c(i.entity_id,t.name)}for(const e of o)c(e,e);return{on:a,total:n,onNames:r}}function ms(e){const t=new Map;for(const i of e){const e=i.sw_version;if(null==e||""===e)continue;const s=bs(e);t.has(s)||t.set(s,[]),t.get(s).push(i)}const i=[...t.entries()].map(([e,t])=>({version:e,devices:t,current:!1})).sort((e,t)=>function(e,t){const i=e.split(".").map(e=>parseInt(e,10)),s=t.split(".").map(e=>parseInt(e,10));for(let o=0;o<Math.max(i.length,s.length);o++){const a=i[o]??0,n=s[o]??0;if(isNaN(a)||isNaN(n))return e.localeCompare(t);if(a!==n)return a-n}return 0}(t.version,e.version));return i.length&&(i[0].current=!0),i}function bs(e){const t="string"==typeof e?e:String(e??""),i=t.match(/(\d+\.\d+(?:\.\d+)?)/);return i?i[1]:t}const ys={offline:0,alert:1,battery:2,update:3};function ws(e){const t=new Map;for(const i of e){const e=i.device.integration||"other";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.entries()].map(([e,t])=>({integration:e,items:t,worst:["offline","alert","battery","update"].find(e=>t.some(t=>t.kinds.includes(e)))}));return i.sort((e,t)=>ys[e.worst]-ys[t.worst]||t.items.length-e.items.length||e.integration.localeCompare(t.integration))}function xs(e){return e.includes(".")}function _s(e){return e.filter(e=>!xs(e))}function ks(e){return e.filter(xs)}function As(e,t){if(!t?.length)return[];const i=new Map(e.entities.map(e=>[e.entity_id,e])),s=[];for(const e of ks(t)){const t=i.get(e);t&&!s.includes(t)&&s.push(t)}return s}function Ss(e,t){return[...ks(e??[]),...t]}const Cs=["temperature","humidity","carbon_dioxide","illuminance","battery"],$s=["motion","door","window","moisture","smoke","gas"],Es=(e,t)=>e[t]?.attributes??{};function Ts(e,t){return Is(e,t)&&!e.entity_category}function Is(e,t){if("sensor"!==e.domain)return!1;const i=t[e.entity_id];return!(!i||"unavailable"===i.state||"unknown"===i.state)&&(!!Es(t,e.entity_id).unit_of_measurement&&!isNaN(parseFloat(i.state)))}function Ms(e,t){if("sensor"!==e.domain&&"binary_sensor"!==e.domain)return!1;const i=t[e.entity_id];return!!i&&"unavailable"!==i.state&&"unknown"!==i.state}function Ds(e){const{device:t,accent:i,online:s,hass:o,config:a}=e,n=e.sensorSelection(t),r=function(e,t,i){for(const s of As(e,i))if(Ms(s,t))return s;const s=i=>{for(const s of Cs){const o=e.entities.find(e=>i(e)&&Es(t,e.entity_id).device_class===s);if(o)return o}},o=s(e=>Ts(e,t));if(o)return o;const a=e.entities.find(e=>Ts(e,t));return a||s(e=>Is(e,t))}(t,o.states,n),l=r?void 0:function(e,t){return e.entities.find(e=>"binary_sensor"===e.domain&&t[e.entity_id]&&$s.includes(Es(t,e.entity_id).device_class??""))}(t,o.states);if(!r&&!l)return nt(t,s,"ts-sensor",it("empty.no_sensor"));if(r){const l=o.states[r.entity_id],c=parseFloat(l?.state??""),d=l?.attributes?.unit_of_measurement??"",p=l?.attributes,h=p?.device_class||ji(p?.friendly_name??"",t.name)||r.entity_id.split(".")[1]?.replace(/_/g," ")||"",u=a.graph_hours??24;e.requestGraphData(r.entity_id);const g=e.getGraphPoints(r.entity_id,u);let v=0;if(g.length>=2){const e=Math.floor(g.length/2),t=g.slice(e).reduce((e,t)=>e+t.v,0)/(g.length-e),i=g.slice(0,e).reduce((e,t)=>e+t.v,0)/e;v=t-i}const f=function(e,t,i,s=4,o){const a=As(e,o).filter(e=>e.entity_id!==i&&Ms(e,t)),n=new Set(a.map(e=>e.entity_id)),r=e.entities.filter(e=>e.entity_id!==i&&!n.has(e.entity_id)&&Ts(e,t));return[...a,...r].slice(0,s)}(t,o.states,r.entity_id,4,n),m=ot(e),b=!m&&e.showEl("secondary"),y=new Set(As(t,n).map(e=>e.entity_id)),w=f.some(e=>y.has(e.entity_id)),x=(m||b)&&f.length?f.map(e=>{const i=o.states[e.entity_id],s=i?.attributes,a=parseFloat(i?.state??""),n=s?.unit_of_measurement??"";if(!w)return q`<span class="ts-chip">${isNaN(a)?i?.state:a.toFixed(1)} ${n}</span>`;const r=ji(s?.friendly_name??"",t.name)||e.entity_id.split(".")[1]?.replace(/_/g," ")||e.entity_id;return q`<span class="ts-chip" title=${r}>
        <span class="ts-chip-lbl">${r}</span>${isNaN(a)?i?.state:ki(a,n)}</span>`}):null;return q`
      <div class="ts-sensor" style="--ts-accent:${i}">
        <div class="ts-sensor-top">
          ${at(t,s)}
          ${m&&x?q`<div class="ts-chips ts-chips-hdr">${x}</div>`:Y}
          <span class="ts-sensor-dc">${h}</span>
        </div>
        ...
        ${e.showEl("trend")&&g.length>=2?q`
          <div class="ts-sensor-trend ${v>0?"up":v<0?"down":""}">
            ${v>0?"↑":v<0?"↓":"→"} ${Math.abs(v)<.05?"stable":Math.abs(v).toFixed(1)+" "+d+"/hr"}
          </div>`:Y}
        ...
        ${b&&x?q`<div class="ts-chips" style="margin-top:6px">
          ${x}
        </div>`:Y}
    ...
    </div>`}function Os(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:o,config:a}=e,n=e.tileSensors(t),r=e.getPrimarySwitch(t),l=function(e,t){const i=[];for(const s of Wt){const o=e[s.key];if(null==o)continue;const a=o.value,n=t.ranges?.[s.key]??{},r=o.diagnostic&&s.diag?s.diag:s,l=n.min??r.min,c=n.max??r.max,d=Xt(s.key,t),p=Math.min(1,Math.max(0,(a-l)/(c-l||1)));if(i.push({key:s.key,label:s.label,val:a,digits:s.digits,min:l,max:c,stops:d,pct:p,color:Kt(d,p)}),i.length>=4)break}return i}(e.sensorValues(t),{ranges:a.graph_style?.sensor_ranges,colors:a.graph_sensor_colors,gradients:a.graph_style?.gauge_gradients,accent:s}),c=e=>`pm-gg-${t.device_id.replace(/\W/g,"")}-${e}`,d=new Set(["power","voltage","current"]),p=110,h=110,u=180,g=180,v=22,f=102,m=e=>e*Math.PI/180,b=(e,t)=>{const i=g+u*Math.min(1,Math.max(0,t)),s=p+e*Math.cos(m(g)),o=h+e*Math.sin(m(g)),a=p+e*Math.cos(m(i)),n=h+e*Math.sin(m(i)),r=u*t>180?1:0;return`M ${s.toFixed(2)} ${o.toFixed(2)} A ${e} ${e} 0 ${r} 1 ${a.toFixed(2)} ${n.toFixed(2)}`},y=(e,t,i)=>"power"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:e.toFixed(i),w=7,x=h+8;return q`
    <div class="ts-ring" style="--ts-accent:${s};align-items:center">
      <div class="ts-ring-top" style="width:100%">
        ...
        ${at(t,o,"ts-ring-name")}
        ${ot(e)?Ps(n,"ts-chips ts-chips-hdr"):Y}
      </div>
      ${l.length?q`
      <svg viewBox="0 0 ${2*p} ${x}" style="width:100%;max-width:360px;height:auto;overflow:visible;display:block">
        <defs>
        ...
        ${l.map((e,t)=>{const s=f-t*v,o=e.stops.length>1?`url(#${c(e.key)})`:e.stops[0],a=18,n=(h-Math.sqrt(Math.max(0,s*s-a*a))+w/2+1.5).toFixed(1),r=i||!d.has(e.key);return G`
            <path d="${b(s,1)}"        fill="none" stroke="${o}" stroke-width="${w}" stroke-linecap="round" opacity="0.12"/>
            <path d="${b(s,e.pct)}" fill="none" stroke="${o}" stroke-width="${w}" stroke-linecap="round" opacity="${r?"0.9":"0.3"}"/>
    ...
    <div class="ts-spark" style="--ts-accent:${s}">
      <div class="ts-spark-top">
        ...
        ${l?Ps(n,"ts-chips ts-chips-hdr"):Y}
      </div>
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=a.uptime&&e.showEl("uptime")?q`<span class="ts-hbar-badge">${gi(a.uptime)}</span>`:Y}
        </div>
    ...
    <div class="ts-list" style="--ts-accent:${s}">
      ...
      ${null!=n.power?f(it("pm.power"),ci(n.power),!0):Y}
      ${!l&&e.showEl("secondary")?q`
        ...
        ${null!=n.energy?f(n.energyLabel,di(n.energy)):Y}
        ${null!=n.temp?f(it("pm.temperature"),`${n.temp.toFixed(1)} °C`):Y}
        ${null!=n.rssi?f(it("pm.rssi"),`${n.rssi} dBm`):Y}`:Y}
      ${null!=n.uptime&&e.showEl("uptime")?f(it("pm.uptime"),gi(n.uptime)):Y}
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-top">
        ${r&&e.showEl("toggle")?q`<button class="tog ${i?"on":"off"}" @click=${t=>e.toggle(r.entityId,i,t)}>${it(i?"state.on_short":"state.off_short")}</button>`:Y}
        ${at(t,o,"ts-hero-name")}
        ${c?Ps(n,"ts-chips ts-chips-hdr"):Y}
      </div>
      ...
      <div class="ts-hero-foot">
        ${!c&&e.showEl("secondary")?Ps(n):Y}
        ${e.showEl("uptime")?q`<span class="ts-uptime">${n.uptime?gi(n.uptime):""}</span>`:Y}
      </div>
      ${zs(e,{skipPowerGraph:!0})}
    </div>`}(e)}}function zs(e,t={}){return e.showEl("lower_body")?e.renderTileLowerBody(e.device,e.profile,{...t,skipGraphs:!e.showEl("graph")}):Y}function Ps(e,t="ts-chips"){return q`<div class="${t}">
    ...
    ${null!=e.rssi?q`<span class="ts-chip">${e.rssi} dBm</span>`:Y}
      ...
      <div class="ts-light" style="--ts-accent:${s}">
        ...
        ${null!=l.power?q`<div style="font-size:.72em;color:var(--sc-text-muted);text-align:center">${ci(l.power)}</div>`:Y}
      </div>`;const c=i?Math.max(1,r.brightness??1):0,d=!!r.colorModes?.length,p=d&&(r.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),h=d&&r.rgbColor?e.rgbToHex(...r.rgbColor):"#ffffff",u=r.whiteValue??0,g=a.states[r.entityId],v=g?.attributes??{},f=v.effect_list??[],m=v.effect??"",b=(v.supported_color_modes??[]).some(e=>"color_temp"===e),y=v.min_mireds??153,w=v.max_mireds??500,x=v.color_temp??y,_=d&&r.rgbColor?(()=>{const[e,t,i]=r.rgbColor,s=Math.max(e,t,i),o=s-Math.min(e,t,i);let a=0;o>0&&(a=s===e?((t-i)/o+6)%6:s===t?(i-e)/o+2:(e-t)/o+4);const n=0===s?0:o/s,l=(e=>e*Math.PI/180)(60*a-90);return{x:Bs+62*n*Math.cos(l),y:Bs+62*n*Math.sin(l)}})():null,k=`wsat-${t.device_id.replace(/\W/g,"")}`;return q`
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?q`
        <div class="ts-light-wheel-wrap">
          <svg width="${Rs}" height="${Rs}" viewBox="0 0 ${Rs} ${Rs}"
            ...
            <circle cx="${Bs}" cy="${Bs}" r="${Bs}" fill="url(#${k})" opacity="${i?1:.3}"/>
      ...
      ${b&&e.showEl("color_temp")?q`
        <div class="ts-light-row">
          ...
          <div style="display:flex;align-items:center;gap:6px;flex:1">
            <input type="range" class="dim-slider ts-light-slider ts-light-ct" min="${y}" max="${w}"
              .value=${String(x)} ?disabled=${!i}
              @change=${e=>{a.callService("light","turn_on",{entity_id:r.entityId,color_temp:parseInt(e.target.value,10)})}}/>
            <span class="ts-light-pct">${Math.round(1e6/x)}K</span>
          </div>
        </div>`:Y}
      ${p&&e.showEl("white")?q`
        <div class="ts-light-row">
      ...
      `}case"graph":return e.renderSparklines(i);case"dimmer":{const t=r?a.states[r.entityId]:null,i=t?.attributes?.effect_list??[],s=t?.attributes?.effect??null,o=r?.whiteValue??0;return r&&m?q`
        <div class="tile-dim-row" @click=${e=>e.stopPropagation()}>
          ${y?q`
            <input type="color" class="color-swatch tile-color-swatch" .value=${w}
              ?disabled=${!f}
              @change=${t=>{t.stopPropagation(),e.setColor(r.entityId,t.target.value,o,x)}}/>
          `:Y}
          <input type="range" class="dim-slider" min="1" max="100"
            style=${ke(y?{accentColor:w}:{})}
        ...
        ${x?q`
          <div class="tile-dim-row tile-white-row" @click=${e=>e.stopPropagation()}>
            ...
            <input type="range" class="dim-slider white-slider" min="0" max="255"
              ...
              @change=${t=>{const i=parseInt(t.target.value,10);e.setColor(r.entityId,w,i,!0)}}/>
      ...
      `:q``}case"media_controls":{const t=i.entities.find(e=>"media_player"===e.domain&&!e.entity_category),s=t?a.states[t.entity_id]:void 0;if(!t||!s)return q``;const n=s.attributes,r=Number(n.supported_features??0),l={PAUSE:1,VOLUME_SET:4,VOLUME_MUTE:8,PREV:16,NEXT:32,TURN_ON:128,TURN_OFF:256,PLAY_MEDIA:512,STOP:4096,PLAY:16384,BROWSE:131072},c=e=>0!==(r&e),d=s.state,p="playing"===d,h="off"===d||"standby"===d||"unavailable"===d,u=[n.media_title,n.media_artist].filter(Boolean).join(" · ")||n.source||"",g="number"==typeof n.volume_level?Math.round(100*n.volume_level):null,v=!0===n.is_volume_muted,f=(e,i={})=>a.callService("media_player",e,{entity_id:t.entity_id,...i}),m=p?it("media.playing"):"paused"===d?it("media.paused"):"idle"===d?it("media.idle"):"unavailable"===d?it("media.unavailable"):h?it("media.off"):d,b=function(e,t){const i=e.device_styles?.[t.device_id]?.radio_stations??e.radio_stations;return(Array.isArray(i)?i:[]).filter(e=>e&&"string"==typeof e.url&&!!e.url)}(o,i),y=c(l.BROWSE)?e.getBrowseGroups(t.entity_id):null,w=Array.isArray(y)?y:[],x=new Map;for(const e of w)for(const t of e.items)x.set(t.id,t.type);for(const e of b)x.has(e.url)||x.set(e.url,"music");const _=n.media_content_id,k=n.media_title,A=()=>{for(const e of w)for(const t of e.items)if(t.title===k)return t.id;return b.find(e=>e.name===k)?.url},S=(_&&x.has(_)?_:void 0)??(k?A():void 0)??"",C=c(l.PLAY_MEDIA)&&(c(l.BROWSE)||b.length>0),$=Array.isArray(y)&&!w.some(e=>e.items.length)&&!b.length,E=i=>{i.stopPropagation(),c(l.BROWSE)&&e.requestBrowse(t.entity_id)};return q`
          ...
          <div class="tile-media-now">
            ...
            ${C?q`
              <select class="input-sel tile-media-sel" title="Play a station"
                ...
                @change=${e=>{const t=e.target.value;t&&f("play_media",{media_content_id:t,media_content_type:x.get(t)??"music"})}}>
        ...
        </div>`}case"delegated_controls":{if(!o.delegate_controls)return q``;const e=It(i);return e.length?q`
        <div class="tile-delegated" @click=${e=>e.stopPropagation()}>
          ${e.map(e=>q`
            <hdd-delegated .hass=${a} .entity=${e.entity_id} .features=${Tt[e.domain]}></hdd-delegated>
          `)}
        </div>`:q``}case"power_bar":return e.renderPowerBar(i);case"badges":return q`
        <div class="tile-bot">
          ${null!=u?q`<span class="tile-power">${ci(u)}</span>`:Y}
      ...
      `;default:return q``}var S}const Ns=255;function js(e){return q`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=n.rssi?q`<div class="ds-signal">${it("detail.signal",{quality:vi(n.rssi),dbm:n.rssi})}${null!=n.uptime?q` · ${it("detail.uptime_inline",{value:gi(n.uptime)})}`:Y}</div>`:Y}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const o=i.states[s.entity_id],a="on"===o?.state,n=o?.attributes?.friendly_name??s.entity_id,r=s.entity_id.match(/_(?:switch|relay|channel)_\d+/)?.[0]??"",l=r?t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(r)&&"power"===i.states[e.entity_id]?.attributes?.device_class):void 0,c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return q`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?Y:q`<span class="ds-channel-power">${ci(c)}</span>`}
    ...
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?q`<span class="ds-big-power">${ci(s.power)}</span>`:Y}
    </div>
    ...
    ${Us(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Ns*100);return q`
    <div class="ds-section">
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${ci(t.power)}</span><span class="ds-sensor-label">${it("detail.sensor_power")}</span></div>`:Y}
        ${null!=t.voltage?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${pi(t.voltage)}</span><span class="ds-sensor-label">${it("detail.sensor_voltage")}</span></div>`:Y}
        ${null!=t.current?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${hi(t.current)}</span><span class="ds-sensor-label">${it("detail.sensor_current")}</span></div>`:Y}
        ${null!=t.energy?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${di(t.energy)}</span><span class="ds-sensor-label">${t.energyLabel}</span></div>`:Y}
        ${null!=t.temp?q`<div class="ds-sensor-item"><span class="ds-sensor-val">${ui(t.temp)}</span><span class="ds-sensor-label">${it("detail.sensor_temp")}</span></div>`:Y}
      </div>
    </div>`:q``}(e):Y}
    ${!o&&s?Hs(e):Y}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=o.rssi?q`<div class="ds-diag-item"><span class="ds-diag-label">${it("detail.rssi")}</span><span class="ds-diag-val">${vi(o.rssi)} (${o.rssi} dBm)</span></div>`:Y}
        ${null!=o.uptime?q`<div class="ds-diag-item"><span class="ds-diag-label">${it("detail.uptime")}</span><span class="ds-diag-val">${gi(o.uptime)}</span></div>`:Y}
      ...
      <div class="cf-backdrop" @click=${t}>
        <div class="cf-box" role="alertdialog" aria-modal="true" aria-label=${it("confirm.aria")}
          ...
          </div>`;const $=s.map(e=>e.v),E=s.filter(e=>!e.live).map(e=>e.v),T=(this._config.graph_style?.sensor_ranges??{})[A]??{},I=T.min??Math.min(...E),M=T.max??Math.max(...E),D=M-I||1,O=s[0].t,z=s[s.length-1].t,P=z-O||1,R=e=>(e.t-O)/P*a,B=e=>n-4-(e.v-I)/D*(n-8),L=s.map(e=>`${R(e).toFixed(1)},${B(e).toFixed(1)}`).join(" "),F=R(s[0]).toFixed(1),N=`sg-${o.replace(/[^a-z0-9]/gi,"")}`,j=$[$.length-1],H=j%1==0?`${j}`:j.toFixed(1),U=Math.max(...E),W=Math.min(...E);let V=$.indexOf(U),K=$.indexOf(W);V<0&&(V=0),K<0&&(K=0);const X=R(s[V]).toFixed(1),Q=B(s[V]).toFixed(1),Z=R(s[K]).toFixed(1),J=B(s[K]).toFixed(1),ee=x(s[0].t),te=x((s[0].t+z)/2),ie=m/P*a,se=`${Math.max(.3,.7*ie).toFixed(2)} ${Math.max(.3,.3*ie).toFixed(2)}`,oe=c&&M-I>0,ae=e=>e%1==0?`${e}`:e.toFixed(1),ne=M===I,re=e=>h?q`
        <span class="spark-axis spark-axis-${e} ${ne?"flat":""}" aria-hidden="true">
          ${ne?q`<i>${ae(M)}</i>`:q`<i>${ae(M)}</i><i>${ae(I)}</i>`}
        </span>`:Y;return q`
          ...
          <div class="spark-row ${i?"":"spark-row-clickable"}" @click=${i?Y:t=>{t.stopPropagation(),this._detailDevice=e.device_id}}>
            ...
            <div class="spark-svg-wrap">
              <svg viewBox="0 0 ${a} ${n}" preserveAspectRatio="none"
                ...
                @mousemove=${e=>{const t=e.currentTarget,i=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(e.clientX-i.left)/i.width)),n=O+o*P;let r=s[0];for(const e of s)Math.abs(e.t-n)<Math.abs(r.t-n)&&(r=e);const l=R(r),c=B(r),d=t.querySelector(".spark-crosshair");d&&(d.setAttribute("x1",String(l)),d.setAttribute("x2",String(l)),d.style.display="");const p=t.querySelector(".spark-hover-dot");p&&(p.setAttribute("cx",String(l)),p.setAttribute("cy",String(c)),p.style.display="");const h=t.parentElement,u=h?.querySelector(".spark-tooltip");if(u){const e=u.querySelector(".spark-tooltip-val"),t=u.querySelector(".spark-tooltip-time");e&&(e.textContent=`${r.v%1==0?String(r.v):r.v.toFixed(1)} ${k}`),t&&(t.textContent=x(r.t)),u.style.left=`${(l/a*100).toFixed(1)}%`,u.style.display=""}}} @mouseleave=${e=>{const t=e.currentTarget;t.querySelector(".spark-crosshair")?.style&&(t.querySelector(".spark-crosshair").style.display="none"),t.querySelector(".spark-hover-dot")?.style&&(t.querySelector(".spark-hover-dot").style.display="none");const i=t.parentElement?.querySelector(".spark-tooltip");i&&(i.style.display="none")}}>
                <defs>
                ...
                `:Y}
                ${"bar"!==u&&v?G`
                  <polygon points="${L} ${a},${n-4} ${F},${n-4}" fill="url(#${N})"/>
                `:Y}
                ${"bar"===u?s.map(e=>{const t=Math.max(2,a/s.length-2),i=R(e)-t/2,o=B(e),r=n-4-o;return G`<rect x="${i.toFixed(1)}" y="${o.toFixed(1)}" width="${t.toFixed(1)}" height="${Math.max(0,r).toFixed(1)}" rx="${g}" fill="${C}" opacity="0.75"/>`}):G`
                    <polyline points="${L}" fill="none"
                      stroke="${C}" stroke-width="${l}"
                      stroke-linecap="round" stroke-linejoin="round"/>
                  `}
                <line x1="0" y1="${n}" x2="${a}" y2="${n}"
                  stroke="rgba(255,255,255,0.5)" stroke-width="0.8"
                  stroke-dasharray="${se}" pointer-events="none"
                  vector-effect="non-scaling-stroke"/>
                ${oe?G`
                  <circle cx="${X}" cy="${Q}" r="3"
                    fill="${C}" stroke="#1e1e2e" stroke-width="1.2"/>
                  <circle cx="${Z}" cy="${J}" r="2.5"
      ...
      <div class="sparklines-block ${i?"exp":""}">
        ${k}
      </div>`}_closeDetailSheet(){this._detailDevice=null}_blockLayout(e,t){return function(e){return Wi(e)?.tile_layout??qi(e)?.tile_layout??Gi(e)?.tile_layout??e.view?.tile_layout??Qi(e)?.tile_layout??e.config.style_presets?.default?.tile_layout??e.config.tile_layout??Ft[e.profile]??Ft.generic}(this._cascade(e,t))}_trvColor(e){const t=Math.max(0,Math.min(1,e));let i,s,o;if(t<.5){const e=2*t;i=Math.round(74+156*e),s=Math.round(144+-18*e),o=Math.round(217+-183*e)}else{const e=2*(t-.5);i=Math.round(230+-1*e),s=Math.round(126+-69*e),o=Math.round(34+19*e)}return`rgb(${i},${s},${o})`}_renderTrvDial(e){const{minTemp:t,maxTemp:i,targetTemp:s,currentTemp:o,step:a,entityId:n}=e,r=this._trvDragTemp??s??t,l=i-t||1,c=Math.max(0,Math.min(1,(r-t)/l)),d=e=>210+(e-t)/l*300,p=(e,t)=>[80+t*Math.cos((e-90)*Math.PI/180),70+t*Math.sin((e-90)*Math.PI/180)],h=(e,t,i)=>{const[s,o]=p(e,i),[a,n]=p(t,i);return`M ${s} ${o} A ${i} ${i} 0 ${t-e>180?1:0} 1 ${a} ${n}`},u=this._trvColor(c),g=d(r),[v,f]=p(g,54),m=null!=o?(o-t)/(i-t):null,b=null!=o?p(d(o),54):null,y=null!=m?this._trvColor(m):u,w=`trv-grad-${n.replace(/\W/g,"_")}`;return G`
      <svg viewBox="0 0 160 132" class="trv-dial-svg valve-interactive" @pointerdown=${e=>{e.stopPropagation();const s=e.currentTarget;s.setPointerCapture(e.pointerId);const o=e=>{const o=this._trvTempFromEvent(e,s,t,i,a);null!=o&&(this._trvDragTemp=o)},r=()=>{s.removeEventListener("pointermove",o),s.removeEventListener("pointerup",l),s.removeEventListener("pointercancel",c)},l=e=>{const o=this._trvTempFromEvent(e,s,t,i,a)??this._trvDragTemp;this._trvDragTemp=null,null!=o&&this._setTemp(n,o),r()},c=()=>{this._trvDragTemp=null,r()};s.addEventListener("pointermove",o),s.addEventListener("pointerup",l),s.addEventListener("pointercancel",c)}}>
        <defs>
          <linearGradient id="${w}" x1="0%" y1="100%" x2="100%" y2="0%">
        ...
        <path d="${h(210,510,54)}" fill="none" stroke="url(#${w})" stroke-width="8" stroke-linecap="round" opacity="0.25"/>
        ${g>210?G`<path d="${h(210,g,54)}" fill="none" stroke="url(#${w})" stroke-width="8" stroke-linecap="round"/>`:Y}
    ...
    `}_getVirtualControls(e){return e.entities.filter(e=>!("select"!==e.domain||!/_enum_\d+$/i.test(e.entity_id))||(!("number"!==e.domain||!/_number_\d+$/i.test(e.entity_id))||(!("button"!==e.domain||!/_button_\d+$/i.test(e.entity_id))||(!("text"!==e.domain||!/_text_\d+$/i.test(e.entity_id))||!("switch"!==e.domain||!/_boolean_\d+$/i.test(e.entity_id)))))).map(e=>{const t=this.hass.states[e.entity_id],i=t?.attributes??{};return{entityId:e.entity_id,domain:e.domain,label:i.friendly_name??e.entity_id.split(".").pop().replace(/_/g," "),value:t?.state??"unavailable",options:i.options,min:i.min,max:i.max,step:i.step,isOn:"on"===t?.state}})}_renderEntityAnim(e,t,i){const s=this._config.device_styles?.[i]?.entity_animations?.[e];if(!s)return q``;const o=(t?s.on:s.off)??"none";return"none"===o?q``:vt(o,t,`--ent-spd:${s.speed??1};--ent-size:${s.size??1}`,"ent-icon")}_renderBlock(e,t,i,s){return Fs(s??this._buildTileCtx(t,i,this._tileAccent(t,t.area??"")),e)}_renderPowerBar(e){if(!this._config.show_power_bar)return q``;const t=this._getPower(e)??0,i=this._config.power_bar_max??2e3;return q`
      ...
      <div class="cloud-detail" @click=${e=>e.stopPropagation()}>
        ...
        </div>`:Y,u=void 0!==s?.brightness,g=!!s?.colorModes?.length,v=g&&s.rgbColor?this._rgbToHex(...s.rgbColor):"#ffffff",f=g&&(s.colorModes?.some(e=>"rgbw"===e||"rgbww"===e)??!1),m=u&&r?Math.max(1,s.brightness??1):0,b=s?.whiteValue??0,y=s?this.hass.states[s.entityId]:null,w=y?.attributes?.effect_list??[],x=y?.attributes?.effect??null,_=u?q`
      <div class="ts-lower-section ts-lower-dimmer" @click=${e=>e.stopPropagation()}>
        ...
        `:Y}
        ${ht(w,x,e=>this.hass.callService("light","turn_on",{entity_id:s.entityId,effect:e}))}
      </div>
    `:Y,k=o?q`
    ...
    `:Y;return p.length||u||o||a||n||C.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${ke(p)}
          ...
          ${Oe(t,e=>e.join("+"),e=>1===e.length?Fs(a,e[0]):q`<div class="tile-row">${e.map(e=>Fs(a,e))}</div>`)}
        </div>`}const y=e.area??"",w=this._tileAccent(e,y);return q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${ke(p)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===f?Os(this._buildTileCtx(e,s,w),b):"light-control"===f?Ls(this._buildTileCtx(e,s,w)):"climate-control"===f?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return nt(t,s,"ts-climate",it("empty.no_climate"));const n="heating"===a.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(o.states[r.entity_id]?.state??"")||null;return q`
    <div class="ts-climate" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:Y}
    </div>`}(this._buildTileCtx(e,s,w)):"cover-control"===f?function(e){const{device:t,accent:i,online:s}=e,o=e.getCover(t);if(!o)return q`<div class="ts-cover"><span style="color:var(--sc-text-muted);font-size:.8em">${it("empty.no_cover")}</span></div>`;const a=o.position??("open"===o.state?100:0),n="opening"===o.state||"closing"===o.state,r=Math.ceil(a/100*gt.length);return q`
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:Y}
    </div>`}(this._buildTileCtx(e,s,w)):"sensor-card"===f?Ds(this._buildTileCtx(e,s,w)):"input-control"===f?yt(this._buildTileCtx(e,s,w)):"scene-button"===f?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),n=o.device_styles?.[t.device_id],r=n?.tile_icon??"pulse",l=n?.tile_icon_size??1,c=vt(r,!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),d=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),p=d?e.timeAgo(d):"";return a.length>0?q`
    ...
    <div class="ts-scene ts-scene-centered" style="--ts-accent:${i}"
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${o>0?q`<span class="fav-chip fav-chip-power">${ci(o)}</span>`:Y}
          </div>
        </div>
      ...
      <div class="area-section ${o?"closed":""} ${n?.bg_image&&"ambient"===n.bg_image_mode?"area-bg-ambient":""}" style=${ke(l)}>
        ...
        ${(()=>{const i=this._areaChipOpen;if(!i||!i.startsWith(`${e}::`))return Y;const o=i.slice(e.length+2),a=this._areaChipDeviceValues(t,o,s);if(!a.length)return Y;const n=Mi.find(e=>e.key===o);return q`
    ...
    `}render(){if(!this._config||!this.hass)return q``;const e=new Set(["hui-card-picker","hui-cards-used-card-picker"]);let t=this,i=!1;for(;t;){if(t instanceof Element&&e.has(t.tagName.toLowerCase())){i=!0;break}const s=t.getRootNode();if(s===t||s===document)break;t=s.host}if(i)return q`
        ...
        </ha-card>`;const o=this._getActiveView(),a=[],n=o?this._applyViewFilter(s,o,a):s;if(o&&!n.length)return this._renderEmptyView(a,s,o);const r=this._groupByArea(n),l=!o||!0===o.show_favourites,c=o?!1!==o.show_rooms:!1!==this._config.show_rooms,d=!0===this._config.header_show_cloud?Object.values(this.hass.states).filter(e=>e.entity_id.startsWith("binary_sensor.")&&e.entity_id.endsWith("_cloud")):[],p=d.filter(e=>"on"===e.state),h=d.filter(e=>"off"===e.state),u=d.filter(e=>"unavailable"===e.state),g=e=>(e.attributes.friendly_name??e.entity_id).replace(/\s*[Cc]loud$/,"").trim(),v=this._buildCardStyles(),f=this._detailDevice?this._getDevices().find(e=>e.device_id===this._detailDevice)??null:null,m=f?js(this._buildTileCtx(f,this._profile(f),this._tileAccent(f,f.area??""))):Y,b=q`
      <ha-card class=${this._config.effects?"":"no-fx"} style=${ke(v)} @click=${()=>{this._cloudDetailOpen&&(this._cloudDetailOpen=null)}}>
        ${m}
        ...
        <div class="dash-header">
          ...
          ${!1!==this._config.header_show_stats?this._renderHeaderChips(n):Y}
        ...
        ${this._renderHeaderDetail(n)}
        ${this._renderViewTabs()}
        ${this._renderDiscoveryNotice()}
        ${this._renderDelegateNotice(s)}
        ${this._renderExtraCards(es(this._config,o??void 0,"header_cards"))}
        <div class="dash-body">
          ${this._renderAttention(n)}
          ${l?this._renderFavoritesSection(s):Y}
          ${c&&r.size>0&&!1!==this._config.show_collapse_all?q`<div class="rooms-toolbar">${this._renderCollapseAll([...r.keys()])}</div>`:Y}
          ${c?Oe([...r.entries()],([e])=>e,([e,t])=>this._renderAreaSection(e,t)):q`<div class="device-grid" style="--cols:${o?.columns??this._config.columns??3}">
                ${Oe(n,e=>e.device_id,e=>this._renderTile(e,this._config.area_styles?.[e.area??""]?.tile_style))}
              </div>`}
        </div>
        ${this._renderExtraCards(es(this._config,o??void 0,"footer_cards"))}
      </ha-card>
    `;return b}_renderAttention(e){if(!1===this._config.show_attention)return q``;const t=vs(e,this.hass.states,{batteryBelow:this._config.attention_battery,includeBeta:this._config.include_beta_updates}),i=!1===this._config.show_firmware_summary?[]:function(e,t=[]){const i=new Set(t.map(e=>e.toLowerCase())),s=new Map;for(const t of e){if(null==t.sw_version||""===t.sw_version)continue;const e=t.integration||"other";i.has(e.toLowerCase())||(s.has(e)||s.set(e,[]),s.get(e).push(t))}return[...s.entries()].map(([e,t])=>({integration:e,groups:ms(t),total:t.length})).filter(e=>e.groups.length>1).sort((e,t)=>t.groups.length-e.groups.length||t.total-e.total||e.integration.localeCompare(t.integration))}(e,this._config.attention_muted_integrations??[]),s=i.length>0,o=ws(t),{shown:a,muted:n}=function(e,t){if(!t?.length)return{shown:e,muted:[]};const i=new Set(t.map(e=>e.toLowerCase()));return{shown:e.filter(e=>!i.has(e.integration.toLowerCase())),muted:e.filter(e=>i.has(e.integration.toLowerCase()))}}(o,this._config.attention_muted_integrations),r=function(e){return e.reduce((e,t)=>e+t.items.length,0)}(a);if(!r&&!n.length&&!s)return q``;const l={offline:"○",alert:"▲",battery:"▮",update:"↑"},c=e=>["offline","alert","battery","update"].find(t=>e.kinds.includes(t)),d=this.preview||this.hasAttribute("data-edit-preview"),p=(e,t)=>d?q`<button class="att-mute" title=${it(t?"attention.unmute":"attention.mute")}
          @click=${t=>{t.stopPropagation(),window.dispatchEvent(new CustomEvent("hdd-attention-mute",{detail:{integration:e}}))}}>${t?"🔔":"🔕"}</button>`:Y,h=e=>q`
      <button class="att-row att-${c(e)}" @click=${()=>{this._detailDevice=e.device.device_id}}>
        <span class="att-icon">${l[c(e)]}</span>
      ...
      </button>`,u=a.length<=1&&!n.length,g=new Map;for(const e of new Set([...a,...n].map(e=>e.integration).concat(i.map(e=>e.integration)))){const t=ni(e);g.set(t,(g.get(t)??0)+1)}const v=e=>{const t=ni(e);return(g.get(t)??0)>1?e:t};return q`
      <div class="attention">
        <div class="att-hdr" @click=${()=>{this._attentionOpen=!this._attentionOpen}}>
          ...
          ${r?q`<span class="att-count">${r}</span>`:Y}
          ${s?q`<span class="att-fw-chip">${1===i.length?it("header.firmware_versions",{n:i[0].groups.length}):it("header.firmware_mixed",{n:i.length})}</span>`:Y}
        </div>
        ${this._attentionOpen?q`
          <div class="att-body">
            ${u?a.flatMap(e=>e.items).map(h):a.map(e=>q`
                  <div class="att-grp">
                    <div class="att-grp-hdr">
                      <span class="att-icon att-${e.worst}">${l[e.worst]}</span>
                      <span class="att-grp-name">${v(e.integration)}</span>
                      <span class="att-grp-n">${e.items.length}</span>
                      ${p(e.integration,!1)}
                    </div>
                    ${e.items.map(h)}
                  </div>`)}
            ${n.length?q`
              <div class="att-muted">
                <span class="att-muted-lbl">${it("attention.muted")}</span>
                ${n.map(e=>q`
                  <span class="att-muted-chip">${v(e.integration)}
                    <span class="att-grp-n">${e.items.length}</span>
                    ${p(e.integration,!0)}
                  </span>`)}
              </div>`:Y}
            ${s?q`
              <div class="att-fw">
                ...
                ${i.map(e=>q`
                  ${i.length>1?q`
                    <div class="att-fw-int">${v(e.integration)}</div>`:Y}
                  ${e.groups.map(e=>q`
                    <div class="att-fw-row ${e.current?"current":""}">
                      <span class="att-fw-ver">${e.version}</span>
                      <span class="att-fw-n">${e.devices.length}</span>
                      ${e.current?q`<span class="att-fw-tag">${it("header.newest")}</span>`:Y}
                    </div>
                    <div class="att-fw-devs">
                      ${e.devices.map(t=>q`
                        ${(()=>{const i=si(this._profile(t).gen);return q`
                            <button class="att-fw-dev" @click=${()=>{this._detailDevice=t.device_id}}>
                              <span class="att-fw-dev-name">${t.name}</span>
                              ${i?q`<span class="att-fw-dev-gen gen-${this._profile(t).gen}">${i}</span>`:Y}
                              <span class="att-fw-dev-ver">${e.version}</span>
                              ${t.area?q`<span class="att-fw-dev-area">${t.area}</span>`:Y}
                            </button>`})()}`)}
                    </div>`)}`)}
              </div>`:Y}
          </div>`:Y}
      </div>`}_renderExtraCards(e){if(!e?.length)return q``;const t=this.preview||this.hasAttribute("data-edit-preview"),i="match"===ts(this._config,this._getActiveView()??void 0);return q`
      <div class="extra-cards ${i?"xc-match":""}">
        ${e.map(e=>q`
          <hdd-card style=${ke(this._extraCardGrid(e))}
            .hass=${this.hass} .config=${e} .preview=${t}></hdd-card>`)}
      </div>`}_renderGridCards(e,t){if(!e?.length)return Y;const i=this.preview||this.hasAttribute("data-edit-preview"),s="match"===ts(this._config,this._getActiveView()??void 0);return q`${e.map(e=>q`
      <hdd-card class="grid-card ${s?"xc-match":""}"
        style=${ke(this._gridCardSpan(e,t))}
        .hass=${this.hass} .config=${e} .preview=${i}></hdd-card>`)}`}_gridCardSpan(e,t){const i=e.grid_options;return i&&"object"==typeof i?"full"===i.columns?{"grid-column":"1 / -1"}:"number"==typeof i.columns&&i.columns>1?{"grid-column":`span ${Math.min(Math.round(i.columns),Math.max(1,t))}`}:{}:{}}_extraCardGrid(e){const t=e.grid_options;if(!t||"object"!=typeof t)return{};const i={},s=t.columns;"number"==typeof s&&s>0&&s<12&&(i["grid-column"]=`span ${Math.round(s)}`);const o=t.rows;return"number"==typeof o&&o>1&&(i["min-height"]=`calc(${Math.round(o)} * var(--hdd-grid-row, 56px))`),i}_renderDelegateNotice(e){if(this._config.delegate_controls||this._delegateNoticeDismissed)return q``;const t=e.filter(e=>It(e).length>0).length;if(!t)return q``;const i=this.preview||this.hasAttribute("data-edit-preview"),s=i?q`<button class="dn-link" @click=${e=>{e.stopPropagation(),window.dispatchEvent(new CustomEvent("hdd-editor-goto",{detail:{tab:"design",section:"design-tiles",flash:"delegate_controls"}}))}}>${it("notice.native_controls")}</button>`:q`<b>${it("notice.native_controls")}</b>`;return q`
      <div class="delegate-notice">
        <span class="dn-icon">◈</span>
    ...
    `],e([ve({attribute:!1})],Ys.prototype,"hass",void 0),e([ve({type:Boolean})],Ys.prototype,"preview",void 0),e([fe()],Ys.prototype,"_config",void 0),e([fe()],Ys.prototype,"_closedAreas",void 0),e([fe()],Ys.prototype,"_areaChipOpen",void 0),e([fe()],Ys.prototype,"_graphData",void 0),e([fe()],Ys.prototype,"_periodEnergy",void 0),e([fe()],Ys.prototype,"_periodEnergyErrAt",void 0),e([fe()],Ys.prototype,"_valveDragPos",void 0),e([fe()],Ys.prototype,"_trvDragTemp",void 0),e([fe()],Ys.prototype,"_cloudDetailOpen",void 0),e([fe()],Ys.prototype,"_detailDevice",void 0),e([fe()],Ys.prototype,"_confirmOff",void 0),e([fe()],Ys.prototype,"_detailHistoryRange",void 0),e([fe()],Ys.prototype,"_activeViewId",void 0),e([fe()],Ys.prototype,"_delegateNoticeDismissed",void 0),e([fe()],Ys.prototype,"_discoveryNoticeDismissed",void 0),e([fe()],Ys.prototype,"_attentionOpen",void 0),e([fe()],Ys.prototype,"_dimFeedback",void 0),Ys=qs=e([he("ha-device-dashboard")],Ys);const Ks=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Ks(e,t);return!0},Xs=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Qs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),eo(t)}};function Zs(e){void 0!==this._$AN?(Xs(this),this._$AM=e,Qs(this)):this._$AM=e}function Js(e,t=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)Ks(s[e],!1),Xs(s[e]);else null!=s&&(Ks(s,!1),Xs(s));else Ks(this,e)}const eo=e=>{e.type==be&&(e._$AP??=Js,e._$AQ??=Zs)};class to extends we{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Qs(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ks(this,e),Xs(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const io=new WeakMap,so=ye(class extends to{render(e){return Y}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Y}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=io.get(t);void 0===i&&(i=new WeakMap,io.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?io.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),oo=ye(class extends we{constructor(){super(...arguments),this.key=Y}render(e,t){return this.key=e,t}update(e,[t,i]){return t!==this.key&&(Ie(e),this.key=t),i}});function ao(e,t){return t?[...e,""]:[...e]}function no(e,t,i){const s=new Set(t),o=e.filter(e=>!s.has(e));return i&&o.push(...s),o.length?[...new Set(o)]:void 0}const ro={kind:"global"};function lo(e,t){switch(t){case"tile":return!0;case"container":return"global"===e.kind||"view"===e.kind||"room"===e.kind;case"chrome":return"global"===e.kind||"view"===e.kind}}function co(e){switch(e.kind){case"global":return"global";case"view":return`view:${e.id}`;case"room":return`room:${e.name}`;case"type":return`type:${e.profile}`;case"device":return`device:${e.id}`}}function po(e,t){switch(e.kind){case"global":return"Global";case"view":return`View · ${t.viewName(e.id)}`;case"room":return`Room · ${e.name||"No room"}`;case"type":return`Type · ${e.profile}`;case"device":return`Device · ${t.deviceName(e.id)}`}}const ho={tile:["theme","color","tile_style","power_monitor_variant","tile_layout","sensors","show_graphs","elements","energy_period"],container:["columns","tile_size","tileGap","tile_gap"],chrome:["style","extra_card_style","area_card_placement"]},uo=["bg_image","bg_image_size","tile_icon","tile_icon_off","tile_icon_speed","tile_icon_size","entity_animations","extra_sensors","radio_stations","input_actions","confirm_off"],go=[...ho.tile,...ho.container,...ho.chrome];function vo(e){return"device"===e.kind?[...go,...uo]:go}function fo(e){let t=(e??"").trim();if(t&&(t=t.replace(/^[a-z]+:\/\//i,""),t=t.split("/")[0].split(":")[0],/^[a-z0-9][a-z0-9.-]+\.[a-z]{2,}$/i.test(t)))return`https://${t}`}function mo(e,t,i=!1){if(e){if(/^https?:\/\//i.test(e))return e;if(e.startsWith("images/")){return"https://control.shelly.cloud/"+(i?e.replace(/_m\.(jpe?g|png)$/i,"_l.$1"):e)}if(e.startsWith("assets/")){const s=i?e.replace(/thumb_(?=[^/]+$)/,""):e;return`${t.replace(/\/$/,"")}/shelly_files/${s}`}}}function bo(e){return!!e&&e.startsWith("images/room_def/")}function yo(e){const t=/^([0-9a-f]{12})(?:_\d+)?$/i.exec(e??"");return t?t[1].toLowerCase():void 0}const wo=e=>e.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\s+/g," ").trim();function xo(e,t){const i=new Map;for(const e of t){const t=new Set;for(const[i,s]of e.connections??[])"mac"===i&&t.add(s.replace(/[:-]/g,"").toLowerCase());for(const[i,s]of e.identifiers??[])"shelly"===i&&/^[0-9a-f]{12}$/i.test(s)&&t.add(s.toLowerCase());for(const s of t){const t=i.get(s)??[];t.push(e.id),i.set(s,t)}}const s=new Map;for(const t of e){const e=yo(t.id);if(!e)continue;const o=i.get(e);o?.length&&s.set(e,o)}return s}const _o=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"discovery",label:"Discovery"},{id:"lights",label:"What counts as a light"},{id:"extra-cards",label:"Extra cards"}]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"design",label:"Design",icon:"◈",sections:[{id:"design-scope",label:"Scope"},{id:"design-panel",label:"Controls for the selected scope"},{id:"theme",label:"Colour theme"},{id:"content",label:"Chips & metrics"},{id:"tiles",label:"Tiles"},{id:"electrical",label:"Sensor chips — Electrical"},{id:"environmental",label:"Sensor chips — Environmental"},{id:"deviceinfo",label:"Sensor chips — Device info",advanced:!0},{id:"alerts",label:"Sensor chips — Alerts",advanced:!0},{id:"header",label:"Header"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours"},{id:"typography",label:"Typography",advanced:!0}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}],ko=[{id:"cascade",title:"Why a setting sometimes does nothing",body:["Almost every visual option can be set at several levels, and the most specific one wins. The order is: this device → this device type → this room → this view → the whole card → the built-in default.","That is why a per-device colour beats a room colour, and why a card-wide `tile_style` beats the per-profile defaults that `smart_tile_styles` turns on — the card-wide value is more specific than a built-in default, so smart styles never get a look in. Set styles per device type instead of card-wide if you want both.","For blocks there is one extra rung: a saved custom style's own layout sits above the room and card-wide values, since choosing a saved look is more deliberate than leaving the global default in place.","The editor flags the common cases for you — see Conflicts."]},{id:"design-scopes",title:"Where a setting lives",body:["Everything about how the card looks is in one tab: **Design**. It is *scope-first* — you pick **where** you are editing, and the same control list redraws for that layer. Global, a view, a room, a device type, or one device.","Pick the scope in the map at the top. Devices are grouped by room, type or integration; room and type headings are clickable because they are layers you can style, while an integration is only a way to find a device. The number on a chip is how many settings that layer overrides, so you can see where customisation lives without opening everything.","Every control says where its value is coming from — **set here**, with a ↺ to drop it, or **from Room · Kitchen** / **from Card**. Most specific wins, always.","What you can set depends on the layer, and the tab says why. There are three groups. **Tile** settings — theme, colour, tile style, blocks, chips, graphs, energy window — can be set anywhere: device, type, room, view, card. **Container** settings — columns and tile size — stop at the room, because a grid needs something to hold it and one device has no column count. **Card chrome** — the header, the card surface, typography — only a view or the card can set, because a room does not contain the card's header.","Two scopes also hold settings with no ladder under them at all. Global has the theme picker, chips & metrics, tiles, the sensor-chip groups, and the card's own header and type. A room has **Room chrome** — the room block's backdrop photo, tile gap, header colours, borders, per-room header chips and button shapes — things that exist exactly once per room.","A shortcut worth knowing: in the card editor, tapping a device tile in the **live preview** jumps straight to that device's scope in Design — same landing as the ✎ button in Rooms & devices. Buttons and sliders on the tile still work normally, so you can test controls in the preview too."]},{id:"content-defaults",title:"Global defaults vs. per-room overrides",body:["The **Chips & metrics** section in Design (at Global scope) sets three things card-wide: which chips each room header shows, which window the energy readout totals (Total / Today / Week / Month), and which sensor chips appear on tiles. Treat it as the first stop — decide what data is on show, then style it.","These are *defaults*. Every room and device inherits them, but any room or device can override any of them — by picking that room or device as the scope in Design — and the moment it does, it stops listening to the global. A global toggle only moves scopes that are still inheriting: turning a chip on globally will **not** turn it on in a room that has set its own chips, and turning it off will not turn it off there.",'Each picker tells you which state it is in. **Inheriting from …** means a global change still reaches it; **Custom selection** means it is pinned to its own value. Setting a room or device to an empty selection is itself a custom choice ("show none"), not the same as inheriting.',"To hand control back to the global default, use that scope's reset — `↺ Default` for room header chips, `↺ Inherit` for the chip pickers. Room header chips resolve room → global → built-in; energy and sensor chips also allow a per-device override (and, for sensor chips, a per-type one) in front of the room."]},{id:"named-sensors",title:"Computers, servers and anything without a device_class",body:["Most chip and graph settings are keyed by Home Assistant's **device class** — `temperature`, `power`, `battery`. That works for hardware that reports one. Plenty does not: CPU load, memory use, free disk and most figures from a PC, NAS, router, Proxmox or VM host arrive with no device class at all, so no class key can name them.",'Wherever the card asks *which sensors*, you can give a specific **entity id** instead of a class, in the same list. `sensors: [temperature, sensor.davidpc_cpuload]` means "the temperature chip, and that exact reading". The card tells the two apart by the dot — every entity id has one, no device class does.',"A named entity only ever appears on the device that owns it. That is what lets one list configure a whole fleet at once: name your PC's CPU sensor and your router's CPU sensor in the same card-wide list, and each tile picks up only its own.","On the **Sensor card** tile style the first entity you name is also the big number the tile leads with, and the order you name them is the order the chips appear — so naming entities is how you build a tile that shows exactly what you want, in the order you want it.","`graph_sensors` takes the same mixed list, so you can plot readings that have no class either. Named lines are drawn first, in the order given.","In the editor, both pickers carry a **Specific entities** field under the class pills — under **Design → Sensor chips** for a tile, and **Graphs & Sensors → Graph Type** for the graphs. Picked on a single device, it offers that device's own entities; card-wide it offers anything. Ticking **All** leaves the entities you named alone, since no pill stands for them; **None** clears everything."]},{id:"discovery",title:"Discovery: what the card looks at",body:['**Shelly mode** (the default) keeps only Shelly and BTHome devices. Most "my device is missing" reports are simply this.',"**Universal mode** discovers every device in Home Assistant, then narrows it three ways: a *scope* (real devices / controllable only / everything), a built-in deny-list of things that are not really devices (phones, browsers, routers, the supervisor), and your own Hide integrations / Hide entity types lists on top.","The two hide lists resolve in opposite directions, which is worth knowing: for domains, excluding wins; for integrations, `include_integrations` is a force-include that overrides the deny-list. That is how you bring one router back without unhiding all of them.","Shelly devices keep their full-fidelity detection in universal mode — model, generation, per-channel merging — so switching modes never downgrades them."]},{id:"profiles",title:"Profiles, tile styles and blocks are three different things",body:["A **profile** is what the card decides a device *is* — relay, dimmer, cover, sensor, input, and so on — from its entities, refined by Shelly model. It drives the badge, the default chips and the default layout. You can override it per device if the guess is wrong.","A **tile style** is how that device is drawn: the adaptive block tile (`default`), or a purpose-built one (power monitor, light control, climate dial, cover, sensor card, input keypad, scene button).","A **block** is one row of content inside the `default` style only — name row, chips, graph, dimmer, cover controls, and so on. Setting blocks on a device that renders as a power monitor does nothing, because that style does not use blocks; use its Elements instead."]},{id:"hiding",title:"Blocks, elements and chips — which one hides what",body:['**Blocks** reorder and hide the parts of the `default` tile. **Elements** show and hide the parts of every other style (its toggle, graph, secondary readings…) — and carry the odd placement choice, like "Chips in the name row" on the power-monitor and sensor styles, which moves the secondary readings up beside the device name. **Sensor chips** choose which measurements appear as little pills, in any style.',"The editor only offers what applies: pick a power-monitor style and the block grid disappears in favour of that style's elements.","Design narrows to whatever scope you pick: choose one device and it offers only the chips that device can produce and the blocks it can render — an i4 offers only the chips it can actually produce and the blocks it can actually render. Flip **All options** at the top of that panel if you want the full surface back."]},{id:"inputs",title:"Input devices have no output",body:['An input is one of two things, and the card reads which from Home Assistant. A **button** input is momentary — it reports presses (single, double, long) on an `event` entity, and its row shows the last press and how long ago. A **switch** input is steady — it reports its position on a `binary_sensor`, and its row shows an ON/OFF pill. Relays have inputs too: a Plus 1PM\'s "Input 0" is the wall switch wired to it.',"An input that is wired to an output on its own device (`input_0` → `switch_0`) needs no setup: tapping its row toggles that output, and the row lights with the output's state. That is the one thing the physical input does that Home Assistant can replay.",'A Shelly i3, i4 or UNI has no output of its own — it reports presses and controls nothing by itself, so the card cannot "push" a channel for you. What it can do is run the same thing the physical button runs. In Design, pick the device as the scope and use **Input actions**: give a channel an action and its row becomes a key — tap toggles an entity or runs a script, hold dims the target light (alternating direction each hold, like a wall dimmer), double-tap runs a second action, and an optional dropdown exposes a `select` entity such as WLED presets.',"A key that toggles something lights up while that thing is on, so the tile doubles as a status display. A key that runs a script stays neutral — the card cannot know a script's state and will not pretend to. Channels you have not wired stay as status rows; tapping one opens its press history."]},{id:"lights",title:"What counts as a light",body:["The **Lights** header chip counts `light` entities that are on. A relay or plug wired to a lamp is a `switch` as far as Home Assistant is concerned — it has no way to know what is on the other end of the wire, and neither does the card.","You do. Label those devices in Home Assistant (Settings → Areas & labels), then tick the label under **Header → What counts as a light**. Every `switch` on a labelled device is counted from then on. The picker only offers labels that exist on your devices, with how many carry each.","For the stragglers a label does not cover, name entities directly in the same panel. A device caught by both routes is still counted once."]},{id:"themes",title:"Themes and colours",body:["The **theme** is authoritative: every colour comes from the preset you pick. The `style` block holds only colours you deliberately changed on top.","**Follow HA** is the exception: instead of a palette it points every colour at Home Assistant’s own theme variables, so the card matches whatever HA theme is active and follows it into light or dark. Available per card, per view and per room like any other theme.","Picking a theme clears those overrides, so the editor offers to save your current colours first — they come back under a ★ Saved entry in the theme picker.","Older configs wrote the whole palette into `style`, which shadowed the theme and made switching it do nothing. Those are migrated automatically on load: a palette that exactly matches a preset collapses back to the theme name, while a partial palette is left alone as the genuine override it is.","A **view** and a **room** can each take a theme of their own, resolved room → view → card. A view theme repaints the whole card, header included, while that view is showing, and outranks the colours in `style`. A room theme repaints what the room contains — its block background, tiles, text, accent and its own header — but not the card header, which no room encloses; the room's individual colour fields still override it key by key."]},{id:"energy",title:"Energy: totals versus windows",body:["By default the energy chip shows a device's lifetime total, straight from its own sensor. Switch it to Today, This week or This month and the card asks the recorder for consumption over that window instead — no helper entities required.","A device with several energy sensors (a Pro 4PM has one per channel) is summed, not sampled, so a multi-channel device is not under-counted.","If you already keep a Utility Meter for a device, point `energy_entity` at it. That replaces the device's own energy chips everywhere — tile, room total and header — so the override never sits next to the raw numbers it stands in for."]},{id:"attention",title:"Needs attention",body:["A fifty-device dashboard hides its own problems — three offline devices among fifty tiles is something you scroll past. The summary above the rooms answers the question the tiles cannot: which ones.","It lists offline devices, firing alerts, flat batteries and pending updates, worst first. Each row opens that device. It is invisible when nothing qualifies, so it costs nothing on a good day.","An offline device is reported as offline and nothing else — its last alert reading is stale, not news.","The firmware block groups the fleet by version and marks the newest, so a device left behind on an old build is obvious. It appears only when more than one version is running.",'**Beta firmware does not count as an update.** A Shelly exposes a `beta_firmware` entity that is on nearly permanently — on one real fleet that was 21 of 25 "available updates". Turn on `include_beta_updates` if you actually run betas.']},{id:"conflicts",title:"The Conflicts panel",body:["When a setting is overridden or ignored, a badge appears above the editor tabs. It exists because the failure is otherwise silent — the option is valid, it just never applies.","It watches for: a theme its `style` block contradicts, smart tile styles masked by a card-wide style, discovery filters set while in Shelly mode, an integration or domain in both the include and exclude lists, the Native controls block with the feature switched off, a saved style that no longer exists, styling attached to a device or room that is gone, input actions pointing at missing entities, hide lists that hide absolutely everything, keys the card does not read at all, and an input action whose channel has been renamed out from under it.","Nothing there is an error — a stale block is harmless. It is a list of things that are not doing what they look like they are doing."]}],Ao=[{id:"first-run",title:"Start from scratch",body:["A new card discovers your Shelly and BTHome devices and groups them by room. Everything below is optional."],steps:["Edit dashboard → Add card → HA Device Dashboard.",'To include non-Shelly devices: Rooms & devices → Discovery → Universal, then pick a scope. Start with "Real devices".',"Set the look once under ◆ Defaults (theme, columns, tile size).","Use ◆ Defaults → Reset look if you want the factory appearance back without losing rooms, devices or actions."]},{id:"one-device",title:"Use the card for a single device",body:["The card is built for a fleet, but nothing stops it being one tile on an ordinary dashboard — a plug beside your other cards, with the same tile styles, graphs and confirmation you use everywhere else."],steps:['Rooms & devices → turn on Advanced → "Show only these devices" → tick the one you want.','Design → Global → Header → turn off "Show the header", unless you want its one-device summary.','Design → Global → Header → turn off "Group by room" so there is no room heading over a single tile, and set Columns to 1. (Per-view, the same switch lives in Views.)','Everything else still applies: pick a tile style, turn on graphs, set "Ask before turning off" if it is a load you do not want to lose.']},{id:"confirm-off",title:"Guard a device you must not switch off by accident",body:["A freezer, a server, the router, the heating — a mis-tap costs you something real. Turning the device ON is never confirmed, so the guard only slows you down in the direction that hurts.","It is set per device on purpose. Two identical plugs in the same room can disagree, which is what you want: arming a whole type or room would put the prompt in front of you constantly and train you to tap straight through it."],steps:["Design → pick the device in the scope picker.",'Under "Safety — this device only", turn on "Ask before turning off".','Tapping OFF now opens a prompt. Cancel is the wide button; the red "Turn off" is the narrow one.',"It covers every on/off the card draws for that device, including the per-channel relay rows and the detail sheet. It cannot cover a control drawn by Home Assistant itself under Native controls."]},{id:"extra-card-layout",title:"Show an embedded card only sometimes, or put two side by side",body:["Cards you embed under Extra cards are rendered by Home Assistant itself, so anything a card can normally do in a dashboard it can do here."],steps:["Extra cards → pick the placement (header, footer or a room) → Add card.","Edit it with Home Assistant's own form for that card type, or switch to YAML — the value carries across either way. A card that ships no visual editor falls back to YAML and says so.","The Preview underneath draws the card as you go, exactly as the dashboard will — including an error card if the config is wrong.",'Header and footer cards can differ per view: set "Applies to" to a view and that view gets its own list, replacing the card-wide one. An empty list on a view means no cards there at all. "Use the card-wide list" clears the override.',"Use ▲ ▼ on a row to reorder.",'For a room, "Where in the room" puts the cards above the tiles (a strip) or among them (each card takes a tile\'s place). In the grid, grid_options.columns counts tiles rather than twelfths.',"Set Look to \"Match this card\" and embedded cards take the dashboard's background, border, radius, text and accent instead of Home Assistant's theme — so they sit in the card rather than on it. A card that hard-codes its own colours keeps them.","To show it conditionally, give the card a `visibility:` block — the same state, user and screen conditions a dashboard card takes. A card hidden by its condition leaves no gap.","To make it narrower, give it `grid_options: {columns: 6}` — the strip is twelve columns wide, so two sixes sit side by side. Leave `grid_options` out for full width.","`rows` sets a minimum height; the strip grows to fit its content rather than clipping."]},{id:"hide-onoff",title:"Hide the on/off button on a tile",body:["For a device you only want to watch, or one whose switching belongs somewhere else."],steps:["Design → pick the scope (device, type, room, view or Global).",'Open the tile style block and untick "On/off button".',"Available on the default, Power and Light tile styles — the three that draw a primary on/off button.","The device can still be switched from its detail sheet; this hides the button on the tile."]},{id:"quiet",title:"Quieten a noisy universal dashboard",body:["Universal mode surfaces everything, including things that are not really devices. Two lists trim it."],steps:["Rooms & devices → Discovery.","Open Hide integrations and tick what you do not want. Use Hide all, then untick the few you do want.","Do the same in Hide entity types for whole domains such as update or camera.","Still too much? Drop the scope from Everything to Real devices."]},{id:"cloud-import",title:"Import your Shelly app setup",body:["Coming from the Shelly app? The card can pull each room's photo and the official product image for every device from your Shelly Cloud account. The auth key is used for the one fetch and never saved; imported images stay hosted on Shelly's cloud."],steps:["Get your key: control.shelly.cloud → user settings → Authorization cloud key. Note the server shown next to it.","Rooms & devices → Import from Shelly Cloud → paste both → Fetch my Shelly setup.","Pair any cloud rooms that did not auto-match with a room here (name matching ignores accents).","Pick what to import — room photos, product images on tiles, full-size vs thumbnails — and Apply.","A custom room photo's cloud URL is unlisted but not private. Swap in a /local/… photo later if that matters.","To invalidate a key you have shared or leaked, change your Shelly account password — the key only rotates with it."]},{id:"room-style",title:"Give one room its own look",body:["Room styling is keyed by the room name, so renaming an area in Home Assistant orphans it — the Conflicts panel will tell you."],steps:["Design → Scope → pick the room (or expand it to reach one device).","Pick the room, then set its colours, tile style, columns or backdrop.","Anything you leave alone keeps inheriting from the card-wide settings."]},{id:"wire-input",title:"Make an i3 / i4 button control a light",body:["The card only reacts to taps on the screen — it cannot give the wall button a job. The physical press is handled by the Shelly's own action/script or by a Home Assistant automation, and which of those you have decides the setup.","A relay with its own output (a 1PM, a Dimmer) needs none of this: its input toggles its own relay by default."],steps:["Design → Scope → expand a room → pick the switch → Input actions.",'No automation, Shelly handles the wall itself: choose "Toggle entity" and enter the light, e.g. light.hall. Several entities work too, comma separated.','An automation already reacts to the button (a Shelly "Button N single push" device trigger): choose "Replay the press" instead — the row fires the same event the wall does, the automation runs, and nothing is configured twice. Hold and double tap can replay long and double pushes the same way.','Set "On hold" to "Dim the light while held" for a dimmer. Hold brightens, release, hold again darkens.',"Optionally set a double-tap action, or point the Dropdown field at a select entity such as select.wled_preset.",'If the switch does not show a keypad, its tile style is set elsewhere — set Device type "Input" to the Inputs style, or use the per-type panel.']},{id:"extra-sensors",title:"Show a reading from another device on a tile",body:["A Wall Display XL has a light sensor but no temperature or humidity sensor; the room's readings come from a BLU H&T beside it. Borrow them and the tile shows them as its own — chips, graphs, gauge rings and the detail sheet included."],steps:["Design → Scope → expand the room → pick the device → Extra sensors.","Search for the sensor entity on the other device (sensor.blu_ht_temperature, say) and pick it. Several work.","The other device keeps showing the reading too, and a borrowed sensor never decides whether this device counts as online."]},{id:"colours",title:"Roll a colour scheme",body:["The theme picker can roll a look for you, and keep the ones you like as named palettes."],steps:["Design → Colour theme. Global sets the card; pick a view, room, type or device first to set one just there.","🎲 Random lands on one of the built-in presets.","✨ Surprise me generates a palette from a random hue instead. Every text colour is contrast-checked against the surface behind it, so a roll is never unreadable.","💾 Save keeps the colours you are looking at under a name — including a preset you have tweaked. Saved palettes appear as ★ swatches in the picker; ✕ on a swatch forgets it.","Rolling stashes the current colours as “Before roll” first, and picking a preset stashes them as “Before theme change”, so neither is a one-way door."]},{id:"snapshots",title:"Save a setup you can get back",body:["Snapshots capture the whole card config. Slots live in this browser; the file export is what moves between devices."],steps:["Toolbar → 💾 Save → name it.","To restore: 📂 Load → pick it from the list.","Before anything drastic, use 📂 Load → Export to file and keep the JSON somewhere safe.","A config with embedded background photos can outgrow browser storage — if it warns you, use the file export."]},{id:"native",title:"Show media players, locks, fans and vacuums",body:["The card does not draw these itself; it can embed Home Assistant's own controls for them."],steps:["Design → Tiles (Global scope) → turn on Native controls.","It is off by default because each one embeds a native element, which costs render time on a large media fleet.",'The controls appear as the "Native controls" block on the default tile style.']},{id:"views",title:"Split a big dashboard into views",body:["Views are tabs inside the card, each with its own filter and layout — useful once one scrolling wall stops being readable."],steps:["Views → Add view, name it, give it an icon.","Filter it by room, device type, or specific devices.","Override columns, tile size or tile style per view if that view needs a different density.","Pin the handful of devices you touch daily with Favourites, and let a view show only those."]}],So=e=>Math.random()<e;const Co=(e,t,i)=>{const s=t/100*Math.min(i/100,1-i/100),o=t=>{const o=(t+e/30)%12,a=i/100-s*Math.max(-1,Math.min(o-3,9-o,1));return Math.round(255*a).toString(16).padStart(2,"0")};return`#${o(0)}${o(8)}${o(4)}`},$o=e=>{const t=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255).map(e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4);return.2126*t[0]+.7152*t[1]+.0722*t[2]},Eo=(e,t)=>{const[i,s]=[$o(e),$o(t)].sort((e,t)=>t-e);return(i+.05)/(s+.05)};function To(e,t,i,s,o,a){let n=i;for(let i=0;i<40;i++){const i=Co(e,t,n);if(Eo(i,s)>=o)return i;if(n+=a?2:-2,n>98||n<2)break}return Co(e,t,a?98:2)}var Io;const Mo=["alarm-panel","area","button","calendar","clock","conditional","energy","entities","entity","entity-filter","gauge","glance","grid","heading","history-graph","horizontal-stack","humidifier","iframe","light","logbook","map","markdown","media-control","picture","picture-elements","picture-entity","picture-glance","plant-status","sensor","shopping-list","statistic","statistics-graph","thermostat","tile","todo-list","trend","vertical-stack","weather-forecast"],Do=[["Name","name"],["Power","power"],["Online","online"],["Room","area"]];let Oo=!1;const zo=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"},{key:"vibration",label:"Vibration",unit:"",defaultColor:"#f87171"}]}],Po=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"media_controls",label:"Media controls",sub:"the card’s own player: now playing, play/pause, volume, browse"},{id:"delegated_controls",label:"Native controls",sub:"HA’s own controls for locks, fans, vacuums — needs Native controls on"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],Ro=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"input-control",label:"Inputs",icon:"⌨",desc:"Channel keypad"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],Bo=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}];let Lo=Io=class extends de{constructor(){super(...arguments),this._tab="devices",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._resetArmed=!1,this._viewDeleteArmed=null,this._xcPlacement="header",this._xcRoom="",this._xcView="",this._xcAdding=!1,this._xcEditIndex=null,this._xcDraft=null,this._xcLatest=null,this._xcDraftKey=0,this._xcMode="form",this._xcFormEl=null,this._xcFormType=null,this._xcFormUnavailable=!1,this._xcPreview=null,this._xcDashboards=null,this._xcImportCards=null,this._xcImportLoading=!1,this._palettes={},this._paletteNaming=!1,this._paletteName="",this._expandedViewIds=new Set,this._openSections={rooms:!0,theme:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1,"design-scope":!0,"design-panel":!0},this._haPickersReady=!1,this._iaAllEntities=null,this._expandedRooms=new Set,this._designScope=ro,this._designGroupBy="room",this._designOpenGroups=new Set,this._designScopeLoaded=!1,this._changesOpen=!1,this._changesResetArmed=!1,this._selectedDeviceId=null,this._conflictsOpen=!1,this._flashControl=null,this._flashTimer=null,this._snapshots={},this._snapMenu=null,this._snapName="",this._snapMsg=null,this._helpOpen=!1,this._helpFilter="",this._helpTopic=null,this._rolled=null,this._styleClipFeedback="",this._openDiscDropdown=null,this._sciServer="",this._sciKey="",this._sciBusy=!1,this._sciError="",this._sciDone="",this._sciData=null,this._sciRoomMap={},this._sciOptRooms=!0,this._sciOptDevices=!0,this._sciOptStock=!1,this._sciOptFull=!0,this._iconPickerState=null,this._onEditorGoto=e=>{const t=e.detail;if(t?.device)return e.preventDefault(),void this._gotoDevice(t.device);t?.tab&&t.section&&t.flash&&(e.preventDefault(),this._gotoControl(t.tab,t.section,t.flash))},this._editorLayoutTimers=[],this._onAttentionMute=e=>{const t=e.detail?.integration;if(!t)return;const i=this._config?.attention_muted_integrations??[],s=i.includes(t)?i.filter(e=>e!==t):[...i,t];this._set("attention_muted_integrations",s.length?s:void 0)},this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._wheel=null,this._closeWheel=()=>{const e=this.renderRoot.querySelector("#ha-dd-color-wheel");e?.hidePopover&&e.matches(":popover-open")&&e.hidePopover(),this._wheel=null},this._onWheelOutsideClick=e=>{if(!this._wheel)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-color-wheel"===e.id||e.classList?.contains("cw-btn")));t||this._closeWheel()},this._wheelPointer=e=>{if("pointermove"===e.type&&!(1&e.buttons))return;const t=e.currentTarget;"pointerdown"===e.type&&t.setPointerCapture(e.pointerId);const i=t.getBoundingClientRect(),s=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-s,n=e.clientY-o,r=Math.min(1,Math.hypot(a,n)/(i.width/2)),l=(180*Math.atan2(a,-n)/Math.PI+360)%360;this._setWheel({h:l,s:r}),e.preventDefault()},this._emitTimer=null,this._pendingConfig=null,this._devCacheKey="",this._devCache=[],this._layDrag=null,this._layMove=null}_setXcDraft(e){this._xcDraft=e,this._xcLatest=null,this._xcDraftKey++,this._xcPreviewTimer&&(clearTimeout(this._xcPreviewTimer),this._xcPreviewTimer=void 0),this._xcPreview=e,this._ensureXcForm(e,!0)}_queueXcPreview(e){this._xcPreviewTimer&&clearTimeout(this._xcPreviewTimer),this._xcPreviewTimer=setTimeout(()=>{this._xcPreviewTimer=void 0,this._xcPreview=e},400)}setConfig(e){this._config=Ei(e),this._loadAdvanced(),this._loadPalettes()}_stepTab(e){const t=_o.map(e=>e.id),i=t.indexOf(this._tab),s=t[Math.min(t.length-1,Math.max(0,(i<0?0:i)+e))];s&&s!==this._tab&&(this._tab=s,this.updateComplete.then(()=>this._scrollTabIntoView(s)))}_scrollTabIntoView(e){const t=this.renderRoot?.querySelector(`.tab[data-tab="${e}"]`);t?.scrollIntoView({inline:"nearest",block:"nearest",behavior:"smooth"})}_gotoControl(e,t,i){this._tab=e,this._defaultsOpen=!1;const s={[t]:!0};"design"===e&&t.startsWith("design-")&&this._globalSectionDescriptors()[t.slice(7)]&&(this._designScope=ro,s["design-panel"]=!0),this._openSections={...this._openSections,...s},this._flashControl=i,this._flashTimer&&clearTimeout(this._flashTimer),this._flashTimer=window.setTimeout(()=>{this._flashControl=null,this._flashTimer=null},2400),this.updateComplete.then(()=>{this._scrollTabIntoView(e),this.renderRoot?.querySelector(`[data-ctl="${i}"]`)?.scrollIntoView({block:"center",behavior:"smooth"})})}_gotoDevice(e){this._selectedDeviceId=e,this._setDesignScope({kind:"device",id:e}),this._gotoControl("design","design-panel","design-scope")}_lsGet(e){try{const t=localStorage.getItem(e);if(null!==t)return t;const i=localStorage.getItem(`${e}:${this._config?.title??"default"}`);return null!==i&&localStorage.setItem(e,i),i}catch{return null}}_loadSnapshots(){try{const e=this._lsGet(Io.LS_SNAPSHOTS);this._snapshots=e?JSON.parse(e):{}}catch{this._snapshots={}}}_writeSnapshots(e){this._snapshots=e;try{localStorage.setItem(Io.LS_SNAPSHOTS,JSON.stringify(e))}catch{this._snapMsg="Too large for browser storage — use Export instead."}}_saveSnapshot(){const e=this._snapName.trim();if(!e)return;const t=JSON.parse(JSON.stringify(this._config)),i=JSON.stringify(t).length;this._writeSnapshots({...this._snapshots,[e]:{saved:(new Date).toISOString(),config:t}}),this._snapName="",this._snapMenu=null,this._snapMsg=i>1e6?`Saved "${e}" — it is large (${Math.round(i/1024)} KB); export it to a file to be safe.`:`Saved "${e}".`,this._clearSnapMsgSoon()}_applySnapshot(e){this._emitNow(Ei(e)),this._snapMenu=null}_deleteSnapshot(e){const t={...this._snapshots};delete t[e],this._writeSnapshots(t)}_exportSnapshot(e){const t=e?this._snapshots[e]?.config:this._config;if(!t)return;const i=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=`${(e??this._config?.title??"ha-device-dashboard").replace(/[^\w.-]+/g,"-")}.json`,o.click(),URL.revokeObjectURL(s),this._snapMenu=null}async _importSnapshot(e){try{const t=JSON.parse(await e.text()),i="custom:ha-device-dashboard"===t.type?t:t.card;if("custom:ha-device-dashboard"!==i?.type)return this._snapMsg="That file is not a config for this card.",void this._clearSnapMsgSoon();this._applySnapshot(i),this._snapMsg=`Loaded ${e.name}.`,this._clearSnapMsgSoon()}catch{this._snapMsg="Could not read that file.",this._clearSnapMsgSoon()}}_clearSnapMsgSoon(){window.setTimeout(()=>{this._snapMsg=null},4e3)}_renderSnapshotControls(){const e=Object.keys(this._snapshots).sort((e,t)=>e.localeCompare(t));return q`
      ...
      </div>`}_renderHelpPanel(){const e=this._helpFilter.trim().toLowerCase(),t=t=>!e||t.title.toLowerCase().includes(e)||t.body.some(t=>t.toLowerCase().includes(e))||(t.steps??[]).some(t=>t.toLowerCase().includes(e)),i=ko.filter(t),s=Ao.filter(t);return q`
      ...
      </div>`}_openWheel(e,t){const i=qt(e),{h:s,s:o,v:a}=Vt(i?.hex??"#808080");this._wheel={hex:Yt(s,o,a),h:s,s:o,v:a,alpha:i?.alpha??1,unparsed:i?void 0:e||void 0,onSelect:t},this.updateComplete.then(()=>{const e=this.renderRoot.querySelector("#ha-dd-color-wheel");if(e)try{e.showPopover&&!e.matches(":popover-open")&&e.showPopover()}catch{}})}_setWheel(e){if(!this._wheel)return;const t={...this._wheel,...e};t.hex=Yt(t.h,t.s,t.v),t.unparsed=void 0,this._wheel=t,t.onSelect(Gt(t.hex,t.alpha))}_wheelButton(e,t,i="Pick a colour"){return q`
      <button class="cw-btn" style="background:${e}" title=${i}
        @click=${i=>{i.stopPropagation(),this._openWheel(e,t)}}></button>`}_renderColorWheel(){const e=this._wheel,t=[...new Set([...Ai.map(e=>e.defaultColor),"#ffffff","#e2e8f0","#94a3b8","#4b5563","#000000"])],i=e?50+50*e.s*Math.sin(e.h*Math.PI/180):50,s=e?50-50*e.s*Math.cos(e.h*Math.PI/180):50;return q`
      <div popover="manual" id="ha-dd-color-wheel" class="cw-pop" @click=${e=>e.stopPropagation()}>
        ${e?q`
          ...
          <div class="cw-row">
            <span class="cw-swatch" style="background:${Gt(e.hex,e.alpha)}"></span>
            <input type="text" class="inline-text" style="width:90px;font-family:monospace" .value=${e.hex} maxlength="7"
              @change=${e=>{const t=e.target.value.trim();if(/^#[0-9a-f]{6}$/i.test(t)){const{h:e,s:i,v:s}=Vt(t);this._setWheel({h:e,s:i,v:s})}}}/>
          ...
          <div class="cw-presets">
            ${t.map(t=>q`
              <span class="cw-preset ${t===e.hex?"on":""}" style="background:${t}" title=${t}
                @click=${()=>{const{h:e,s:i,v:s}=Vt(t);this._setWheel({h:e,s:i,v:s})}}></span>`)}
          </div>`:Y}
      ...
      </span>`}_chipPicker(e,t,i,s,o,a){const n=t??[],r=void 0!==e,l=t=>!o||o.has(t)||(e??[]).includes(t),c=zo.map(e=>({...e,items:e.items.filter(e=>l(e.key))})).filter(e=>e.items.length),d=zo.flatMap(e=>e.items.map(e=>e.key)).filter(l),p=new Set(r?e:n.length?n:d);return q`
      <div class="chip-picker">
        <div class="chip-picker-hdr">
          <span class="chip-picker-state">${r?"Custom selection":`Inheriting from ${i}`}</span>
          ${this._selAllNone(()=>s(Ss(e??n,d)),()=>s([]))}
      ...
      </div>`}_badge(e,t,i){return q`<span class="sec-badge" style="color:${t};background:${i}">${e}</span>`}_renderDevicesTab(){const e=this._config,t=this._getAreas(),i=e.areas,s=this._allDevices().map(e=>({device_id:e.device_id,name:e.name,area:e.area})).sort((e,t)=>e.name.localeCompare(t.name)),o=e.hidden_devices??[],a=new Map;for(const e of s){const t=e.area??"";a.has(t)||a.set(t,[]),a.get(t).push(e)}const n=ao(t.map(e=>e.name),a.has("")),r=n,l=e=>{this._set("areas",function(e,t,i){const s=new Set(void 0===t?e:t);return s.has(i)?s.delete(i):s.add(i),e.every(e=>s.has(e))?void 0:[...s]}(r,i,e))},c=void 0===i?r.length:i.length,d=this._badge(`${c} / ${r.length}`,"#4ade80","rgba(74,222,128,0.1)"),p=a.get("")?.length??0,h=q`
      <div class="rooms-toolbar">
        ...
        <div class="toolbar-group">
          ...
          ${this._pills(e.sort_by??"name",Do,e=>this._set("sort_by",e))}
        </div>
        <div class="toolbar-group">
      ...
      ${e.favorites?.length?(()=>{const t=Io.FAV_ROW_KEY,i=(e.favorites??[]).map(e=>s.find(t=>t.device_id===e)).filter(Boolean),a=this._expandedRooms.has(t),n=!(!e.area_styles?.Favourites||!Object.keys(e.area_styles.Favourites).length);return q`
            ...
            <div class="room-expanded">
              ${i.length>1?q`
                <div class="room-devices-hdr">
                  ...
                  ${this._selAllNone(()=>this._set("hidden_devices",no(o,i.map(e=>e.device_id),!1)),()=>this._set("hidden_devices",no(o,i.map(e=>e.device_id),!0)))}
                </div>`:Y}
      ...
      ${n.map(t=>{const s=t||"No Room",n=a.get(t)??[],r=(e=>{return s=e,void 0===(t=i)||t.includes(s);var t,s})(t),c=this._expandedRooms.has(t),d=!(!e.area_styles?.[t]||!Object.keys(e.area_styles[t]).length);return q`
          <div class="room-row">
          ...
          ${c?q`
            <div class="room-expanded">
              ...
              ${n.length>1?q`
                <div class="room-devices-hdr">
                  <span class="room-devices-lbl">Devices</span>
                  ${this._selAllNone(()=>this._set("hidden_devices",no(o,n.map(e=>e.device_id),!1)),()=>this._set("hidden_devices",no(o,n.map(e=>e.device_id),!0)))}
                </div>`:Y}
              <div class="room-devices">
      ...
      </div>`}_renderDiscoverySection(){const e=this._config,t="universal"===e.mode,i=e.universal_scope??"devices",s=this.hass?ri(this.hass):{integrations:[],domains:[]},o=q`
      <div class="field">
      ...
      ${t?q`
        ...
        ${this._renderCheckDropdown("disc-int","Hide integrations",s.integrations.map(e=>({value:e,label:ni(e)})),e.exclude_integrations??[],e=>this._set("exclude_integrations",e),"Tick the integrations to drop. The built-in list (phones, browsers, routers…) is always hidden on top of these.")}
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?q`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const o=`custom:${t}`;return this._renamingStyle===t?q`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${so(e=>e?.focus())}/>`:q`<span class="pill ${e===o?"on":""}" @click=${()=>s(o)}>
                ${i.label||t}
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>Po.find(t=>t.id===e)?.label??e)(e)}</span>`,l=this._config.style?.accent_color??"#f4601e";return q`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${o.map((e,t)=>q`
            <div class="lay-row">
              ${e.map((e,i)=>r(e,t,i))}
              ${e.length<Io.ROW_MAX?q`<span class="lay-slot">drop here</span>`:Y}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=Bt[e];if(!s)return q``;const o=t=>this._inheritedElementValue(e,t.id,t.def??!0);return q`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_designKnown(){const e=this._allDevices();return{views:(this._config.views??[]).map(e=>e.id),rooms:[...new Set(e.map(e=>e.area??""))],types:[...new Set(e.map(e=>this._deviceProfile(e)))],devices:e.map(e=>e.device_id)}}_designScopeStorageKey(){return`hdd:designScope:${this._config?.title??"default"}`}_hydrateDesignScope(){if(!this._designScopeLoaded&&this.hass&&this._config){this._designScopeLoaded=!0;try{this._designScope=function(e,t){if(!e||"global"===e)return ro;const i=e.indexOf(":");if(i<0)return ro;const s=e.slice(0,i),o=e.slice(i+1);return"view"===s&&t.views.includes(o)?{kind:"view",id:o}:"room"===s&&t.rooms.includes(o)?{kind:"room",name:o}:"type"===s&&t.types.includes(o)?{kind:"type",profile:o}:"device"===s&&t.devices.includes(o)?{kind:"device",id:o}:ro}(localStorage.getItem(this._designScopeStorageKey()),this._designKnown())}catch{}}}_setDesignScope(e){this._designScope=e,this._iaAllEntities=null;try{localStorage.setItem(this._designScopeStorageKey(),co(e))}catch{}}_deviceProfile(e){return this._config.device_styles?.[e.device_id]?.profile??ii(e).type}_designOverrides(){return this._config?function(e,t){const i=[],s=(e,t,s)=>{if(t)for(const o of s)void 0!==t[o]&&i.push({scope:e,key:o,value:t[o]})};s(ro,e,go.filter(e=>"style"!==e&&"theme"!==e&&"tileGap"!==e));const o=e.style??{};for(const[e,s]of Object.entries(o)){if(void 0===s)continue;const o=t?.[e];void 0!==o&&o===s||i.push({scope:ro,key:e,value:s,palette:void 0!==o})}for(const t of e.views??[])s({kind:"view",id:t.id},t,go);for(const[t,i]of Object.entries(e.area_styles??{}))s({kind:"room",name:t},i,go);for(const[t,i]of Object.entries(e.profile_styles??{}))s({kind:"type",profile:t},i,go);for(const[t,i]of Object.entries(e.device_styles??{}))s({kind:"device",id:t},i,[...go,...uo]);return i}(this._config,qe(this._config.theme)):[]}_clearOverride(e){const t=this._config;switch(e.scope.kind){case"global":if(e.palette||void 0!==t.style?.[e.key]){const i={...t.style??{}};delete i[e.key],this._set("style",Object.keys(i).length?i:void 0)}else this._set(e.key,void 0);return;case"view":return void this._updateView(e.scope.id,{[e.key]:void 0});case"room":return void this._setAreaStyle(e.scope.name,e.key,void 0);case"type":return void this._setProfileStyle(e.scope.profile,{[e.key]:void 0});case"device":return void this._setDeviceStyle(e.scope.id,{[e.key]:void 0})}}_renderChangesPanel(){const e=this._designOverrides(),t=this._allDevices(),i=e=>po(e.scope,{viewName:e=>(this._config.views??[]).find(t=>t.id===e)?.name||e,deviceName:e=>t.find(t=>t.device_id===e)?.name??e}),s=new Map;for(const t of e){const e=i(t);s.has(e)||s.set(e,[]),s.get(e).push(t)}return q`
      ...
      </div>`}_designFamily(e,t,i){return lo(this._designScope,e)?q`
      ...
      </div>`}_designGlobalSections(e){const t=this._globalSectionDescriptors(),i=new Set(_o.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id)));return q`${e.map(e=>{const s=t[e];if(!s)return Y;const o=this._sec(`design-${e}`,s.icon,s.bg,s.fg,s.label,s.badge,s.body);return i.has(e)?this._adv(o):o})}`}_renderDesignPanel(){const e=this._designScope,t=this._scopeValues(),i=this._allDevices(),s=po(e,{viewName:e=>(this._config.views??[]).find(t=>t.id===e)?.name||e,deviceName:e=>i.find(t=>t.device_id===e)?.name??e}),o=vo(e).filter(e=>void 0!==t[e]).length,a=()=>{"device"===e.kind?this._saveDeviceAsStyle(e.id):"type"===e.kind&&this._saveProfileAsStyle(e.profile)},n=("device"===e.kind||"type"===e.kind)&&o>0;return q`
      <div class="dsn-panel">
        ...
        ${this._designFamily("tile","Tile — device → type → room → view → card",()=>{const i=this._effectiveScopeStyle(),s=Ro.find(e=>e.v===i)?.label??i,o="global"===e.kind&&"default"!==i&&(()=>{const e=e=>void 0!==e&&"default"===Xi(this._baseStyleOf(e)).style;return Object.values(this._config.device_styles??{}).some(t=>e(t.tile_style))||Object.values(this._config.profile_styles??{}).some(t=>e(t.tile_style))||Object.values(this._config.area_styles??{}).some(t=>e(t.tile_style))||(this._config.views??[]).some(t=>e(t.tile_style))})(),a="default"===i||o;return q`
      ...
      ${this._designRow("Blocks","tile_layout",a?q`
            ...
            ${this._renderLayoutCanvas(t.tile_layout,Lt(this._inheritedFrom("tile_layout")?.value??Ft.generic),e=>this._patchScope({tile_layout:e}))}`:q`<div class="hint">
      ...
      ${(()=>Bt[i]?this._designRow("Elements","elements",this._renderStyleElementToggles(i,t.elements??{},e=>this._patchScope({elements:e}))):Y)()}
      ...
      </div>`}_renderInputActionsBlock(e){const t=this._allDevices().find(t=>t.device_id===e),i=t?Ui(t,this.hass.states):[];if(!i.length)return q``;const s=(this._config.device_styles?.[e]??{}).input_actions??{},o=e=>Array.isArray(e)?e.join(", "):e??"",a=e=>void 0!==s[e.entityId]?e.entityId:void 0!==s[String(e.channel)]?String(e.channel):e.entityId,n=(t,i)=>{const o={...s};i?o[t]={...o[t]??{action:"none"},...i}:delete o[t],this._setDeviceStyle(e,{input_actions:Object.keys(o).length?o:void 0})},r=t?t.entities.map(e=>e.entity_id):[],l=!!t&&Mt(t),c=this._iaAllEntities??!l,d=(e,t,i,s=!0,o)=>this._entityField(e,t,{deviceEntities:r,scopeAll:c,placeholder:i,multi:s,note:o}),p=(e,t)=>(e=>Array.isArray(e)?0===e.length:!e)(e)&&o(t)?`Optional — leave empty to use the tap target (${o(t)})`:void 0;return q`
      <div class="dsn-family">
    ...
    `}_renderViewCard(e,t,i,s,o,a,n,r){const l=this._expandedViewIds.has(e.id),c=e.filter??{},d=new Set(c.exclude_devices??[]),p=this._countViewMatches(e,n,r),h=n.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return q`
      <div class="view-card ${l?"expanded":""}">
        <div class="view-card-hdr" @click=${()=>{const t=new Set(this._expandedViewIds);l?t.delete(e.id):t.add(e.id),this._expandedViewIds=t}}>
          ...
          <span class="view-card-count" title="Devices matching this view's filter">${p}/${h}</span>
        ...
        ${l?q`
          <div class="view-card-body">
            ...
            ${(()=>{const t=new Map;for(const e of n){const i=r.get(e.device_id)?.integration;i&&t.set(i,(t.get(i)??0)+1)}if(t.size<2)return Y;const i=[...t.entries()].sort((e,t)=>t[1]-e[1]||e[0].localeCompare(t[0])),s=c.integrations??[];return q`
                <div class="field">
                  <div class="field-lbl">Integrations
                    ${this._selAllNone(()=>this._updateViewFilter(e.id,{integrations:i.map(([e])=>e)}),()=>this._updateViewFilter(e.id,{integrations:[]}))}</div>
                  <div class="pill-grp">
                    ${i.map(([t,i])=>q`
                      <span class="pill ${s.includes(t)?"on":""}"
                        @click=${()=>this._toggleViewFilterValue(e.id,"integrations",t)}
                      >${ni(t)} ${i}</span>`)}
                  </div>
                </div>`})()}

            ${(()=>{const t=ao(a.map(e=>e.name),n.some(e=>!e.area));if(!t.length)return Y;return q`
                <div class="field">
                  <div class="field-lbl">Areas
                    ${this._selAllNone(()=>this._updateViewFilter(e.id,{areas:t}),()=>this._updateViewFilter(e.id,{areas:[]}))}</div>
                  <div class="pill-grp">
                    ${t.map(t=>q`
                      <span class="pill ${(c.areas??[]).includes(t)?"on":""}"
                        @click=${()=>this._toggleViewFilterValue(e.id,"areas",t)}>${(e=>e||"No Room")(t)}</span>`)}
                  </div>
                </div>`})()}
            ...
            <div class="field">
              ...
              ${void 0!==e.columns?q`<button class="color-reset" @click=${()=>u("columns",void 0)}>↺</button>`:Y}
            </div>
            ...
            <div class="field">
              ...
              ${this._pills(e.sort_by,[...Do,["inherit",void 0]],e=>u("sort_by",e))}
            </div>`)}
          </div>`:Y}
    ...
    `,f=q`
      ...
      ${!1!==e.show_attention?q`
        ...
        ${(()=>{const t=ws(vs(this._allDevices(),this.hass?.states??{},{batteryBelow:e.attention_battery,includeBeta:e.include_beta_updates}));if(t.length<2)return Y;const i=e.attention_muted_integrations??[];return q`
            <div class="field">
              ...
              <div class="pill-grp">
                ${t.map(e=>{const t=!i.includes(e.integration);return q`
                    <span class="pill ${t?"on":""}" @click=${()=>{const s=t?[...i,e.integration]:i.filter(t=>t!==e.integration);this._set("attention_muted_integrations",s.length?s:void 0)}}>${ni(e.integration)} ${e.items.length}</span>`})}
              </div>
            </div>`})()}
        <div class="tog-row">
      ...
      </div>`;return{theme:{icon:"🎨",bg:"rgba(244,96,30,0.1)",fg:"#f4601e",label:"Colour theme",badge:Y,body:x},header:{icon:"◈",bg:"rgba(99,102,241,0.1)",fg:"#818cf8",label:"Header",badge:Y,body:r},lights:{icon:"💡",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"What counts as a light",badge:Y,body:m},content:{icon:"◫",bg:"rgba(244,96,30,0.1)",fg:"#f4601e",label:"Chips & metrics",badge:Y,body:w},tiles:{icon:"⊡",bg:"rgba(45,212,191,0.1)",fg:"#2dd4bf",label:"Tiles",badge:Y,body:v},card:{icon:"▢",bg:"rgba(129,140,248,0.1)",fg:"#818cf8",label:"Card",badge:Y,body:f},colors:{icon:"◐",bg:"rgba(244,96,30,0.12)",fg:"#f4601e",label:"Colours",badge:Y,body:d},typography:{icon:"T",bg:"rgba(251,191,36,0.1)",fg:"#fbbf24",label:"Typography",badge:Y,body:h}}}_globalSectionDescriptors(){return{...this._layoutSectionDescriptors(),...this._graphSectionDescriptors(),...this._sensorSectionDescriptors()}}_renderCustomTab(e){const t=new Set(["electrical","environmental","deviceinfo","alerts"]);return this._renderTabSections(e,this._globalSectionDescriptors(),(e,i)=>{const s=[...i].some(e=>t.has(e));return t.has(e)&&!s?q`<div class="hint" style="margin:4px 2px 8px">Global default — override per room (Layout & Style → room) or per device (Rooms & devices).</div>`:Y})}_graphSectionDescriptors(){const e=this._config,t=e.graph_style??{},i=t.type??"line",s=e.graph_sensor_colors??{},o=e.graph_sensors??Ht,a=q`
      <div class="tog-row" style="border:none;padding:0 0 6px">
      ...
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",Ss(o,Ai.map(e=>e.key))),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${Ai.map(e=>{const t=o.some(t=>$i(t)===e.key);return q`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?o.filter(t=>$i(t)!==e.key):[...o,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
        <div class="chip-picker-ents" style="margin-top:8px">
          <div class="chip-picker-grp-lbl">⌗ Specific entities</div>
          ${this._entityField(ks(o),e=>{const t=Array.isArray(e)?e:e?[e]:[];this._set("graph_sensors",[..._s(o),...t])},{deviceEntities:[],scopeAll:!0,placeholder:"sensor.davidpc_cpuload",multi:!0,note:"Plots readings with no device class. Drawn first, in the order added, and only on the device that owns them."})}
        </div>
      </div>
      ${this._adv(q`
        ...
        <div class="gg-row">
          <div class="gg-hdr">
            ...
            ${p?q`<button class="color-reset" title=${3===d.length?"Drop the middle stop":"Add a middle stop"}
              @click=${3===d.length?()=>r(e.key,[d[0],d[2]]):()=>r(e.key,[d[0],Kt(d,.5),d[1]])}>${3===d.length?"− mid":"+ mid"}</button>`:Y}
      ...
      ${Wt.map(e=>c(e))}
      ${o.filter(e=>!Wt.find(t=>t.key===e)).length?q`
        ...
        ${o.filter(e=>!Wt.find(t=>t.key===e)).map(e=>{const t=Ai.find(t=>t.key===e);return d(e,t?.label??e,(e=>s[e]??Ai.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Y}
`,h=t.sensor_ranges??{},u=(e,i,s)=>{const o=""===s.trim()?void 0:parseFloat(s),a={...h[e]??{}};void 0===o||isNaN(o)?delete a[i]:a[i]=o;const n={...h,[e]:a};a.min||0===a.min||a.max||0===a.max||delete n[e],this._set("graph_style",{...t,sensor_ranges:Object.keys(n).length?n:void 0})},g=q`
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=h[e.key]??{},s=void 0!==i.min||void 0!==i.max;return q`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),o=$i(i.key),a=!!Ai.find(e=>e.key===o),n=e.graph_sensors??Ht,r=n.some(e=>$i(e)===o);return q`
      ...
      </div>`}render(){if(!this._config)return q``;const e=_o.map(e=>({id:e.id,label:e.label,icon:e.icon})),t=new Set(_o.flatMap(e=>e.sections.filter(e=>e.advanced).map(e=>e.id))),i={};_o.forEach(e=>{i[e.id]=e.sections.map(e=>e.id)}),i.devices=["rooms","lights"],i.views=[],i.yaml=[];const s=Object.fromEntries(Object.entries(i).map(([e,i])=>[e,this._advanced?i:i.filter(e=>!t.has(e))])),o=s[this._tab]??[],a=()=>[Io.FAV_ROW_KEY,...new Set(this._allDevices().map(e=>e.area??""))],n="views"===this._tab?{keys:(this._config.views??[]).map(e=>e.id),isOpen:e=>this._expandedViewIds.has(e),setAll:e=>{this._expandedViewIds=e?new Set((this._config.views??[]).map(e=>e.id)):new Set}}:"devices"===this._tab?{keys:a(),isOpen:e=>this._expandedRooms.has(e),setAll:e=>{this._expandedRooms=e?new Set(a()):new Set}}:{keys:o,isOpen:e=>!!this._openSections[e],setAll:e=>{if(!o.length)return;const t={...this._openSections};for(const i of o)t[i]=e;this._openSections=t}},r=n.keys.length>0&&n.keys.every(n.isOpen),l=n.keys.length>1,c=e.findIndex(e=>e.id===this._tab);return q`
      <div class="shell">
      ...
      </div>`}};Lo.FAV_ROW_KEY="★ Favourites",Lo.LS_SNAPSHOTS="shelly-dashboard:cardSnapshots",Lo.LS_PALETTES="shelly-dashboard:palettes",Lo.LS_ADVANCED="shelly-dashboard:editorAdvanced",Lo.ROLL_SLOT="Before roll",Lo._realCardTypes=null,Lo._cardTypeProbe=null,Lo.ROW_MAX=3,Lo.DRAG_SLOP=6,Lo._CONTENT_KEYS=["type","title","mode","universal_scope","include_integrations","exclude_integrations","include_domains","exclude_domains","areas","devices","hidden_devices","favorites","hidden_entities","show_offline","views","default_view","delegate_controls","sensors","graph_sensors","energy_period","header_chips","area_header_chips"],Lo.styles=[mt,Ye,r`
    :host {
      display:block;
