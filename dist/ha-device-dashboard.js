...
`,Xe=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"}];const Qe=["temperature","humidity","carbon_dioxide","illuminance","battery"],Ve=["motion","door","window","moisture","smoke","gas"];const Ye=new Set(["switch","light","cover","valve","climate","sensor","binary_sensor","fan","lock","media_player","vacuum","alarm_control_panel","humidifier","water_heater","update","button","number","select","text","camera","event"]);function Ke(e){const t=e.entities??{},i=e.devices??{},s=e.areas??{},r=new Map;for(const[a,o]of Object.entries(t)){if(!o?.device_id)continue;if(o.hidden_by)continue;const t=a.split(".")[0];if(!Ye.has(t))continue;const n=(o.platform??"").toLowerCase();if("shelly"!==n&&"bthome"!==n)continue;const l=o.device_id;if(!r.has(l)){const e=i[l];if(!e)continue;const t=(e.configuration_url??"").match(/https?:\/\/((?:\d{1,3}\.){3}\d{1,3})/),a=(e.manufacturer??"").toLowerCase().includes("shelly")||"shelly"===n;if("bthome"===n&&!a)continue;const c=e.area_id??o.area_id,d=c?s[c]?.name:void 0;r.set(l,{device_id:l,name:e.name_by_user??e.name??l,area:d,model:e.model,sw_version:e.sw_version,ip:t?t[1]:void 0,isShelly:a,integration:n,entities:[]})}const c=r.get(l);c.isShelly||"shelly"!==n||(c.isShelly=!0,c.integration="shelly");const d=e.states[a];c.entities.push({entity_id:a,domain:t,state:d?.state??"unavailable",attributes:d?.attributes??{},device_id:l,area_id:o.area_id,platform:n,entity_category:o.entity_category??void 0})}const a=new Set;for(const[e,t]of r){if(a.has(e))continue;const s=i[e],o=s?.via_device_id;if(!o||!r.has(o)||a.has(o))continue;const n=i[o],l=s?.configuration_url??"",c=n?.configuration_url??"",d=e=>{const t=e.match(/https?:\/\/([^/]+)/);return t?t[1]:""},p=l&&c&&d(l)===d(c),h=!l&&c&&t.integration===r.get(o).integration;if(!p&&!h)continue;const g=r.get(o);g.entities.push(...t.entities),!g.ip&&t.ip&&(g.ip=t.ip),!g.model&&t.model&&(g.model=t.model),a.add(e)}for(const e of a)r.delete(e);return Array.from(r.values()).filter(e=>e.entities.length>0).sort((e,t)=>e.name.localeCompare(t.name))}function Je(e){const t=e.entity_category;return"diagnostic"===t?"diagnostic":"config"===t?"config":"primary"}const $e={relay:"Relay",plug:"Plug",dimmer:"Dimmer",rgb:"RGB",climate:"TRV",cover:"Roller",valve:"Valve",energy:"Energy",sensor:"Sensor",input:"Input",uni:"UNI",wall_display:"Display",generic:""},et={relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button"};function tt(e,t){return"wall_display"===e?t.entities.some(e=>"climate"===e.domain)?"climate-control":void 0:et[e]}const it={"power-monitor":[{id:"toggle",label:"On/off button"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary readings (V/A/kWh)"},{id:"uptime",label:"Uptime badge"},{id:"lower_body",label:"Lower body (blocks)"}],"light-control":[{id:"color_wheel",label:"Colour wheel"},{id:"brightness",label:"Brightness slider"},{id:"color_temp",label:"Colour temperature"},{id:"white",label:"White channel"},{id:"effects",label:"Effects"},{id:"power",label:"Power reading"}],"climate-control":[{id:"heating_badge",label:"Heating badge"},{id:"dial",label:"Temperature dial"},{id:"adjust_buttons",label:"+/− buttons"},{id:"stats",label:"Stats row"},{id:"presets",label:"Preset buttons"}],"cover-control":[{id:"position_pct",label:"Position %"},{id:"shutter_graphic",label:"Shutter graphic"},{id:"moving_label",label:"Moving label"},{id:"buttons",label:"Open / stop / close"}],"sensor-card":[{id:"primary_value",label:"Primary value"},{id:"trend",label:"Trend arrow"},{id:"graph",label:"Sparkline graph"},{id:"secondary",label:"Secondary chips"}],"scene-button":[{id:"icon",label:"Icon"},{id:"name",label:"Name"},{id:"timestamp",label:"Last-triggered time"},{id:"input_rows",label:"Input channel rows"}]};function st(e){if(e)return e.map(e=>Array.isArray(e)?e:[e])}function rt(e){const t=st(e);return t&&t.flat()}const at={relay:["name_row","relay_channels","sensors","graph","power_bar","virtual_controls","badges"],plug:["name_row","sensors","graph","power_bar","virtual_controls","badges"],dimmer:["name_row","dimmer","sensors","graph","virtual_controls","badges"],rgb:["name_row","dimmer","sensors","graph","virtual_controls","badges"],climate:["name_row","sensors","trv_control","virtual_controls","badges"],cover:["name_row","cover_controls","sensors","virtual_controls","badges"],valve:["name_row","sensors","valve_controls","virtual_controls","badges"],energy:["name_row","sensors","graph","virtual_controls","badges"],sensor:["name_row","sensors","graph","virtual_controls","badges"],input:["name_row","sensors","input_channels","virtual_controls","badges"],uni:["name_row","input_channels","sensors","virtual_controls","badges"],wall_display:["name_row","sensors","graph","trv_control","virtual_controls","badges"],generic:["name_row","sensors","virtual_controls","badges"]},ot=[{match:/wall\s*display/i,profile:"wall_display"},{match:/\btrv\b/i,profile:"climate"},{match:/smoke|flood|motion|door.?\/?\s?window|\bh\s?&\s?t\b/i,profile:"sensor"},{match:/button/i,profile:"input"},{match:/\bi[34]\b/i,profile:"input"},{match:/valve/i,profile:"valve"},{match:/rgbw/i,profile:"rgb"},{match:/dimmer/i,profile:"dimmer"},{match:/plug/i,profile:"plug"},{match:/\b3?em\b/i,profile:"energy"},{match:/\buni\b/i,profile:"uni"},{match:/\b[12]pm\b|\bpro\b|\bshelly\s*(plus\s*)?[12](\.5|l)?\b|\b[12]l\b/i,profile:"relay"}];const nt={relay:["power","energy","voltage","current","temperature","overtemp","overpower"],plug:["power","energy","voltage","current","overtemp","overpower"],energy:["power","energy","voltage","current","apparent_power","power_factor","frequency"],dimmer:["power","energy","temperature","overtemp"],rgb:["power","energy"],cover:["power","energy","temperature"],climate:["temperature","humidity","battery"],wall_display:["temperature","humidity","illuminance"],valve:["temperature"],sensor:["temperature","humidity","illuminance","co2","gas","battery","motion","door","flood","smoke","vibration"],input:["battery"],uni:["temperature","battery"]},lt=["power","temperature","humidity","battery"],ct={name_row:"Name & toggle",sensors:"Sensor chips",graph:"Graph",dimmer:"Brightness / colour",cover_controls:"Cover controls",trv_control:"Temperature control",valve_controls:"Valve controls",input_channels:"Input channels",relay_channels:"Relay channels",power_bar:"Power bar",virtual_controls:"Virtual controls",badges:"Type & gen badges"};function dt(e){const t=(e.model??"").toLowerCase(),i=new Set(e.entities.map(e=>e.domain));let s;if(i.has("climate")&&i.has("switch"))s="wall_display";else if(i.has("climate"))s="climate";else if(i.has("cover"))s="cover";else if(i.has("valve"))s="valve";else if(i.has("light")){const t=e.entities.some(e=>{if("light"!==e.domain)return!1;return(e.attributes?.supported_color_modes??[]).some(e=>["rgb","rgbw","rgbww","hs","xy"].includes(e))});s=t?"rgb":"dimmer"}else if(!e.entities.some(e=>"event"===e.domain&&"button"===e.attributes?.device_class)||e.entities.some(e=>"switch"===e.domain&&/_(switch|relay)_\d/.test(e.entity_id))||e.entities.some(e=>"sensor"===e.domain&&["humidity","carbon_dioxide","illuminance","pressure","moisture"].includes(e.attributes?.device_class??"")))if(i.has("switch"))s=t.includes("uni")?"uni":!t.includes("plug")&&(e.entities.some(e=>"binary_sensor"===e.domain&&e.entity_id.includes("input"))||t.includes("1pm")||t.includes("2pm")||t.includes("pro "))?"relay":"plug";else{const t=e.entities.some(e=>"sensor"===e.domain&&("power"===e.attributes?.device_class||"energy"===e.attributes?.device_class||"apparent_power"===e.attributes?.device_class)),i=e.entities.some(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("button")||e.entity_id.includes("channel")||null==e.attributes?.device_class)||"event"===e.domain&&("button"===e.attributes?.device_class||e.entity_id.includes("channel")||e.entity_id.includes("input"))),r=e.entities.some(e=>"sensor"===e.domain&&["temperature","humidity","illuminance","moisture","battery","gas"].includes(e.attributes?.device_class??"")),a=e.entities.some(e=>"binary_sensor"===e.domain&&["motion","door","window","moisture","smoke","gas","vibration","opening"].includes(e.attributes?.device_class??""));s=t?"energy":!i||r||a?"sensor":"input"}else s="input";return s}const pt=new Set(["relay","plug","energy","sensor","input","uni","generic"]),ht={id:"shelly",matches:e=>e.isShelly,detect:e=>{let t=dt(e);if(pt.has(t)){const i=function(e){if(e)for(const t of ot)if(t.match.test(e))return t.profile}(e.model);i&&(t=i)}return{type:t,gen:ft(e.model??""),label:$e[t],integration:e.integration}}},gt={id:"generic",matches:()=>!0,detect:e=>{const t=dt(e);return{type:t,gen:"other",label:$e[t],integration:e.integration}}},ut=[ht,gt];function vt(e){for(const t of ut)if(t.matches(e))return t.detect(e);return gt.detect(e)}function ft(e){const t=e.toLowerCase();return t.includes("blu")||t.includes("bluetooth")?"ble":t.includes("g4")||t.includes("gen4")||t.includes("gen 4")?4:t.includes("g3")||t.includes("gen3")||t.includes("gen 3")||/^s3/i.test(e)?3:t.includes("plus")||t.includes("pro")||/^sn/i.test(e)?2:1}const bt={shelly:"Shelly",zha:"ZHA",mqtt:"MQTT",z2m:"Z2M",zigbee2mqtt:"Z2M",hue:"Hue",deconz:"deCONZ",matter:"Matter",homekit:"HomeKit",tuya:"Tuya",tplink:"Kasa",esphome:"ESPHome",wled:"WLED",tasmota:"Tasmota",konnected:"Konnected",nest:"Nest",ring:"Ring",lifx:"LIFX",nanoleaf:"Nanoleaf",sonos:"Sonos"};const mt="—";function yt(e){return Number.isFinite(e)?e>=1e3?`${(e/1e3).toFixed(2)} kW`:`${e.toFixed(1)} W`:mt}function xt(e){return Number.isFinite(e)?`${e.toFixed(3)} kWh`:mt}function wt(e){return Number.isFinite(e)?`${e.toFixed(1)} V`:mt}function kt(e){return Number.isFinite(e)?`${e.toFixed(3)} A`:mt}function At(e){return Number.isFinite(e)?`${e.toFixed(1)} °C`:mt}function _t(e){return!Number.isFinite(e)||e<0?mt:e<60?`${Math.floor(e)}s`:e<3600?`${Math.floor(e/60)}m`:e<86400?`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`:`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h`}function Ct(e){return Number.isFinite(e)?e>=-50?"Excellent":e>=-60?"Good":e>=-70?"Fair":"Poor":mt}function St(e){return Number.isFinite(e)?`${e.toFixed(1)} VA`:mt}function zt(e){return Number.isFinite(e)?`${e.toFixed(1)} VAr`:mt}function It(e){return Number.isFinite(e)?`${e.toFixed(2)} Hz`:mt}function Ot(e){return Number.isFinite(e)?`${e.toFixed(1)} %`:mt}function Mt(e){return Number.isFinite(e)?e>=1e4?`${(e/1e3).toFixed(1)} klx`:`${Math.round(e)} lx`:mt}function Tt(e){return Number.isFinite(e)?`${Math.round(e)} ppm`:mt}function Et(e){return Number.isFinite(e)?`${Math.round(e)} %`:mt}const Bt=[{key:"power",label:"Power",unit:"W",group:"Electrical",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",group:"Electrical",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",group:"Electrical",defaultColor:"#fbbf24"},{key:"energy",label:"Energy",unit:"kWh",group:"Electrical",defaultColor:"#4ade80"},{key:"apparent_power",label:"App. Power",unit:"VA",group:"Electrical",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",group:"Electrical",defaultColor:"#818cf8"},{key:"frequency",label:"Frequency",unit:"Hz",group:"Electrical",defaultColor:"#34d399"},{key:"power_factor",label:"Power Factor",unit:"%",group:"Electrical",defaultColor:"#fb923c"},{key:"temperature",label:"Temperature",unit:"°C",group:"Environmental",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",group:"Environmental",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",group:"Environmental",defaultColor:"#fde047"},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",group:"Environmental",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",group:"Environmental",defaultColor:"#fb923c"},{key:"battery",label:"Battery",unit:"%",group:"Device",defaultColor:"#86efac"},{key:"signal_strength",label:"RSSI",unit:"dBm",group:"Device",defaultColor:"#7dd3fc"}],Dt=Object.fromEntries(Bt.map(e=>[e.key,e.label.split(" ")[0]])),Rt={co2:"carbon_dioxide",rssi:"signal_strength"};function Pt(e){return Rt[e]??e}function Ft(e){if(!e)return e;let t=!1,i=e.graph_sensors;if(Array.isArray(i)){const e=new Set,s=i.map(Pt).filter(t=>!e.has(t)&&(e.add(t),!0));(s.length!==i.length||s.some((e,t)=>e!==i[t]))&&(i=s,t=!0)}let s=e.graph_sensor_colors;if(s&&"object"==typeof s){let e=!1;const i={};for(const[t,r]of Object.entries(s)){const s=Pt(t);s!==t&&(e=!0),s in i||(i[s]=r)}e&&(s=i,t=!0)}if(!t)return e;const r={...e};return i&&(r.graph_sensors=i),s&&(r.graph_sensor_colors=s),r}const Lt=[{key:"online",label:"Online",agg:"count"},{key:"offline",label:"Offline",agg:"count"},{key:"power",label:"Power",agg:"sum"},{key:"energy",label:"Energy",agg:"sum"},{key:"temperature",label:"Temperature",agg:"avg"},{key:"humidity",label:"Humidity",agg:"avg"},{key:"illuminance",label:"Light",agg:"avg"},{key:"rssi",label:"Wi-Fi",agg:"avg"},{key:"alerts",label:"Alerts",agg:"count"},{key:"updates",label:"Updates",agg:"count"}],Nt=["online","offline","power","alerts"],jt=Object.freeze({theme:"warm_dusk",tile_style:"default",tile_size:"md",columns:3,sort_by:"name",smart_tile_styles:!1,show_graphs:!0,graph_hours:24,header_chips:Nt});function Ht(e,t){switch(t){case"gauge":return function(e){const{device:t,isOn:i,accent:s,online:r,config:a,profile:o}=e,n=e.tileSensors(t),l=e.getPrimarySwitch(t),c=a.graph_style?.sensor_ranges??{},d=a.graph_sensor_colors??{},p=[{label:"W",val:n.power,min:c.power?.min??0,max:c.power?.max??3e3,color:d.power??s},{label:"V",val:n.voltage,min:c.voltage?.min??0,max:c.voltage?.max??250,color:d.voltage??"#a78bfa"},{label:"A",val:n.current,min:c.current?.min??0,max:c.current?.max??16,color:d.current??"#fbbf24"},{label:"°C",val:n.temp,min:c.temperature?.min??0,max:c.temperature?.max??100,color:d.temperature??"#4fc3f7"}].filter(e=>null!=e.val),h=110,g=110,u=180,v=180,f=22,b=102,m=e=>e*Math.PI/180,y=(e,t)=>{const i=v+u*Math.min(1,Math.max(0,t)),s=h+e*Math.cos(m(v)),r=g+e*Math.sin(m(v)),a=h+e*Math.cos(m(i)),o=g+e*Math.sin(m(i)),n=u*t>180?1:0;return`M ${s.toFixed(2)} ${r.toFixed(2)} A ${e} ${e} 0 ${n} 1 ${a.toFixed(2)} ${o.toFixed(2)}`},x=(e,t)=>null==e?"—":"W"===t&&e>=1e3?`${(e/1e3).toFixed(1)}k`:"A"===t?e.toFixed(2):"°C"===t?e.toFixed(1):String(Math.round(e)),w=g+22;return G`
    ...
    <div class="ts-hbar" style="--ts-accent:${s}">
      ...
      <div class="ts-hbar-footer">
        <div style="display:flex;gap:6px;align-items:center">
          ...
          ${null!=o.uptime&&e.showEl("uptime")?G`<span class="ts-hbar-badge">${_t(o.uptime)}</span>`:Q}
        </div>
    ...
    <div class="ts-hero" style="--ts-accent:${s}">
      ...
      <div class="ts-hero-foot">
        ...
        ${e.showEl("uptime")?G`<span class="ts-uptime">${n.uptime?_t(n.uptime):""}</span>`:Q}
      </div>
      ${e.showEl("lower_body")?e.renderTileLowerBody(t,o):Q}
    </div>`}(e)}}const Ut=140,Wt=70;function qt(e){const{device:t,isOn:i,accent:s,online:r,hass:a,profile:o}=e,n=e.getPrimarySwitch(t),l=e.tileSensors(t);if(!n)return G`<div class="ts-light"><span style="color:var(--sc-text-muted);font-size:.8em">No light entity</span></div>`;if(n.entityId.startsWith("switch.")||"dimmer"!==o.type&&"rgb"!==o.type)return G`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      ${d&&e.showEl("color_wheel")?G`
        <div class="ts-light-wheel-wrap">
          <svg width="${Ut}" height="${Ut}" viewBox="0 0 ${Ut} ${Ut}"
            ...
            <foreignObject x="0" y="0" width="${Ut}" height="${Ut}">
              <div xmlns="http://www.w3.org/1999/xhtml" style="width:${Ut}px;height:${Ut}px;border-radius:50%;background:conic-gradient(red,yellow,lime,cyan,blue,magenta,red);opacity:${i?1:.3}"></div>
            </foreignObject>
            <circle cx="${Wt}" cy="${Wt}" r="${Wt}" fill="url(#${A})" opacity="${i?1:.3}"/>
      ...
      `:G``}case"power_bar":return e.renderPowerBar(i);case"badges":return G`
        <div class="tile-bot">
          ${null!=g?G`<span class="tile-power">${yt(g)}</span>`:Q}
      ...
      `;default:return G``}}const Zt=255;function Xt(e){return G`
    ...
    <div class="ds-header" style="--ds-accent:${s}">
      ...
      ${null!=o.rssi?G`<div class="ds-signal">Wi-Fi: ${Ct(o.rssi)} (${o.rssi} dBm)${null!=o.uptime?G` · Up ${_t(o.uptime)}`:Q}</div>`:Q}
        ...
        <div class="ds-channel-list">
          ${s.map(s=>{const r=i.states[s.entity_id],a="on"===r?.state,o=r?.attributes?.friendly_name??s.entity_id,n=s.entity_id.match(/[_-](\d+)$/)?.[1]??"",l=t.entities.find(e=>"sensor"===e.domain&&e.entity_id.includes(n)&&"power"===i.states[e.entity_id]?.attributes?.device_class),c=l?parseFloat(i.states[l.entity_id]?.state??""):NaN;return G`
              <div class="ds-channel-row">
                ...
                ${isNaN(c)?Q:G`<span class="ds-channel-power">${yt(c)}</span>`}
    ...
    ${Vt(e)}`}(e);case"plug":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=e.tileSensors(e.device);return G`
    <div class="ds-section ds-plug-hero">
      ...
      ${null!=s.power?G`<span class="ds-big-power">${yt(s.power)}</span>`:Q}
    </div>
    ${Vt(e)}`}(e);case"dimmer":return function(e){const t=e.getPrimarySwitch(e.device),i=t?.isOn??!1,s=t?.brightness??0,r=Math.round(s/255*100);return G`
    <div class="ds-section">
    ...
    ${Vt(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,r=i?.brightness??0,a=Math.round(r/Zt*100);return G`
    <div class="ds-section">
    ...
    ${Vt(e)}`}(e);case"climate":return function(e){const t=e.getTrv(e.device);return G`
    <div class="ds-section">
    ...
    ${Vt(e)}`}(e);case"cover":return function(e){const t=e.getCover(e.device);return G`
    <div class="ds-section">
    ...
    ${Vt(e,{history:!1})}`}(e);case"valve":return function(e){const t=e.getValve(e.device);return G`
    <div class="ds-section">
    ...
    ${Vt(e,{sensors:!1,history:!1})}`}(e);case"energy":return function(e){return G`${Vt(e)}`}(e);case"sensor":return function(e){const{device:t,hass:i}=e,s=t.entities.find(e=>{if("sensor"!==e.domain)return!1;const t=i.states[e.entity_id];return t&&!isNaN(parseFloat(t.state))}),r=e.getAlerts(t);return G`
    ...
    ${Vt(e,{historyFirst:!0})}`}(e);case"input":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"binary_sensor"===e.domain&&(e.entity_id.includes("input")||e.entity_id.includes("channel")));return G`
    <div class="ds-section">
    ...
    ${Vt(e,{sensors:!1,history:!1})}`}(e);case"uni":return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>"sensor"===e.domain&&(e.entity_id.includes("adc")||e.entity_id.includes("analog"))),r=t.entities.filter(e=>"switch"===e.domain);return G`
    ${s.length?G`
      <div class="ds-section">
    ...
    ${Vt(e,{sensors:!1,history:!1})}`}(e);case"wall_display":return function(e){const t=e.getTrv(e.device),i=e.getPrimarySwitch(e.device),s=i?.isOn??!1;return G`
    ${t?G`
      <div class="ds-section">
        <div class="ds-section-title">Climate</div>
        <div class="ds-climate-info">
    ...
    ${Vt(e)}`}(e);default:return function(e){const{device:t,hass:i}=e,s=t.entities.filter(e=>["select","number","button","text","input_boolean","input_number","input_select"].includes(e.domain));return G`
    ${s.length?G`
      <div class="ds-section">
    ...
    </div>`}function Qt(e){if(!e.getGraphEntities(e.device).length)return G``;const t=e.getDetailHistoryRange();return G`
    <div class="ds-section">
      <div class="ds-tabs">
    ...
    </div>`}function Vt(e,t={}){const{sensors:i=!0,history:s=!0,historyFirst:r=!1}=t;return G`
    ${r&&s?Qt(e):Q}
    ...
    <div class="ds-section">
      ...
      <div class="ds-sensor-grid">
        ${null!=t.power?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${yt(t.power)}</span><span class="ds-sensor-label">Power</span></div>`:Q}
        ${null!=t.voltage?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${wt(t.voltage)}</span><span class="ds-sensor-label">Voltage</span></div>`:Q}
        ${null!=t.current?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${kt(t.current)}</span><span class="ds-sensor-label">Current</span></div>`:Q}
        ${null!=t.energy?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${xt(t.energy)}</span><span class="ds-sensor-label">Energy</span></div>`:Q}
        ${null!=t.temp?G`<div class="ds-sensor-item"><span class="ds-sensor-val">${At(t.temp)}</span><span class="ds-sensor-label">Temp</span></div>`:Q}
      </div>
    </div>`:G``}(e):Q}
    ${!r&&s?Qt(e):Q}
    ...
    <div class="ds-section">
      ...
      <div class="ds-diag-grid">
        ...
        ${null!=r.rssi?G`<div class="ds-diag-item"><span class="ds-diag-label">RSSI</span><span class="ds-diag-val">${Ct(r.rssi)} (${r.rssi} dBm)</span></div>`:Q}
        ${null!=r.uptime?G`<div class="ds-diag-item"><span class="ds-diag-label">Uptime</span><span class="ds-diag-val">${_t(r.uptime)}</span></div>`:Q}
    ...
    `:Q;return p.length||g||r||a||o||S.length>1?G`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${o}" style=${Ae(l)}
          ...
          ${Be(a,e=>e.join("+"),e=>1===e.length?Gt(c,e[0]):G`<div class="tile-row">${e.map(e=>Gt(c,e))}</div>`)}
        </div>`}const m=e.area??"",y=this._tileAccent(e,m);return G`<div class="${`tile tile-${o} ${i?"":"offline"} tile--clickable`}" style=${Ae(l)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===v?Ht(this._buildTileCtx(e,s,y),b):"light-control"===v?qt(this._buildTileCtx(e,s,y)):"climate-control"===v?function(e){const{device:t,accent:i,online:s,hass:r}=e,a=e.getTrv(t);if(!a)return He(t,s,"ts-climate","No climate entity");const o="heating"===a.hvacAction,n=t.entities.find(e=>"sensor"===e.domain&&"battery"===r.states[e.entity_id]?.attributes?.device_class),l=n&&parseFloat(r.states[n.entity_id]?.state??"")||null;return G`
      ...
      <div class="fav-section">
        <div class="fav-header">
          ...
          <div class="fav-chips">
            ...
            ${r>0?G`<span class="fav-chip fav-chip-power">${yt(r)}</span>`:Q}
          </div>
        </div>
      ...
      <div class="area-section ${s?"closed":""} ${o?.bg_image&&"ambient"===o.bg_image_mode?"area-bg-ambient":""}" style=${Ae(l)}>
        <div class="area-header" @click=${()=>{const t=new Set(this._closedAreas);t.has(e)?t.delete(e):t.add(e),this._closedAreas=t}}>
          ...
          <div class="area-meta">
            ...
            ${a>0?G`<span class="area-power">${yt(a)}</span>`:Q}
    ...
    `],e([ve({attribute:!1})],$t.prototype,"hass",void 0),e([ve({type:Boolean})],$t.prototype,"preview",void 0),e([fe()],$t.prototype,"_config",void 0),e([fe()],$t.prototype,"_closedAreas",void 0),e([fe()],$t.prototype,"_entityListOpen",void 0),e([fe()],$t.prototype,"_graphData",void 0),e([fe()],$t.prototype,"_valveDragPos",void 0),e([fe()],$t.prototype,"_trvDragTemp",void 0),e([fe()],$t.prototype,"_cloudDetailOpen",void 0),e([fe()],$t.prototype,"_detailDevice",void 0),e([fe()],$t.prototype,"_detailHistoryRange",void 0),e([fe()],$t.prototype,"_activeViewId",void 0),e([fe()],$t.prototype,"_tileBlockOverride",void 0),e([fe()],$t.prototype,"_tileChipOverride",void 0),e([fe()],$t.prototype,"_areaHeaderOverride",void 0),e([fe()],$t.prototype,"_tileShowGraphsOverride",void 0),e([fe()],$t.prototype,"_areaCustomizeOpen",void 0),$t=Yt=e([he("ha-device-dashboard")],$t);const ei=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),ei(e,t);return!0},ti=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},ii=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),ai(t)}};function si(e){void 0!==this._$AN?(ti(this),this._$AM=e,ii(this)):this._$AM=e}function ri(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)ei(s[e],!1),ti(s[e]);else null!=s&&(ei(s,!1),ti(s));else ei(this,e)}const ai=e=>{e.type==me&&(e._$AP??=ri,e._$AQ??=si)};class oi extends xe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),ii(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ei(this,e),ti(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}const ni=new WeakMap,li=ye(class extends oi{render(e){return Q}update(e,[t]){const i=t!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),Q}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let i=ni.get(t);void 0===i&&(i=new WeakMap,ni.set(t,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?ni.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),ci={warm_dusk:{accent_color:"#c98a63",card_bg:"#1e1a17",tile_bg:"rgba(255,244,232,0.035)",tile_border:"rgba(255,244,232,0.08)",tile_hover_bg:"rgba(255,244,232,0.06)",tile_hover_shadow:"rgba(0,0,0,0.35)",tile_sensor_bg:"rgba(255,244,232,0.045)",tile_exp_bg:"rgba(255,244,232,0.05)",text_primary:"#ece5dc",text_secondary:"#b3a596",text_muted:"#7e7265",header_bg:"#241f1b",header_bg2:"#33291f",header_text_color:"#f3ece3",header_orb_color:"#c98a63",online_color:"#93b384",offline_color:"#d47f62",power_color:"#dba25c",area_header_color:"#c98a63"},dark_industrial:{accent_color:"#f4601e",card_bg:"#1c1c1e",tile_bg:"rgba(255,255,255,0.04)",tile_border:"rgba(255,255,255,0.07)",tile_hover_bg:"rgba(255,255,255,0.07)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(255,255,255,0.04)",tile_exp_bg:"rgba(255,255,255,0.06)",text_primary:"#e5e7eb",text_secondary:"#9ca3af",text_muted:"#6b7280",header_bg:"#1a1a2e",header_bg2:"#0f3460",header_text_color:"#ffffff",header_orb_color:"#3b82f6",online_color:"#4ade80",offline_color:"#ef4444",power_color:"#fb923c",area_header_color:"#f4601e"},teal_terminal:{accent_color:"#2dd4bf",card_bg:"#0b0f0e",tile_bg:"#0f1917",tile_border:"#1e2b28",tile_hover_bg:"rgba(45,212,191,0.08)",tile_hover_shadow:"rgba(0,0,0,0.40)",tile_sensor_bg:"rgba(45,212,191,0.05)",tile_exp_bg:"rgba(45,212,191,0.07)",text_primary:"#d1fae5",text_secondary:"#6ee7b7",text_muted:"#4b5563",header_bg:"#042f2e",header_bg2:"#0b6157",header_text_color:"#ccfbf1",header_orb_color:"#2dd4bf",online_color:"#34d399",offline_color:"#f87171",power_color:"#fbbf24",area_header_color:"#2dd4bf"},brutalist:{accent_color:"#facc15",card_bg:"#000000",tile_bg:"#0a0a0a",tile_border:"#ffffff",tile_hover_bg:"rgba(255,255,255,0.12)",tile_hover_shadow:"rgba(250,204,21,0.25)",tile_sensor_bg:"rgba(255,255,255,0.06)",tile_exp_bg:"rgba(255,255,255,0.09)",text_primary:"#ffffff",text_secondary:"#d4d4d4",text_muted:"#a3a3a3",header_bg:"#000000",header_bg2:"#171717",header_text_color:"#facc15",header_orb_color:"#facc15",online_color:"#22c55e",offline_color:"#ef4444",power_color:"#facc15",area_header_color:"#ffffff"},frosted_light:{accent_color:"#0071e3",card_bg:"#f2f2f7",tile_bg:"#ffffff",tile_border:"#d1d1d6",tile_hover_bg:"rgba(0,0,0,0.04)",tile_hover_shadow:"rgba(0,0,0,0.12)",tile_sensor_bg:"rgba(0,0,0,0.04)",tile_exp_bg:"rgba(0,0,0,0.05)",text_primary:"#1c1c1e",text_secondary:"#48484a",text_muted:"#8e8e93",header_bg:"#e8eef7",header_bg2:"#cfe0f5",header_text_color:"#1c1c1e",header_orb_color:"#0071e3",online_color:"#34c759",offline_color:"#ff3b30",power_color:"#ff9500",area_header_color:"#0071e3"},nordic_warm:{accent_color:"#d08770",card_bg:"#2e3440",tile_bg:"#3b4252",tile_border:"#434c5e",tile_hover_bg:"rgba(236,239,244,0.06)",tile_hover_shadow:"rgba(0,0,0,0.30)",tile_sensor_bg:"rgba(236,239,244,0.04)",tile_exp_bg:"rgba(236,239,244,0.06)",text_primary:"#eceff4",text_secondary:"#d8dee9",text_muted:"#9aa4b8",header_bg:"#3b4252",header_bg2:"#434c5e",header_text_color:"#eceff4",header_orb_color:"#ebcb8b",online_color:"#a3be8c",offline_color:"#bf616a",power_color:"#d08770",area_header_color:"#d08770"},midnight_purple:{accent_color:"#a78bfa",card_bg:"#0f0a1e",tile_bg:"#1a1030",tile_border:"#2e1f4d",tile_hover_bg:"rgba(167,139,250,0.10)",tile_hover_shadow:"rgba(0,0,0,0.45)",tile_sensor_bg:"rgba(167,139,250,0.06)",tile_exp_bg:"rgba(167,139,250,0.08)",text_primary:"#ede9fe",text_secondary:"#c4b5fd",text_muted:"#7c6ba8",header_bg:"#1e1b4b",header_bg2:"#4c1d95",header_text_color:"#ede9fe",header_orb_color:"#a78bfa",online_color:"#4ade80",offline_color:"#fb7185",power_color:"#c084fc",area_header_color:"#a78bfa"}},di=["warm_dusk","dark_industrial","teal_terminal","brutalist","frosted_light","nordic_warm","midnight_purple"],pi={warm_dusk:"Warm Dusk",dark_industrial:"Dark Industrial",teal_terminal:"Teal Terminal",brutalist:"Brutalist",frosted_light:"Frosted Light",nordic_warm:"Nordic Warm",midnight_purple:"Midnight Purple",custom:"Custom"},hi=Object.keys(ci.dark_industrial);function gi(e){const t=e??{};if(0===Object.keys(t).length)return"warm_dusk";for(const e of di){const i=ci[e];let s=!0;for(const e of Object.keys(i))if(t[e]!==i[e]){s=!1;break}if(s)return e}return"custom"}const ui=[{id:"devices",label:"Rooms & devices",icon:"⌂",sections:[{id:"rooms-toolbar",label:"Rooms toolbar"},{id:"device-panel",label:"Per-device style panel"},{id:"room-panel",label:"Per-room style panel"}]},{id:"device-styling",label:"Device styling",icon:"◆",sections:[]},{id:"views",label:"Views",icon:"☰",sections:[{id:"views-toolbar",label:"Views toolbar"},{id:"view-card",label:"Per-view card + filters"}]},{id:"header-styling",label:"Header",icon:"◈",sections:[{id:"header",label:"Header"}]},{id:"card-theme",label:"Card & Theme",icon:"🎨",sections:[{id:"tiles",label:"Tiles"},{id:"card",label:"Card",advanced:!0},{id:"colors",label:"Colours",advanced:!0},{id:"typography",label:"Typography",advanced:!0}]},{id:"graphs",label:"Graphs & Sensors",icon:"∿",sections:[{id:"graphtype",label:"Graph Type"},{id:"graphcolors",label:"Per-sensor Colors",advanced:!0},{id:"graphranges",label:"Sensor Min / Max",advanced:!0},{id:"electrical",label:"Electrical"},{id:"environmental",label:"Environmental"},{id:"deviceinfo",label:"Device Info",advanced:!0},{id:"alerts",label:"Alerts",advanced:!0}]},{id:"yaml",label:"YAML",icon:"</>",sections:[{id:"yaml-pane",label:"YAML output"}]}];var vi;const fi=[{label:"Default",value:void 0,group:"System"},{label:"Inter",value:"Inter, sans-serif",group:"System"},{label:"Roboto",value:"Roboto, sans-serif",group:"System"},{label:"Mono",value:"'IBM Plex Mono', monospace",group:"System"},{label:"System UI",value:"system-ui, sans-serif",group:"System"},{label:"Abril Fatface",value:"'Abril Fatface', cursive",group:"Bundled"},{label:"Bangers",value:"'Bangers', cursive",group:"Bundled"},{label:"Graduate",value:"'Graduate', cursive",group:"Bundled"},{label:"Limelight",value:"'Limelight', cursive",group:"Bundled"},{label:"Lobster",value:"'Lobster', cursive",group:"Bundled"},{label:"Pacifico",value:"'Pacifico', cursive",group:"Bundled"},{label:"Righteous",value:"'Righteous', cursive",group:"Bundled"},{label:"Special Elite",value:"'Special Elite', cursive",group:"Bundled"},{label:"Alfa Slab One",value:"'Alfa Slab One', cursive",group:"Display",cdn:"Alfa+Slab+One"},{label:"Bebas Neue",value:"'Bebas Neue', sans-serif",group:"Display",cdn:"Bebas+Neue"},{label:"Black Ops One",value:"'Black Ops One', cursive",group:"Display",cdn:"Black+Ops+One"},{label:"Bungee",value:"'Bungee', cursive",group:"Display",cdn:"Bungee"},{label:"Bungee Shade",value:"'Bungee Shade', cursive",group:"Display",cdn:"Bungee+Shade"},{label:"Cinzel",value:"'Cinzel', serif",group:"Display",cdn:"Cinzel"},{label:"Dancing Script",value:"'Dancing Script', cursive",group:"Display",cdn:"Dancing+Script"},{label:"Fredericka the Great",value:"'Fredericka the Great', cursive",group:"Display",cdn:"Fredericka+the+Great"},{label:"Great Vibes",value:"'Great Vibes', cursive",group:"Display",cdn:"Great+Vibes"},{label:"Monoton",value:"'Monoton', cursive",group:"Display",cdn:"Monoton"},{label:"Permanent Marker",value:"'Permanent Marker', cursive",group:"Display",cdn:"Permanent+Marker"},{label:"Shrikhand",value:"'Shrikhand', cursive",group:"Display",cdn:"Shrikhand"},{label:"Ultra",value:"'Ultra', serif",group:"Display",cdn:"Ultra"}];let bi=!1;const mi=[{group:"Electrical",icon:"⊕",iconColor:"#4a9eff",iconBg:"rgba(74,158,255,0.1)",items:[{key:"power",label:"Power",unit:"W",defaultColor:"#f4601e"},{key:"voltage",label:"Voltage",unit:"V",defaultColor:"#a78bfa"},{key:"current",label:"Current",unit:"A",defaultColor:"#fbbf24"},{key:"energy",label:"Energy (kWh)",unit:"kWh",defaultColor:"#4ade80"},{key:"frequency",label:"Frequency",unit:"Hz",defaultColor:"#34d399"},{key:"apparent_power",label:"App. Power",unit:"VA",defaultColor:"#f472b6"},{key:"reactive_power",label:"React. Power",unit:"VAr",defaultColor:"#818cf8"},{key:"power_factor",label:"Power Factor",unit:"%",defaultColor:"#fb923c"}]},{group:"Environmental",icon:"◌",iconColor:"#4ade80",iconBg:"rgba(74,222,128,0.1)",items:[{key:"temperature",label:"Temperature",unit:"°C",defaultColor:"#4fc3f7"},{key:"humidity",label:"Humidity",unit:"%",defaultColor:"#2dd4bf"},{key:"illuminance",label:"Illuminance",unit:"lx",defaultColor:"#fde047"},{key:"co2",label:"CO₂",unit:"ppm",defaultColor:"#a3e635"},{key:"gas",label:"Gas",unit:"%",defaultColor:"#fb923c"}]},{group:"Device Info",icon:"◎",iconColor:"#a78bfa",iconBg:"rgba(167,139,250,0.1)",items:[{key:"cloud",label:"Cloud status",unit:"",defaultColor:"#7dd3fc"},{key:"rssi",label:"Wi-Fi RSSI",unit:"dBm",defaultColor:"#7dd3fc"},{key:"uptime",label:"Uptime",unit:"",defaultColor:"#86efac"},{key:"ip",label:"IP Address",unit:"",defaultColor:"#94a3b8"},{key:"ssid",label:"SSID",unit:"",defaultColor:"#94a3b8"},{key:"battery",label:"Battery",unit:"%",defaultColor:"#86efac"},{key:"fw_version",label:"Firmware",unit:"",defaultColor:"#94a3b8"},{key:"mac",label:"MAC Address",unit:"",defaultColor:"#94a3b8"}]},{group:"Alerts",icon:"⚠",iconColor:"#f87171",iconBg:"rgba(239,68,68,0.15)",items:[{key:"overtemp",label:"Overtemp",unit:"",defaultColor:"#f87171"},{key:"overpower",label:"Overpower",unit:"",defaultColor:"#f87171"},{key:"motion",label:"Motion",unit:"",defaultColor:"#f87171"},{key:"door",label:"Door / Window",unit:"",defaultColor:"#f87171"},{key:"flood",label:"Flood",unit:"",defaultColor:"#f87171"},{key:"smoke",label:"Smoke",unit:"",defaultColor:"#f87171"}]}],yi=[{id:"name_row",label:"Name row",sub:"Device name + status dot + primary control"},{id:"sensors",label:"Sensor chips",sub:"Power, temp, voltage, RSSI…"},{id:"graph",label:"Sparkline graph",sub:"History sparklines per selected sensor"},{id:"dimmer",label:"Dimmer / color",sub:"Brightness + color picker for lights"},{id:"cover_controls",label:"Cover controls",sub:"Open / stop / close + position"},{id:"trv_control",label:"TRV control",sub:"Thermostat display + ± buttons"},{id:"valve_controls",label:"Valve controls",sub:"Open / stop / close for valves"},{id:"input_channels",label:"Input channels",sub:"Binary input state chips (i3/i4)"},{id:"relay_channels",label:"Relay channels",sub:"Per-channel toggles for multi-relay devices"},{id:"power_bar",label:"Power bar",sub:"Mini usage bar at tile bottom"},{id:"virtual_controls",label:"Virtual controls",sub:"Script-defined switches, selectors & actions"},{id:"badges",label:"Type & gen badges",sub:"Dimmer · G3 · Relay labels"}],xi=[{v:"default",label:"Default",icon:"⊟",desc:"Adaptive blocks"},{v:"power-monitor",label:"Power",icon:"⚡",desc:"Watts + sensors"},{v:"light-control",label:"Light",icon:"💡",desc:"Wheel + sliders"},{v:"climate-control",label:"Climate",icon:"🌡",desc:"Thermostat dial"},{v:"cover-control",label:"Cover",icon:"▤",desc:"Blind + buttons"},{v:"sensor-card",label:"Sensor",icon:"◎",desc:"Big value + trend"},{v:"scene-button",label:"Scene",icon:"▶",desc:"Tappable icon"}],wi=[{v:"big-number",label:"Number",icon:"▲"},{v:"gauge",label:"Gauge",icon:"◉"},{v:"graph",label:"Graph",icon:"∿"},{v:"compact",label:"Compact",icon:"⊟"},{v:"table",label:"Table",icon:"≡"}],ki=["style","tile_size","tile_opacity","card_opacity","card_bg_image","card_bg_image_size","tile_layout","graph_style","graph_sensors","graph_hours","graph_line_color","graph_sensor_colors","sensors","sort_by","columns","show_power_bar","power_bar_max","area_styles","device_styles","views","default_view"];let Ai=vi=class extends de{constructor(){super(...arguments),this._tab="devices",this._styleScope="device",this._cardThemeRoom="",this._newStyleName="",this._renamingStyle=null,this._advanced=!1,this._defaultsOpen=!1,this._pendingTheme=null,this._savedTheme=null,this._expandedViewId=null,this._openSections={rooms:!0,header:!0,tiles:!0,card:!1,colors:!1,typography:!1,graphtype:!0,graphcolors:!1,graphranges:!1,electrical:!0,environmental:!0,deviceinfo:!1,alerts:!1},this._expandedRooms=new Set,this._expandedRoomStyle=new Set,this._selectedDeviceId=null,this._deviceSearch="",this._styleClipFeedback="",this._copyAreaOpen=!1,this._copyJson="",this._pasteOpen=!1,this._pasteText="",this._iconPickerState=null,this._editorLayoutTimers=[],this._closeIconPicker=()=>{const e=this.renderRoot.querySelector("#ha-dd-icon-grid-popover");e&&"hidePopover"in e&&e.matches?.(":popover-open")&&e.hidePopover(),this._iconPickerState=null},this._onIconPickerOutsideClick=e=>{if(!this._iconPickerState)return;const t=e.composedPath().some(e=>e instanceof HTMLElement&&("ha-dd-icon-grid-popover"===e.id||e.classList?.contains("icon-picker-btn")));t||this._closeIconPicker()},this._emitTimer=null,this._pendingConfig=null,this._devCache=[],this._layDrag=null,this._layMove=null}setConfig(e){this._config=Ft(e),this._loadAdvanced(),this._loadSavedTheme()}_savedThemeKey(){return`shelly-dashboard:savedTheme:${this._config?.title??"default"}`}_loadSavedTheme(){try{const e=localStorage.getItem(this._savedThemeKey());this._savedTheme=e?JSON.parse(e):null}catch{}}_saveCurrentTheme(){const e=this._config.style??{},t={};for(const i of hi)void 0!==e[i]&&(t[i]=e[i]);this._savedTheme=t;try{localStorage.setItem(this._savedThemeKey(),JSON.stringify(t))}catch{}}_advKey(){return`shelly-dashboard:editorAdvanced:${this._config?.title??"default"}`}_loadAdvanced(){try{this._advanced="1"===localStorage.getItem(this._advKey())}catch{}}_setAdvanced(e){this._advanced=e;try{localStorage.setItem(this._advKey(),e?"1":"0")}catch{}}_adv(e){return this._advanced?e:Q}connectedCallback(){super.connectedCallback(),function(){if(bi||"undefined"==typeof document)return;const e=fi.filter(e=>e.cdn).map(e=>`family=${e.cdn}`).join("&");if(!e)return;const t=document.createElement("link");t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?${e}&display=swap`,document.head.appendChild(t),bi=!0}(),window.addEventListener("mousedown",this._onIconPickerOutsideClick,!0),this._editorRAF=requestAnimationFrame(()=>{const e=this.getRootNode(),t=e?.host;if(!t)return;const i=t.getRootNode(),s=i?.host;if(!s)return;const r=s.shadowRoot;if(!r)return;const a="ha-device-dashboard-editor-fix";if(!r.getElementById(a)){const e=document.createElement("style");e.id=a,e.textContent="\n          @media (min-width: 1000px) {\n            div.element-editor { overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            hui-card-element-editor { display:block !important; height:100% !important; overflow:hidden !important; min-height:0 !important; box-sizing:border-box !important; }\n            div.element-preview { overflow-x:hidden !important; box-sizing:border-box !important; }\n          }\n        ",r.appendChild(e)}const o=(e,t)=>{if(e)for(const[i,s]of Object.entries(t))e.style.setProperty(i,s,"important")},n=(e,t)=>{if(e)for(const i of t)e.style.removeProperty(i)},l=()=>{const e=r.querySelector("div.content"),t=this.shadowRoot?.querySelector(".shell"),i=r.querySelector("ha-dialog-footer");if(!e||!t)return;const s=r.querySelector("div.element-editor"),a=r.querySelector("div.element-preview");if(!window.matchMedia("(min-width: 1000px)").matches){const i=["height","max-height","overflow","overflow-y","align-items","flex","min-height","box-sizing"];return n(e,i),n(s,i),n(a,i),void n(t,["height","max-height"])}const l=window.innerHeight,c=i?.offsetHeight??0,d=e.getBoundingClientRect().top,p=Math.max(300,l-d-c);o(e,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden","align-items":"stretch","box-sizing":"border-box"}),o(s,{height:`${p}px`,"max-height":`${p}px`,overflow:"hidden"}),o(a,{height:`${p}px`,"max-height":`${p}px`,"overflow-y":"auto"});const h=t.getBoundingClientRect().top,g=s?s.getBoundingClientRect().bottom:l,u=Math.max(400,g-h);t.style.height=`${u}px`,t.style.maxHeight=`${u}px`};if(l(),this._editorLayoutTimers.push(window.setTimeout(l,50),window.setTimeout(l,250),window.setTimeout(l,700)),this._editorResizeHandler=l,window.addEventListener("resize",l),"undefined"!=typeof ResizeObserver){this._editorRO=new ResizeObserver(l);const e=r.querySelector("div.element-editor");e&&this._editorRO.observe(e)}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this._onIconPickerOutsideClick,!0),null!=this._editorRAF&&(cancelAnimationFrame(this._editorRAF),this._editorRAF=void 0),this._editorLayoutTimers.forEach(e=>clearTimeout(e)),this._editorLayoutTimers=[],this._editorResizeHandler&&(window.removeEventListener("resize",this._editorResizeHandler),this._editorResizeHandler=void 0),this._editorRO?.disconnect(),this._editorRO=void 0,this._flushConfig()}_renderIconGridPopover(){const e=this._iconPickerState,t="#f4601e";return G`
      ...
      ${(()=>{const t=Object.entries(this._config.custom_styles??{});return t.length?G`
          ...
          <div class="pill-grp">
            ${t.map(([t,i])=>{const r=`custom:${t}`;return this._renamingStyle===t?G`<input type="text" class="inline-text" style="width:9em"
                  ...
                  ${li(e=>e?.focus())}/>`:G`<span class="pill ${e===r?"on":""}" @click=${()=>s(r)}>
                ${i.label||t}
      ...
      ${o?G`
        ...
        </div>`:Q}`}_renderDeviceStylingTab(){const e=this._allDevices(),t=new Map;for(const i of e){const e=i.area||"—";t.has(e)||t.set(e,[]),t.get(e).push(i)}const i=[...t.keys()].sort((e,t)=>e.localeCompare(t)),s=this._selectedDeviceId,r=s?e.find(e=>e.device_id===s):null,a=r?vt(r):null,o=this._styleScope,n=a?e.filter(e=>vt(e).type===a.type).length:0,l=a?$e[a.type]||a.type:"",c=e=>G`
      ...
      <div class="dev-styling-tab">
        ...
        ${r&&a?G`
          ...
          ${"device"===o?(()=>{const e=this._config.device_styles?.[s]??{},t=e.tile_style??(this._config.smart_tile_styles&&r?tt(a.type,r):void 0)??"default";return G`
        ${this._renderDeviceStylePanel(s)}
        ${this._renderStyleElementToggles(t,e.elements??{},e=>this._setDeviceStyle(s,{elements:e}))}
        ${c(()=>this._saveDeviceAsStyle(s))}`})():(()=>{const e=this._config.profile_styles?.[a.type]??{},t=e.tile_style??(this._config.smart_tile_styles?et[a.type]:void 0)??this._config.tile_style,i=this._baseStyleOf(t)??"default";return G`
        ...
        <div class="dev-style-panel">
          <div class="field" style="margin-bottom:4px">
            ...
            ${this._renderTileStylePicker(e.tile_style,e.power_monitor_variant??"big-number",et[a.type],e=>this._setProfileStyle(a.type,{tile_style:e}),e=>this._setProfileStyle(a.type,{power_monitor_variant:e}))}
          </div>
      ...
      <span class="lay-chip ${t<0?"off":""}"
        ...
        @pointercancel=${()=>this._layDragEnd()}>${(e=>yi.find(t=>t.id===e)?.label??e)(e)}</span>`,n=this._config.style?.accent_color??"#f4601e";return G`
      <div class="field" style="margin-top:10px">
        ...
        <div class="lay-canvas">
          ${s.map((e,t)=>G`
            <div class="lay-row">
              ${e.map((e,i)=>o(e,t,i))}
              ${e.length<vi.ROW_MAX?G`<span class="lay-slot">drop here</span>`:Q}
            </div>`)}
      ...
      </div>`}_renderStyleElementToggles(e,t,i){const s=it[e];if(!s)return G``;return G`
      <div class="field" style="margin-top:10px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
      ...
      </div>`}_renderDeviceStylePanel(e){const t=this._config.device_styles?.[e]??{},i=yi.map(e=>e.id),s=this._config.tile_layout??i,r=rt(s),a=rt(t.tile_layout)??null,o=t.entity_animations??{},n=o=>{const n=(a??r).includes(o),l=function(e,t,i,s){const r=st(e).map(e=>[...e]);if(!i)return r.map(e=>e.filter(e=>e!==t)).filter(e=>e.length>0);if(r.some(e=>e.includes(t)))return r;const a=e=>{const t=s.indexOf(e);return t<0?s.length:t},o=r.findIndex(e=>a(e[0])>a(t));return r.splice(o<0?r.length:o,0,[t]),r}(t.tile_layout??s,o,!n,i),c=JSON.stringify(l)===JSON.stringify(st(s));this._setDeviceStyle(e,{tile_layout:c?void 0:l})},l=(t,i,s)=>{const r={...o[t]??{}};if("speed"===i){const e=Number(s);1===e?delete r.speed:r.speed=e}else"none"===s?delete r[i]:r[i]=s;const a={...o,[t]:r};r.on||r.off||r.speed||delete a[t],this._setDeviceStyle(e,{entity_animations:Object.keys(a).length?a:void 0})},c=this._allDevices().find(t=>t.device_id===e),d=c?vt(c):null,p=d?{relay:"power-monitor",plug:"power-monitor",energy:"power-monitor",uni:"power-monitor",dimmer:"light-control",rgb:"light-control",climate:"climate-control",wall_display:"climate-control",cover:"cover-control",sensor:"sensor-card",input:"scene-button",generic:"scene-button"}[d.type]:void 0,h=t.tile_style,g=t.power_monitor_variant??"big-number",u=G`
      <div class="field" style="margin-bottom:4px">
        <div class="field-lbl" style="display:flex;align-items:center;gap:6px">
          Tile layout style
      ...
      <div class="dev-style-panel">
        <div class="field" style="margin-bottom:6px">
          ...
          <select class="inline-text" style="width:100%"
            ...
            <option value="" ?selected=${!t.profile}>Auto${d?` — detected: ${$e[d.type]||d.type||"generic"}`:""}</option>
            ${["relay","plug","dimmer","rgb","climate","cover","valve","energy","sensor","input","uni","wall_display","generic"].map(e=>G`
              <option value=${e} ?selected=${t.profile===e}>${$e[e]||e}</option>`)}
          </select>
        </div>
        ${u}
        <div class="color-row">
        ...
        ${(()=>{const i=c?vt(c):null,o=t.tile_style??(this._config.smart_tile_styles&&i&&c?tt(i.type,c):void 0)??this._config.tile_style,l=this._baseStyleOf(o);return l&&"default"!==l?Q:G`
            ...
            ${this._adv(G`
                ...
                <div class="block-toggles">
                  ${yi.filter(e=>"graph"!==e.id).map(e=>{const t=null===a?r.includes(e.id):a.includes(e.id);return G`<span class="block-tog ${t?"on":""}" @click=${()=>n(e.id)}>
                      ${t?"👁":"○"} ${e.label}
                    </span>`})}
                </div>`)}`})()}
    ...
    `}_renderViewCard(e,t,i,s,r,a,o,n){const l=this._expandedViewId===e.id,c=e.filter??{},d=new Set(c.devices??[]),p=new Set(c.exclude_devices??[]),h=this._countViewMatches(e,o,n),g=o.length,u=(t,i)=>this._updateView(e.id,{[t]:i});return G`
      ...
      ${!1!==e.header_show_stats?G`
        <div class="field" style="margin:6px 0 2px">
          ...
          <div class="pill-grp">
            ${Lt.map(t=>{const i=e.header_chips??Nt,s=i.includes(t.key);return G`
                <span class="pill ${s?"on":""}"
                  @click=${()=>{const e=s?i.filter(e=>e!==t.key):[...i,t.key],r=e.length===Nt.length&&Nt.every(t=>e.includes(t));this._set("header_chips",r?void 0:e)}}>${t.label}</span>`})}
          </div>
    ...
    `,u=G`
      ...
      </div>`)}`,a=e.graph_sensors??lt,o=[{key:"power",label:"Power (W)",default:"#f4601e"},{key:"voltage",label:"Voltage (V)",default:"#a78bfa"},{key:"current",label:"Current (A)",default:"#fbbf24"},{key:"temperature",label:"Temperature (°C)",default:"#4fc3f7"}],n=(e,t,i)=>{const r=s[e]??i,a=!!s[e];return G`
        <div class="color-row">
          <div class="color-preview-swatch" style="background:${r}"></div>
      ...
      ${a.filter(e=>!o.find(t=>t.key===e)).length?G`
        ...
        ${a.filter(e=>!o.find(t=>t.key===e)).map(e=>{const t=Bt.find(t=>t.key===e);return n(e,t?.label??e,(e=>s[e]??Bt.find(t=>t.key===e)?.defaultColor??"#f4601e")(e))})}`:Q}
      <div class="field" style="margin-top:10px">
        <div class="field-lbl">Which sensors to graph
          ${this._selAllNone(()=>this._set("graph_sensors",Bt.map(e=>e.key)),()=>this._set("graph_sensors",[]))}</div>
        <div class="pill-grp">
          ${Bt.map(e=>{const t=a.some(t=>Pt(t)===e.key);return G`
            <span class="pill ${t?"on":""}" @click=${()=>{const i=t?a.filter(t=>Pt(t)!==e.key):[...a,e.key];this._set("graph_sensors",i)}}>${e.label}</span>`})}
        </div>
      ...
      <div class="range-table">
        ...
        ${[{key:"power",label:"Power",unit:"W",def:{min:0,max:3e3}},{key:"voltage",label:"Voltage",unit:"V",def:{min:0,max:250}},{key:"current",label:"Current",unit:"A",def:{min:0,max:16}},{key:"temperature",label:"Temperature",unit:"°C",def:{min:0,max:100}},{key:"humidity",label:"Humidity",unit:"%",def:{min:0,max:100}},{key:"carbon_dioxide",label:"CO₂",unit:"ppm",def:{min:400,max:2e3}},{key:"illuminance",label:"Illuminance",unit:"lx",def:{min:0,max:1e3}},{key:"battery",label:"Battery",unit:"%",def:{min:0,max:100}},{key:"energy",label:"Energy",unit:"kWh",def:{min:0,max:100}},{key:"signal_strength",label:"WiFi RSSI",unit:"dBm",def:{min:-100,max:-30}}].map(e=>{const i=c[e.key]??{},s=void 0!==i.min||void 0!==i.max;return G`
          ...
          <div class="sensor-grid">
            ${s.items.map(i=>{const s=t.includes(i.key),r=Pt(i.key),a=!!Bt.find(e=>e.key===r),o=e.graph_sensors??lt,n=o.some(e=>Pt(e)===r);return G`
                <div class="sensor-item ${s?"active":""}" @click=${()=>{const e=s?t.filter(e=>e!==i.key):[...t,i.key];this._set("sensors",e)}}>
                  ...
                  ${a?G`<button class="sensor-graph-btn ${n?"on":""}"
                    ...
                    @click=${e=>{e.stopPropagation();const t=n?o.filter(e=>Pt(e)!==r):[...o,r];this._set("graph_sensors",t)}}>∿</button>`:Q}
                </div>`})}
      ...
      <pre class="yaml-out">${i}</pre>`}_applyTheme(e){this._set("style",function(e,t){return{...e??{},...ci[t]}}(this._config.style,e))}_onPickTheme(e){const t=this._config.style??{},i=hi.some(e=>void 0!==t[e]);i&&"custom"===gi(t)?this._pendingTheme=e:this._applyTheme(e)}_applySaved(){this._savedTheme&&this._set("style",{...this._config.style??{},...this._savedTheme})}_renderDefaultsPanel(){const e=this._config,t=e.style??{},i=e.views??[],s=gi(t),r=!!this._savedTheme&&Object.entries(this._savedTheme).every(([e,i])=>t[e]===i);return G`
        ...
        <div class="dp-grid">
          ...
          <div class="dp-group">
            ...
            <div class="theme-grid">
              ...
              ${di.map(e=>{const t=ci[e];return G`
                  <button class="theme-swatch ${s===e?"on":""}" title=${pi[e]}
                    ...
                    <span class="ts-name">${pi[e]}</span>
                  </button>`})}
            </div>
            ${this._pendingTheme?G`
              <div class="theme-warn">
                <div class="tw-msg">Replace your current custom colours with <b>${pi[this._pendingTheme]}</b>?</div>
                <div class="tw-btns">
      ...
      </div>`}};Ai.ROW_MAX=3,Ai.DRAG_SLOP=6,Ai.styles=[Ze,n`
    :host {
      display:block;
  ...
  `],e([ve({attribute:!1})],Ai.prototype,"hass",void 0),e([fe()],Ai.prototype,"_config",void 0),e([fe()],Ai.prototype,"_tab",void 0),e([fe()],Ai.prototype,"_styleScope",void 0),e([fe()],Ai.prototype,"_cardThemeRoom",void 0),e([fe()],Ai.prototype,"_newStyleName",void 0),e([fe()],Ai.prototype,"_renamingStyle",void 0),e([fe()],Ai.prototype,"_advanced",void 0),e([fe()],Ai.prototype,"_defaultsOpen",void 0),e([fe()],Ai.prototype,"_pendingTheme",void 0),e([fe()],Ai.prototype,"_savedTheme",void 0),e([fe()],Ai.prototype,"_expandedViewId",void 0),e([fe()],Ai.prototype,"_openSections",void 0),e([fe()],Ai.prototype,"_expandedRooms",void 0),e([fe()],Ai.prototype,"_expandedRoomStyle",void 0),e([fe()],Ai.prototype,"_selectedDeviceId",void 0),e([fe()],Ai.prototype,"_deviceSearch",void 0),e([fe()],Ai.prototype,"_styleClipFeedback",void 0),e([fe()],Ai.prototype,"_copyAreaOpen",void 0),e([fe()],Ai.prototype,"_copyJson",void 0),e([fe()],Ai.prototype,"_pasteOpen",void 0),e([fe()],Ai.prototype,"_pasteText",void 0),e([fe()],Ai.prototype,"_iconPickerState",void 0),Ai=vi=e([he("ha-device-dashboard-editor")],Ai);console.info("%c ha-device-dashboard %c mobile-editor-2026-07-10f ","background:#c98a63;color:#1e1a17;font-weight:700;border-radius:3px 0 0 3px","background:#241f1b;color:#f3ece3;border-radius:0 3px 3px 0"),window.customCards=window.customCards||[],window.customCards.push({type:"ha-device-dashboard",name:"HA Device Dashboard",description:"Universal device fleet overview — Shelly, ZHA, Hue, ESPHome, Matter and more.",preview:!0,documentationURL:"https://github.com/TheIcelandicguy/ha-device-dashboard"});
