...
`,bt=[{value:"none",label:"None",group:""},{value:"flame",label:"Flame",group:"🔥"},{value:"flame2",label:"Double",group:"🔥"},{value:"flame3",label:"Campfire",group:"🔥"},{value:"snowflake",label:"Snow",group:"❄️"},{value:"snowflake2",label:"6-arm",group:"❄️"},{value:"snowflake3",label:"Drifting",group:"❄️"},{value:"fan",label:"Fan 3",group:"🌀"},{value:"fan2",label:"Fan 4",group:"🌀"},{value:"fan3",label:"Vortex",group:"🌀"},{value:"lightning",label:"Bolt",group:"⚡"},{value:"lightning2",label:"Double",group:"⚡"},{value:"lightning3",label:"Arc",group:"⚡"},{value:"bulb",label:"Bulb",group:"💡"},{value:"bulb2",label:"Edison",group:"💡"},{value:"bulb3",label:"LED",group:"💡"},{value:"water",label:"Drop",group:"💧"},{value:"water2",label:"Waves",group:"💧"},{value:"water3",label:"Ripple",group:"💧"},{value:"sun",label:"Sun",group:"☀️"},{value:"sun2",label:"Sunrise",group:"☀️"},{value:"sun3",label:"Burst",group:"☀️"},{value:"moon",label:"Crescent",group:"🌙"},{value:"moon2",label:"Full",group:"🌙"},{value:"moon3",label:"Stars",group:"🌙"},{value:"pulse",label:"Pulse",group:"◉"},{value:"pulse2",label:"Double",group:"◉"},{value:"pulse3",label:"EKG",group:"◉"},{value:"wave",label:"Wave",group:"〜"},{value:"wave2",label:"Equalizer",group:"〜"},{value:"wave3",label:"Signal",group:"〜"},{value:"wave4",label:"WiFi",group:"〜"},{value:"heart",label:"Heart",group:"❤️"},{value:"heart2",label:"Outline",group:"❤️"},{value:"leaf",label:"Leaf",group:"🌿"},{value:"leaf2",label:"Sprout",group:"🌿"},{value:"lock",label:"Lock",group:"🔒"},{value:"lock2",label:"Unlocked",group:"🔒"},{value:"wind",label:"Flow",group:"💨"},{value:"wind2",label:"Gusts",group:"💨"},{value:"wind3",label:"Spiral",group:"💨"},{value:"bell",label:"Bell",group:"🔔"},{value:"bell2",label:"Ring",group:"🔔"},{value:"bell3",label:"Alarm",group:"🔔"},{value:"thermometer",label:"Therm",group:"🌡️"},{value:"thermometer2",label:"Hot",group:"🌡️"},{value:"thermometer3",label:"Cold/Hot",group:"🌡️"},{value:"battery",label:"Battery",group:"🔋"},{value:"battery2",label:"Charging",group:"🔋"},{value:"battery3",label:"Low",group:"🔋"},{value:"star",label:"Star",group:"⭐"},{value:"star2",label:"Sparkle",group:"⭐"},{value:"star3",label:"Shoot",group:"⭐"},{value:"display",label:"Flicker",group:"🖥️"},{value:"display2",label:"Scanline",group:"🖥️"},{value:"display3",label:"Wake",group:"🖥️"},{value:"oven",label:"Oven",group:"🍳"},{value:"washer",label:"Washer",group:"🫧"},{value:"washer2",label:"Tumble",group:"🫧"},{value:"dishwasher",label:"Dishes",group:"🫧"},{value:"floorheat",label:"Floor heat",group:"♨️"},{value:"radiator",label:"Radiator",group:"♨️"},{value:"valve",label:"Valve",group:"🚰"},{value:"smoke",label:"Smoke det.",group:"🚨"},{value:"camera",label:"Camera",group:"📷"},{value:"strip",label:"LED strip",group:"🌈"},{value:"strip2",label:"Rainbow",group:"🌈"},{value:"plug",label:"Plug",group:"🔌"},{value:"garage",label:"Garage",group:"🚗"},{value:"ble",label:"Bluetooth",group:"📡"},{value:"router",label:"Router",group:"📡"},{value:"pc",label:"PC",group:"💻"}];function yt(e){const{device:t,accent:i,online:s}=e,o=e.getInputChannels(t),a=o.filter(i=>null!=e.getInputActionLabel(t,i)),n=o.filter(i=>null==e.getInputActionLabel(t,i)),r=a.length<=1?1:a.length<=4?2:3,l=a.map(i=>({ch:i,chip:e.getInputSelectChip(t,i)})).filter(e=>null!=e.chip);return q`
    ...
    <div class="ts-light" style="--ts-accent:${s}" @click=${e=>e.stopPropagation()}>
      ...
      `;default:return q``}var S}const Ds=255;function Os(e){return q`
    ...
    ${Ps(e)}`}(e);case"rgb":return function(e){const{accent:t}=e,i=e.getPrimarySwitch(e.device),s=i?.isOn??!1,o=i?.brightness??0,a=Math.round(o/Ds*100);return q`
    <div class="ds-section">
    ...
    `:Y;return p.length||u||o||a||n||C.length>1?q`
      <div class="ts-lower-body">
        ...
        <div class="tile tile--clickable ${i?"":"offline"} tile-${n}" style=${ke(p)}
          ...
          ${Oe(t,e=>e.join("+"),e=>1===e.length?Ms(a,e[0]):q`<div class="tile-row">${e.map(e=>Ms(a,e))}</div>`)}
        </div>`}const y=e.area??"",x=this._tileAccent(e,y);return q`<div class="${`tile tile-${n} ${i?"":"offline"} tile--clickable`}" style=${ke(p)}
      @pointerdown=${t=>this._onTilePointerDown(e,t)}
      @pointerup=${t=>this._onTilePointerUp(e,t)}
      @pointercancel=${()=>this._onTilePointerCancel()}
      @pointermove=${e=>this._onTilePointerMove(e)}>
      ${"power-monitor"===f?Ss(this._buildTileCtx(e,s,x),b):"light-control"===f?Is(this._buildTileCtx(e,s,x)):"climate-control"===f?function(e){const{device:t,accent:i,online:s,hass:o}=e,a=e.getTrv(t);if(!a)return nt(t,s,"ts-climate",it("empty.no_climate"));const n="heating"===a.hvacAction,r=t.entities.find(e=>"sensor"===e.domain&&"battery"===o.states[e.entity_id]?.attributes?.device_class),l=r&&parseFloat(o.states[r.entity_id]?.state??"")||null;return q`
    ...
    <div class="ts-cover" style="--ts-accent:${i}" @click=${e=>e.stopPropagation()}>
      ...
      ${e.showEl("graphs")&&e.getGraphEntities(t).length?q`<div class="ts-lower-section ts-lower-graphs">${e.renderSparklines(t)}</div>`:Y}
    </div>`}(this._buildTileCtx(e,s,x)):"sensor-card"===f?As(this._buildTileCtx(e,s,x)):"input-control"===f?yt(this._buildTileCtx(e,s,x)):"scene-button"===f?function(e){const{device:t,accent:i,online:s,config:o}=e,a=e.getInputChannels(t),n=o.device_styles?.[t.device_id],r=n?.tile_icon??"pulse",l=n?.tile_icon_size??1,c=vt(r,!0,`--ent-spd:${n?.tile_icon_speed??1};color:${i}`,"ts-scene-icon"),d=t.entities.reduce((t,i)=>{const s=e.hass.states[i.entity_id]?.last_changed??"";return s>t?s:t},""),p=d?e.timeAgo(d):"";return a.length>0?q`
  ...
  `],e([ve({attribute:!1})],Eo.prototype,"hass",void 0),e([fe()],Eo.prototype,"_config",void 0),e([fe()],Eo.prototype,"_tab",void 0),e([fe()],Eo.prototype,"_newStyleName",void 0),e([fe()],Eo.prototype,"_renamingStyle",void 0),e([fe()],Eo.prototype,"_advanced",void 0),e([fe()],Eo.prototype,"_defaultsOpen",void 0),e([fe()],Eo.prototype,"_resetArmed",void 0),e([fe()],Eo.prototype,"_viewDeleteArmed",void 0),e([fe()],Eo.prototype,"_xcPlacement",void 0),e([fe()],Eo.prototype,"_xcRoom",void 0),e([fe()],Eo.prototype,"_xcView",void 0),e([fe()],Eo.prototype,"_xcAdding",void 0),e([fe()],Eo.prototype,"_xcEditIndex",void 0),e([fe()],Eo.prototype,"_xcDraft",void 0),e([fe()],Eo.prototype,"_xcMode",void 0),e([fe()],Eo.prototype,"_xcFormEl",void 0),e([fe()],Eo.prototype,"_xcFormUnavailable",void 0),e([fe()],Eo.prototype,"_xcPreview",void 0),e([fe()],Eo.prototype,"_xcDashboards",void 0),e([fe()],Eo.prototype,"_xcImportCards",void 0),e([fe()],Eo.prototype,"_xcImportLoading",void 0),e([fe()],Eo.prototype,"_palettes",void 0),e([fe()],Eo.prototype,"_paletteNaming",void 0),e([fe()],Eo.prototype,"_paletteName",void 0),e([fe()],Eo.prototype,"_expandedViewIds",void 0),e([fe()],Eo.prototype,"_openSections",void 0),e([fe()],Eo.prototype,"_haPickersReady",void 0),e([fe()],Eo.prototype,"_iaAllEntities",void 0),e([fe()],Eo.prototype,"_expandedRooms",void 0),e([fe()],Eo.prototype,"_designScope",void 0),e([fe()],Eo.prototype,"_designGroupBy",void 0),e([fe()],Eo.prototype,"_designOpenGroups",void 0),e([fe()],Eo.prototype,"_changesOpen",void 0),e([fe()],Eo.prototype,"_changesResetArmed",void 0),e([fe()],Eo.prototype,"_selectedDeviceId",void 0),e([fe()],Eo.prototype,"_conflictsOpen",void 0),e([fe()],Eo.prototype,"_flashControl",void 0),e([fe()],Eo.prototype,"_snapshots",void 0),e([fe()],Eo.prototype,"_snapMenu",void 0),e([fe()],Eo.prototype,"_snapName",void 0),e([fe()],Eo.prototype,"_snapMsg",void 0),e([fe()],Eo.prototype,"_helpOpen",void 0),e([fe()],Eo.prototype,"_helpFilter",void 0),e([fe()],Eo.prototype,"_helpTopic",void 0),e([fe()],Eo.prototype,"_rolled",void 0),e([fe()],Eo.prototype,"_styleClipFeedback",void 0),e([fe()],Eo.prototype,"_openDiscDropdown",void 0),e([fe()],Eo.prototype,"_sciServer",void 0),e([fe()],Eo.prototype,"_sciKey",void 0),e([fe()],Eo.prototype,"_sciBusy",void 0),e([fe()],Eo.prototype,"_sciError",void 0),e([fe()],Eo.prototype,"_sciDone",void 0),e([fe()],Eo.prototype,"_sciData",void 0),e([fe()],Eo.prototype,"_sciRoomMap",void 0),e([fe()],Eo.prototype,"_sciOptRooms",void 0),e([fe()],Eo.prototype,"_sciOptDevices",void 0),e([fe()],Eo.prototype,"_sciOptStock",void 0),e([fe()],Eo.prototype,"_sciOptFull",void 0),e([fe()],Eo.prototype,"_iconPickerState",void 0),e([fe()],Eo.prototype,"_wheel",void 0),Eo=xo=e([he("ha-device-dashboard-editor")],Eo);let To=class extends de{constructor(){super(...arguments),this.entity="",this._built=""}willUpdate(e){this.entity&&this.entity!==this._built&&this._build()}updated(){this._el&&this.hass&&(this._el.hass=this.hass)}async _build(){const e=this.entity;this._built=e;try{const t=window.loadCardHelpers,i=t?await t():void 0;if(!i||this.entity!==e)return;const s=i.createCardElement({type:"tile",entity:e,features:this.features??[]});this.hass&&(s.hass=this.hass),this._el=s}catch{this._el=void 0}}render(){return this._el??Y}};To.styles=r`
    :host {
      display: block;
